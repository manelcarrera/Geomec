...
# 1. include first 'TestData/CORA' folder with all the models in the installer zip
  ...
  try:
    ...
    for model in models:
      ...
      if os.path.isfile(file):
        ...
        # ../../TestData/CORA/quadlinear.gm4 
        # runmodel 
        # ../../TestData/CORA/quadlinear.parameterfile
        # ../../TestData/CORA/quadlinear.selectedlsfs
