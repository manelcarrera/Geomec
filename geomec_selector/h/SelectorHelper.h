...
namespace version
{
	...
	std::pair< QString, bool > get_GUI( 
		const std::pair< std::vector< QString >, 
...
namespace migrate
{
	...
	static const std::vector< QString > SETTINGS_KEYS = {
		"XMLMatLib",
		"OIVLicenseAttempt",
		"UNIT",
		"UnlockGVT",
	...
	static const std::vector< QString > PATHS_KEYS = {
		"DIAPATH",
		"InputExeName",
		"DianaExeName",
		"FgvExeName" };

	static const std::vector< QString > COLOR_SCALE_KEYS = {
		"Local"	};

	static const std::vector< QString > POINT_SET_DLG_KEYS = {
		"DefaultValueType" };
