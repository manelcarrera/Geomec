...
// -From Geomec > Settings > Last menu item: 'Mark as default' / 'Un-mark as default' (only current version can be
// set/unset)
//
////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
int main(int argc, char *argv[]) {
  ...
  if (!_path.startsWith(DEFAULT_INST_START) && !_path.toUpper().startsWith(BLADE_INST_START.toUpper())) {
  ...
  if (!QFile::exists(file)) {
    QFile::copy(QUtil::url(PACKAGES_PATH, "selector.xml"), file);
    QFile::setPermissions(file, QFile::ReadOther | QFile::WriteOther);
  }
  ...
  if (!QFile::exists(file)) {
    QFile::copy(QUtil::url(PACKAGES_PATH, "geomec.ini"), file);
    QFile::setPermissions(file, QFile::ReadOther | QFile::WriteOther);
  }
