...
CMatParamDomain::CMatParamDomain(bool bMinIsInf, double dMin, bool bIncludeMin, bool bMaxIsInf, double dMax,
                                 bool bIncludeMax)
    : m_bMinIsInf(bMinIsInf), m_dMin(dMin), m_bIncludeMin(bIncludeMin), m_bMaxIsInf(bMaxIsInf), m_dMax(dMax),
      m_bIncludeMax(bIncludeMax) {}

CMatParamDomain::CMatParamDomain(const CMatParamDomain &rhs)
    : m_bMinIsInf(rhs.m_bMinIsInf), m_dMin(rhs.m_dMin), m_bIncludeMin(rhs.m_bIncludeMin), m_bMaxIsInf(rhs.m_bMaxIsInf),
      m_dMax(rhs.m_dMax), m_bIncludeMax(rhs.m_bIncludeMax) {}

CMatParamDomain *CMatParamDomain::Clone() const { return new CMatParamDomain(*this); }
...
bool CMatParamDomain::IsDomainCheck() const { return true; }
