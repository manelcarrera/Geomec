...
CMaterial::CMaterial(const CMaterial &rhs) { *this = rhs; }
...
void CMaterial::setCheckStrategy(const CCheckStrategy &checkStrategy) { m_pCheckStrategy = &checkStrategy; }
...
#ifdef OLD_PARAMS
CMaterial *CMaterial::Clone() const { return new CMaterial(*this); }
#endif
...
bool CMaterial::operator!=(const CMaterial &rhs) const { return !operator==(rhs); }

const QString &CMaterial::Name() const { return m_strName; }
...
int CMaterial::MaterialModel() const { return m_nMaterialModel; }

const QString &CMaterial::MaterialModelName() const { return m_strModelName; }

#ifdef OLD_PARAMS
int CMaterial::ParameterSize() const { return int(m_vcParams.size()); }
...
int CMaterial::GroupSize() const { return int(m_vcGroups.size()); }
...
///// CMaterial::CGroup
CMaterial::CGroup::CGroup(CMaterial *mat, const QString &strName) : m_mat(mat), m_strName(strName) {}

const QString &CMaterial::CGroup::Name() const { return m_strName; }

size_t CMaterial::CGroup::ParameterSize() const { return m_vcParameters.size(); }
...
#ifdef OLD_PARAMS
CMaterial *CMaterial::CCreator::OnCreateMaterial() { return new CMaterial; }
#endif
...
void CMaterial::CCreator::Destroy(CMaterial *mat) { delete mat; }

void CMaterial::CCreator::Reset() { m_vcUngrouped.clear(); }
