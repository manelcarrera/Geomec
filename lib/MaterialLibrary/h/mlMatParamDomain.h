...
public:
  ...
  bool operator==(const CMatParamDomain &rhs) const {
    return m_bMinIsInf == rhs.m_bMinIsInf && m_dMin == rhs.m_dMin && m_bIncludeMin == rhs.m_bIncludeMin &&
           m_bMaxIsInf == rhs.m_bMaxIsInf && m_dMax == rhs.m_dMax && m_bIncludeMax == rhs.m_bIncludeMax;
  }
#endif
