...
CDianaExecuterSignalHandler::CDianaExecuterSignalHandler() : m_bFinished(false), m_bError(false) {
...
bool CDianaExecuterSignalHandler::GetCalculationResult() { return (m_bFinished && !m_bError); }

void CDianaExecuterSignalHandler::OnMessage(QString str) { _m()->outstream() << str.toStdString() << std::endl; }
void CDianaExecuterSignalHandler::OnAppSpcMessage(QString str) { _m()->outstream() << str.toStdString() << std::endl; }
...
void CDianaExecuterSignalHandler::OnWarning(QString str) { _m()->outstream() << str.toStdString() << std::endl; }

void CDianaExecuterSignalHandler::OnFinished() { m_bFinished = true; }
