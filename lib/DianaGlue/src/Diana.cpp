...
BOOL CDiana::SetEnvironment() {
  ...
  if (m_strDiaPath.isEmpty() || m_strTempPath.isEmpty() || m_strDiaExeName.isEmpty())
...
BOOL CDiana::StartDiana() {
  ...
  if (m_strDiaPath.isEmpty() || m_strTempPath.isEmpty() || m_strDiaExeName.isEmpty() || m_strDataFile.isEmpty())
...
bool CDiana::GetCalculationResult() { return m_bCalcResult; }
