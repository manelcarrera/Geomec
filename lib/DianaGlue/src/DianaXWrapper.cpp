...
void CDianaXWrapper::SetDisplayStopMessage(bool displayStopMessage){	m_exe_diana_dlg->SetDisplayStopMessage(displayStopMessage); }
void CDianaXWrapper::SetShowDefaultMessages(bool showDefaultMessages){	m_exe_diana_dlg->SetShowDefaultMessages(showDefaultMessages); }
void CDianaXWrapper::SetAutoCloseDialog(bool autoCloseDialog){			m_exe_diana_dlg->SetAutoCloseDialog(autoCloseDialog); }
void CDianaXWrapper::SetProgressIsLifesign(bool progressIsLifesign){	m_exe_diana_dlg->SetProgressIsLifesign(progressIsLifesign); }
...
{
  m_exe_diana_dlg->ExecuteDianaCleanup();
}
