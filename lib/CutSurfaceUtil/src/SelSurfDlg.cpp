...
int SelSurfDlg::SelectedSurfacesCount() const
{
	return slected_surfaces->size();
}

const STNamedSurface& SelSurfDlg::GetSelectedSurfaces(int index) const
{
	return (*slected_surfaces)[index];
}
...
/*virtual*/ void SelSurfDlg::OnCancel()
{
	CDialog::OnCancel(); 
}
