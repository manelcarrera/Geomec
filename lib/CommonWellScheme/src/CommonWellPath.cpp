...
CCommonWellPath::CCommonWellPath(const QString &text) : IModelObject(text) {}

QString CCommonWellPath::GetHoleName() const { return m_HoleName; }
...
geo::CVector CCommonWellPath::GetDirection(const double &azimuth, const double &inclination) {
...
void CCommonWellPath::GetNewPosition(const double &a1, const double &a2, const double &tmd1, const double &tmd2,
                                     const double &tmd, const double &i1, const double &i2, const double &eas1,
                                     const double &nor1, const double &tvd1, double &eas, double &nor, double &tvd,
                                     double &azi, double &inc, double &dls) {
...
void CCommonWellPath::PartialInitFromArray_tmd_azi_inc(double start_northing, double start_easting, double start_depth,
                                                       QVector<double> &tmd, QVector<double> &azi, QVector<double> &inc,
                                                       QVector<geo::CPoint> &points, QVector<double> &output_azi,
                                                       QVector<double> &output_inc) {
