...
CStaticFile::CStaticFile(DWORD dwFormat, BOOL   bPathEllipsis)
: m_bPathEllipsis(bPathEllipsis), m_dwFormat(dwFormat)
{
}
...
BOOL CStaticFile::PathEllipsis() const
{
	return m_bPathEllipsis; 
}

void CStaticFile::PathEllipsis(const BOOL bEnable) 
{ 
	m_bPathEllipsis = bEnable; 
} 

DWORD CStaticFile::TextFormat() const
{
	return m_dwFormat; 
} 

void CStaticFile::TextFormat(const DWORD dwFormat) 
{ 
	m_dwFormat = dwFormat; 
} 