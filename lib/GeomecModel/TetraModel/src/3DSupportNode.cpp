...
C3DSupportNode::C3DSupportNode(unsigned int uName, CInterfaceBoundary &boundary) : CBaseSupportNode(uName, boundary) {}

C3DSupportNode::C3DSupportNode(const C3DSupportNode &rhs)
    : CBaseSupportNode(rhs), m_GlobalTensors(rhs.m_GlobalTensors) {}
...
bool C3DSupportNode::operator==(const C3DSupportNode &rhs) const {
  ...
  if (!(m_GlobalTensors == rhs.m_GlobalTensors))
    return false;
...
C3DSupportNode::TColor C3DSupportNode::Color() const { return qRgb(255, 255, 255); }
...
C3DSupportNode::CGlobalTensorDef::CGlobalTensorDef() : m_nGlobalTensorInput(GTI_UNDEFINED), m_GlobalTensor(0) {}

bool C3DSupportNode::CGlobalTensorDef::operator==(const CGlobalTensorDef &rhs) const {
  if (m_nGlobalTensorInput != rhs.m_nGlobalTensorInput)
    return false;
...
void C3DSupportNode::CGlobalTensorDef::GlobalTensorInput(TGlobalTensorInput nInput) { m_nGlobalTensorInput = nInput; }

const ITensor &C3DSupportNode::CGlobalTensorDef::Tensor() const { return m_GlobalTensor; }

ITensor &C3DSupportNode::CGlobalTensorDef::Tensor() { return m_GlobalTensor; }

void C3DSupportNode::CGlobalTensorDef::LoadStream(TSTREAM &stream, CStreamVersion & /*version*/,
                                                  TPROGRESS & /*progress*/) {
  int dum;
  stream >> dum;
