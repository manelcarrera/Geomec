...
const CTetraSubHorizon* CTetraSubBoundary::CHorizonPlaceHolder::Horizon() const
{
  return m_pHorizon;
}

CTetraSubHorizon* CTetraSubBoundary::CHorizonPlaceHolder::Horizon()
{
  return m_pHorizon;
}

bool CTetraSubBoundary::CHorizonPlaceHolder::Empty() const
{
  return true;
}

long CTetraSubBoundary::CHorizonPlaceHolder::SavedItems() const
{
  return 0l;
}
...
unsigned int CTetraSubBoundary::CHorizonPlaceHolder::TypeId() const
{
  return 0;
}
...
CTetraSubBoundary::	CTetraSubBoundary(CTetraModel& model)
: CColorNode("Boundary", model),
  m_drawmode(DRAW_INIT)
{
...
int CTetraSubBoundary::DisplayListSize() const
{
  return GenerateDisplayList().size();
}
...
const geo::IObject& CTetraSubBoundary::DisplayList(int nIndex) const
{
  return *GenerateDisplayList()[nIndex];
}



int CTetraSubBoundary::SideSurfaceSize() const
{
  return m_vcSideSurface.size();
}

const CSurfaceBase& CTetraSubBoundary::SideSurface(int nIndex) const
{
  return *m_vcSideSurface[nIndex];
}

CSurfaceBase& CTetraSubBoundary::SideSurface(int nIndex)
{
   return *m_vcSideSurface[nIndex];
}
...
const CTetraSubBoundary::CHorizonPlaceHolder& CTetraSubBoundary::TopHorizon() const
{
  return *m_pTop;
}

CTetraSubBoundary::CHorizonPlaceHolder& CTetraSubBoundary::TopHorizon()
{
  return *m_pTop;
}

const CTetraSubBoundary::CHorizonPlaceHolder& CTetraSubBoundary::BottomHorizon() const
{
  return *m_pBottom;
}

CTetraSubBoundary::CHorizonPlaceHolder& CTetraSubBoundary::BottomHorizon()
{
  return *m_pBottom;
}

unsigned int CTetraSubBoundary::IconId() const
{
  return IDI_BOUNDARY;
}

unsigned int CTetraSubBoundary::TypeId() const
{
  return IDT_BOUNDARY;
}

QString CTetraSubBoundary::TypeName() const
{
  return getStringTableEntry(IDS_BOUNDARY);
}

bool CTetraSubBoundary::Empty() const
{
  return false;
}

long CTetraSubBoundary::SavedItems() const
{
  return CColorNode::SavedItems() + 2 + SideSurfaceSize();
}
void CTetraSubBoundary::LoadStream(TSTREAM& stream, CStreamVersion& version, TPROGRESS& progress)
{
  ...
  if(Name() == "SubBoundary") Name("Boundary");
