...
CTetraSubHorizon::CTetraSubHorizon(CFemAppModel& model)
...
{
  return  (IntermediateFault() == this && PlusFault() != 0 && MinusFault() != 0) || PlusFault() == this || MinusFault() == this;
}
...
const CTetraSubHorizon *CTetraSubHorizon::IntermediateFault() const
{
  return DSFault(DSFNameBase(Name()));
}

const CTetraSubHorizon *CTetraSubHorizon::MinusFault() const
{
  return DSFault(DSFNameBase(Name()) + "_minus");
}

const CTetraSubHorizon *CTetraSubHorizon::PlusFault() const
{
  return DSFault(DSFNameBase(Name()) + "_plus");
}
