...
private:
  ...
  void getOrderedSurfaceEdges(const IntermediateSurfaceInfo &surf, std::vector<geo::CPoint> &points,
  ...
  void createRotatedCopy(const IntermediateSurfaceInfo &surf, const geo::CPoint &plane_mid,
  ...
  void getRotationInfo(const IntermediateSurfaceInfo &surf_0, const IntermediateSurfaceInfo &surf_1,
  ...
  void getTyingInformation(TyingInfoMap &mpNodeInfo, const IntermediateSurfaceInfo &surf_src,
                           const IntermediateSurfaceInfo &surf_dst, double eps = .1) const;
};
