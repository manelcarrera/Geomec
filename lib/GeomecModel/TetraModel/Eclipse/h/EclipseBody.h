...
/*
	...
	double ShapeFunction(const double &xi, const double &eta, const double &zeta, const std::vector<geo::CValue> &vals) const;
	double ShapeFunctionDerivedXi(const double &eta, const double &zeta, Coord func) const;
	double ShapeFunctionDerivedEta(const double &xi, const double &zeta, Coord func) const;
	double ShapeFunctionDerivedZeta(const double &xi, const double &eta, Coord func) const;
	virtual void Jacobian(geo::IMatrix &matrix, const double &xi, const double &eta, const double &zeta) const;
*/
