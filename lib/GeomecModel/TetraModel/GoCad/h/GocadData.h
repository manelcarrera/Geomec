...
public:
  ...
  public:
    ...
    virtual void LoadStream(CStorageNode::TSTREAM& stream, CStreamVersion& version, CStorageNode::TPROGRESS& progress, IGoCadTypes& /*parent*/)
    {
  ...
  public:
    ...
    void LoadStream(CStorageNode::TSTREAM& stream, CStreamVersion& version, CStorageNode::TPROGRESS& progress, IGoCadTypes &parent);
  ...
  private:
    ...
    friend class CGocadImport;
    QString m_strName;
    std::vector <const CVertex *> m_vcVertices; // the pointers of vertices and atoms are owned by a IGoCadTypes derived class
  ...
  private:
    ...
    TSolidType m_type; // differences are minimal, and mostly outside this class, by routines that process volumes and surfaces
...
void LoadStreamLegacy(CStorageNode::TSTREAM& stream, CStreamVersion& version, CStorageNode::TPROGRESS& progress, struct gm_skua::SKUAParseData& data);
