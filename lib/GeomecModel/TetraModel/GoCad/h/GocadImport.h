...
private:
  ...
  void FindDSFFaults();
  bool CheckSolid();
  bool CheckSolidProperties(const std::vector<QString> &vcPropertyNames, std::vector<int> &vcESizes,
  ...
  bool ParseProperties(TArgIterator itArg, TArgIterator itArgEnd, const std::vector<int> &vcESizes,
