...
void loadVectorRef(CStorageNode::TSTREAM &stream, CStreamVersion &version, CStorageNode::TPROGRESS &progress, V& vector, R& ref)
{
  int size = 0;
...
template <typename V>
void loadBasicVector(CStorageNode::TSTREAM &stream, CStreamVersion &/*version*/, CStorageNode::TPROGRESS &/*progress*/, V& vector)
{
  int size = 0;
...
void loadVectorAtomRef(CStorageNode::TSTREAM &stream, CStreamVersion &version, CStorageNode::TPROGRESS &progress, std::vector<const CGocadData::CAtom *>& vector, CGocadData::IGoCadTypes& parent)
{
  int size = 0;
  stream >> size;
...
void loadVectorVertexRef(CStorageNode::TSTREAM &stream, CStreamVersion &version, CStorageNode::TPROGRESS &progress, std::vector<const CGocadData::CVertex *>& vector, CGocadData::IGoCadTypes& parent)
{
  int size = 0;
  stream >> size;
...
void loadNodesRef(CStorageNode::TSTREAM &stream, CStreamVersion &version, CStorageNode::TPROGRESS &progress, N& nodes, R& ref)
{
  int numberOfNodes = 0;
...
void loadMap(CStorageNode::TSTREAM& stream, CStreamVersion& version, CStorageNode::TPROGRESS& progress, MAP& map, CGocadData::IGoCadTypes& parent)
{
  int size = 0;
...
template <typename V>
void saveVector(CStorageNode::TSTREAM &stream, CStorageNode::TPROGRESS &progress, V& vector)
{
...
template <typename M>
void saveMap(CStorageNode::TSTREAM &stream, CStorageNode::TPROGRESS &progress, M& map)
{
  int size = map.size();
...
void fillNodes(std::vector<const CGocadData::CNode *>& nodes, CGocadData::IGoCadTypes::TAtomMap& atomIDs, CGocadData::IGoCadTypes::TVertexMap& vertexIDs)
{
...
bool CGocadData::CNode::IsEqualTo(const CNode& node) const
{
  return (Pointee() == &node || node.Pointee() == this);
}

int CGocadData::CNode::ID() const
{
  return m_nID;
}

int CGocadData::CNode::PropertySize() const
{
  return m_vcProperties.size();
}
...
void CGocadData::CNode::LoadStream(CStorageNode::TSTREAM& stream,
...
///// CVertex
double CGocadData::CVertex::X() const
{
  return m_dCoord[0];
}

double CGocadData::CVertex::Y() const
{
  return m_dCoord[1];
}

double CGocadData::CVertex::Z() const
{
  return m_dCoord[2];
}

void CGocadData::CVertex::LoadStream(CStorageNode::TSTREAM& stream, CStreamVersion& version, CStorageNode::TPROGRESS& progress, IGoCadTypes& /* parent */)
{
...
const CGocadData::CNode* CGocadData::CAtom::Pointee() const
{
  return m_pVertex;
}
...
void CGocadData::CAtom::setVertex(const CVertex *vertex)
{
  m_pVertex = vertex;
}

void CGocadData::CAtom::LoadStream(CStorageNode::TSTREAM& stream, CStreamVersion& version, CStorageNode::TPROGRESS& progress, IGoCadTypes& parent)
{
  CGocadData::CNode::LoadStream(stream, version, progress);
...
const CGocadData::CNode* CGocadData::CSharedVertex::Pointee() const
{
  return m_pVertex;
}
...
void CGocadData::CSharedVertex::setVertex(const CVertex *vertex)
{
  m_pVertex = vertex;
}

void CGocadData::CSharedVertex::LoadStream(CStorageNode::TSTREAM& stream, CStreamVersion& version, CStorageNode::TPROGRESS& progress, IGoCadTypes& parent)
{
  CGocadData::CNode::LoadStream(stream, version, progress);
...
int CGocadData::CTetra::PropertySize() const
{
  return m_vcProperties.size();
}
...
void CGocadData::CTetra::LoadStream(CStorageNode::TSTREAM& stream, CStreamVersion& version, CStorageNode::TPROGRESS& progress, IGoCadTypes& parent)
{
...
void CGocadData::CTriangle::LoadStream(CStorageNode::TSTREAM& stream, CStreamVersion& version, CStorageNode::TPROGRESS& progress, IGoCadTypes& parent)
{
  loadNodesRef(stream, version, progress, m_Nodes, parent);
}
...
const QString& CGocadData::CTFace::Name() const
{
  return m_strName;
}

size_t CGocadData::CTFace::TriangleSize() const
{
  return m_vcTriangles.size();
}
...
void CGocadData::CTFace::LoadStream(CStorageNode::TSTREAM& stream,
  CStreamVersion& version, CStorageNode::TPROGRESS& progress, IGoCadTypes& parent)
{
  stream >> m_strName;
...
void CGocadData::CTFace::SaveStream(CStorageNode::TSTREAM& stream,
...
CGocadData::CSurface::CSurface()
  : m_bDoubleSidedFaultSurface(false)
{
}
...
const QString& CGocadData::CSurface::Name() const
{
  return m_strName;
}

int CGocadData::CSurface::TFaceSize() const
{
...
bool CGocadData::CSurface::DoubleSidedFaultSurface() const
{
  return m_bDoubleSidedFaultSurface;
}

void CGocadData::CSurface::LoadStream(CStorageNode::TSTREAM& stream,
  CStreamVersion& version, CStorageNode::TPROGRESS& progress, IGoCadTypes& parent)
{
  stream >> m_strName;
...
void CGocadData::CSurface::SaveStream(CStorageNode::TSTREAM& stream,
  CStorageNode::TPROGRESS& progress)
{
  stream << m_strName;
...
CGocadData::CTVolume::CTVolume()
  : m_bDoubleSidedFaultVolume(false)
{
}
...
const QString& CGocadData::CTVolume::Name() const
{
  return m_strName;
}

int CGocadData::CTVolume::VertexSize() const
{
  return m_vcVertices.size();
}
...
int CGocadData::CTVolume::AtomSize() const
{
  return m_vcAtoms.size();
}
...
int CGocadData::CTVolume::TetraSize() const
{
  return m_vcTetras.size();
}
...
bool CGocadData::CTVolume::DoubleSidedFaultVolume() const
{
  return m_bDoubleSidedFaultVolume;
}

void CGocadData::CTVolume::LoadStream(CStorageNode::TSTREAM& stream,
  CStreamVersion& version, CStorageNode::TPROGRESS& progress, IGoCadTypes& parent)
{
  stream >> m_strName;
...
void CGocadData::CTVolume::SaveStream(CStorageNode::TSTREAM& stream,
  CStorageNode::TPROGRESS& progress)
{
  stream << m_strName;
...
///// IGoCadTypes
const QString& CGocadData::IGoCadTypes::Name() const
{
  return m_strName;
}
...
int CGocadData::IGoCadTypes::PropertiesSize() const
{
  return m_vcPropertyNames.size();
}
...
double CGocadData::IGoCadTypes::ZFactor() const
{
  return m_dZFactor;
}
...
int CGocadData::IGoCadTypes::VertexIDsSize() const
{
  return m_mpVertexIDs.size();
}
...
int CGocadData::IGoCadTypes::AtomIDsSize() const
{
  return m_mpAtomIDs.size();
}
...
int CGocadData::IGoCadTypes::SharedVertexIDsSize() const
{
  return m_mpSharedVertexIDs.size();
}
...
void CGocadData::IGoCadTypes::LoadStream(CStorageNode::TSTREAM& stream,
  CStreamVersion& version, CStorageNode::TPROGRESS& progress)
{
  stream >> m_dZFactor;
...
void CGocadData::IGoCadTypes::SaveStream(CStorageNode::TSTREAM& stream,
  CStorageNode::TPROGRESS& progress)
{
  stream << m_dZFactor;
...
///// CTSolid
CGocadData::CTSolid::CTSolid(bool bLightTSolid)
  : m_type(bLightTSolid ? LightTSolid : TSolid)
{
}
...
CGocadData::CTSolid::TSolidType CGocadData::CTSolid::Type() const
{
  return m_type;
}

int CGocadData::CTSolid::NoDataValueSize() const
{
  return m_vcNoDataValues.size();
}
...
int CGocadData::CTSolid::ESizeSize() const
{
  return m_vcESizes.size();
}
...
int CGocadData::CTSolid::TetraPropertiesSize() const
{
  return m_vcTetraPropertyNames.size();
}
...
int CGocadData::CTSolid::TetraNoDataValueSize() const
{
  return m_vcTetraNoDataValues.size();
}
...
int CGocadData::CTSolid::TetraESizeSize() const
{
  return m_vcTetraESizes.size();
}
...
int CGocadData::CTSolid::VolumeSize() const
{
  return m_vcVolumes.size();
}
...
int CGocadData::CTSolid::SurfaceSize() const
{
...
void CGocadData::CTSolid::LoadStream(CStorageNode::TSTREAM& stream,
  CStreamVersion& version, CStorageNode::TPROGRESS& progress)
{
...
void CGocadData::CTSolid::SaveStream(CStorageNode::TSTREAM& stream,
  CStorageNode::TPROGRESS& progress)
{
...
void CGocadData::CVset::LoadStream(CStorageNode::TSTREAM& stream,
  CStreamVersion& version, CStorageNode::TPROGRESS& progress)
{
  CGocadData::IGoCadTypes::LoadStream(stream, version, progress);
}

void CGocadData::CVset::SaveStream(CStorageNode::TSTREAM& stream,
  CStorageNode::TPROGRESS& progress)
{
  CGocadData::IGoCadTypes::SaveStream(stream, progress);
}
...
void CGocadData::CTSurf::LoadStream(CStorageNode::TSTREAM& stream,
  CStreamVersion& version, CStorageNode::TPROGRESS& progress)
{
  CGocadData::IGoCadTypes::LoadStream(stream, version, progress);
...
void CGocadData::CTSurf::SaveStream(CStorageNode::TSTREAM& stream,
  CStorageNode::TPROGRESS& progress)
{
  CGocadData::IGoCadTypes::SaveStream(stream, progress);
...
// these can be long, but are straight-forward: the old format was object hierarchy/pointer based, the new one is flat/vector based
...
void transform(const CGocadData::CTVolume& old_data, struct SKUAParseData& new_data)
{
  ...
  new_data.volume_types.emplace_back(old_data.DoubleSidedFaultVolume() ? SKUAParseData::VolumeType::VolDSFVolume : SKUAParseData::VolumeType::VolNormal);
...
{
  new_data.surface_names.emplace_back(SKUAParseData::String((int)new_data.surface_names.size(), old_data.Name().toStdString().c_str()));

  int type = old_data.DoubleSidedFaultSurface() ? SKUAParseData::SurfaceType::SurfDSFFault : SKUAParseData::SurfaceType::SurfUnknown;
...
void transform_vertex_properties(const CGocadData::CTSolid& old_data, struct SKUAParseData& new_data, int minID, int maxID)
{
...
void LoadStreamLegacy(CStorageNode::TSTREAM& stream, CStreamVersion& version, CStorageNode::TPROGRESS& progress, struct SKUAParseData& data)
{
