...
static const int hexa_tetra_index[6][4] =
{
  { 0, 1, 2, 5 },
  { 0, 5, 2, 4 },
  { 5, 6, 2, 4 },
...
static const int tetra_tetra_index[4] =
{ 0, 1, 2, 3 };
...
CGocadExport::CNodeBase::CNodeBase(const CNodeBase& rhs)
: m_nId(rhs.m_nId)
{
}
...
int CGocadExport::CNodeBase::Id() const
{
  return m_nId;
}

void CGocadExport::CNodeBase::Id(int id)
{
  m_nId = id;
}
...
CGocadExport::CVertex::CVertex(const geo::INode& node)
: m_node(node)
{
}

CGocadExport::CVertex::CVertex(const CVertex& rhs)
: CNodeBase(rhs),
  m_node(rhs.m_node)
{
}
...
CGocadExport::CAtom::CAtom(const CVertex& vertex)
: m_vertex(vertex)
{
}

void CGocadExport::CAtom::Write(FILE* fp, int /*iUnit*/, const TElementValueVec& vcElementValues, int nLocalIndex) const
{
  assert(Id() > 0);
...
CGocadExport::CTetra::CTetra(const geo::IElement& element, CNodeBase** pNode)
: m_element(element)
{
  int i;
  for(i = 0; i < 4; ++i)
...
void CGocadExport::CTetra::Write(FILE* fp, const IValueDomainScalar::TValueVec& vcAverageElementValues, const QString* pstrFormationName) const
{
  fprintf(fp, "TETRA");
...
const geo::IElement& CGocadExport::CTetra::Element() const
{
  return m_element;
}
...
: m_model(model),
  m_bLinear(model.ResultRegister().Linear()),
  m_bNonLinear(model.ResultRegister().NonLinear()),
  m_bHeat(model.ResultRegister().Heat()),
  m_bMixture(model.ResultRegister().Mixture()),
  m_bMixtureContainment(model.ResultRegister().MixtureContainment()),
  m_iUnit(0),
  m_bVectorESize(true),
  m_bTensorESize(false),
  m_bAverage(false),
  m_bSplitFormations(false),
  m_fp(0),
...
void CGocadExport::ExportVSets(IProgressBase &prog)
{
  WritePointSets(prog);
}

const CModelBase& CGocadExport::Model() const
{
  return m_model;
}

CModelBase& CGocadExport::Model()
{
  return m_model;
}

void CGocadExport::AddDepletionStage(const CDepletionStage& stage)
{
  m_stTimeSteps.insert(&stage);
}

void CGocadExport::RemoveDepletionStage(const CDepletionStage& stage)
{
  m_stTimeSteps.erase(&stage);
}
...
void CGocadExport::AddPointSet(const CPointSet &ptSet)
{
  m_stPointSets.insert(&ptSet);
}

void CGocadExport::RemovePointSet(const CPointSet &ptSet)
{
  m_stPointSets.erase(&ptSet);
}

void CGocadExport::AddFormation(const CFormationBase& formation)
{
  m_stFormations.insert(&formation);
}

void CGocadExport::RemoveFormation(const CFormationBase& formation)
{
  m_stFormations.erase(&formation);
}

void CGocadExport::AddHorizon(const CHorizonBase& horizon)
{
  m_stHorizons.insert(&horizon);
}

void CGocadExport::RemoveHorizon(const CHorizonBase& horizon)
{
  m_stHorizons.erase(&horizon);
}

bool CGocadExport::PointSet(const CPointSet &ptSet)
{
  return (m_stPointSets.find(&ptSet) != m_stPointSets.end());
}
...
bool CGocadExport::HasPointSets() const
{
  return !m_stPointSets.empty();
}

bool CGocadExport::HasFormations() const
{
  return !m_stFormations.empty();
}

bool CGocadExport::HasHorizons() const
{
  return !m_stHorizons.empty();
}
...
void CGocadExport::Linear(bool bOn)
{
  m_bLinear = bOn;
}

bool CGocadExport::Linear() const
{
  return m_bLinear;
}

void CGocadExport::NonLinear(bool bOn)
{
  m_bNonLinear = bOn;
}

bool CGocadExport::NonLinear() const
{
  return m_bNonLinear;
}

void CGocadExport::Heat(bool bOn)
{
  m_bHeat = bOn;
}

bool CGocadExport::Heat() const
{
  return m_bHeat;
}

void CGocadExport::Mixture(bool bOn)
{
  m_bMixture = bOn;
}

bool CGocadExport::Mixture() const
{
  return m_bMixture;
}

void CGocadExport::MixtureContainment(bool bOn)
{
  m_bMixtureContainment = bOn;
}

bool CGocadExport::MixtureContainment() const
{
  return m_bMixtureContainment;
}

void CGocadExport::Unit(int iUnit)
{
  m_iUnit = iUnit;
}

int CGocadExport::Unit() const
{
  return m_iUnit;
}

void CGocadExport::VectorESize(bool bOn)
{
  m_bVectorESize = bOn;
}

bool CGocadExport::VectorESize() const
{
  return m_bVectorESize;
}

void CGocadExport::TensorESize(bool bOn)
{
  m_bTensorESize = bOn;
}

bool CGocadExport::TensorESize() const
{
  return m_bTensorESize;
}

void CGocadExport::Average(bool bOn)
{
  m_bAverage = bOn;
}

bool CGocadExport::Average() const
{
  return m_bAverage;
}

void CGocadExport::SplitFormations(bool bOn)
{
  m_bSplitFormations = bOn;
}

bool CGocadExport::SplitFormations() const
{
  return m_bSplitFormations;
}

void CGocadExport::FormationNames(bool bOn)
{
  m_bFormationNames = bOn;
}

bool CGocadExport::FormationNames() const
{
  return m_bFormationNames;
}
...
void CGocadExport::AddPointValueFromComponent(const geo::IPoint &point, const IValueComponentBase &comp, IValueDomainScalar::TValueVec &vcPointValues, const COpenGLNode &object) const
{
...
void CGocadExport::AddPointValuesFromResult(const geo::IPoint &point, const IResult &result, const std::vector<int> &indices, IValueDomainScalar::TValueVec &vcPointValues, const COpenGLNode &object) const
{
  const CDepletionStage *pStage = &m_model.InitialDepletionStage();
  while(pStage)
  {
...
void CGocadExport::AddElementValuesFromComponent(const geo::IElement& element, const IValueComponentBase& comp, TElementValueVec& vcElementValues, const COpenGLNode& object) const
{
  if(comp.CanMap(object))
  {
...
void CGocadExport::AddElementValuesFromResult(const geo::IElement& element, const IResult& result, const std::vector<int>& vcIndices, TElementValueVec& vcElementValues, const COpenGLNode& object) const
{
  const CDepletionStage* pStage = &m_model.InitialDepletionStage();
  while(pStage)
  {
...
void CGocadExport::GetPointValues(const geo::IPoint &point, IValueDomainScalar::TValueVec &vcPointValues, const COpenGLNode& object) const
{
...
void CGocadExport::GetElementValues(const geo::IElement& element, TElementValueVec& vcElementValues, const COpenGLNode& object) const
{
...
void CGocadExport::CreateNodes(const geo::IElement& element, const int* pNodeIndices, CNodeBase** pNode, const TElementValueVec& vcElementValues)
{
  int n;
  for(n = 0; n < 4; ++n)
  {
...
void CGocadExport::WriteTrailer()
{
  fprintf(m_fp, "END\n");
}

bool CGocadExport::HasProperties() const
{
  return false;
}
