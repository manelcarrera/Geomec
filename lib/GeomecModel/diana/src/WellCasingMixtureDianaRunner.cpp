...
CWellCasingModel& CWellCasingMixtureDianaRunner::CasingModel()
{
...
void CWellCasingMixtureDianaRunner::CreateStrainLoad(const geo::IElement& elm, const CDepletionStage& stage, dia::CLoadCase& lcase)
{
...
IValueDomainScalar::TValueVec CWellCasingMixtureDianaRunner::ElementConcentrations(const geo::IElement& element, const CDepletionStage& stage) const
{
  if(CasingModel().Mesh().IsCementElement(element))
  {
