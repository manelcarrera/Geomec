...
bool CWellCasingDianaRunner::FetchInitialPressures(const geo::IElement& element, const CDepletionStage& stage, IValueDomainScalar::TValueVec& vcInitialPressures)
{
...
bool CWellCasingDianaRunner::FetchInitialTemperatures(const geo::IElement& element, const CDepletionStage& stage, IValueDomainScalar::TValueVec& vcInitialTemperatures)
{
...
CWellCasingModel& CWellCasingDianaRunner::CasingModel()
{
  return static_cast<CWellCasingModel&>(Model());
}

void CWellCasingDianaRunner::CreateStrainLoad(const geo::IElement& elm, const CDepletionStage& stage, dia::CLoadCase& lcase)
{
