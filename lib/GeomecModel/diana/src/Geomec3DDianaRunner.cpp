...
CGeomec3DDianaRunner::CGeomec3DDianaRunner(CMeshBase &meshbase, C3DModel &model, CDianaRunController &controller)
...
void CGeomec3DDianaRunner::WriteInterfaceInitialLoads(const CDepletionStage & /*stage*/,
                                                      const geo::CInterfaceElement &iface, dia::CLoadCase &lcase,
...
void CGeomec3DDianaRunner::WriteInterfaceStageLoads(const CDepletionStage &stage, const geo::CInterfaceElement &iface,
                                                    dia::CLoadCase &lcase,
                                                    const IValueDomainScalar::TValueVec &vcInitialPressures) {
...
bool CGeomec3DDianaRunner::FetchInitialPressures(const geo::IElement &element, const CDepletionStage &stage,
...
bool CGeomec3DDianaRunner::CreateInitialLoads(const geo::IElement &element, const CDepletionStage &stage,
                                              dia::CLoadCase &lcase,
                                              const IValueDomainScalar::TValueVec &vcInitialPressures,
...
bool CGeomec3DDianaRunner::CreateStageLoads(const geo::IElement &element, const CDepletionStage &stage,
                                            dia::CLoadCase &lcase,
                                            const IValueDomainScalar::TValueVec &vcInitialPressures,
                                            const IValueDomainScalar::TValueVec &vcInitialTemperatures) {
  const geo::CInterfaceElement *pIface = dynamic_cast<const geo::CInterfaceElement *>(&element);
