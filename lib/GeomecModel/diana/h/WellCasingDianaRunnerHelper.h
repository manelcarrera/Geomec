...
public:
  ...
  void InterfaceElementPressures(RUNNER& runner, const geo::IElement& elm, const CDepletionStage& stage, IValueDomainScalar::TValueVec& vcValues) const;
...
template <class RUNNER>
void CWellCasingDianaRunnerHelper::InterfaceElementPressures(RUNNER& runner, const geo::IElement& elm, const CDepletionStage& stage, IValueDomainScalar::TValueVec& vcValues) const
{
