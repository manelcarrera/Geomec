...
public:
  CGeomecCompactionDianaRunner(CMeshBase &meshbase, CModelBase &model, CDianaRunController &controller);
...
protected:
  ...
  virtual bool FetchInitialPressures(const geo::IElement &element, const CDepletionStage &stage,
                                     IValueDomainScalar::TValueVec &vcInitialPressures) = 0;
  virtual bool CreateInitialLoads(const geo::IElement &element, const CDepletionStage &stage, dia::CLoadCase &lcase,
                                  ...
                                  const IValueDomainScalar::TValueVec &vcInitialTemperatures) = 0;
  ...
  virtual bool FetchInitialTemperatures(const geo::IElement &element, const CDepletionStage &stage,
                                        IValueDomainScalar::TValueVec &vcInitialTemperatures);
  void FetchElementInitialTemperatures(const CDepletionStage &stage, const geo::IElement &element,
                                       IValueDomainScalar::TValueVec &vcInitialTemperatures);
  bool FetchElementInitialPressures(const CDepletionStage &stage, const geo::IElement &element,
                                    IValueDomainScalar::TValueVec &vcInitialPressures);
  void WriteElementInitialLoads(const CDepletionStage &stage, const geo::IElement &element, dia::CLoadCase &lcase,
                                const IValueDomainScalar::TValueVec &vcInitialPressures,
                                const IValueDomainScalar::TValueVec &vcInitialTemperatures);
  void WriteElementStageLoads(const CDepletionStage &stage, const geo::IElement &element, dia::CLoadCase &lcase,
                              const IValueDomainScalar::TValueVec &vcInitialPressures,
                              const IValueDomainScalar::TValueVec &vcInitialTemperatures);
  virtual void FetchStagePressures(const geo::IElement &element, const CDepletionStage &stage,
                                   IValueDomainScalar::TValueVec &vcPressures);
  virtual void FetchStageTemperatures(const geo::IElement &element, const CDepletionStage &stage,
