...
public:
  CGeomecMixtureDianaRunner(CMeshBase &meshbase, CModelBase &model, CDianaRunController &controller);
...
protected:
  ...
  virtual void ElementPressures(const geo::IElement &elm, const CDepletionStage &stage,
...
private:
  ...
  geo::CValue Pressure(const geo::INode &node, const std::set<int> &stAttachedElements,
  ...
  void FetchStageTemperatures(const geo::IElement &element, const CDepletionStage &stage,
