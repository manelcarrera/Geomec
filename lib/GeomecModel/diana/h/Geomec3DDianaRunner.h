...
public:
  CGeomec3DDianaRunner(CMeshBase &meshbase, C3DModel &model, CDianaRunController &controller);
...
private:
  ...
  void WriteInterfaceInitialLoads(const CDepletionStage &stage, const geo::CInterfaceElement &iface,
                                  dia::CLoadCase &lcase, const IValueDomainScalar::TValueVec &vcInitialPressures);
  void WriteInterfaceStageLoads(const CDepletionStage &stage, const geo::CInterfaceElement &iface,
                                dia::CLoadCase &lcase, const IValueDomainScalar::TValueVec &vcInitialPressures);
};
