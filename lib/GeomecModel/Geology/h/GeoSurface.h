...
// Construction ...
  ...
  CSurfaceBase(const QString &strName, 
  ...
  CSurfaceBase(const QString &strName, 
       ...
       CFemAppModel& model);
  CSurfaceBase(const QString &strName,
      const geo::CArray<geo::CPoint> &vcPoint,
      CFemAppModel& model);
...
//	double CalcAverageEdgeSize();
  ...
  void ExportSurface(const QString& sExt, const CUnitNode& unitNode,
...
public:
  void DoCutSurfaces(CModelBase& model, int cutSurfacesCount,
