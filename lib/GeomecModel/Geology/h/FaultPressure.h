...
public:
  ...
  virtual geo::CValue ValuePoint(const geo::IPoint &pt, const CQuantity::UNIT unit = CQuantity::SI_UNIT,
...
protected:
  IValueDomainScalar::TValueVec InterfaceValues3D(const geo::CInterfaceElement &iface, bool bMax,
                                                  const CQuantity::UNIT unit) const;
  IValueDomainScalar::TValueVec InterfaceValues(const geo::IInterfaceElement &iface, bool bMax,
                                                const CQuantity::UNIT unit) const;
...
private:
  ...
  public:
    ...
    virtual IValueDomainScalar::TValue ValuePoint(const geo::IPoint &pt,
                                                  const CQuantity::UNIT unit = CQuantity::SI_UNIT,
                                                  geo::IParallelInitializationCallback *cb = 0) const;
    virtual IValueDomainScalar::TValueVec ValueElement(const geo::IElement &elm,
                                                       const CQuantity::UNIT unit = CQuantity::SI_UNIT,
