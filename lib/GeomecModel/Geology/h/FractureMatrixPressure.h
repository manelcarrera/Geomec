...
typedef CFormationLoadRepeaterComponent<TFractureMatrixPressure, CComponentConstant<TFractureMatrixPressure>,
                                        CFractureMatrixComponentRepeater, CFractureMatrixComponentGWC>
    TFractureMatrixComponentRepeaterBase;
...
typedef CFormationLoad<TFractureMatrixPressure, CComponentConstant<TFractureMatrixPressure>,
                       CFractureMatrixComponentRepeater, CFractureMatrixComponentGWC>
    TFractureMatrixPressureBase;

class CFractureMatrixPressure : public TFractureMatrixPressureBase {
public:
  CFractureMatrixPressure(const CPressure *pressure, CFormationBase &f, CDepletionStage &d,
                          bool bEmpty = false); // Undefined initialisation
  CFractureMatrixPressure(const CPressure *pressure, CFormationBase &f, CDepletionStage &d,
                          const double &dReferencePressure, const double &dReferenceDepth, const double &dGradient,
  ...
  CFractureMatrixPressure(const CPressure *pressure, CFormationBase &f, CDepletionStage &d,
                          ...
                          const CQuantity::UNIT unit = CQuantity::SI_UNIT);
  CFractureMatrixPressure(const CPressure *pressure, CFormationBase &f, CDepletionStage &d, TFractureMatrixPressure &p);
