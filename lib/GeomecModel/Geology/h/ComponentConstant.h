...
template <typename Pressure>
  class CComponentConstant : public CFormationLoadGradientComponent<Pressure, CSinglePressure, CPressureGradientQuantity>
{
public:
...
template <typename Pressure>
  unsigned int CComponentConstant <Pressure>::TypeId() const
{
	return IDT_COMPONENT_PRESSURE_CONSTANT;
}

template <typename Pressure>
  unsigned int CComponentConstant <Pressure>::IconId() const
{
	return IDI_COMPONENT_PRESSURE_CONSTANT;
}

template <typename Pressure>
  QString CComponentConstant <Pressure>::TypeName() const
{
	return getStringTableEntry(IDS_COMPONENT_PRESSURE_CONSTANT);
}

template <typename Pressure>
  QString CComponentConstant <Pressure>::UnitName(const CQuantity::UNIT unit) const
{
	QString sRet;
...
template <typename Pressure>
  QString CComponentConstant <Pressure>::ExportLabel() const
{
