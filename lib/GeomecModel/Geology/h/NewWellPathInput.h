...
public:
  ...
  CNewWellPathInput(const QString &file, const QString &name, CFemAppModel &model, CQuantity::UNIT unit,
                    IProgressBase &dlg);
  ...
  static const CNewWellPath *CreateWellPath(CNewWellPathInput *input, const CModelBase &model,
  ...
  void InitFromPointArray(QVector<geo::CPoint> &vcPoint, bool setGlobals = true, QVector<double> *azimuth = 0,
                          QVector<double> *inclination = 0);
