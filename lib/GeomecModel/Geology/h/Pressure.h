...
class CComponentRepeater : public CFormationLoadRepeaterComponent<TPressure, CComponentConstant <TPressure>, CComponentRepeater, CComponentGWC>
{
public:
