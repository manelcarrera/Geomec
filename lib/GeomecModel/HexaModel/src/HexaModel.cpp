...
unsigned int CHexaModel::ModelIconId() const { return staticModelIconId(); }

// ##ModelId=3BAF4D1E0013
QString CHexaModel::documentType() const { return staticDocumentType(); }

unsigned int CHexaModel::staticModelIconId() { return IDI_HORIZON_MODEL; }

QString CHexaModel::staticDocumentType() { return "Hexahedron"; }
...
bool CHexaModel::IsResult() const { return ResultRegister().ResultsAvailable(); }

void CHexaModel::Calculate() {
  // TODO : Call the functions of the ResultServer to calculate.
}

CMeshBase &CHexaModel::Mesh() { return *m_pMesh; }

const CMeshBase &CHexaModel::Mesh() const { return *m_pMesh; }

CHexaModel::ModelType CHexaModel::modelType() const { return eHexaModel; }
