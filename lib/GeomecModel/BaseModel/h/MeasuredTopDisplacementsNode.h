...
template <int COMPONENT_INDEX, unsigned int TAG> class CRpnTopDisplacementProxy : public rpn::CRpnOperand::IValueProxy {
public:
...
CRpnTopDisplacementProxy<COMPONENT_INDEX, TAG>::CRpnTopDisplacementProxy(C3DModel &model, rpn::CRpnStack &stack)
    : rpn::CRpnOperand::IValueProxy(stack), m_pModel(&model) {}

template <int COMPONENT_INDEX, unsigned int TAG>
CRpnTopDisplacementProxy<COMPONENT_INDEX, TAG>::CRpnTopDisplacementProxy(C3DModel &model, rpn::CRpnStack &stack,
                                                                         const QString &sProxyId)
    : rpn::CRpnOperand::IValueProxy(stack, sProxyId.toStdString().c_str()), m_pModel(&model) {}

template <int COMPONENT_INDEX, unsigned int TAG>
CRpnTopDisplacementProxy<COMPONENT_INDEX, TAG>::CRpnTopDisplacementProxy(rpn::CRpnStack &stack, const QString &sProxyId)
    : rpn::CRpnOperand::IValueProxy(stack, sProxyId.toStdString().c_str()), m_pModel(0) {}
...
template <int COMPONENT_INDEX, unsigned int TAG> int CRpnTopDisplacementProxy<COMPONENT_INDEX, TAG>::TypeId() const {
...
template <int COMPONENT_INDEX, unsigned int TAG>
void CRpnTopDisplacementProxy<COMPONENT_INDEX, TAG>::LoadStream(std::stringstream & /*stream*/,
                                                                CStreamVersion & /*version*/) {}

template <int COMPONENT_INDEX, unsigned int TAG> bool CRpnTopDisplacementProxy<COMPONENT_INDEX, TAG>::Defined() const {
  return (m_pModel->MeasuredTopDisplacementsNode().DisplacementVector() != 0);
}

template <int COMPONENT_INDEX, unsigned int TAG> bool CRpnTopDisplacementProxy<COMPONENT_INDEX, TAG>::exists() const {
  return (m_pModel->MeasuredTopDisplacementsNode().DisplacementVector() != 0);
}

template <int COMPONENT_INDEX, unsigned int TAG>
IValueDomainScalar::TValue CRpnTopDisplacementProxy<COMPONENT_INDEX, TAG>::Value(const geo::IPoint &pt,
                                                                                 UNIT unit) const {
...
template <int COMPONENT_INDEX, unsigned int TAG>
IValueDomainScalar::TValueVec CRpnTopDisplacementProxy<COMPONENT_INDEX, TAG>::Value(const geo::IElement &el,
                                                                                    UNIT unit) const {
