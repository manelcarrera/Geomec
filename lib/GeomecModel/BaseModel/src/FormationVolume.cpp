...
: IFormationElementSet(formation, bDoLink) 
, m_BodyGroup(&body_group)
{
}

CFormationVolume::CFormationVolume(C3DFormation& formation)
: IFormationElementSet(formation), m_BodyGroup(0)
{
}
...
geo::CValue CFormationVolume::ThicknessAt(const geo::IPoint& pt, geo::IPoint& ptTop, geo::IPoint& ptBottom, geo::IParallelInitializationCallback *cb) const
{
...
void CFormationVolume::clearThicknessCache()
{
  m_mpThicknessCache.clear();
}
