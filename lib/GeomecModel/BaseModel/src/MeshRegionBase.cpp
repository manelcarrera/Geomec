...
CMeshRegionBase::CMeshRegionBase(CFemAppModel &model) : CColorNode(model) {}
...
CMeshRegionBase::CMeshRegionBase(const CMeshRegionBase &rhs) : CColorNode(rhs) {}
...
bool CMeshRegionBase::operator==(const CMeshRegionBase &rhs) const { return CColorNode::operator==(rhs); }

unsigned int CMeshRegionBase::TypeId() const { return IDT_TREE_MESH_REGIONS; }

QString CMeshRegionBase::TypeName() const { return getStringTableEntry(IDS_TREE_MESH_REGIONS); }