...
void IModelLifetimeFacade::NewMainDecorators() { CValueTypeFactory::instance()->reset(); }
...
CModelBase *IModelLifetimeFacade::NewChild(int type, CWellZoomInModel &parent, CAnalysisLogger &logger,
...
CModelBase *IModelLifetimeFacade::NewChild(int type, CModelBase &parent, CNewWellPath &wp, CAnalysisLogger &logger,
                                           const CVersionManager &versionManager) {
...
CModelBase *IModelLifetimeFacade::NewChild(int type, CModelBase &parent, CWellPath &wp, CAnalysisLogger &logger,
                                           const CVersionManager &versionManager) {
  if (type == WELL_ZOOMIN_MODEL)
    return new CWellZoomInModel(parent, wp, logger, versionManager);
...
CModelBase *IModelLifetimeFacade::LoadMain(const CModelBase::IModelLoadSave &modelLoadSave, const QString &strFileName,
                                           CAnalysisLogger &logger, bool bSilent) {
...
CModelBase *IModelLifetimeFacade::LoadChild(const CModelBase::IModelLoadSave &modelLoadSave, const QString &strFileName,
                                            CAnalysisLogger &logger) {
  return privateModelIO::LoadModel(modelLoadSave, strFileName, logger, false);
}

bool IModelLifetimeFacade::SaveMain(const CModelBase::IModelLoadSave &modelLoadSave, CModelBase &model,
                                    const QString &strFileName, bool bSwitch) {
  return privateModelIO::SaveModel(modelLoadSave, model, strFileName, bSwitch);
}

void IModelLifetimeFacade::Close(CModelBase *model) { model->CloseModel(); }

void IModelLifetimeFacade::Delete(CModelBase *model) { model->destroy(); }
