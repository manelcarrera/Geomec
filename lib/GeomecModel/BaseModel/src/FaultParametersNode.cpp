...
: CStorageNode(stage.Name(), fault.Model()),
  m_fault(fault),
  m_stage(stage),
  m_pBranchStage(0),
  m_bCohesionSameAsPrevious(!stage.Initial()),
  m_bFrictionSameAsPrevious(!stage.Initial()),
  m_bDStiffSameAsPrevious(!stage.Initial()),
  m_bCohesionExtrapolated(true),
  m_bFrictionExtrapolated(true),
  m_Cohesion(10),
  m_FrictionAngle(15),
  m_dUserDStiff1(DEF_USER_DSTIF1),
  m_dUserDStiff2(DEF_USER_DSTIF2),
  m_dFractureDStiff1(DEF_FRACTURE_DSTIF1),
  m_dFractureDStiff2(DEF_FRACTURE_DSTIF2),
...
{
  if(CohesionSameAsPrevious() &&
     FrictionSameAsPrevious() &&
...
unsigned int CFaultParametersNode::TypeId() const
{
  return IDT_VALUETYPE_FAULTPARAMETERS;
}

bool CFaultParametersNode::Empty() const
{
  return false;
}

long CFaultParametersNode::SavedItems() const
{
  return 1;
}
...
bool CFaultParametersNode::CohesionSameAsPrevious() const
{
  return !m_stage.Initial() && m_bCohesionSameAsPrevious;
}

bool CFaultParametersNode::FrictionSameAsPrevious() const
{
  return !m_stage.Initial() && m_bFrictionSameAsPrevious;
}

bool CFaultParametersNode::DStiffSameAsPrevious() const
{
  return !m_stage.Initial() && m_bDStiffSameAsPrevious;
}

void CFaultParametersNode::CohesionSameAsPrevious(bool b)
{
  m_bCohesionSameAsPrevious = b;
}

void CFaultParametersNode::FrictionSameAsPrevious(bool b)
{
  m_bFrictionSameAsPrevious = b;
}

void CFaultParametersNode::DStiffSameAsPrevious(bool b)
{
  m_bDStiffSameAsPrevious = b;
}

const CCohesionQuantity& CFaultParametersNode::Cohesion() const
{
  return m_Cohesion;
}

const CAngleQuantity& CFaultParametersNode::FrictionAngle() const
{
...
void CFaultParametersNode::Cohesion(double dCohesion)
{
  m_Cohesion = dCohesion;
}

void CFaultParametersNode::FrictionAngle(double dFrictionAngle)
{
  m_FrictionAngle = dFrictionAngle;
}
...
bool CFaultParametersNode::DistributedFriction() const
{
  return (m_pValueTypeFriction != 0);
}

bool CFaultParametersNode::CohesionExtrapolated() const
{
  return m_bCohesionExtrapolated;
}

bool CFaultParametersNode::FrictionExtrapolated() const
{
  return m_bFrictionExtrapolated;
}

void CFaultParametersNode::CohesionExtrapolated(bool b)
{
  m_bCohesionExtrapolated = b;
}

void CFaultParametersNode::FrictionExtrapolated(bool b)
{
...
const CDepletionStage& CFaultParametersNode::Stage() const
{
  return m_stage;
}

const CHorizonBase& CFaultParametersNode::Fault() const
{
  return m_fault;
}
