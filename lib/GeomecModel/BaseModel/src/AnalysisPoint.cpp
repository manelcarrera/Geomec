...
CAnalysisPoint::CAnalysisPoint(CFemAppModel &model) : CColorNode(model) {}
...
CAnalysisPoint::CAnalysisPoint(const CAnalysisPoint &rhs) : CColorNode(rhs), m_point(rhs.m_point) {}
...
long CAnalysisPoint::SavedItems() const { return 1 + CColorNode::SavedItems(); }

unsigned int CAnalysisPoint::IconId() const { return IDI_ANALYSIS_POINT; }

int CAnalysisPoint::DisplayListSize() const { return 1; }
...
const geo::IPoint &CAnalysisPoint::Point() const { return m_point; }

void CAnalysisPoint::Point(const geo::IPoint &point) { m_point = point; }

unsigned int CAnalysisPoint::TypeId() const { return IDT_TREE_ANALYSIS_POINTS; }

QString CAnalysisPoint::TypeName() const { return getStringTableEntry(IDS_TREE_ANALYSIS_POINTS); }
...
CAnalysisPointEntry::CAnalysisPointEntry(CModelBase &model)
    : CStorageNodeEntry<CAnalysisPoint>(MD_BASE_ANALYSIS_POINT, IDI_ANALYSIS_POINT_ENTRY, IDS_TREE_ANALYSIS_POINT,
                                        model) {}
