...
: m_modelBase(dynamic_cast <CModelBase*> (femAppModel))
, m_faultPressures(collectFaultPressures(m_modelBase))
{
}
...
std::vector <QString>
  CSetGlobalFaultBehaviour::getUnitNames(const CUnitNode& unitNode) const
{
...
bool CSetGlobalFaultBehaviour::getModeType(CFaultPressure::TModeType& modeType)
  const
{
  bool firstTime = true;
...
bool CSetGlobalFaultBehaviour::getValues(std::vector <double>& values,
...
void CSetGlobalFaultBehaviour::setGlobalFaultBehaviour(
  const std::vector <double>& values, const CUnitNode& unitNode,
...
bool CSetGlobalFaultBehaviour::isLocked(const CFaultPressure* faultPressure)
  const
{
...
CSetGlobalFaultBehaviour::TFaultPressures
  CSetGlobalFaultBehaviour::collectFaultPressures(CModelBase* modelBase)
{
