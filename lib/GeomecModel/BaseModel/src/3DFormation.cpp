...
//////////////////////////////////////////////////////////////////////
C3DFormation::C3DFormation(const C3DFormation &rhs) : CFormationBase(rhs) {}

C3DFormation::C3DFormation(CFemAppModel &model) : CFormationBase(model) {}

C3DFormation::C3DFormation(const QString &strName, CModelBase &model) : CFormationBase(strName, model) {}

int C3DFormation::VolumeSize() const { return ElementSetSize(); }
...
const IFormationElementSet &Casing3DFormation::ElementSet(int nIndex) const { return m_volume; }
