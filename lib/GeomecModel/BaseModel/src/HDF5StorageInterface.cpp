...
CHDF5StorageInterface::CHDF5StorageInterface(CHDF5File &h5file, int modelIndex, int maxStages, int maxColumns)
    : IStorageInterface(), m_h5file(&h5file), m_modelIndex(modelIndex), m_maxStages(maxStages),
      m_maxColumns(maxColumns), m_directory(0), m_fallbackStorage(0), m_useFallback(5, false), m_invalid(5, false) {}

CHDF5StorageInterface::~CHDF5StorageInterface() { delete m_fallbackStorage; }

const char *CHDF5StorageInterface::Directory() const { return m_directory; }
...
bool CHDF5StorageInterface::OwnedByGuard() const { return m_owned_by_guard; }

void CHDF5StorageInterface::OwnedByGuard(bool bOwnedByGuard) { m_owned_by_guard = bOwnedByGuard; }
...
void CHDF5StorageInterface::AttachHDF5File(CHDF5File *h5file) { m_h5file = h5file; }
