...
public:
  ...
  {
  public:
    IVectorComponent(unsigned int uComponentName, IVectorResult& parent, enum VECTOR_COMPONENT component, const CDepletionStage& stage, const CAnalysisType& antype, int nRegister);
    IVectorComponent(IVectorResult& parent, const CDepletionStage& stage, const CAnalysisType& antype, int nRegister);
    virtual void MapValueElement(const geo::IElement& elm, TVectorVec& vectors, TMapType map_type, UNIT unit = CQuantity::SI_UNIT, geo::IParallelInitializationCallback *cb = 0) const = 0;
    virtual void MapValueElementCB(const geo::IElement& elm, TVectorVec& vectors, TMapType map_type, UNIT unit = CQuantity::SI_UNIT, geo::IParallelInitializationCallback *cb = 0) const = 0;
  };
  ...
  class CVectorComponent : public IVectorComponent
    ...
    virtual IValueDomainScalar::TValue ValuePoint(const geo::IPoint& pt, const UNIT unit = CQuantity::SI_UNIT, geo::IParallelInitializationCallback *callback = 0) const;
    virtual void MapValueElement(const geo::IElement& elm, IValueDomainScalar::TValueVec& values, TMapType map_type, UNIT unit = CQuantity::SI_UNIT, geo::IParallelInitializationCallback *callback = 0) const;
		
    virtual void MapTensorElement(const geo::IElement& elm, std::vector<CTensor> & values, TMapType map_type, geo::IParallelInitializationCallback *callback = 0) const;
    virtual void MapValueElement(const geo::IElement& elm, TVectorVec& vectors, TMapType map_type, UNIT unit = CQuantity::SI_UNIT, geo::IParallelInitializationCallback *callback = 0) const;
    virtual void MapValueElementCB(const geo::IElement& elm, TVectorVec& vectors, TMapType map_type, UNIT unit = CQuantity::SI_UNIT, geo::IParallelInitializationCallback *callback = 0) const;
  ...
  virtual const geo::IVector& VectorPoint(const geo::IPoint& point, const IResultComponent& component, geo::IParallelInitializationCallback *callback = 0) const = 0;
	virtual const geo::IVector& VectorElement(const geo::IElement& element, 
										      int nNodeIndex, 
											  TMapType map_type,
                        const IResultComponent& component, geo::IParallelInitializationCallback *callback = 0) const = 0;
...
public:
  ...
  virtual const geo::IVector& VectorPoint(const geo::IPoint& point, const IResultComponent& component, geo::IParallelInitializationCallback *callback = 0) const;
	virtual const geo::IVector& VectorElement(const geo::IElement& element, 
										      int nNodeIndex, 
											  TMapType map_type,
                        const IResultComponent& component, geo::IParallelInitializationCallback *callback = 0) const;
