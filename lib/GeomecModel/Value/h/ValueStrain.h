...
class TStrain: public CValueStrainTemp<IDT_VALUETYPE_STRAIN, IDS_ET_STRAIN, IDI_VALUETYPE_STRAIN, IDS_VALUENAME_STRAIN>
{
public:
  TStrain(IPointSet& point_set, const QString& strName)
  : CValueStrainTemp<IDT_VALUETYPE_STRAIN, IDS_ET_STRAIN, IDI_VALUETYPE_STRAIN, IDS_VALUENAME_STRAIN>(point_set, strName, Units::LengthUnit)
  {
  }
