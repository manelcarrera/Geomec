...
public:
  ...
  public:
    CMaterialResultComponent(const QString &strName, const CDepletionStage &stage, CMaterialResult &parent,
  ...
  public:
    CBoundaryMaterialResultComponent(const QString &strName, const CDepletionStage &stage, CMaterialResult &parent,
                                     const CAnalysisType &antype, int nRegister, bool showRad);
