...
public:
  ...
  public:
    ...
    {
    public:
      CLengthChangeComponent(unsigned int uName,
                                      CPrincipalLengthChangeComposite& parent,
                                      const CDepletionStage& stage,
                                      const CAnalysisType& antype,
                                      int nRegister);
      CLengthChangeComponent(const QString& sName,
                                      CPrincipalLengthChangeComposite& parent,
                                      const CDepletionStage& stage,
                                      const CAnalysisType& antype,
                                      int nRegister);

      virtual geo::CValue ValuePoint(const geo::IPoint& pt, const IValueComponentBase::UNIT unit = IQuantityDouble::SI_UNIT, geo::IParallelInitializationCallback *cb = 0) const;
      virtual void MapValueElement(const geo::IElement& elm, IValueDomainScalar::TValueVec& values, IResultComponent::TMapType map_type, IValueComponentBase::UNIT unit = CQuantity::SI_UNIT, geo::IParallelInitializationCallback *cb = 0) const;
  ...
  private:
	...
	{
	public:
		enum INVARIANT_TYPE { INV_I1 = 0, INV_I2, INV_I3, INV_VONMIS, INV_TRESCA, INV_MEAN, INV_VONMIS_GRADIENT, INV_MEAN_GRADIENT };
    ...
    public:
      typedef enum
      {
        ...
        TC_RADIAL_MAX = 2
			...
			CWellPathStressComponent(unsigned int uName,
  ...
  public:
    ...
    {
    public:
      CVerticalGradientComponent(unsigned int uName,
