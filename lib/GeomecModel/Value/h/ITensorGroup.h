...
public:
  ...
  public:
    ...
    virtual bool IsTensorVector() const { return m_direction != CYLINDRICAL; }
...
protected:
  ...
  void PrincipalDirections(geo::CVector &vcmax, double &max_length, geo::CVector &vcmed, double &med_length,
