...
public:
  ...
  virtual void ExportExcel(const QString& sFileName,
                           const IExportFormat::TDataVec& vcData,
                           const IExportFormat::CExportArg arg,
                           bool bAppend = false) const = 0;

  virtual void ExportASCII(const QString& sFileName,
                           const IExportFormat::TDataVec& vcData,
                           const IExportFormat::CExportArg arg,
                           bool bAppend = false) const = 0;

  virtual void Export2LAS(const QString& sFileName,
                          const IExportFormat::TDataVec& vcData,
...
class CWellPathExporter : public IResultExporter
{
public:
...
: IResultExporter(model),
  m_vcWellpath(vcWellpath)
{
}

template <class WELLPATH>
void CWellPathExporter<WELLPATH>::ExportExcel(const QString& sFileName,
                                              const IExportFormat::TDataVec& vcData,
                                              const IExportFormat::CExportArg arg,
                                              bool bAppend) const
{
...
template <class WELLPATH>
void CWellPathExporter<WELLPATH>::ExportASCII(const QString& sFileName,
                                              const IExportFormat::TDataVec& vcData,
                                              const IExportFormat::CExportArg arg,
                                              bool bAppend) const
{
...
template <class WELLPATH>
void CWellPathExporter<WELLPATH>::Export2LAS(const QString& sFileName,
                                             const IExportFormat::TDataVec& vcData,
                                             const IExportFormat::CExportArg arg) const
{
...
private:
  template <class T>
  const IResultExporter* CreateTypedExporter(const std::vector<const T*>& vcSelection);
  template <class T>
  std::vector<const T*> MakeVector(const CTypedSelection<T>& selection);
...
template<class T>
std::vector<const T*> CExporterFactory::MakeVector(const CTypedSelection<T>& selection)
{
