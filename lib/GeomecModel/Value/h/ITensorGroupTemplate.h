...
public:
  CElementWellPoint(const geo::IElement &element, const geo::IPoint &wellpoint)
      : geo::CElementPoint(element, wellpoint), m_wellpoint(wellpoint) {}

  const geo::IPoint &WellPoint() const { return m_wellpoint; }
...
template <class T> class _ResultCache : public _ITensorResultCache {
public:
  ...
  bool m_bChange;
  _ResultCache()
      : m_bPrincipalValid(false), m_bCylindricalValid(false), m_element(0), m_map_type(CValueType::MT_NONE),
        m_bChange(false) {}
};
...
template <class TENSOR_TYPE> class ITensorGroupTemplate : public ITensorGroup {
public:
...
public:
  _ResultCache<TENSOR_TYPE> &GetCache(const IResultComponent &component,
                                      geo::IParallelInitializationCallback *callback) const;

private:
  void BuildCache() const;

  const TENSOR_TYPE &TensorAtPoint(const geo::IPoint &point, const IResultComponent &component,
                                   geo::IParallelInitializationCallback *cb) const;

  const TTensorValueVec &TensorAtElement(const geo::IElement &element, TMapType map_type,
                                         const IResultComponent &component,
                                         geo::IParallelInitializationCallback *cb) const;

  CTensor RotatedTensor(const ITensor &tensor, const geo::IVector &dir) const;
  CTensor OrientedTensor(const geo::IPoint &point, const geo::IVector &dir, const IResultComponent &component,
                         geo::IParallelInitializationCallback *cb = 0) const;
  CTensor OrientedTensor(const geo::IElement &element, int nNodeIndex, TMapType map_type, const geo::IVector &dir,
                         const IResultComponent &component, geo::IParallelInitializationCallback *cb = 0) const;
  CTensor WellPathOrientedTensor(const geo::IPoint &point, const IResultComponent &component,
                                 geo::IParallelInitializationCallback *cb = 0) const;
...
public:
  ...
  const TENSOR_TYPE &TensorAtPoint(const geo::IPoint &point, const IResultComponent &component,
                                   const CDepletionStage &stage, const CAnalysisType &antype, bool bChange,
                                   geo::IParallelInitializationCallback *cb = 0) const;

  const TTensorValueVec &TensorAtElement(const geo::IElement &element, TMapType map_type,
                                         const IResultComponent &component, const CDepletionStage &stage,
                                         const CAnalysisType &antype, bool bChange,
                                         geo::IParallelInitializationCallback *cb = 0) const;

  virtual const TPrincipal &VectorPoint(const geo::IPoint &point, CVectorComposite::PRINCIPAL_DIRECTION direction,
                                        const IResultComponent &component,
                                        geo::IParallelInitializationCallback *cb = 0) const;

  virtual const TPrincipal &VectorElement(const geo::IElement &element, CVectorComposite::PRINCIPAL_DIRECTION direction,
                                          int nNodeIndex, TMapType map_type, const IResultComponent &component,
                                          geo::IParallelInitializationCallback *cb = 0) const;

  virtual void ClearCache();
  virtual void OnNeighbourModified(const CGraphNode &node, enum ModifiedHint uHint);

  geo::CValue WellPathAxialValuePoint(const geo::IPoint &point, const IResultComponent &component,
                                      geo::IParallelInitializationCallback *cb = 0) const;
  geo::CValue WellPathRadialMaxValuePoint(const geo::IPoint &point, const IResultComponent &component,
                                          geo::IParallelInitializationCallback *cb = 0) const;
  geo::CValue WellPathRadialMinValuePoint(const geo::IPoint &point, const IResultComponent &component,
                                          geo::IParallelInitializationCallback *cb = 0) const;

  IValueDomainScalar::TValueVec AxialValueElement(const geo::IElement &element, TMapType map_type,
                                                  const IResultComponent &component, const geo::IVector &dir,
                                                  geo::IParallelInitializationCallback *cb = 0) const;
  IValueDomainScalar::TValueVec RadialMaxValueElement(const geo::IElement &element, TMapType map_type,
                                                      const IResultComponent &component, const geo::IVector &dir,
                                                      geo::IParallelInitializationCallback *cb = 0) const;
  IValueDomainScalar::TValueVec RadialMinValueElement(const geo::IElement &element, TMapType map_type,
                                                      const IResultComponent &component, const geo::IVector &dir,
                                                      geo::IParallelInitializationCallback *cb = 0) const;

  IValueDomainScalar::TValueVec ShearValueInPlaneElement(const geo::IElement &element, TMapType map_type,
                                                         const IResultComponent &component, const geo::IVector &dir,
                                                         geo::IParallelInitializationCallback *cb = 0) const;

  IValueDomainScalar::TValueVec ShearDipAngleInPlaneElement(const geo::IElement &element, TMapType map_type,
                                                            const IResultComponent &component, const geo::IVector &dir,
                                                            geo::IParallelInitializationCallback *cb = 0) const;

  IValueDomainScalar::TValueVec WellPathAxialValueElement(const geo::IElement &element, TMapType map_type,
                                                          const IResultComponent &component,
                                                          geo::IParallelInitializationCallback *cb = 0) const;
  IValueDomainScalar::TValueVec WellPathRadialMaxValueElement(const geo::IElement &element, TMapType map_type,
                                                              const IResultComponent &component,
                                                              geo::IParallelInitializationCallback *cb = 0) const;
  IValueDomainScalar::TValueVec WellPathRadialMinValueElement(const geo::IElement &element, TMapType map_type,
                                                              const IResultComponent &component,
                                                              geo::IParallelInitializationCallback *cb = 0) const;
...
private:
  ...
  const TPrincipal &PrincipalVectorPoint(const geo::IPoint &point, CVectorComposite::PRINCIPAL_DIRECTION direction,
                                         const IResultComponent &component,
                                         geo::IParallelInitializationCallback *cb = 0) const;

  const TPrincipal &PrincipalVectorElement(const geo::IElement &element,
                                           CVectorComposite::PRINCIPAL_DIRECTION direction, int nNodeIndex,
                                           TMapType map_type, const IResultComponent &component,
                                           geo::IParallelInitializationCallback *cb = 0) const;

  const TPrincipal &CylindricalVectorPoint(const geo::IPoint &point, CVectorComposite::PRINCIPAL_DIRECTION direction,
                                           const IResultComponent &component,
                                           geo::IParallelInitializationCallback *cb = 0) const;
...
ITensorGroupTemplate<TENSOR_TYPE>::ITensorGroupTemplate(unsigned int uResultName, TValueSetFunction function,
                                                        CResultGroup &group)
    : ITensorGroup(uResultName, group), m_function(function) {}

template <class TENSOR_TYPE>
ITensorGroupTemplate<TENSOR_TYPE>::ITensorGroupTemplate(const QString &sResultName, TValueSetFunction function,
                                                        CResultGroup &group)
    : ITensorGroup(sResultName, group), m_function(function) {}

template <class TENSOR_TYPE>
const TENSOR_TYPE &
ITensorGroupTemplate<TENSOR_TYPE>::TensorAtPoint(const geo::IPoint &point, const IResultComponent &component,
...
*/
template <class TENSOR_TYPE> void ITensorGroupTemplate<TENSOR_TYPE>::BuildCache() const {
  assert(m_cache.size() == 0);
  CModelBase &model = (CModelBase &)Model();
  for (int i = 0; i < model.ResultRegisterSize(); i++) {
    TCacheMap cache_map;
    cache_map.insert(
        typename TCacheMap::value_type(CAnalysisType(CAnalysisType::AT_LINEAR),
                                       TCache(model.ResultRegister(i).DepletionStageEntry().EntryNodes().size())));
    cache_map.insert(
        typename TCacheMap::value_type(CAnalysisType(CAnalysisType::AT_NONLIN),
                                       TCache(model.ResultRegister(i).DepletionStageEntry().EntryNodes().size())));
    cache_map.insert(
        typename TCacheMap::value_type(CAnalysisType(CAnalysisType::AT_HEAT),
                                       TCache(model.ResultRegister(i).DepletionStageEntry().EntryNodes().size())));
    cache_map.insert(
        typename TCacheMap::value_type(CAnalysisType(CAnalysisType::AT_MIXTURE),
                                       TCache(model.ResultRegister(i).DepletionStageEntry().EntryNodes().size())));
    cache_map.insert(
        typename TCacheMap::value_type(CAnalysisType(CAnalysisType::AT_MIXTURE_CONTAINMENT),
                                       TCache(model.ResultRegister(i).DepletionStageEntry().EntryNodes().size())));
...
*/
template <class T> void ITensorGroupTemplate<T>::ClearCache() { m_cache.clear(); }

template <class T> void ITensorGroupTemplate<T>::OnNeighbourModified(const CGraphNode &node, enum ModifiedHint uHint) {
  ClearCache();
  ITensorGroup::OnNeighbourModified(node, uHint);
}

template <class TENSOR_TYPE>
const ITensor &ITensorGroupTemplate<TENSOR_TYPE>::TensorPoint(const geo::IPoint &point,
                                                              const IResultComponent &component,
                                                              geo::IParallelInitializationCallback *cb) const {
...
template <class TENSOR_TYPE>
const ITensor &ITensorGroupTemplate<TENSOR_TYPE>::TensorElement(const geo::IElement &element, int nNodeIndex,
                                                                TMapType map_type, const IResultComponent &component,
                                                                geo::IParallelInitializationCallback *cb) const {
...
template <class TENSOR_TYPE>
const typename ITensorGroupTemplate<TENSOR_TYPE>::TTensorValueVec &ITensorGroupTemplate<TENSOR_TYPE>::TensorAtElement(
    const geo::IElement &element, TMapType map_type, const IResultComponent &component, const CDepletionStage &stage,
    const CAnalysisType &antype, bool bChange, geo::IParallelInitializationCallback *cb) const {
  ...
  (component.ResultRegister().*m_function)(stage, antype, bChange)
...
ITensorGroupTemplate<TENSOR_TYPE>::TensorAtElement(const geo::IElement &element, TMapType map_type,
                                                   const IResultComponent &component,
                                                   geo::IParallelInitializationCallback *cb) const {
...
template <class TENSOR_TYPE>
_ITensorResultCache &
ITensorGroupTemplate<TENSOR_TYPE>::CParallelInitializationCallback::GetCache(const ITensorGroup * /*caller*/,
...
template <class TENSOR_TYPE>
_ResultCache<TENSOR_TYPE> &
ITensorGroupTemplate<TENSOR_TYPE>::GetCache(const IResultComponent &component,
                                            geo::IParallelInitializationCallback *callback) const {
...
template <class TENSOR_TYPE>
const typename ITensorGroupTemplate<TENSOR_TYPE>::TPrincipal &ITensorGroupTemplate<TENSOR_TYPE>::PrincipalVectorPoint(
    const geo::IPoint &point, CVectorComposite::PRINCIPAL_DIRECTION direction, const IResultComponent &component,
    geo::IParallelInitializationCallback *cb) const {
  assert(!point.Empty());
  // Is the point in the cache?
  _ResultCache<TENSOR_TYPE> &cache = GetCache(component, cb);
  ...
  for (int i = 0; i < 3; i++) {
    if (cache.m_derived[i].size() != 1)
      cache.m_derived[i].resize(1);
  }
  PrincipalDirections(
      cache.m_derived[CVectorComposite::PD_MAX][0].first, cache.m_derived[CVectorComposite::PD_MAX][0].second,
      cache.m_derived[CVectorComposite::PD_MED][0].first, cache.m_derived[CVectorComposite::PD_MED][0].second,
      cache.m_derived[CVectorComposite::PD_MIN][0].first, cache.m_derived[CVectorComposite::PD_MIN][0].second, tensor);
...
template <class TENSOR_TYPE>
const typename ITensorGroupTemplate<TENSOR_TYPE>::TPrincipal &ITensorGroupTemplate<TENSOR_TYPE>::PrincipalVectorElement(
    const geo::IElement &element, CVectorComposite::PRINCIPAL_DIRECTION direction, int nNodeIndex, TMapType map_type,
  ...
  int i;
  for (i = 0; i < 3; i++) {
    if (cache.m_derived[i].size() != element.NrOfPoints())
      cache.m_derived[i].resize(element.NrOfPoints());
  }
  for (i = 0; i < element.NrOfPoints(); i++) {
    const ITensor &tensor = TensorElement(element, i, map_type, component, cb);
    PrincipalDirections(
        cache.m_derived[CVectorComposite::PD_MAX][i].first, cache.m_derived[CVectorComposite::PD_MAX][i].second,
        cache.m_derived[CVectorComposite::PD_MED][i].first, cache.m_derived[CVectorComposite::PD_MED][i].second,
        cache.m_derived[CVectorComposite::PD_MIN][i].first, cache.m_derived[CVectorComposite::PD_MIN][i].second,
        tensor);
  }
  cache.m_bPrincipalValid = true;
...
template <class TENSOR_TYPE>
const typename ITensorGroupTemplate<TENSOR_TYPE>::TPrincipal &ITensorGroupTemplate<TENSOR_TYPE>::CylindricalVectorPoint(
    const geo::IPoint &point, CVectorComposite::PRINCIPAL_DIRECTION direction, const IResultComponent &component,
    geo::IParallelInitializationCallback *cb) const {
  assert(!point.Empty());
  // Is the point in the cache?
  ...
  const ITensor &tensor = TensorPoint(point, component, cb);
  if (cache.m_derived[direction].size() != 1)
    cache.m_derived[direction].resize(1);
...
ITensorGroupTemplate<TENSOR_TYPE>::CylindricalVectorElement(const geo::IElement &element,
                                                            ...
                                                            int nNodeIndex, TMapType map_type,
                                                            const IResultComponent &component,
                                                            geo::IParallelInitializationCallback *cb) const {
  // Is the element in the cache?
  _ResultCache<TENSOR_TYPE> &cache = GetCache(component, cb);
  ...
  if (cache.m_derived[direction].size() != element.NrOfPoints())
    cache.m_derived[direction].resize(element.NrOfPoints());
...
template <class TENSOR_TYPE>
const typename ITensorGroupTemplate<TENSOR_TYPE>::TPrincipal &ITensorGroupTemplate<TENSOR_TYPE>::VectorPoint(
    const geo::IPoint &point, CVectorComposite::PRINCIPAL_DIRECTION direction, const IResultComponent &component,
    geo::IParallelInitializationCallback *cb) const {
...
template <class TENSOR_TYPE>
const typename ITensorGroupTemplate<TENSOR_TYPE>::TPrincipal &ITensorGroupTemplate<TENSOR_TYPE>::VectorElement(
    const geo::IElement &element, CVectorComposite::PRINCIPAL_DIRECTION direction, int nNodeIndex, TMapType map_type,
    const IResultComponent &component, geo::IParallelInitializationCallback *cb) const {
  if (direction == CVectorComposite::CYLINDRICAL)
...
template <class TENSOR_TYPE>
CTensor ITensorGroupTemplate<TENSOR_TYPE>::OrientedTensor(const geo::IPoint &point, const geo::IVector &dir,
                                                          const IResultComponent &component,
                                                          geo::IParallelInitializationCallback *cb) const {
...
template <class TENSOR_TYPE>
CTensor ITensorGroupTemplate<TENSOR_TYPE>::OrientedTensor(const geo::IElement &element, int nNodeIndex,
                                                          TMapType map_type, const geo::IVector &dir,
                                                          const IResultComponent &component,
                                                          geo::IParallelInitializationCallback *cb) const {
...
template <class TENSOR_TYPE>
CTensor ITensorGroupTemplate<TENSOR_TYPE>::WellPathOrientedTensor(const geo::IPoint &point,
                                                                  const IResultComponent &component,
                                                                  geo::IParallelInitializationCallback *cb) const {
  ...
  if ((!pWellPoint || pWellPoint->Empty()) && (!pNewWellPoint || pNewWellPoint->Empty()) // waij TFS 74145
  )
    return CTensor();
...
template <class TENSOR_TYPE>
geo::CValue ITensorGroupTemplate<TENSOR_TYPE>::WellPathAxialValuePoint(const geo::IPoint &point,
                                                                       const IResultComponent &component,
                                                                       geo::IParallelInitializationCallback *cb) const {
...
template <class TENSOR_TYPE>
geo::CValue ITensorGroupTemplate<TENSOR_TYPE>::WellPathRadialMaxValuePoint(
    const geo::IPoint &point, const IResultComponent &component, geo::IParallelInitializationCallback *cb) const {
  CTensor rotated_tensor = WellPathOrientedTensor(point, component, cb);
...
template <class TENSOR_TYPE>
geo::CValue ITensorGroupTemplate<TENSOR_TYPE>::WellPathRadialMinValuePoint(
    const geo::IPoint &point, const IResultComponent &component, geo::IParallelInitializationCallback *cb) const {
  CTensor rotated_tensor = WellPathOrientedTensor(point, component, cb);
...
ITensorGroupTemplate<TENSOR_TYPE>::AxialValueElement(const geo::IElement &element, TMapType map_type,
                                                     const IResultComponent &component, const geo::IVector &dir,
                                                     geo::IParallelInitializationCallback *cb) const {
...
template <class TENSOR_TYPE>
IValueDomainScalar::TValueVec
ITensorGroupTemplate<TENSOR_TYPE>::RadialMaxValueElement(const geo::IElement &element, TMapType map_type,
                                                         const IResultComponent &component, const geo::IVector &dir,
                                                         geo::IParallelInitializationCallback *cb) const {
  int np = element.NrOfNodes();
  if (!np)
...
template <class TENSOR_TYPE>
IValueDomainScalar::TValueVec
ITensorGroupTemplate<TENSOR_TYPE>::RadialMinValueElement(const geo::IElement &element, TMapType map_type,
                                                         const IResultComponent &component, const geo::IVector &dir,
                                                         geo::IParallelInitializationCallback *cb) const {
  int np = element.NrOfNodes();
  if (!np)
...
template <class TENSOR_TYPE>
IValueDomainScalar::TValueVec
ITensorGroupTemplate<TENSOR_TYPE>::ShearValueInPlaneElement(const geo::IElement &element, TMapType map_type,
                                                            const IResultComponent &component, const geo::IVector &dir,
                                                            geo::IParallelInitializationCallback *cb) const {
  int np = element.NrOfNodes();
  if (!np)
...
template <class TENSOR_TYPE>
IValueDomainScalar::TValueVec ITensorGroupTemplate<TENSOR_TYPE>::ShearDipAngleInPlaneElement(
    const geo::IElement &element, TMapType map_type, const IResultComponent &component, const geo::IVector &dir,
    geo::IParallelInitializationCallback *cb) const {
  int np = element.NrOfNodes();
  if (!np)
    np = element.NrOfPoints();
...
template <class TENSOR_TYPE>
IValueDomainScalar::TValueVec
ITensorGroupTemplate<TENSOR_TYPE>::WellPathAxialValueElement(const geo::IElement &element, TMapType map_type,
                                                             const IResultComponent &component,
                                                             geo::IParallelInitializationCallback *cb) const {
...
template <class TENSOR_TYPE>
IValueDomainScalar::TValueVec
ITensorGroupTemplate<TENSOR_TYPE>::WellPathRadialMaxValueElement(const geo::IElement &element, TMapType map_type,
                                                                 const IResultComponent &component,
                                                                 geo::IParallelInitializationCallback *cb) const {
  IValueDomainScalar::TValueVec vcVal(element.NrOfNodes());
...
template <class TENSOR_TYPE>
IValueDomainScalar::TValueVec
ITensorGroupTemplate<TENSOR_TYPE>::WellPathRadialMinValueElement(const geo::IElement &element, TMapType map_type,
                                                                 const IResultComponent &component,
                                                                 geo::IParallelInitializationCallback *cb) const {
  IValueDomainScalar::TValueVec vcVal(element.NrOfNodes());
