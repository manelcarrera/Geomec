...
public:
  ...
  static IRpnMaterialParameterProxy *CreateMaterialParameterProxy(const CModelBase &model, const std::string &name,
...
private:
  ...
  CFillMaterialParameterProxies &operator=(const CFillMaterialParameterProxies &rhs);

  static std::vector<IRpnMaterialParameterProxy *> fillMaterialParameterProxies(CMeshBase &mesh,
                                                                                rpn::CRpnStack &rpnStack);
