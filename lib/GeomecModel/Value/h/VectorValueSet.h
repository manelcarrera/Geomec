...
public:
  CVectorValueSet(const CResultRegister &parent, const CDepletionStage &stage, const CAnalysisType &antype, int nStart,
                  bool bShear, bool bInterface, bool bChange);
  ...
  virtual void MapValueElement(const geo::IElement &elm, TValueVec &values, TMapType map_type,
