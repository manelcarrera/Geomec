...
*/
  ...
  class CScalarResultComponent : public IScalarResultComponent
  {
      ...
      typedef std::map<std::pair<CAnalysisType::TAnalysisType, const CDepletionStage*>, geo::CValue> TDisplacementValueMap;
  ...
  public:
    ...
    , geo::CValue &ShTot_SvTot
      ...
      void PorePressureInput(IValueDomainScalar::TValueVec& values, const geo::IElement& element, const CDepletionStage& stage) const;
      void FractureMatrixPressure(IValueDomainScalar::TValueVec& values, const geo::IElement& element, const CDepletionStage& stage) const;
      void Temperature(IValueDomainScalar::TValueVec& values, const geo::IElement& element, const CDepletionStage& stage) const;
      void TemperatureInput(IValueDomainScalar::TValueVec& values, const geo::IElement& element, const CDepletionStage& stage) const;
      void Consolidation(IValueDomainScalar::TValueVec& values, const geo::IElement& element, const CDepletionStage& stage) const;
      void StressRatios(IValueDomainScalar::TValueVec& values, const geo::IElement& element, const CDepletionStage& stage) const; // wjrx mantis 2870
      void Porosity(IValueDomainScalar::TValueVec& values, const geo::IElement& element, const CDepletionStage& stage, geo::IParallelInitializationCallback *cb) const;
      void GammaValues(IValueDomainScalar::TValueVec& values, const geo::IElement& element, TResultType type, UNIT unit, geo::IParallelInitializationCallback *cb) const;
      void Thickness(IValueDomainScalar::TValueVec& values, const geo::IElement& element, const CDepletionStage& stage, geo::IParallelInitializationCallback *cb) const;
      void ShearCapacityMC(IValueDomainScalar::TValueVec& values, const geo::IElement& element, const CDepletionStage& stage) const;
      void CompactionCapacity(IValueDomainScalar::TValueVec& values, const geo::IElement& element, const CDepletionStage& stage) const;
      void ApertureValues(TResultType result_type, IValueDomainScalar::TValueVec& values, const CDepletionStage& stage, const geo::IElement& mesh_element, UNIT unit) const;
      void permeabilityMultiplierValues(TResultType result_type, IValueDomainScalar::TValueVec& values, const geo::IElement& mesh_element, UNIT unit) const;
  ...
  public:
      ...
      virtual geo::CValue ValuePoint(const geo::IPoint& pt, const IValueComponentBase::UNIT unit = IQuantityDouble::SI_UNIT) const;
      virtual void MapValueElement(const geo::IElement& elm, IValueDomainScalar::TValueVec& values, IResultComponent::TMapType map_type, IValueComponentBase::UNIT unit = CQuantity::SI_UNIT) const;
  ...
  public:
      ...
      virtual geo::CValue ValuePoint(const geo::IPoint& point, const UNIT unit = IQuantityDouble::SI_UNIT, geo::IParallelInitializationCallback *cb = 0) const;
      virtual void MapValueElement(const geo::IElement& elm, IValueDomainScalar::TValueVec& values, TMapType map_type, UNIT unit = IQuantityDouble::SI_UNIT, geo::IParallelInitializationCallback *cb = 0) const;
...
public:
  ...
  const IResult& Aperture(CScalarResult::TResultType resultType) const { assert(m_pAperture.find(resultType) != m_pAperture.end()); return *(m_pAperture.find(resultType)->second); }
...
class CAvgVolumeParallelInitializationCallback : public CResultTree::CScalarResult::CTensorParallelInitializationCallback
{
  friend class CValueMapper;
...
public:
  CAvgVolumeParallelInitializationCallback(CModelBase& model, CResultTree::CScalarResult::CScalarResultComponent& parent);
