...
public:
  ...
  public:
    CMatTensorComponent(CValueType &value_type, const Units::CUnitType &unittype, const Ranges::CRangeType &rangetype,
                        unsigned int uComponentName, unsigned int uComponentIndex, unsigned int uExportLabel,
                        unsigned int typeID);
...
public:
  CMatParamsTensor(unsigned int uExportID, unsigned int uTypeID, unsigned int uIconID, IPointSet &point_set,
