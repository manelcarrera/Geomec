...
IUnitConversion *IUnitConversion::Create(const std::string &sJustAName, const std::string &sUnitName) {
...
CLinearRationalUnitConversion::CLinearRationalUnitConversion(const std::string &sJustAName,
                                                             const double &divisor_factor,
                                                             const double &divisor_addition,
                                                             const double &denominator_factor,
                                                             const double &denominator_addition)
    : IUnitConversion(sJustAName), m_divisor_factor(divisor_factor), m_divisor_addition(divisor_addition),
      m_denominator_factor(denominator_factor), m_denominator_addition(denominator_addition) {}

CLinearRationalUnitConversion *CLinearRationalUnitConversion::Create(const std::string &sJustAName,
...
double CLinearRationalUnitConversion::ConvertToSi(const double &value) const {
  return (m_divisor_factor * value + m_divisor_addition) / (m_denominator_factor * value + m_denominator_addition);
}
