...
void CResultInfo::Result(const IValueComposite *result) { m_result = result; }

const IValueComposite *CResultInfo::Result() const { return m_result; }

void CResultInfo::TimeStep(int ii) { m_timeStep = ii; }

int CResultInfo::TimeStep() const { return m_timeStep; }
...
void CResultInfo::Component(unsigned int ii) { m_component = ii; }

unsigned int CResultInfo::Component() const { return m_component; }

void CResultInfo::Name(const std::string &nm) { m_name = nm; }

const std::string CResultInfo::Name() const { return m_name; }
