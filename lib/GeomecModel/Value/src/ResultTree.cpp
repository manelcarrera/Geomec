...
bool CResultTree::CEffectiveStressResult::OnBuildComponent(const CDepletionStage &stage, const CAnalysisType &antype,
                                                           int /*nRegister*/) const {
  return antype == CAnalysisType::AT_LINEAR || antype == CAnalysisType::AT_MIXTURE ||
...
unsigned int CResultTree::CEffectiveStressResult::ExportNameId() const { return IDS_ET_STRESS; }

unsigned int CResultTree::CEffectiveStressResult::TypeId() const { return IDT_ET_STRESS; }

QString CResultTree::CEffectiveStressResult::TypeName() const { return getStringTableEntry(IDS_ET_STRESS); }

unsigned int CResultTree::CEffectiveStressResult::PostExportNameId() const { return 0; }
...
CResultTree::CTotalStressResult::CSurfaceStressComposite::CSurfaceStressComponent::CSurfaceStressComponent(
    unsigned int uName, CSurfaceStressComposite &parent, TComponent comp, const CDepletionStage &stage,
    const CAnalysisType &antype, int nRegister)
    : IResultComponent(uName, parent, stage, antype, nRegister, int(comp)), m_comp(comp) {}
...
QString
CResultTree::CTotalStressResult::CSurfaceStressComposite::CSurfaceStressComponent::UnitName(const UNIT unit) const {
...
geo::CValue CResultTree::CTotalStressResult::CSurfaceStressComposite::CSurfaceStressComponent::ValuePoint(
    const geo::IPoint & /*pt*/, const UNIT /*unit*/, geo::IParallelInitializationCallback * /*cb*/) const {
  assert(false);
  return geo::CValue();
}

void CResultTree::CTotalStressResult::CSurfaceStressComposite::CSurfaceStressComponent::MapValueElement(
...
bool CResultTree::CTotalStressResult::CSurfaceStressComposite::CSurfaceStressComponent::
    NeedParallelInitializationCallback() const {
  return true;
}

geo::IParallelInitializationCallback *
CResultTree::CTotalStressResult::CSurfaceStressComposite::CSurfaceStressComponent::GetParallelInitializationCallback() {
  ITensorGroup *pTensorGroup = dynamic_cast<ITensorGroup *>(Parent().parent());
  assert(pTensorGroup);
  return pTensorGroup->GetParallelInitializationCallback();
}

bool CResultTree::CTotalStressResult::CSurfaceStressComposite::CSurfaceStressComponent::PrepareMapping(
...
CResultTree::CTotalStressResult::CSurfaceStressComposite::CSurfaceStressComposite(unsigned int uName,
                                                                                  CResultGroup &group,
...
CResultTree::CTotalStressResult::CSurfaceStressComposite::CSurfaceStressComposite(const QString &sName,
                                                                                  CResultGroup &group,
                                                                                  int storageNodeIndex)
    : IResult(sName, group) {
  m_pTensorGroup = static_cast<IStressTensorGroup *>(&group);
...
unsigned int CResultTree::CTotalStressResult::CSurfaceStressComposite::IconId() const { return IDI_RESULT_MAP; }
...
bool CResultTree::CTotalStressResult::CSurfaceStressComposite::CanMap(const COpenGLNode &node,
                                                                      int /*nRegister*/) const {
...
bool CResultTree::CTotalStressResult::CSurfaceStressComposite::ValidName(const std::string &name,
  ...
  return validateName(resultInfo, name, sCombinedName, SurfaceStressComponentList(), "_L|_M|_C|_N");
}

bool CResultTree::CTotalStressResult::CSurfaceStressComposite::OnBuildComponent(const CDepletionStage &stage,
                                                                                const CAnalysisType &antype,
                                                                                int nRegister) const {
  return m_pTensorGroup->OnBuildComponent(stage, antype, nRegister);
}

void CResultTree::CTotalStressResult::CSurfaceStressComposite::BuildComponent(const CDepletionStage &stage,
                                                                              const CAnalysisType &antype,
                                                                              int nRegister) {
  if (OnBuildComponent(stage, antype, nRegister)) {
    ...
    new CSurfaceStressComponent(IDS_RC_SHEAR_PLANE, *this, CSurfaceStressComponent::SSTC_SHEAR_PLANE, stage, antype,
                                nRegister);
    new CSurfaceStressComponent(IDS_RC_SHEAR_DIP_ANGLE, *this, CSurfaceStressComponent::SSTC_SHEAR_DIP_ANGLE, stage,
                                antype, nRegister);
  }
}
...
CResultTree::CTotalStressResult::CTotalStressResult(unsigned int uName, CResultGroup &group, bool bChange)
    : IStressTensorGroup(uName, &CResultRegister::TotalStress, group, bChange), m_pSurfaceStressComposite(0) {
  CreateComposite();
}

CResultTree::CTotalStressResult::CTotalStressResult(const QString &sName, CResultGroup &group, bool bChange)
    : IStressTensorGroup(sName, &CResultRegister::TotalStress, group, bChange), m_pSurfaceStressComposite(0) {
  CreateComposite();
}
...
void CResultTree::CTotalStressResult::CreateComposite() {
  ...
  if (Change()) {
    m_pSurfaceStressComposite =
        new CSurfaceStressComposite(IDS_RG_SURFACESTRESS, *this, RC_TOTAL_STRESS_SURFACESTRESS_CHANGE);
  } else {
    m_pSurfaceStressComposite = new CSurfaceStressComposite(IDS_RG_SURFACESTRESS, *this, RC_TOTAL_STRESS_SURFACESTRESS);
  }
}

bool CResultTree::CTotalStressResult::OnBuildComponent(const CDepletionStage &stage, const CAnalysisType &antype,
                                                       int /*nRegister*/) const {
  return antype == CAnalysisType::AT_LINEAR || antype == CAnalysisType::AT_MIXTURE ||
         antype == CAnalysisType::AT_MIXTURE_CONTAINMENT ||
         (antype == CAnalysisType::AT_NONLIN && stage.OutputType() != CDepletionStage::NONE);
...
unsigned int CResultTree::CTotalStressResult::TypeId() const { return IDT_ET_STRESS; }

unsigned int CResultTree::CTotalStressResult::ExportNameId() const { return IDS_ET_STRESS; }

QString CResultTree::CTotalStressResult::TypeName() const { return getStringTableEntry(IDS_ET_STRESS); }

unsigned int CResultTree::CTotalStressResult::PostExportNameId() const { return 0; }
...
bool CResultTree::CParentStressInputResult::OnBuildComponent(const CDepletionStage &stage, const CAnalysisType &antype,
                                                             int /*nRegister*/) const {
  return antype == CAnalysisType::AT_LINEAR || antype == CAnalysisType::AT_MIXTURE ||
         antype == CAnalysisType::AT_MIXTURE_CONTAINMENT ||
         (antype == CAnalysisType::AT_NONLIN && stage.OutputType() != CDepletionStage::NONE);
...
unsigned int CResultTree::CParentStressInputResult::ExportNameId() const { return IDS_ET_PARENT_STRESS; }

unsigned int CResultTree::CParentStressInputResult::TypeId() const { return IDT_ET_STRESS; }

QString CResultTree::CParentStressInputResult::TypeName() const { return getStringTableEntry(IDS_ET_PARENT_STRESS); }

unsigned int CResultTree::CParentStressInputResult::PostExportNameId() const { return 0; }
...
const ITensor &CResultTree::CParentStressInputResult::TensorPoint(const geo::IPoint &point,
  ...
  if (!cache.m_element && !cache.m_point.Empty() && point == cache.m_point && cache.m_stage == &stage &&
      bChange == cache.m_bChange) {
...
const ITensor &CResultTree::CParentStressInputResult::TensorElement(const geo::IElement &element, int nNodeIndex,
                                                                    TMapType map_type,
                                                                    const IResultComponent &component,
                                                                    geo::IParallelInitializationCallback *cb) const {
  ...
  if ((cache.m_element == &element) && (map_type == cache.m_map_type) && cache.m_point.Empty() &&
      cache.m_stage == &stage && bChange == cache.m_bChange) {
...
void CResultTree::CParentStressInputResult::TensorElementFromParentModel(_ResultCache<CStressTensor> &cache,
  ...
  CStressTensorValueSet initialStress = parentModel.ResultRegister().EffectiveStress(
      parentInitialStage, model->ParentLinearResults(antype) ? CAnalysisType::AT_LINEAR : CAnalysisType::AT_NONLIN,
      false);
...
unsigned int CResultTree::CTotalStrainResult::PreExportNameId() const { return 0; }

unsigned int CResultTree::CTotalStrainResult::ExportNameId() const { return IDS_ET_STRAIN; }

unsigned int CResultTree::CTotalStrainResult::TypeId() const { return IDT_ET_STRAIN; }

QString CResultTree::CTotalStrainResult::TypeName() const { return getStringTableEntry(IDS_ET_STRAIN); }

unsigned int CResultTree::CTotalStrainResult::PostExportNameId() const { return 0; }

unsigned int CResultTree::CTotalStrainResult::ComponentIndex() const { return RC_TOTAL_STRAIN_COMPONENT; }

bool CResultTree::CTotalStrainResult::OnBuildComponent(const CDepletionStage &stage, const CAnalysisType &antype,
                                                       int /*nRegister*/) const {
  return stage.isAfter(stage.Entry().MarkedAsInitialStage()) &&
         (antype == CAnalysisType::AT_LINEAR || antype == CAnalysisType::AT_MIXTURE ||
          antype == CAnalysisType::AT_MIXTURE_CONTAINMENT || antype == CAnalysisType::AT_HEAT ||
          (antype == CAnalysisType::AT_NONLIN && stage.OutputType() != CDepletionStage::NONE));
}
...
unsigned int CResultTree::CTotalStrainResult::InvariantIndex() const { return RC_TOTAL_STRAIN_INVARIANT; }
...
bool CResultTree::CPlasticStrainResult::OnBuildComponent(const CDepletionStage &stage, const CAnalysisType &antype,
                                                         int /*nRegister*/) const {
  return stage.isAfter(stage.Entry().MarkedAsInitialStage()) &&
         (antype == CAnalysisType::AT_NONLIN || antype == CAnalysisType::AT_MIXTURE ||
          antype == CAnalysisType::AT_MIXTURE_CONTAINMENT) &&
         stage.OutputType() != CDepletionStage::NONE;
}

unsigned int CResultTree::CPlasticStrainResult::PreExportNameId() const { return 0; }

unsigned int CResultTree::CPlasticStrainResult::TypeId() const { return IDT_ET_STRAIN; }

QString CResultTree::CPlasticStrainResult::TypeName() const { return getStringTableEntry(IDS_ET_STRAIN); }

unsigned int CResultTree::CPlasticStrainResult::ExportNameId() const { return IDS_ET_STRAIN; }

unsigned int CResultTree::CPlasticStrainResult::PostExportNameId() const { return IDS_ET_PLASTIC; }

unsigned int CResultTree::CPlasticStrainResult::ComponentIndex() const { return RC_PLASTIC_STRAIN_COMPONENT; }
...
unsigned int CResultTree::CPlasticStrainResult::InvariantIndex() const { return RC_PLASTIC_STRAIN_INVARIANT; }

bool CResultTree::CPlasticStrainResult::CanMap(const COpenGLNode &node, int nRegister) const {
  return CanMapOnVolumeElements(node, nRegister);
}

bool CResultTree::CPlasticStrainResult::PrepareMapping(const geo::IElementSet *,
  ...
  int c0 = pRegister->ColumnNumber(pComponent->AnalysisType(),
                                   pRegister->DepletionStageEntry().MarkedAsInitialStage().Index(), CI_PSTRAIN_XX);
  ...
  c0 = pRegister->ColumnNumber(pComponent->AnalysisType(),
                               pRegister->DepletionStageEntry().MarkedAsInitialStage().Index(), CI_POREPRES);
...
bool CResultTree::CDisplacementResult::ValidName(const std::string &name, CResultInfo &resultInfo) const {
  std::string label = VectorExportLabel().toStdString();

  return validateName(resultInfo, name, label, VectorResultComponentList(), "_L|_M|_C|_N");
}

bool CResultTree::CDisplacementResult::OnBuildComponent(const CDepletionStage &stage, const CAnalysisType &antype,
                                                        int /*nRegister*/) const {
  return stage.isAfter(stage.Entry().MarkedAsInitialStage()) &&
         (antype == CAnalysisType::AT_LINEAR || antype == CAnalysisType::AT_MIXTURE ||
          antype == CAnalysisType::AT_MIXTURE_CONTAINMENT ||
...
QString CResultTree::CDisplacementResult::VectorExportLabel() const { return getStringTableEntry(IDS_ET_DISPLACEMENT); }
...
bool CResultTree::CDisplacementResult::PrepareMapping(const geo::IElementSet * /*pElementSet*/,
                                                      const IValueComponentBase *pValueComponent) {
  bool retval = true;
  ...
  int c0 = pRegister->ColumnNumber(pComponent->AnalysisType(),
                                   pRegister->DepletionStageEntry().MarkedAsInitialStage().Index(), CI_DISPLA_X);
...
CResultTree::CFaultScalarResult::CFaultScalarResultComponent::CFaultScalarResultComponent(
    CFaultScalarResult &parent,   // The tensor composite composite parent
    const CDepletionStage &stage, // Depletion stage of the component
    const CAnalysisType &antype, int nRegister)
    : IScalarResultComponent("", parent, stage, antype, nRegister, 0) {}

bool CResultTree::CFaultScalarResult::ValidName(const std::string &name, CResultInfo &resultInfo) const {
  std::string label = ExportLabel(0).toStdString();

  return validateName(resultInfo, name, label, TensorResultComponentList(), "_L|_M|_C|_N");
}

bool CResultTree::CFaultScalarResult::OnBuildComponent(const CDepletionStage &stage, const CAnalysisType &antype,
                                                       int /*nRegister*/) const {
  if ((ResultType() == DILATATION || ResultType() == PLASTIC_ENERGY) &&
      !stage.isAfter(stage.Entry().MarkedAsInitialStage()))
    return false;

  if (ResultType() == PLASTIC_ENERGY)
    return (antype == CAnalysisType::AT_MIXTURE || antype == CAnalysisType::AT_MIXTURE_CONTAINMENT ||
            (antype == CAnalysisType::AT_NONLIN && stage.OutputType() != CDepletionStage::NONE));
...
unsigned int CResultTree::CFaultScalarResult::CFaultScalarResultComponent::IconId() const { return 0; }

unsigned int CResultTree::CFaultScalarResult::CFaultScalarResultComponent::TypeId() const { return 0; }
...
void CResultTree::CFaultScalarResult::CFaultScalarResultComponent::DilatationValues(
    const CDepletionStage &stage, IValueDomainScalar::TValueVec &values, const geo::IElement &mesh_element,
    UNIT unit) const {
...
void CResultTree::CFaultScalarResult::CFaultScalarResultComponent::PlasticEnergy(const CDepletionStage &stage,
  ...
  */
  ...
  if (!stage.Initial() && (&stage.Previous() != &stage.InitialStage())) {
    pComponent =
        pComposite->ResultComponent(stage.Previous(), AnalysisType(), RegisterIndex(), IVectorResult::VC_LENGTH);
    if (pComponent)
  ...
  if (vcShear.size() == element.NrOfPoints() && vcPlasticDispl.size() == element.NrOfPoints() &&
      vcPlasticDisplPrev.size() == element.NrOfPoints()) {
    values.resize(element.NrOfPoints());
    for (int i = 0; i < element.NrOfPoints(); ++i) {
      if (previous_values[i].Valid() && vcShear[i].Valid() && vcPlasticDispl[i].Valid() &&
...
namespace {
geo::CVector GetDisplacementVectorCasing(const CVectorValueSet &displa, const geo::IElement &elm,
                                         const geo::IPoint &ptSample) {
...
geo::CVector GetDisplacementVectorWellZoomIn(const CVectorValueSet &displa, const geo::IElement &elm,
                                             const geo::IPoint &ptSample) {
  const geo::CInterfaceElement *pIface = dynamic_cast<const geo::CInterfaceElement *>(&elm);
  if (pIface) {
    if (pIface->FrontFace())
...
void CResultTree::CFaultScalarResult::CFaultScalarResultComponent::ElementValues(
    IValueDomainScalar::TValueVec &values, const geo::IElement &mesh_element, UNIT unit,
    geo::IParallelInitializationCallback * /*cb*/) const {
  ...
  case SHEAR_CAPACITY: {
    ...
    // wjrx mantis 2571 ResultRegister().FaultEffectiveStress(Stage(), Linear(), false).ElementValues(eff_stress,
    // mesh_element.Index());
    ResultRegister()
        .FaultShearStress(Stage(), AnalysisType(), false)
        .ElementValues(eff_stress, mesh_element.Index(), 0); // wjrx mantis 2571

    IValueDomainScalar::TValueVec eff_normal_stress(mesh_element.NrOfPoints());
    const IScalarResultComponent &normal_component = dynamic_cast<const IScalarResultComponent &>(
        *model.ResultTree().FaultEffectiveNormalStress().ResultComponent(Stage(), AnalysisType(), RegisterIndex()));
    normal_component.ElementValues(eff_normal_stress, mesh_element, CQuantity::SI_UNIT,
                                   0); // added UNIT wjrx mantis 2571

    double friction =
        ResultRegister().MaterialParameterValue(mesh_element.Index(), IDT_VALUETYPE_FRICTION_ANGLE, Stage());
  ...
  case PORE_PRESSURE_CHANGE: {
    ...
    ResultRegister()
        .FaultPorePressure(Stage(), AnalysisType(), pResult->ResultType() == PORE_PRESSURE_CHANGE)
        .ElementValues(values, mesh_element.Index(), 0);
    break;
  }
  case PORE_PRESSURE_INPUT:
  case PORE_PRESSURE_CHANGE_INPUT: {
    ...
    if (pFault) {
      ...
      if (pResult->ResultType() == PORE_PRESSURE_CHANGE_INPUT) {
        IValueDomainScalar::TValueVec vcIniValues =
            pFault->Pressure(Stage().InitialStage()).Component().ScalarData().ValueElement(mesh_element);
        for (size_t i = 0; i < values.size(); ++i) {
  ...
  case BOUNDARY_PRESSURE_INPUT: {
    ...
    // model->ParentLinearResults() ? CAnalysisType::AT_LINEAR : CAnalysisType::AT_NONLIN, false);

    CStressTensorValueSet stress = parentModel.ResultRegister().TotalStress(
        parentStage, model->ParentLinearResults(AnalysisType()) ? CAnalysisType::AT_LINEAR : CAnalysisType::AT_NONLIN,
        false);
  ...
  case BOUNDARY_DISPLACEMENT_INPUT: {
    ...
    CVectorValueSet displa = parentModel.ResultRegister().Displacement(
        parentStage, model->ParentLinearResults(AnalysisType()) ? CAnalysisType::AT_LINEAR : CAnalysisType::AT_NONLIN,
        false);
...
IValueDomainScalar::TValueVec CResultTree::CFaultScalarResult::CFaultScalarResultComponent::ValueElement(
    const geo::IElement &elm, const UNIT unit, geo::IParallelInitializationCallback *cb) const {
  const CNonMeshedSurface::CGeoSurface *pGeoSurface =
      dynamic_cast<const CNonMeshedSurface::CGeoSurface *>(elm.IndexingElementSet());
  if (pGeoSurface) {
    const CFaultScalarResult *pResult = dynamic_cast<const CFaultScalarResult *>(&Parent());
    assert(pResult);
    switch (pResult->ResultType()) {
    case SHEAR_CAPACITY: {
      ...
      rotation.Value(0, 0, norm.X());
      rotation.Value(0, 1, tang1.X());
      rotation.Value(0, 2, tang2.X());
      rotation.Value(1, 0, norm.Y());
      rotation.Value(1, 1, tang1.Y());
      rotation.Value(1, 2, tang2.Y());
      rotation.Value(2, 0, norm.Z());
      rotation.Value(2, 1, tang1.Z());
      rotation.Value(2, 2, tang2.Z());
    ...
    case PORE_PRESSURE_INPUT: {
      ...
      if (pGeoSurface->Parent().Pressure().ManualValues()) {
        ...
        vcValues = model.ResultTree()
                       .PorePressure()
                       .ResultComponent(Stage(), AnalysisType())
                       ->ScalarData()
                       .ValueElement(elm, unit, cb);
      }
    ...
    case PORE_PRESSURE_CHANGE_INPUT: {
      ...
      if (pGeoSurface->Parent().Pressure().ManualValues()) {
        ...
        vcValues = model.ResultTree()
                       ...
                       ->ScalarData()
                       .ValueElement(elm, unit, cb);
        vcValuesIni = model.ResultTree()
                          .PorePressure()
                          .ResultComponent(model.DepletionStageEntry().MarkedAsInitialStage(), AnalysisType())
                          ->ScalarData()
                          .ValueElement(elm, unit, cb);
...
//////////////////////////////////////////////////////////////////////
void CResultTree::CFaultScalarResult::BuildComponent(const CDepletionStage &stage, const CAnalysisType &antype,
                                                     int nRegister) {
  if (OnBuildComponent(stage, antype, nRegister)) {
    switch (ResultType()) {
    case DILATATION:
...
CResultTree::CFaultScalarResult::CFaultScalarResult(unsigned int uName, unsigned int uLabelId, CResultGroup &group,
...
CResultTree::CFaultScalarResult::CFaultScalarResult(const QString &sName, unsigned int uLabelId, CResultGroup &group,
                                                    TResultType result_type)
...
QString CResultTree::CFaultScalarResult::ExportLabel(int /*nComponent*/) const { return getStringTableEntry(m_uLabel); }
...
bool CResultTree::CFaultScalarResult::isFaultResult() const { return true; }
...
bool CResultTree::CFaultScalarResult::PrepareMapping(const geo::IElementSet * /*pElementSet*/,
                                                     const IValueComponentBase * /*pValueComponent*/) {
  return false;
}
...
bool CResultTree::CFaultDisplacementResult::ValidName(const std::string &name, CResultInfo &resultInfo) const {
  std::string label = VectorExportLabel().toStdString();

  return validateName(resultInfo, name, label, VectorResultComponentList(), "_L|_M|_C|_N");
}

bool CResultTree::CFaultDisplacementResult::OnBuildComponent(const CDepletionStage &stage, const CAnalysisType &antype,
                                                             int /*nRegister*/) const {
  return stage.isAfter(stage.Entry().MarkedAsInitialStage()) &&
         (antype == CAnalysisType::AT_LINEAR || antype == CAnalysisType::AT_MIXTURE ||
          antype == CAnalysisType::AT_MIXTURE_CONTAINMENT ||
...
bool CResultTree::CFaultDisplacementResult::isFaultResult() const { return true; }
...
bool CResultTree::CFaultDisplacementResult::PrepareMapping(const geo::IElementSet * /*pElementSet*/,
                                                           const IValueComponentBase *pValueComponent) {
  IResultComponent *pComponent = const_cast<IResultComponent *>(static_cast<const IResultComponent *>(pValueComponent));
  CResultRegister *pRegister = &static_cast<CModelBase &>(Model()).ResultRegister();

  int c0 = pRegister->ColumnNumber(pComponent->AnalysisType(),
                                   pRegister->DepletionStageEntry().MarkedAsInitialStage().Index(), CI_STRAIN_XX);
...
const geo::IVector &
CResultTree::CFaultPlasticSlipResult::VectorPoint(const geo::IPoint &point, const IResultComponent &component,
                                                  geo::IParallelInitializationCallback * /*cb*/) const {
  if (m_cache.pPoint == &point && m_cache.pStage == &component.Stage() &&
  ...
  pComp = model.ResultTree().FaultDisplacement().ResultComponent(component.Stage(), component.AnalysisType(),
                                                                 component.RegisterIndex(), component.ComponentIndex());
  if (!pComp)
    return vecEmpty;
  ...
  geo::CValue valFaultDilatation =
      model.ResultTree()
          .FaultDilatation()
          .ResultComponent(component.Stage(), component.AnalysisType(), component.RegisterIndex())
          ->ValuePoint(point);
  if (!valFaultDilatation.Valid())
    return vecEmpty;

  pComp = model.ResultTree().FaultShearStress().ResultComponent(component.Stage(), component.AnalysisType(),
                                                                component.RegisterIndex(), component.ComponentIndex());
  if (!pComp)
    return vecEmpty;
  ...
  pComp = model.ResultTree().FaultShearStress().ResultComponent(model.DepletionStageEntry().MarkedAsInitialStage(),
                                                                component.AnalysisType(), component.RegisterIndex(),
  ...
  geo::CVector vecPlasticSlip = Calculate(*pInterface, point, vecFaultDisplacement, valFaultDilatation.Value(),
                                          vecFaultShearStress - vecFaultShearStressIni, dDStiff);
...
const geo::IVector &
CResultTree::CFaultPlasticSlipResult::VectorElement(const geo::IElement &element, int nNodeIndex, TMapType map_type,
                                                    const IResultComponent &component,
                                                    geo::IParallelInitializationCallback *cb) const {
  if (m_cache.pElement == &element && m_cache.pStage == &component.Stage() &&
      m_cache.antype == component.AnalysisType().AnalysisType() &&
      m_cache.nRegisterIndex == component.RegisterIndex() &&
  ...
  if (pHor)
    ...
    if (pWellCasingModel && pWellCasingModel->Mesh().IsCementInterfaceElement(*pInterface)) {
      const CInterfaceMaterial *pIfaceMat =
          pWellCasingModel->CasingNode().CementInterface().Material(component.Stage()).LibraryMaterial();
      if (pIfaceMat)
  ...
  if (!pComp)
    return vecEmpty;
  geo::CVector vecFaultDisplacement =
      model.ResultTree().FaultDisplacement().VectorElement(element, nNodeIndex, map_type, *pComp, cb);
  if (vecFaultDisplacement.Empty())
    return vecEmpty;
  ...
  geo::CValue valFaultDilatation =
      model.ResultTree()
          .FaultDilatation()
          .ResultComponent(component.Stage(), component.AnalysisType(), component.RegisterIndex())
          ->ValueElement(element, CDoubleQuantity::SI_UNIT, cb)[nNodeIndex];
  if (!valFaultDilatation.Valid())
    return vecEmpty;
  ...
  if (!pComp)
    return vecEmpty;
  geo::CVector vecFaultShearStress =
      model.ResultTree().FaultShearStress().VectorElement(element, nNodeIndex, map_type, *pComp, cb);
  if (vecFaultShearStress.Empty())
    return vecEmpty;
  ...
  if (!pComp)
    return vecEmpty;
  geo::CVector vecFaultShearStressIni =
      model.ResultTree().FaultShearStress().VectorElement(element, nNodeIndex, map_type, *pComp, cb);
  if (vecFaultShearStressIni.Empty())
    return vecEmpty;

  geo::CVector vecPlasticSlip =
      Calculate(*pInterface, element.Node(nNodeIndex), vecFaultDisplacement, valFaultDilatation.Value(),
                vecFaultShearStress - vecFaultShearStressIni, dDStiff);
...
bool CResultTree::CFaultPlasticSlipResult::isFaultResult() const { return true; }

bool CResultTree::CFaultPlasticSlipResult::PrepareMapping(const geo::IElementSet * /*pElementSet*/,
                                                          const IValueComponentBase * /*pValueComponent*/) {
  return false;
}
...
bool CResultTree::CFaultPlasticSlipResult::ValidName(const std::string &name, CResultInfo &resultInfo) const {
  std::string label = VectorExportLabel().toStdString();

  return validateName(resultInfo, name, label, VectorResultComponentList(), "_L|_M|_C|_N");
}

bool CResultTree::CFaultPlasticSlipResult::OnBuildComponent(const CDepletionStage &stage, const CAnalysisType &antype,
                                                            int /*nRegister*/) const {
  return stage.isAfter(stage.Entry().MarkedAsInitialStage()) &&
         (antype == CAnalysisType::AT_MIXTURE || antype == CAnalysisType::AT_MIXTURE_CONTAINMENT ||
          (antype == CAnalysisType::AT_NONLIN && stage.OutputType() != CDepletionStage::NONE));
}

geo::CVector CResultTree::CFaultPlasticSlipResult::Calculate(const geo::IInterfaceElement &iface,
                                                             const geo::IPoint &point,
                                                             const geo::IVector &vecDeformation, double dDilatation,
...
CResultTree::CFaultNormalStress::CNormalStressComponent::CNormalStressComponent(
    CFaultNormalStress &parent,   // The tensor composite composite parent
    const CDepletionStage &stage, // Depletion stage of the component
    const CAnalysisType &antype, int nRegister)
    : IScalarResultComponent("", parent, stage, antype, nRegister, 0) {}

unsigned int CResultTree::CFaultNormalStress::CNormalStressComponent::IconId() const { return 0; }

unsigned int CResultTree::CFaultNormalStress::CNormalStressComponent::TypeId() const { return 0; }
...
void CResultTree::CFaultNormalStress::CNormalStressComponent::ElementValues(
    IValueDomainScalar::TValueVec &values, const geo::IElement &mesh_element, UNIT unit,
    geo::IParallelInitializationCallback * /*cb*/) const {
  const geo::IInterfaceElement *p = dynamic_cast<const geo::IInterfaceElement *>(&mesh_element);
  if (p == NULL)
    return; // wjrx mantis 2570
  ...
  CVectorValueSet::TValueVec vcValue(values.size());
  ResultRegister()
      .FaultEffectiveStress(Stage(), AnalysisType(), parent.m_bChange)
      .ElementValues(vcValue, mesh_element.Index(), geo::IParallelInitializationCallback::Sequential);
  std::vector<geo::CValue> vcPressure(values.size(), geo::CValue(0));
  if (parent.m_bTotal) {
    ResultRegister()
        .FaultPorePressure(Stage(), AnalysisType(), parent.m_bChange)
        .ElementValues(vcPressure, mesh_element.Index(), geo::IParallelInitializationCallback::Sequential);
  }
...
//////////////////////////////////////////////////////////////////////
bool CResultTree::CFaultNormalStress::ValidName(const std::string &name, CResultInfo &resultInfo) const {
  std::string label = ExportLabel(0).toStdString();

  return validateName(resultInfo, name, label, "", "_L|_M|_C|_N");
}

bool CResultTree::CFaultNormalStress::OnBuildComponent(const CDepletionStage &stage, const CAnalysisType &antype,
                                                       int /*nRegister*/) const {
...
void CResultTree::CFaultNormalStress::BuildComponent(const CDepletionStage &stage, const CAnalysisType &antype,
                                                     int nRegister) {
  if (OnBuildComponent(stage, antype, nRegister))
    new CNormalStressComponent(*this, stage, antype, nRegister);
}

CResultTree::CFaultNormalStress::CFaultNormalStress(unsigned int uFileIndex, unsigned int uName, unsigned int uLabelId,
                                                    CResultGroup &group, bool bTotal, bool bChange)
...
bool CResultTree::CFaultNormalStress::isFaultResult() const { return true; }

bool CResultTree::CFaultNormalStress::PrepareMapping(const geo::IElementSet * /*pElementSet*/,
                                                     const IValueComponentBase * /*pValueComponent*/) {
  return false;
}
...
CResultTree::CScalarResult::CScalarResultComponent::CScalarResultComponent(
    CScalarResult &parent,        // The tensor composite composite parent
    const CDepletionStage &stage, // Depletion stage of the component
    const CAnalysisType &antype, int nRegister)
    : IScalarResultComponent("", parent, stage, antype, nRegister, 0) {
  m_mpValues.clear();
...
unsigned int CResultTree::CScalarResult::CScalarResultComponent::IconId() const { return 0; }

unsigned int CResultTree::CScalarResult::CScalarResultComponent::TypeId() const { return 0; }
...
void CResultTree::CScalarResult::CScalarResultComponent::PorePressureUndrained(IValueDomainScalar::TValueVec &values,
  ...
  IValueDomainScalar::TValueVec vcIniStresses =
      model.ResultTree()
          .TotalStress()
          .InvariantComposite()
          ->ResultComponent(inistage, AnalysisType(), RegisterIndex(),
                            CResultTree::CTotalStressResult::CInvariantComposite::INV_I1)
          ->ValueElement(mesh_element);

  // get stage average stresses
  IValueDomainScalar::TValueVec vcStresses =
      model.ResultTree()
          .TotalStress()
          .InvariantComposite()
          ->ResultComponent(stage, AnalysisType(), RegisterIndex(),
                            CResultTree::CTotalStressResult::CInvariantComposite::INV_I1)
          ->ValueElement(mesh_element);
  ...
  for (i = 0; i < mesh_element.NrOfNodes(); ++i) {
    if (vcIniPressures[i].Valid() && vcIniStresses[i].Valid() && vcStresses[i].Valid() && vcIniTemper[i].Valid() &&
        vcTemper[i].Valid()) {
      ...
      values[i] = P0 + ((1 / Kb - 1 / Kg) * (sigma - sigma0) + phi * (beta_f - beta_b) * (T - T0)) /
                           (1 / Kb - (phi + 1) / Kg + phi / Kf);
    } else {
      values[i] = geo::CValue();
    }
  }
...
void CResultTree::CScalarResult::CScalarResultComponent::PorePressure(IValueDomainScalar::TValueVec &values,
                                                                      const geo::IElement &mesh_element,
  ...
  ResultRegister()
      .PorePressure(stage, AnalysisType(), false)
      .ElementValues(values, mesh_element.Index(), geo::IParallelInitializationCallback::Sequential);
}

void CResultTree::CScalarResult::CScalarResultComponent::PorePressureInput(IValueDomainScalar::TValueVec &values,
                                                                           const geo::IElement &mesh_element,
                                                                           const CDepletionStage &stage) const {
  const CModelBase &model = dynamic_cast<const CModelBase &>(Model());
...
void CResultTree::CScalarResult::CScalarResultComponent::FractureMatrixPressure(IValueDomainScalar::TValueVec &values,
                                                                                const geo::IElement &mesh_element,
                                                                                const CDepletionStage &stage) const {
  const CModelBase &model = dynamic_cast<const CModelBase &>(Model());
  const CScalarResult *pResult = dynamic_cast<const CScalarResult *>(&Parent());
...
void CResultTree::CScalarResult::CScalarResultComponent::Temperature(IValueDomainScalar::TValueVec &values,
                                                                     const geo::IElement &mesh_element,
                                                                     const CDepletionStage &stage) const {
  assert(ResultRegister().ResultsAvailable(AnalysisType()));
  ResultRegister()
      .Temperature(stage, AnalysisType(), false)
      .ElementValues(values, mesh_element.Index(), geo::IParallelInitializationCallback::Sequential);
}

void CResultTree::CScalarResult::CScalarResultComponent::TemperatureInput(IValueDomainScalar::TValueVec &values,
                                                                          const geo::IElement &mesh_element,
                                                                          const CDepletionStage &stage) const {
  // get from input data
  const CModelBase &model = static_cast<const CModelBase &>(Model());
...
void CResultTree::CScalarResult::CScalarResultComponent::Consolidation(IValueDomainScalar::TValueVec &values,
                                                                       const geo::IElement &mesh_element,
                                                                       const CDepletionStage &stage) const {
  const CModelBase &model = static_cast<const CModelBase &>(Model());
  const CFormationBase *pFormation = model.Mesh().Formation(mesh_element);
  if (pFormation && pFormation->Material(stage).LibraryMaterial()->IsParameter(IDT_VALUETYPE_PRECONSOLIDATION))
    ResultRegister()
        .Consolidation(stage, AnalysisType(), false)
        .ElementValues(values, mesh_element.Index(), geo::IParallelInitializationCallback::Sequential);
}

void CResultTree::CScalarResult::CScalarResultComponent::Porosity(IValueDomainScalar::TValueVec &values,
                                                                  const geo::IElement &mesh_element,
                                                                  const CDepletionStage &stage,
                                                                  geo::IParallelInitializationCallback *cb) const {
  ...
  const IResultComponent *pCompInvVolStrain = model.ResultTree().TotalStrain().Invariants().ResultComponent(
      stage, AnalysisType(), RegisterIndex(), IStrainTensorGroup::CInvariantComposite::INV_I1);
...
void CResultTree::CScalarResult::CScalarResultComponent::GammaValues(IValueDomainScalar::TValueVec &values,
                                                                     const geo::IElement &mesh_element,
                                                                     TResultType type, UNIT /*unit*/,
                                                                     geo::IParallelInitializationCallback *cb) const {
  const CModelBase &model = dynamic_cast<const CModelBase &>(Model());
  ...
  if (pTempPool) {
    ...
    ResultRegister()
        .EffectiveStress(model.DepletionStageEntry().MarkedAsInitialStage(), AnalysisType(), false)
        .ElementValues(*pVcInitStress, mesh_element.Index(), cb);

    CStressTensorValueSet::TValueVec *pVcStress = pTempPool->getStressTensorVector(1, mesh_element.NrOfPoints());
    ResultRegister()
        .EffectiveStress(Stage(), AnalysisType(), false)
        .ElementValues(*pVcStress, mesh_element.Index(), cb);
    ...
    for (size_t i = 0; i < values.size(); i++) {
      switch (type) {
      case GAMMA_VERTICAL:
        values[i] = MF::GammaVertical((*pVcInitStress)[i], (*pVcStress)[i], (*pVcInitPressure)[i].Value(),
                                      (*pVcPressure)[i].Value(), MF::EFFECTIVE);
        break;
      case GAMMA_MAX:
        values[i] = MF::GammaMax((*pVcInitStress)[i], (*pVcStress)[i], (*pVcInitPressure)[i].Value(),
                                 (*pVcPressure)[i].Value(), MF::EFFECTIVE);
        break;
      case GAMMA_MED:
        values[i] = MF::GammaMed((*pVcInitStress)[i], (*pVcStress)[i], (*pVcInitPressure)[i].Value(),
                                 (*pVcPressure)[i].Value(), MF::EFFECTIVE);
        break;
      case GAMMA_MIN:
        values[i] = MF::GammaMin((*pVcInitStress)[i], (*pVcStress)[i], (*pVcInitPressure)[i].Value(),
                                 (*pVcPressure)[i].Value(), MF::EFFECTIVE);
        break;
      case GAMMA_VOLUME:
        values[i] = MF::GammaVolume((*pVcInitStress)[i], (*pVcStress)[i], (*pVcInitPressure)[i].Value(),
                                    (*pVcPressure)[i].Value(), MF::EFFECTIVE);
        break;
      default:
        assert(false);
  ...
  } else // legacy
  {
    ...
    ResultRegister()
        .EffectiveStress(model.DepletionStageEntry().MarkedAsInitialStage(), AnalysisType(), false)
        .ElementValues(vcInitStress, mesh_element.Index(), cb);
    ...
    for (size_t i = 0; i < values.size(); i++) {
      switch (type) {
      case GAMMA_VERTICAL:
        values[i] = MF::GammaVertical(vcInitStress[i], vcStress[i], vcInitPressure[i].Value(), vcPressure[i].Value(),
                                      MF::EFFECTIVE);
        break;
      case GAMMA_MAX:
        values[i] =
            MF::GammaMax(vcInitStress[i], vcStress[i], vcInitPressure[i].Value(), vcPressure[i].Value(), MF::EFFECTIVE);
        break;
      case GAMMA_MED:
        values[i] =
            MF::GammaMed(vcInitStress[i], vcStress[i], vcInitPressure[i].Value(), vcPressure[i].Value(), MF::EFFECTIVE);
        break;
      case GAMMA_MIN:
        values[i] =
            MF::GammaMin(vcInitStress[i], vcStress[i], vcInitPressure[i].Value(), vcPressure[i].Value(), MF::EFFECTIVE);
        break;
      case GAMMA_VOLUME:
        values[i] = MF::GammaVolume(vcInitStress[i], vcStress[i], vcInitPressure[i].Value(), vcPressure[i].Value(),
                                    MF::EFFECTIVE);
        break;
      default:
        assert(false);
...
geo::CValue CResultTree::CScalarResult::CScalarResultComponent::FetchDisplacementValueFor(
    const geo::IPoint &pt, const CDepletionStage &stage, geo::IParallelInitializationCallback *cb) const {
  geo::CValue valRet;
...
void CResultTree::CScalarResult::CScalarResultComponent::Thickness(IValueDomainScalar::TValueVec &values,
                                                                   const geo::IElement &element,
                                                                   const CDepletionStage &stage,
                                                                   geo::IParallelInitializationCallback *cb) const {
  const CModelBase &model = static_cast<const CModelBase &>(Model());
...
void CResultTree::CScalarResult::CScalarResultComponent::ShearCapacityMC(IValueDomainScalar::TValueVec &values,
                                                                         const geo::IElement &element,
                                                                         const CDepletionStage & /*stage*/) const {
  ...
  ResultRegister()
      .EffectiveStress(Stage(), AnalysisType(), false)
      .ElementValues(vcStress, element.Index(), geo::IParallelInitializationCallback::Sequential);
...
void CResultTree::CScalarResult::CScalarResultComponent::CompactionCapacity(IValueDomainScalar::TValueVec &values,
                                                                            const geo::IElement &element,
                                                                            const CDepletionStage &stage) const {
  // get the material model
  int iMatModel = ResultRegister().MaterialModel(element.Index());
...
void CResultTree::CScalarResult::CScalarResultComponent::ApertureValues(CScalarResult::TResultType result_type,
                                                                        IValueDomainScalar::TValueVec &values,
                                                                        const CDepletionStage &stage,
                                                                        const geo::IElement &mesh_element,
                                                                        UNIT unit) const {
  ...
  if (pFormation) {
    const CMaterialServer &mat_server = pFormation->Material(stage);
    if (mat_server.Valid() &&
        (mat_server.MaterialModel() == MM_FRACTURE_APERTURE || mat_server.MaterialModel() == MM_FRACTURE_APERTURE2)) {
      ...
      IValueDomainScalar::TValueVec vcInitValues(
          mesh_element.NrOfNodes()); // initial values when 'marked as initial stage' != 'initial stage'
        ...
        if (!bDelta) {
          if (&stage != &inistage && &inistage != &inistage.InitialStage()) {
            ...
            if (ffmat.IsParameter(uiValueTypeV0)) {
              ...
              // Compute initial fracture aperture (per direction) from the initial (effective) normal stress s'n (hence
              // after D0) wi = wref * exp ( -a (s'n - s'ref))
...
void CResultTree::CScalarResult::CScalarResultComponent::apertureValues(IValueDomainScalar::TValueVec &fractureAperture,
                                                                        const geo::IElement &mesh_element,
                                                                        const CDepletionStage &depletionStage,
                                                                        UNIT unit, TResultType resultType) const {
  const CModelBase &model = (const CModelBase &)(Model());
  const IScalarResultComponent *scalarResultComponent = dynamic_cast<const IScalarResultComponent *>(
      model.ResultTree().Aperture(resultType).ResultComponent(depletionStage, AnalysisType(), 0));

  assert(scalarResultComponent != 0);

  scalarResultComponent->ElementValues(fractureAperture, mesh_element, unit,
                                       geo::IParallelInitializationCallback::Sequential);
}

void CResultTree::CScalarResult::CScalarResultComponent::PlasticEnergy(const CDepletionStage &stage,
                                                                       IValueDomainScalar::TValueVec &values,
                                                                       const geo::IElement &element, UNIT unit,
                                                                       geo::IParallelInitializationCallback *cb) const {
  /*
  WI 81410:
  ...
  */
  ...
  if (pComposite) {
    ...
    pComponent = pComposite->ResultComponent(stage, AnalysisType(), RegisterIndex(),
                                             CResultTree::CEffectiveStressResult::CInvariantComposite::INV_I1);
    if (pComponent)
      vcIsoEffStress = pComponent->ValueElement(element, unit, cb);

    // von mises stress
    pComponent = pComposite->ResultComponent(stage, AnalysisType(), RegisterIndex(),
                                             CResultTree::CEffectiveStressResult::CInvariantComposite::INV_VONMIS);
    if (pComponent)
  ...
  if (pComposite) {
    ...
    pComponent = pComposite->ResultComponent(stage, AnalysisType(), RegisterIndex(),
                                             CResultTree::CPlasticStrainResult::CInvariantComposite::INV_I1);
    if (pComponent)
      vcPlastVolStrain = pComponent->ValueElement(element, unit, cb);

    if (!stage.Initial() && (&stage.Previous() != &stage.InitialStage())) {
      pComponent = pComposite->ResultComponent(stage.Previous(), AnalysisType(), RegisterIndex(),
                                               CResultTree::CPlasticStrainResult::CInvariantComposite::INV_I1);
      if (pComponent)
    ...
    pComponent = pComposite->ResultComponent(stage, AnalysisType(), RegisterIndex(),
                                             CResultTree::CPlasticStrainResult::CInvariantComposite::INV_VONMIS);
    if (pComponent)
  ...
  if (vcIsoEffStress.size() == element.NrOfPoints() && vcVonMisesStress.size() == element.NrOfPoints() &&
      vcPlastVolStrain.size() == element.NrOfPoints() && vcPlastVolStrainPrev.size() == element.NrOfPoints() &&
      vcPlastVonMisesStrain.size() == element.NrOfPoints() &&
      vcPlastVonMisesStrainPrev.size() == element.NrOfPoints()) {
    values.resize(element.NrOfPoints());
    for (int i = 0; i < element.NrOfPoints(); ++i) {
      if (previous_values[i].Valid() && vcIsoEffStress[i].Valid() && vcVonMisesStress[i].Valid() &&
          vcPlastVolStrain[i].Valid() && vcPlastVolStrainPrev[i].Valid() && vcPlastVonMisesStrain[i].Valid() &&
...
void CResultTree::CScalarResult::CScalarResultComponent::permeabilityMultiplierValues(
    TResultType result_type, IValueDomainScalar::TValueVec &values, const geo::IElement &mesh_element,
    UNIT unit) const {
  const CModelBase &model = dynamic_cast<const CModelBase &>(Model());
  const CFormationBase *pFormation = model.Mesh().Formation(mesh_element);
  if (!pFormation)
  ...
  const CFFMaterial &mat =
      pFormation->Material(model.DepletionStageEntry().MarkedAsInitialStage()).Material(mesh_element);

  if (!mat.IsParameter(IDT_VALUETYPE_HIGH_FRACT_DENS) || !mat.IsParameter(IDT_VALUETYPE_INTER_FRACT_DENS) ||
  ...
  switch (result_type) {
  case PERMEABILITY_MULTIPLIER_HI:
    apertureValues(fractureAperture1, mesh_element, Stage(), unit, APERTURE_ME);
    apertureValues(fractureApertureChange1, mesh_element, Stage(), unit, APERTURE_ME_CHANGE);
    apertureValues(fractureAperture2, mesh_element, Stage(), unit, APERTURE_LO);
    apertureValues(fractureApertureChange2, mesh_element, Stage(), unit, APERTURE_LO_CHANGE);
    rho1 = mat.ParameterValue(IDT_VALUETYPE_INTER_FRACT_DENS);
    rho2 = mat.ParameterValue(IDT_VALUETYPE_LOW_FRACT_DENS);
    break;
  case PERMEABILITY_MULTIPLIER_ME:
    apertureValues(fractureAperture1, mesh_element, Stage(), unit, APERTURE_LO);
    apertureValues(fractureApertureChange1, mesh_element, Stage(), unit, APERTURE_LO_CHANGE);
    apertureValues(fractureAperture2, mesh_element, Stage(), unit, APERTURE_HI);
    apertureValues(fractureApertureChange2, mesh_element, Stage(), unit, APERTURE_HI_CHANGE);
    rho1 = mat.ParameterValue(IDT_VALUETYPE_LOW_FRACT_DENS);
    rho2 = mat.ParameterValue(IDT_VALUETYPE_HIGH_FRACT_DENS);
    break;
  case PERMEABILITY_MULTIPLIER_LO:
    apertureValues(fractureAperture1, mesh_element, Stage(), unit, APERTURE_HI);
    apertureValues(fractureApertureChange1, mesh_element, Stage(), unit, APERTURE_HI_CHANGE);
    apertureValues(fractureAperture2, mesh_element, Stage(), unit, APERTURE_ME);
    apertureValues(fractureApertureChange2, mesh_element, Stage(), unit, APERTURE_ME_CHANGE);
  ...
  for (int i = 0; i < mesh_element.NrOfNodes(); ++i) {
    if (fractureApertureChange1[i].Valid() && fractureAperture1[i].Valid() && fractureApertureChange2[i].Valid() &&
        fractureAperture2[i].Valid()) {
...
//
void CResultTree::CScalarResult::CScalarResultComponent::calcValues(const geo::CValue &sEE, const geo::CValue &sNN,
                                                                    const geo::CValue &sVV, const geo::CValue &sEN,
                                                                    geo::CValue &SHTotazimuth, geo::CValue &SHTot_SvTot,
                                                                    geo::CValue &ShTot_SvTot) const {
...
void CResultTree::CScalarResult::CScalarResultComponent::ElementValues(IValueDomainScalar::TValueVec &values,
                                                                       const geo::IElement &mesh_element, UNIT unit,
                                                                       geo::IParallelInitializationCallback *cb) const {
  const CModelBase &model = dynamic_cast<const CModelBase &>(Model());
  const CScalarResult *pResult = dynamic_cast<const CScalarResult *>(&Parent());
  assert(pResult);
  ...
  case SHTOT_SvTOT: {
    CStressTensorValueSet::TValueVec vcValues(mesh_element.NrOfPoints());
    ResultRegister()
        .TotalStress(Stage(), AnalysisType(), false)
        .ElementValues(vcValues, mesh_element.Index(), geo::IParallelInitializationCallback::Sequential);
          ...
          for (int j = 0; j < element_set->ElementSize(); ++j) {
            ...
            for (int k = 0; k < element->NrOfPoints(); ++k) {
              if ((*gamma_min)[k].Valid() && (*gamma_med)[k].Valid() && (*gamma_max)[k].Valid()) {
                ...
                total_weighted_local += influence_volume * (1.0 / 3.0) *
                                        ((*gamma_min)[k].Value() + (*gamma_med)[k].Value() + (*gamma_max)[k].Value());
    ...
    if (!mesh_element.IsInterfaceElement()) {
      ...
      if (formationBase) {
        if (formationBase->Strain(Stage()).IsVolumetric()) {
          values = formationBase->Strain(Stage()).Component().ScalarData().ValueElement(mesh_element);

          if (pResult->ResultType() == VOLUMETRIC_STRAIN_CHANGE_INPUT) {
            if (!modelBase.DepletionStageEntry().MarkedAsInitialStage().Initial()) {
              const IValueDomainScalar::TValueVec &inivalues =
                  formationBase->Strain(modelBase.DepletionStageEntry().MarkedAsInitialStage())
                      .Component()
                      .ScalarData()
                      .ValueElement(mesh_element);
              for (size_t i = 0; i < values.size(); ++i) {
...
geo::IParallelInitializationCallback *
CResultTree::CScalarResult::CScalarResultComponent::GetParallelInitializationCallback() {
  const CScalarResult *pResult = dynamic_cast<const CScalarResult *>(&Parent());
  assert(pResult);
...
bool CResultTree::CScalarResult::CScalarResultComponent::Gradient() const {
  ...
  return pResult->ResultType() == PORE_PRESSURE_GRADIENT || pResult->ResultType() == PORE_PRESSURE_GRADIENT_INPUT ||
         pResult->ResultType() == TEMPERATURE_GRADIENT || pResult->ResultType() == TEMPERATURE_GRADIENT_INPUT;
}
...
bool CResultTree::CScalarResult::ValidName(const std::string &name, CResultInfo &resultInfo) const {
  std::string label = ExportLabel(0).toStdString();

  return validateName(resultInfo, name, label, "", "_L|_M|_C|_N|_H");
}

bool CResultTree::CScalarResult::OnBuildComponent(const CDepletionStage &stage, const CAnalysisType &antype,
                                                  int /*nRegister*/) const {
  if (antype == CAnalysisType::AT_HEAT &&
      (ResultType() == TEMPERATURE_CHANGE_INPUT || ResultType() == TEMPERATURE_INPUT ||
       ResultType() == TEMPERATURE_GRADIENT_INPUT || ResultType() == TEMPERATURE ||
       ResultType() == TEMPERATURE_CHANGE || ResultType() == TEMPERATURE_GRADIENT ||
       ResultType() == PORE_PRESSURE_CHANGE_INPUT || ResultType() == PORE_PRESSURE_INPUT ||
       ResultType() == PORE_PRESSURE_GRADIENT_INPUT || ResultType() == NORMAL_STRAIN_INPUT ||
       ResultType() == LATERAL_STRAIN_INPUT || ResultType() == VOLUMETRIC_STRAIN_INPUT ||
...
void CResultTree::CScalarResult::BuildComponent(const CDepletionStage &stage, const CAnalysisType &antype,
                                                int nRegister) {
  if (OnBuildComponent(stage, antype, nRegister)) {
    switch (ResultType()) {
    case PORE_PRESSURE_CHANGE:
    ...
    case VOLUME_AVERAGE:
      ...
      break;
    case CONSOL:
      if (antype == CAnalysisType::AT_NONLIN || antype == CAnalysisType::AT_MIXTURE ||
          antype == CAnalysisType::AT_MIXTURE_CONTAINMENT)
        new CScalarResultComponent(*this, stage, antype, nRegister);
      break;
    case CONSOL_CHANGE:
...
CResultTree::CScalarResult::CScalarResult(unsigned int uName, unsigned int uLabelId, CResultGroup &group,
                                          TResultType result_type)
    : IResult(uName, group), m_result_type(result_type), m_uLabel(uLabelId), m_pVolumeAverage(0),
      m_bNeedTensorParallelInitializationCallback(false) {
  BuildComponents();
  SetIndex();
}

CResultTree::CScalarResult::CScalarResult(const QString &sName, unsigned int uLabelId, CResultGroup &group,
                                          TResultType result_type)
    : IResult(sName, group), m_result_type(result_type), m_uLabel(uLabelId), m_pVolumeAverage(0),
      m_bNeedTensorParallelInitializationCallback(false) {
  BuildComponents();
  SetIndex();
}
...
CResultTree::CScalarResult::TResultType CResultTree::CScalarResult::ResultType() const { return m_result_type; }

QString CResultTree::CScalarResult::ExportLabel(int /*nComponent*/) const { return getStringTableEntry(m_uLabel); }

bool CResultTree::CScalarResult::CanMap(const COpenGLNode &node, int nRegister) const {
  if ((m_result_type == PORE_PRESSURE || m_result_type == PORE_PRESSURE_CHANGE ||
       m_result_type == PORE_PRESSURE_INPUT || m_result_type == PORE_PRESSURE_CHANGE_INPUT)) {
...
bool CResultTree::CScalarResult::OnDefined(const IResultComponent &component) const {
  if ((m_result_type == PORE_PRESSURE_INPUT) || (m_result_type == PORE_PRESSURE_CHANGE_INPUT) ||
      (m_result_type == PORE_PRESSURE_GRADIENT_INPUT) || (m_result_type == TEMPERATURE_INPUT) ||
      (m_result_type == TEMPERATURE_CHANGE_INPUT) || (m_result_type == TEMPERATURE_GRADIENT_INPUT) ||
      (m_result_type == NORMAL_STRAIN_INPUT) || (m_result_type == LATERAL_STRAIN_INPUT) ||
      (m_result_type == VOLUMETRIC_STRAIN_INPUT) || (m_result_type == VOLUMETRIC_STRAIN_CHANGE_INPUT)) {
    return true;
  }
...
bool CResultTree::CScalarResult::PrepareMapping(const geo::IElementSet *pElementSet,
                                                const IValueComponentBase *pValueComponent) {
  ...
  case PORE_PRESSURE_CHANGE_INPUT:
    ...
    if (!vm->PrepareMappingComponent(*pModel, pElementSet, pRegister->DepletionStageEntry().MarkedAsInitialStage(),
                                     CValueMapper::MAP_PRESSURE))
      retval = false;
  /* Fall-through */
  case PORE_PRESSURE_INPUT:
  case PORE_PRESSURE_GRADIENT_INPUT:
  ...
  case TEMPERATURE_CHANGE_INPUT:
    // TemperatureInput Di
    if (!vm->PrepareMappingComponent(*pModel, pElementSet, pRegister->DepletionStageEntry().MarkedAsInitialStage(),
                                     pComponent->AnalysisType().AnalysisType() != CAnalysisType::AT_HEAT
                                         ? CValueMapper::MAP_TEMPERATURE
                                         : CValueMapper::MAP_TEMPERATURE_HEAT))
      retval = false;
  /* Fall-through */
  case TEMPERATURE_INPUT:
  case TEMPERATURE_GRADIENT_INPUT:
    // TemperatureInput
    if (!vm->PrepareMappingComponent(*pModel, pElementSet, pComponent->Stage(),
                                     pComponent->AnalysisType().AnalysisType() != CAnalysisType::AT_HEAT
                                         ? CValueMapper::MAP_TEMPERATURE
                                         : CValueMapper::MAP_TEMPERATURE_HEAT))
      retval = false;
  ...
  case THICKNESS:
    // Thickness
    {
      // Thickness uses the Displacement vectorvalueset, and along the line the existence of results is checked for D0,
      // hence we need it
      int c = pRegister->ColumnNumber(pComponent->AnalysisType(),
                                      pRegister->DepletionStageEntry().MarkedAsInitialStage().Index(), CI_DISPLA_X);
  ...
  case APERTURE_LO_CHANGE:
    ...
    if (!vm->PrepareMappingMaterial(*pModel, pElementSet, pComponent->Stage(),
                                    CValueMapper::MARKED_AS_INITIAL | CValueMapper::CHECK_CEMENT |
                                        CValueMapper::CHECK_MARKED_VS_INITIAL))
      retval = false;
    break;
  case PLASTIC_ENERGY:
    // PlasticEnergy
  ...
  case VOLUMETRIC_STRAIN_CHANGE_INPUT:
    ...
    if (!pModel->DepletionStageEntry().MarkedAsInitialStage().Initial()) {
      if (!vm->PrepareMappingComponent(*pModel, pElementSet, pRegister->DepletionStageEntry().MarkedAsInitialStage(),
                                       CValueMapper::MAP_VOLUMETRIC_STRAIN))
        retval = false;
    }
  /* Fall-through */
  case VOLUMETRIC_STRAIN_INPUT:
...
CResultTree::CScalarResult::CTensorParallelInitializationCallback::CTensorParallelInitializationCallback(
    CModelBase &model)
    : ITensorGroupTemplate<CStrainTensor>::CParallelInitializationCallback(model), m_cb(model), m_ScalarVectors(8),
...
_ITensorResultCache &
CResultTree::CScalarResult::CTensorParallelInitializationCallback::GetCache(const ITensorGroup *caller,
                                                                            const IResultComponent &component) const {
...
void CResultTree::CScalarResult::CTensorParallelInitializationCallback::initVector(
    std::vector<std::vector<Value>> &vectors, size_t index, size_t size) {
...
CResultTree::CScalarResult::CTensorParallelInitializationCallback::getScalarVector(size_t index, size_t size) {
  initVector<geo::CValue>(m_ScalarVectors, index, size);
  return &m_ScalarVectors[index];
}

CStressTensorValueSet::TValueVec *
CResultTree::CScalarResult::CTensorParallelInitializationCallback::getStressTensorVector(size_t index, size_t size) {
...
//////////////////////////////////////////////////////////////////////
CResultTree::CFaultShearStress::CFaultShearStress(unsigned int uFileIndex, unsigned int uLabelId, CResultGroup &group)
    : CVectorResult(IDS_RG_SHEAR_STRESS, &CResultRegister::FaultShearStress, group, false), m_uLabelId(uLabelId) {
  BuildComponents();
  Index(uFileIndex);
}

bool CResultTree::CFaultShearStress::ValidName(const std::string &name, CResultInfo &resultInfo) const {
  std::string label = VectorExportLabel().toStdString();

  return validateName(resultInfo, name, label, VectorResultComponentList(), "_L|_M|_C|_N");
}

bool CResultTree::CFaultShearStress::OnBuildComponent(const CDepletionStage &stage, const CAnalysisType &antype,
                                                      int /*nRegister*/) const {
  return (antype == CAnalysisType::AT_LINEAR || antype == CAnalysisType::AT_MIXTURE ||
          antype == CAnalysisType::AT_MIXTURE_CONTAINMENT ||
          (antype == CAnalysisType::AT_NONLIN && stage.OutputType() != CDepletionStage::NONE));
...
double CResultTree::CFaultShearStress::ConvertToField(const double &dValue) const { return dValue * FF_FACTOR_STRESS; }

QString CResultTree::CFaultShearStress::ExportLabel(int nComponent) const {
  return VectorExportLabel() + IVectorResult::ExportLabel(nComponent);
}

QString CResultTree::CFaultShearStress::VectorExportLabel() const { return getStringTableEntry(m_uLabelId); }

bool CResultTree::CFaultShearStress::CanMap(const COpenGLNode &node, int nRegister) const {
  return CanMapOnFaultElements(node, nRegister);
}

bool CResultTree::CFaultShearStress::isFaultResult() const { return true; }
...
bool CResultTree::CFaultShearStress::PrepareMapping(const geo::IElementSet * /*pElementSet*/,
                                                    const IValueComponentBase *pValueComponent) {
  bool retval = true;
  ...
  int c0 = pRegister->ColumnNumber(pComponent->AnalysisType(),
                                   pRegister->DepletionStageEntry().MarkedAsInitialStage().Index(), CI_STRESS_XX);
...
CResultTree::CFaultShearStressLengthChangeComposite::CFaultShearStressLengthChangeComposite(unsigned int /*uName*/,
...
CResultTree::CFaultShearStressLengthChangeComposite::CFaultShearStressLengthChangeComposite(const QString & /*sName*/,
                                                                                            unsigned int uLabelId,
                                                                                            CResultGroup &group)
    : CVectorResult(IDS_RG_SHEAR_STRESS, &CResultRegister::FaultDisplacement, group, false), m_uLabelId(uLabelId) {
  BuildComponents();
}
...
unsigned int CResultTree::CFaultShearStressLengthChangeComposite::IconId() const { return IDI_RESULT; }

bool CResultTree::CFaultShearStressLengthChangeComposite::ValidName(const std::string &name,
                                                                    CResultInfo &resultInfo) const {
  std::string label = VectorExportLabel().toStdString();
...
bool CResultTree::CFaultShearStressLengthChangeComposite::OnBuildComponent(const CDepletionStage &stage,
                                                                           const CAnalysisType &antype,
                                                                           int /*nRegister*/) const {
  return stage.isAfter(stage.Entry().MarkedAsInitialStage()) && antype != CAnalysisType::AT_HEAT;
}

void CResultTree::CFaultShearStressLengthChangeComposite::BuildComponent(const CDepletionStage &stage,
                                                                         const CAnalysisType &antype, int nRegister) {
  if (OnBuildComponent(stage, antype, nRegister))
...
bool CResultTree::CFaultShearStressLengthChangeComposite::isFaultResult() const { return true; }
...
bool CResultTree::CFaultShearStressLengthChangeComposite::PrepareMapping(const geo::IElementSet * /*pElementSet*/,
                                                                         const IValueComponentBase *pValueComponent) {
  bool retval = true;
  ...
  int c0 = pRegister->ColumnNumber(pComponent->AnalysisType(),
                                   pRegister->DepletionStageEntry().MarkedAsInitialStage().Index(), CI_STRESS_XX);
  int d0 = pRegister->ColumnNumber(pComponent->AnalysisType(),
                                   pRegister->DepletionStageEntry().MarkedAsInitialStage().Index(), CI_STRAIN_XX);
  int c1 = pRegister->ColumnNumber(pComponent->AnalysisType(), pComponent->Stage().Index(), CI_STRESS_XX);
...
CResultTree::CFaultShearStressLengthChangeComposite::CFaultShearStressLengthChangeComponent::
    ...
    : IVectorResult::CVectorComponent(uName, parent, (VECTOR_COMPONENT)0, stage, antype, nRegister), m_parent(parent) {}

geo::CValue CResultTree::CFaultShearStressLengthChangeComposite::CFaultShearStressLengthChangeComponent::ValuePoint(
    const geo::IPoint &pt, const IValueComponentBase::UNIT unit) const {
...
void CResultTree::CFaultShearStressLengthChangeComposite::CFaultShearStressLengthChangeComponent::MapValueElement(
    const geo::IElement &elm, IValueDomainScalar::TValueVec &values, IResultComponent::TMapType map_type,
    IValueComponentBase::UNIT unit) const {
  TSourceComponentPair prSources = SourceComponents();
  if (prSources.first == 0)
    return; // invalid
...
const CResultTree::CFaultShearStressLengthChangeComposite &
CResultTree::CFaultShearStressLengthChangeComposite::CFaultShearStressLengthChangeComponent::Composite() const {
  return m_parent;
}
...
bool CResultTree::CFaultShearStressLengthChangeComposite::CFaultShearStressLengthChangeComponent::isFaultResult()
    const {
  return true;
}
...
CResultTree::CRTCIStrainResult::CRTCIStrainResult(CResultGroup &group) : IResult("RTCI Strain", group) {
  BuildComponents();
}

QString CResultTree::CRTCIStrainResult::ExportLabel(int /*nComponent*/) const { return "RTCIStrain"; }
...
bool CResultTree::CRTCIStrainResult::ValidName(const std::string &name, CResultInfo &resultInfo) const {
  std::string label = ExportLabel(0).toStdString();

  return validateName(resultInfo, name, label, "", "_L|_M|_C|_N");
}

bool CResultTree::CRTCIStrainResult::OnBuildComponent(const CDepletionStage &stage, const CAnalysisType &antype,
                                                      int /*nRegister*/) const {
  return stage.isAfter(stage.Entry().MarkedAsInitialStage()) &&
         (antype == CAnalysisType::AT_LINEAR || antype == CAnalysisType::AT_MIXTURE ||
          antype == CAnalysisType::AT_MIXTURE_CONTAINMENT ||
...
void CResultTree::CRTCIStrainResult::BuildComponent(const CDepletionStage &stage, const CAnalysisType &antype,
                                                    int nRegister) {
  if (OnBuildComponent(stage, antype, nRegister))
...
CResultTree::CRTCIStrainResult::CRTCIStrainResultComponent::CRTCIStrainResultComponent(CRTCIStrainResult &result,
                                                                                       const CDepletionStage &stage,
                                                                                       const CAnalysisType &antype,
                                                                                       int nRegister)
    : IResultComponent("", result, stage, antype, nRegister, 0) {}

unsigned int CResultTree::CRTCIStrainResult::CRTCIStrainResultComponent::IconId() const { return IDI_RESULT; }

unsigned int CResultTree::CRTCIStrainResult::CRTCIStrainResultComponent::TypeId() const { return 0; }
...
geo::CValue CResultTree::CRTCIStrainResult::CRTCIStrainResultComponent::ValuePoint(
    const geo::IPoint & /*point*/, const UNIT /*unit*/, geo::IParallelInitializationCallback * /*cb*/) const {
  return geo::CValue();
}

void CResultTree::CRTCIStrainResult::CRTCIStrainResultComponent::MapValueElement(
    const geo::IElement &elm, IValueDomainScalar::TValueVec &values, TMapType /*map_type*/, UNIT /*unit*/,
    geo::IParallelInitializationCallback * /*cb*/) const {
  const CModelBase &model = static_cast<const CModelBase &>(Model());
  const CStrainTensorValueSet &strain =
      model.ResultRegister(RegisterIndex()).TotalStrain(Stage(), AnalysisType(), false);
...
bool CResultTree::CRTCIStrainResult::CRTCIStrainResultComponent::PrepareMapping(
    const geo::IElementSet * /*pElementSet*/) {
  bool retval = true;

  int c = ResultRegister().ColumnNumber(
      AnalysisType(), ResultRegister().DepletionStageEntry().MarkedAsInitialStage().Index(), CI_POREPRES);
...
CResultTree::CResultTree(CModelBase &model)
    : CResultGroup(IDS_RG_ROOT, model), m_pRTCIStrain(0), m_pParentStressInput(0), m_pBoundaryDisplacementInput(0),
  ...
  m_pPorePressureInput =
      new CScalarResult(IDS_RG_ABSOLUTE, IDS_ET_PORE_PRESSURE, *pPressureInput, CScalarResult::PORE_PRESSURE_INPUT);
  m_pPorePressureChangeInput = new CScalarResult(IDS_RG_CHANGE, IDS_ET_PORE_PRESSURE_CHANGE, *pPressureInput,
                                                 CScalarResult::PORE_PRESSURE_CHANGE_INPUT);
  m_pPorePressureGradientInput = new CScalarResult(IDS_RG_GRADIENT, IDS_ET_PORE_PRESSURE_GRADIENT, *pPressureInput,
                                                   CScalarResult::PORE_PRESSURE_GRADIENT_INPUT);

  CResultGroup *pTemperatureInput = new CResultGroup(IDS_RG_TEMPERATURE, *pInput);
  m_pTemperatureInput =
      new CScalarResult(IDS_RG_ABSOLUTE, IDS_ET_TEMPERATURE, *pTemperatureInput, CScalarResult::TEMPERATURE_INPUT);
  m_pTemperatureChangeInput = new CScalarResult(IDS_RG_CHANGE, IDS_ET_TEMPERATURE_CHANGE, *pTemperatureInput,
                                                CScalarResult::TEMPERATURE_CHANGE_INPUT);
  m_pTemperatureGradientInput = new CScalarResult(IDS_RG_GRADIENT, IDS_ET_TEMPERATURE_GRADIENT, *pTemperatureInput,
                                                  CScalarResult::TEMPERATURE_GRADIENT_INPUT);
  ...
  m_pVolumetricStrainInput = new CScalarResult(IDS_RG_ABSOLUTE, IDS_ET_VOLUMETRICSTRAIN, *pVolumetricStrainInput,
                                               CScalarResult::VOLUMETRIC_STRAIN_INPUT);
  m_pVolumetricStrainChangeInput =
      new CScalarResult(IDS_RG_CHANGE, IDS_ET_VOLUMETRICSTRAIN_CHANGE, *pVolumetricStrainInput,
                        CScalarResult::VOLUMETRIC_STRAIN_CHANGE_INPUT);

  CResultGroup *pNormalStrainInput = new CResultGroup(IDS_VALUENAME_NRMSTRAIN, *pStrainInput);
  CResultGroup *pLateralStrainInput = new CResultGroup(IDS_VALUENAME_LATSTRAIN, *pStrainInput);

  new CScalarResult(IDS_RG_ABSOLUTE, IDS_ET_NRMSTRAIN, *pNormalStrainInput, CScalarResult::NORMAL_STRAIN_INPUT);
  new CScalarResult(IDS_RG_ABSOLUTE, IDS_ET_LATSTRAIN, *pLateralStrainInput, CScalarResult::LATERAL_STRAIN_INPUT);
  ...
  m_pFaultPressureInput = new CFaultScalarResult(IDS_RG_ABSOLUTE, IDS_ET_FAULT_PRESSURE, *pFaultPressureInput,
                                                 CFaultScalarResult::PORE_PRESSURE_INPUT);
  m_pFaultPressureChangeInput =
      new CFaultScalarResult(IDS_RG_CHANGE, IDS_ET_FAULT_PRESSURE_CHANGE, *pFaultPressureInput,
                             CFaultScalarResult::PORE_PRESSURE_CHANGE_INPUT);

  if (isWellModel) {
    CResultGroup *pBoundaryInput = new CResultGroup(IDS_RG_BOUNDARY_INPUT, *pInput);
    m_pBoundaryPressureInput = new CFaultScalarResult(IDS_RG_BOUNDARY_PRESSURE, IDS_ET_BOUNDARY_PRESSURE,
                                                      *pBoundaryInput, CFaultScalarResult::BOUNDARY_PRESSURE_INPUT);
    m_pBoundaryDisplacementInput =
        new CFaultScalarResult(IDS_RG_BOUNDARY_DISPLACEMENT, IDS_ET_BOUNDARY_DISPLACEMENT, *pBoundaryInput,
                               CFaultScalarResult::BOUNDARY_DISPLACEMENT_INPUT);
  ...
  m_pGammaVertical =
      new CScalarResult(IDS_RC_GAMMA_VERTICAL, IDS_ET_GAMMA_VERTICAL, *pGammaGroup, CScalarResult::GAMMA_VERTICAL);
  ...
  m_pGammaVolume =
      new CScalarResult(IDS_RC_GAMMA_VOLUME, IDS_ET_GAMMA_VOLUME, *pGammaGroup, CScalarResult::GAMMA_VOLUME);
  m_pVolumeAverage =
      new CScalarResult(IDS_RC_VOLUME_AVERAGE, IDS_RG_GAMMA, *pGammaGroup, CScalarResult::VOLUME_AVERAGE);
  // Shear capacity
  m_pShearCapacity =
      new CScalarResult(IDS_RC_SHEAR_CAPACITY, IDS_ET_SHEAR_CAPACITY, *pStressGroup, CScalarResult::SHEAR_CAPACITY);
  m_pCompactionCapacity = new CScalarResult(IDS_RC_COMPACTION_CAPACITY, IDS_ET_COMPACTION_CAPACITY, *pStressGroup,
                                            CScalarResult::COMPACTION_CAPACITY);
  ...
  m_pConsolidationChange =
      new CScalarResult(IDS_RG_CHANGE, IDS_ET_CONSOL_CHANGE, *pConsolidation, CScalarResult::CONSOL_CHANGE);

  // Stress Ratios    wjrx mantis 2870
  CResultGroup *pStressRatios = new CResultGroup(IDS_RG_STRESSRATIOS, *pStressGroup);
  m_pSHtotAzimuth =
      new CScalarResult(IDS_RC_SHTOTAZIMUTH, IDS_ET_SHTOTAZIMUTH, *pStressRatios, CScalarResult::SHTOTAZIMUTH);
  m_pSHtotSvtot = new CScalarResult(IDS_RC_SHTOT_SVTOT, IDS_ET_SHTOT_SVTOT, *pStressRatios, CScalarResult::SHTOT_SvTOT);
  m_pShtotSvtot =
      new CScalarResult(IDS_RC_S_HTOT_SVTOT, IDS_ET_S_HTOT_SVTOT, *pStressRatios, CScalarResult::ShTOT_SvTOT);
  ...
  m_pPorePressure =
      new CScalarResult(IDS_RG_ABSOLUTE, IDS_ET_PORE_PRESSURE, *pPorePressure, CScalarResult::PORE_PRESSURE);
  m_pPorePressureChange = new CScalarResult(IDS_RG_CHANGE, IDS_ET_PORE_PRESSURE_CHANGE, *pPorePressure,
                                            CScalarResult::PORE_PRESSURE_CHANGE);
  m_pPorePressureGradient = new CScalarResult(IDS_RG_GRADIENT, IDS_ET_PORE_PRESSURE_GRADIENT, *pPorePressure,
                                              CScalarResult::PORE_PRESSURE_GRADIENT);

  // Fracture Matrix Pressure
  CResultGroup *pFractureMatrixPressure = new CResultGroup(IDS_RG_FRACTURE_MATRIX_PRESSURE, *pPressure);
  m_pFractureMatrixPressure = new CScalarResult(IDS_RG_ABSOLUTE, IDS_ET_FRACTURE_MATRIX_PRESSURE,
                                                *pFractureMatrixPressure, CScalarResult::FRACTURE_MATRIX_PRESSURE);
  m_pFractureMatrixPressureChange =
      new CScalarResult(IDS_RG_CHANGE, IDS_ET_FRACTURE_MATRIX_PRESSURE_CHANGE, *pFractureMatrixPressure,
                        CScalarResult::FRACTURE_MATRIX_PRESSURE_CHANGE);
  ...
  m_pTemperatureChange =
      new CScalarResult(IDS_RG_CHANGE, IDS_ET_TEMPERATURE_CHANGE, *pTemperature, CScalarResult::TEMPERATURE_CHANGE);
  m_pTemperatureGradient = new CScalarResult(IDS_RG_GRADIENT, IDS_ET_TEMPERATURE_GRADIENT, *pTemperature,
                                             CScalarResult::TEMPERATURE_GRADIENT);
  ...
  m_pPorosityChange =
      new CScalarResult(IDS_RG_CHANGE, IDS_ET_POROSITY_RES_CHANGE, *pPorosity, CScalarResult::POROSITY_CHANGE);
  ...
  m_pPlasticEnergy = new CScalarResult(IDS_RG_PLASTIC_ENERGY, IDS_ET_PLASTIC_ENERGY, *pPlasticEnergyGroup,
                                       CScalarResult::PLASTIC_ENERGY);
  ...
  m_pThicknessChange =
      new CScalarResult(IDS_RG_CHANGE, IDS_ET_THICKNESS_CHANGE, *pThicknessGroup, CScalarResult::THICKNESS_CHANGE);

  // Fractures result
  CResultGroup *pFractureAperture = new CResultGroup(IDS_RG_FRACTURE_APERTURE, *pOutput);
  CResultGroup *pFractureApertureAbs = new CResultGroup(IDS_RG_ABSOLUTE, *pFractureAperture);
  m_pAperture.insert(
      std::make_pair(CScalarResult::APERTURE_HI,
                     m_pApertureHi = new CScalarResult(IDS_APERTURE_HI, IDS_ET_APERTURE_HI, *pFractureApertureAbs,
                                                       CScalarResult::APERTURE_HI)));
  m_pAperture.insert(
      std::make_pair(CScalarResult::APERTURE_ME,
                     m_pApertureMe = new CScalarResult(IDS_APERTURE_ME, IDS_ET_APERTURE_ME, *pFractureApertureAbs,
                                                       CScalarResult::APERTURE_ME)));
  m_pAperture.insert(
      std::make_pair(CScalarResult::APERTURE_LO,
                     m_pApertureLo = new CScalarResult(IDS_APERTURE_LO, IDS_ET_APERTURE_LO, *pFractureApertureAbs,
                                                       CScalarResult::APERTURE_LO)));
  CResultGroup *pFractureApertureChange = new CResultGroup(IDS_RG_CHANGE, *pFractureAperture);
  m_pAperture.insert(std::make_pair(CScalarResult::APERTURE_HI_CHANGE,
                                    m_pApertureHiChange = new CScalarResult(IDS_APERTURE_HI, IDS_ET_APERTURE_HI_CHANGE,
                                                                            *pFractureApertureChange,
                                                                            CScalarResult::APERTURE_HI_CHANGE)));
  m_pAperture.insert(std::make_pair(CScalarResult::APERTURE_ME_CHANGE,
                                    m_pApertureMeChange = new CScalarResult(IDS_APERTURE_ME, IDS_ET_APERTURE_ME_CHANGE,
                                                                            *pFractureApertureChange,
                                                                            CScalarResult::APERTURE_ME_CHANGE)));
  m_pAperture.insert(std::make_pair(CScalarResult::APERTURE_LO_CHANGE,
                                    m_pApertureLoChange = new CScalarResult(IDS_APERTURE_LO, IDS_ET_APERTURE_LO_CHANGE,
                                                                            *pFractureApertureChange,
                                                                            CScalarResult::APERTURE_LO_CHANGE)));
  CResultGroup *pPermeabilityMultiplier = new CResultGroup(IDS_RG_PERMEABILITY_MULTIPLIER, *pFractureAperture);
  m_pAperture.insert(std::make_pair(CScalarResult::PERMEABILITY_MULTIPLIER_HI,
                                    m_pPermeabilityMultiplierHi = new CScalarResult(
                                        IDS_PERMEABILITY_MULTIPLIER_HI, IDS_ET_PERMEABILITY_MULTIPLIER_HI,
                                        *pPermeabilityMultiplier, CScalarResult::PERMEABILITY_MULTIPLIER_HI)));
  m_pAperture.insert(std::make_pair(CScalarResult::PERMEABILITY_MULTIPLIER_ME,
                                    m_pPermeabilityMultiplierMe = new CScalarResult(
                                        IDS_PERMEABILITY_MULTIPLIER_ME, IDS_ET_PERMEABILITY_MULTIPLIER_ME,
                                        *pPermeabilityMultiplier, CScalarResult::PERMEABILITY_MULTIPLIER_ME)));
  m_pAperture.insert(std::make_pair(CScalarResult::PERMEABILITY_MULTIPLIER_LO,
                                    m_pPermeabilityMultiplierLo = new CScalarResult(
                                        IDS_PERMEABILITY_MULTIPLIER_LO, IDS_ET_PERMEABILITY_MULTIPLIER_LO,
                                        *pPermeabilityMultiplier, CScalarResult::PERMEABILITY_MULTIPLIER_LO)));
  ...
  m_pFaultDilatation = new CFaultScalarResult(IDS_RC_FAULT_DILATATION, IDS_ET_FAULT_DILATATION, *pFaultDisplacement,
                                              CFaultScalarResult::DILATATION);
  ...
  m_pFaultPlasticEnergy = new CFaultScalarResult(IDS_RG_FAULT_PLASTIC_ENERGY, IDS_ET_FAULT_PLASTIC_ENERGY,
                                                 *pFaultPlasticEnergy, CFaultScalarResult::PLASTIC_ENERGY);
  // Create the stress group
  CResultGroup *pFaultStress = new CResultGroup(IDS_RG_FAULT_STRESS, *pFaultGroup);
  m_pFaultShearCapacity = new CFaultScalarResult(IDS_RC_SHEAR_CAPACITY, IDS_ET_FAULT_SHEARCAPACITY, *pFaultStress,
                                                 CFaultScalarResult::SHEAR_CAPACITY);
  CResultGroup *pFaultAbsolute = new CResultGroup(IDS_RG_ABSOLUTE, *pFaultStress);
  m_pFaultTotalNormalStress = new CFaultNormalStress(RC_FAULT_TOTAL_NORMAL_STRESS, IDS_FAULT_TOTAL_NORMAL_STRESS,
                                                     IDS_ET_FAULT_TOTAL_NORMAL_STRESS, *pFaultAbsolute, true, false);
  m_pFaultEffectiveNormalStress = new CFaultNormalStress(RC_FAULT_EFF_NORMAL_STRESS, IDS_FAULT_EFF_NORMAL_STRESS,
                                                         IDS_ET_FAULT_EFF_NORMAL_STRESS, *pFaultAbsolute, false, false);
  m_pFaultShearStress = new CFaultShearStress(RC_FAULT_SHEAR_STRESS, IDS_ET_FAULT_SHEAR_STRESS, *pFaultAbsolute);

  CResultGroup *pFaultChange = new CResultGroup(IDS_RG_CHANGE, *pFaultStress);
  m_pFaultTotalNormalStressChange =
      new CFaultNormalStress(RC_FAULT_TOTAL_NORMAL_STRESS_CHANGE, IDS_FAULT_TOTAL_NORMAL_STRESS,
                             IDS_ET_FAULT_TOTAL_NORMAL_STRESS, *pFaultChange, true, true);
  m_pFaultEffectiveNormalStressChange =
      new CFaultNormalStress(RC_FAULT_EFF_NORMAL_STRESS_CHANGE, IDS_FAULT_EFF_NORMAL_STRESS,
                             IDS_ET_FAULT_EFF_NORMAL_STRESS, *pFaultChange, false, true);
  m_pFaultShearStresschange = new CFaultShearStressLengthChangeComposite(
      RC_FAULT_SHEAR_STRESS_CHANGE, IDS_ET_FAULT_SHEAR_STRESS_CHANGE, *pFaultChange);
  ...
  m_pFaultPressure = new CFaultScalarResult(IDS_RG_ABSOLUTE, IDS_ET_FAULT_PRESSURE, *pFaultPressure,
                                            CFaultScalarResult::PORE_PRESSURE);
  m_pFaultPressureChange = new CFaultScalarResult(IDS_RG_CHANGE, IDS_ET_FAULT_PRESSURE_CHANGE, *pFaultPressure,
                                                  CFaultScalarResult::PORE_PRESSURE_CHANGE);
...
CThicknessParallelInitializationCallback::CThicknessParallelInitializationCallback(
    ...
    : m_parent(parent),
      m_pmpDisplacementCache(new CResultTree::CScalarResult::CScalarResultComponent::TDisplacementMap()) {}

CThicknessParallelInitializationCallback::~CThicknessParallelInitializationCallback() {
  CValueMapper *vm = CValueMapper::instance();

  // we transfer ownership of the pointers to CValueMapper
  for (TFormationVolumeThicknessCacheMap::iterator it = m_mpFormationVolumeThicknessCache.begin();
       it != m_mpFormationVolumeThicknessCache.end(); ++it) {
    vm->Add(it->first, it->second);
  }
  vm->Add(&m_parent, m_pmpDisplacementCache);
}

void CThicknessParallelInitializationCallback::GetCache(const CFormationVolume *pVolume,
                                                        CFormationVolume::TThicknessCache **pCache) {
  *pCache = m_mpFormationVolumeThicknessCache
                .insert(TFormationVolumeThicknessCacheMap::value_type(pVolume, new CFormationVolume::TThicknessCache()))
                .first->second;
}

void CThicknessParallelInitializationCallback::GetCache(
    CResultTree::CScalarResult::CScalarResultComponent::TDisplacementMap **pCache) {
  *pCache = m_pmpDisplacementCache;
}

CAvgVolumeParallelInitializationCallback::CAvgVolumeParallelInitializationCallback(
    CModelBase &model, CResultTree::CScalarResult::CScalarResultComponent &parent)
    : CResultTree::CScalarResult::CTensorParallelInitializationCallback(model), m_parent(parent),
...
void CAvgVolumeParallelInitializationCallback::GetCache(
    CResultTree::CScalarResult::CScalarResultComponent::TFormAvgVolMap **cache) {
  *cache = m_pmpValues;
}
