...
//////////////////////////////////////////////////////////////////////
IVectorResult::IVectorResult(unsigned int uName, CResultGroup& group)
: IResult(uName, group)
{
}

IVectorResult::IVectorResult(const QString& sName, CResultGroup& group)
: IResult(sName, group)
{
}
...
//////////////////////////////////////////////////////////////////////
IVectorResult::IVectorComponent::IVectorComponent(unsigned int uComponentName, IVectorResult& parent, VECTOR_COMPONENT component, const CDepletionStage& stage, const CAnalysisType& antype, int nRegister)
  : IResultComponent(uComponentName, parent, stage, antype, nRegister, (int)component)
{
}

IVectorResult::IVectorComponent::IVectorComponent(IVectorResult& parent, const CDepletionStage& stage, const CAnalysisType& antype, int nRegister)
  : IResultComponent("Full Vector", parent, stage, antype, nRegister, 4)
{
}


IVectorResult::CVectorComponent::CVectorComponent(unsigned int uComponentName, IVectorResult& parent, VECTOR_COMPONENT component, const CDepletionStage& stage, const CAnalysisType& antype, int nRegister)
...
bool IVectorResult::CVectorComponent::NeedParallelInitializationCallback() const
{
  return true;
}
...
IVectorResult::CFullVectorComponent::CVectorData::CVectorData(const CFullVectorComponent& parent) : m_Parent(&parent), m_Min(DBL_MAX), m_Max(-DBL_MAX)
{
  assert(m_Parent);
}
...
IValueDomainVector::TMinMax IVectorResult::CFullVectorComponent::CVectorData::MinMax(IProgressBase &, const IValueDataInterface::UNIT) const
{
  return IValueDomainVector::TMinMax(geo::CVector(m_Min, m_Min, m_Min), geo::CVector(m_Max, m_Max, m_Max));
}

IValueDomainVector::TValue IVectorResult::CFullVectorComponent::CVectorData::ValuePoint(const geo::IPoint &/*pt*/, const IValueDataInterface::UNIT /*unit*/, geo::IParallelInitializationCallback* /*cb*/) const
{
  return IValueDomainVector::TValue();
}

IValueDomainVector::TValueVec IVectorResult::CFullVectorComponent::CVectorData::ValueElement(const geo::IElement &elt, const IValueDataInterface::UNIT unit, geo::IParallelInitializationCallback *cb) const 
{
...
IValueDomainVector::TValue IVectorResult::CFullVectorComponent::CVectorData::Average(IProgressBase&, const IValueDataInterface::UNIT) const
{
  return IValueDomainVector::TValue();
}


IVectorResult::CFullVectorComponent::CFullVectorComponent(IVectorResult& parent, const CDepletionStage& stage, const CAnalysisType& antype, int nRegister)
...
void IVectorResult::CFullVectorComponent::MapValueElement(const geo::IElement& /*elm*/, IValueDomainScalar::TValueVec& /*values*/, TMapType /*map_type*/, UNIT /*unit*/, geo::IParallelInitializationCallback * /*cb*/) const
{
}
...
bool IVectorResult::CFullVectorComponent::NeedParallelInitializationCallback() const
{
  return true;
}
...
const IValueDataInterfaceVector* IVectorResult::CFullVectorComponent::VectorData() const
{
  return &m_Data;
}

IValueDataInterfaceVector* IVectorResult::CFullVectorComponent::VectorData()
{
  return &m_Data;
}

void IVectorResult::CFullVectorComponent::ResetMinMax() const
{
  m_Data.ResetMinMax();
}
...
CVectorResult::_ResultCache& CVectorResult::CParallelInitializationCallback::GetCache(const IResultComponent& component) const
{
...
bool CVectorResult::PrepareMapping(const geo::IElementSet* /*pElementSet*/, const IValueComponentBase* /*pValueComponent*/)
{
  return true;
}
