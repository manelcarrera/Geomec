...
const Units::CUnitType Units::DimensionLessUnit(IDS_UNIT_DIMENSIONLESS, IDS_UNIT_DIMENSIONLESS,
...
const Units::CUnitType Units::StressGradientUnit(IDS_UNIT_SI_STRESSGRADIENT, IDS_UNIT_FIELD_STRESSGRADIENT,
                                                 FF_FACTOR_STRESSGRADIENT);
const Units::CUnitType Units::ThermalConductUnit(IDS_UNIT_SI_THERM_CONDUCT, IDS_UNIT_FIELD_THERM_CONDUCT,
                                                 FF_FACTOR_THERM_CONDUCT);
const Units::CUnitType Units::ThermalCapaciUnit(IDS_UNIT_SI_THERM_CAPACI, IDS_UNIT_FIELD_THERM_CAPACI,
                                                FF_FACTOR_THERM_CAPACI);
...
//////////////////////////////////////////////////////////////////////
CValueComponent::CValueSet::CValueSet(const CValueComponent &component) : m_component(component) {}
...
void CValueComponent::CValueSet::ElementValues(TValueVec &values, int iElementIndex,
...
void CValueComponent::CValueSet::Empty() { assert(false); }

bool CValueComponent::CValueSet::IsEmpty() const { return false; }
...
//////////////////////////////////////////////////////////////////////
CValueComponent::CValueComponent(unsigned int uName, CValueType &value_type, IValueSet &value_set,
                                 unsigned int uComponent, unsigned int uMode)
...
CValueComponent::CValueComponent(const QString &sName, CValueType &value_type, IValueSet &value_set,
                                 unsigned int uComponent, unsigned int uMode)
...
CValueComponent::CValueComponent(unsigned int uName, CValueType &value_type, unsigned int uComponent,
                                 unsigned int uMode)
    : IValueComponentBase(uName, value_type, uComponent, uMode), m_pValueSet(0), m_pSIValueSet(0), m_pFieldValueSet(0),
      m_Data(*this) {}

CValueComponent::CValueComponent(const QString &sName, CValueType &value_type, unsigned int uComponent,
                                 unsigned int uMode)
    : IValueComponentBase(sName, value_type, uComponent, uMode), m_pValueSet(0), m_pSIValueSet(0), m_pFieldValueSet(0),
      m_Data(*this) {}

CValueComponent::CValueComponent(CValueType &value_type, IValueSet &value_set, unsigned int uComponent,
                                 unsigned int uMode)
...
CValueComponent::CValueComponent(const CValueComponent &rhs)
    : IValueComponentBase(rhs), m_pValueSet(rhs.m_pValueSet), m_pSIValueSet(0), m_pFieldValueSet(0), m_Data(*this) {}
...
const IValueDataInterfaceScalar &CValueComponent::ScalarData() const { return m_Data; }

IValueDataInterfaceScalar &CValueComponent::ScalarData() { return m_Data; }
...
bool CValueComponent::Defined() const { return m_pValueSet != 0; }

IValueDomainScalar::TMinMax CValueComponent::MinMax(IProgressBase & /*progressBase*/,
...
IValueDomainScalar::TValue CValueComponent::Average(IProgressBase & /*progressBase*/,
                                                    const CQuantity::UNIT unit) const {
  assert(Defined());
...
IValueDomainScalar::TValue CValueComponent::ValuePoint(const geo::IPoint &pt, const CQuantity::UNIT unit,
                                                       geo::IParallelInitializationCallback *cb) const {
...
IValueDomainScalar::TValue CValueComponent::InterpolateValuePoint(const geo::IPoint &pt, const CQuantity::UNIT unit,
                                                                  geo::IParallelInitializationCallback *cb) const {
  const CValueType *pType = dynamic_cast<const CValueType *>(&Parent());
  assert(pType);
  geo::CValue value;
...
IValueDomainScalar::TValueVec CValueComponent::ValueElement(const geo::IElement &elm, const CQuantity::UNIT unit,
                                                            geo::IParallelInitializationCallback *cb) const {
  ...
  } else if ((value_type.MapType() == CValueType::MT_POINT) ||
             (value_type.PointSet().Dimension() == IPointSet::DIM_1D)) {
    if (!MapValueSet(unit).GetSmoothedNodalValues(elm, vcRet, cb) ||
        (value_type.PointSet().Dimension() == IPointSet::DIM_1D)) {
      for (int i = 0; i < elm.NrOfPoints(); i++)
        vcRet[i] = InterpolateValuePoint(elm.Point(i), unit, cb);
    }
