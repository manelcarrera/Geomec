...
inline double hash_round(double d) { return round(d * 1E8) / 1E8; }
...
CCacheInterface::CCacheInterface(CCacheManager &parent, const geo::IElementSet *elt_set)
    : m_parent(&parent), m_elt_set(elt_set) {
...
bool CCacheInterface::NeedsDelete() { return true; }
...
geo::CPoint CCacheInterface::Min(int nIndex) { return m_min[nIndex]; }

void CCacheInterface::Min(int nIndex, geo::CPoint &Point) { m_min[nIndex] = Point; }

geo::CPoint CCacheInterface::Max(int nIndex) { return m_max[nIndex]; }

void CCacheInterface::Max(int nIndex, geo::CPoint &Point) { m_max[nIndex] = Point; }

geo::CElementPoint CCacheInterface::Mid(int nIndex) { return m_mid[nIndex]; }

void CCacheInterface::Mid(int nIndex, geo::CElementPoint &ElementPoint) { m_mid[nIndex] = ElementPoint; }
...
void CCacheInterface::ElementCacheObject(const geo::IElementSet *elt_set, int nIndex,
                                         geo::CElementCacheObject &ElementCacheObject) {
...
bool CCacheInterface::Cached(const geo::IElementSet *elt_set) { return m_cache_objects.count(elt_set) > 0; }
