...
IStressTensorGroup::IStressTensorGroup(unsigned int uResultName, TValueSetFunction function, CResultGroup& group, bool bChange)
: ITensorGroupTemplate<CStressTensor>(uResultName, function, group)
, m_bChange(bChange)
, m_pInVariant(0)
, m_pWPStressComposite(0)
, m_pVerticalGradientComposite(0)
{
...
IStressTensorGroup::IStressTensorGroup(const QString& sResultName, TValueSetFunction function, CResultGroup& group, bool bChange)
: ITensorGroupTemplate<CStressTensor>(sResultName, function, group)
, m_bChange(bChange)
, m_pInVariant(0)
, m_pWPStressComposite(0)
, m_pVerticalGradientComposite(0)
...
IStressTensorGroup::MaxPrincipleLengthChange() const
{
  return m_pLengthChange[CPrincipalLengthChangeComposite::PD_MAX];
}

const IStressTensorGroup::CPrincipalLengthChangeComposite *
IStressTensorGroup::MedPrincipleLengthChange() const
{
  return m_pLengthChange[CPrincipalLengthChangeComposite::PD_MED];
}

const IStressTensorGroup::CPrincipalLengthChangeComposite *
IStressTensorGroup::MinPrincipleLengthChange() const
{
...
IStressTensorGroup::CPrincipalLengthChangeComposite::CPrincipalLengthChangeComposite(unsigned int uName, CResultGroup& group, PRINCIPAL_DIRECTION direction)
...
IStressTensorGroup::CPrincipalLengthChangeComposite::CPrincipalLengthChangeComposite(const QString& name, CResultGroup& group, PRINCIPAL_DIRECTION direction)
...
unsigned int IStressTensorGroup::CPrincipalLengthChangeComposite::IconId() const
{
  return IDI_RESULT;
}
...
bool IStressTensorGroup::CPrincipalLengthChangeComposite::ValidName
...
geo::IParallelInitializationCallback *IStressTensorGroup::CPrincipalLengthChangeComposite::GetParallelInitializationCallback()
{
...
bool IStressTensorGroup::CPrincipalLengthChangeComposite::PrepareMapping(const geo::IElementSet *pElementSet, const IValueComponentBase *pValueComponent)
{
  bool retval = true;
  ITensorGroup *pGroup = dynamic_cast<ITensorGroup *>(Parent());
...
IStressTensorGroup::CPrincipalLengthChangeComposite::CLengthChangeComponent::CLengthChangeComponent(unsigned int /*uName*/,
                                                                                                                      CPrincipalLengthChangeComposite& parent,
...
IStressTensorGroup::CPrincipalLengthChangeComposite::CLengthChangeComponent::CLengthChangeComponent(const QString& /*sName*/,
                                                                                                                      CPrincipalLengthChangeComposite& parent,
                                                                                                                      const CDepletionStage& stage,
                                                                                                                      const CAnalysisType& antype,
                                                                                                                      int nRegister)
...
geo::CValue IStressTensorGroup::CPrincipalLengthChangeComposite::CLengthChangeComponent::ValuePoint(const geo::IPoint& pt, const IValueComponentBase::UNIT unit, geo::IParallelInitializationCallback *cb) const
{
...
void IStressTensorGroup::CPrincipalLengthChangeComposite::CLengthChangeComponent::MapValueElement(const geo::IElement& elm, IValueDomainScalar::TValueVec& values, IResultComponent::TMapType map_type, IValueComponentBase::UNIT unit, geo::IParallelInitializationCallback *cb) const
{
  TSourceComponentPair prSources = SourceComponents();
  if(prSources.first == 0)
...
const IStressTensorGroup::CPrincipalLengthChangeComposite& IStressTensorGroup::CPrincipalLengthChangeComposite::CLengthChangeComponent::Composite() const
{
  return static_cast<const CPrincipalLengthChangeComposite&>(Parent());
}

const IStressTensorGroup& IStressTensorGroup::CPrincipalLengthChangeComposite::CLengthChangeComponent::AbsoluteStressTensorGroup() const
{
  return Composite().AbsoluteStressTensorGroup();
}

const IStressTensorGroup& IStressTensorGroup::CPrincipalLengthChangeComposite::CLengthChangeComponent::ChangeStressTensorGroup() const
{
...
bool IStressTensorGroup::CPrincipalLengthChangeComposite::CLengthChangeComponent::NeedParallelInitializationCallback() const
{
  return true;
}
...
bool IStressTensorGroup::CInvariantComposite::CInvariantComponent::PrepareMapping(const geo::IElementSet* /*pElementSet*/)
{
  bool retval = true;
...
{
  return 
  ((  dynamic_cast<const CNewWellPath*>(&node) != 0 // waij TFS 74145
  || ( dynamic_cast<const CWellCasingModel*>(&Model()) != 0))
  && dynamic_cast<const CWellCasingRTCI*>(&node) == 0
  );
}

bool IStressTensorGroup::CWellPathStressComposite::ValidName
( const std::string &name
, CResultInfo &resultInfo
) const
{
...
geo::IParallelInitializationCallback *IStressTensorGroup::CWellPathStressComposite::GetParallelInitializationCallback()
{
  ITensorGroup *pGroup = dynamic_cast<ITensorGroup *>(Parent());
  if (pGroup)
    return pGroup->GetParallelInitializationCallback();
...
bool IStressTensorGroup::CWellPathStressComposite::PrepareMapping(const geo::IElementSet *pElementSet, const IValueComponentBase *pValueComponent)
{
  bool retval = true;
  ITensorGroup *pGroup = dynamic_cast<ITensorGroup *>(Parent());
  if (!pGroup || !pGroup->PrepareMapping(pElementSet, pValueComponent))
...
unsigned int IStressTensorGroup::CWellPathStressComposite::CWellPathStressComponent::TypeId() const
{
  return 0;
}
...
void IStressTensorGroup::CWellPathStressComposite::CWellPathStressComponent::MapValueElement(const geo::IElement& elm,
...
unsigned int IStressTensorGroup::CVerticalGradientComposite::IconId() const
{
  return IDI_RESULT;
}
...
bool IStressTensorGroup::CVerticalGradientComposite::PrepareMapping(const geo::IElementSet *pElementSet, const IValueComponentBase *pValueComponent)
{
  bool retval = true;
  ITensorGroup *pGroup = dynamic_cast<ITensorGroup *>(Parent());
  if (!pGroup || !pGroup->PrepareMapping(pElementSet, pValueComponent))
...
IStressTensorGroup::CVerticalGradientComposite::CVerticalGradientComponent::CVerticalGradientComponent(unsigned int uName,
                                                                                                       CVerticalGradientComposite& parent,
                                                                                                       const CDepletionStage& stage,
                                                                                                       const CAnalysisType& antype,
                                                                                                       int nRegister)
...
unsigned int IStressTensorGroup::CVerticalGradientComposite::CVerticalGradientComponent::TypeId() const
{
  return 0;
}
...
IValueDomainScalar::TValue IStressTensorGroup::CVerticalGradientComposite::CVerticalGradientComponent::ValuePoint(const geo::IPoint& pt, const UNIT unit, geo::IParallelInitializationCallback *cb) const
{
  return GradientValuePoint(pt, unit, cb);
}

void IStressTensorGroup::CVerticalGradientComposite::CVerticalGradientComponent::MapValueElement(const geo::IElement& elm, IValueDomainScalar::TValueVec& values, TMapType map_type, UNIT unit, geo::IParallelInitializationCallback *cb) const
{
  return VerticalComponent().MapValueElement(elm, values, map_type, unit, cb);
}

IValueDomainScalar::TValue IStressTensorGroup::CVerticalGradientComposite::CVerticalGradientComponent::Value(const geo::IElement& /*mesh_element*/, int /*nNodeIndex*/, UNIT /*unit*/) const
{
  assert(false);
  return IValueDomainScalar::TValue();
}

const IResultComponent& IStressTensorGroup::CVerticalGradientComposite::CVerticalGradientComponent::VerticalComponent() const
{
  ...
  return *tensorgroup.Components().ResultComponent(Stage(), AnalysisType(), RegisterIndex(), ITensorGroup::CComponentComposite::TC_ZZ);
}

bool IStressTensorGroup::CVerticalGradientComposite::CVerticalGradientComponent::NeedParallelInitializationCallback() const
{
  return true;
}

bool IStressTensorGroup::CVerticalGradientComposite::CVerticalGradientComponent::PrepareMapping(const geo::IElementSet* pElementSet)
{
  bool retval = true;
