...
const QString& CLogASCIIStandardFile::CLasDataLine::Mnemonic() const
{
  return m_strMnemonic;
}

const QString& CLogASCIIStandardFile::CLasDataLine::Unit() const
{
  return m_strUnit;
}

const QString& CLogASCIIStandardFile::CLasDataLine::Data() const
{
  return m_strData;
}

const QString& CLogASCIIStandardFile::CLasDataLine::Description() const
{
...
CLogASCIIStandardFile::CCurveDataLine::CCurveDataLine(const QString& strLine, int nLineNr, const CLogASCIIStandardFile& lasFile)
{
...
CLogASCIIStandardFile::CException::CException(const QString& strError)
: m_strError(strError)
{
}
...
const QString& CLogASCIIStandardFile::CException::Error() const
{
  return m_strError;
}
...
CLogASCIIStandardFile::CUnitConverter::CUnitConverter(double dFactor)
: m_dFactor(dFactor)
{
}

CLogASCIIStandardFile::CUnitConverter::CUnitConverter(const CUnitConverter& rhs)
: m_dFactor(rhs.m_dFactor)
{
}
...
double CLogASCIIStandardFile::CUnitConverter::Factor() const
{
  return m_dFactor;
}
...
CLogASCIIStandardFile::CInverseUnitConverter::CInverseUnitConverter(double dFactor)
: CUnitConverter(dFactor)
{
}
...
CLogASCIIStandardFile::CColumnDef::CColumnDef(unsigned int uiValueType, unsigned int uiValueNameID, const QString& strMnemonic, const CUnitConverter* pUnitConverter)
...
: m_uiValueType(rhs.m_uiValueType),
  m_strValueName(rhs.m_strValueName),
  m_strMnemonic(rhs.m_strMnemonic),
...
unsigned int CLogASCIIStandardFile::CColumnDef::ValueTypeID() const
{
  return m_uiValueType;
}

const QString& CLogASCIIStandardFile::CColumnDef::ValueName() const
{
  return m_strValueName;
}

const QString& CLogASCIIStandardFile::CColumnDef::Mnemonic() const
{
  return m_strMnemonic;
}
...
CLogASCIIStandardFile::~CLogASCIIStandardFile()
{
  Close();
}
...
const QString& CLogASCIIStandardFile::Error() const
{
  return m_strError;
}

const geo::CValue& CLogASCIIStandardFile::NullValue() const
{
  return m_NullValue;
}

char CLogASCIIStandardFile::Delimiter() const
{
  return m_delimiter;
}

int CLogASCIIStandardFile::ColumnSize() const
{
  return m_vcColumns.size();
}
...
bool CLogASCIIStandardFile::IsComment(const char* text) const
{
  return (text != 0 && *text == '#');
}

bool CLogASCIIStandardFile::IsSection(const char* text) const
{
  return (text != 0 && *text == '~');
}
...
void CLogASCIIStandardFile::NewSection(const char* text)
{
  ...
  else if(s.left(5).compare("CURVE", Qt::CaseInsensitive) == 0 && s.right(11).compare("INFORMATION", Qt::CaseInsensitive) == 0)
...
void CLogASCIIStandardFile::ReadCurveInfoData(const char* text)
{
  ...
  if(lasData.Mnemonic().compare("DEPT", Qt::CaseInsensitive)  == 0 || lasData.Mnemonic().compare("DEPTH", Qt::CaseInsensitive) == 0 ||
     lasData.Mnemonic().compare("MD", Qt::CaseInsensitive)    == 0 || lasData.Mnemonic().compare("AHD", Qt::CaseInsensitive)   == 0 ||
     lasData.Mnemonic().compare("AHDKB", Qt::CaseInsensitive) == 0) // depth
  {
    ...
    else if(lasData.Unit().compare("FT", Qt::CaseInsensitive) == 0 || lasData.Unit().compare("F", Qt::CaseInsensitive) == 0)
  ...
  else if(lasData.Mnemonic().compare("VP", Qt::CaseInsensitive) == 0) // acoustic velocity (Vp)
  {
    if(lasData.Unit().compare("M/S", Qt::CaseInsensitive) == 0)
      pUnitConverter = new CProportionalUnitConverter(1.);
    else if(lasData.Unit().compare("FT/S", Qt::CaseInsensitive) == 0 || lasData.Unit().compare("F/S", Qt::CaseInsensitive) == 0)
      pUnitConverter = new CProportionalUnitConverter(1. / FF_FACTOR_LENGTH);
    else if(lasData.Unit().compare("M/US", Qt::CaseInsensitive) == 0)
      pUnitConverter = new CProportionalUnitConverter(1.e6);
    else if(lasData.Unit().compare("FT/US", Qt::CaseInsensitive) == 0 || lasData.Unit().compare("F/US", Qt::CaseInsensitive) == 0)
  ...
  else if(lasData.Mnemonic().compare("DT", Qt::CaseInsensitive) == 0 || lasData.Mnemonic().compare("SONIC", Qt::CaseInsensitive) == 0) // transit time (1/Vp)
  {
    if(lasData.Unit().compare("S/M", Qt::CaseInsensitive) == 0)
      pUnitConverter = new CInverseUnitConverter(1.);
    else if(lasData.Unit().compare("S/FT", Qt::CaseInsensitive) == 0 || lasData.Unit().compare("S/F", Qt::CaseInsensitive) == 0)
    ...
    else if(lasData.Unit().compare("US/FT", Qt::CaseInsensitive) == 0 || lasData.Unit().compare("US/F", Qt::CaseInsensitive) == 0)
      pUnitConverter = new CInverseUnitConverter(1.e6 / FF_FACTOR_LENGTH);
    RegisterValueType(IDT_VALUETYPE_VELOCITYP, IDS_VALUENAME_VELOCITYP, lasData, m_nLine, pUnitConverter);
  }
  else if(lasData.Mnemonic().compare("RHOB", Qt::CaseInsensitive) == 0 || lasData.Mnemonic().compare("DENSITY", Qt::CaseInsensitive) == 0 ||
          lasData.Mnemonic().compare("DEN", Qt::CaseInsensitive)  == 0) // density
  {
    if(lasData.Unit().compare("K/M3", Qt::CaseInsensitive) == 0)
      ...
      pUnitConverter = new CProportionalUnitConverter(1.e6);
    else if(lasData.Unit().compare("G/CM3", Qt::CaseInsensitive) == 0 || lasData.Unit().compare("G/C3", Qt::CaseInsensitive) == 0)
  ...
  {
    RegisterValueType(IDT_VALUETYPE_POROSITY, IDS_VALUENAME_POROSITY, lasData, m_nLine, new CProportionalUnitConverter(1.));
  }
  ...
  else if(lasData.Mnemonic().compare("SHEARSONIC", Qt::CaseInsensitive) == 0 || lasData.Mnemonic().compare("DTS", Qt::CaseInsensitive) == 0 ||
...
void CLogASCIIStandardFile::ReadCurveData(const char* text)
{
...

  {
    ...
    CNewWellPoint pLast = 
      m_pNewWellPath->WellPoint(m_pNewWellPath->WellPointSize()-1);
...
void CLogASCIIStandardFile::RegisterValueType(unsigned int uiValueType, unsigned int uiValueNameID, const CLasDataLine& lasData, int nLineNr, CUnitConverter* pUnitConverter)
{
  if(uiValueType != 0)
  {
    ...
    if(!prInsert.second) // already defined, throw error
    {
      ...
      msg = QString("Line %1: '%2' is already defined through '%3' (line %4)").
        arg(m_nLine).arg(lasData.Mnemonic()).arg(prInsert.first->second.first).arg(prInsert.first->second.second);
...
{
  QString msg;
  msg = QString("Line %1: unrecognized unit '%2' for mnemonic '%3'").arg(nLineNr).arg(lasData.Unit()).arg(lasData.Mnemonic());
  throw CException(msg);
}
