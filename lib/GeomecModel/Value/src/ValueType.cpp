...
bool CValueType::SingleElementValue() const
{
  return false;
}
...
QString CValueType::ExportType() const
{
  return "";
}
...
//=============================================================================
// Weigthing
enum CValueType::TMapEnum CValueType::MapType() const
{
  return m_map_type;
}
...
long CValueType::SavedItems() const
{
  return 0;
}
