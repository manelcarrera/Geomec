...
CExportResultDataEntry::CExportResultDataEntry(CFemAppModel &model)
    : CStorageNodeEntry<CExportResultData>(MD_BASE_EXPORT_MACROS, IDI_EXPORT_MACROS, IDS_TREE_EXPORT_MACROS, model) {
  initReservoirMacro();
}
...
void CExportResultDataEntry::LoadStream(CFemAppModel &model, CStorageNodeEntry<CExportResultData>::TSTREAM &stream,
                                        CStreamVersion &version,
                                        CStorageNodeEntry<CExportResultData>::TPROGRESS &progress) {
