...
CStaborResult::CStaborResult(CResultGroup &group)
    : IResult(IDS_RG_DSTABOR, group),
      m_well_path_entry((CNewWellPathEntry &)*group.Model().GraphEntry(MD_NEW_WELLPATH)) {
...
bool CStaborResult::Empty() const { return false; }

long CStaborResult::SavedItems() const { return 1; }
...
bool CStaborResult::ValidName(const std::string &name, CResultInfo &resultInfo) const {
...
CStaborResult::CStaborResultComponent::CStaborResultComponent(CStaborResult &result, const CDepletionStage &stage,
...
void CStaborResult::CStaborResultComponent::Clear() { m_mpValue.clear(); }
...
bool CStaborResult::CStaborResultComponent::Empty() const { return true; }

long CStaborResult::CStaborResultComponent::SavedItems() const { return 1; }

unsigned int CStaborResult::CStaborResultComponent::IconId() const { return 0; }

unsigned int CStaborResult::CStaborResultComponent::TypeId() const { return 0; }
...
void CStaborResult::CStaborResultComponent::ElementValues(IValueDomainScalar::TValueVec &values,
...
QString CStaborResult::CStaborResultComponent::ExportLabel() const { return IScalarResultComponent::ExportLabel(); }
