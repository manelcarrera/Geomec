...
protected:
  ...
  virtual void CreateHexaElements(const std::vector<int>& vcGrid1, const std::vector<int>& vcGrid2, double uppertmd, double lowertmd, TBoundaryElementVec& vcBoundaryElements, const SegmentInfo& segmentinfo) = 0;
