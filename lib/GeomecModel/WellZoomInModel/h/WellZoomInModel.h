...
private:
  ...
  CWellZoomInModel(CFemAppModel& model, CWellPath& wellpath, CAnalysisLogger& logger, const CVersionManager& versionManager);
  CWellZoomInModel(CFemAppModel& model, CNewWellPath& wellpath, CAnalysisLogger& logger, const CVersionManager& versionManager);
