...
private:
  ...
  TBoundaryNodeMap m_mpMesh2Boundary; // maps mesh node indices to boundary node indices (not all mesh nodes will be found)
  TBoundaryNodeMap m_mpBoundary2Mesh; // maps boundary node indices to mesh node indices (all boundary nodes should be found)
