...
template <class VALUETYPE> class IWellCasingInternalLoad : public IValueComposite {
public:
  typedef enum { LM_REPEATER = 0, LM_GRADIENT = 1 } TLoadingMode;
...
template <class VALUETYPE> class IWellCasingInternalLoadComponent : public IValueComponentBase {
public:
  typedef IValueDataInterfaceScalarTempl<IWellCasingInternalLoadComponent<VALUETYPE>>
      IValueDataInterfaceWellCasingInternalScalar;
...
IWellCasingInternalLoad<VALUETYPE>::IWellCasingInternalLoad(CDepletionStage &stage)
    : IValueComposite(stage.Name().toStdString().c_str(), stage.Model()), m_stage(stage), m_bDistributedOnly(false),
...
IWellCasingInternalLoad<VALUETYPE>::IWellCasingInternalLoad(const IWellCasingInternalLoad &rhs)
    : IValueComposite(rhs), m_stage(rhs.m_stage), m_vcDistributed(rhs.m_vcDistributed),
      m_bDistributedOnly(rhs.m_bDistributedOnly), m_LoadingMode(rhs.m_LoadingMode) {}
...
template <class VALUETYPE>
IValueComponentBase &IWellCasingInternalLoad<VALUETYPE>::Component(unsigned int /*uComponent*/,
                                                                   unsigned int /*uMode*/) {
  return IValueComposite::Component(0, m_LoadingMode);
}

template <class VALUETYPE>
const IValueComponentBase &IWellCasingInternalLoad<VALUETYPE>::Component(unsigned int /*uComponent*/,
                                                                         unsigned int /*uMode*/) const {
  return IValueComposite::Component(0, m_LoadingMode);
}

template <class VALUETYPE> unsigned int IWellCasingInternalLoad<VALUETYPE>::ModeSize() const { return 1; }

template <class VALUETYPE> const CDepletionStage &IWellCasingInternalLoad<VALUETYPE>::Stage() const { return m_stage; }

template <class VALUETYPE> CDepletionStage &IWellCasingInternalLoad<VALUETYPE>::Stage() { return m_stage; }

template <class VALUETYPE> size_t IWellCasingInternalLoad<VALUETYPE>::DistributedSize() const {
  return m_vcDistributed.size();
}

template <class VALUETYPE> const VALUETYPE &IWellCasingInternalLoad<VALUETYPE>::DistributedValue(size_t nIndex) const {
  assert(nIndex < m_vcDistributed.size());
  return *m_vcDistributed[nIndex];
}

template <class VALUETYPE> void IWellCasingInternalLoad<VALUETYPE>::DistributedOnly(bool b) { m_bDistributedOnly = b; }

template <class VALUETYPE> bool IWellCasingInternalLoad<VALUETYPE>::DistributedOnly() const {
  return m_bDistributedOnly;
}

template <class VALUETYPE> void IWellCasingInternalLoad<VALUETYPE>::LoadingMode(TLoadingMode mode) {
...
template <class VALUETYPE> void IWellCasingInternalLoad<VALUETYPE>::OnNewNeighbour(const CGraphNode &node) {
...
template <class VALUETYPE> void IWellCasingInternalLoad<VALUETYPE>::OnNeighbourDeleted(const CGraphNode &node) {
...
template <class VALUETYPE> bool IWellCasingInternalLoad<VALUETYPE>::ConnectItem(const CGraphNode &item) {
...
template <class VALUETYPE> bool IWellCasingInternalLoad<VALUETYPE>::CanConnectItem(const CGraphNode &item) const {
  const VALUETYPE *pVT = dynamic_cast<const VALUETYPE *>(&item);
  if (pVT)
...
template <class VALUETYPE> void IWellCasingInternalLoad<VALUETYPE>::Modified(enum ModifiedHint uHint) {
...
template <class VALUETYPE> long IWellCasingInternalLoad<VALUETYPE>::SavedItems() const {
...
void IWellCasingInternalLoad<VALUETYPE>::LoadStream(TSTREAM &stream, CStreamVersion &version, TPROGRESS &progress) {
  TValueCompositeEntry &composite_entry =
      (TValueCompositeEntry &)*((CModelBase &)Model()).GraphEntry(MD_BASE_VALUE_COMPOSITE);
...
template <class VALUETYPE> void IWellCasingInternalLoad<VALUETYPE>::SaveStream(TSTREAM &stream, TPROGRESS &progress) {
...
template <class VALUETYPE>
IWellCasingInternalLoadComponent<VALUETYPE>::IWellCasingInternalLoadComponent(
    IWellCasingInternalLoad<VALUETYPE> &parent, unsigned int uMode)
    : IValueComponentBase(parent, 0, uMode), m_Data(*this) {}

template <class VALUETYPE>
IWellCasingInternalLoadComponent<VALUETYPE>::IWellCasingInternalLoadComponent(
    const IWellCasingInternalLoadComponent &rhs)
    : IValueComponentBase(rhs), m_Data(rhs.m_Data) {}

template <class VALUETYPE>
IWellCasingInternalLoadComponent<VALUETYPE> &
IWellCasingInternalLoadComponent<VALUETYPE>::operator=(const IWellCasingInternalLoadComponent &rhs) {
...
template <class VALUETYPE> IValueDataInterfaceScalar &IWellCasingInternalLoadComponent<VALUETYPE>::ScalarData() {
  return m_Data;
}

template <class VALUETYPE> unsigned int IWellCasingInternalLoadComponent<VALUETYPE>::TypeId() const { return 0; }
...
template <class VALUETYPE>
IValueDomainScalar::TMinMax IWellCasingInternalLoadComponent<VALUETYPE>::MinMax(IProgressBase &progressBase,
...
template <class VALUETYPE>
IValueDomainScalar::TValue IWellCasingInternalLoadComponent<VALUETYPE>::Average(IProgressBase &progressBase,
                                                                                const CQuantity::UNIT unit) const {
  geo::CBox box(ParentLoad().Min(), ParentLoad().Max());
...
IWellCasingInternalLoadComponent<VALUETYPE>::ValueElement(const geo::IElement &elm, const CQuantity::UNIT unit,
...
IWellCasingInternalLoadComponent<VALUETYPE>::ValuePoint(const geo::IPoint &pt, const CQuantity::UNIT unit,
                                                        geo::IParallelInitializationCallback *cb) const {
  double dResult = 0;
  int nValues = 0;
  for (size_t i = 0; i < ParentLoad().DistributedSize(); ++i) {
...
template <class VALUETYPE> bool IWellCasingInternalLoadComponent<VALUETYPE>::Defined() const { return true; }

template <class VALUETYPE> bool IWellCasingInternalLoadComponent<VALUETYPE>::Empty() const { return false; }
...
template <class VALUETYPE>
IWellCasingInternalLoadComponentGradient<VALUETYPE>::IWellCasingInternalLoadComponentGradient(
    IWellCasingInternalLoad<VALUETYPE> &parent)
    : IWellCasingInternalLoadComponent<VALUETYPE>(parent, IWellCasingInternalLoad<VALUETYPE>::LM_GRADIENT),
      m_dReferenceValue(0), m_dReferenceDepth(0), m_dGradient(0) {}

template <class VALUETYPE>
IWellCasingInternalLoadComponentGradient<VALUETYPE>::IWellCasingInternalLoadComponentGradient(
    const IWellCasingInternalLoadComponentGradient &rhs)
    : IWellCasingInternalLoadComponent<VALUETYPE>(rhs), m_dReferenceValue(rhs.m_dReferenceValue),
      m_dReferenceDepth(rhs.m_dReferenceDepth), m_dGradient(rhs.m_dGradient) {}

template <class VALUETYPE>
IWellCasingInternalLoadComponentGradient<VALUETYPE> &
IWellCasingInternalLoadComponentGradient<VALUETYPE>::operator=(const IWellCasingInternalLoadComponentGradient &rhs) {
  if (!(*this == rhs)) {
...
template <class VALUETYPE>
bool IWellCasingInternalLoadComponentGradient<VALUETYPE>::operator==(
    const IWellCasingInternalLoadComponentGradient &rhs) const {
  if (!IWellCasingInternalLoadComponent<VALUETYPE>::operator==(rhs))
    return false;

  return (fabs(m_dReferenceValue - rhs.m_dReferenceValue) < 1e-8 &&
          fabs(m_dReferenceDepth - rhs.m_dReferenceDepth) < 1e-8 && fabs(m_dGradient - rhs.m_dGradient) < 1e-8);
}

template <class VALUETYPE> void IWellCasingInternalLoadComponentGradient<VALUETYPE>::ReferenceValue(double d) {
  m_dReferenceValue = d;
}

template <class VALUETYPE> double IWellCasingInternalLoadComponentGradient<VALUETYPE>::ReferenceValue() const {
  return m_dReferenceValue;
}

template <class VALUETYPE> void IWellCasingInternalLoadComponentGradient<VALUETYPE>::ReferenceDepth(double d) {
  m_dReferenceDepth = d;
}

template <class VALUETYPE> double IWellCasingInternalLoadComponentGradient<VALUETYPE>::ReferenceDepth() const {
  return m_dReferenceDepth;
}

template <class VALUETYPE> void IWellCasingInternalLoadComponentGradient<VALUETYPE>::Gradient(double d) {
  m_dGradient = d;
}

template <class VALUETYPE> double IWellCasingInternalLoadComponentGradient<VALUETYPE>::Gradient() const {
  return m_dGradient;
}

template <class VALUETYPE>
IValueDomainScalar::TValueVec
IWellCasingInternalLoadComponentGradient<VALUETYPE>::ValueElement(const geo::IElement &elm, const CQuantity::UNIT unit,
                                                                  geo::IParallelInitializationCallback *cb) const {
...
template <class VALUETYPE>
IValueDomainScalar::TValue
IWellCasingInternalLoadComponentGradient<VALUETYPE>::ValuePoint(const geo::IPoint &pt, const CQuantity::UNIT unit,
                                                                geo::IParallelInitializationCallback *cb) const {
...
template <class VALUETYPE>
void IWellCasingInternalLoadComponentGradient<VALUETYPE>::LoadStream(TSTREAM &stream, CStreamVersion & /*version*/,
                                                                     TPROGRESS &progress) {
...
template <class VALUETYPE> long IWellCasingInternalLoadComponentGradient<VALUETYPE>::SavedItems() const { return 1; }

///// IWellCasingInternalLoadComponentRepeater

template <class VALUETYPE>
IWellCasingInternalLoadComponentRepeater<VALUETYPE>::IWellCasingInternalLoadComponentRepeater(
    IWellCasingInternalLoad<VALUETYPE> &parent)
    : IWellCasingInternalLoadComponent<VALUETYPE>(parent, IWellCasingInternalLoad<VALUETYPE>::LM_REPEATER) {}

template <class VALUETYPE>
IWellCasingInternalLoadComponentRepeater<VALUETYPE>::IWellCasingInternalLoadComponentRepeater(
    const IWellCasingInternalLoadComponentRepeater &rhs)
    : IWellCasingInternalLoadComponent<VALUETYPE>(rhs) {}

template <class VALUETYPE>
const IWellCasingInternalLoadComponent<VALUETYPE> &
IWellCasingInternalLoadComponentRepeater<VALUETYPE>::PreviousStageComponent() const {
  const IWellCasingInternalLoad<VALUETYPE> &parent = IWellCasingInternalLoadComponent<VALUETYPE>::ParentLoad();
...
template <class VALUETYPE>
IValueDomainScalar::TValueVec
IWellCasingInternalLoadComponentRepeater<VALUETYPE>::ValueElement(const geo::IElement &elm, const CQuantity::UNIT unit,
                                                                  geo::IParallelInitializationCallback *cb) const {
  IValueDomainScalar::TValueVec vcRet = IWellCasingInternalLoadComponent<VALUETYPE>::ValueElement(elm, unit, cb);
...
template <class VALUETYPE>
IValueDomainScalar::TValue
IWellCasingInternalLoadComponentRepeater<VALUETYPE>::ValuePoint(const geo::IPoint &pt, const CQuantity::UNIT unit,
                                                                geo::IParallelInitializationCallback *cb) const {
  geo::CValue val = IWellCasingInternalLoadComponent<VALUETYPE>::ValuePoint(pt, unit, cb);
...
template <class VALUETYPE> long IWellCasingInternalLoadComponentRepeater<VALUETYPE>::SavedItems() const { return 0; }
