...
CWellCasingCementInitialMaterial::CWellCasingCementInitialMaterial(const CFFMaterial& base)
: m_base(base)
{
}
...
int CWellCasingCementInitialMaterial::Type() const
{
  return 104;
}
...
void CWellCasingCementInitialMaterial::WriteFilosParamValues(dia::IDianaRunner& diarunner, double* values, int stride) const
{
