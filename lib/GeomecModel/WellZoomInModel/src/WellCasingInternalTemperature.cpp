...
unsigned int CWellCasingInternalTemperature::TypeId() const
{
...
QString CWellCasingInternalTemperature::LoadName() const
{
  return "Temperature";
}
...
bool CWellCasingInternalTemperature::Empty() const
{
  return false;
}

long CWellCasingInternalTemperature::SavedItems() const
{
  return 0;
}

const CWellCasingInternalTemperature::CWellCasingInternalTemperatureComponentRepeater& CWellCasingInternalTemperature::Repeater() const
{
  return *m_pRepeater;
}

CWellCasingInternalTemperature::CWellCasingInternalTemperatureComponentRepeater& CWellCasingInternalTemperature::Repeater()
{
  return *m_pRepeater;
}

const CWellCasingInternalTemperature::CWellCasingInternalTemperatureComponentGradient& CWellCasingInternalTemperature::Gradient() const
{
  return *m_pGradient;
}

CWellCasingInternalTemperature::CWellCasingInternalTemperatureComponentGradient& CWellCasingInternalTemperature::Gradient()
{
  return *m_pGradient;
}
...
CWellCasingInternalTemperature::CWellCasingInternalTemperatureComponentRepeater::CWellCasingInternalTemperatureComponentRepeater(CWellCasingInternalTemperature& parent)
: IWellCasingInternalLoadComponentRepeater<TTemperature>(parent)
{
}

CWellCasingInternalTemperature::CWellCasingInternalTemperatureComponentRepeater::CWellCasingInternalTemperatureComponentRepeater(const CWellCasingInternalTemperatureComponentRepeater& rhs)
...
CWellCasingInternalTemperature::CWellCasingInternalTemperatureComponentGradient::CWellCasingInternalTemperatureComponentGradient(CWellCasingInternalTemperature& parent)
: IWellCasingInternalLoadComponentGradient<TTemperature>(parent)
{
}

CWellCasingInternalTemperature::CWellCasingInternalTemperatureComponentGradient::CWellCasingInternalTemperatureComponentGradient(const CWellCasingInternalTemperatureComponentGradient& rhs)
