...
unsigned int CWellCasingInternalPressure::IconId() const { return Component().IconId(); }

unsigned int CWellCasingInternalPressure::TypeId() const { return IDT_VALUETYPE_PRESSURE; }
...
QString CWellCasingInternalPressure::LoadName() const { return "Pressure"; }
...
bool CWellCasingInternalPressure::Empty() const { return false; }

const CWellCasingInternalPressure::CWellCasingInternalPressureComponentRepeater &
CWellCasingInternalPressure::Repeater() const {
  return *m_pRepeater;
}
...
const CWellCasingInternalPressure::CWellCasingInternalPressureComponentGradient &
CWellCasingInternalPressure::Gradient() const {
  return *m_pGradient;
}
...
CWellCasingInternalPressure::CWellCasingInternalPressureComponentRepeater::CWellCasingInternalPressureComponentRepeater(
    CWellCasingInternalPressure &parent)
    : IWellCasingInternalLoadComponentRepeater<TPressure>(parent) {}

CWellCasingInternalPressure::CWellCasingInternalPressureComponentRepeater::CWellCasingInternalPressureComponentRepeater(
    const CWellCasingInternalPressureComponentRepeater &rhs)
...
double
CWellCasingInternalPressure::CWellCasingInternalPressureComponentRepeater::UnitFactor(CQuantity::UNIT unit) const {
...
QString
CWellCasingInternalPressure::CWellCasingInternalPressureComponentRepeater::UnitName(const CQuantity::UNIT unit) const {
  QString sRet;
...
CWellCasingInternalPressure::CWellCasingInternalPressureComponentGradient::CWellCasingInternalPressureComponentGradient(
    CWellCasingInternalPressure &parent)
    : IWellCasingInternalLoadComponentGradient<TPressure>(parent) {}

CWellCasingInternalPressure::CWellCasingInternalPressureComponentGradient::CWellCasingInternalPressureComponentGradient(
    const CWellCasingInternalPressureComponentGradient &rhs)
...
double
CWellCasingInternalPressure::CWellCasingInternalPressureComponentGradient::UnitFactor(CQuantity::UNIT unit) const {
  if (unit == CDoubleQuantity::FIELD_UNIT)
    return FF_FACTOR_PRESSURE;
...
QString
CWellCasingInternalPressure::CWellCasingInternalPressureComponentGradient::UnitName(const CQuantity::UNIT unit) const {
  QString sRet;
  if (unit == CQuantity::SI_UNIT)
    sRet = getStringTableEntry(IDS_UNIT_SI_PRESSURE);
  else
