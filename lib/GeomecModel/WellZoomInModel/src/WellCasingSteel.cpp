...
unsigned int CWellCasingSteel::IconId() const
{
  return IDI_WELLCASINGMODEL;
}

unsigned int CWellCasingSteel::TypeId() const
{
  return 0;
}
...
bool CWellCasingSteel::Less(const CGraphNode& /*node*/) const
{
  return true;
}
...
bool CWellCasingSteel::Empty() const
{
  return false;
}

long CWellCasingSteel::SavedItems() const
{
  return 0;
}
...
CWellCasingSteel::TColor CWellCasingSteel::Color() const
{
  return m_color;
}

void CWellCasingSteel::Color(TColor nColor)
{
  m_color = nColor;
}
...
CWellCasingMaterialServer::CWellCasingMaterialServer(TWellCasingMaterialServerParent& parent, const CDepletionStage& stage)
: TBase(parent, stage)
{
  reParent(&parent);
