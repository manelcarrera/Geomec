...
CMaterialKey::CMaterialKey() : m_pValueMap(0) {}

CMaterialKey::CMaterialKey(TValueMap *values) : m_pValueMap(values) {}
...
CMaterialMappingCache::CMaterialMappingCache() : m_bUseCache(false), m_bNoCaching(false) {}
...
bool CMaterialMappingCache::UseCache() const { return m_bUseCache; }
...
bool CMaterialMappingCache::NoCaching() const { return m_bNoCaching; }
