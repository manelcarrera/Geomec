...
void CMaterialCamClayCreatorV2::OnCreateLibraryParameters(CLibraryMaterial &m) {
  ...
  AddLibParam(MLD_YOUNGMODULUS, DEF_E, m, f->getMPUnitType(CMaterialHelperFactory::UT_STRESS),
              ...
              f->getMPSetStrategy(CMaterialHelperFactory::MP_SET_CamClayYoung), YOUNG_FILOSPATH, false, GROUP_MANUAL);
  ...
  AddLibParam(MLD_POISSONRATIO, DEF_NU, m, f->getMPUnitType(CMaterialHelperFactory::UT_NONE),
              ...
              f->getMPSetStrategy(CMaterialHelperFactory::MP_SET_CamClayPoisson), POISON_FILOSPATH, false,
              GROUP_MANUAL);
  ...
  AddLibParam(MLD_BULKSTIFFNESS, 0, m, f->getMPUnitType(CMaterialHelperFactory::UT_STRESS), IDT_VALUETYPE_BULKSTIFFNESS,
              ...
              f->getMPSetStrategy(CMaterialHelperFactory::MP_SET_CamClayBulkStiff), QString(), false, GROUP_BULK);
  AddLibParam(MLD_SHEARMODULUS, 0, m, f->getMPUnitType(CMaterialHelperFactory::UT_STRESS), IDT_VALUETYPE_SHEARMODULUS,
              ...
              f->getMPSetStrategy(CMaterialHelperFactory::MP_SET_CamClayShearStiff), QString(), false, GROUP_BULK);
  AddLibParam(MLD_DYNUNISTIFFNESS, 0, m, f->getMPUnitType(CMaterialHelperFactory::UT_STRESS),
              ...
              f->getMPSetStrategy(CMaterialHelperFactory::MP_SET_CamClayDynUni), QString(), false, GROUP_DYNAMIC);
  AddLibParam(MLD_DYNSHEARSTIFFNESS, 0, m, f->getMPUnitType(CMaterialHelperFactory::UT_STRESS),
              ...
              f->getMPSetStrategy(CMaterialHelperFactory::MP_SET_CamClayDynShear), QString(), false, GROUP_DYNAMIC);
  AddLibParam(MLD_VELOCITYP, 0, m, f->getMPUnitType(CMaterialHelperFactory::UT_VELOCITY), IDT_VALUETYPE_VELOCITYP,
              ...
              f->getMPSetStrategy(CMaterialHelperFactory::MP_SET_CamClayVelocityP), QString(), false, GROUP_VELOCITIES);
  AddLibParam(MLD_VELOCITYS, 0, m, f->getMPUnitType(CMaterialHelperFactory::UT_VELOCITY), IDT_VALUETYPE_VELOCITYS,
              ...
              f->getMPSetStrategy(CMaterialHelperFactory::MP_SET_CamClayVelocityS), QString(), false, GROUP_VELOCITIES);
  ...
  AddLibParam(MLD_CME, DEF_CME, m, f->getMPUnitType(CMaterialHelperFactory::UT_PER_STRESS), IDT_VALUETYPE_ELASCOMPRES,
              ...
              f->getMPSetStrategy(CMaterialHelperFactory::MP_SET_CamClayCME), QString(), false, GROUP_COMPRESSIBILITY);
  ...
  AddLibParam(MLD_POROSITY, DEF_PORO, m, f->getMPUnitType(CMaterialHelperFactory::UT_NONE), IDT_VALUETYPE_POROSITY,
              ...
              f->getMPSetStrategy(CMaterialHelperFactory::MP_SET_CamClayPorosity), POROSI_FILOSPATH, true);
  ...
  AddLibParam(MLD_INITFRICTION, DEF_FRICTION, m, f->getMPUnitType(CMaterialHelperFactory::UT_ANGLE),
              ...
              f->getMPSetStrategy(CMaterialHelperFactory::MP_SET_CamClayFriction), FRICTI_FILOSPATH, false);
  ...
  AddLibParam(MLD_HARDENING, DEF_HARDENING, m, f->getMPUnitType(CMaterialHelperFactory::UT_NONE),
              ...
              f->getMPSetStrategy(CMaterialHelperFactory::MP_SET_CamClayHardening), LAMBDA_FILOSPATH, false);
  AddLibParam(MLD_PRECONSOLIDATION, DEF_PRECONSO, m, f->getMPUnitType(CMaterialHelperFactory::UT_STRESS),
              ...
              f->getMPSetStrategy(CMaterialHelperFactory::MP_SET_CamClayPreconsolidation), PRECON_FILOSPATH, false);
  ...
  AddLibParam(MLD_CAPSHAPE, DEF_CAPSHAPE, m, f->getMPUnitType(CMaterialHelperFactory::UT_NONE), IDT_VALUETYPE_CAPSHAPE,
              ...
              f->getMPSetStrategy(CMaterialHelperFactory::MP_SET_CamClayCapShap), ALPHA_FILOSPATH, false);
  AddLibParam(MLD_GAMMA, DEF_GAMMA, m, f->getMPUnitType(CMaterialHelperFactory::UT_NONE), IDT_VALUETYPE_TENSILE_STRETCH,
              f->getMPCheckStrategy(CMaterialHelperFactory::MP_GE_1), 0, GAMMA_FILOSPATH, true);
  AddLibParam(MLD_CMP, 0, m, f->getMPUnitType(CMaterialHelperFactory::UT_PER_STRESS), IDT_VALUETYPE_PLASCOMPRES,
              f->getMPCheckStrategy(CMaterialHelperFactory::MP_CamClayCMP),
              f->getMPSetStrategy(CMaterialHelperFactory::MP_SET_CamClayCMP), QString(), false);
...
int CMaterialCamClayCreatorV2::MaterialModel() { return MM_CAMCLAY; }

QString CMaterialCamClayCreatorV2::MaterialModelName() { return MLD_CAMCLAY; }

QString CMaterialCamClayCreatorV2::CalibrationPath() const { return "CAMCLA"; }
...
void CMaterialCamClayCreatorV2::CPQPlotter::GetYieldCurve(const CLibraryMaterial &mat, double dPrecon, double dPMin,
...
void CMaterialCamClayCreatorV2::CPQPlotter::GetPrimaryYieldCurve(const CLibraryMaterial &mat, double dPMin,
                                                                 double dPMax, CStressStrainArray &values) const {
...
void CMaterialCamClayCreatorDEPRECATED::OnCreateLibraryParameters(CLibraryMaterial &m) {
  Add(new CLibraryMaterialParameter(MLD_YOUNGMODULUS, DEF_E, m, *new CUnitTypeStress, IDT_VALUETYPE_YOUNGS_MODULUS,
                                    new MP_GT(0), new CMaterialCamClayYoungSetStrategy, YOUNG_FILOSPATH, false),
      GROUP_MANUAL);
  ...
  Add(new CLibraryMaterialParameter(MLD_POISSONRATIO, DEF_NU, m, *new CUnitTypeNone, IDT_VALUETYPE_POISSONS_RATIO,
                                    new MP_GE_LT(0, 0.5), new CMaterialCamClayPoissonSetStrategy, POISON_FILOSPATH,
                                    false),
      GROUP_MANUAL);
  ...
  Add(new CLibraryMaterialParameter(MLD_BULKSTIFFNESS, 0, m, *new CUnitTypeStress, IDT_VALUETYPE_BULKSTIFFNESS,
                                    ...
                                    new CMaterialCamClayBulkStiffSetStrategy),
      GROUP_BULK);
  ...
  Add(new CLibraryMaterialParameter(MLD_VELOCITYP, 0, m, *new CUnitTypeVelocity, IDT_VALUETYPE_VELOCITYP,
                                    ...
                                    new CMaterialCamClayVelocityPSetStrategy),
      GROUP_VELOCITIES);
  ...
  Add(new CLibraryMaterialParameter(MLD_POROSITY, DEF_PORO, m, *new CUnitTypeNone, IDT_VALUETYPE_POROSITY,
                                    new MP_GE_LT(0, 1), new CMaterialCamClayPorositySetStrategy, POROSI_FILOSPATH,
                                    true));
  ...
  Add(new CLibraryMaterialParameter(MLD_INITFRICTION, DEF_FRICTION, m, *new CUnitTypeAngle, IDT_VALUETYPE_INITFRICTION,
                                    new MP_GE_LT(0, 70), new CMaterialCamClayFrictionSetStrategy, FRICTI_FILOSPATH,
                                    false));
  ...
  Add(new CLibraryMaterialParameter(MLD_HARDENING, DEF_HARDENING, m, *new CUnitTypeNone, IDT_VALUETYPE_HARDENING,
                                    new MP_GT_LE(0, 1), new CMaterialCamClayHardeningSetStrategy, LAMBDA_FILOSPATH,
                                    false));
  Add(new CLibraryMaterialParameter(MLD_PRECONSOLIDATION, DEF_PRECONSO, m, *new CUnitTypeStress,
                                    IDT_VALUETYPE_PRECONSOLIDATION, new MP_GT(0),
                                    new CMaterialCamClayPreconsolidationSetStrategy, PRECON_FILOSPATH, false));
  Add(new CLibraryMaterialParameter(MLD_CAPSHAPE, DEF_CAPSHAPE, m, *new CUnitTypeNone, IDT_VALUETYPE_CAPSHAPE,
                                    new MP_GE_LE(0.1, 5.0), new CMaterialCamClayCapShapSetStrategy, ALPHA_FILOSPATH,
                                    false));
  ...
  Add(new CLibraryMaterialParameter(MLD_CMP, 0, m, *new CUnitTypePerStress, IDT_VALUETYPE_PLASCOMPRES,
                                    new CMaterialCamClayCMPCheckStrategy, new CMaterialCamClayCMPSetStrategy));
...
int CMaterialCamClayCreatorDEPRECATED::MaterialModel() { return MM_CAMCLAY; }

QString CMaterialCamClayCreatorDEPRECATED::MaterialModelName() { return MLD_CAMCLAY; }

QString CMaterialCamClayCreatorDEPRECATED::CalibrationPath() const { return "CAMCLA"; }

IPQPlotter *CMaterialCamClayCreatorDEPRECATED::PQPlotter() const { return new CPQPlotter; }

#ifdef min
#undef min // To give std::min precedence over #define min(...)
#endif     // min

void CMaterialCamClayCreatorDEPRECATED::CPQPlotter::GetYieldCurve(const CLibraryMaterial &mat, double dPrecon,
...
IPQPlotter *CMaterialCamClayCreatorDEPRECATED::CPQPlotter::Clone() const { return new CPQPlotter; }

void CMaterialCamClayCreatorDEPRECATED::CPQPlotter::GetPrimaryYieldCurve(const CLibraryMaterial &mat, double dPMin,
                                                                         double dPMax,
                                                                         CStressStrainArray &values) const {
  const ml::CMatParam *pPrecon = mat.Parameter(MLD_PRECONSOLIDATION);
  GetYieldCurve(mat, pPrecon->Value(), dPMin, dPMax, values);
...
bool CMaterialCamClayCMPCheckStrategy::operator()(double dValue, const ml::CMatParam &param, QString &strErrorMsg,
                                                  int nUnitDef) const {
