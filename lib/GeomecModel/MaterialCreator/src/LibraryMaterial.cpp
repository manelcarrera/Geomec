...
CLibraryMaterial::CLibraryMaterial(const QString& strCalibrationPath, IPQPlotter* pPQPlotter, bool bCanCalibrateElastic, bool bCanCalibratePlastic)
: m_strCalibrationPath(strCalibrationPath),
  m_bCanCalibrateElastic(bCanCalibrateElastic),
  m_bCanCalibratePlastic(bCanCalibratePlastic),
  m_bBehavesLinearly(false),
  m_pPQPlotter(pPQPlotter),
  m_nMaxIterations(20),
  m_dConvCriterion(0.001)
{
}
...
CLibraryMaterial* CLibraryMaterial::Clone() const
{
  return new CLibraryMaterial(*this);
}
...
int CLibraryMaterial::MaxIterations() const
{
  return m_nMaxIterations;
}

double CLibraryMaterial::ConvCriterion() const
{
  return m_dConvCriterion;
}

void CLibraryMaterial::MaxIterations(int nMaxIterations)
{
  m_nMaxIterations = nMaxIterations;
}

void CLibraryMaterial::ConvCriterion(double dConvCriterion)
{
  m_dConvCriterion = dConvCriterion;
}
...
size_t CLibraryMaterial::ParameterSize() const
{
...
ml::CMatParam& CLibraryMaterial::MatParameter(size_t i)
{
  return *m_vcParameters[i];
}
...
CLibraryMaterialParameter& CLibraryMaterial::Parameter(size_t i)
{
  return *m_vcParameters[i];
}
...
{
  return const_cast<CLibraryMaterialParameter*>(((const CLibraryMaterial*)this)->ParameterByValueTypeID(uiValueTypeID));
}
...
bool CLibraryMaterial::CanCalibrateElastic() const
{
  return !m_strCalibrationPath.isEmpty() && m_bCanCalibrateElastic;
}

bool CLibraryMaterial::CanCalibratePlastic() const
{
  return !m_strCalibrationPath.isEmpty() && m_bCanCalibratePlastic;
}

bool CLibraryMaterial::BehavesLinearly() const
{
  return m_bBehavesLinearly;
}

void CLibraryMaterial::BehavesLinearly(bool bBehavesLinearly)
{
  m_bBehavesLinearly = bBehavesLinearly;
}
