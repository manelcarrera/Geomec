...
void CMaterialUpscaledAnisotropyCreatorV2::OnCreateLibrary(CLibraryMaterial& m)
{
  m.BehavesLinearly(true);
}

void CMaterialUpscaledAnisotropyCreatorV2::OnCreateLibraryParameters(CLibraryMaterial& m)
{
...
int CMaterialUpscaledAnisotropyCreatorV2::MaterialModel()
{
  return MM_UPSCALED_ANISOTROPY;
}

QString CMaterialUpscaledAnisotropyCreatorV2::MaterialModelName()
{
  return MLD_UPSCALED_ANISOTROPY;
}

QString CMaterialUpscaledAnisotropyCreatorV2::CalibrationPath() const
{
  return QString();
}


void CMaterialUpscaledAnisotropyCreatorDEPRECATED::OnCreateLibrary(CLibraryMaterial& /*m*/)
{
}

void CMaterialUpscaledAnisotropyCreatorDEPRECATED::OnCreateLibraryParameters(CLibraryMaterial& m)
 {
...
int CMaterialUpscaledAnisotropyCreatorDEPRECATED::MaterialModel()
{
  return MM_UPSCALED_ANISOTROPY;
}

QString CMaterialUpscaledAnisotropyCreatorDEPRECATED::MaterialModelName()
{
  return MLD_UPSCALED_ANISOTROPY;
}

QString CMaterialUpscaledAnisotropyCreatorDEPRECATED::CalibrationPath() const
{
  return QString();
}
