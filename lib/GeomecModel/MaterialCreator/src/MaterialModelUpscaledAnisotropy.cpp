...
void CMaterialUpscaledAnisotropyCreatorV2::OnCreateLibrary(CLibraryMaterial &m) { m.BehavesLinearly(true); }
...
int CMaterialUpscaledAnisotropyCreatorV2::MaterialModel() { return MM_UPSCALED_ANISOTROPY; }

QString CMaterialUpscaledAnisotropyCreatorV2::MaterialModelName() { return MLD_UPSCALED_ANISOTROPY; }

QString CMaterialUpscaledAnisotropyCreatorV2::CalibrationPath() const { return QString(); }
...
int CMaterialUpscaledAnisotropyCreatorDEPRECATED::MaterialModel() { return MM_UPSCALED_ANISOTROPY; }

QString CMaterialUpscaledAnisotropyCreatorDEPRECATED::MaterialModelName() { return MLD_UPSCALED_ANISOTROPY; }

QString CMaterialUpscaledAnisotropyCreatorDEPRECATED::CalibrationPath() const { return QString(); }
