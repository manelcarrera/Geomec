...
///// CMaterialLibraryXML
CMaterialLibraryXML::CMaterialLibraryXML(ml::CMaterialLibrary &matlib) : mlxml::CMaterialLibraryXML(matlib) {}
...
///// CMaterialXML
CMaterialXML::CMaterialXML(CLibraryMaterial &mat) : mlxml::CMaterialXML(mat) {}
