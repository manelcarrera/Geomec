...
void CMaterialFractureAperture2CreatorV2::OnCreateLibraryParameters(CLibraryMaterial &m) {
  ...
  AddLibParam(MLD_LAYER_NORMAL_AZI, 0, m, f->getMPUnitType(CMaterialHelperFactory::UT_ANGLE),
              ...
              QString(), false);
  //  AddLibParam(MLD_FRACT_STIFF_NORMAL,              1,                      m,
  //  f->getMPUnitType(CMaterialHelperFactory::UT_STRESS_GRADIENT), IDT_VALUETYPE_FRACT_STIFF_NORMAL,
  //  f->getMPCheckStrategy(CMaterialHelperFactory::MP_GE_1),                  0, QString(), false);
  //  AddLibParam(MLD_FRACT_STIFF_SHEAR,               1,                      m,
  //  f->getMPUnitType(CMaterialHelperFactory::UT_STRESS_GRADIENT), IDT_VALUETYPE_FRACT_STIFF_SHEAR,
  //  f->getMPCheckStrategy(CMaterialHelperFactory::MP_GE_1),                  0, QString(), false);
  ...
  AddLibParam(MLD_INTER_FRACT_DENS, 0, m, f->getMPUnitType(CMaterialHelperFactory::UT_PER_DISTANCE),
              ...
              false);
  AddLibParam(MLD_REFERENCE_APERTURE, DEF_REFERENCE_APERTURE, m, f->getMPUnitType(CMaterialHelperFactory::UT_DEPTH),
              IDT_VALUETYPE_REFERENCE_APERTURE, f->getMPCheckStrategy(CMaterialHelperFactory::MP_GE_1Emin6), 0,
              QString(), false);
...
int CMaterialFractureAperture2CreatorV2::MaterialModel() { return MM_FRACTURE_APERTURE2; }

QString CMaterialFractureAperture2CreatorV2::MaterialModelName() { return MLD_FRACTURE_APERTURE2; }

QString CMaterialFractureAperture2CreatorV2::CalibrationPath() const { return QString(); }
...
void CMaterialFractureAperture2CreatorDEPRECATED::OnCreateLibraryParameters(CLibraryMaterial &m) {
  ...
  //  Add(new CLibraryMaterialParameter(MLD_FRACT_STIFF_NORMAL,              1,                      m, *new
  //  CUnitTypeStressGradient, IDT_VALUETYPE_FRACT_STIFF_NORMAL,              new MP_GE(1), 0)); Add(new
  //  CLibraryMaterialParameter(MLD_FRACT_STIFF_SHEAR,               1,                      m, *new
  //  CUnitTypeStressGradient, IDT_VALUETYPE_FRACT_STIFF_SHEAR,               new MP_GE(1), 0));
  ...
  Add(new CLibraryMaterialParameter(MLD_REFERENCE_APERTURE, DEF_REFERENCE_APERTURE, m, *new CUnitTypeDepth,
                                    IDT_VALUETYPE_REFERENCE_APERTURE, new MP_GE(1e-6), 0));
...
int CMaterialFractureAperture2CreatorDEPRECATED::MaterialModel() { return MM_FRACTURE_APERTURE2; }

QString CMaterialFractureAperture2CreatorDEPRECATED::MaterialModelName() { return MLD_FRACTURE_APERTURE2; }

QString CMaterialFractureAperture2CreatorDEPRECATED::CalibrationPath() const { return QString(); }
