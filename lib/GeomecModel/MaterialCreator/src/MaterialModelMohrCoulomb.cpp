...
void CMaterialMohrCoulombCreatorV2::OnCreateLibraryParameters(CLibraryMaterial& m)
{
  ...
  AddLibParam(MLD_FRICTIONANGLE,       DEF_FRICTION,       m, f->getMPUnitType(CMaterialHelperFactory::UT_ANGLE),          IDT_VALUETYPE_FRICTION_ANGLE,    f->getMPCheckStrategy(CMaterialHelperFactory::MP_MohrCoulombFriction),   0,                                     FRICTI_FILOSPATH, false);
  AddLibParam(MLD_DILATATION,          DEF_DILATATION,     m, f->getMPUnitType(CMaterialHelperFactory::UT_ANGLE),          IDT_VALUETYPE_DILATATION,        f->getMPCheckStrategy(CMaterialHelperFactory::MP_MohrCoulombDilatation), 0,                                     DILATA_FILOSPATH, false);
...
int CMaterialMohrCoulombCreatorV2::MaterialModel()
{
  return MM_MOHRCOULOMB;
}

QString CMaterialMohrCoulombCreatorV2::MaterialModelName()
{
  return MLD_MOHRCOULOMB;
}

QString CMaterialMohrCoulombCreatorV2::CalibrationPath() const
{
  return "MOHRCO";
}
...
void CMaterialMohrCoulombCreatorDEPRECATED::OnCreateLibraryParameters(CLibraryMaterial& m)
{
  ...
  Add(new CLibraryMaterialParameter(MLD_FRICTIONANGLE,       DEF_FRICTION,       m, *new CUnitTypeAngle,         IDT_VALUETYPE_FRICTION_ANGLE,    new CMaterialMohrCoulombFrictionCheckStrategy,   0,                                     FRICTI_FILOSPATH, false));
  Add(new CLibraryMaterialParameter(MLD_DILATATION,          DEF_DILATATION,     m, *new CUnitTypeAngle,         IDT_VALUETYPE_DILATATION,        new CMaterialMohrCoulombDilatationCheckStrategy, 0,                                     DILATA_FILOSPATH, false));
...
int CMaterialMohrCoulombCreatorDEPRECATED::MaterialModel()
{
  return MM_MOHRCOULOMB;
}

QString CMaterialMohrCoulombCreatorDEPRECATED::MaterialModelName()
{
  return MLD_MOHRCOULOMB;
}

QString CMaterialMohrCoulombCreatorDEPRECATED::CalibrationPath() const
{
  return "MOHRCO";
}

IPQPlotter* CMaterialMohrCoulombCreatorDEPRECATED::PQPlotter() const
{
  return new CPQPlotter;
}

IPQPlotter* CMaterialMohrCoulombCreatorDEPRECATED::CPQPlotter::Clone() const
{
  return new CPQPlotter;
}
