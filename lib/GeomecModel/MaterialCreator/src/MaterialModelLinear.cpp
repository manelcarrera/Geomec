...
void CMaterialLinearCreatorV2::OnCreateLibrary(CLibraryMaterial& m)
{
...
int CMaterialLinearCreatorV2::MaterialModel()
{
  return MM_LINEAR;
}

QString CMaterialLinearCreatorV2::MaterialModelName()
{
  return MLD_LINEAR;
}

QString CMaterialLinearCreatorV2::CalibrationPath() const
{
  return "LINEAR";
}
...
int CMaterialLinearCreatorDEPRECATED::MaterialModel()
{
  return MM_LINEAR;
}

QString CMaterialLinearCreatorDEPRECATED::MaterialModelName()
{
  return MLD_LINEAR;
}

QString CMaterialLinearCreatorDEPRECATED::CalibrationPath() const
{
  return "LINEAR";
}
...
bool CMaterialLinearDynUniCheckStrategy::operator()(double dValue, const ml::CMatParam& param, QString& strErrorMsg, int nUnitDef) const
{
  const ml::CMaterial& mat = param.ParentMaterial();
...
bool CMaterialLinearDynShearCheckStrategy::operator()(double dValue, const ml::CMatParam& param, QString& strErrorMsg, int nUnitDef) const
{
  const ml::CMaterial& mat = param.ParentMaterial();
...
bool CMaterialLinearVelocityPCheckStrategy::operator()(double dValue, const ml::CMatParam& param, QString& strErrorMsg, int /*nUnitDef*/) const
{
  const ml::CMaterial& mat = param.ParentMaterial();
...
bool CMaterialLinearVelocitySCheckStrategy::operator()(double dValue, const ml::CMatParam& param, QString& strErrorMsg, int /*nUnitDef*/) const
{
  const ml::CMaterial& mat = param.ParentMaterial();
...
bool CMaterialLinearLatRatioMinCheckStrategy::operator()(double dValue, const ml::CMatParam& param, QString& strErrorMsg, int /*nUnitDef*/) const
{
  const ml::CMaterial& mat = param.ParentMaterial();
...
bool CMaterialLinearLatRatioMaxCheckStrategy::operator()(double dValue, const ml::CMatParam& param, QString& strErrorMsg, int /*nUnitDef*/) const
{
  const ml::CMaterial& mat = param.ParentMaterial();
