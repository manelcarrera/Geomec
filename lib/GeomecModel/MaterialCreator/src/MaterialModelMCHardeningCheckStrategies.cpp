...
bool CMaterialMCHardEquivalentPlasticStrain1CheckStrategy::operator()(double dValue, const ml::CMatParam &param,
  ...
  if (pEqPlStr2) {
    ...
    if (dValue < 0 || dValue >= dEqPlStr2) {
      strErrorMsg = QObject::tr(
          "Equivalent Plastic Strain 1 must be at least equal to 0 and smaller than Equivalent Plastic Strain 2.");
      return false;
    }
...
bool CMaterialMCHardEquivalentPlasticStrain2CheckStrategy::operator()(double dValue, const ml::CMatParam &param,
                                                                      QString &strErrorMsg, int nUnitDef) const {
  const ml::CMaterial &mat = param.ParentMaterial();
  ...
  if (pEqPlStr3) {
    ...
    if (dValue <= dEqPlStr1 || dValue >= dEqPlStr3) {
      strErrorMsg = QObject::tr("Equivalent Plastic Strain 2 must be larger than Equivalent Plastic Strain 1 and "
                                "smaller than Equivalent Plastic Strain 3.");
      return false;
    }
  } else if (dValue <= dEqPlStr1 || dValue > 1) {
    strErrorMsg = QObject::tr(
        "Equivalent Plastic Strain 2 must be larger than Equivalent Plastic Strain 1 and at most equal to 1.");
    return false;
  }
...
bool CMaterialMCHardEquivalentPlasticStrain3CheckStrategy::operator()(double dValue, const ml::CMatParam &param,
                                                                      QString &strErrorMsg, int nUnitDef) const {
  const ml::CMaterial &mat = param.ParentMaterial();
  ...
  if (dValue <= dEqPlStr2 || dValue > 1) {
    strErrorMsg = QObject::tr(
        "Equivalent Plastic Strain 3 must be larger than Equivalent Plastic Strain 2 and at most equal to 1.");
    return false;
  }
