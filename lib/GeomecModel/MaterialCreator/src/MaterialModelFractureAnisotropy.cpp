...
int CMaterialFractureAnisotropyCreatorV2::MaterialModel() { return MM_FRACTURE_ANISOTROPY; }

QString CMaterialFractureAnisotropyCreatorV2::MaterialModelName() { return MLD_FRACTURE_ANISOTROPY; }

QString CMaterialFractureAnisotropyCreatorV2::CalibrationPath() const { return QString(); }
...
int CMaterialFractureAnisotropyCreatorDEPRECATED::MaterialModel() { return MM_FRACTURE_ANISOTROPY; }

QString CMaterialFractureAnisotropyCreatorDEPRECATED::MaterialModelName() { return MLD_FRACTURE_ANISOTROPY; }

QString CMaterialFractureAnisotropyCreatorDEPRECATED::CalibrationPath() const { return QString(); }
