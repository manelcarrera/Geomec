...
void CMaterialAnisotropicCamClayCreatorV2::OnCreateLibraryParameters(CLibraryMaterial &m) {
  ...
  AddLibParam(MLD_YOUNGMODULUS_NORM, DEF_E, m, f->getMPUnitType(CMaterialHelperFactory::UT_STRESS),
              ...
              f->getMPSetStrategy(CMaterialHelperFactory::MP_SET_AnisotropyYoungNorm), QString(), false);
  ...
  AddLibParam(MLD_YOUNGMODULUS_TRANS, DEF_E, m, f->getMPUnitType(CMaterialHelperFactory::UT_STRESS),
              ...
              f->getMPSetStrategy(CMaterialHelperFactory::MP_SET_AnisotropyYoungTrans), QString(), false);
  ...
  AddLibParam(MLD_ANISOTROPIC_SHEARMODULUS, DEF_G, m, f->getMPUnitType(CMaterialHelperFactory::UT_STRESS),
              ...
              f->getMPSetStrategy(CMaterialHelperFactory::MP_SET_AnisotropyShearStiff), QString(), false);
  ...
  AddLibParam(MLD_LAYER_NORMAL_INCL, DEF_LAYERNORMAL_INCL, m, f->getMPUnitType(CMaterialHelperFactory::UT_ANGLE),
              IDT_VALUETYPE_LAYER_NORMAL_INCL, f->getMPCheckStrategy(CMaterialHelperFactory::MP_GE_0_LE_90), 0,
              QString(), false);
  AddLibParam(MLD_LAYER_NORMAL_AZI, DEF_LAYERNORMAL_AZI, m, f->getMPUnitType(CMaterialHelperFactory::UT_ANGLE),
              IDT_VALUETYPE_LAYER_NORMAL_AZI, f->getMPCheckStrategy(CMaterialHelperFactory::MP_GE_min360_LE_360), 0,
              QString(), false);
  AddLibParam(MLD_THERM_LIN_EXP_NORM, DEF_THERMX_NORMAL, m, f->getMPUnitType(CMaterialHelperFactory::UT_PER_TEMPER),
              IDT_VALUETYPE_THERM_LIN_EXP_NORM, f->getMPCheckStrategy(CMaterialHelperFactory::MP_GE_0_LE_1Emin3), 0,
              QString(), false);
  AddLibParam(MLD_THERM_LIN_EXP_LAT, DEF_THERMX_TRANS, m, f->getMPUnitType(CMaterialHelperFactory::UT_PER_TEMPER),
              IDT_VALUETYPE_THERM_LIN_EXP_LAT, f->getMPCheckStrategy(CMaterialHelperFactory::MP_GE_0_LE_1Emin3), 0,
              QString(), false);
  ...
  AddLibParam(MLD_POROSITY, DEF_PORO, m, f->getMPUnitType(CMaterialHelperFactory::UT_NONE), IDT_VALUETYPE_POROSITY,
              ...
              f->getMPSetStrategy(CMaterialHelperFactory::MP_SET_CamClayPorosity), QString(), false);
  ...
  AddLibParam(MLD_INITFRICTION, DEF_FRICTION, m, f->getMPUnitType(CMaterialHelperFactory::UT_ANGLE),
              ...
              f->getMPSetStrategy(CMaterialHelperFactory::MP_SET_CamClayFriction), QString(), false);
  ...
  AddLibParam(MLD_HARDENING, DEF_HARDENING, m, f->getMPUnitType(CMaterialHelperFactory::UT_NONE),
              ...
              f->getMPSetStrategy(CMaterialHelperFactory::MP_SET_CamClayHardening), QString(), false);
  AddLibParam(MLD_PRECONSOLIDATION, DEF_PRECONSO, m, f->getMPUnitType(CMaterialHelperFactory::UT_STRESS),
              ...
              f->getMPSetStrategy(CMaterialHelperFactory::MP_SET_CamClayPreconsolidation), QString(), false);
  AddLibParam(MLD_CAPSHAPE, DEF_CAPSHAPE, m, f->getMPUnitType(CMaterialHelperFactory::UT_NONE), IDT_VALUETYPE_CAPSHAPE,
              ...
              f->getMPSetStrategy(CMaterialHelperFactory::MP_SET_CamClayCapShap), QString(), false);
  AddLibParam(MLD_GAMMA, DEF_GAMMA, m, f->getMPUnitType(CMaterialHelperFactory::UT_NONE), IDT_VALUETYPE_TENSILE_STRETCH,
              f->getMPCheckStrategy(CMaterialHelperFactory::MP_GE_1), 0, QString(), false);
...
int CMaterialAnisotropicCamClayCreatorV2::MaterialModel() { return MM_ANISOTROPIC_CAMCLAY; }

QString CMaterialAnisotropicCamClayCreatorV2::MaterialModelName() { return MLD_ANISOTROPIC_CAMCLAY; }

QString CMaterialAnisotropicCamClayCreatorV2::CalibrationPath() const { return QString(); }
...
void CMaterialAnisotropicCamClayCreatorDEPRECATED::OnCreateLibraryParameters(CLibraryMaterial &m) {
  ...
  Add(new CLibraryMaterialParameter(MLD_LAYER_NORMAL_INCL, DEF_LAYERNORMAL_INCL, m, *new CUnitTypeAngle,
                                    IDT_VALUETYPE_LAYER_NORMAL_INCL, new MP_GE_LE(0, 90), 0));
  Add(new CLibraryMaterialParameter(MLD_LAYER_NORMAL_AZI, DEF_LAYERNORMAL_AZI, m, *new CUnitTypeAngle,
                                    IDT_VALUETYPE_LAYER_NORMAL_AZI, new MP_GE_LE(-360, 360), 0));
  Add(new CLibraryMaterialParameter(MLD_THERM_LIN_EXP_NORM, DEF_THERMX_NORMAL, m, *new CUnitTypePerTemper,
                                    IDT_VALUETYPE_THERM_LIN_EXP_NORM, new MP_GE_LE(0, 1e-3), 0));
  Add(new CLibraryMaterialParameter(MLD_THERM_LIN_EXP_LAT, DEF_THERMX_TRANS, m, *new CUnitTypePerTemper,
                                    IDT_VALUETYPE_THERM_LIN_EXP_LAT, new MP_GE_LE(0, 1e-3), 0));
  ...
  Add(new CLibraryMaterialParameter(MLD_POROSITY, DEF_PORO, m, *new CUnitTypeNone, IDT_VALUETYPE_POROSITY,
                                    new MP_GE_LT(0, 1), new CMaterialCamClayPorositySetStrategy));
  ...
  Add(new CLibraryMaterialParameter(MLD_INITFRICTION, DEF_FRICTION, m, *new CUnitTypeAngle, IDT_VALUETYPE_INITFRICTION,
                                    new MP_GE_LT(0, 70), new CMaterialCamClayFrictionSetStrategy));
  ...
  Add(new CLibraryMaterialParameter(MLD_HARDENING, DEF_HARDENING, m, *new CUnitTypeNone, IDT_VALUETYPE_HARDENING,
                                    new MP_GT_LE(0, 1), new CMaterialCamClayHardeningSetStrategy));
  Add(new CLibraryMaterialParameter(MLD_PRECONSOLIDATION, DEF_PRECONSO, m, *new CUnitTypeStress,
                                    ...
                                    new CMaterialCamClayPreconsolidationSetStrategy));
  Add(new CLibraryMaterialParameter(MLD_CAPSHAPE, DEF_CAPSHAPE, m, *new CUnitTypeNone, IDT_VALUETYPE_CAPSHAPE,
                                    new MP_GE_LE(0.1, 5.0), new CMaterialCamClayCapShapSetStrategy));
...
int CMaterialAnisotropicCamClayCreatorDEPRECATED::MaterialModel() { return MM_ANISOTROPIC_CAMCLAY; }

QString CMaterialAnisotropicCamClayCreatorDEPRECATED::MaterialModelName() { return MLD_ANISOTROPIC_CAMCLAY; }

QString CMaterialAnisotropicCamClayCreatorDEPRECATED::CalibrationPath() const { return QString(); }
