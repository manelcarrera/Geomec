...
void CMaterialCreepCreatorV2::OnCreateLibraryParameters(CLibraryMaterial &m) {
  ...
  AddLibParam(MLD_A1, DEF_A1, m, f->getMPUnitType(CMaterialHelperFactory::UT_PER_TIME), IDT_VALUETYPE_CREEP_A1,
              f->getMPCheckStrategy(CMaterialHelperFactory::MP_GE_0_LE_10), 0, CRPA1_FILOSPATH, false);
  AddLibParam(MLD_ACTIVATION_ENERGY1, DEF_QR1, m, f->getMPUnitType(CMaterialHelperFactory::UT_KELVIN_TEMPER),
              IDT_VALUETYPE_CREEP_QR1, f->getMPCheckStrategy(CMaterialHelperFactory::MP_GE_0_LE_1E6), 0,
              Q1BYR_FILOSPATH, true);

  AddLibParam(MLD_n1, DEF_N1, m, f->getMPUnitType(CMaterialHelperFactory::UT_NONE), IDT_VALUETYPE_CREEP_N1,
              f->getMPCheckStrategy(CMaterialHelperFactory::MP_GE_1_LE_10), 0, CRPN1_FILOSPATH, false);
  AddLibParam(MLD_A2, DEF_A2, m, f->getMPUnitType(CMaterialHelperFactory::UT_PER_TIME), IDT_VALUETYPE_CREEP_A2,
              f->getMPCheckStrategy(CMaterialHelperFactory::MP_GE_0_LE_10), 0, CRPA2_FILOSPATH, false);
  AddLibParam(MLD_ACTIVATION_ENERGY2, DEF_QR2, m, f->getMPUnitType(CMaterialHelperFactory::UT_KELVIN_TEMPER),
              IDT_VALUETYPE_CREEP_QR2, f->getMPCheckStrategy(CMaterialHelperFactory::MP_GE_0_LE_1E6), 0,
              Q2BYR_FILOSPATH, true);
  AddLibParam(MLD_n2, DEF_N2, m, f->getMPUnitType(CMaterialHelperFactory::UT_NONE), IDT_VALUETYPE_CREEP_N2,
              f->getMPCheckStrategy(CMaterialHelperFactory::MP_GE_1_LE_10), 0, CRPN2_FILOSPATH, false);
  AddLibParam(MLD_REFERENCE_STRESS, DEF_REF_STRESS, m, f->getMPUnitType(CMaterialHelperFactory::UT_STRESS),
              IDT_VALUETYPE_CREEP_ALPHA, f->getMPCheckStrategy(CMaterialHelperFactory::MP_GE_1Emin3_LE_1E3), 0,
              ALPHA_FILOSPATH, true);
...
int CMaterialCreepCreatorV2::MaterialModel() { return MM_CREEP; }

QString CMaterialCreepCreatorV2::MaterialModelName() { return MLD_CREEP; }

QString CMaterialCreepCreatorV2::CalibrationPath() const { return "FOKKER"; }
...
void CMaterialCreepCreatorDEPRECATED::OnCreateLibraryParameters(CLibraryMaterial &m) {
  ...
  Add(new CLibraryMaterialParameter(MLD_A1, DEF_A1, m, *new CUnitTypePerTime, IDT_VALUETYPE_CREEP_A1,
                                    new MP_GE_LE(0, 10), 0, CRPA1_FILOSPATH, false));
  Add(new CLibraryMaterialParameter(MLD_ACTIVATION_ENERGY1, DEF_QR1, m, *new CUnitTypeKelvinTemper,
                                    IDT_VALUETYPE_CREEP_QR1, new MP_GE_LE(0, 1e6), 0, Q1BYR_FILOSPATH, true));
  Add(new CLibraryMaterialParameter(MLD_n1, DEF_N1, m, *new CUnitTypeNone, IDT_VALUETYPE_CREEP_N1, new MP_GE_LE(1, 10),
                                    0, CRPN1_FILOSPATH, false));
  Add(new CLibraryMaterialParameter(MLD_A2, DEF_A2, m, *new CUnitTypePerTime, IDT_VALUETYPE_CREEP_A2,
                                    new MP_GE_LE(0, 10), 0, CRPA2_FILOSPATH, false));
  Add(new CLibraryMaterialParameter(MLD_ACTIVATION_ENERGY2, DEF_QR2, m, *new CUnitTypeKelvinTemper,
                                    IDT_VALUETYPE_CREEP_QR2, new MP_GE_LE(0, 1e6), 0, Q2BYR_FILOSPATH, true));
  Add(new CLibraryMaterialParameter(MLD_n2, DEF_N2, m, *new CUnitTypeNone, IDT_VALUETYPE_CREEP_N2, new MP_GE_LE(1, 10),
                                    0, CRPN2_FILOSPATH, false));
  Add(new CLibraryMaterialParameter(MLD_REFERENCE_STRESS, DEF_REF_STRESS, m, *new CUnitTypeStress,
                                    IDT_VALUETYPE_CREEP_ALPHA, new MP_GE_LE(1e-3, 1e3), 0, ALPHA_FILOSPATH, true));
...
int CMaterialCreepCreatorDEPRECATED::MaterialModel() { return MM_CREEP; }

QString CMaterialCreepCreatorDEPRECATED::MaterialModelName() { return MLD_CREEP; }

QString CMaterialCreepCreatorDEPRECATED::CalibrationPath() const { return "FOKKER"; }
