...
CLibraryMaterialParameter::CLibraryMaterialParameter(const QString &strName, double dValue, CLibraryMaterial &parentMat,
    ...
    : ml::CMatParam(strName, dValue, parentMat, unitConversion, pCheckStrategy, pSetStrategy),
      m_strCalibrationPath(strCalibrationPath), m_bFixedCalibrationParam(bFixedCalibrationParam),
      m_bCurrentlyFixed(false), m_uiValueTypeID(uiValueTypeID) {}

CLibraryMaterialParameter::CLibraryMaterialParameter(CLibraryMaterial &parentMat) : ml::CMatParam(parentMat) {}
...
bool CLibraryMaterialParameter::operator==(const CLibraryMaterialParameter &rhs) const {
  return (m_strCalibrationPath == rhs.m_strCalibrationPath &&
          m_bFixedCalibrationParam == rhs.m_bFixedCalibrationParam && m_bCurrentlyFixed == rhs.m_bCurrentlyFixed &&
          m_uiValueTypeID == rhs.m_uiValueTypeID);
}

bool CLibraryMaterialParameter::operator!=(const CLibraryMaterialParameter &rhs) const { return !operator==(rhs); }

const QString &CLibraryMaterialParameter::CalibrationPath() const { return m_strCalibrationPath; }

bool CLibraryMaterialParameter::IsFixedCalibrationParameter() const { return m_bFixedCalibrationParam; }

bool CLibraryMaterialParameter::IsCurrentlyFixed() const { return m_bCurrentlyFixed; }

void CLibraryMaterialParameter::CurrentlyFixed(bool bFixed) { m_bCurrentlyFixed = bFixed; }

unsigned int CLibraryMaterialParameter::ValueTypeID() const { return m_uiValueTypeID; }
