...
void CMaterialUndrainedCreatorV2::OnCreateLibrary(CLibraryMaterial& m)
{
...
void CMaterialUndrainedCreatorV2::OnCreateLibraryParameters(CLibraryMaterial& m)
{
  ...
  AddLibParam(MLD_YOUNGMODULUS,        DEF_E,                          m, f->getMPUnitType(CMaterialHelperFactory::UT_STRESS),         IDT_VALUETYPE_YOUNGS_MODULUS,    f->getMPCheckStrategy(CMaterialHelperFactory::MP_GT_0),              f->getMPSetStrategy(CMaterialHelperFactory::MP_SET_UndrainedYoung),          YOUNG_FILOSPATH,  false, GROUP_DRAINED);
  ...
  AddLibParam(MLD_POISSONRATIO,        DEF_NU,                         m, f->getMPUnitType(CMaterialHelperFactory::UT_NONE),           IDT_VALUETYPE_POISSONS_RATIO,    f->getMPCheckStrategy(CMaterialHelperFactory::MP_GE_0_LT_5Emin1),    f->getMPSetStrategy(CMaterialHelperFactory::MP_SET_UndrainedPoisson),        POISON_FILOSPATH, false, GROUP_DRAINED);
  ...
  AddLibParam(MLD_UNDRAINEDYOUNG,      0,                              m, f->getMPUnitType(CMaterialHelperFactory::UT_STRESS),         IDT_VALUETYPE_UNDRAINEDYOUNG,    f->getMPCheckStrategy(CMaterialHelperFactory::MP_GT_0),              f->getMPSetStrategy(CMaterialHelperFactory::MP_SET_UndrainedUndrainedYoung), QString(), false,                          GROUP_UNDRAINED);
  AddLibParam(MLD_UNDRAINEDPOISSON,    0,                              m, f->getMPUnitType(CMaterialHelperFactory::UT_NONE),           IDT_VALUETYPE_UNDRAINEDPOISSON,  f->getMPCheckStrategy(CMaterialHelperFactory::MP_GE_0_LT_5Emin1),    f->getMPSetStrategy(CMaterialHelperFactory::MP_SET_UndrainedUndrainedPoisson), QString(), false,                        GROUP_UNDRAINED);
  AddLibParam(MLD_UNDRAINEDTHERMX,     0,                              m, f->getMPUnitType(CMaterialHelperFactory::UT_PER_TEMPER),     IDT_VALUETYPE_UNDRAINEDTHERMX,   f->getMPCheckStrategy(CMaterialHelperFactory::MP_GE_0_LE_2Emin1),    f->getMPSetStrategy(CMaterialHelperFactory::MP_SET_UndrainedUndrainedThermalExpansionCoefficient), QString(), false,    GROUP_UNDRAINED);
  ...
  AddLibParam(MLD_POROSITY,            DEF_PORO,                       m, f->getMPUnitType(CMaterialHelperFactory::UT_NONE),           IDT_VALUETYPE_POROSITY,          f->getMPCheckStrategy(CMaterialHelperFactory::MP_GE_0_LT_1),         f->getMPSetStrategy(CMaterialHelperFactory::MP_SET_UndrainedPorosity), QString(), false);
  AddLibParam(MLD_GRAINSTIFFNESS,      DEF_GRAINSTIFFNESS,             m, f->getMPUnitType(CMaterialHelperFactory::UT_STRESS),         IDT_VALUETYPE_GRAINSTIFFNESS,    f->getMPCheckStrategy(CMaterialHelperFactory::MP_GE_10_LE_1E6),      f->getMPSetStrategy(CMaterialHelperFactory::MP_SET_UndrainedGrainStiffness), BULKS_FILOSPATH,  true);
  ...
  AddLibParam(MLD_FLUIDMODULUS,        DEF_SALTCREEP_FLUIDMOD,         m, f->getMPUnitType(CMaterialHelperFactory::UT_STRESS),         IDT_VALUETYPE_FLUID_BULK_MOD,    f->getMPCheckStrategy(CMaterialHelperFactory::MP_GT_0),              f->getMPSetStrategy(CMaterialHelperFactory::MP_SET_UndrainedFluidBulkModulus), QString(), false);
  ...
  AddLibParam(MLD_THERMX,              DEF_THERMX,                     m, f->getMPUnitType(CMaterialHelperFactory::UT_PER_TEMPER),     IDT_VALUETYPE_THERMAL_EXPANSION, f->getMPCheckStrategy(CMaterialHelperFactory::MP_GE_0_LE_1Emin3),    f->getMPSetStrategy(CMaterialHelperFactory::MP_SET_UndrainedVolumetricThermalExpansionCoefficient), QString(), false);
  ...
  AddLibParam(MLD_FLUIDX,              DEF_FLUIDX,                     m, f->getMPUnitType(CMaterialHelperFactory::UT_PER_TEMPER),     IDT_VALUETYPE_FLUIDX,            f->getMPCheckStrategy(CMaterialHelperFactory::MP_GE_0_LE_1Emin1),    f->getMPSetStrategy(CMaterialHelperFactory::MP_SET_UndrainedFluidThermalExpansionCoefficient), QString(), false);
...
int CMaterialUndrainedCreatorV2::MaterialModel()
{
  return MM_UNDRAINED;
}

QString CMaterialUndrainedCreatorV2::MaterialModelName()
{
...
{
  Add(new CLibraryMaterialParameter(MLD_YOUNGMODULUS,        DEF_E,                          m, *new CUnitTypeStress,        IDT_VALUETYPE_YOUNGS_MODULUS,    new MP_GT(0),                                new CMaterialUndrainedYoungSetStrategy,          YOUNG_FILOSPATH,  false), GROUP_DRAINED);
  ...
  Add(new CLibraryMaterialParameter(MLD_POISSONRATIO,        DEF_NU,                         m, *new CUnitTypeNone,          IDT_VALUETYPE_POISSONS_RATIO,    new MP_GE_LT(0, 0.5),                        new CMaterialUndrainedPoissonSetStrategy,        POISON_FILOSPATH, false), GROUP_DRAINED);
  ...
  Add(new CLibraryMaterialParameter(MLD_UNDRAINEDYOUNG,      0,                              m, *new CUnitTypeStress,        IDT_VALUETYPE_UNDRAINEDYOUNG,    new MP_GT(0),                                new CMaterialUndrainedUndrainedYoungSetStrategy),                          GROUP_UNDRAINED);
  Add(new CLibraryMaterialParameter(MLD_UNDRAINEDPOISSON,    0,                              m, *new CUnitTypeNone,          IDT_VALUETYPE_UNDRAINEDPOISSON,  new MP_GE_LT(0, 0.5),                        new CMaterialUndrainedUndrainedPoissonSetStrategy),                        GROUP_UNDRAINED);
  Add(new CLibraryMaterialParameter(MLD_UNDRAINEDTHERMX,     0,                              m, *new CUnitTypePerTemper,     IDT_VALUETYPE_UNDRAINEDTHERMX,   new MP_GE_LE(0, 0.2),                        new CMaterialUndrainedUndrainedThermalExpansionCoefficientSetStrategy),    GROUP_UNDRAINED);
  ...
  Add(new CLibraryMaterialParameter(MLD_POROSITY,            DEF_PORO,                       m, *new CUnitTypeNone,          IDT_VALUETYPE_POROSITY,          new MP_GE_LT(0, 1),                          new CMaterialUndrainedPorositySetStrategy));
  Add(new CLibraryMaterialParameter(MLD_GRAINSTIFFNESS,      DEF_GRAINSTIFFNESS,             m, *new CUnitTypeStress,        IDT_VALUETYPE_GRAINSTIFFNESS,    new MP_GE_LE(10, 1000000),                   new CMaterialUndrainedGrainStiffnessSetStrategy, BULKS_FILOSPATH,  true));
  ...
  Add(new CLibraryMaterialParameter(MLD_FLUIDMODULUS,        DEF_SALTCREEP_FLUIDMOD,         m, *new CUnitTypeStress,        IDT_VALUETYPE_FLUID_BULK_MOD,    new MP_GT(0),                                new CMaterialUndrainedFluidBulkModulusSetStrategy));
  ...
  Add(new CLibraryMaterialParameter(MLD_THERMX,              DEF_THERMX,                     m, *new CUnitTypePerTemper,     IDT_VALUETYPE_THERMAL_EXPANSION, new MP_GE_LE(0, 1e-3),                       new CMaterialUndrainedVolumetricThermalExpansionCoefficientSetStrategy));
  ...
  Add(new CLibraryMaterialParameter(MLD_FLUIDX,              DEF_FLUIDX,                     m, *new CUnitTypePerTemper,     IDT_VALUETYPE_FLUIDX,            new MP_GE_LE(0, 0.1),                        new CMaterialUndrainedFluidThermalExpansionCoefficientSetStrategy));
...
int CMaterialUndrainedCreatorDEPRECATED::MaterialModel()
{
  return MM_UNDRAINED;
}

QString CMaterialUndrainedCreatorDEPRECATED::MaterialModelName()
{
  return MLD_UNDRAINED;
}
...
static double Alpha(double Kb, double Kg)
{
  return 1 - Kb / Kg;
}
...
static double VolumetricThermalExpansionCoefficient(double Bu, double phi, double Bf, double Eu, double Kb, double Kg, double Kf)
{
...
static double UndrainedThermalExpansionCoefficient(double Bb, double phi, double Bf, double Eu, double Kb, double alpha, double Kg, double Kf)
{
...
void CMaterialUndrainedUndrainedThermalExpansionCoefficientSetStrategy::operator()(double dValue,ml::CMatParam& param) const
{
  ml::CMaterial& mat = param.ParentMaterial();
...
void CMaterialUndrainedVolumetricThermalExpansionCoefficientSetStrategy::operator()(double dValue, ml::CMatParam& param) const
{
  ml::CMaterial& mat = param.ParentMaterial();
...
void CMaterialUndrainedFluidThermalExpansionCoefficientSetStrategy::operator()(double dValue, ml::CMatParam& param) const
{
  ml::CMaterial& mat = param.ParentMaterial();
