...
void CMaterialDualCapLinElaCreatorV2::OnCreateLibraryParameters(CLibraryMaterial &m) {
  ...
  AddLibParam(MLD_HARDENING, DEF_HARDENING, m, f->getMPUnitType(CMaterialHelperFactory::UT_NONE),
              IDT_VALUETYPE_HARDENING, f->getMPCheckStrategy(CMaterialHelperFactory::MP_DualCapHardening),
  ...
  AddLibParam(MLD_PRECONSOLIDATION, DEF_PRECONSO, m, f->getMPUnitType(CMaterialHelperFactory::UT_STRESS),
              IDT_VALUETYPE_PRECONSOLIDATION, f->getMPCheckStrategy(CMaterialHelperFactory::MP_DualCapPreconsolidation),
  ...
  AddLibParam(MLD_SEC_PRECON, DEF_SEC_PRECON, m, f->getMPUnitType(CMaterialHelperFactory::UT_STRESS),
              IDT_VALUETYPE_SEC_PRECON, f->getMPCheckStrategy(CMaterialHelperFactory::MP_DualCapSecondaryPrecon), 0,
              PRECO1_FILOSPATH, false);
  AddLibParam(MLD_SEC_HARDENING, DEF_SEC_HARD, m, f->getMPUnitType(CMaterialHelperFactory::UT_NONE),
              IDT_VALUETYPE_SEC_HARDENING, f->getMPCheckStrategy(CMaterialHelperFactory::MP_DualCapSecHardening), 0,
              MU_FILOSPATH, false);
...
int CMaterialDualCapLinElaCreatorV2::MaterialModel() { return MM_DUALCAP_LINELA; }

QString CMaterialDualCapLinElaCreatorV2::MaterialModelName() { return MLD_DUALCAP_LINELA; }

QString CMaterialDualCapLinElaCreatorV2::CalibrationPath() const { return "DOHALI"; }
...
void CMaterialDualCapLinElaCreatorDEPRECATED::OnCreateLibraryParameters(CLibraryMaterial &m) {
  ...
  Add(new CLibraryMaterialParameter(MLD_PRECONSOLIDATION, DEF_PRECONSO, m, *new CUnitTypeStress,
                                    IDT_VALUETYPE_PRECONSOLIDATION, new CMaterialDualCapPreconsolidationCheckStrategy,
  ...
  Add(new CLibraryMaterialParameter(MLD_CAPSHAPE, DEF_CAPSHAPE, m, *new CUnitTypeNone, IDT_VALUETYPE_CAPSHAPE,
                                    ...
                                    false));
  Add(new CLibraryMaterialParameter(MLD_SEC_PRECON, DEF_SEC_PRECON, m, *new CUnitTypeStress, IDT_VALUETYPE_SEC_PRECON,
                                    new CMaterialDualCapSecondaryPreconCheckStrategy, 0, PRECO1_FILOSPATH, false));
  Add(new CLibraryMaterialParameter(MLD_SEC_HARDENING, DEF_SEC_HARD, m, *new CUnitTypeNone, IDT_VALUETYPE_SEC_HARDENING,
                                    new MP_GE_LE(0, 1), 0, MU_FILOSPATH, false));
...
int CMaterialDualCapLinElaCreatorDEPRECATED::MaterialModel() { return MM_DUALCAP_LINELA; }

QString CMaterialDualCapLinElaCreatorDEPRECATED::MaterialModelName() { return MLD_DUALCAP_LINELA; }

QString CMaterialDualCapLinElaCreatorDEPRECATED::CalibrationPath() const { return "DOHALI"; }

IPQPlotter *CMaterialDualCapLinElaCreatorDEPRECATED::PQPlotter() const {
  return new CMaterialDualCapCreator::CPQPlotter;
}

bool CMaterialDualCapLinElaHardeningCheckStrategy::operator()(double dValue, const ml::CMatParam &param,
...
bool CMaterialDualCapLinElaSecondaryHardeningCheckStrategy::operator()(double dValue, const ml::CMatParam &param,
                                                                       QString &strErrorMsg, int nUnitDef) const {
  const ml::CMaterial &mat = param.ParentMaterial();
