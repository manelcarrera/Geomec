...
public:
  // virtual CMaterialDualCapPreconsolidationCheckStrategy* Clone() const { return new
  // CMaterialDualCapPreconsolidationCheckStrategy; }
...
public:
  // virtual CMaterialDualCapSecondaryPreconCheckStrategy* Clone() const { return new
  // CMaterialDualCapSecondaryPreconCheckStrategy; }
  virtual bool operator()(double dValue, const ml::CMatParam &param, QString &strErrorMsg, int nUnitDef = 0) const;
};
...
public:
  // virtual CMaterialDualCapPreconsolidationSetStrategy* Clone() const { return new
  // CMaterialDualCapPreconsolidationSetStrategy; }
  virtual void operator()(double dValue, ml::CMatParam &param) const;
};

class CMaterialDualCapElasticHardeningSetStrategy : public ml::CMatParam::CSetStrategy {
public:
  // virtual CMaterialDualCapElasticHardeningSetStrategy* Clone() const { return new
  // CMaterialDualCapElasticHardeningSetStrategy; }
  virtual void operator()(double dValue, ml::CMatParam &param) const;
};
