...
{
public:
  //virtual CMaterialLinearLatRatioMinCheckStrategy* Clone() const { return new CMaterialLinearLatRatioMinCheckStrategy; }
  virtual bool operator()(double dValue, const ml::CMatParam& param, QString& strErrorMsg, int nUnitDef = 0) const;
};
...
{
public:
  //virtual CMaterialLinearLatRatioMaxCheckStrategy* Clone() const { return new CMaterialLinearLatRatioMaxCheckStrategy; }
  virtual bool operator()(double dValue, const ml::CMatParam& param, QString& strErrorMsg, int nUnitDef = 0) const;
};
