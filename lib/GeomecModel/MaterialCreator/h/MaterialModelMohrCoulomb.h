...
public:
  // virtual CMaterialMohrCoulombFrictionCheckStrategy* Clone() const { return new
  // CMaterialMohrCoulombFrictionCheckStrategy; }
...
public:
  // virtual CMaterialMohrCoulombDilatationCheckStrategy* Clone() const { return new
  // CMaterialMohrCoulombDilatationCheckStrategy; }
  virtual bool operator()(double dValue, const ml::CMatParam &param, QString &strErrorMsg, int nUnitDef = 0) const;
};
