...
{
public:
  //virtual CMaterialMCHardEquivalentPlasticStrain1CheckStrategy* Clone() const { return new CMaterialMCHardEquivalentPlasticStrain1CheckStrategy; }
...
{
public:
  //virtual CMaterialMCHardEquivalentPlasticStrain2CheckStrategy* Clone() const { return new CMaterialMCHardEquivalentPlasticStrain2CheckStrategy; }
  virtual bool operator()(double dValue, const ml::CMatParam& param, QString& strErrorMsg, int nUnitDef = 0) const;
};
...
{
public:
  //virtual CMaterialMCHardEquivalentPlasticStrain3CheckStrategy* Clone() const { return new CMaterialMCHardEquivalentPlasticStrain3CheckStrategy; }
  virtual bool operator()(double dValue, const ml::CMatParam& param, QString& strErrorMsg, int nUnitDef = 0) const;
};
