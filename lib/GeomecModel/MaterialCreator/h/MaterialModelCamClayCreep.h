...
{
public:
  //virtual CMaterialCamClayCreepPoissonSetStrategy* Clone() const { return new CMaterialCamClayCreepPoissonSetStrategy; }
  virtual void operator()(double dValue, ml::CMatParam& param) const;
};
...
{
public:
  //virtual CMaterialCamClayCreepBulkStiffSetStrategy* Clone() const { return new CMaterialCamClayCreepBulkStiffSetStrategy; }
  virtual void operator()(double dValue, ml::CMatParam& param) const;
};
...
{
public:
  //virtual CMaterialCamClayCreepShearStiffSetStrategy* Clone() const { return new CMaterialCamClayCreepShearStiffSetStrategy; }
  virtual void operator()(double dValue, ml::CMatParam& param) const;
};
...
{
public:
 //virtual CMaterialCamClayCreepDynShearSetStrategy* Clone() const { return new CMaterialCamClayCreepDynShearSetStrategy; }
  virtual void operator()(double dValue, ml::CMatParam& param) const;
};
...
{
public:
  //virtual CMaterialCamClayCreepVelocityPSetStrategy* Clone() const { return new CMaterialCamClayCreepVelocityPSetStrategy; }
  virtual void operator()(double dValue, ml::CMatParam& param) const;
};
...
{
public:
  //virtual CMaterialCamClayCreepVelocitySSetStrategy* Clone() const { return new CMaterialCamClayCreepVelocitySSetStrategy; }
  virtual void operator()(double dValue, ml::CMatParam& param) const;
};
...
{
public:
  //virtual CMaterialCamClayCreepPorositySetStrategy* Clone() const { return new CMaterialCamClayCreepPorositySetStrategy; }
  virtual void operator()(double dValue, ml::CMatParam& param) const;
};
...
{
public:
  //virtual CMaterialCamClayCreepFrictionSetStrategy* Clone() const { return new CMaterialCamClayCreepFrictionSetStrategy; }
  virtual void operator()(double dValue, ml::CMatParam& param) const;
};
...
{
public:
  //virtual CMaterialCamClayCreepHardeningSetStrategy* Clone() const { return new CMaterialCamClayCreepHardeningSetStrategy; }
  virtual void operator()(double dValue, ml::CMatParam& param) const;
};
...
{
public:
  virtual CMaterialCamClayCreepPreconsolidationSetStrategy* Clone() const { return new CMaterialCamClayCreepPreconsolidationSetStrategy; }
  virtual void operator()(double dValue, ml::CMatParam& param) const;
};
...
{
public:
  //virtual CMaterialCamClayCreepCapShapSetStrategy* Clone() const { return new CMaterialCamClayCreepCapShapSetStrategy; }
  virtual void operator()(double dValue, ml::CMatParam& param) const;
};
