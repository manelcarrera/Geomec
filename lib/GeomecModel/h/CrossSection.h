...
public:
  ...
  public:
    ...
    public:
      CCSObjectDrawDef(const COpenGLNode &node) : CColorNode::CDrawDef(node) {}
  ...
  enum TCrossSectionType { VERTICAL = 0, HORIZONTAL, MANUAL };
...
public:
  ...
  void SetBookmarked(const geo::IPoint &basePoint, const geo::IVector &normal, OrientationType orientation,
                     bool bSendModified = true);
  void SetScreen(const geo::IPoint &basePoint, const geo::IVector &normal, OrientationType orientation,
                 bool bSendModified = true);
  ...
  static bool calculateTwoArbitraryPointsInPlane(geo::IPoint &first, geo::IPoint &second, const geo::IPlane &plane,
