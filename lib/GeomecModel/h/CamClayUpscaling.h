...
public:
  ...
  double PlasticCompressibility1(const double &n0, const double &Lam1, const double &Pc1, const double &Ce,
                                 const double &alpha, const double &phi);
  double PlasticCompressibility2(const double &n0, const double &Lam1, const double &Lam2, const double &Pc2,
