...
class CTemperatureGradientComponent
    : public CFormationLoadGradientComponent<TTemperature, CTemperatureQuantity, CTemperatureGradientQuantity> {
public:
...
class CTemperatureRepeaterComponent
    : public CFormationLoadRepeaterComponent<TTemperature, CTemperatureGradientComponent, CTemperatureRepeaterComponent,
                                             CTemperatureGWCDummyComponent> {
public:
...
typedef CFormationLoad<TTemperature, CTemperatureGradientComponent, CTemperatureRepeaterComponent,
                       CTemperatureGWCDummyComponent>
    TTemperatureBase;
...
public:
  ...
  CTemperature(CFormationBase &f, CDepletionStage &d, const double &dReferenceTemperature,
               const double &dReferenceDepth, const double &dGradient,
               const CQuantity::UNIT unit = CQuantity::SI_UNIT); // Constant initialisation
  CTemperature(CFormationBase &f, CDepletionStage &d, TTemperature &p);
...
private:
  ...
  CGlobalValueObserver<CTemperature, CGlobalTemperature> *m_GlobalTemperatureObserver;
};
