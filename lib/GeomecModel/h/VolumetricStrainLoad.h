...
class CVolumetricStrainLoadGradientComponent
    : public CFormationLoadGradientComponent<TVolumetricStrain, CStrainQuantity, CStrainQuantity> {
private:
...
class CVolumetricStrainLoadRepeaterComponent
    : public CFormationLoadRepeaterComponent<TVolumetricStrain, CVolumetricStrainLoadGradientComponent,
...
typedef CFormationLoad<TVolumetricStrain, CVolumetricStrainLoadGradientComponent,
                       CVolumetricStrainLoadRepeaterComponent, CVolumetricStrainLoadGWCDummyComponent>
    TVolumetricStrainLoadBase;
...
public:
  ...
  CVolumetricStrainLoad(CFormationBase &f, CDepletionStage &d, const double &dVolStrain,
