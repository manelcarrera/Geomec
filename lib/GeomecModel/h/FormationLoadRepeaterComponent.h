...
template <class VALUE_TYPE, class CONSTANT_TYPE, class REPEATER_TYPE, class GWC_TYPE>
CFormationLoadRepeaterComponent<VALUE_TYPE, CONSTANT_TYPE, REPEATER_TYPE, GWC_TYPE>::CFormationLoadRepeaterComponent(
    CFormationLoadBase<VALUE_TYPE> &formationload)
    : CFormationLoadComponent<VALUE_TYPE>(formationload, CFormationLoadBase<VALUE_TYPE>::REPEAT_MODE) {}

template <class VALUE_TYPE, class CONSTANT_TYPE, class REPEATER_TYPE, class GWC_TYPE>
CFormationLoadRepeaterComponent<VALUE_TYPE, CONSTANT_TYPE, REPEATER_TYPE, GWC_TYPE>::CFormationLoadRepeaterComponent(
    const CFormationLoadRepeaterComponent &rhs)
...
CFormationLoadRepeaterComponent<VALUE_TYPE, CONSTANT_TYPE, REPEATER_TYPE, GWC_TYPE>::ValueElement(
    const geo::IElement &elm, const CQuantity::UNIT unit, geo::IParallelInitializationCallback *cb) const {
  const TFormationLoad *pFormationLoad =
      dynamic_cast<const TFormationLoad *>(&CFormationLoadComponent<VALUE_TYPE>::FormationLoadBase());
...
CFormationLoadRepeaterComponent<VALUE_TYPE, CONSTANT_TYPE, REPEATER_TYPE, GWC_TYPE>::ValuePoint(
...
template <class VALUE_TYPE, class CONSTANT_TYPE, class REPEATER_TYPE, class GWC_TYPE>
void CFormationLoadRepeaterComponent<VALUE_TYPE, CONSTANT_TYPE, REPEATER_TYPE, GWC_TYPE>::LoadStream(
...
template <class VALUE_TYPE, class CONSTANT_TYPE, class REPEATER_TYPE, class GWC_TYPE>
void CFormationLoadRepeaterComponent<VALUE_TYPE, CONSTANT_TYPE, REPEATER_TYPE, GWC_TYPE>::SaveStream(
...
template <class VALUE_TYPE, class CONSTANT_TYPE, class REPEATER_TYPE, class GWC_TYPE>
bool CFormationLoadRepeaterComponent<VALUE_TYPE, CONSTANT_TYPE, REPEATER_TYPE, GWC_TYPE>::PrepareMapping(
