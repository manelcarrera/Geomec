...
public:
  ...
  void Set(const double &dReferenceValue, const double &dReferenceDepth, const double &dGradient,
...
template <class VALUE_TYPE, class SINGLE_TYPE, class GRADIENT_TYPE>
CFormationLoadGradientComponent<VALUE_TYPE, SINGLE_TYPE, GRADIENT_TYPE>::CFormationLoadGradientComponent(
    CFormationLoadBase<VALUE_TYPE> &formationload, bool bEmpty)
    : CFormationLoadComponent<VALUE_TYPE>(formationload, CFormationLoadBase<VALUE_TYPE>::CONSTANT_MODE, bEmpty),
      m_ReferenceValue(0), m_ReferenceDepth(0), m_Gradient(0) {}

template <class VALUE_TYPE, class SINGLE_TYPE, class GRADIENT_TYPE>
CFormationLoadGradientComponent<VALUE_TYPE, SINGLE_TYPE, GRADIENT_TYPE>::CFormationLoadGradientComponent(
    const CFormationLoadGradientComponent &rhs)
    : CFormationLoadComponent<VALUE_TYPE>(rhs), m_ReferenceValue(rhs.m_ReferenceValue),
      m_ReferenceDepth(rhs.m_ReferenceDepth), m_Gradient(rhs.m_Gradient) {}
...
template <class VALUE_TYPE, class SINGLE_TYPE, class GRADIENT_TYPE>
IValueDomainScalar::TValueVec CFormationLoadGradientComponent<VALUE_TYPE, SINGLE_TYPE, GRADIENT_TYPE>::ValueElement(
    const geo::IElement &elm, const CQuantity::UNIT unit, geo::IParallelInitializationCallback *cb) const {
...
template <class VALUE_TYPE, class SINGLE_TYPE, class GRADIENT_TYPE>
IValueDomainScalar::TValue CFormationLoadGradientComponent<VALUE_TYPE, SINGLE_TYPE, GRADIENT_TYPE>::ValuePoint(
    const geo::IPoint &pt, const CQuantity::UNIT unit, geo::IParallelInitializationCallback *cb) const {
  const CModelBase &model = static_cast<const CModelBase &>(CFormationLoadComponent<VALUE_TYPE>::Model());
...
template <class VALUE_TYPE, class SINGLE_TYPE, class GRADIENT_TYPE>
bool CFormationLoadGradientComponent<VALUE_TYPE, SINGLE_TYPE, GRADIENT_TYPE>::operator==(
    const CFormationLoadGradientComponent &rhs) const {
  if (rhs.IsCopy()) {
  ...
  return ((ReferenceValue() == rhs.ReferenceValue()) && (ReferenceDepth() == rhs.ReferenceDepth()) &&
          (Gradient() == rhs.Gradient()));
}

template <class VALUE_TYPE, class SINGLE_TYPE, class GRADIENT_TYPE>
CFormationLoadGradientComponent<VALUE_TYPE, SINGLE_TYPE, GRADIENT_TYPE> &
CFormationLoadGradientComponent<VALUE_TYPE, SINGLE_TYPE, GRADIENT_TYPE>::operator=(
    const CFormationLoadGradientComponent &rhs) {
  if (!((*this) == rhs)) {
...
template <class VALUE_TYPE, class SINGLE_TYPE, class GRADIENT_TYPE>
void CFormationLoadGradientComponent<VALUE_TYPE, SINGLE_TYPE, GRADIENT_TYPE>::SaveStream(TSTREAM &stream,
                                                                                         TPROGRESS &progress) {
...
template <class VALUE_TYPE, class SINGLE_TYPE, class GRADIENT_TYPE>
void CFormationLoadGradientComponent<VALUE_TYPE, SINGLE_TYPE, GRADIENT_TYPE>::LoadStream(TSTREAM &stream,
...
template <class VALUE_TYPE, class SINGLE_TYPE, class GRADIENT_TYPE>
bool CFormationLoadGradientComponent<VALUE_TYPE, SINGLE_TYPE, GRADIENT_TYPE>::PrepareMapping(
