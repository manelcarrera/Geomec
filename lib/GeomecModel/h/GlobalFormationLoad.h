...
template <class VALUE_TYPE, class CONSTANT_TYPE> class CGlobalFormationLoad : public CFormationLoadBase<VALUE_TYPE> {
public:
  CGlobalFormationLoad(const QString &strName, CFemAppModel &model);
  ...
  virtual void LoadStream(typename CFormationLoadBase<VALUE_TYPE>::TSTREAM &stream, CStreamVersion &version,
                          typename CFormationLoadBase<VALUE_TYPE>::TPROGRESS &progress);
  virtual void SaveStream(typename CFormationLoadBase<VALUE_TYPE>::TSTREAM &stream,
                          typename CFormationLoadBase<VALUE_TYPE>::TPROGRESS &progress);
...
CGlobalFormationLoad<VALUE_TYPE, CONSTANT_TYPE>::CGlobalFormationLoad(const QString &strName, CFemAppModel &model)
...
template <class VALUE_TYPE, class CONSTANT_TYPE>
CGlobalFormationLoad<VALUE_TYPE, CONSTANT_TYPE> &
CGlobalFormationLoad<VALUE_TYPE, CONSTANT_TYPE>::operator=(const CGlobalFormationLoad &rhs) {
...
CONSTANT_TYPE &CGlobalFormationLoad<VALUE_TYPE, CONSTANT_TYPE>::Constant() {
  return const_cast<CONSTANT_TYPE &>(
      static_cast<const CGlobalFormationLoad<VALUE_TYPE, CONSTANT_TYPE> &>(*this).Constant());
}

template <class VALUE_TYPE, class CONSTANT_TYPE>
geo::CPoint CGlobalFormationLoad<VALUE_TYPE, CONSTANT_TYPE>::Min() const {
  const CModelBase *pModel = (const CModelBase *)(&CFormationLoadBase<VALUE_TYPE>::Model());
...
template <class VALUE_TYPE, class CONSTANT_TYPE>
void CGlobalFormationLoad<VALUE_TYPE, CONSTANT_TYPE>::LoadStream(
    typename CFormationLoadBase<VALUE_TYPE>::TSTREAM &stream, CStreamVersion &version,
    typename CFormationLoadBase<VALUE_TYPE>::TPROGRESS &progress) {
...
template <class VALUE_TYPE, class CONSTANT_TYPE>
void CGlobalFormationLoad<VALUE_TYPE, CONSTANT_TYPE>::SaveStream(
    typename CFormationLoadBase<VALUE_TYPE>::TSTREAM &stream,
    typename CFormationLoadBase<VALUE_TYPE>::TPROGRESS &progress) {
