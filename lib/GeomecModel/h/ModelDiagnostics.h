...
const QString Setting_LoadMainModelNoResults("LoadMainModelNoResults"); // don't store the results of the main model in the result cache
...
const QString Setting_LoadMainModelOnly("LoadMainModelOnly"); // break off loading before processing the zoomin graphnodeentry
}
