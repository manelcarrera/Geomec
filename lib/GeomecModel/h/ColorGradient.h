...
public:
  ...
  CColorGradient(unsigned int uName, CFemAppModel &model, const double &firstValue, const double &secondValue,
                 TColor min_color = qRgb(0, 0, 255), TColor max_color = qRgb(255, 0, 0), bool bGlobal = true);
