#ifndef _RetrieveDianaFileNamesConsole_h_
#define _RetrieveDianaFileNamesConsole_h_
...
private:
  ...
  CRetrieveDianaFileNamesConsole &operator=(const CRetrieveDianaFileNamesConsole &rhs);

private:
  QString m_strWorkingDir;
};

#endif // _RetrieveDianaFileNamesConsole_h_
