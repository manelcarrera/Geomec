...
class CFormationLoadBase : public IValueComposite 
{
...
template <class VALUE_TYPE>
CFormationLoadBase<VALUE_TYPE>::~CFormationLoadBase()
{

}

template <class VALUE_TYPE>
bool CFormationLoadBase<VALUE_TYPE>::operator==(const CFormationLoadBase& rhs) const
{
  if(!IValueComposite::operator ==(rhs))
    return false;

  return ((m_vcDistributed == rhs.m_vcDistributed) &&
...
template <class VALUE_TYPE>
size_t CFormationLoadBase<VALUE_TYPE>::DistributedSize() const
{
  return m_vcDistributed.size();
}

template <class VALUE_TYPE>
const VALUE_TYPE& CFormationLoadBase<VALUE_TYPE>::DistributedValue(size_t nIndex) const
{
...
template <class VALUE_TYPE>
void CFormationLoadBase<VALUE_TYPE>::OnNewNeighbour(const CGraphNode &node)
{
...
template <class VALUE_TYPE>
void CFormationLoadBase<VALUE_TYPE>::OnNeighbourDeleted(const CGraphNode &node)
{
...
template <class VALUE_TYPE>
bool CFormationLoadBase<VALUE_TYPE>::DistributedOnly() const
{
  return m_bDistributedOnly;
}

template <class VALUE_TYPE>
void CFormationLoadBase<VALUE_TYPE>::DistributedOnly(bool bDistributedOnly)
{
  m_bDistributedOnly = bDistributedOnly;
}

template <class VALUE_TYPE>
bool CFormationLoadBase<VALUE_TYPE>::ConnectItem(const CGraphNode &item)
{
...
template <class VALUE_TYPE>
bool CFormationLoadBase<VALUE_TYPE>::CanConnectItem(const CGraphNode &item) const
{
  const VALUE_TYPE* pDistri = dynamic_cast<const VALUE_TYPE*>(&item);
...
template <class VALUE_TYPE>
void CFormationLoadBase<VALUE_TYPE>::SaveStream(TSTREAM &stream, TPROGRESS &progress)
{
  // Pre defined and extrapolated are saved here from 3.0.21
...
template <class VALUE_TYPE>
long CFormationLoadBase<VALUE_TYPE>::SavedItems() const
{
  return (long)DistributedSize();
}

template <class VALUE_TYPE>
bool CFormationLoadBase<VALUE_TYPE>::ReadOnly() const
{
  return false;
}

template <class VALUE_TYPE>
const CFormationBase* CFormationLoadBase<VALUE_TYPE>::Formation() const
{
  return 0;
}

template <class VALUE_TYPE>
CFormationBase* CFormationLoadBase<VALUE_TYPE>::Formation()
{
  return 0;
}

template <class VALUE_TYPE>
bool CFormationLoadBase<VALUE_TYPE>::PrepareMapping(const geo::IElementSet *pElementSet, const IValueComponentBase* /*pValueComponent*/)
{
  bool retval = true;
...
class FormationBaseTemplDistributedSetWrapper : public IDistributedSetWrapper
{
  const CFormationLoadBase<VALUE_TYPE>& parent;

public:

  FormationBaseTemplDistributedSetWrapper(const CFormationLoadBase<VALUE_TYPE>& formationBase) : parent(formationBase) {}
