...
protected:
  ...
  virtual CElementSet *OnCreateElementSet(const QString &sName, CFemAppModel &model, CQuantity::UNIT coordinate_unit,
                                          CQuantity::UNIT value_unit) const;
  virtual CPointSet *OnCreatePointSet(const QString &sName, CFemAppModel &model, int nValueSetSize,
