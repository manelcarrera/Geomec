...
class CMaterialServerParent : public BASE
{
public:
...
template <class BASE, class MATERIALSERVER>
CMaterialServerParent<BASE, MATERIALSERVER>::CMaterialServerParent(CFemAppModel& model)
: BASE(model)
{
}
...
template <class BASE, class MATERIALSERVER>
CMaterialServerParent<BASE, MATERIALSERVER>& CMaterialServerParent<BASE, MATERIALSERVER>::operator=(const CMaterialServerParent& rhs)
{
  BASE::operator=(rhs);
...
template <class BASE, class MATERIALSERVER>
const MATERIALSERVER* CMaterialServerParent<BASE, MATERIALSERVER>::ConnectedMaterial(const CDepletionStage& stage) const
{
...
template <class BASE, class MATERIALSERVER>
void CMaterialServerParent<BASE, MATERIALSERVER>::LoadStream(TSTREAM& stream, CStreamVersion& version, TPROGRESS& progress)
{
...
template <class BASE, class MATERIALSERVER>
long CMaterialServerParent<BASE, MATERIALSERVER>::SavedItems() const
{
...
template <class BASE, class MATERIALSERVER>
unsigned int CMaterialServerParent<BASE, MATERIALSERVER>::IconId() const
{
  assert(false);
...
template <class BASE, class MATERIALSERVER>
unsigned int CMaterialServerParent<BASE, MATERIALSERVER>::TypeId() const
{
  assert(false);
...
template <class BASE, class MATERIALSERVER>
int CMaterialServerParent<BASE, MATERIALSERVER>::DisplayListSize() const
{
  assert(false);
...
template <class BASE, class MATERIALSERVER>
void CMaterialServerParent<BASE, MATERIALSERVER>::SaveMaterial(CDepletionStage& stage, TSTREAM& stream, TPROGRESS& progress)
{
  MATERIALSERVER* pMatServer = ConnectedMaterial(stage);
  if(pMatServer)
...
template <class BASE, class MATERIALSERVER>
void CMaterialServerParent<BASE, MATERIALSERVER>::LoadMaterial(CDepletionStage& stage, TSTREAM& stream, CStreamVersion& version, TPROGRESS& progress)
{
