...
public:
  CInterfaceBoundary(const geo::IPoint &ptMin, const geo::IPoint &ptMax, CFemAppModel &model,
...
private:
  ...
  typedef std::map<const geo::CInterfaceElement *, CBoundaryInterfaceDef::TBoundarySurface>
      TInterfaceElement2BoundarySurfaceMap;
