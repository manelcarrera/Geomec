...
geo::CMatrix CMaterialFractAnisotropy::CalculateAnisotropyComplianceMatrix(const CFFMaterial &ffmat,
                                                                           double En,
                                                                           double Et,
                                                                           double Nun,
                                                                           double Nut,
...
bool CMaterialFractAnisotropy::WriteFilosParamName(const CFFMaterial &ffmat, dia::IDianaRunner& diarunner, int i, char *name) const
{
  if (i == 0)
  {
...
void CMaterialFractAnisotropy::WriteFilosParamValues(const CFFMaterial &ffmat, dia::IDianaRunner& diarunner, double *values, int stride) const
{
