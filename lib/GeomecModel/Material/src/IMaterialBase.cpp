...
IMaterialBase::IMaterialBase(const QString &strName, CFemAppModel &model) : CStorageNode(strName, model) {}

IMaterialBase::IMaterialBase(const IMaterialBase &rhs) : CStorageNode(rhs) {}
...
bool IMaterialBase::FixedMaterialModel() const { return false; }
...
const IMaterialBase::TServerSet &IMaterialBase::Servers() const { return m_stServers; }
