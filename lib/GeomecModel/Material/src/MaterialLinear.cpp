...
CMaterialLinear::CMaterialLinear(CMaterialEntry &entry, CLibraryMaterial &libmat) : IMaterialRock(entry, libmat) {}
...
bool CMaterialLinear::WriteFilosParamName(const CFFMaterial &ffmat, dia::IDianaRunner &diarunner, int i,
                                          char *name) const {
  if (i == 0) {
...
void CMaterialLinear::WriteFilosParamValues(const CFFMaterial &ffmat, dia::IDianaRunner &diarunner, double *values,
                                            int stride) const {
