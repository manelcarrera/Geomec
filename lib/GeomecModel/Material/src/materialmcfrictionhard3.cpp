...
bool CMaterialMCFrictionHard3::WriteFilosParamName(const CFFMaterial &ffmat, dia::IDianaRunner &diarunner, int i,
                                                   char *name) const {
  if (i < 8) {
...
void CMaterialMCFrictionHard3::WriteFilosParamValues(const CFFMaterial &ffmat, dia::IDianaRunner &diarunner,
