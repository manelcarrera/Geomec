...
bool CMaterialMCFrictionHard1::WriteFilosParamName(const CFFMaterial &ffmat, dia::IDianaRunner& diarunner, int i, char *name) const
{
  if (i < 4)
  {
...
void CMaterialMCFrictionHard1::WriteFilosParamValues(const CFFMaterial &ffmat, dia::IDianaRunner& diarunner, double *values, int stride) const
{
  *values = 0; // DISCOH(1)
  values += stride;
