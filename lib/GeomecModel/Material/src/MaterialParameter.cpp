...
double CMaterialParameter::Value() const { return m_LibraryParameter.Value(); }
/*
...
*/
unsigned int CMaterialParameter::ValueTypeID() const { return m_uiValueTypeID; }
/*
...
bool CMaterialParameter::operator<(const CMaterialParameter &rhs) const {
  return (m_uiValueTypeID < rhs.m_uiValueTypeID || (!(rhs.m_uiValueTypeID < m_uiValueTypeID) && Value() < rhs.Value()));
}
