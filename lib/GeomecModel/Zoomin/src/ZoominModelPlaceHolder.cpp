...
CZoominModelPlaceHolder::CZoominModelPlaceHolder(CFemAppModel& model)
: COpenGLNode(model),
  m_pChildModel(0)
{
}
...
CModelBase& CZoominModelPlaceHolder::ChildModel()
{
  return *m_pChildModel;
}

const CModelBase& CZoominModelPlaceHolder::ChildModel() const
{
  return *m_pChildModel;
}

int CZoominModelPlaceHolder::DisplayListSize() const
{
  return m_pChildModel->Boundary().DisplayListSize();
}
...
CZoominModelPlaceHolder::TColor CZoominModelPlaceHolder::Color() const
{
  return m_pChildModel->Boundary().Color();
}

unsigned int CZoominModelPlaceHolder::IconId() const
{
  return m_pChildModel->IconId();
}

unsigned int CZoominModelPlaceHolder::TypeId() const
{
  return m_pChildModel->TypeId();
}

bool CZoominModelPlaceHolder::Empty() const
{
  return false;
}

long CZoominModelPlaceHolder::SavedItems() const
{
  return COpenGLNode::SavedItems() + m_pChildModel->SavedItems();
}
