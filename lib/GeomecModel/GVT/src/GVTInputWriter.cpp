...
CGVTInputWriter::CGVTInputWriter(const CGVTSettings &settings) : m_GVTSettings(settings), m_fp(0), m_strError("") {}
...
bool CGVTInputWriter::WritePointSetSection() {
  CUnitNode unitNode;
  IExportFormat::CExportArg arg(unitNode.Unit(), IExportFormat::AXIS3D, CValueType::MT_NONE, 0, 0,
                                CAnalysisType::AT_NONLIN, 0, IExportFormat::FULL_ELEMENT, IExportFormat::INPUT_POINTS,
                                false, true, true);
