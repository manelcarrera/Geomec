...
CGVTVelocityModelFile::CGVTVelocityModelFile(const TVelocityFromFile&,
  CModelBase &modelBase, const QString& velocityModelFile)
: m_GVTVelocityModelSource(new CGVTVelocityModelFromFile(velocityModelFile))
, m_modelBase(modelBase)
{
}

CGVTVelocityModelFile::CGVTVelocityModelFile(const TVelocityFromMaterial&,
...
: m_GVTVelocityModelSource(rhs.m_GVTVelocityModelSource)
, m_modelBase(rhs.m_modelBase)
{
}

CGVTVelocityModelFile& CGVTVelocityModelFile::operator = (
  const CGVTVelocityModelFile& rhs)
{
...
void CGVTVelocityModelFile::velocityModelSourceNumerator(
...
void CGVTVelocityModelFile::LoadStream(TSTREAM& stream, CStreamVersion& version,
  TPROGRESS& progress)
{
...
CGVTVelocityModelFile::TVelocityFromFile
  CGVTVelocityModelFile::velocityFromFile;
CGVTVelocityModelFile::TVelocityFromMaterial
  CGVTVelocityModelFile::velocityFromMaterial;
