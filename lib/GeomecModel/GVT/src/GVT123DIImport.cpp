...
CGVT123DIImport::CGVT123DIImport()
    : m_fp(0), m_nLineNr(0), m_strError(""), m_N_BIN(std::pair<int, bool>(0, false)),
      m_N_TRACK(std::pair<int, bool>(0, false)), m_REAL_DELTA_X(std::pair<double, bool>(0, false)),
      m_REAL_DELTA_Y(std::pair<double, bool>(0, false)), m_REAL_GEO_X(std::pair<double, bool>(0, false)),
      m_REAL_GEO_Y(std::pair<double, bool>(0, false)), m_SKEW_ANGLE(std::pair<double, bool>(0, false)),
      m_bFeetUnit(false), m_DELTA_BIN_NUM(1), m_DELTA_TRACK_NUM(1), m_FIRST_BIN(0), m_FIRST_TRACK(0) {
...
bool CGVT123DIImport::ReadDELTA_BIN_NUM(const QString &strLine) { return ReadIntegerValue(strLine, m_DELTA_BIN_NUM); }

bool CGVT123DIImport::ReadDELTA_TRACK_NUM(const QString &strLine) {
  return ReadIntegerValue(strLine, m_DELTA_TRACK_NUM);
}

bool CGVT123DIImport::ReadFIRST_BIN(const QString &strLine) { return ReadIntegerValue(strLine, m_FIRST_BIN); }

bool CGVT123DIImport::ReadFIRST_TRACK(const QString &strLine) { return ReadIntegerValue(strLine, m_FIRST_TRACK); }
