...
CGVTFactor::CGVTFactorComponent::CGVTFactorComponent(const QString &strName, CGVTFactor &parent,
...
unsigned int CGVTFactor::CGVTFactorComponent::IconId() const { return Parent().IconId(); }

unsigned int CGVTFactor::CGVTFactorComponent::TypeId() const { return Parent().TypeId(); }

QString CGVTFactor::CGVTFactorComponent::UnitName(const UNIT unit) const { return "-"; }

long CGVTFactor::CGVTFactorComponent::SavedItems() const { return 0; }
...
CGVTFactor::CGVTFactorComponent::ValuePoint(const geo::IPoint &pt, const UNIT /* unit */,
...
CGVTFactor::CGVTFactorComponent::ValueElement(const geo::IElement &elm, const UNIT /* unit */,
                                              geo::IParallelInitializationCallback * /* cb */) const {
...
void CGVTFactor::CGVTFactorComponent::MapValueElement(const geo::IElement &elm, IValueDomainScalar::TValueVec &values,
...
bool CGVTFactor::Empty() const { return false; }

long CGVTFactor::SavedItems() const { return 0; }

unsigned int CGVTFactor::IconId() const { return IDI_RESULT; }

unsigned int CGVTFactor::TypeId() const { return m_uiValueTypeID; }

bool CGVTFactor::Less(const CGraphNode &node) const { return IResult::Less(node); }

bool CGVTFactor::OnDefined(const IResultComponent & /*component*/) const { return true; }

bool CGVTFactor::CanMap(const COpenGLNode & /*node*/, int /*nRegister*/) const { return true; }
...
const QString &CGVTFactor::StoredExportLabel() const { return m_strExportLabel; }

QString CGVTFactor::UnitName(const UNIT unit) const { return "-"; }

double CGVTFactor::UnitFactor(const UNIT unit) const { return 1; }
...
IResultComponent *CGVTFactor::OnGetResultComponent(int nTimeStep, const CAnalysisType & /*antype*/, int /*nRegister*/,
...
bool CGVTFactor::ValidName(const std::string & /*name*/
                           ,
...
CGVTResultGroup::CGVTResultGroup(CResultGroup &group) : CResultGroup("Output", group) {}

unsigned int CGVTResultGroup::IconId() const { return IDI_RESULT_MAP; }
...
long CGVTResultGroup::SavedItems() const { return 0; }

void CGVTResultGroup::LoadStream(CStorageNode::TSTREAM &stream, CGVTResultVersion & /* version */,
...
CGVTResultTree::CGVTResultTree(CModelBase &model) : CResultGroup("GVT Results", model) {
  CResultGroup *pFactors = new CResultGroup("Factors", *this);
  new CGVTFactor(IDS_VALUENAME_GVT_FACTOR_R_EX, IDT_VALUETYPE_GVT_FACTOR_R_EX, IDI_VALUETYPE_GVT_FACTOR_R_EX,
                 *pFactors);
  new CGVTFactor(IDS_VALUENAME_GVT_FACTOR_R_C, IDT_VALUETYPE_GVT_FACTOR_R_C, IDI_VALUETYPE_GVT_FACTOR_R_C, *pFactors);
  new CGVTFactor(IDS_VALUENAME_GVT_FACTOR_S_NB, IDT_VALUETYPE_GVT_FACTOR_S_NB, IDI_VALUETYPE_GVT_FACTOR_S_NB,
                 *pFactors);
...
unsigned int CGVTResultTree::IconId() const { return IDI_RESULT_MAP; }

long CGVTResultTree::SavedItems() const { return m_pOutput->SavedItems() + m_pDerived->SavedItems(); }
