...
CGVTVelocityModel::CGVTVelocityModel(eVelocityModel velmod)
  : m_ModelType(velmod)
{
  switch(velmod)
  {
...
: m_ModelType(rhs.m_ModelType),
  m_mpParameters(rhs.m_mpParameters),
  m_mpFastParameters(rhs.m_mpFastParameters),
...
const QString &CGVTVelocityModel::ModelName() const
{
  return m_ModelName;
}

eVelocityModel CGVTVelocityModel::ModelType() const
{
  return m_ModelType;
}
...
size_t CGVTVelocityModel::ParamCount() const
{
  return m_mpParameters.size();
}
...
const std::map<QString, double> &CGVTVelocityModel::Parameters() const
{ 
  return m_mpParameters;
}

std::map<QString, double> &CGVTVelocityModel::Parameters()
{
  return m_mpParameters;
}
