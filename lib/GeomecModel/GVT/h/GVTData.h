...
public:
  void Build(IProgressBase &progress, const CModelBase& model, const CPillarMap& pillarMap, const CGVTDataTypes::TFormationVelocityModels& formVelocityModels, const CGVTDataTypes::TTimeLapses& timelapses, bool bRebuild, bool bReinterpolate, CPointSet *input, bool& requireNewInput);
...
private:
  ...
  void Setup(const CModelBase& model, const CPillarMap& pillarMap, const CGVTDataTypes::TFormationVelocityModels& formVelocityModels);
};
...
class CGVTData
{
  ...
  void BuildAnalysisPointSet(IProgressBase &progress, CGVTSeismicGridDefinition &gridDef, bool bRebuild, bool bReinterpolate);
...
public:
  ...
  void Build(IProgressBase &progress, CGVTSeismicGridDefinition &gridDef, const CGVTDataTypes::TFormationVelocityModels& formVelocityModels, const CGVTDataTypes::TTimeLapses& timelapses, bool deltaVp, bool deltaT, bool bRebuild, bool bReinterpolate, bool bBuildInputPointSet = true);
