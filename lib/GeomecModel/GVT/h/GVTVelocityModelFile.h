...
public:
  static struct TVelocityFromFile {
  } velocityFromFile;
  static struct TVelocityFromMaterial {
  } velocityFromMaterial;

  CGVTVelocityModelFile(const TVelocityFromFile &, CModelBase &modelBase, const QString &velocityModelFile = QString());
