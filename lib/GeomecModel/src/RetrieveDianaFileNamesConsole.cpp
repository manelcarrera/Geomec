...
CRetrieveDianaFileNamesConsole::CRetrieveDianaFileNamesConsole(const QString workingdir)
    : IRetrieveDianaFileNames(), m_strWorkingDir(workingdir) {}

CRetrieveDianaFileNamesConsole::~CRetrieveDianaFileNamesConsole() {}

bool CRetrieveDianaFileNamesConsole::retrieveDianaFileNames(QString &newTitle, const std::string &title) const {
