...
CStrainLoadGradientComponent::CStrainLoadGradientComponent(
    CStrainType &type,
    CFormationLoad<TStrain, CStrainLoadGradientComponent, CStrainLoadRepeaterComponent, CStrainLoadGWCDummyComponent>
        &parent,
    bool bEmpty)
...
CStrainLoadGradientComponent::CStrainLoadGradientComponent(const CStrainLoadGradientComponent &rhs)
    : CFormationLoadGradientComponent<TStrain, CStrainQuantity, CStrainQuantity>(rhs), m_Type(rhs.m_Type),
      m_UseVolumetric(rhs.m_UseVolumetric), m_UseInPlane(rhs.m_UseInPlane),
      m_ReferenceValueNormal(rhs.m_ReferenceValueNormal), m_ReferenceValueLateral(rhs.m_ReferenceValueLateral) {}
...
void CStrainLoadGradientComponent::ReferenceValueNormal(double value, const CQuantity::UNIT unit) {
  m_ReferenceValueNormal.Value(value, unit);
}
void CStrainLoadGradientComponent::ReferenceValueLateral(double value, const CQuantity::UNIT unit) {
  m_ReferenceValueLateral.Value(value, unit);
}
...
bool CStrainLoadGradientComponent::operator==(const CStrainLoadGradientComponent &rhs) const {
  ...
  return m_UseVolumetric == rhs.m_UseVolumetric && m_UseInPlane == rhs.m_UseInPlane &&
         m_ReferenceValueNormal == rhs.m_ReferenceValueNormal && m_ReferenceValueLateral == rhs.m_ReferenceValueLateral;
}

///// CStrainLoadGWCDummyComponent

CStrainLoadGWCDummyComponent::CStrainLoadGWCDummyComponent() : IValueComponentBase(*this) { assert(false); }
...
void CStrainLoadGWCDummyComponent::Set(const double & /*dContactPressure*/, const double & /*dTransitionPressure*/,
...
CStrainLoadRepeaterComponent::CTensorData::CTensorData(const CStrainLoad &parent,
                                                       const CStrainLoadRepeaterComponent &component)
    : m_Parent(parent), m_Component(component), m_Min(DBL_MAX), m_Max(-DBL_MAX) {}
...
IValueDomainTensor::TMinMax
CStrainLoadRepeaterComponent::CTensorData::MinMax(IProgressBase &, const IValueDataInterface::UNIT /*unit*/) const {
  return TMinMax(m_Min, m_Max);
}

IValueDomainTensor::TValue CStrainLoadRepeaterComponent::CTensorData::Average(IProgressBase &,
                                                                              const IValueDataInterface::UNIT) const {
  return IValueDomainTensor::TValue();
}

IValueDomainTensor::TValue
CStrainLoadRepeaterComponent::CTensorData::ValuePoint(const geo::IPoint &, const IValueDataInterface::UNIT,
                                                      geo::IParallelInitializationCallback * /*cb*/) const {
  return IValueDomainTensor::TValue();
}

IValueDomainTensor::TValueVec CStrainLoadRepeaterComponent::CTensorData::ValueElement(
    const geo::IElement &elm, const IValueDataInterface::UNIT unit,
...
CStrainLoadRepeaterComponent::CScalarData::CScalarData(const CStrainLoad &parent,
                                                       const CStrainLoadRepeaterComponent &component)
    : m_Parent(parent), m_Component(component) {}

IValueDomainScalar::TMinMax
CStrainLoadRepeaterComponent::CScalarData::MinMax(IProgressBase &, const IValueDataInterface::UNIT /*unit*/) const {
  return TMinMax(0, 0);
}

IValueDomainScalar::TValue
CStrainLoadRepeaterComponent::CScalarData::ValuePoint(const geo::IPoint &, const IValueDataInterface::UNIT,
                                                      geo::IParallelInitializationCallback * /*cb*/) const {
  return IValueDomainScalar::TValue();
}

IValueDomainScalar::TValue CStrainLoadRepeaterComponent::CScalarData::Average(IProgressBase &,
                                                                              const IValueDataInterface::UNIT) const {
  return IValueDomainScalar::TValue();
}

IValueDomainScalar::TValueVec
CStrainLoadRepeaterComponent::CScalarData::ValueElement(const geo::IElement &elm, const IValueDataInterface::UNIT unit,
                                                        geo::IParallelInitializationCallback *cb) const {
  switch (m_Parent.Type()) {
  case CStrainLoad::CONSTANT_MODE:
...
CStrainLoadRepeaterComponent::CStrainLoadRepeaterComponent(CStrainType &type, CStrainLoad &strain)
    : CFormationLoadRepeaterComponent<TStrain, CStrainLoadGradientComponent, CStrainLoadRepeaterComponent,
                                      CStrainLoadGWCDummyComponent>(strain),
...
CStrainLoadRepeaterComponent::CStrainLoadRepeaterComponent(const CStrainLoadRepeaterComponent &rhs)
    : CFormationLoadRepeaterComponent<TStrain, CStrainLoadGradientComponent, CStrainLoadRepeaterComponent,
                                      CStrainLoadGWCDummyComponent>(rhs),
      m_TensorData(static_cast<const CStrainLoad &>(Parent()), *this),
      m_ScalarData(static_cast<const CStrainLoad &>(Parent()), *this), m_Type(rhs.m_Type),
...
const IValueDataInterfaceTensor *CStrainLoadRepeaterComponent::TensorData() const { return &m_TensorData; }
IValueDataInterfaceTensor *CStrainLoadRepeaterComponent::TensorData() { return &m_TensorData; }
const IValueDataInterfaceScalar &CStrainLoadRepeaterComponent::ScalarData() const { return m_ScalarData; }
IValueDataInterfaceScalar &CStrainLoadRepeaterComponent::ScalarData() { return m_ScalarData; }
...
const IValueComponentBase &CStrainLoadRepeaterComponent::GlobalValues() const { return m_GlobalValuesComponent; }
...
IValueDataInterfaceScalar &CStrainLoadRepeaterComponent::CGlobalValuesComponent::ScalarData() { return m_Data; }
...
bool CStrainLoadRepeaterComponent::CGlobalValuesComponent::Defined() const { return true; }

IValueDomainScalar::TMinMax
CStrainLoadRepeaterComponent::CGlobalValuesComponent::MinMax(IProgressBase & /*progressBase*/,
                                                             const UNIT /*unit*/) const {
  return IValueDomainScalar::TMinMax(0, 0);
}

geo::CValue
CStrainLoadRepeaterComponent::CGlobalValuesComponent::ValuePoint(const geo::IPoint & /*pt*/, const UNIT /*unit*/,
                                                                 geo::IParallelInitializationCallback * /*cb*/) const {
  return geo::CValue(0);
}

IValueDomainScalar::TValueVec CStrainLoadRepeaterComponent::CGlobalValuesComponent::ValueElement(
...
IValueDomainScalar::TValue CStrainLoadRepeaterComponent::CGlobalValuesComponent::Average(IProgressBase &,
                                                                                         const UNIT) const {
  return IValueDomainScalar::TValue();
}

unsigned int CStrainLoadRepeaterComponent::CGlobalValuesComponent::IconId() const { return 0; }

unsigned int CStrainLoadRepeaterComponent::CGlobalValuesComponent::TypeId() const { return 0; }

bool CStrainLoadRepeaterComponent::CGlobalValuesComponent::Empty() const { return true; }

long CStrainLoadRepeaterComponent::CGlobalValuesComponent::SavedItems() const { return 0; }

///// CStrainLoad

CStrainLoad::CStrainLoad(CStrainType &t, CFormationBase &f, CDepletionStage &d, bool bEmpty) : TBase(f, d), m_Type(&t) {
  LinkTo(d);
  reParent(&f);
...
CStrainLoad::CStrainLoad(CStrainType &t, CFormationBase &f, CDepletionStage &d, const double &dVolStrain,
  ...
  Constant().Set(dVolStrain, 0, 0, unit);
...
unsigned int CStrainLoad::TypeId() const { return m_Type->TypeId(); }
...
void CStrainLoad::OnNeighbourDeleted(const CGraphNode &node) {
  ...
  if (!model.getDeleting()) {
    ...
    for (std::vector<const CGraphNode *>::iterator it = m_vcDistributedNodes.begin(); it != m_vcDistributedNodes.end();
         ++it) {
      assert(!(*it)->IsCopy());
      if (*it == &node) {
...
CStrainLoad::CStrainLoadComponent::CStrainLoadComponent(CStrainLoad &parent) : TBase(parent, 0) {}

CStrainLoad::CStrainLoadComponent::CStrainLoadComponent(const CStrainLoadComponent &rhs) : TBase(rhs) {}

unsigned int CStrainLoad::CStrainLoadComponent::TypeId() const { return Parent().TypeId(); }

unsigned int CStrainLoad::CStrainLoadComponent::IconId() const { return Parent().IconId(); }

QString CStrainLoad::CStrainLoadComponent::TypeName() const { return Parent().TypeName(); }
...
QString CStrainLoad::CStrainLoadComponent::ExportLabel() const { return Parent().ExportLabel(); }
...
long CStrainLoad::CStrainLoadComponent::SavedItems() const { return TBase::SavedItems(); }
...
template <typename TYPE> const TYPE *CStrainLoad::StrainComponent() const {
  for (size_t i = 0; i < referenceSize(); ++i) {
...
public:
  CStrainDistributedSetWrapper(const CValueType &base, bool distributedOnly, size_t index = 0)
      : parent(base), m_distributedOnly(distributedOnly), m_Index(index) {}
...
IValueDomainScalar::TValueVec CStrainLoad::ValueElement(const geo::IElement &elm,
                                                        geo::IParallelInitializationCallback * /*cb*/) const {
  ...
  if (vcRet.size() > 0 && Type() == CONSTANT_MODE && Constant().UseVolumetric()) {
    ...
    for (size_t i = 0; i < vcRet.size(); ++i) {
      if (!vcRet[i].Valid())
        vcRet[i].Value((Constant().ReferenceDepth().Convert(model.Depth(elm.Point(i)), unit, CQuantity::SI_UNIT) -
                        Constant().ReferenceDepth().Value(unit)) *
                           Constant().Gradient().Value(unit) +
                       Constant().ReferenceValue().Value(unit));
    }
  }
...
std::vector<CTensor> CStrainLoad::ValueTensor(const geo::IElement &elm, bool &bIsStrainTensor) const {
  ...
  // set XY, YZ, XZ to valid (they have value 0 already) -- we do it here, so that later the normal/lateral strain
  ...
  // if the strain tensor is undefined for this element, we look into normal/lateral strains and their respective
  // defaults
  ...
  if (!bIsStrainTensor && !DistributedOnly() && Type() == CStrainLoad::CONSTANT_MODE &&
      Constant().UseInPlane()) { // fill in empty slots

    for (size_t i = 0; i < 2; ++i) {
      for (size_t j = 0; j < elm.NrOfNodes(); ++j) {
        if (tmpTensor[j].values[i].empty) {
          double value = (Constant().ReferenceDepth().Convert(model.Depth(elm.Point(j)), unit, CQuantity::SI_UNIT) -
                          Constant().ReferenceDepth().Value(unit)) *
                             Constant().Gradient().Value(unit) +
                         Constant().ReferenceValueLateral().Value(unit);
    ...
    for (size_t j = 0; j < elm.NrOfNodes(); ++j) {
      if (tmpTensor[j].values[2].empty) {
        double value = (Constant().ReferenceDepth().Convert(model.Depth(elm.Point(j)), unit, CQuantity::SI_UNIT) -
                        Constant().ReferenceDepth().Value(unit)) *
                           Constant().Gradient().Value(unit) +
                       Constant().ReferenceValueNormal().Value(unit);
...
bool CStrainLoad::EncounteredFullTensor() const { return m_bEncounteredFullTensor; }
...
bool CStrainLoad::IsTensor() const {
  ...
  case CStrainLoad::CONSTANT_MODE:
    ...
    break;
  case CStrainLoad::REPEAT_MODE: {
    for (size_t distributedNode = 0; distributedNode < DistributedSize(); ++distributedNode) {
      if ((dynamic_cast<const TLateralStrain *>(&DistributedValue(distributedNode)) != 0) ||
          (dynamic_cast<const TNormalStrain *>(&DistributedValue(distributedNode)) != 0)) {
        return true;
      }
    }
...
bool CStrainLoad::IsVolumetric() const {
  ...
  case CStrainLoad::REPEAT_MODE: {
    for (size_t distributedNode = 0; distributedNode < DistributedSize(); ++distributedNode) {
      if (dynamic_cast<const TVolumetricStrain *>(&DistributedValue(distributedNode)) != 0) {
        return true;
      }
    }
    ...
    for (size_t i = 0; i < referenceSize(); ++i) {
      if (dynamic_cast<const TStrainTensor *>(&referenceAt(i))) {
        ...
        return true;
                 ...
                 dynamic_cast<const TLateralStrain *>(&referenceAt(i))) {
        haveStrain = true;
      }
    }
...
const CStrainLoad *CStrainLoad::ParentStrainLoad() const {
  ...
  if (pFormation && pFormation->ParentFormation())
    pParentStrainLoad = &pFormation->ParentFormation()->Strain(
