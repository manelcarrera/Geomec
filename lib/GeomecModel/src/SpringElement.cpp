...
size_t CSpringElement::NrOfNodes() const { return 1; }

std::string CSpringElement::Type() const { return std::string("SP1TR"); }

const geo::IElementSet *CSpringElement::IndexingElementSet() const { return &m_mesh; }
