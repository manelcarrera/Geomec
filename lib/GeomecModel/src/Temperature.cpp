...
: CFormationLoadGradientComponent<TTemperature, CTemperatureQuantity, CTemperatureGradientQuantity>(temperature, bEmpty)
{
}
...
: CFormationLoadRepeaterComponent<TTemperature, CTemperatureGradientComponent, CTemperatureRepeaterComponent, CTemperatureGWCDummyComponent>(temperature)
{
}

CTemperatureRepeaterComponent::CTemperatureRepeaterComponent(const CTemperatureRepeaterComponent& rhs)
: CFormationLoadRepeaterComponent<TTemperature, CTemperatureGradientComponent, CTemperatureRepeaterComponent, CTemperatureGWCDummyComponent>(rhs)
{
}
...
: TTemperatureBase(rhs)
, m_GlobalTemperatureObserver(new CGlobalValueObserver<CTemperature, CGlobalTemperature>(*rhs.m_GlobalTemperatureObserver))
{
}
...
{
  delete m_GlobalTemperatureObserver;
}
...
bool CTemperature::IsFirstValidDepletionStage() const
{
