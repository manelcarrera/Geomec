...
//=============================================================================
unsigned int CElementValueSet::TypeId() const { return 0; }

unsigned int CElementValueSet::IconId() const { return IDI_ELEMENT_VALUESET; }
...
//=============================================================================
geo::IValueSet::TValueVec CElementValueSet::ValueElement(const geo::IElement &element,
...
//=============================================================================
// Present Point
CElementValueSet::TValue CElementValueSet::ValuePoint(const geo::IPoint &pt,
                                                      geo::IParallelInitializationCallback *cb) const {
  // wjrx mantis 3480
  //
...
//=============================================================================
long CElementValueSet::SavedItems() const { return IValueSet::SavedItems() + m_value_set.ElementSet().ElementSize(); }
...
const geo::CValueSet &CElementValueSet::getValueSet() const { return m_value_set; }

geo::CValueSet &CElementValueSet::getValueSet() { return m_value_set; }
