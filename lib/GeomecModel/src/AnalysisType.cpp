...
CAnalysisType CAnalysisType::FirstType() { return CAnalysisType(TAnalysisType(AT_FIRST)); }
...
CAnalysisType::CAnalysisType() : m_bValid(false) {}

CAnalysisType::CAnalysisType(TAnalysisType antype) : m_antype(antype), m_bValid(true) {}

CAnalysisType::CAnalysisType(const CAnalysisType &rhs) : m_antype(rhs.m_antype), m_bValid(rhs.m_bValid) {}
...
bool CAnalysisType::operator==(const CAnalysisType &rhs) const {
  ...
  return m_bValid == rhs.m_bValid && m_antype == rhs.m_antype;
}

bool CAnalysisType::operator!=(const CAnalysisType &rhs) const { return !operator==(rhs); }
...
bool CAnalysisType::operator!=(TAnalysisType type) const { return !operator==(type); }
...
bool CAnalysisType::Valid() const { return m_bValid; }
...
long CAnalysisType::SavedItems() const { return 1; }
