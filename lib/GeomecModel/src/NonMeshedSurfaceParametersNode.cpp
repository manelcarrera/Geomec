...
CNonMeshedSurfaceParametersNode::CNonMeshedSurfaceParametersNode(CNonMeshedSurface &surface)
    : CStorageNode("Parameters", surface.Model()), m_surface(surface), m_bCohesionExtrapolated(true),
      m_bFrictionExtrapolated(true), m_Cohesion(10), m_FrictionAngle(15), m_pValueTypeCohesion(0),
...
CNonMeshedSurfaceParametersNode::CNonMeshedSurfaceParametersNode(const CNonMeshedSurfaceParametersNode &rhs)
    : CStorageNode(rhs), m_surface(rhs.m_surface), m_bCohesionExtrapolated(rhs.m_bCohesionExtrapolated),
      m_bFrictionExtrapolated(rhs.m_bFrictionExtrapolated), m_Cohesion(rhs.m_Cohesion),
      m_FrictionAngle(rhs.m_FrictionAngle), m_pValueTypeCohesion(rhs.m_pValueTypeCohesion),
      m_pValueTypeFriction(rhs.m_pValueTypeFriction) {}

CNonMeshedSurfaceParametersNode &
...
bool CNonMeshedSurfaceParametersNode::operator==(const CNonMeshedSurfaceParametersNode &rhs) const {
  return (&m_surface == &rhs.m_surface && m_bCohesionExtrapolated == rhs.m_bCohesionExtrapolated &&
          m_bFrictionExtrapolated == rhs.m_bFrictionExtrapolated && m_Cohesion == rhs.m_Cohesion &&
          m_FrictionAngle == rhs.m_FrictionAngle && m_pValueTypeCohesion == rhs.m_pValueTypeCohesion &&
          m_pValueTypeFriction == rhs.m_pValueTypeFriction);
}
...
unsigned int CNonMeshedSurfaceParametersNode::IconId() const { return IDI_NONMESHEDSURFACEPARAMETERS; }

unsigned int CNonMeshedSurfaceParametersNode::TypeId() const { return IDT_VALUETYPE_NONMESHEDSURFACEPARAMETERS; }

bool CNonMeshedSurfaceParametersNode::Empty() const { return false; }

long CNonMeshedSurfaceParametersNode::SavedItems() const { return 1; }
...
const CCohesionQuantity &CNonMeshedSurfaceParametersNode::Cohesion() const { return m_Cohesion; }

const CAngleQuantity &CNonMeshedSurfaceParametersNode::FrictionAngle() const { return m_FrictionAngle; }

CCohesionQuantity &CNonMeshedSurfaceParametersNode::Cohesion() { return m_Cohesion; }

CAngleQuantity &CNonMeshedSurfaceParametersNode::FrictionAngle() { return m_FrictionAngle; }

bool CNonMeshedSurfaceParametersNode::DistributedCohesion() const { return (m_pValueTypeCohesion != 0); }

bool CNonMeshedSurfaceParametersNode::DistributedFriction() const { return (m_pValueTypeFriction != 0); }

bool CNonMeshedSurfaceParametersNode::CohesionExtrapolated() const { return m_bCohesionExtrapolated; }

bool CNonMeshedSurfaceParametersNode::FrictionExtrapolated() const { return m_bFrictionExtrapolated; }

void CNonMeshedSurfaceParametersNode::CohesionExtrapolated(bool b) { m_bCohesionExtrapolated = b; }

void CNonMeshedSurfaceParametersNode::FrictionExtrapolated(bool b) { m_bFrictionExtrapolated = b; }
...
std::vector<double> CNonMeshedSurfaceParametersNode::Cohesion(const geo::IElement &element,
...
std::vector<double> CNonMeshedSurfaceParametersNode::FrictionAngle(const geo::IElement &element,
                                                                   const CQuantity::UNIT unit) const {
  std::vector<double> vcResult(element.NrOfPoints());
...
const CNonMeshedSurface &CNonMeshedSurfaceParametersNode::Surface() const { return m_surface; }
