...
CPointSet* CCreatePointSet::create(CModelBase& modelBase,
  const CUnitNode& unitNode, const QString& name) const
{
...
void CCreatePointSet::createPointSetRecursive(size_t index, geo::CPoint& point,
