...
CFaultFracture::CFaultFracture(CHorizonBase* horizonBase, CDoubleQuantity::UNIT unit)
  ...
  , m_slipType(m_horizonBase->SlipType())
  , m_faultParametersNode(0)
  , m_unit(unit)
{
...
const QString& CFaultFracture::name() const
{
  return m_horizonBase->Name();
}

bool CFaultFracture::HasHorizon(const CHorizonBase *horizonBase) const
{
  return m_horizonBase == horizonBase;
}

bool CFaultFracture::Slip() const
{
  return m_horizonBase->Slip();
}
...
bool CFaultFracture::hasFaultParametersForInitialDepletionStage() const
{
  return m_faultParametersNode != 0;
}

QString CFaultFracture::CohesionUnitName() const
{
  return m_cohesionUnitName;
}

double CFaultFracture::Cohesion() const
{
  return m_cohesion;
}

void CFaultFracture::Cohesion(double value)
{
  m_cohesion = value;
}

QString CFaultFracture::FrictionAngleUnitName() const
{
  return m_frictionAngleUnitName;
}

double CFaultFracture::FrictionAngle() const
{
  return m_frictionAngle;
}

void CFaultFracture::FrictionAngle(double value)
{
  m_frictionAngle = value;
}

int CFaultFracture::SlipType() const
{
  return m_slipType;
}

void CFaultFracture::SlipType(int slipType)
{
  m_slipType = slipType;
}

void CFaultFracture::FinalizeBehaviour()
{
  m_horizonBase->SlipType(static_cast<CHorizonBase::TSlipType>(m_slipType));
}
