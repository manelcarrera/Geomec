...
: m_cBuffer(new char[m_bufferSize+1])
, m_lineCounter(0)
...
CImportPetrel::t_unit CImportPetrel::getLateralUnit() const
{
  return m_coordUnit;
}

CImportPetrel::t_unit CImportPetrel::getDepthUnit() const
{
  return m_depthUnit;
}
...
bool CImportPetrel::CheckColumnNumbers()
{
  return m_x_column >= 0 && m_y_column >= 0 && m_z_column >= 0;
}

bool CImportPetrel::_CheckUnit
...
bool CImportPetrel::CheckCoordUnit
( const QString &s_unit
, const CImportPetrel::t_unit unit
)
{
  if ( _CheckUnit( s_unit, unit, 
...
bool CImportPetrel::CheckDepthUnit
( const QString &s_unit
, const CImportPetrel::t_unit unit
)
{
...
const QString &CImportPetrel::Message() const
{
  return m_message;
}
