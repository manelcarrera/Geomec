...
CVolumetricStrainLoadGradientComponent::CVolumetricStrainLoadGradientComponent(
    CFormationLoadBase<TVolumetricStrain> &volstrain, bool bEmpty)
    : CFormationLoadGradientComponent<TVolumetricStrain, CStrainQuantity, CStrainQuantity>(volstrain, bEmpty) {}

CVolumetricStrainLoadGradientComponent::CVolumetricStrainLoadGradientComponent(
    const CVolumetricStrainLoadGradientComponent &rhs)
    : CFormationLoadGradientComponent<TVolumetricStrain, CStrainQuantity, CStrainQuantity>(rhs) {}

unsigned int CVolumetricStrainLoadGradientComponent::TypeId() const { return IDT_COMPONENT_VOLSTRAIN_GRADIENT; }

unsigned int CVolumetricStrainLoadGradientComponent::IconId() const { return IDI_COMPONENT_VOLSTRAIN_GRADIENT; }

QString CVolumetricStrainLoadGradientComponent::TypeName() const {
  return getStringTableEntry(IDS_COMPONENT_VOLSTRAIN_GRADIENT);
}

QString CVolumetricStrainLoadGradientComponent::UnitName(const CQuantity::UNIT /*unit*/) const { return QString("-"); }
...
CVolumetricStrainLoadGWCDummyComponent::CVolumetricStrainLoadGWCDummyComponent() : IValueComponentBase(*this) {
  assert(false);
}

CVolumetricStrainLoadGWCDummyComponent::CVolumetricStrainLoadGWCDummyComponent(
    CVolumetricStrainLoadGWCDummyComponent &rhs)
...
CVolumetricStrainLoadRepeaterComponent::CVolumetricStrainLoadRepeaterComponent(CVolumetricStrainLoad &volstrain)
    : CFormationLoadRepeaterComponent<TVolumetricStrain, CVolumetricStrainLoadGradientComponent,
                                      CVolumetricStrainLoadRepeaterComponent, CVolumetricStrainLoadGWCDummyComponent>(
          volstrain),
      m_GlobalValuesComponent(volstrain) {}

CVolumetricStrainLoadRepeaterComponent::CVolumetricStrainLoadRepeaterComponent(
    const CVolumetricStrainLoadRepeaterComponent &rhs)
    : CFormationLoadRepeaterComponent<TVolumetricStrain, CVolumetricStrainLoadGradientComponent,
                                      CVolumetricStrainLoadRepeaterComponent, CVolumetricStrainLoadGWCDummyComponent>(
          rhs),
...
unsigned int CVolumetricStrainLoadRepeaterComponent::IconId() const { return 0; }

QString CVolumetricStrainLoadRepeaterComponent::TypeName() const { return QString(); }

QString CVolumetricStrainLoadRepeaterComponent::UnitName(const CQuantity::UNIT /*unit*/) const { return QString("-"); }

QString CVolumetricStrainLoadRepeaterComponent::ExportLabel() const {
  return getStringTableEntry(IDS_ET_VOLUMETRICSTRAIN);
}

const CVolumetricStrainLoadRepeaterComponent::TFormationLoad &
CVolumetricStrainLoadRepeaterComponent::PreviousFormationLoad() const {
  assert(false);
...
bool CVolumetricStrainLoadRepeaterComponent::CGlobalValuesComponent::Defined() const { return true; }

IValueDomainScalar::TMinMax
CVolumetricStrainLoadRepeaterComponent::CGlobalValuesComponent::MinMax(IProgressBase & /*progressBase*/,
                                                                       const UNIT /*unit*/) const {
  return IValueDomainScalar::TMinMax(0, 0);
}

IValueDomainScalar::TValue CVolumetricStrainLoadRepeaterComponent::CGlobalValuesComponent::ValuePoint(
    const geo::IPoint & /*pt*/, const UNIT /*unit*/, geo::IParallelInitializationCallback * /*cb*/) const {
  return geo::CValue(0);
}

IValueDomainScalar::TValueVec CVolumetricStrainLoadRepeaterComponent::CGlobalValuesComponent::ValueElement(
...
IValueDomainScalar::TValue CVolumetricStrainLoadRepeaterComponent::CGlobalValuesComponent::Average(IProgressBase &,
                                                                                                   const UNIT) const {
  return IValueDomainScalar::TValue();
}

unsigned int CVolumetricStrainLoadRepeaterComponent::CGlobalValuesComponent::IconId() const { return 0; }

unsigned int CVolumetricStrainLoadRepeaterComponent::CGlobalValuesComponent::TypeId() const { return 0; }

bool CVolumetricStrainLoadRepeaterComponent::CGlobalValuesComponent::Empty() const { return true; }

long CVolumetricStrainLoadRepeaterComponent::CGlobalValuesComponent::SavedItems() const { return 0; }

///// CVolumetricStrainLoad
CVolumetricStrainLoad::CVolumetricStrainLoad(CFormationBase &f, CDepletionStage &d, bool bEmpty) : TBase(f, d) {
  LinkTo(d);
  reParent(&f);
...
CVolumetricStrainLoad::CVolumetricStrainLoad(CFormationBase &f, CDepletionStage &d, const double &dVolStrain,
...
CVolumetricStrainLoad::CVolumetricStrainLoad(const CVolumetricStrainLoad &rhs) : TBase(rhs) {}
...
unsigned int CVolumetricStrainLoad::TypeId() const { return IDT_VALUETYPE_VOLUMETRICSTRAIN; }

QString CVolumetricStrainLoad::TypeName() const { return getStringTableEntry(IDS_VALUENAME_VOLUMETRICSTRAIN); }
...
TVolumetricStrainLoadBase &CVolumetricStrainLoad::FormationStageLoad(CFormationBase & /*formation*/,
...
CVolumetricStrainLoad::CVolumetricStrainLoadComponent::CVolumetricStrainLoadComponent(
    const CVolumetricStrainLoadComponent &rhs)
    : TBase(rhs) {}

unsigned int CVolumetricStrainLoad::CVolumetricStrainLoadComponent::TypeId() const { return Parent().TypeId(); }

unsigned int CVolumetricStrainLoad::CVolumetricStrainLoadComponent::IconId() const { return Parent().IconId(); }

QString CVolumetricStrainLoad::CVolumetricStrainLoadComponent::TypeName() const { return Parent().TypeName(); }
...
QString CVolumetricStrainLoad::CVolumetricStrainLoadComponent::ExportLabel() const { return Parent().ExportLabel(); }
...
long CVolumetricStrainLoad::CVolumetricStrainLoadComponent::SavedItems() const { return TBase::SavedItems(); }
