...
void C3DFormation::ReadFormation(C3DDatabase &db, const C3DModel& model, const long lFormationKey, IProgressBase &callback)
{
#ifndef _WIN64
...
int C3DFormation::Element() const
{
	return (int)m_lElement;
}

const CPressure& C3DFormation::Pressure(const int nDepletionStage) const
{
	return m_vcPressure[nDepletionStage];
}
