...
CPressure::CPressure()
: m_type(UNDEFINED), m_dReferenceDepth(0), m_dReferencePressure(0)
{
...
CPressure::PressureType CPressure::Type() const
{
	return m_type;
}

bool CPressure::UnDefined() const
{
	return m_type == UNDEFINED;
}

bool CPressure::GWC() const
{
	return m_type == OWCGWC;
}

bool CPressure::Constant() const
{
	return m_type == CONSTANT;
}

bool CPressure::Distributed() const
{
	return m_type == DISTRIBUTED;
}

const QString& CPressure::SourceFileName() const
{
