...
CTimeHQuantity::CTimeHQuantity(const double &value, const UNIT unit)
: CDoubleQuantity()
{
  MaxValue(DOUBLE_MAX_,  SI_UNIT);
  MinValue(DOUBLE_MIN_,  SI_UNIT);
...
CTimeHQuantity::CTimeHQuantity(const double& value,
                         const double &min ,
                         const double &max,
                         bool bIncludeMin,
                         bool bIncludeMax,
...
std::string	CTimeHQuantity::QuantityName() const
{
  return "TimeInHours";
}
...
CTimeHQuantity::CTimeHQuantity(const CTimeHQuantity &rhs)
: CDoubleQuantity(rhs)
{
