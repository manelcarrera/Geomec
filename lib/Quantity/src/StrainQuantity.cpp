...
CStrainQuantity::CStrainQuantity()
: CDoubleQuantity()
{
...
CStrainQuantity::CStrainQuantity(const double &value, const UNIT unit)
: CDoubleQuantity()
{
	MaxValue(DOUBLE_MAX_,  SI_UNIT);
	MinValue(DOUBLE_MIN_,  SI_UNIT);
...
CStrainQuantity::CStrainQuantity(const double& value,
			                       const double &min ,
			                       const double &max,
			                       bool bIncludeMin,
			                       bool bIncludeMax,
...
std::string	CStrainQuantity::QuantityName() const
{
	return "Strain";
}
...
CStrainQuantity::CStrainQuantity(const CStrainQuantity &rhs)
: CDoubleQuantity(rhs)
{
