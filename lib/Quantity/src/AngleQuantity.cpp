...
CAngleQuantity::CAngleQuantity(const CAngleQuantity &rhs) : CDoubleQuantity(rhs) {}

CAngleQuantity::CAngleQuantity(const double &value, const double &min, const double &max, bool bIncludeMin,
...
std::string CAngleQuantity::QuantityName() const { return "Angle"; }
