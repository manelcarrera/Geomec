...
CThermalConductivityQuantity::CThermalConductivityQuantity() : CDoubleQuantity() {
  MaxValue(DOUBLE_MAX_, SI_UNIT);
  MinValue(DOUBLE_MIN_, SI_UNIT);
}

CThermalConductivityQuantity::CThermalConductivityQuantity(const double &value, const UNIT unit) : CDoubleQuantity() {
  MaxValue(DOUBLE_MAX_, SI_UNIT);
  MinValue(DOUBLE_MIN_, SI_UNIT);
  Value(value, unit);
}

CThermalConductivityQuantity::CThermalConductivityQuantity(const double &dTimeH, const double &min, const double &max,
                                                           const UNIT unit)
    : CDoubleQuantity() {
...
CThermalConductivityQuantity::CThermalConductivityQuantity(const double &value, const double &min, const double &max,
...
std::string CThermalConductivityQuantity::QuantityName() const { return "Thermal conductivity"; }
