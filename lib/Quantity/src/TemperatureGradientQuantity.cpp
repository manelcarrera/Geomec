...
//////////////////////////////////////////////////////////////////////
CTemperatureGradientQuantity::CTemperatureGradientQuantity()
: CDoubleQuantity()
{
...
CTemperatureGradientQuantity::CTemperatureGradientQuantity(const double &value, const UNIT unit)
: CDoubleQuantity()
{
	MaxValue(DOUBLE_MAX_,  SI_UNIT);
	MinValue(DOUBLE_MIN_,  SI_UNIT);
...
CTemperatureGradientQuantity::CTemperatureGradientQuantity(const double& dTemperatureGradient,const double &min ,const double &max, const UNIT unit)
:CDoubleQuantity()
{
...
CTemperatureGradientQuantity::CTemperatureGradientQuantity(const double& value,
			                                               const double &min ,
			                                               const double &max,
			                                               bool bIncludeMin,
			                                               bool bIncludeMax,
...
std::string	CTemperatureGradientQuantity::QuantityName() const
{
