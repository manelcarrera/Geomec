...
CTimeDQuantity::CTimeDQuantity(const double &value, const UNIT unit)
: CDoubleQuantity()
{
  MaxValue(DOUBLE_MAX_,  SI_UNIT);
  MinValue(DOUBLE_MIN_,  SI_UNIT);
...
CTimeDQuantity::CTimeDQuantity(const double& value,
                         const double &min ,
                         const double &max,
                         bool bIncludeMin,
                         bool bIncludeMax,
...
std::string	CTimeDQuantity::QuantityName() const
{
  return "TimeInDays";
}
...
CTimeDQuantity::CTimeDQuantity(const CTimeDQuantity &rhs)
: CDoubleQuantity(rhs)
{
