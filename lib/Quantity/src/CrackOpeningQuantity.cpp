...
CCrackOpeningQuantity::CCrackOpeningQuantity() : CDoubleQuantity() {
  MaxValue(DOUBLE_MAX_, SI_UNIT);
  MinValue(DOUBLE_MIN_, SI_UNIT);
}

CCrackOpeningQuantity::CCrackOpeningQuantity(const double &value, const UNIT unit) : CDoubleQuantity() {
  MaxValue(DOUBLE_MAX_, SI_UNIT);
  MinValue(DOUBLE_MIN_, SI_UNIT);
  Value(value, unit);
}
...
CCrackOpeningQuantity::CCrackOpeningQuantity(const CCrackOpeningQuantity &rhs) : CDoubleQuantity(rhs) {}

CCrackOpeningQuantity::CCrackOpeningQuantity(const double &value, const double &min, const double &max,
...
std::string CCrackOpeningQuantity::QuantityName() const { return "Crack Opening"; }
