...
//////////////////////////////////////////////////////////////////////
CDensityQuantity::CDensityQuantity()
: CDoubleQuantity()
{
...
CDensityQuantity::CDensityQuantity(const double &value, const UNIT unit)
: CDoubleQuantity()
{
  MaxValue(DOUBLE_MAX_,  SI_UNIT);
  MinValue(DOUBLE_MIN_,  SI_UNIT);
...
CDensityQuantity::CDensityQuantity(const double& value,
                             const double &min ,
                             const double &max,
                             bool bIncludeMin,
                             bool bIncludeMax,
...
CDensityQuantity::CDensityQuantity(const CDensityQuantity& rhs)
: CDoubleQuantity(rhs)
{
}
...
std::string	CDensityQuantity::QuantityName() const
{
  return "Density";
}
