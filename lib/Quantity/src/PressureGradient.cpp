...
CPressureGradientQuantity::CPressureGradientQuantity()
: CDoubleQuantity()
{
...
CPressureGradientQuantity::CPressureGradientQuantity(const double &value, const UNIT unit)
: CDoubleQuantity()
{
	MaxValue(DOUBLE_MAX_,  SI_UNIT);
	MinValue(DOUBLE_MIN_,  SI_UNIT);
...
CPressureGradientQuantity::CPressureGradientQuantity(const double& value,const double &min ,const double &max, const UNIT unit)
:CDoubleQuantity()
{
	MaxValue(max,  unit);
	MinValue(min,  unit);
...
CPressureGradientQuantity::CPressureGradientQuantity(const double& value,
			                             const double &min ,
			                             const double &max,
			                             bool bIncludeMin,
			                             bool bIncludeMax,
...
std::string CPressureGradientQuantity::QuantityName() const
{
...
CPressureGradientQuantity::CPressureGradientQuantity(const CPressureGradientQuantity &rhs)
: CDoubleQuantity (rhs)
{
...
CPressureGradient2::CPressureGradient2()
: CDoubleQuantity()
{
	MaxValue(DOUBLE_MAX_,  SI_UNIT);
	MinValue(DOUBLE_MIN_,  SI_UNIT);
...
CPressureGradient2::CPressureGradient2(const double &value, const UNIT unit)
: CDoubleQuantity()
{
	MaxValue(DOUBLE_MAX_,  SI_UNIT);
	MinValue(DOUBLE_MIN_,  SI_UNIT);
...
CPressureGradient2::CPressureGradient2(const double& value,
			                             const double &min ,
			                             const double &max,
			                             bool bIncludeMin,
			                             bool bIncludeMax,
...
std::string CPressureGradient2::QuantityName() const
{
	return "PressureGradient";
}
...
CPressureGradient2::CPressureGradient2(const CPressureGradient2 &rhs)
: CDoubleQuantity (rhs)
{
