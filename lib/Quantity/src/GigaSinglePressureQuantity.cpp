...
//////////////////////////////////////////////////////////////////////
CGigaSinglePressureQuantity::CGigaSinglePressureQuantity() : CDoubleQuantity() {
  MaxValue(DOUBLE_MAX_, SI_UNIT);
  MinValue(DOUBLE_MIN_, SI_UNIT);
}

CGigaSinglePressureQuantity::CGigaSinglePressureQuantity(const double &value, const UNIT unit) : CDoubleQuantity() {
  MaxValue(DOUBLE_MAX_, SI_UNIT);
  MinValue(DOUBLE_MIN_, SI_UNIT);
  Value(value, unit);
}

CGigaSinglePressureQuantity::CGigaSinglePressureQuantity(const double &value, const double &min, const double &max,
                                                         const UNIT unit)
    : CDoubleQuantity() {
...
std::string CGigaSinglePressureQuantity::QuantityName() const { return "Giga Pressure"; }
