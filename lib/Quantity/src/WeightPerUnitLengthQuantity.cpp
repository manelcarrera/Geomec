...
CWeightPerUnitLengthQuantity::CWeightPerUnitLengthQuantity(const double &value, const UNIT unit)
: CDoubleQuantity()
{
  MaxValue(DOUBLE_MAX_,  SI_UNIT);
  MinValue(DOUBLE_MIN_,  SI_UNIT);
...
CWeightPerUnitLengthQuantity::CWeightPerUnitLengthQuantity(const double& dWPUL,const double &min ,const double &max, const UNIT unit)
:CDoubleQuantity()
{
...
CWeightPerUnitLengthQuantity::CWeightPerUnitLengthQuantity(	const double& value,
                          const double &min ,
                          const double &max,
                          bool bIncludeMin,
                          bool bIncludeMax,
...
std::string	CWeightPerUnitLengthQuantity::QuantityName() const
{
  return "Weight per unit Length";
}
