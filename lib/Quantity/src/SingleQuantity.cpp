...
CDoubleQuantity::CDoubleQuantity() : m_undefined(true), m_bIncludeMax(true), m_bIncludeMin(true) {}
...
CDoubleQuantity::CDoubleQuantity(const CDoubleQuantity &rhs)
    : QObject(), // QObject(const QObject&) is private,
      ...
      m_value(rhs.m_value), m_max(rhs.m_max), m_min(rhs.m_min), m_undefined(rhs.m_undefined),
      m_bIncludeMax(rhs.m_bIncludeMax), m_bIncludeMin(rhs.m_bIncludeMin) {}
...
// default SI setvalue
void CDoubleQuantity::SetValue(const double &value) { Value(value, SI_UNIT); }
...
/*virtual*/ double CDoubleQuantity::MaxValue(const UNIT unit) const { return Convert(m_max, unit, SI_UNIT); }

/*virtual*/ double CDoubleQuantity::MinValue(const UNIT unit) const { return Convert(m_min, unit, SI_UNIT); }
...
/*virtual*/ bool CDoubleQuantity::Undefined() const { return m_undefined; }

/*virtual*/ bool CDoubleQuantity::IncludeMin() const { return m_bIncludeMin; }

/*virtual*/ bool CDoubleQuantity::IncludeMax() const { return m_bIncludeMax; }

/*virtual*/ void CDoubleQuantity::IncludeMin(bool v) { m_bIncludeMin = v; }

/*virtual*/ void CDoubleQuantity::IncludeMax(bool v) { m_bIncludeMax = v; }
...
/*virtual*/ void CDoubleQuantity::restore(IModelStream &stream) {
  ...
  short i_bool;
  stream >> i_bool;
  m_undefined = (i_bool == 1);
  stream >> i_bool;
  m_bIncludeMax = (i_bool == 1);
  stream >> i_bool;
  m_bIncludeMin = (i_bool == 1);
}
