...
CStressGradOrDensity::CStressGradOrDensity(const CStressGradOrDensity &rhs) : CDoubleQuantity(rhs) { Init(); }

CStressGradOrDensity::CStressGradOrDensity() : CDoubleQuantity() {
  MaxValue(DOUBLE_MAX_, SI_UNIT);
  MinValue(DOUBLE_MIN_, SI_UNIT);
  Init();
}

CStressGradOrDensity::CStressGradOrDensity(const double &value, const UNIT unit) : CDoubleQuantity() {
  MaxValue(DOUBLE_MAX_, SI_UNIT);
  MinValue(DOUBLE_MIN_, SI_UNIT);
  Value(value, unit);
  Init();
...
CStressGradOrDensity::CStressGradOrDensity(const double &dStressGradient, const double &min, const double &max,
                                           const UNIT unit)
    : CDoubleQuantity() {
...
CStressGradOrDensity::CStressGradOrDensity(const double &value, const double &min, const double &max, bool bIncludeMin,
...
CStressGradOrDensity::TYPE CStressGradOrDensity::GetType() const { return m_Type; }
...
std::string CStressGradOrDensity::QuantityName() const { return "StressGradient"; }
