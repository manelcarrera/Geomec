...
CForceQuantity::CForceQuantity(const double &value, const UNIT unit)
: CDoubleQuantity()
{
  MaxValue(DOUBLE_MAX_,  SI_UNIT);
  MinValue(DOUBLE_MIN_,  SI_UNIT);
...
CForceQuantity::CForceQuantity(const double& value,
                             const double &min ,
                             const double &max,
                             bool bIncludeMin,
                             bool bIncludeMax,
...
CForceQuantity::CForceQuantity(const CForceQuantity& rhs)
: CDoubleQuantity(rhs)
{
}
...
std::string	CForceQuantity::QuantityName() const
{
  return "Force";
}
