...
CTemperatureQuantity::CTemperatureQuantity(const double &dTemperature, const double &min, const double &max,
                                           const UNIT unit) {
...
CTemperatureQuantity::CTemperatureQuantity(const double &value, const double &min, const double &max, bool bIncludeMin,
...
std::string CTemperatureQuantity::QuantityName() const { return "Temperature"; }
...
CTemperatureQuantity::CTemperatureQuantity(const CTemperatureQuantity &rhs) : CDoubleQuantity(rhs) {}
