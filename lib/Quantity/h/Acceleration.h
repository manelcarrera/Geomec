...
public:
  ...
  CAcceleration(const double &min = 5.0, const double &max = 15.0, const UNIT unit = SI_UNIT);
  // ##ModelId=3C03636500A2
  CAcceleration(const double &value, const double &min, const double &max, const UNIT unit = SI_UNIT);
