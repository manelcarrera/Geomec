...
public:
  ...
  CLossCoefQuantity(const double &value, const UNIT unit = SI_UNIT);

  CLossCoefQuantity(const double &value, const double &min, const double &max, const UNIT unit = SI_UNIT);

  CLossCoefQuantity(const double &value, const double &min, const double &max, bool bIncludeMin = true,
