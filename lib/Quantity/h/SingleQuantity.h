...
signals:
  ...
  void OnValidate(const double &new_value, bool &accept, CDoubleQuantity::UNIT unit, const CDoubleQuantity &Quantity,
                  QString &Description);
  void OnRefuseValue(const CDoubleQuantity &Quantity, const QString &Description);
  void OnCheckValue(const double &value, bool &accept, CDoubleQuantity::UNIT unit, std::string &reason,
                    const CDoubleQuantity &Quantity);
