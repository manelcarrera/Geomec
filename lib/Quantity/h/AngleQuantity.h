...
public:
  ...
  CAngleQuantity(const double &value, const UNIT unit = SI_UNIT);

  CAngleQuantity(const double &value, const double &min, const double &max, const UNIT unit = SI_UNIT);

  CAngleQuantity(const double &value, const double &min, const double &max, bool bIncludeMin = true,
