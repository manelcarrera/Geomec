...
protected:
  ...
  RescueTimeStepGroup *getTimeStepGroup(std::unique_ptr<RescueModel> &pModel, const RGDepletionStage &depStage,
  ...
  std::vector<RGSurface>
      m_surfaces[RGSurface::NumTypes]; // map of array of all surfaces (horizons, faults front, faults back, slices
