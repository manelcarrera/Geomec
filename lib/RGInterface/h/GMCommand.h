...
public:
   ...
   /// @brief Get property associated with this command. The command type must be typeCommandSaveProperty or typeCommandLoadProperty 
   /// @return property object
   RGProperty     getProperty() const { assert( m_command == typeCommandSaveProperty || m_command == typeCommandLoadProperty ); return m_property; }

   /// @brief Get date object associated with this command. The command type must be typeCommandDefineInitialDate
   /// @return date object
   RGDate         getDatePrm() const { assert( m_command == typeCommandDefineInitialDate ); return m_date; }
   ...
   /// @return constructed GMCommand object. If command name or command parameters can't be recognized, it returns invalid object
