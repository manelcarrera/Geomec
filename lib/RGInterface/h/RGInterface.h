...
public:
   ...
   /// available number of depletion stages invalid depletion stage is returned. This method must be called by RockMech only 
   /// @param num 
   ...
   // In addition a relation between the formation index and the name under which the user knows the formation could will be provided
