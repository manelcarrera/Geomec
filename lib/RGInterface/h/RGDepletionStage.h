...
public:
  ...
  RGDepletionStage(const RGDepletionStage &ds) : m_elapsedSecs(ds.getElapsedSecs()), m_stage(ds.getDepletionStage()) {
    ;
  }
  ...
  RGDepletionStage(const int &depletionStage, const int &elapsedSecs)
      : m_elapsedSecs(elapsedSecs), m_stage(depletionStage) {
  ...
  bool operator==(const RGDepletionStage &ds) const { return m_stage == ds.getDepletionStage(); }
