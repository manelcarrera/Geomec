...
enum RGFailureMechamismObject { Fault = 0, Formation, Well, TopSurface, Property, UndefinedObject };
...
RGFailure::RGFailureMechanismFailureTypes INTERFACE_RGINTERFACE
FailureMechanismFailureTypeFromString(const std::string &);
