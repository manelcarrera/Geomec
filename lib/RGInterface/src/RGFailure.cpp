...
const std::string c_RGFailureMechamismObject2String[] = {"Fault",      "Formation", "Well",
                                                         "TopSurface", "Property",  "UndefinedObject"};
const std::string c_RGFailureMechanismFailureTypes2String[] = {
    "FaultShearCapacity", "FaultDisplacementL", "ShearCapacity",       "EPStress1L",          "EPStress3L",
    "PStrain1L",          "PStrain3L",          "StrainInvVolumetric", "PStrain1PlasticL",    "PStrain3PlasticL",
    "CompactionCapacity", "WPAxialStrain",      "DisplacementV",       "UndefinedFailureType"};
const std::string c_RGFailureMechanismLsfType2String[] = {"Minimum",
                                                          "Maximum",
