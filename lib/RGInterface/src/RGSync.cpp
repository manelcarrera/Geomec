...
RGLock* createLock(RGSync::ProcessRole role, const std::string& modelName)
{
   return new RGFileLock(role, modelName);
}
...
///////////////////////////////////////////////////////////////////////////////
RGSync::RGSync( RGSync::ProcessRole role, const std::string& modelName ) 
{
   m_lock = createLock(role, modelName);
}
...
///////////////////////////////////////////////////////////////////////////////
bool RGSync::waitFor(int timeout)
{
   return m_lock->waitFor(timeout);
}
