...
RGSurface::RGSurface(const RGSurface &tcp) : m_pimpl(new RGSurfaceImpl(*(tcp.m_pimpl))) {}

/// @brief Nothing specific
RGSurface::~RGSurface() { delete m_pimpl; }
...
std::string RGSurface::toString() const { return m_pimpl->toString(); }

const std::string c_surfaceAttribute2String[] = {"Regular", "Top", "Bottom", "Side", "UndefinedAttribute"};
std::string RGSurface::toString(const RGSurface::Attribute att) { return c_surfaceAttribute2String[att]; }
...
std::string RGSurface::toString(const RGSurface::Type type) { return c_surfaceType2String[type]; }
