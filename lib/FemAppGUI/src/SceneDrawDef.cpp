...
CSceneDrawDef::CSceneDrawDef(COpenGLSceneNode& openGLSceneNode,
...
std::vector <CSceneDrawDef::TColor>
  CSceneDrawDef::Color(const geo::IObject& object) const
{
  COpenGLNode::CDrawDef::DrawDecisionVector
    drawDecisionVector = m_drawDef.Color(object);
...
CSceneDrawDef::TColor CSceneDrawDef::TextColor() const
{
  COpenGLNode::CDrawDef::DrawDecisionColor
    drawDecisionColor = m_drawDef.TextColor();
...
bool CSceneDrawDef::Visible() const
{
  COpenGLNode::CDrawDef::DrawDecisionBool
    drawDecisionBool = m_drawDef.Visible();
...
{
  COpenGLNode::CDrawDef::DrawDecisionBool
    drawDecisionBool = m_drawDef.PolyFillFront();
...
{
  COpenGLNode::CDrawDef::DrawDecisionBool
    drawDecisionBool = m_drawDef.PolyFillBack();
...
{
  COpenGLNode::CDrawDef::DrawDecisionBool
    drawDecisionBool = m_drawDef.LineStipple();
...
GLint CSceneDrawDef::LineStippleFactor() const
{
  COpenGLNode::CDrawDef::DrawDecisionGLint
    drawDecisionGLint = m_drawDef.LineStippleFactor();
...
GLushort CSceneDrawDef::LineStipplePattern() const
{
  COpenGLNode::CDrawDef::DrawDecisionGLushort
    drawDecisionGLushort = m_drawDef.LineStipplePattern();
...
float CSceneDrawDef::LineWidth() const
{
  COpenGLNode::CDrawDef::DrawDecisionFloat
    drawDecisionFloat = m_drawDef.LineWidth();
...
{
  COpenGLNode::CDrawDef::DrawDecisionFloat
    drawDecisionFloat = m_drawDef.PointSize();
...
{
  COpenGLNode::CDrawDef::DrawDecisionBool
    drawDecisionBool = m_drawDef.PolyDrawFront();
...
{
  COpenGLNode::CDrawDef::DrawDecisionBool
    drawDecisionBool = m_drawDef.PolyDrawBack();
...
int CSceneDrawDef::DepthFunc() const
{
  COpenGLNode::CDrawDef::DrawDecisionInt
    drawDecisionInt = m_drawDef.DepthFunc();
...
{
  COpenGLNode::CDrawDef::DrawDecisionBool
    drawDecisionBool = m_drawDef.RequireCompile();
...
long CSceneDrawDef::CircleNrOfSegments() const
{
  COpenGLNode::CDrawDef::DrawDecisionLong
    drawDecisionLong = m_drawDef.CircleNrOfSegments();
...
{
  COpenGLNode::CDrawDef::DrawDecisionBool
    drawDecisionBool = m_drawDef.CurvedDraw();
...
{
  COpenGLNode::CDrawDef::DrawDecisionBool
    drawDecisionBool = m_drawDef.LabelBorder();
...
{
  COpenGLNode::CDrawDef::DrawDecisionColor
    drawDecisionColor = m_drawDef.LabelBorderOutlineColor();
...
{
  COpenGLNode::CDrawDef::DrawDecisionColor
    drawDecisionColor = m_drawDef.LabelBorderInteriorColor();
...
{
  COpenGLNode::CDrawDef::DrawDecisionBool
    drawDecisionBool = m_drawDef.UseStencilBuffer();
...
GLenum CSceneDrawDef::StencilFuncFunc() const
{
  COpenGLNode::CDrawDef::DrawDecisionGLenum
    drawDecisionGLenum = m_drawDef.StencilFuncFunc();
...
{
  COpenGLNode::CDrawDef::DrawDecisionGLint
    drawDecisionGLint = m_drawDef.StencilFuncRef();
...
GLuint CSceneDrawDef::StencilFuncMask() const
{
  COpenGLNode::CDrawDef::DrawDecisionGLuint
    drawDecisionGLuint = m_drawDef.StencilFuncMask();
...
{
  COpenGLNode::CDrawDef::DrawDecisionGLenum
    drawDecisionGLenum = m_drawDef.StencilOpFail();
...
{
  COpenGLNode::CDrawDef::DrawDecisionGLenum
    drawDecisionGLenum = m_drawDef.StencilOpZFail();
...
{
  COpenGLNode::CDrawDef::DrawDecisionGLenum
    drawDecisionGLenum = m_drawDef.StencilOpZPass();
...
{
  COpenGLNode::CDrawDef::DrawDecisionBool
    drawDecisionBool = m_drawDef.IsSelectable(object);
