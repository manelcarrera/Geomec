...
CGraphNode_Delegate::CGraphNode_Delegate(CGraphNode* graphNode)
: m_graphNode(graphNode)
, m_treeNode(nullptr)
{
}

CGraphNode_Delegate::CGraphNode_Delegate(const QString& strInstanceName)
: m_graphNode(0)
, m_treeNode(nullptr)
{
}

bool CGraphNode_Delegate::Attributes()
{
  return true;
}

CTreeNode *CGraphNode_Delegate::TreeNode()
{
  return m_treeNode;
}

void CGraphNode_Delegate::TreeNode(CTreeNode *treeNode)
{
  m_treeNode = treeNode;
}
...
bool CGraphNode_Delegate::CanEdit() const
{
  return true;
}

bool CGraphNode_Delegate::Edit()
{
  return true;
}
...
bool CGraphNode_Delegate::CanDestroy() const
{
  return m_graphNode->CanDestroy();
}

bool CGraphNode_Delegate::Destroy()
{
  return m_graphNode->Destroy();
}
