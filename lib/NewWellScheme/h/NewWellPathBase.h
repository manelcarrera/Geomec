...
public:
  ...
  virtual double TMD(unsigned int index, CDoubleQuantity::UNIT unit = CDoubleQuantity::SI_UNIT) const = 0;
  ...
  static void GetBetweenPosition(const CNewWellPoint &p1, const CNewWellPoint &p2, const double &tmd, double &eas,
