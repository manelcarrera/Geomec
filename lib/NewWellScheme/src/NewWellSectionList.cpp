...
CNewWellSectionList::CNewWellSectionList(
  const std::list <INewWellSection*>& newWellSectionList)
: m_newWellSectionList(newWellSectionList)
{
}

std::list <INewWellSection*> CNewWellSectionList::getSections(
  const CNewWellPoint& newWellPoint, bool includeEdge)
{
