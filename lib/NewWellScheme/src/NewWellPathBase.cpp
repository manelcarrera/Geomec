...
, m_pDefPointList(new CNewWellDefinitionPointList(*this))
, m_GlobalNorthing(0)
, m_GlobalEasting(0)
, m_GlobalTVD(0)
{;}
...
:CCommonWellPath("CNewWellPathBase")
, m_pDefPointList(new CNewWellDefinitionPointList(*this))
, m_GlobalNorthing(0)
, m_GlobalEasting(0)
, m_GlobalTVD(0)
...
const CNewWellDefinitionPointList& CNewWellPathBase::DefPointList() const
{
	return *m_pDefPointList;
}

CNewWellDefinitionPointList& CNewWellPathBase::DefPointList()
{
	return *m_pDefPointList;
}
...
void CNewWellPathBase::GetBetweenPosition( const CNewWellPoint& p1,
...
bool CNewWellPathBase::InitFromArray_tmd_azi_inc(
