...
INewWellSection::INewWellSection(const CNewWellPathBase& WellPath)
...
const CNewWellPoint & CNewWellSection::Bottom() const
{
  return m_Bottom;
}

std::string CNewWellSection::GetDescription() const
{
