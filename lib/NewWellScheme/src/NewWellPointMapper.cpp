...
CNewWellPointValueMap::CNewWellPointValueMap() : CNewWellPointMapper(QString(), std::list<CNewWellPoint>()) {}

CNewWellPointValueMap::CNewWellPointValueMap(const QString &description, const std::list<CNewWellPoint> &List,
                                             CDoubleQuantity *pQuantity)
    : CNewWellPointMapper<geo::CValue>(description, List), m_pQuantity(pQuantity) {}

CNewWellPointValueMap::~CNewWellPointValueMap() {}

//////////////////////////////////////////////////////////////////////

const CDoubleQuantity &CNewWellPointValueMap::QuantityIndicator() { return *m_pQuantity; }
