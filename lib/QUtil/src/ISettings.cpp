...
namespace settings {
QString get_s(const char *section, const char *key) { return ISettings::instance()->getProfileString(section, key); }
//
// default: false
//
...
// set
//
void set_i(const char *section, const char *key, int val) { ISettings::instance()->writeProfileInt(section, key, val); }
} // namespace settings
