...
IProgressBase *CProgressFactory::create(eProgress type_, const QString &title, bool cancel, int jobs) {
  if (_g->dsa()) {
...
IProgressBase *CProgressFactory::create_imp(eProgress type_, const QString &title, bool cancel, int jobs) {
