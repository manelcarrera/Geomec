...
void IProgressBase::StatusMessage(const QString & /*sMessage*/) {
  printer->error("IProgressBase::StatusMessage -> NOT IMPLEMENTED");
}
...
// only for dual
//
void IProgressBase::NextJob(const QString & /*secondaryTitle*/) {
  printer->error("IProgressBase::NextJob -> NOT IMPLEMENTED");
}
