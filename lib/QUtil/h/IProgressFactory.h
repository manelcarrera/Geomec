...
public:
  virtual IProgressBase *create(eProgress type_, const QString &title = "", bool cancel = true, int jobs = 1) = 0;

  virtual IProgressBase *create_imp(eProgress type_, const QString &title = "", bool cancel = true, int jobs = 1) = 0;
};
