...
public:
  CSettingsFile(const QString &usr_filename, const QString &sys_filename);

  static void init(const QString &usr_filename, const QString &sys_filename);
  ...
  virtual unsigned int getSystemInt(const QString &section, const QString &entry, int aDefault) const;
