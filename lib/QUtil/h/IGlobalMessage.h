...
public:
  ...
  virtual int msg(const QString &message, unsigned int style = MB_OK, unsigned int contextID = 0);

  virtual int msg(const char *message, unsigned int style = MB_OK, unsigned int contextID = 0) = 0;

  virtual int msg(unsigned int message, unsigned int style = MB_OK, unsigned int contextID = 0);

  virtual int msg(const std::vector<std::string> &message, unsigned int style = MB_OK, unsigned int contextID = 0);

  virtual int warn(const QString &message, unsigned int style = MB_OK, unsigned int contextID = 0);

  virtual int warn(const char *message, unsigned int style = MB_OK, unsigned int contextID = 0);

  virtual int warn(unsigned int message, unsigned int style = MB_OK, unsigned int contextID = 0);

  virtual int warn(const std::vector<std::string> &message, unsigned int style = MB_OK, unsigned int contextID = 0);

  virtual int error(const QString &message, unsigned int style = MB_OK, unsigned int contextID = 0);

  virtual int error(const char *message, unsigned int style = MB_OK, unsigned int contextID = 0);

  virtual int error(unsigned int message, unsigned int style = MB_OK, unsigned int contextID = 0);

  virtual int error(const std::vector<std::string> &message, unsigned int style = MB_OK, unsigned int contextID = 0);
