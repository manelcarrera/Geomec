...
enum eDsaError { UnableToLaunchDiana, HeartBeatError, EndDepletionCheckError };

enum eQueues { DianaInterface, GUI, RA };
...
static const std::string g_cmd_s[]{//////////////////////////////////
                                   ...
                                   "Start_HB",    // 1
                                   "Quit_HB",     // 2
                                   "Quit_Listen", "DoNothing", "RunDiana", "HeartBeat", "QuitDiana",

                                   // responses
                                   "LaunchDiana_Ack", "RunDiana_Ack", "RunDiana_Done", "HeartBeat_Ack",
                                   "HeartBeat_Error", "QuitDiana_Ack", "QuitDiana_Done", "Quit_HB_Done", "DianaMsg",
                                   ...
                                   // GUI messages
                                   "Log", "DisableViews", "DisableViews_Done", "UpdateViews", "SetParams", "Start",
                                   "Run",
                                   "Save", // memory -> .gm5 file
                                   "Save_Done", "ChecksError",
                                   //
                                   "Progress",
                                   //"DeleteContext",
                                   ...
                                   // only dsa
                                   //
                                   "RunError", "RunSuccess", "RunEnd", "CancelRun",
                                   //

                                   //
                                   // Controller
                                   //
                                   "Run_All", "Run_Stage", "Run_First", "Run_Next", "RunController", "ClearController",
                                   //
                                   //
                                   //
                                   "Quit_Thread",
                                   ...
                                   //
                                   "Quit_RA", "Quit_RA_Done",
                                   //
                                   "Test", "Test_Ack", "Test_Step", "Test_End", "Test_Command"};
