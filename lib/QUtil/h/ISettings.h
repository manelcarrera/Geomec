...
public:
  ...
  virtual bool writeProfileString(const QString &section, const QString &entry, const QString &value) = 0;

  virtual QString getProfileString(const QString &section, const QString &entry,
                                   const QString &aDefault = QString()) const = 0;

  virtual bool writeProfileInt(const QString &section, const QString &entry, int value) = 0;

  virtual unsigned int getProfileInt(const QString &section, const QString &entry, int aDefault = 0) const = 0;
