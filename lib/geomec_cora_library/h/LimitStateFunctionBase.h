...
public:
  CLimitStateFunctionBase(CSummaryResultFile &summaryResultFile, std::vector<QString> &function,
                          CGetModelInfo &modelInfo, const QString &versionNumber, const TObjects &objects,
...
private:
  ...
  static TObject findObject(CSummaryResultFile &summaryResultFile, CGetModelInfo &modelInfo, const QString &object,
                            const TObjects &objects, const QString &objectType);
  static TFailureMode findFailureMode(CSummaryResultFile &summaryResultFile, CGetModelInfo &modelInfo,
                                      const QString &failureModeString, TObject object, const QString &objectType);
  static CAnalysisType::TAnalysisType selectAnalysisType(const QString &failureMode);
