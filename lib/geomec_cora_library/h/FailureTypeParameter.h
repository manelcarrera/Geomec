...
public:
  CFailureTypeParameter(CSummaryResultFile &summaryResultFile, std::istream &stream, const CGetModelInfo &modelInfo);
...
private:
  ...
  static TFailureTypeParameterBase selectFailureType(CSummaryResultFile &summaryResultFile, std::istream &stream,
                                                     const CGetModelInfo &modelInfo);
  static TFailureTypeParameterBase selectFailureType(CSummaryResultFile &summaryResultFile, const std::string &object,
