...
class CFailureTypeParameterFormation4Pressure : public CFailureTypeParameterFormation {
public:
  CFailureTypeParameterFormation4Pressure(CSummaryResultFile &summaryResultFile, const std::string &object,
...
private:
  CFailureTypeParameterFormation4Pressure(const CFailureTypeParameterFormation4Pressure &rhs);
  CFailureTypeParameterFormation4Pressure &operator=(CFailureTypeParameterFormation4Pressure rhs);
};
