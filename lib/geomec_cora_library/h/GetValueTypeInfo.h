...
public:
  ...
  std::pair<geo::CValue, geo::CValue> getRange(unsigned int valueTypeID, const QString &valueTypeName) const;
  std::pair<geo::CValue, geo::CValue> getRange(const CLibraryMaterialParameter &libraryMaterialParameter) const;
