...
template <typename Object, typename ElementSet, typename ParameterType, typename Pressure>
void getPressureParameters(TParameters &parameters, CModelBase * /*modelBase*/, const CDepletionStage &depletionStage,
                           Object *object, const ElementSet &elementSet, const ParameterType &parameterType,
...
template <>
double calculateTotalSize<CFormationBase, geo::IElementSet>(CFormationBase *object, const geo::IElementSet &elementSet);
