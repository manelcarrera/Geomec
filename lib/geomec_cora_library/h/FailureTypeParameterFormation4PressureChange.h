...
class CFailureTypeParameterFormation4PressureChange : public CFailureTypeParameterFormation {
public:
  CFailureTypeParameterFormation4PressureChange(CSummaryResultFile &summaryResultFile, const std::string &object,
...
private:
  CFailureTypeParameterFormation4PressureChange(const CFailureTypeParameterFormation4PressureChange &rhs);
  CFailureTypeParameterFormation4PressureChange &operator=(CFailureTypeParameterFormation4PressureChange rhs);
};
