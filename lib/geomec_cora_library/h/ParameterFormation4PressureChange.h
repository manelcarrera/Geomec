...
public:
  CParameterFormation4PressureChange(const QString &name, const geo::CValue &minimum, const geo::CValue &maximum,
...
private:
  CParameterFormation4PressureChange(const CParameterFormation4PressureChange &rhs);
  CParameterFormation4PressureChange &operator=(CParameterFormation4PressureChange rhs);
