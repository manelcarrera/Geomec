...
public:
  ...
  std::pair<geo::CValue, geo::CValue> getRange(const CLibraryMaterialParameter &libraryMaterialParameter,
                                               const std::set<CValueType *> &valueTypes) const;
...
private:
  ...
  double getMean(const CLibraryMaterialParameter &libraryMaterialParameter, const CValueType *valueType) const;
  std::pair<geo::CValue, geo::CValue> getRange(const CLibraryMaterialParameter &libraryMaterialParameter,
