...
public:
  CParameterNonMeshedSurface(const QString &name, const geo::CValue &minimum, const geo::CValue &maximum, double mean,
...
private:
  ...
  CParameterNonMeshedSurface &operator=(const CParameterNonMeshedSurface &rhs);
