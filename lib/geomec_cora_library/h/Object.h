...
class CObject
{
  public:
    ...
    static struct TFaultObject {} faultObject;
    static struct TFormationObject {} formationObject;
    static struct TSurfaceObject {} surfaceObject;
    static struct TNonMeshedSurfaceObject {} nonMeshedSurfaceObject;
    static struct THorizonObject {} horizonObject;
    static struct TWellObject {} wellObject;

    CObject(const TFaultObject&, CModelBase* modelBase,
      CHorizonBase* horizonBase);
    CObject(const TFormationObject&, CFormationBase* formationBase,
      CModelBase* modelBase);
    CObject(const TSurfaceObject&, CSurfaceBase* surfaceBase);
    CObject(const TNonMeshedSurfaceObject&, CModelBase* modelBase,
