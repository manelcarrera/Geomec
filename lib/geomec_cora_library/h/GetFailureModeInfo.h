...
private:
  ...
  static TFailureModes getFailureModes(std::vector<QString> &exportLabels, CModelBase *modelBase, bool annotated,
                                       const CFilterResults &filterResults,
                                       const CFilterOutputProperty &filterOutputProperty);
  static void getFailureModes(TFailureModes &failureModes, std::vector<QString> &exportLabels, CModelBase *modelBase,
                              const IResult *result, bool annotated, const CFilterResults &filterResults,
                              const CFilterOutputProperty &filterOutputProperty);
