...
private:
  ...
  static void getParameters(TParameters &faultParameters, CModelBase *modelBase, const CDepletionStage &depletionStage,
                            CHorizonBase *horizonBase);
  static void getParameters(TParameters &faultParameters, CModelBase *modelBase, const CDepletionStage &depletionStage,
                            CHorizonBase *horizonBase, unsigned int valueTypeID, unsigned int valueTypeName);
  static void getFaultParameters(TParameters &faultParameters, CModelBase *modelBase,
