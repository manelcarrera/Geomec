...
class CParameter {
public:
  static struct TFaultParameter {
  } faultParameter;
  static struct TFormationParameter4Material {
  } formationParameter4Material;
  static struct TFormationParameter4Pressure {
  } formationParameter4Pressure;
  static struct TFormationParameter4PressureChange {
  } formationParameter4PressureChange;
  static struct THorizonParameter {
  } horizonParameter;
  static struct TSurfaceParameter {
  } surfaceParameter;
  static struct TNonMeshedSurfaceParameter {
  } nonMeshedSurfaceParameter;
  static struct TWellParameter {
  } wellParameter;

  CParameter(const TFaultParameter &, const QString &name, const geo::CValue &minimum, const geo::CValue &maximum,
             double mean, CHorizonBase *horizonBase, int depletionStage, unsigned int valueTypeID);
  CParameter(const TFormationParameter4Material &, const QString &name, const geo::CValue &minimum,
  ...
  CParameter(const TFormationParameter4Pressure &, const QString &name, const geo::CValue &minimum,
             const geo::CValue &maximum, double mean, CFormationBase *formationBase, int depletionStage,
             unsigned int valueTypeID);
  CParameter(const TFormationParameter4PressureChange &, const QString &name, const geo::CValue &minimum,
             const geo::CValue &maximum, double mean, CFormationBase *formationBase, int depletionStage,
             unsigned int valueTypeID);
  CParameter(const THorizonParameter &);
  CParameter(const TSurfaceParameter &);
  CParameter(const TNonMeshedSurfaceParameter &, const QString &name, const geo::CValue &minimum,
  ...
  template <typename ParameterType> bool isParameterType() const;
...
template <typename ParameterType> bool CParameter::isParameterType() const {
