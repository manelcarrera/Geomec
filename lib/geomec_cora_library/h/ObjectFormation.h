...
private:
  ...
  static TParameters getParameters(CFormationBase *formationBase, CModelBase *modelBase);
  static CElementSet *createElementSet(bool &owner, CModelBase *modelBase, CFormationBase *formationBase);
  static CElementSet *elementSetExists(CModelBase *modelBase, CFormationBase *formationBase);
