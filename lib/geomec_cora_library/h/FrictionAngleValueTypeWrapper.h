...
template <typename ParametersNode>
  class CFrictionAngleValueTypeWrapper : public IValueTypeWrapper
{
  public:
  ...
  CFrictionAngleValueTypeWrapper& operator = (
      const CFrictionAngleValueTypeWrapper& rhs);

  const ParametersNode& m_parametersNode;
};

template <typename ParametersNode>
  CFrictionAngleValueTypeWrapper <ParametersNode> ::
  CFrictionAngleValueTypeWrapper(const ParametersNode& parametersNode)
  : IValueTypeWrapper()
...
template <typename ParametersNode>
  CFrictionAngleValueTypeWrapper <ParametersNode> ::
  ~CFrictionAngleValueTypeWrapper()
{
}

template <typename ParametersNode>
  bool CFrictionAngleValueTypeWrapper <ParametersNode> ::
  hasDistributedValueType() const
{
  return m_parametersNode.DistributedFriction();
}

template <typename ParametersNode>
  const std::vector <double> CFrictionAngleValueTypeWrapper <ParametersNode> ::
...
template <typename ParametersNode>
  const CDoubleQuantity& CFrictionAngleValueTypeWrapper <ParametersNode> ::
