...
typedef std::pair<const CDepletionStage *, CAnalysisType> TDepletionStageAnalysisType;
typedef std::vector<TDepletionStageAnalysisType> TDepletionStageAnalysisTypeVector;

class CDepletionStageAnalysisType {
public:
  CDepletionStageAnalysisType(CModelBase *modelBase);

  const TDepletionStageAnalysisTypeVector getDepletionStageAnalysisType() const;
...
private:
  ...
  static TDepletionStageAnalysisTypeVector createDepletionStageAnalysisTypeVector(CModelBase *modelBase);
