...
const QString& CObjectSurface::name() const
{
  return m_surfaceBase->Name();
}

const TParameters& CObjectSurface::getParameters() const
{
  return m_parameters;
}
...
const QString& CObjectSurface::prefix() const
{
  return PREFIX;
}

const COpenGLNode* CObjectSurface::object() const
{
...
const QString& CObjectSurface::typeName() const
{
  return TYPE_NAME;
}
