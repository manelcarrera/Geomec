...
CPre20ResponseTypeFailureAreaMax::CPre20ResponseTypeFailureAreaMax(CSummaryResultFile &summaryResultFile,
...
double CPre20ResponseTypeFailureAreaMax::calculate(const TObject &object, const TFailureMode &failureMode) {
