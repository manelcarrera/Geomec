...
CResponseTypeFailureAreaPercMax::CResponseTypeFailureAreaPercMax(CSummaryResultFile &summaryResultFile,
...
double CResponseTypeFailureAreaPercMax::calculate(const TObject &object, const TFailureMode &failureMode) {
