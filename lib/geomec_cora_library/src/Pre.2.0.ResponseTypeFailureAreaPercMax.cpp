...
CPre20ResponseTypeFailureAreaPercMax::CPre20ResponseTypeFailureAreaPercMax(CSummaryResultFile &summaryResultFile,
...
double CPre20ResponseTypeFailureAreaPercMax::calculate(const TObject &object, const TFailureMode &failureMode) {
