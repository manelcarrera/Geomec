...
CParseCSV::CParseCSV(std::ifstream &csvFile, char delimiter, char quote, char newline)
    : m_csvFile(csvFile), m_delimiter(delimiter), m_quote(quote), m_newline(newline) {}
