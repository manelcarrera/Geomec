...
CParameter::CParameter(const TFaultParameter&, const QString& name,
...
CParameter::CParameter(const TFormationParameter4Material&, const QString& name,
  const geo::CValue& minimum, const geo::CValue& maximum, double mean,
...
CParameter::CParameter(const TFormationParameter4Pressure&, const QString& name,
  const geo::CValue& minimum, const geo::CValue& maximum, double mean,
...
CParameter::CParameter(const TFormationParameter4PressureChange&,
...
CParameter::CParameter(const THorizonParameter&)
: m_objectBase()
{
}

CParameter::CParameter(const TSurfaceParameter&)
: m_objectBase()
{
}

CParameter::CParameter(const TNonMeshedSurfaceParameter&, const QString& name,
  const geo::CValue& minimum, const geo::CValue& maximum, double mean,
...
CParameter::CParameter(const TWellParameter&)
: m_objectBase()
{
}

int CParameter::depletionStage() const
{
  return m_objectBase->depletionStage();
}

unsigned int CParameter::valueTypeID() const
{
  return m_objectBase->valueTypeID();
}

const QString& CParameter::name() const
{
  return m_objectBase->name();
}

CGraphNode* CParameter::object() const
{
  return m_objectBase->object();
}

double CParameter::min() const
{
  return m_objectBase->min();
}

double CParameter::max() const
{
  return m_objectBase->max();
}

double CParameter::mean() const
{
  return m_objectBase->mean();
}

const QString CParameter::lowerLimit() const
{
  return m_objectBase->lowerLimit();
}

const QString CParameter::upperLimit() const
{
  return m_objectBase->upperLimit();
}

std::ostream& CParameter::operator () (std::ostream& os) const
{
...
CParameter::TFormationParameter4Material
  CParameter::formationParameter4Material;
CParameter::TFormationParameter4Pressure
  CParameter::formationParameter4Pressure;
CParameter::TFormationParameter4PressureChange
