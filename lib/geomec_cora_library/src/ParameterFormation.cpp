...
CParameterFormation::CParameterFormation(const QString& name,
...
int CParameterFormation::depletionStage() const
{
  return m_depletionStage;
}

const QString& CParameterFormation::name() const
{
  return m_name;
}

CGraphNode* CParameterFormation::object() const
{
...
double CParameterFormation::mean() const
{
  return m_mean;
}
