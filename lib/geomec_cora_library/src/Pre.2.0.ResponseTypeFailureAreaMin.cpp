...
CPre20ResponseTypeFailureAreaMin::CPre20ResponseTypeFailureAreaMin(CSummaryResultFile &summaryResultFile,
...
double CPre20ResponseTypeFailureAreaMin::calculate(const TObject &object, const TFailureMode &failureMode) {
