...
const QString PARAMETER_FILE_PROCESSING =
  "The parameter file cannot (yet) be processed for objects of type %1";
...
const TParameter CFailureTypeParameterBase::getActualParameter() const
{
  return m_actualParameter;
}
...
TObject CFailureTypeParameterBase::findActualObject(
  CSummaryResultFile& /*summaryResultFile*/, const std::string& object,
...
TParameter CFailureTypeParameterBase::findActualParameter(
  CSummaryResultFile& /*summaryResultFile*/, const std::string& object,
