...
CParameterNonMeshedSurface::CParameterNonMeshedSurface(const QString& name,
...
int CParameterNonMeshedSurface::depletionStage() const
{
  return m_depletionStage;
}

unsigned int CParameterNonMeshedSurface::valueTypeID() const
{
  return m_valueTypeID;
}

const QString& CParameterNonMeshedSurface::name() const
{
  return m_name;
}

CGraphNode* CParameterNonMeshedSurface::object() const
{
  return m_surfaceBase;
}
...
double CParameterNonMeshedSurface::mean() const
{
  return m_mean;
}
