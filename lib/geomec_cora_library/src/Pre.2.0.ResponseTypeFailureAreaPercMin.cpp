...
CPre20ResponseTypeFailureAreaPercMin::CPre20ResponseTypeFailureAreaPercMin(CSummaryResultFile &summaryResultFile,
...
double CPre20ResponseTypeFailureAreaPercMin::calculate(const TObject &object, const TFailureMode &failureMode) {
