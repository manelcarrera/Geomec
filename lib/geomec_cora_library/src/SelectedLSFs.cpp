...
CSelectedLSFs::CSelectedLSFs(CSummaryResultFile& summaryResultFile,
...
std::vector <TLimitStateFunction> CSelectedLSFs::getLimitStateFunctions() const
{
...
const QString SELECTED_LFS_FILE_DOES_NOT_EXIST =
  "selected LSF file '%1' does not exist";

} // anonymous namespace

std::vector <TLimitStateFunction> CSelectedLSFs::readSelectedLSFs(
