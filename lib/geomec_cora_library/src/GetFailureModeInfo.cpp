...
std::vector <QString> CGetFailureModeInfo::getExportLabels() const
{
  return m_exportLabels;
}
...
TFailureModes CGetFailureModeInfo::getFailureModes(
  std::vector <QString>& exportLabels, CModelBase* modelBase, bool annotated,
...
void retrieveAnalysisType(QString analysisType[],
...
QString retrieveDepletionStage(
  const TResultComponentObject& validResultComponentObject)
{
...
void pushFailureModeExportLabel(TFailureModes& failureModes,
  std::vector <QString>& exportLabels, const IResult* result,
  const TDepletionStageAnalysisTypeVector& depletionStageAnalysisTypeVector,
...
void CGetFailureModeInfo::getFailureModes(
  std::vector <TFailureMode>& failureModes, std::vector <QString>& exportLabels,
