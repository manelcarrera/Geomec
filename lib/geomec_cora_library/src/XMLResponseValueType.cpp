...
CXMLResponseValueType::CXMLResponseValueType(const TResponseValueTypeSimple&,
  const QString& responseValueTypeName)
: m_responseValueTypeName(responseValueTypeName)
, m_responseValueTypePostFix(RESPONSE_VALUE_TYPE_SIMPLE)
{
}

CXMLResponseValueType::CXMLResponseValueType(
  const TResponseValueTypeFailureArea&, const QString& responseValueTypeName)
: m_responseValueTypeName(responseValueTypeName)
, m_responseValueTypePostFix(RESPONSE_VALUE_TYPE_FAILURE_AREA)
{
}
...
CXMLResponseValueType::TResponseValueTypeSimple
  CXMLResponseValueType::responseValueTypeSimple;
CXMLResponseValueType::TResponseValueTypeFailureArea
