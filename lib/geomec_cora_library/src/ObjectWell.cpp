...
const QString& CObjectWell::name() const
{
  return m_newWellPath->Name();
}

const TParameters& CObjectWell::getParameters() const
{
  return m_parameters;
}
...
const QString& CObjectWell::prefix() const
{
  return PREFIX;
}

const COpenGLNode* CObjectWell::object() const
{
  return m_newWellPath;
}
...
const QString& CObjectWell::typeName() const
{
  return TYPE_NAME;
}
