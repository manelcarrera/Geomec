...
CFailureMode::CFailureMode(const QString& resultExportLabel,
  const IResultComponent* resultComponent)
: m_resultExportLabel(resultExportLabel)
...
const QString& CFailureMode::getResultExportLabel() const
{
  return m_resultExportLabel;
}

const IResultComponent* CFailureMode::getResultComponent() const
{
  return m_resultComponent;
}

void CFailureMode::setObject(const TObject& object)
{
  m_object = object;
}

void CFailureMode::setFailureModeLabel(const QString& failureModeLabel)
{
  m_failureModeLabel = failureModeLabel;
}

const TObject& CFailureMode::getObject() const
{
  return m_object;
}

const QString& CFailureMode::getFailureModeLabel() const
{
  return m_failureModeLabel;
}
