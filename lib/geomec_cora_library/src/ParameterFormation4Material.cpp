...
CParameterFormation4Material::CParameterFormation4Material(const QString& name,
...
unsigned int CParameterFormation4Material::valueTypeID() const
{
  return m_libraryMaterialParameter.ValueTypeID();
}
