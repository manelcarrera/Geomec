...
: m_modelData(argv[1])
, m_versionNumberIsPresent(isVersionNumberPresent(argc, argv))
...
CModelData& CGetModelInfoData::modelData()
{
  return m_modelData;
}

const CModelData& CGetModelInfoData::modelData() const
{
  return m_modelData;
}

const QString& CGetModelInfoData::versionNumber() const
{
  return m_versionNumber;
}

const char* CGetModelInfoData::modelInfoFileName() const
{
  return m_modelInfoFileName;
}

CSummaryResultFile& CGetModelInfoData::summaryResultFile()
{
  return m_summaryResultFile;
}

const CSummaryResultFile& CGetModelInfoData::summaryResultFile() const
{
  return m_summaryResultFile;
}
