...
CResponseTypeFailureAreaMax::CResponseTypeFailureAreaMax(CSummaryResultFile &summaryResultFile,
...
double CResponseTypeFailureAreaMax::calculate(const TObject &object, const TFailureMode &failureMode) {
