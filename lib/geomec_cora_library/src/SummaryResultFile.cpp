...
CSummaryResultFile::CSummaryResultFile(const QString &fileName)
    : m_summaryResultFile(fileName.toStdString().c_str()), m_resultValue(RESULT_VALUE_OK), m_additionalInformation() {}
...
CSummaryResultFile::TResultValue CSummaryResultFile::getResultValue() const { return m_resultValue; }

void CSummaryResultFile::setResultValue(TResultValue resultValue) { m_resultValue = resultValue; }

void CSummaryResultFile::addAdditionalInformation(const QString &additionalInformation) {
