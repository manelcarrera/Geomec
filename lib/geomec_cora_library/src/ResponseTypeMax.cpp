...
CResponseTypeMax::CResponseTypeMax(CSummaryResultFile &summaryResultFile, const std::vector<QString> &function)
    : CResponseTypeBase(summaryResultFile, function) {}

CResponseTypeMax::~CResponseTypeMax() {}

double CResponseTypeMax::calculate(const TObject &object, const TFailureMode &failureMode) {
