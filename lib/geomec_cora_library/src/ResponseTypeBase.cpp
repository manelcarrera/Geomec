...
const QString CResponseTypeBase::RESPONSE_TYPE_FAILURE_AREA_MAX =
  "Failure area Max";
const QString CResponseTypeBase::RESPONSE_TYPE_FAILURE_AREA_MIN =
  "Failure area Min";
const QString CResponseTypeBase::RESPONSE_TYPE_FAILURE_AREA_PERCENTAGE_MAX =
  "Failure area % Max";
const QString CResponseTypeBase::RESPONSE_TYPE_FAILURE_AREA_PERCENTAGE_MIN =
  "Failure area % Min";
const QString CResponseTypeBase::RESPONSE_TYPE_FN = "[Ff][0-9]{1,3}";

const QString CResponseTypeBase::RESPONSE_TYPE_IS_NOT_IMPLEMENTED =
  "response type '%1' is not implemented";

const double CResponseTypeBase::UNDEFINED_OR_INVALID_RESPONSE_TYPE = -999;

CResponseTypeBase::CResponseTypeBase(CSummaryResultFile& summaryResultFile,
  const std::vector <QString>& function)
: m_summaryResultFile(summaryResultFile)
, m_failureType(function[0])
, m_responseType(function[3])
{
}
...
const QString CResponseTypeBase::getFailureType() const
{
  return m_failureType;
}

const QString CResponseTypeBase::getResponseType() const
{
...
void CResponseTypeBase::verifyResponseType(
  const IValueDomainScalar::TValueVec& valueVector) const
{
...
double CResponseTypeBase::calculateTotalSize(const TObject& object,
