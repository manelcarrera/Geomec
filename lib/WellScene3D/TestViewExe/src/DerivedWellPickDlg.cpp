...
CDerivedWellPickDlg::CDerivedWellPickDlg(well::CWellPointList *pList, CWellSceneInterMed *pSceneInterMed,
                                         QPtrVector<well::CWellSectionList> Sections, CDoubleQuantity::UNIT unit,
                                         CWnd *pParent)
