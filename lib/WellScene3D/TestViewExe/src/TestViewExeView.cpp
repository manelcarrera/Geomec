...
#ifdef _DEBUG
void CTestViewExeView::AssertValid() const { CView::AssertValid(); }

void CTestViewExeView::Dump(CDumpContext &dc) const { CView::Dump(dc); }
...
void CTestViewExeView::OnUpdate(CView *pSender, LPARAM lHint, CObject *pHint) { CurrentScene(GetDocument()->Scene()); }
