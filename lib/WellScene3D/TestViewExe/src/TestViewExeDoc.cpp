...
COLORREF color_table[] = {RGB(255, 0, 0), RGB(0, 255, 0), RGB(0, 0, 255), RGB(255, 255, 0), RGB(0, 255, 255)};
/////////////////////////////////////////////////////////////////////////////
// CTestViewExeDoc
...
CTestViewExeDoc::CTestViewExeDoc() { InitWellPath(); }
...
COpenGLScene *CTestViewExeDoc::Scene() { return m_pScene; }
...
#ifdef _DEBUG
void CTestViewExeDoc::AssertValid() const { CDocument::AssertValid(); }

void CTestViewExeDoc::Dump(CDumpContext &dc) const { CDocument::Dump(dc); }
#endif //_DEBUG
...
void CTestViewExeDoc::OnTestmenuAtachscene() { m_pSceneInterMed->AttachScene(m_pScene); }

void CTestViewExeDoc::OnTestmenuDetachscene() { m_pSceneInterMed->DetachScene(); }
...
void CTestViewExeDoc::OnTestmenuShowdialog() {
  ...
  // CDerivedWellPickDlg	 dlg(&m_pWellPath->GetWellPointList(LST_DSTABORPOINTS), m_pSceneInterMed, &Sections
