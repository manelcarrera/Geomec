...
CWellSceneInterMed::CWellSceneInterMed(well::CWellPathBase &WellPath)
    : m_pScene(0), m_pWellPath(&WellPath), m_bDrawWellInfo(true) {
...
void CWellSceneInterMed::OnSceneDestroy(const COpenGLScene & /*scene*/) { DetachScene(); }
...
CWellPointDrawSpec &CWellSceneInterMed::AddPoint(well::CWellPoint &WellPoint,
                                                 CWellPointDrawSpec::TYPE type /*= CWellPointDrawSpec::LEVEL_SYMBOL*/) {
...
well::CWellPathBase &CWellSceneInterMed::WellPath() { return *m_pWellPath; }

// ##ModelId=3F7AA97E028B
COpenGLScene *CWellSceneInterMed::Scene() { return m_pScene; }
...
well::CWellPoint *CWellSceneInterMed::ProcessNewPointSelection(std::vector<const geo::IObject *> &vec,
...
bool CWellSceneInterMed::DrawWellInfo() const { return m_bDrawWellInfo; }
