...
CWellDrawSpecBase::CWellDrawSpecBase(CWellSceneInterMed& WellSceneInterMed)
:m_pWellSceneInterMed(&WellSceneInterMed)
{
...
bool CWellDrawSpecBase::GetVisible() const
{
  return m_Visible;
}
...
QRgb CWellDrawSpecBase::GetColor() const
{
  return m_Color;
}
...
int CWellDrawSpecBase::GetLineWidth() const
{
  return m_LineWidth;
}
...
CWellSceneInterMed& CWellDrawSpecBase::InterMed() 
{
  return *m_pWellSceneInterMed;
}


QRgb CWellDrawSpecBase::GetTextColor() const
{
  return m_TextColor;
}
...
QString CWellDrawSpecBase::GetDescription() const
{
...
int CWellDrawSpecBase::GetPointSize() const
{
  return m_PointSize; 
}


CLabelPoint::eLabelAlign CWellDrawSpecBase::GetAlign() const
{
  return m_Align;
}

void CWellDrawSpecBase::SetAlign(CLabelPoint::eLabelAlign align) 
{
  m_Align = align;
}
...
QRgb CWellDrawSpecBase::ArrowColor() const
{
  return m_ArrowColor;
}
