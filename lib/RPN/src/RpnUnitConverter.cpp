...
CRpnUnitConverter::CRpnUnitConverter() : m_conversion(UNKNOWN), m_pOperand(0) {}

CRpnUnitConverter::CRpnUnitConverter(CRpnStack &stack, TConversion conversion) : m_conversion(conversion) {
...
CRpnUnitConverter::CRpnUnitConverter(const CRpnUnitConverter &rhs)
    : m_conversion(rhs.m_conversion), m_pOperand(rhs.m_pOperand) {}
...
CRpnUnitConverter::eObjectType CRpnUnitConverter::ObjectType() const { return OT_UNITCONVERTER; }
...
bool CRpnUnitConverter::Defined() const { return true; }
