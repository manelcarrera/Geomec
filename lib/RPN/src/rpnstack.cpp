...
CRpnStack::CCoordinateProxy::CCoordinateProxy(const QString &sName, CRpnStack &stack, COORDINATE coor,
                                              const QString &sProxyId)
...
QString CRpnStack::CCoordinateProxy::TextTag() const { return m_sName; }
...
CRpnStack::CRpnStack() : m_pConstant(0) {}

CRpnStack::CRpnStack(const CRpnStack &rhs) : m_pConstant(0) {
...
int CRpnStack::StackSize() const { return m_vcRpnStack.size(); }
...
bool CRpnStack::IsConstant() const { return m_pConstant != 0; }
...
void CRpnStack::Enter() { m_pConstant = 0; }
...
CRpnOperand::IValueProxy *CRpnStack::AttachOperand(CRpnOperand &operand, const QString &sProxyId) {
  TProxyMap::iterator it =
      m_mpProxy.insert(TProxyMap::value_type(sProxyId, TProxy((CRpnOperand::IValueProxy *)0, TOperandSet()))).first;
...
CRpnObject *CRpnStack::GetExpandedRpnObject(CRpnStack & /*targetstack*/,
