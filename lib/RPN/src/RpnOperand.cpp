...
CRpnOperand::IValueProxy::IValueProxy(CRpnStack& stack, const QString& sProxyId)
: m_pStack(&stack)
{
...
CRpnOperand::IValueProxy::IValueProxy(CRpnStack& stack)
: m_pStack(&stack)
{
  m_sProxyId = m_pStack->AttachValueProxy(*this);
}

CRpnOperand::IValueProxy::~IValueProxy()
{
  m_pStack->DetachValueProxy(*this);
}

const QString& CRpnOperand::IValueProxy::ProxyId() const
{
  return m_sProxyId;
}

CFemAppModel *CRpnOperand::IValueProxy::FindModel(CFemAppModel& /*model*/)
{
  return 0;
}
...
bool CRpnOperand::IValueProxy::HasProperties() const
{
  return false;
}
...
bool CRpnOperand::IValueProxy::operator<(const IValueProxy& rhs) const
{
  return TypeId() < rhs.TypeId();
}

bool CRpnOperand::IValueProxy::CanDelete() const
{
  return false;
}

void CRpnOperand::IValueProxy::Delete()
{
  delete this;
}

CRpnObject* CRpnOperand::IValueProxy::GetExpandedRpnObject(CRpnStack& /*targetstack*/, std::list<std::string>& /*lstMessages*/) const
{
  return 0;
}
...
/// Get the stack
///
CRpnStack *CRpnOperand::IValueProxy::Stack() const
{
  return m_pStack;
}
//////////////////////////////////////////////////////////////////////
...
const CRpnOperand::IValueProxy* CRpnOperand::Proxy() const
{
  return m_pProxy;
}
...
CRpnOperand::eObjectType CRpnOperand::ObjectType() const
{
  return OT_OPERAND;
}
