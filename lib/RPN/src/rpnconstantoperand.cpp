...
void CRpnConstantOperand::One() { m_sNumber += "1"; }

void CRpnConstantOperand::Two() { m_sNumber += "2"; }

void CRpnConstantOperand::Three() { m_sNumber += "3"; }

void CRpnConstantOperand::Four() { m_sNumber += "4"; }

void CRpnConstantOperand::Five() { m_sNumber += "5"; }

void CRpnConstantOperand::Six() { m_sNumber += "6"; }

void CRpnConstantOperand::Seven() { m_sNumber += "7"; }

void CRpnConstantOperand::Eight() { m_sNumber += "8"; }

void CRpnConstantOperand::Nine() { m_sNumber += "9"; }
...
void CRpnConstantOperand::Sign() {
  ...
  // wjrx mantis 3184
  //
  if (m_sNumber.length() >= 2 && nExponent == m_sNumber.length() - 2 && m_sNumber.right(1) == "-") {
...
QString CRpnConstantOperand::Formula() const { return m_sNumber; }
...
CRpnConstantOperand::eObjectType CRpnConstantOperand::ObjectType() const { return OT_CONSTANT; }
...
bool CRpnConstantOperand::Recursive(TParentSet /*stParent*/) const { return false; }

bool CRpnConstantOperand::exists() const { return true; }

CRpnObject *CRpnConstantOperand::GetExpandedRpnObject(CRpnStack & /*targetstack*/,
