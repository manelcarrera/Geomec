...
CRpnBinaryOperation::CRpnBinaryOperation(CRpnStack &stack, enum RPN_OPERATION operation) : m_operation(operation) {
...
CRpnBinaryOperation::CRpnBinaryOperation() : m_pOperandA(0), m_pOperandB(0) {}
...
CRpnBinaryOperation::eObjectType CRpnBinaryOperation::ObjectType() const { return OT_BINARY; }
...
CRpnObject *CRpnBinaryOperation::GetExpandedRpnObject(CRpnStack &targetstack,
