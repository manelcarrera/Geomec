...
CRpnConstant::CRpnConstant(CRpnStack &stack, RPN_CONSTANT constant) : m_constant(constant) { stack.Push(*this); }
...
CRpnConstant::eObjectType CRpnConstant::ObjectType() const { return OT_RPN_CONSTANT; }
...
bool CRpnConstant::Recursive(TParentSet /*stParent*/) const { return false; }

bool CRpnConstant::exists() const { return true; }
