...
template< typename T, typename K, DataType type_, int size >
class GenData : public IT_Data
{
	T m_values;
public:
	GenData( T val ) : IT_Data(){ values( val ); }
	GenData( T val, IT_Data::TIntV params ) : IT_Data() { values( val ); m_params = params; }
...
{
public:
	GenData_3d( IT_Data::TPointsV points ) : GenData<IT_Data::TPointsV, IT_Data::TPoint, DataType::DoubleV, 3>( points ){};									// GM -> IT
	GenData_3d( IT_Data::TPointsV points, IT_Data::TIntV params ) : GenData<IT_Data::TPointsV, IT_Data::TPoint, DataType::DoubleV, 3>( points, params ){};	// GM <- IT
};

class GenData_1d : public GenData<IT_Data::TValuesV, double, DataType::DoubleV, 1>
{
public:
	GenData_1d( IT_Data::TValuesV values ) : GenData<IT_Data::TValuesV, double, DataType::DoubleV, 1>( values ){};											// GM -> IT
	GenData_1d( IT_Data::TValuesV values, IT_Data::TIntV params ) : GenData<IT_Data::TValuesV, double, DataType::DoubleV, 1>( values, params ){};			// GM <- IT
};
