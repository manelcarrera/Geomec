...
template <class T> class CWellPointMapper : public IWellPointMapper {
public:
...
template <class T> CWellPointMapper<T>::~CWellPointMapper() { ClearMap(); }

template <class T> const T &CWellPointMapper<T>::GetItem(const CWellPoint *point) const {
  typename QMap<const CWellPoint *, T>::const_iterator it = m_Map.find(point);
  assert(it != m_Map.end());

  return *it;
}

template <class T> T &CWellPointMapper<T>::GetItem(const CWellPoint *point) {
...
template <class T> const CWellPointList &CWellPointMapper<T>::List() const { return *m_pList; }

template <class T> void CWellPointMapper<T>::InsertItem(CWellPoint *point, const T &item) {
...
template <class T> void CWellPointMapper<T>::ClearMap() {
  // if(m_bDelete)
  //	{
...
template <class T> const QString CWellPointMapper<T>::Description() const { return m_Description; }

template <class T> void CWellPointMapper<T>::Description(QString description) { m_Description = description; }
