...
public:
  enum LOCATION { ONSHORE, PLATFORM, SUBSEA };
...
public:
  static void GetBetweenPosition(const CWellPoint &p1, const CWellPoint &p2, const double &tmd, double &eas,
  ...
  void ChangeGlobalPos(const double &northing, const double &easting, const double &tvd);
  ...
  bool InitFromArray_tmd_azi_inc(double global_northing, double global_easting, double global_depth,
                                 double start_northing, double start_easting, double start_depth, QVector<double> &tmd,
                                 QVector<double> &azi, QVector<double> &inc);

  // initialization of the definition points with arrays uses numerical approx (SI_UNIT)
  bool InitFromArray_tmd_tvd_azi(double global_northing, double global_easting, double global_depth,
                                 double start_northing, double start_easting, double start_inc, QVector<double> &tmd,
                                 QVector<double> &tvd, QVector<double> &azi);
