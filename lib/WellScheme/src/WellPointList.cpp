...
CWellPointList::CWellPointList(const CWellPathBase &WellPath, bool bAutoDelete /*=true*/,
                               bool bAllowDuplicateTMD /* = false */) {
  m_Description = "No Description";
...
CWellPointList::~CWellPointList() { clear(); }
...
CWellPointList::CWellPointList(const CWellPointList &rhs)
    : QObject(), // QObject(const QObject&) is private,
      ...
      m_lstPoints(rhs.m_lstPoints), m_bAutoDelete(rhs.m_bAutoDelete), m_bAllowDuplicateTMD(rhs.m_bAllowDuplicateTMD) {}
...
bool CWellPointList::AutoDelete() const { return m_bAutoDelete; }

void CWellPointList::AutoDelete(bool autodelete) { m_bAutoDelete = autodelete; }

bool CWellPointList::AllowDuplicateTMD() const { return m_bAllowDuplicateTMD; }

void CWellPointList::AllowDuplicateTMD(bool allowduplicate) { m_bAllowDuplicateTMD = allowduplicate; }

// ##ModelId=3F7AA15603C0
int CWellPointList::NrOfPoints() const { return m_lstPoints.size(); }
...
CWellPointList *CWellPointList::This() const { return const_cast<CWellPointList *>(this); }
...
bool CWellPointList::EqualPointExist(const CWellPoint &point) const { return (GetIndex(&point) != -1); }

bool CWellPointList::Exist(const double &tmd) const { return EqualPointExist(well::CWellPoint(WellPath(), tmd)); }

bool CWellPointList::Exist(const CWellPoint *point) const { return !(GetIndex(point) == -1); }
...
CWellPointList::Iterator CWellPointList::begin() const { return This()->m_lstPoints.begin(); }

CWellPointList::Iterator CWellPointList::end() const { return This()->m_lstPoints.end(); }
...
const CWellPathBase &CWellPointList::WellPath() const { return *m_pWellPath; }

void CWellPointList::WellPath(CWellPathBase *pWellPath) { m_pWellPath = pWellPath; }
...
QString CWellPointList::GetDescription() const { return m_Description; }

void CWellPointList::SetDescription(QString description) { m_Description = description; }
