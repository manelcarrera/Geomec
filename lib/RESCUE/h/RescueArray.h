...
public:
  RescueArray(const RESCUECHAR *propertyNameIn, const RESCUECHAR *propertyTypeIn, const RESCUECHAR *unitOfMeasureIn,
              RescueGrid *existingGrid, RescueModel *parentModelIn, RESCUEBOOL cellCenteredIn = FALSE);
  virtual ~RescueArray();
...
private:
  ...
  virtual void SwapAxes(bool swapI, RESCUEINT64 iNodes, bool swapJ, RESCUEINT64 jNodes, bool swapK,
                        RESCUEINT64 kNodes) = 0;
