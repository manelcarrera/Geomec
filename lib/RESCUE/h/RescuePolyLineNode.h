...
public:
  ...
  *****************************************************************/
  typedef enum { I_SECTION, J_SECTION, K_SLICE } RescueLayerType;
  void SetLayerValue(RescueGeometry *geometry, RescueLayerType layerType, RESCUEFLOAT layerNdxParam);
