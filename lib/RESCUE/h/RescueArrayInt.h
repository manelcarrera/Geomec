...
private:
  RescueArrayInt(const RESCUECHAR *propertyNameIn, const RESCUECHAR *propertyTypeIn, const RESCUECHAR *unitOfMeasureIn,
                 RescueGrid *existingGrid, RESCUEINT32 nullValueIn, RescueModel *parentModelIn,
