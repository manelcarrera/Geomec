...
public:
  RescueParametricLGRMap(RescueGeometry *lgrGeometry, RESCUEINT64 expectedRefined, RESCUEINT64 expectedParent,
  ...
  void ClearMap(); // Resets the counts.
                   /*********************** Cell at a time *****************************/
  void SetCellToCell(RESCUEINT64 iNdx, RESCUEINT64 jNdx, RESCUEINT64 kNdx, RESCUEINT64 parentCount, RESCUEINT64 *pIndx,
                     RESCUEINT64 *pJndx, RESCUEINT64 *pKndx);
  void SetCellToCell(RESCUEINT32 iNdx, RESCUEINT32 jNdx, RESCUEINT32 kNdx, RESCUEINT32 parentCount, RESCUEINT32 *pIndx,
                     RESCUEINT32 *pJndx, RESCUEINT32 *pKndx);
  ...
  void Accept(RESCUEINT64 cellToCellCount, // Sets the entire map at one go.
              ...
              RESCUEINT64 parentMapCount, RESCUEINT64 *parentIndxIn, RESCUEINT64 *parentJndxIn,
              RESCUEINT64 *parentKndxIn, RESCUEINT64 *lgrNdx);
  void Accept(RESCUEINT32 cellToCellCount, // Sets the entire map at one go.
              ...
              RESCUEINT32 *parentJndxIn, RESCUEINT32 *parentKndxIn, RESCUEINT32 *lgrNdx);
  void Set(RESCUEINT64 cellToCellCount, // Sets the entire map at one go.
           ...
           RESCUEINT64 *lgrKndxIn, RESCUEINT64 *parentNdxIn, RESCUEINT64 *parentCountIn, RESCUEINT64 parentMapCount,
           RESCUEINT64 *parentIndxIn, RESCUEINT64 *parentJndxIn, RESCUEINT64 *parentKndxIn, RESCUEINT64 *lgrNdxIn);
  void Set(RESCUEINT32 cellToCellCount, // Sets the entire map at one go.
           ...
           RESCUEINT32 *lgrKndxIn, RESCUEINT32 *parentNdxIn, RESCUEINT32 *parentCountIn, RESCUEINT32 parentMapCount,
           RESCUEINT32 *parentIndxIn, RESCUEINT32 *parentJndxIn, RESCUEINT32 *parentKndxIn, RESCUEINT32 *lgrNdxIn);
