...
private:
  RescueArrayDouble(const RESCUECHAR *propertyNameIn, const RESCUECHAR *propertyTypeIn,
                    const RESCUECHAR *unitOfMeasureIn, RescueGrid *existingGrid, RESCUEDOUBLE nullValueIn,
                    RescueModel *parentModelIn, RESCUEBOOL cellCenteredIn = FALSE, RESCUEDOUBLE *valueArray = 0)
