...
public:
  ...
  ***********************************************************************************/
  ...
  RescueWireframeOwner *Owner() {
    return owner;
  } // Returns the RescueWireframeOwner
  ...
  ***********************************************************************************************/
  ...
  RescueTrimVertex *NthRescueTrimVertex(RESCUEINT64 zeroBasedOrdinal) {
    return trimVertexes->NthObject(zeroBasedOrdinal);
  }
  ...
  RescueTrimVertex *TrimVertexIdentifiedBy(RESCUEINT64 identifier) {
    return trimVertexes->ObjectIdentifiedBy(identifier);
  }
  ...
  RESCUEINT64 LoadNo() {
    return loadNo;
  } // This number is incremented each time the wireframe is loaded
