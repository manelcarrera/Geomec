...
private:
  RescueSplitLine(RescueGeometry *geometry, RESCUEFLOAT x, RESCUEFLOAT y, RESCUEFLOAT step, RESCUEFLOAT origin,
  ...
  void SetCornerNode(RescueGeometry *geometry, RESCUEINT64 i, RESCUEINT64 j, RESCUEINT64 k, RESCUEINT64 corner,
                     RESCUEFLOAT x, RESCUEFLOAT y, RESCUEFLOAT z);
  void SetXValue(RescueGeometry *geometry, RESCUEINT64 i, RESCUEINT64 j, RESCUEINT64 k, RESCUEINT64 corner,
                 RESCUEFLOAT value);
  void SetYValue(RescueGeometry *geometry, RESCUEINT64 i, RESCUEINT64 j, RESCUEINT64 k, RESCUEINT64 corner,
                 RESCUEFLOAT value);
  void SetZValue(RescueGeometry *geometry, RESCUEINT64 i, RESCUEINT64 j, RESCUEINT64 k, RESCUEINT64 corner,
                 RESCUEFLOAT value);
...
private:
  RESCUEINT64 GenerateAddress(RESCUEINT64 i, RESCUEINT64 j, RESCUEINT64 k, RESCUEINT64 iPrime, RESCUEINT64 jPrime,
                              RESCUEINT64 kPrime);
