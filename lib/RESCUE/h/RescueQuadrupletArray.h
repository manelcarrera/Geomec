...
public:
  RescueQuadrupletArray(RescueContext *context, RescueGrid *existingGrid, RESCUEFLOAT missingValueIn,
                        RescueModel *parentModelIn)
      : RescueTripletArray(context, existingGrid, missingValueIn, parentModelIn), mdValue(0), mdValueLength(0) {
    isA = R_RescueQuadrupletArray;
  }
  RescueQuadrupletArray(RescueGrid *existingGrid, RESCUEFLOAT missingValueIn, RESCUEFLOAT *valueArray,
                        RescueModel *parentModelIn);
