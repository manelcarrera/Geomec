...
public:
  ...
  void AddCell(RESCUEINT64 cellCenterNdxIn, RESCUEINT64 kLayerIn, RESCUEINT64 count, RESCUEINT64 *faceIndices);
  void AddCell(RESCUEINT32 cellCenterNdxIn, RESCUEINT32 kLayerIn, RESCUEINT32 count, RESCUEINT32 *faceIndices);
  ...
  void CopyVertices(RESCUEINT64 lowNdx, RESCUEINT64 count, RESCUEFLOAT *preAllocatedX, RESCUEFLOAT *preAllocatedY,
                    RESCUEFLOAT *preAllocatedZ,
  ...
  void CopyFaces(RESCUEINT64 lowNdx, RESCUEINT64 count, RESCUEINT64 *preAllocatedNdx, RESCUEINT64 *preAllocatedCount,
                 RESCUEINT64 offset);
  void CopyFaces(RESCUEINT32 lowNdx, RESCUEINT32 count, RESCUEINT32 *preAllocatedNdx, RESCUEINT32 *preAllocatedCount,
                 RESCUEINT32 offset);
  ...
  void CopyCells(RESCUEINT64 lowNdx, RESCUEINT64 count, RESCUEINT64 *faceCellNdxArray, RESCUEINT64 *faceCellCountArray,
                 RESCUEINT64 *cellCenterNdxArray, RESCUEINT64 *kLayerArray, RESCUEINT64 offset);
  void CopyCells(RESCUEINT32 lowNdx, RESCUEINT32 count, RESCUEINT32 *faceCellNdxArray, RESCUEINT32 *faceCellCountArray,
                 RESCUEINT32 *cellCenterNdxArray, RESCUEINT32 *kLayerArray, RESCUEINT32 offset);
  ...
  /*********************************** Writing Cells ***********************************/
  // These replace entire contents.
  void AcceptCells(RESCUEINT64 cellCountIn, RESCUEINT64 *faceCellNdxIn, RESCUEINT64 *faceCellCountIn,
                   RESCUEINT64 *cellCenterNdxIn, RESCUEINT64 *kLayerIn, RESCUEINT64 faceListCountIn,
                   RESCUEINT64 *faceListIn);
  void AcceptCells(RESCUEINT32 cellCountIn, RESCUEINT32 *faceCellNdxIn, RESCUEINT32 *faceCellCountIn,
  ...
  // They become the property of this class.
  void SetCells(RESCUEINT64 cellCountIn, RESCUEINT64 *faceCellNdxIn, RESCUEINT64 *faceCellCountIn,
                RESCUEINT64 *cellCenterNdxIn, RESCUEINT64 *kLayerIn, RESCUEINT64 faceListCountIn,
                RESCUEINT64 *faceListIn);
  void SetCells(RESCUEINT32 cellCountIn, RESCUEINT32 *faceCellNdxIn, RESCUEINT32 *faceCellCountIn,
                RESCUEINT32 *cellCenterNdxIn, RESCUEINT32 *kLayerIn, RESCUEINT32 faceListCountIn,
                RESCUEINT32 *faceListIn);
  // Arrays are copied.
  /**************************************************************************************/
private:
  ...
  RescueUnstructuredGrid(RescueGeometry *lgrGeometry,     // Instantiated via RescueGeometry
                         ...
                         RESCUEINT64 expectedVertexRealloc = 100, RESCUEINT64 expectedFaceRealloc = 100,
                         RESCUEINT64 expectedFaceVertexRealloc = 100, RESCUEINT64 expectedCellRealloc = 100,
                         RESCUEINT64 expectedCellFaceRealloc = 100);
  void Archive(RescueContext *context, FILE *archiveFile);
  virtual void Relink(RescueObject *object);
  void SetupGrid();
  void CalculateMinMax(RESCUEFLOAT &minX, RESCUEFLOAT &maxX, RESCUEFLOAT &minY, RESCUEFLOAT &maxY, RESCUEFLOAT &minZ,
                       RESCUEFLOAT &maxZ);
  /*
