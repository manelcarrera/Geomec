...
private:
  RescueArrayFloat(const RESCUECHAR *propertyNameIn, const RESCUECHAR *propertyTypeIn,
                   const RESCUECHAR *unitOfMeasureIn, RescueGrid *existingGrid, RESCUEFLOAT nullValueIn,
                   RescueModel *parentModelIn, RESCUEBOOL cellCenteredIn = FALSE, RESCUEFLOAT *valueArray = 0)
