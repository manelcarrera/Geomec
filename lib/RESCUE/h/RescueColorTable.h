...
public:
  ...
  void GetColorRow(RESCUEINT64 zeroBasedOrdinal, RescueColor **lowColor, RescueColor **highColor,
                   RESCUEBOOL &haveLowHint, RESCUEFLOAT &lowHint, RESCUEBOOL &haveHighHint, RESCUEFLOAT &highHint);
  ...
  void AddColorRow(RESCUEBOOL lowToInfinite, RESCUEFLOAT lowValue, RESCUEBOOL highToInfinite, RESCUEFLOAT highValue,
                   RescueColor *color);
  ...
  // be freed by the application after use.
  void AddColorRow(RESCUEBOOL lowToInfinite, RESCUEFLOAT lowValue, RESCUEBOOL highToInfinite, RESCUEFLOAT highValue,
                   RescueColor *lowColor, RescueColor *highColor);
