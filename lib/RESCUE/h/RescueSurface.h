...
public:
  ...
  RescueSurface(RescueModel *modelIn, RescueCoordinateSystem::Orientation orientation,
                ...
                RESCUEINT64 j_lowbound, RESCUEINT64 j_count, RESCUEFLOAT missingValue, SurfaceType type);
  RescueSurface(RescueModel *modelIn, RescueCoordinateSystem::Orientation orientation,
                RescueCoordinateSystemAxis *i_axis, RESCUEFLOAT i_origin, RESCUEFLOAT i_step, RESCUEINT64 i_lowbound,
                RESCUEINT64 i_count, RescueCoordinateSystemAxis *j_axis, RESCUEFLOAT j_origin, RESCUEFLOAT j_step,
  ...
  RescueSurface(RescueModel *modelIn, RescueCoordinateSystem::Orientation orientation, RESCUEINT64 i_lowbound,
                RESCUEINT64 i_count, RESCUEINT64 j_lowbound, RESCUEINT64 j_count, RESCUEFLOAT missingValue,
                SurfaceType type);
  RescueSurface(RescueModel *modelIn, RescueCoordinateSystem::Orientation orientation, RESCUEINT64 i_lowbound,
                RESCUEINT64 i_count, RESCUEINT64 j_lowbound, RESCUEINT64 j_count, RESCUEFLOAT missingValue,
                RESCUEFLOAT *tripletArray, SurfaceType type);
  ...
  **********************************************************************************************/
  ...
  RescueIJSurface *NthIJSurface(RESCUEINT64 zeroBasedOrdinal) { return ijSurfaces->NthObject(zeroBasedOrdinal); }
  RescueIJSurface *SurfaceIJIdentifiedBy(RESCUEINT64 identifier) { return ijSurfaces->ObjectIdentifiedBy(identifier); }
  ...
  void AddPropertyGroup(RescuePropertyGroup *existingPropertyGroup) { (*groups) += existingPropertyGroup; }
  ...
  RescueTriangulatedSurface *CreateTriangulatedSurface(RESCUEINT64 vertexCount, RESCUEFLOAT **coordinates,
                                                       RESCUEINT64 faceCount, RESCUEINT64 **faces);
  RescueTriangulatedSurface *CreateTriangulatedSurface(RESCUEINT64 vertexCount, RESCUEFLOAT *coordinates,
                                                       RESCUEINT64 faceCount, RESCUEINT64 *faces);
  RescueTriangulatedSurface *CreateTriangulatedSurface(RESCUEINT32 vertexCount, RESCUEFLOAT **coordinates,
                                                       RESCUEINT32 faceCount, RESCUEINT32 **faces);
  RescueTriangulatedSurface *CreateTriangulatedSurface(RESCUEINT32 vertexCount, RESCUEFLOAT *coordinates,
                                                       RESCUEINT32 faceCount, RESCUEINT32 *faces);
