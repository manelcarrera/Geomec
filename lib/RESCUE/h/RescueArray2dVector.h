...
private:
  RescueArray2dVector(const RESCUECHAR *propertyNameIn, const RESCUECHAR *propertyTypeIn,
                      const RESCUECHAR *unitOfMeasureIn, RescueGrid *existingGrid, Rescue2dVector nullValueIn,
                      RescueModel *parentModelIn, RESCUEBOOL cellCenteredIn = FALSE, Rescue2dVector *valueArray = 0)
