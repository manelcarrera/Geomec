...
private:
  ...
  void AddGroup(RescuePropertyGroup *group, RescueGeometry *geometry, RESCUECHAR *nullOrTimeStepName);
  void AddRow(RescueProperty *property, RescueGeometry *geom, RescueTimeStepGroup *ts, RescuePropertyGroup *group);
  RESCUEINT64 NdxOf(RescueProperty *property, RescueGeometry *geom, RescueTimeStepGroup *ts,
                    RescuePropertyGroup *group);
  RESCUEINT64 CompareRow(RESCUEINT64 ndx, RescueProperty *property, RescueGeometry *geom, RescueTimeStepGroup *ts,
                         RescuePropertyGroup *group);
