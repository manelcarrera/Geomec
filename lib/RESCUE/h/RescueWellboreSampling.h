...
public:
  ...
  RescueWellboreSampling(RescueWellbore *parentWellbore, RESCUEINT64 count, RESCUEFLOAT origin, RESCUEFLOAT step);
  RescueWellboreSampling(RescueWellbore *parentWellbore, RESCUEINT64 count, RESCUEFLOAT *values);
  ...
  RescueWellboreProperty *PropertyDescribedBy(const RESCUECHAR *name, const RESCUECHAR *type, const RESCUECHAR *uom);
