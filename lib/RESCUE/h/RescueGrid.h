...
public:
  virtual ~RescueGrid();
  RescueGrid(RescueContext *context, RescueCoordinateSystem::Orientation displayOrientationIn, RESCUEINT64 i_lowbound,
             RESCUEINT64 i_count);
  RescueGrid(RescueContext *context, RescueCoordinateSystem::Orientation displayOrientationIn, RESCUEFLOAT i_origin,
             RESCUEFLOAT i_step, RESCUEINT64 i_lowbound, RESCUEINT64 i_count);
  RescueGrid(RescueContext *context, RescueCoordinateSystem::Orientation displayOrientationIn, RESCUEINT64 i_lowbound,
             RESCUEINT64 i_count, RESCUEINT64 j_lowbound, RESCUEINT64 j_count);
  RescueGrid(RescueContext *context, RescueCoordinateSystem::Orientation displayOrientationIn,
  ...
  RescueGrid(RescueContext *context, RescueCoordinateSystem::Orientation displayOrientationIn, RESCUEINT64 i_lowbound,
             RESCUEINT64 i_count, RESCUEINT64 j_lowbound, RESCUEINT64 j_count, RESCUEINT64 k_lowbound,
             RESCUEINT64 k_count);
  RescueGrid(RescueContext *context, RescueCoordinateSystem::Orientation displayOrientationIn,
             RescueCoordinateSystemAxis *i_axis, RESCUEFLOAT i_origin, RESCUEFLOAT i_step, RESCUEINT64 i_lowbound,
             RESCUEINT64 i_count, RescueCoordinateSystemAxis *j_axis, RESCUEFLOAT j_origin, RESCUEFLOAT j_step,
             RESCUEINT64 j_lowbound, RESCUEINT64 j_count, RESCUEINT64 k_lowbound, RESCUEINT64 k_count);
  RescueGrid(RescueContext *context, RescueCoordinateSystem::Orientation displayOrientationIn,
             RescueCoordinateSystemAxis *i_axis, RESCUEFLOAT i_origin, RESCUEFLOAT i_step, RESCUEINT64 i_lowbound,
             RESCUEINT64 i_count, RescueCoordinateSystemAxis *j_axis, RESCUEFLOAT j_origin, RESCUEFLOAT j_step,
...
private:
  RescueGrid(RescueContext *context, FILE *archiveFile);
