...
private:
  RescueArrayByte(const RESCUECHAR *propertyNameIn, const RESCUECHAR *propertyTypeIn, const RESCUECHAR *unitOfMeasureIn,
                  RescueGrid *existingGrid, RESCUEUCHAR nullValueIn, RescueLookup *lookupIn, RescueModel *parentModelIn,
