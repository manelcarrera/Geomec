...
public:
  ...
  static RESCUEBOOL SamePoint(RESCUEFLOAT x1, RESCUEFLOAT y1, RESCUEFLOAT z1, RESCUEFLOAT x2, RESCUEFLOAT y2,
                              RESCUEFLOAT z2);
  ...
  static void SwapAxes(RESCUEFLOAT *array, bool swapI, RESCUEINT64 iNodes, bool swapJ, RESCUEINT64 jNodes, bool swapK,
                       RESCUEINT64 kNodes);
  static void SwapAxes(RESCUEINT32 *array, bool swapI, RESCUEINT64 iNodes, bool swapJ, RESCUEINT64 jNodes, bool swapK,
                       RESCUEINT64 kNodes);
  static void SwapAxes(RESCUEUSHORT *array, bool swapI, RESCUEINT64 iNodes, bool swapJ, RESCUEINT64 jNodes, bool swapK,
                       RESCUEINT64 kNodes);
  static void SwapAxes(RESCUEDOUBLE *array, bool swapI, RESCUEINT64 iNodes, bool swapJ, RESCUEINT64 jNodes, bool swapK,
                       RESCUEINT64 kNodes);
  static void SwapAxes(RESCUEUCHAR *array, bool swapI, RESCUEINT64 iNodes, bool swapJ, RESCUEINT64 jNodes, bool swapK,
                       RESCUEINT64 kNodes);

  static RESCUEINT64 *Allocate64For32(RESCUEINT32 *inputArray, RESCUEINT32 cellToCellCount, RESCUEBOOL freeInput);
  static RESCUEINT32 *Allocate32For64(RESCUEINT64 *inputArray, RESCUEINT32 cellToCellCount, RESCUEBOOL freeInput,
                                      RESCUEBOOL throwIfTooBig);
