...
public:
  ...
  */
  RescueSOctTreeNode(RescueTriangulatedSurface *parent, RESCUEFLOAT minX, RESCUEFLOAT maxX, RESCUEFLOAT minY,
                     RESCUEFLOAT maxY, RESCUEFLOAT minZ, RESCUEFLOAT maxZ, RESCUEINT64 xDivisions,
                     RESCUEINT64 yDivisions, RESCUEINT64 zDivisions);
...
protected:
  void CommonInitialization(RESCUEFLOAT minX, RESCUEFLOAT maxX, RESCUEFLOAT minY, RESCUEFLOAT maxY, RESCUEFLOAT minZ,
                            RESCUEFLOAT maxZ); // Called during constructor, so cannot polymorph.
  ...
  */
  RescueSOctTreeNode(RescueSOctTreeNode *parent, RESCUEFLOAT minX, RESCUEFLOAT maxX, RESCUEFLOAT minY, RESCUEFLOAT maxY,
                     RESCUEFLOAT minZ, RESCUEFLOAT maxZ, RESCUEINT64 xDivisions, RESCUEINT64 yDivisions,
                     RESCUEINT64 zDivisions);
  void Split(RESCUEINT64 xDivisions, RESCUEINT64 yDivisions, RESCUEINT64 zDivisions);
  RescueSOctTreeNode *LeafNode(RescueSOctTreeNode *parent, RESCUEFLOAT minX, RESCUEFLOAT maxX, RESCUEFLOAT minY,
                               RESCUEFLOAT maxY, RESCUEFLOAT minZ, RESCUEFLOAT maxZ, RESCUEINT64 xDivisions,
                               RESCUEINT64 yDivisions, RESCUEINT64 zDivisions);
