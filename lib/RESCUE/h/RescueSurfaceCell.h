...
private:
  RescueSurfaceCell(RescueGeometry *geometryIn, RescueIJSurface *surfaceIn, RESCUEINT64 cellNumber,
                    RESCUEINT64 cellFaceNumberIn, SurfaceSide sideIn, RESCUEFLOAT *uvsIn = 0);
