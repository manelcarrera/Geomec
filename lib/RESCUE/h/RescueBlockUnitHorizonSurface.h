...
public:
  RescueBlockUnitHorizonSurface(RescueCoordinateSystem::Orientation orientation, RescueHorizon *parentHorizon,
  ...
  RescueBlockUnitHorizonSurface(RescueCoordinateSystem::Orientation orientation, RescueHorizon *parentHorizon,
                                RESCUEFLOAT i_origin, RESCUEFLOAT i_step, RESCUEINT64 i_lowbound, RESCUEINT64 i_count,
                                RESCUEFLOAT j_origin, RESCUEFLOAT j_step, RESCUEINT64 j_lowbound, RESCUEINT64 j_count,
                                RESCUEFLOAT missingValue, RESCUEFLOAT *valueTriplets,
  ...
  RescueBlockUnitHorizonSurface(RescueCoordinateSystem::Orientation orientation, RescueHorizon *parentHorizon,
                                RESCUEINT64 i_lowbound, RESCUEINT64 i_count, RESCUEINT64 j_lowbound,
                                RESCUEINT64 j_count, RESCUEFLOAT missingValue, RESCUEFLOAT *valueTriplets,
                                RescueSurface::SurfaceType typeIn = RescueSurface::HORIZON);
  ...
  void SetBlockUnitAboveMe(RescueBlockUnit *existingUnit) { unitAboveMe = existingUnit; }
  void SetBlockUnitBelowMe(RescueBlockUnit *existingUnit) { unitBelowMe = existingUnit; }
