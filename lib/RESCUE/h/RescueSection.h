...
public:
  ~RescueSection();
  RescueSection(RescueCoordinateSystem::Orientation orientation, RESCUECHAR *newSectionName, RescueModel *parentModel,
                RescueSurface::SurfaceType typeIn, RESCUEINT64 i_lowbound, RESCUEINT64 i_count, RESCUEINT64 j_lowbound,
  ...
  RescueSection(RescueCoordinateSystem::Orientation orientation, RESCUECHAR *newSectionName, RescueModel *parentModel,
                RescueSurface::SurfaceType typeIn, RESCUEFLOAT missingValue);
  ...
  // Drop with section->ParentModel()->DropRescueSection(section);
  RescueSection(RescueCoordinateSystem::Orientation orientation, RESCUECHAR *newSectionName, RescueModel *modelIn,
                SurfaceType type, RescueCoordinateSystemAxis *i_axis, RESCUEFLOAT i_origin, RESCUEFLOAT i_step,
                RESCUEINT64 i_lowbound, RESCUEINT64 i_count, RescueCoordinateSystemAxis *j_axis, RESCUEFLOAT j_origin,
  ...
  RESCUEBOOL IsNamed(const RESCUECHAR *possibleName);
