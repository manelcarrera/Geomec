...
private:
  ...
  void AddRow(RescueGeometry *geom, RescueTimeStepGroup *ts, RescuePropertyGroup *group);
  RESCUEINT64 NdxOf(RescueGeometry *geom, RescueTimeStepGroup *ts, RescuePropertyGroup *group);
  RESCUEINT64 CompareRow(RESCUEINT64 ndx, RescueGeometry *geom, RescueTimeStepGroup *ts, RescuePropertyGroup *group);
