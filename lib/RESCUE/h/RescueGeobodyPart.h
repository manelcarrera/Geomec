...
public:
  ...
  RescueGeobodyPart(RescueCoordinateSystem::Orientation orientation, RescueGeobody *parentBody, RESCUEFLOAT i_origin,
                    RESCUEFLOAT i_step, RESCUEINT64 i_lowbound, RESCUEINT64 i_count, RESCUEFLOAT j_origin,
                    RESCUEFLOAT j_step, RESCUEINT64 j_lowbound, RESCUEINT64 j_count, RESCUEINT64 k_lowbound,
  ...
  RescueGeobodyPart(RescueCoordinateSystem::Orientation orientation, RescueGeobody *parentBody, RESCUEFLOAT i_origin,
                    ...
                    RESCUEFLOAT topOffsetIn, RescueReferenceSurface *bottomSurfaceIn, RESCUEFLOAT bottomOffsetIn);
  ...
  RescueGeobodyPart(RescueCoordinateSystem::Orientation orientation, RescueGeobody *parentBody, RESCUEFLOAT i_origin,
                    RESCUEFLOAT i_step, RESCUEINT64 i_lowbound, RESCUEINT64 i_count, RESCUEFLOAT j_origin,
                    RESCUEFLOAT j_step, RESCUEINT64 j_lowbound, RESCUEINT64 j_count, RESCUEINT64 k_lowbound,
                    RESCUEINT64 k_count, RESCUEFLOAT missingValue, RescueReferenceSurface *referenceSurfaceIn,
                    RESCUEFLOAT referenceOffsetIn, RESCUEFLOAT thicknessIn, RescueGeometry::RescueLapType onOffLapIn);
  // Constructor for a grid whose z values are
...
private:
  ...
  void UnArchiveWireframeData(RescueModel *model, FILE *archiveFile) {
    bodyVolumes->UnArchiveWireframeData(model, archiveFile);
  }
