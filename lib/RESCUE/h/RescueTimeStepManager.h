...
public:
  ...
  RescueTimeStepGroup **TimeSteps() {
    return steps;
  } // A related array of Count() time step
  ...
  RescueTimeStepGroup *MakeTimeStepGroup(RESCUEINT32 year, RESCUEINT32 month, RESCUEINT32 day, RESCUEINT32 hour,
                                         RESCUEINT32 minute, RESCUEINT32 second);
