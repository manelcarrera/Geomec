...
#ifndef cSetRescueTimeStepGroup_H
#define cSetRescueTimeStepGroup_H
...
public:
  ...
  RescueTimeStepGroup *ObjectNamed(const RESCUECHAR *nameIn);
  RescueTimeStepGroup *ObjectIdentifiedBy(RESCUEINT64 identifier);
