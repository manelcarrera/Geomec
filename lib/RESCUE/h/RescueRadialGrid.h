...
public:
  ...
  RESCUEINT64 CopyArrays(RESCUEINT64 lowSrc, RESCUEINT64 count, RESCUEFLOAT *xs, RESCUEFLOAT *ys, RESCUEFLOAT *zs,
                         RESCUEINT64 offset);
  ...
  RESCUEINT64 CopyCenter(RESCUEINT64 lowSrc, RESCUEINT64 count, RESCUEFLOAT *xs, RESCUEFLOAT *ys, RESCUEFLOAT *zs,
                         RESCUEFLOAT *md, RESCUEINT64 offset);
  ...
  void Accept(RESCUEINT64 radialCellsIn, RESCUEINT64 angularCellsIn, RESCUEINT64 kLayersIn, RESCUEBOOL closedIn,
              RESCUEFLOAT *vertexXin, RESCUEFLOAT *vertexYin, RESCUEFLOAT *vertexZin, RESCUEFLOAT *centerXin,
              RESCUEFLOAT *centerYin, RESCUEFLOAT *centerZin, RESCUEFLOAT *centerMDin);
