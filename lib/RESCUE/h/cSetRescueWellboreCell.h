...
#ifndef cSetRescueWellboreCell_H
#define cSetRescueWellboreCell_H
...
class cSetRescueWellboreCell {
protected:
  RescueWellboreCell **objects;
  RESCUEINT64 allocated;
  RESCUEINT64 count;

public:
  cSetRescueWellboreCell();
  ~cSetRescueWellboreCell();
  ...
  RescueWellboreCell *ObjectNamed(const RESCUECHAR *nameIn);
  RescueWellboreCell *ObjectIdentifiedBy(RESCUEINT64 identifier);
...
private:
  void InsertAt(RESCUEINT64 ndx, RescueWellboreCell *newObject);
};
