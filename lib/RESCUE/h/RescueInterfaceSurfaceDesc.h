...
public:
  RescueInterfaceSurfaceDesc(RescueGeometry *lgrGeometryIn, RESCUEBOOL isExteriorIn, RESCUEINT64 expectedFaces,
                             RESCUEINT64 expectedCells, RESCUEINT64 facesRealloc = DEFAULT_FACE_REALLOC,
  ...
  void SetFaceToCell(RESCUEINT64 iNdx, RESCUEINT64 jNdx, RESCUEINT64 kNdx, RESCUEINT64 faceNdx, RESCUEINT64 cellCount,
                     RESCUEINT64 *cellRef, RESCUEINT64 *cIndx, RESCUEINT64 *cJndx, RESCUEINT64 *cKndx);
  void SetFaceToCell(RESCUEINT32 iNdx, RESCUEINT32 jNdx, RESCUEINT32 kNdx, RESCUEINT32 faceNdx, RESCUEINT32 cellCount,
                     RESCUEINT32 *cellRef, RESCUEINT32 *cIndx, RESCUEINT32 *cJndx, RESCUEINT32 *cKndx);
  ...
  RESCUEINT64 ReadFaceToCell(RESCUEINT64 iNdx, RESCUEINT64 jNdx, RESCUEINT64 kNdx, RESCUEINT64 faceNdx,
                             RESCUEINT64 allocated, RESCUEINT64 *cellRef, RESCUEINT64 *cIndx, RESCUEINT64 *cJndx,
                             RESCUEINT64 *cKndx);
  RESCUEINT32 ReadFaceToCell(RESCUEINT32 iNdx, RESCUEINT32 jNdx, RESCUEINT32 kNdx, RESCUEINT32 faceNdx,
                             RESCUEINT32 allocated, RESCUEINT32 *cellRef, RESCUEINT32 *cIndx, RESCUEINT32 *cJndx,
                             RESCUEINT32 *cKndx);
  ...
  RESCUEINT64 ReadCellToFace(RESCUEINT64 cRef, RESCUEINT64 cIndx, RESCUEINT64 cJndx, RESCUEINT64 cKndx,
                             RESCUEINT64 allocated, RESCUEINT64 *iNdx, RESCUEINT64 *jNdx, RESCUEINT64 *kNdx,
                             RESCUEINT64 *faceNdx);
  RESCUEINT32 ReadCellToFace(RESCUEINT32 cRef, RESCUEINT32 cIndx, RESCUEINT32 cJndx, RESCUEINT32 cKndx,
                             RESCUEINT32 allocated, RESCUEINT32 *iNdx, RESCUEINT32 *jNdx, RESCUEINT32 *kNdx,
                             RESCUEINT32 *faceNdx);
  ...
  void Accept(RESCUEINT64 faceCountIn, // Sets the entire map at one go.
              ...
              RESCUEINT64 *cellCountIn, RESCUEINT64 cellMapCountIn, RESCUEINT64 *cellRefIn, RESCUEINT64 *cellINdxIn,
              RESCUEINT64 *cellJNdxIn, RESCUEINT64 *cellKNdxIn, RESCUEINT64 *faceRowNdxIn);
  void Accept(RESCUEINT32 faceCountIn,  // Sets the entire map at one go.
              ...
              RESCUEINT32 cellMapCountIn, RESCUEINT32 *cellRefIn, RESCUEINT32 *cellINdxIn, RESCUEINT32 *cellJNdxIn,
              RESCUEINT32 *cellKNdxIn, RESCUEINT32 *faceRowNdxIn);
  void Set(RESCUEINT64 faceCountIn, // Sets the entire map at one go.
           ...
           RESCUEINT64 *faceKndxIn, RESCUEINT64 *faceNdxIn, RESCUEINT64 *cellNdxIn, RESCUEINT64 *cellCountIn,
           RESCUEINT64 cellMapCountIn, RESCUEINT64 *cellRefIn, RESCUEINT64 *cellINdxIn, RESCUEINT64 *cellJNdxIn,
           RESCUEINT64 *cellKNdxIn, RESCUEINT64 *faceRowNdxIn);
  void Set(RESCUEINT32 faceCountIn, // Sets the entire map at one go.
           ...
           RESCUEINT32 *faceKndxIn, RESCUEINT32 *faceNdxIn, RESCUEINT32 *cellNdxIn, RESCUEINT32 *cellCountIn,
           RESCUEINT32 cellMapCountIn, RESCUEINT32 *cellRefIn, RESCUEINT32 *cellINdxIn, RESCUEINT32 *cellJNdxIn,
           RESCUEINT32 *cellKNdxIn, RESCUEINT32 *faceRowNdxIn);
