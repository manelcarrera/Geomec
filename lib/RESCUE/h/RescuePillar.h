...
public:
  ...
  RESCUEFLOAT KValue(RESCUEINT64 k, RESCUEINT64 dir); // Corresponds to Values(RESCUEINT64 k, RESCUEINT64 dir,
                                                      // RESCUEFLOAT &z); Read values, especially Java.
  ...
  // coefficients.
  void AddControlPoint(RESCUEFLOAT x, RESCUEFLOAT y, RESCUEFLOAT z, RESCUEFLOAT xb, RESCUEFLOAT xc, RESCUEFLOAT xd,
...
protected:
  ...
  void SwapIJAxis(bool swapI, RESCUEINT64 iLowBound, RESCUEINT64 iCount, bool swapJ, RESCUEINT64 jLowBound,
                  RESCUEINT64 jCount);
