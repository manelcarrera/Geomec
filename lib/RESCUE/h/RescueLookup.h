...
public:
  RescueLookup(const RESCUECHAR *newName, RESCUEINT64 size, RescueModel *newParentModel);
  // Create a new lookup.
  ...
  RESCUEBOOL IsNamed(const RESCUECHAR *possibleName) { return ((*name) == possibleName); }
