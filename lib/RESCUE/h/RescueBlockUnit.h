...
public:
  ...
  RescueBlockUnit(RescueCoordinateSystem::Orientation orientation,
                  ...
                  RescueUnit *parentUnit, RESCUEFLOAT i_origin, RESCUEFLOAT i_step, RESCUEINT64 i_lowbound,
                  RESCUEINT64 i_count, RESCUEFLOAT j_origin, RESCUEFLOAT j_step, RESCUEINT64 j_lowbound,
                  RESCUEINT64 j_count, RESCUEFLOAT k_origin, RESCUEFLOAT k_step, RESCUEINT64 k_lowbound,
                  RESCUEINT64 k_count, RESCUEFLOAT missingValue);
  RescueBlockUnit(RescueCoordinateSystem::Orientation orientation,
                  RescueBlock *parentBlock, // Geometry may be regular in all 3 directions.
                  RescueUnit *parentUnit, RESCUEFLOAT i_origin, RESCUEFLOAT i_step, RESCUEINT32 i_lowbound,
                  RESCUEINT32 i_count, RESCUEFLOAT j_origin, RESCUEFLOAT j_step, RESCUEINT32 j_lowbound,
                  RESCUEINT32 j_count, RESCUEFLOAT k_origin, RESCUEFLOAT k_step, RESCUEINT32 k_lowbound,
  ...
  RescueBlockUnit(RescueCoordinateSystem::Orientation orientation,
                  ...
                  RescueUnit *parentUnit, RESCUEFLOAT i_origin, RESCUEFLOAT i_step, RESCUEINT64 i_lowbound,
                  RESCUEINT64 i_count, RESCUEFLOAT j_origin, RESCUEFLOAT j_step, RESCUEINT64 j_lowbound,
                  RESCUEINT64 j_count, RESCUEINT64 k_lowbound, RESCUEINT64 k_count, RESCUEFLOAT missingValue);
  RescueBlockUnit(RescueCoordinateSystem::Orientation orientation,
                  RescueBlock *parentBlock, // Geometry may be regular in i and j.
                  RescueUnit *parentUnit, RESCUEFLOAT i_origin, RESCUEFLOAT i_step, RESCUEINT32 i_lowbound,
                  RESCUEINT32 i_count, RESCUEFLOAT j_origin, RESCUEFLOAT j_step, RESCUEINT32 j_lowbound,
                  RESCUEINT32 j_count, RESCUEINT32 k_lowbound, RESCUEINT32 k_count, RESCUEFLOAT missingValue);

  RescueBlockUnit(RescueCoordinateSystem::Orientation orientation, RescueBlock *parentBlock, RescueUnit *parentUnit,
  ...
  RescueBlockUnit(RescueCoordinateSystem::Orientation orientation, RescueBlock *parentBlock, RescueUnit *parentUnit,
                  RESCUEFLOAT i_origin, RESCUEFLOAT i_step, RESCUEINT32 i_lowbound, RESCUEINT32 i_count,
                  RESCUEFLOAT j_origin, RESCUEFLOAT j_step, RESCUEINT32 j_lowbound, RESCUEINT32 j_count,
  ...
  void SetSurfaceAboveMe(RescueBlockUnitHorizonSurface *existingSurface) { surfaceAboveMe = existingSurface; }
  void SetSurfaceBelowMe(RescueBlockUnitHorizonSurface *existingSurface) { surfaceBelowMe = existingSurface; }
  ...
  RescueMacroVolume *MacroVolumeIdentifiedBy(RESCUEINT64 id) { return (*macroVolumes).ObjectIdentifiedBy(id); }
  ...
  void AddPropertyGroup(RescuePropertyGroup *existingPropertyGroup) { (*propertyGroups) += existingPropertyGroup; }
  ...
  RescueColor *Color() {
    return color;
  } // Will return NULL if no color has been assigned.  DO NOT
...
private:
  ...
  void UnArchiveWireframeData(RescueModel *model, FILE *archiveFile) {
    macroVolumes->UnArchiveWireframeData(model, archiveFile);
  }
