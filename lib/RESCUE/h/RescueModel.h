...
public:
  ...
  RESCUEBOOL ArchiveModel(RESCUECHAR *pathName, RESCUEBOOL binary = FALSE, RESCUEINT32 version = FILE_VERSION,
                          RESCUEBOOL write32 = true);
  ...
  void SetWriter(const RESCUECHAR *vendorName, const RESCUECHAR *vendorVersion, const RESCUECHAR *modelDate,
                 const RESCUECHAR *userName);
  ...
  RESCUEINT32 UnitCount(RESCUEBOOL throwIfTooBig) {
    return RescueContext::Return32For64(units->Count64(), throwIfTooBig);
  }
  RESCUEINT32 BlockCount(RESCUEBOOL throwIfTooBig) {
    return RescueContext::Return32For64(blocks->Count64(), throwIfTooBig);
  }
  RESCUEINT32 HorizonCount(RESCUEBOOL throwIfTooBig) {
    return RescueContext::Return32For64(horizons->Count64(), throwIfTooBig);
  }
  RESCUEINT32 WellboreCount(RESCUEBOOL throwIfTooBig) {
    return RescueContext::Return32For64(wellbores->Count64(), throwIfTooBig);
  }
  RESCUEINT32 SectionCount(RESCUEBOOL throwIfTooBig) {
    return RescueContext::Return32For64(sections->Count64(), throwIfTooBig);
  }
  RESCUEINT32 PropertyGroupCount(RESCUEBOOL throwIfTooBig) {
    return RescueContext::Return32For64(propertyGroup->Count64(), throwIfTooBig);
  }
  RESCUEINT32 HistoryCount(RESCUEBOOL throwIfTooBig) {
    return RescueContext::Return32For64(history->Count64(), throwIfTooBig);
  }
  RESCUEINT32 GeobodyCount(RESCUEBOOL throwIfTooBig) {
    return RescueContext::Return32For64(geoBodies->Count64(), throwIfTooBig);
  }
  RESCUEINT32 ReferenceSurfaceCount(RESCUEBOOL throwIfTooBig) {
    return RescueContext::Return32For64(referenceSurfaces->Count64(), throwIfTooBig);
  }
  RESCUEINT32 LookupCount(RESCUEBOOL throwIfTooBig) {
    return RescueContext::Return32For64(lookups->Count64(), throwIfTooBig);
  }
  RESCUEINT32 EventDescrCount(RESCUEBOOL throwIfTooBig) {
    return RescueContext::Return32For64(eventDescr->Count64(), throwIfTooBig);
  }
  RESCUEINT32 FaultIntersectionCount(RESCUEBOOL throwIfTooBig) {
    return RescueContext::Return32For64(faultIntersections->Count64(), throwIfTooBig);
  }
  RESCUEINT32 ReservoirCount(RESCUEBOOL throwIfTooBig) {
    return RescueContext::Return32For64(reservoirs->Count64(), throwIfTooBig);
  }
  RESCUEINT32 WireframeCount(RESCUEBOOL throwIfTooBig) {
    return RescueContext::Return32For64(wireframes->Count64(), throwIfTooBig);
  }
  ...
  RescueReferenceSurface *NthRescueReferenceSurface(RESCUEINT64 zeroBasedOrdinal) {
    return referenceSurfaces->NthObject(zeroBasedOrdinal);
  }
  RescueModelPropertyGroup *NthRescueModelPropertyGroup(RESCUEINT64 zeroBasedOrdinal) {
    return propertyGroup->NthObject(zeroBasedOrdinal);
  }
  ...
  RescueEventDescr *NthRescueEventDescr(RESCUEINT64 zeroBasedOrdinal) {
    return eventDescr->NthObject(zeroBasedOrdinal);
  }
  RescueFaultIntersection *NthRescueFaultIntersection(RESCUEINT64 zeroBasedOrdinal) {
    return faultIntersections->NthObject(zeroBasedOrdinal);
  }
  ...
  RESCUEBOOL DropRescueModelPropertyGroup(RescueModelPropertyGroup *groupToDrop) {
    return ((*propertyGroup) -= groupToDrop);
  }
  ...
  RescueEventDescr *EventDescrIdentifiedBy(RESCUEINT64 identifier) {
    return eventDescr->ObjectIdentifiedBy(identifier);
  }
  RescueFaultIntersection *FaultIntersectionIdentifiedBy(RESCUEINT64 identifier) {
    return faultIntersections->ObjectIdentifiedBy(identifier);
  }
  ...
  ***********************************************************************************/
  ...
  void SetCoordinateSystem(RescueCoordinateSystem *newCoordinateSystem) { coordinateSystem = newCoordinateSystem; }
  ...
  *******************************************************************************************/
  ...
  RescueGeometry *GridGeometryIdentifiedBy(RESCUEINT64 identifier) {
  ...
  *******************************************************************************************/
  ...
  // If you want to remove them from the
  // model use the corresponding Drop method.
  RESCUEBOOL DropRescuePropertyGroup(RescuePropertyGroup *unitToDrop) { return ((*localGroups) -= unitToDrop); }
  ...
  *******************************************************************************************/
  static int SetOrientation(RescueContext *context, char *modelFileName,
