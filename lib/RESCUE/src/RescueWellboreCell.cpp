...
RescueWellboreCell::RescueWellboreCell(RescueGeometry *geometryIn, RescueWellbore *wellboreIn, RESCUEINT64 cellNumberIn)
    : RescueObject(geometryIn->ParentModel()->Context()), wellbore(wellboreIn), geometry(geometryIn),
...
RescueWellboreCell::RescueWellboreCell(RescueContext *context, FILE *archiveFile)
    : RescueObject(context), wellbore(0), geometry(0) {
...
RescueWellboreCell::~RescueWellboreCell() { (*wellbore->cellIntersections) -= this; }
...
void RescueWellboreCell::CellIndex(RescueGeometry *geometryIn, RESCUEINT32 &i, RESCUEINT32 &j, RESCUEINT32 &k,
                                   bool throwIfTooBig) {
  RESCUEINT64 iPrime;
  RESCUEINT64 jPrime;
  RESCUEINT64 kPrime;
...
void RescueWellboreCell::CellIndex(RescueGeometry *geometryIn, RESCUEINT32 *returnArray, RESCUEINT32 arraySize,
                                   bool throwIfTooBig) {
  RESCUEINT32 i;
  RESCUEINT32 j;
  RESCUEINT32 k;
