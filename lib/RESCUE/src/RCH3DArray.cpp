...
void RCH3DArray::Set(RESCUEINT64 i, RESCUEINT64 j, RESCUEINT64 k, RESCUEFLOAT value)
{
  Ndx(i, j, k) = value;
}

void RCH3DArray::Set(RESCUEINT32 i, RESCUEINT32 j, RESCUEINT32 k, RESCUEFLOAT value)
{
  Ndx(i, j, k) = value;
}
