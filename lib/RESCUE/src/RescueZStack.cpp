...
void RescueZStack::ZValue(RESCUEINT64 k, RESCUEFLOAT newZValue) { value[k] = newZValue; }
...
void RescueZStack::Values(RescueGeometry *geometry, RESCUEINT64 i, RESCUEINT64 j, RESCUEINT64 k, RESCUEINT64 corner,
...
void RescueZStack::Values(RescueGeometry *geometry, RESCUEINT64 i, RESCUEINT64 j, RESCUEINT64 k, RESCUEFLOAT &x,
