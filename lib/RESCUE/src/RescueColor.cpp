...
RescueColor::RescueColor(RescueColor &otherColor) : RescueObject(otherColor.context), context(otherColor.context) {
...
RescueColor::RescueColor(RescueContext *contextIn, RESCUEFLOAT red, RESCUEFLOAT green, RESCUEFLOAT blue,
                         RESCUECHAR *name)
    : RescueObject(contextIn), context(contextIn) {
  CommonInitialization();
  SetColor(red, green, blue, name);
...
RescueColor::~RescueColor() { delete colorName; }
...
RescueColor::RescueColor(RescueContext *contextIn, FILE *archiveFile) : RescueObject(contextIn), context(contextIn) {
  CommonInitialization();
