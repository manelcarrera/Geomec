...
RescueBlockUnitHorizonSurface::RescueBlockUnitHorizonSurface(
    RescueCoordinateSystem::Orientation orientation, RescueHorizon *parentHorizonIn, RESCUEFLOAT i_origin,
    RESCUEFLOAT i_step, RESCUEINT64 i_lowbound, RESCUEINT64 i_count, RESCUEFLOAT j_origin, RESCUEFLOAT j_step,
    RESCUEINT64 j_lowbound, RESCUEINT64 j_count, RESCUEFLOAT missingValue, RescueSurface::SurfaceType typeIn)
    : RescueReferenceSurface(parentHorizonIn->ParentModel(), orientation,
                             parentHorizonIn->ParentModel()->CoordinateSystem()->Axis(0), i_origin, i_step, i_lowbound,
                             i_count, parentHorizonIn->ParentModel()->CoordinateSystem()->Axis(1), j_origin, j_step,
                             j_lowbound, j_count, missingValue, typeIn),
      parentHorizon(parentHorizonIn), unitAboveMe(0), unitBelowMe(0) {
...
RescueBlockUnitHorizonSurface::RescueBlockUnitHorizonSurface(
    RescueCoordinateSystem::Orientation orientation, RescueHorizon *parentHorizonIn, RESCUEFLOAT i_origin,
    RESCUEFLOAT i_step, RESCUEINT64 i_lowbound, RESCUEINT64 i_count, RESCUEFLOAT j_origin, RESCUEFLOAT j_step,
    RESCUEINT64 j_lowbound, RESCUEINT64 j_count, RESCUEFLOAT missingValue, RESCUEFLOAT *valueTriplets,
    RescueSurface::SurfaceType typeIn)
    : RescueReferenceSurface(parentHorizonIn->ParentModel(), orientation,
                             parentHorizonIn->ParentModel()->CoordinateSystem()->Axis(0), i_origin, i_step, i_lowbound,
                             i_count, parentHorizonIn->ParentModel()->CoordinateSystem()->Axis(1), j_origin, j_step,
                             j_lowbound, j_count, missingValue, valueTriplets, typeIn),
      parentHorizon(parentHorizonIn), unitAboveMe(0), unitBelowMe(0) {
  (*parentHorizon->surfaces) += this;
  isA = R_RescueBlockUnitHorizonSurface;
}

RescueBlockUnitHorizonSurface::RescueBlockUnitHorizonSurface(RescueCoordinateSystem::Orientation orientation,
                                                             RescueHorizon *parentHorizonIn, RESCUEINT64 i_lowbound,
                                                             RESCUEINT64 i_count, RESCUEINT64 j_lowbound,
                                                             RESCUEINT64 j_count, RESCUEFLOAT missingValue,
                                                             RescueSurface::SurfaceType typeIn)
    : RescueReferenceSurface(parentHorizonIn->ParentModel(), orientation,
                             parentHorizonIn->ParentModel()->CoordinateSystem()->Axis(0), 0.0, 0.0, i_lowbound, i_count,
                             parentHorizonIn->ParentModel()->CoordinateSystem()->Axis(1), 0.0, 0.0, j_lowbound, j_count,
                             missingValue, typeIn)
...
RescueBlockUnitHorizonSurface::RescueBlockUnitHorizonSurface(RescueCoordinateSystem::Orientation orientation,
                                                             RescueHorizon *parentHorizonIn, RESCUEFLOAT missingValue,
                                                             RescueSurface::SurfaceType typeIn)
    : RescueReferenceSurface(
          parentHorizonIn->ParentModel(), orientation, parentHorizonIn->ParentModel()->CoordinateSystem()->Axis(0), 0.0,
          0.0, 0, 0, parentHorizonIn->ParentModel()->CoordinateSystem()->Axis(1), 0.0, 0.0, 0, 0, missingValue, typeIn),
      parentHorizon(parentHorizonIn), unitAboveMe(0), unitBelowMe(0) {
  (*parentHorizon->surfaces) += this;
  isA = R_RescueBlockUnitHorizonSurface;
}
...
RescueBlockUnitHorizonSurface::RescueBlockUnitHorizonSurface(RescueCoordinateSystem::Orientation orientation,
    ...
    : RescueReferenceSurface(parentHorizonIn->ParentModel(), orientation,
                             parentHorizonIn->ParentModel()->CoordinateSystem()->Axis(0), 0.0, 0.0, i_lowbound, i_count,
                             parentHorizonIn->ParentModel()->CoordinateSystem()->Axis(1), 0.0, 0.0, j_lowbound, j_count,
                             missingValue, valueTriplets, typeIn),
      parentHorizon(parentHorizonIn), unitAboveMe(0), unitBelowMe(0) {
  (*parentHorizon->surfaces) += this;
  isA = R_RescueBlockUnitHorizonSurface;
}

RescueBlockUnitHorizonSurface::RescueBlockUnitHorizonSurface(RescueContext *context, FILE *archiveFile)
    : RescueReferenceSurface(context, archiveFile, 0), parentHorizon(0), unitAboveMe(0), unitBelowMe(0), edges(0) {
...
RescueBlockUnitHorizonSurface::~RescueBlockUnitHorizonSurface() { delete edges; }
