...
RescueGeometry::RescueGeometry(RescueModel *parentModelIn, RescueGrid *existingGrid, RESCUEFLOAT missingValueIn)
    : RescueHistoryObject(parentModelIn->Context()), grid(existingGrid), missingValue(missingValueIn),
      parentModel(parentModelIn), surfaceCell(0), wellboreCell(0), surfaceToGrid(0), stairSteps(0), geometryUnit(0),
      properties(0), hasChanged(TRUE), dirtyMinMax(TRUE), loaded(TRUE), color(0), parentBlockUnit(0),
      parentGeobodyPart(0), referenceID(0), referenceName(0), lgrType(R_NOT_LGR), lgrGridType(R_STRUCTURED_CPG),
      parentILowBound(0), parentICount(0), parentJLowBound(0), parentJCount(0), parentKLowBound(0), parentKCount(0),
      parentGeometry(0), lgrs(new cSetRescueGeometry()), xWeightLength(0), xWeight(0), yWeightLength(0), yWeight(0),
      zWeightLength(0), zWeight(0), parametricMap(0), isds(new cSetRescueInterfaceSurfaceDesc()), unstructuredGrid(0),
      radialGrid(0), minX(0), maxX(0), minY(0), maxY(0), minZ(0), maxZ(0), propertyContainers(0),
      propertyContainerId(0), lgrSetName(0), lgrStartTime(0), lgrEndTime(0) {
...
RescueGeometry::RescueGeometry(RescueModel *parentModelIn, RescueGrid *existingGrid, RESCUEFLOAT missingValueIn,
    ...
    : RescueHistoryObject(parentModelIn->Context()), grid(existingGrid), missingValue(missingValueIn),
      parentModel(parentModelIn), referenceSurface1(topSurfaceIn), referenceSurface2(bottomSurfaceIn),
      offset1(topOffsetIn), offset2(bottomOffsetIn), thickness((RESCUEFLOAT)0.0), onOffLap(R_ONLAP), surfaceCell(0),
      wellboreCell(0), surfaceToGrid(0), stairSteps(0), geometryUnit(0), properties(0), hasChanged(TRUE),
      dirtyMinMax(TRUE), loaded(TRUE), color(0), parentBlockUnit(0), parentGeobodyPart(0), referenceID(0),
      referenceName(0), lgrType(R_NOT_LGR), lgrGridType(R_STRUCTURED_CPG), parentILowBound(0), parentICount(0),
      parentJLowBound(0), parentJCount(0), parentKLowBound(0), parentKCount(0), parentGeometry(0),
      lgrs(new cSetRescueGeometry()), xWeightLength(0), xWeight(0), yWeightLength(0), yWeight(0), zWeightLength(0),
      zWeight(0)

      ,
      parametricMap(0), isds(new cSetRescueInterfaceSurfaceDesc()), unstructuredGrid(0), radialGrid(0), minX(0),
      maxX(0), minY(0), maxY(0), minZ(0), maxZ(0), propertyContainers(0), propertyContainerId(0), lgrSetName(0),
      lgrStartTime(0), lgrEndTime(0) {
  isA = R_RescueGeometry;
  surfaceCell = new cSetRescueSurfaceCell();
  geometryUnit = new cSetRescueGeometryUnit();
  properties = new cSetRescueProperty();
...
RescueGeometry::RescueGeometry(RescueModel *parentModelIn, RescueGrid *existingGrid, RESCUEFLOAT missingValueIn,
    ...
    : RescueHistoryObject(parentModelIn->Context()), grid(existingGrid), missingValue(missingValueIn),
      parentModel(parentModelIn), referenceSurface1(referenceSurfaceIn), referenceSurface2(0),
      offset1(referenceOffsetIn), offset2((RESCUEFLOAT)0.0), thickness(thicknessIn), onOffLap(onOffLapIn),
      surfaceCell(0), wellboreCell(0), surfaceToGrid(0), stairSteps(0), geometryUnit(0), properties(0),
      hasChanged(TRUE), dirtyMinMax(TRUE), loaded(TRUE), color(0), parentBlockUnit(0), parentGeobodyPart(0),
      referenceID(0), referenceName(0), lgrType(R_NOT_LGR), lgrGridType(R_STRUCTURED_CPG), parentILowBound(0),
      parentICount(0), parentJLowBound(0), parentJCount(0), parentKLowBound(0), parentKCount(0), parentGeometry(0),
      lgrs(new cSetRescueGeometry()), xWeightLength(0), xWeight(0), yWeightLength(0), yWeight(0), zWeightLength(0),
      zWeight(0), parametricMap(0), isds(new cSetRescueInterfaceSurfaceDesc()), unstructuredGrid(0), radialGrid(0),
      minX(0), maxX(0), minY(0), maxY(0), minZ(0), maxZ(0), propertyContainers(0), propertyContainerId(0),
      lgrSetName(0), lgrStartTime(0), lgrEndTime(0) {
  isA = R_RescueGeometry;
  surfaceCell = new cSetRescueSurfaceCell();
  geometryUnit = new cSetRescueGeometryUnit();
  properties = new cSetRescueProperty();
...
RescueGeometry::RescueGeometry(RescueGeometry *parentGrid, RESCUEINT64 referenceIDin, RESCUEINT64 parentILowBoundin,
                               RESCUEINT64 parentICountin, RESCUEINT64 refinedILowBoundin, RESCUEINT64 refinedICountin,
                               RESCUEINT64 parentJLowBoundin, RESCUEINT64 parentJCountin,
                               RESCUEINT64 refinedJLowBoundin, RESCUEINT64 refinedJCountin,
                               RESCUEINT64 parentKLowBoundin, RESCUEINT64 parentKCountin,
                               RESCUEINT64 refinedKLowBoundin, RESCUEINT64 refinedKCountin)
    : RescueHistoryObject(parentGrid->ParentModel()->Context()), missingValue(parentGrid->MissingValue()),
      parentModel(parentGrid->ParentModel()), referenceSurface1(0), referenceSurface2(0), thickness(0),
      onOffLap(R_ONLAP), surfaceCell(0), wellboreCell(0), surfaceToGrid(0), stairSteps(0), geometryUnit(0),
      properties(0), hasChanged(TRUE), dirtyMinMax(TRUE), loaded(TRUE), color(0), parentBlockUnit(0),
      parentGeobodyPart(0)

      ,
      referenceID(referenceIDin), referenceName(0), lgrType(R_RULE_BASED), lgrGridType(R_STRUCTURED_CPG),
      parentILowBound(parentILowBoundin), parentICount(parentICountin), parentJLowBound(parentJLowBoundin),
      parentJCount(parentJCountin), parentKLowBound(parentKLowBoundin), parentKCount(parentKCountin),
      parentGeometry(parentGrid), lgrs(new cSetRescueGeometry()), xWeightLength(0), xWeight(0), yWeightLength(0),
      yWeight(0), zWeightLength(0), zWeight(0), parametricMap(0), isds(new cSetRescueInterfaceSurfaceDesc()),
      unstructuredGrid(0), radialGrid(0), minX(0), maxX(0), minY(0), maxY(0), minZ(0), maxZ(0), propertyContainers(0),
      propertyContainerId(0), lgrSetName(0), lgrStartTime(0), lgrEndTime(0) {
  (*parentGeometry->lgrs) += this;
  RescueContext *context = parentGrid->ParentModel()->Context();
  grid = new RescueGrid(context, parentGrid->Grid()->DisplayOrientation(), refinedILowBoundin, refinedICountin,
                        refinedJLowBoundin, refinedJCountin, refinedKLowBoundin, refinedKCountin);
  isA = R_RescueGeometry;
  surfaceCell = new cSetRescueSurfaceCell();
  geometryUnit = new cSetRescueGeometryUnit();
  properties = new cSetRescueProperty();
...
RescueGeometry::RescueGeometry(RescueGeometry *parentGrid, RESCUEINT32 referenceIDin, RESCUEINT32 parentILowBoundin,
                               RESCUEINT32 parentICountin, RESCUEINT32 refinedILowBoundin, RESCUEINT32 refinedICountin,
                               RESCUEINT32 parentJLowBoundin, RESCUEINT32 parentJCountin,
                               RESCUEINT32 refinedJLowBoundin, RESCUEINT32 refinedJCountin,
                               RESCUEINT32 parentKLowBoundin, RESCUEINT32 parentKCountin,
                               RESCUEINT32 refinedKLowBoundin, RESCUEINT32 refinedKCountin)
    : RescueHistoryObject(parentGrid->ParentModel()->Context()), missingValue(parentGrid->MissingValue()),
      parentModel(parentGrid->ParentModel()), referenceSurface1(0), referenceSurface2(0), thickness(0),
      onOffLap(R_ONLAP), surfaceCell(0), wellboreCell(0), surfaceToGrid(0), stairSteps(0), geometryUnit(0),
      properties(0), hasChanged(TRUE), dirtyMinMax(TRUE), loaded(TRUE), color(0), parentBlockUnit(0),
      parentGeobodyPart(0), referenceID(referenceIDin), referenceName(0), lgrType(R_RULE_BASED),
      lgrGridType(R_STRUCTURED_CPG), parentILowBound(parentILowBoundin), parentICount(parentICountin),
      parentJLowBound(parentJLowBoundin), parentJCount(parentJCountin), parentKLowBound(parentKLowBoundin),
      parentKCount(parentKCountin), parentGeometry(parentGrid), lgrs(new cSetRescueGeometry()), xWeightLength(0),
      xWeight(0), yWeightLength(0), yWeight(0), zWeightLength(0), zWeight(0)

      ,
      parametricMap(0), isds(new cSetRescueInterfaceSurfaceDesc()), unstructuredGrid(0), radialGrid(0)
...
RescueGeometry::RescueGeometry(RescueGeometry *parentGrid, RESCUEINT64 referenceIDin, RESCUEINT64 parentILowBoundin,
                               RESCUEINT64 parentICountin, RESCUEINT64 *refinedICountArrayin,
                               RESCUEINT64 parentJLowBoundin, RESCUEINT64 parentJCountin,
                               RESCUEINT64 *refinedJCountArrayin, RESCUEINT64 parentKLowBoundin,
                               RESCUEINT64 parentKCountin, RESCUEINT64 *refinedKCountArrayin)
    : RescueHistoryObject(parentGrid->ParentModel()->Context()), missingValue(parentGrid->MissingValue()),
      parentModel(parentGrid->ParentModel()), referenceSurface1(0), referenceSurface2(0), thickness(0),
      onOffLap(R_ONLAP), surfaceCell(0), wellboreCell(0), surfaceToGrid(0), stairSteps(0), geometryUnit(0),
      properties(0), hasChanged(TRUE), dirtyMinMax(TRUE), loaded(TRUE), color(0), parentBlockUnit(0),
      ...
      ,
      referenceID(referenceIDin), referenceName(0), lgrType(R_RULE_BASED_NOSPAN), lgrGridType(R_STRUCTURED_CPG),
      parentILowBound(parentILowBoundin), parentICount(parentICountin), parentJLowBound(parentJLowBoundin),
      parentJCount(parentJCountin), parentKLowBound(parentKLowBoundin), parentKCount(parentKCountin),
      parentGeometry(parentGrid), lgrs(new cSetRescueGeometry()), xWeightLength(1), xWeight(0), yWeightLength(1),
      yWeight(0), zWeightLength(1), zWeight(0), parametricMap(0), isds(new cSetRescueInterfaceSurfaceDesc()),
      unstructuredGrid(0), radialGrid(0), minX(0), maxX(0), minY(0), maxY(0), minZ(0), maxZ(0), propertyContainers(0),
      propertyContainerId(0), lgrSetName(0), lgrStartTime(0), lgrEndTime(0) {
  (*parentGeometry->lgrs) += this;
  RescueContext *context = parentGrid->ParentModel()->Context();
  ...
  grid = new RescueGrid(context, parentGrid->Grid()->DisplayOrientation(), parentILowBound, xWeightLength,
                        parentJLowBound, yWeightLength, parentKLowBound, zWeightLength);
...
RescueGeometry::RescueGeometry(RescueGeometry *parentGrid, RESCUEINT32 referenceIDin, RESCUEINT32 parentILowBoundin,
                               RESCUEINT32 parentICountin, RESCUEINT32 *refinedICountArrayin,
                               RESCUEINT32 parentJLowBoundin, RESCUEINT32 parentJCountin,
                               RESCUEINT32 *refinedJCountArrayin, RESCUEINT32 parentKLowBoundin,
                               RESCUEINT32 parentKCountin, RESCUEINT32 *refinedKCountArrayin)
    : RescueHistoryObject(parentGrid->ParentModel()->Context()), missingValue(parentGrid->MissingValue()),
      parentModel(parentGrid->ParentModel()), referenceSurface1(0), referenceSurface2(0), thickness(0),
      onOffLap(R_ONLAP), surfaceCell(0), wellboreCell(0), surfaceToGrid(0), stairSteps(0), geometryUnit(0),
      properties(0), hasChanged(TRUE), dirtyMinMax(TRUE), loaded(TRUE), color(0), parentBlockUnit(0),
...
RescueGeometry::RescueGeometry(RescueGeometry *parentGrid, RESCUEINT64 referenceIDin, RESCUEINT64 xLowBoundin,
                               RESCUEDOUBLE *xWeightsIn, RESCUEINT64 xWeightLengthIn, RESCUEINT64 yLowBoundin,
                               RESCUEDOUBLE *yWeightsIn, RESCUEINT64 yWeightLengthIn, RESCUEINT64 zLowBoundin,
                               RESCUEDOUBLE *zWeightsIn, RESCUEINT64 zWeightLengthIn)
    : RescueHistoryObject(parentGrid->ParentModel()->Context()), missingValue(parentGrid->MissingValue()),
      parentModel(parentGrid->ParentModel()), referenceSurface1(0), referenceSurface2(0), thickness(0),
      onOffLap(R_ONLAP), surfaceCell(0), wellboreCell(0), surfaceToGrid(0), stairSteps(0), geometryUnit(0),
      properties(0), hasChanged(TRUE), dirtyMinMax(TRUE), loaded(TRUE), color(0), parentBlockUnit(0),
      ...
      ,
      referenceID(referenceIDin), referenceName(0), lgrType(R_WEIGHT_BASED), lgrGridType(R_STRUCTURED_CPG),
      parentILowBound(0), parentICount(0), parentJLowBound(0), parentJCount(0), parentKLowBound(0), parentKCount(0),
      parentGeometry(parentGrid), lgrs(new cSetRescueGeometry()), xWeightLength(xWeightLengthIn), xWeight(0),
      yWeightLength(yWeightLengthIn), yWeight(0), zWeightLength(zWeightLengthIn), zWeight(0), parametricMap(0),
      isds(new cSetRescueInterfaceSurfaceDesc()), unstructuredGrid(0), radialGrid(0)
  ...
  (*parentGeometry->lgrs) += this;
  RescueContext *context = parentGrid->ParentModel()->Context();
  grid = new RescueGrid(context, parentGrid->Grid()->DisplayOrientation(), xLowBoundin, xWeightLength, yLowBoundin,
                        yWeightLength, zLowBoundin, zWeightLength);
  isA = R_RescueGeometry;
  surfaceCell = new cSetRescueSurfaceCell();
  geometryUnit = new cSetRescueGeometryUnit();
  properties = new cSetRescueProperty();
...
RescueGeometry::RescueGeometry(RescueGeometry *parentGrid, RESCUEINT32 referenceIDin, RESCUEINT32 xLowBoundin,
                               RESCUEDOUBLE *xWeightsIn, RESCUEINT32 xWeightLengthIn, RESCUEINT32 yLowBoundin,
                               RESCUEDOUBLE *yWeightsIn, RESCUEINT32 yWeightLengthIn, RESCUEINT32 zLowBoundin,
                               RESCUEDOUBLE *zWeightsIn, RESCUEINT32 zWeightLengthIn)
    : RescueHistoryObject(parentGrid->ParentModel()->Context()), missingValue(parentGrid->MissingValue()),
      parentModel(parentGrid->ParentModel()), referenceSurface1(0), referenceSurface2(0), thickness(0),
      onOffLap(R_ONLAP), surfaceCell(0), wellboreCell(0), surfaceToGrid(0), stairSteps(0), geometryUnit(0),
      properties(0), hasChanged(TRUE), dirtyMinMax(TRUE), loaded(TRUE), color(0), parentBlockUnit(0),
      ...
      parentGeometry(parentGrid), lgrs(new cSetRescueGeometry()), xWeightLength(xWeightLengthIn), xWeight(0),
      yWeightLength(yWeightLengthIn), yWeight(0), zWeightLength(zWeightLengthIn), zWeight(0), parametricMap(0),
      isds(new cSetRescueInterfaceSurfaceDesc()), unstructuredGrid(0), radialGrid(0), minX(0), maxX(0), minY(0),
      maxY(0), minZ(0), maxZ(0), propertyContainers(0), propertyContainerId(0), lgrSetName(0), lgrStartTime(0),
      lgrEndTime(0) {
  xWeight = new RESCUEDOUBLE[(size_t)xWeightLength];
  memcpy(xWeight, xWeightsIn, sizeof(RESCUEDOUBLE) * (int)xWeightLength);
  yWeight = new RESCUEDOUBLE[(size_t)yWeightLength];
...
RescueGeometry::RescueGeometry(RescueGeometry *parentGrid, RESCUEINT64 referenceIDin, RESCUEINT64 parentILowBoundin,
                               RESCUEINT64 parentICountin, RESCUEINT64 *xWeightLengthin, RESCUEDOUBLE **xWeightsin,
                               RESCUEINT64 parentJLowBoundin, RESCUEINT64 parentJCountin, RESCUEINT64 *yWeightLengthin,
                               RESCUEDOUBLE **yWeightsin, RESCUEINT64 parentKLowBoundin, RESCUEINT64 parentKCountin,
                               RESCUEINT64 *zWeightLengthin, RESCUEDOUBLE **zWeightsin)
    : RescueHistoryObject(parentGrid->ParentModel()->Context()), missingValue(parentGrid->MissingValue()),
      parentModel(parentGrid->ParentModel()), referenceSurface1(0), referenceSurface2(0), thickness(0),
      onOffLap(R_ONLAP), surfaceCell(0), wellboreCell(0), surfaceToGrid(0), stairSteps(0), geometryUnit(0),
      properties(0), hasChanged(TRUE), dirtyMinMax(TRUE), loaded(TRUE), color(0), parentBlockUnit(0),
      ...
      ,
      referenceID(referenceIDin), referenceName(0), lgrType(R_WEIGHT_BASED_NOSPAN), lgrGridType(R_STRUCTURED_CPG),
      parentILowBound(parentILowBoundin), parentICount(parentICountin), parentJLowBound(parentJLowBoundin),
      parentJCount(parentJCountin), parentKLowBound(parentKLowBoundin), parentKCount(parentKCountin),
      parentGeometry(parentGrid), lgrs(new cSetRescueGeometry()), xWeightLength(1), xWeight(0), yWeightLength(1),
      yWeight(0), zWeightLength(1), zWeight(0), parametricMap(0), isds(new cSetRescueInterfaceSurfaceDesc()),
  ...
  grid = new RescueGrid(context, parentGrid->Grid()->DisplayOrientation(), 0, xWeightLength, 0, yWeightLength, 0,
                        zWeightLength);
  isA = R_RescueGeometry;
  surfaceCell = new cSetRescueSurfaceCell();
  geometryUnit = new cSetRescueGeometryUnit();
...
RescueGeometry::RescueGeometry(RescueGeometry *parentGrid, RESCUEINT32 referenceIDin, RESCUEINT32 parentILowBoundin,
                               RESCUEINT32 parentICountin, RESCUEINT32 *xWeightLengthin, RESCUEDOUBLE **xWeightsin,
                               RESCUEINT32 parentJLowBoundin, RESCUEINT32 parentJCountin, RESCUEINT32 *yWeightLengthin,
                               RESCUEDOUBLE **yWeightsin, RESCUEINT32 parentKLowBoundin, RESCUEINT32 parentKCountin,
                               RESCUEINT32 *zWeightLengthin, RESCUEDOUBLE **zWeightsin)
    : RescueHistoryObject(parentGrid->ParentModel()->Context()), missingValue(parentGrid->MissingValue()),
      parentModel(parentGrid->ParentModel()), referenceSurface1(0), referenceSurface2(0), thickness(0),
      onOffLap(R_ONLAP), surfaceCell(0), wellboreCell(0), surfaceToGrid(0), stairSteps(0), geometryUnit(0),
      properties(0), hasChanged(TRUE), dirtyMinMax(TRUE), loaded(TRUE), color(0), parentBlockUnit(0),
...
RescueGeometry::RescueGeometry(RescueGeometry *parentGrid, RESCUEINT64 referenceIDIn, RescueGrid *existingGrid,
                               RESCUEFLOAT missingValueIn)
    : RescueHistoryObject(parentGrid->ParentModel()->Context()), grid(existingGrid), missingValue(missingValueIn),
      parentModel(parentGrid->ParentModel()), surfaceCell(0), wellboreCell(0), surfaceToGrid(0), stairSteps(0),
      geometryUnit(0), properties(0), hasChanged(TRUE), dirtyMinMax(TRUE), loaded(TRUE), color(0), parentBlockUnit(0),
      parentGeobodyPart(0), referenceID(referenceIDIn), referenceName(0), lgrType(R_UNCONSTRAINED),
      lgrGridType(R_STRUCTURED_CPG), parentILowBound(0), parentICount(0), parentJLowBound(0), parentJCount(0),
      parentKLowBound(0), parentKCount(0), parentGeometry(parentGrid), lgrs(new cSetRescueGeometry()), xWeightLength(0),
      xWeight(0), yWeightLength(0), yWeight(0), zWeightLength(0), zWeight(0), parametricMap(0),
      isds(new cSetRescueInterfaceSurfaceDesc()), unstructuredGrid(0), radialGrid(0), minX(0), maxX(0), minY(0),
      maxY(0), minZ(0), maxZ(0), propertyContainers(0), propertyContainerId(0), lgrSetName(0), lgrStartTime(0),
      lgrEndTime(0) {
  isA = R_RescueGeometry;
...
RescueGeometry::RescueGeometry(RescueGeometry *parentGrid, RESCUEINT32 referenceIDIn, RescueGrid *existingGrid,
                               RESCUEFLOAT missingValueIn)
    : RescueHistoryObject(parentGrid->ParentModel()->Context()), grid(existingGrid), missingValue(missingValueIn),
      parentModel(parentGrid->ParentModel()), surfaceCell(0), wellboreCell(0), surfaceToGrid(0), stairSteps(0),
      geometryUnit(0), properties(0), hasChanged(TRUE), dirtyMinMax(TRUE), loaded(TRUE), color(0), parentBlockUnit(0),
...
RescueGeometry::RescueGeometry(RescueGeometry *parentGrid, RESCUEINT64 referenceIDIn, RescueLGRGridType gridType,
                               RESCUEINT64 expectedVertexCount, RESCUEINT64 expectedFaceCount,
                               RESCUEINT64 expectedFaceVertexTuples, RESCUEINT64 expectedCellCount,
                               RESCUEINT64 expectedCellFaceTuples, RESCUEINT64 expectedVertexRealloc,
                               RESCUEINT64 expectedFaceRealloc, RESCUEINT64 expectedFaceVertexRealloc,
                               RESCUEINT64 expectedCellRealloc, RESCUEINT64 expectedCellFaceRealloc)
    : RescueHistoryObject(parentGrid->ParentModel()->Context()), grid(0), missingValue(0),
      parentModel(parentGrid->ParentModel()), surfaceCell(0), wellboreCell(0), surfaceToGrid(0), stairSteps(0),
      geometryUnit(0), properties(0), hasChanged(TRUE), dirtyMinMax(TRUE), loaded(TRUE), color(0), parentBlockUnit(0),
      parentGeobodyPart(0)

      ,
      referenceID(referenceIDIn), referenceName(0), lgrType(R_UNCONSTRAINED), lgrGridType(gridType), parentILowBound(0),
      parentICount(0), parentJLowBound(0), parentJCount(0), parentKLowBound(0), parentKCount(0),
      parentGeometry(parentGrid), lgrs(new cSetRescueGeometry()), xWeightLength(0), xWeight(0), yWeightLength(0),
      yWeight(0), zWeightLength(0), zWeight(0), parametricMap(0), isds(new cSetRescueInterfaceSurfaceDesc()),
      unstructuredGrid(0), radialGrid(0), minX(0), maxX(0), minY(0), maxY(0), minZ(0), maxZ(0), propertyContainers(0),
      propertyContainerId(0), lgrSetName(0), lgrStartTime(0), lgrEndTime(0) {
  ...
  unstructuredGrid =
      new RescueUnstructuredGrid(this, expectedVertexCount, expectedFaceCount, expectedFaceVertexTuples,
                                 expectedCellCount, expectedCellFaceTuples, expectedVertexRealloc, expectedFaceRealloc,
                                 expectedFaceVertexRealloc, expectedCellRealloc, expectedCellFaceRealloc);
}

RescueGeometry::RescueGeometry(RescueGeometry *parentGrid, RESCUEINT64 parentILowBoundIn, RESCUEINT64 parentICountIn,
                               RESCUEINT64 parentJLowBoundIn, RESCUEINT64 parentJCountIn, RESCUEINT64 parentKLowBoundIn,
                               RESCUEINT64 parentKCountIn, RESCUEINT64 referenceIDIn, RescueLGRGridType gridType,
                               RESCUEINT64 expectedVertexCount, RESCUEINT64 expectedFaceCount,
                               RESCUEINT64 expectedFaceVertexTuples, RESCUEINT64 expectedCellCount,
                               RESCUEINT64 expectedCellFaceTuples, RESCUEINT64 expectedVertexRealloc,
                               RESCUEINT64 expectedFaceRealloc, RESCUEINT64 expectedFaceVertexRealloc,
    ...
    : RescueHistoryObject(parentGrid->ParentModel()->Context()), grid(0), missingValue(0),
      ...
      geometryUnit(0), properties(0), hasChanged(TRUE), dirtyMinMax(TRUE), loaded(TRUE), color(0), parentBlockUnit(0),
      parentGeobodyPart(0), referenceID(referenceIDIn), referenceName(0), lgrType(R_UNCONSTRAINED),
      lgrGridType(gridType), parentILowBound(parentILowBoundIn), parentICount(parentICountIn),
      parentJLowBound(parentJLowBoundIn), parentJCount(parentJCountIn), parentKLowBound(parentKLowBoundIn),
      parentKCount(parentKCountIn), parentGeometry(parentGrid), lgrs(new cSetRescueGeometry()), xWeightLength(0),
      xWeight(0), yWeightLength(0), yWeight(0), zWeightLength(0), zWeight(0), parametricMap(0),
      isds(new cSetRescueInterfaceSurfaceDesc()), unstructuredGrid(0), radialGrid(0), minX(0), maxX(0), minY(0),
...
RescueGeometry::RescueGeometry(RescueGeometry *parentGrid, RESCUEINT64 referenceIDIn)
    : RescueHistoryObject(parentGrid->ParentModel()->Context()), grid(0), missingValue(0),
      parentModel(parentGrid->ParentModel()), surfaceCell(0), wellboreCell(0), surfaceToGrid(0), stairSteps(0),
      geometryUnit(0), properties(0), hasChanged(TRUE), dirtyMinMax(TRUE), loaded(TRUE), color(0), parentBlockUnit(0),
      parentGeobodyPart(0), referenceID(referenceIDIn), referenceName(0), lgrType(R_UNCONSTRAINED),
      lgrGridType(R_STRUCTURED_RADIAL), parentILowBound(0), parentICount(0), parentJLowBound(0), parentJCount(0),
      parentKLowBound(0), parentKCount(0), parentGeometry(parentGrid), lgrs(new cSetRescueGeometry()), xWeightLength(0),
      xWeight(0), yWeightLength(0), yWeight(0), zWeightLength(0), zWeight(0), parametricMap(0),
      isds(new cSetRescueInterfaceSurfaceDesc()), unstructuredGrid(0), radialGrid(0), minX(0), maxX(0), minY(0),
      maxY(0), minZ(0), maxZ(0), propertyContainers(0), propertyContainerId(0), lgrSetName(0), lgrStartTime(0),
...
RescueGeometry::RescueGeometry(RescueGeometry *parentGrid, RESCUEINT64 parentILowBoundIn, RESCUEINT64 parentICountIn,
                               RESCUEINT64 parentJLowBoundIn, RESCUEINT64 parentJCountIn, RESCUEINT64 parentKLowBoundIn,
                               RESCUEINT64 parentKCountIn, RESCUEINT64 referenceIDIn)
    : RescueHistoryObject(parentGrid->ParentModel()->Context()), grid(0), missingValue(0),
      parentModel(parentGrid->ParentModel()), surfaceCell(0), wellboreCell(0), surfaceToGrid(0), stairSteps(0),
      geometryUnit(0), properties(0), hasChanged(TRUE), dirtyMinMax(TRUE), loaded(TRUE), color(0), parentBlockUnit(0),
      parentGeobodyPart(0), referenceID(referenceIDIn), referenceName(0), lgrType(R_UNCONSTRAINED),
      lgrGridType(R_STRUCTURED_RADIAL), parentILowBound(parentILowBoundIn), parentICount(parentICountIn),
      parentJLowBound(parentJLowBoundIn), parentJCount(parentJCountIn)

      ,
      parentKLowBound(parentKLowBoundIn), parentKCount(parentKCountIn), parentGeometry(parentGrid),
      lgrs(new cSetRescueGeometry()), xWeightLength(0), xWeight(0), yWeightLength(0), yWeight(0), zWeightLength(0),
      zWeight(0), parametricMap(0), isds(new cSetRescueInterfaceSurfaceDesc()), unstructuredGrid(0), radialGrid(0),
      minX(0), maxX(0), minY(0), maxY(0), minZ(0), maxZ(0), propertyContainers(0), propertyContainerId(0),
      lgrSetName(0), lgrStartTime(0), lgrEndTime(0) {
...
RESCUEINT32 RescueGeometry::LGRCount() { return lgrs->Count(); }

RESCUEINT64 RescueGeometry::LGRCount64() { return lgrs->Count64(); }

RescueGeometry *RescueGeometry::NthLGR(RESCUEINT64 zeroBasedOrdinal) { return lgrs->NthObject(zeroBasedOrdinal); }
...
RescueGeometry::RescueGridType RescueGeometry::GeometryType() {
  if (VertexIs() == R_EQUAL_AXIS || VertexIs() == R_UNEQUAL_AXIS) {
    return R_XY_ORTHOGONAL;
  } else {
    RescueGridType myReturn = R_CONFORMABLE;
    if (VertexIs() == R_COORDINATE_LINE || VertexIs() == R_COORDINATE_POLYLINE) {
...
void RescueGeometry::SetCoordinateLine(RESCUEINT64 i, RESCUEINT64 j, RESCUEFLOAT xTop, RESCUEFLOAT yTop,
                                       RESCUEFLOAT zTop, RESCUEFLOAT xBottom, RESCUEFLOAT yBottom, RESCUEFLOAT zBottom,
                                       RESCUEFLOAT *middleZvalues) {
  if (lgrType == R_RULE_BASED || lgrType == R_WEIGHT_BASED || lgrType == R_RULE_BASED_NOSPAN ||
  ...
  *object = new RescueCoordinateLine(this, xTop, yTop, zTop, xBottom, yBottom, zBottom, middleZvalues);
  if (vertexIs == R_EQUAL_AXIS || vertexIs == R_UNEQUAL_AXIS) {
    vertexIs = R_COORDINATE_LINE;
  }
}

RescueGeometryObject **RescueGeometry::PromoteToSplitLine(RESCUEINT64 i, RESCUEINT64 j, RESCUEINT64 k,
                                                          RESCUEINT64 corner) {
  ...
  if (*object == 0) {
    ...
    *object = new RescueSplitLine(this, grid->Axis(0)->ValueAt(iPrime), grid->Axis(1)->ValueAt(jPrime),
                                  grid->Axis(2)->Step(), grid->Axis(2)->Origin());
...
void RescueGeometry::SetCornerNode(RESCUEINT64 i, RESCUEINT64 j, RESCUEINT64 k, RESCUEINT64 corner, RESCUEFLOAT x,
...
void RescueGeometry::UVWValues(RESCUEDOUBLE i, RESCUEDOUBLE j, RESCUEDOUBLE k, RESCUEDOUBLE &uTerm, RESCUEDOUBLE &vTerm,
                               RESCUEDOUBLE &wTerm) {
  if (lgrType == R_RULE_BASED || lgrType == R_WEIGHT_BASED || lgrType == R_RULE_BASED_NOSPAN ||
      lgrType == R_WEIGHT_BASED_NOSPAN) {
    if (parentGeometry == 0) {
      ...
      case R_RULE_BASED: {
        if (xAxis->Count64() > 1) {
          uTerm = (RESCUEDOUBLE)parentILowBound +
                  (((RESCUEDOUBLE)(parentICount - 1) / (RESCUEDOUBLE)(xAxis->Count64() - 1)) * i);
        } else {
          uTerm = (RESCUEDOUBLE)parentILowBound;
        }
        if (yAxis->Count64() > 1) {
          vTerm = (RESCUEDOUBLE)parentJLowBound +
                  (((RESCUEDOUBLE)(parentJCount - 1) / (RESCUEDOUBLE)(yAxis->Count64() - 1)) * j);
        } else {
          vTerm = (RESCUEDOUBLE)parentJLowBound;
        }
        if (zAxis->Count64() > 1) {
          wTerm = (RESCUEDOUBLE)parentKLowBound +
                  (((RESCUEDOUBLE)(parentKCount - 1) / (RESCUEDOUBLE)(zAxis->Count64() - 1)) * k);
        } else {
          wTerm = (RESCUEDOUBLE)parentKLowBound;
        }
      } break;
...
void RescueGeometry::UVWValues(RESCUEINT32 i, RESCUEINT32 j, RESCUEINT32 k, RESCUEDOUBLE &uTerm, RESCUEDOUBLE &vTerm,
                               RESCUEDOUBLE &wTerm) {
  UVWValues((RESCUEINT64)i, (RESCUEINT64)j, (RESCUEINT64)k, uTerm, vTerm, wTerm);
}

void RescueGeometry::UVWValues(RESCUEINT64 i, RESCUEINT64 j, RESCUEINT64 k, RESCUEDOUBLE &uTerm, RESCUEDOUBLE &vTerm,
                               RESCUEDOUBLE &wTerm) {
  if (lgrType == R_RULE_BASED || lgrType == R_WEIGHT_BASED || lgrType == R_RULE_BASED_NOSPAN ||
      lgrType == R_WEIGHT_BASED_NOSPAN) {
    if (parentGeometry == 0) {
      ...
      case R_RULE_BASED: {
        if (xAxis->Count64() > 1) {
          uTerm = (RESCUEDOUBLE)parentILowBound +
                  (((RESCUEDOUBLE)(parentICount - 1) / (RESCUEDOUBLE)(xAxis->Count64() - 1)) * (RESCUEDOUBLE)i);
        } else {
          uTerm = (RESCUEDOUBLE)parentILowBound;
        }
        if (yAxis->Count64() > 1) {
          vTerm = (RESCUEDOUBLE)parentJLowBound +
                  (((RESCUEDOUBLE)(parentJCount - 1) / (RESCUEDOUBLE)(yAxis->Count64() - 1)) * (RESCUEDOUBLE)j);
        } else {
          vTerm = (RESCUEDOUBLE)parentJLowBound;
        }
        if (zAxis->Count64() > 1) {
          wTerm = (RESCUEDOUBLE)parentKLowBound +
                  (((RESCUEDOUBLE)(parentKCount - 1) / (RESCUEDOUBLE)(zAxis->Count64() - 1)) * (RESCUEDOUBLE)k);
        } else {
          wTerm = (RESCUEDOUBLE)parentKLowBound;
        }
      } break;
...
RESCUEBOOL RescueGeometry::Values(RESCUEDOUBLE u, RESCUEDOUBLE v, RESCUEDOUBLE w, RESCUEFLOAT &x, RESCUEFLOAT &y,
                                  RESCUEFLOAT &z) {
  if (lgrType == R_RULE_BASED || lgrType == R_WEIGHT_BASED || lgrType == R_RULE_BASED_NOSPAN ||
      lgrType == R_WEIGHT_BASED_NOSPAN) {
  ...
  for (cLoop = 0; cLoop < 8; cLoop++)
  {
    ...
    */
    for (cLoop = 0; cLoop < 8; cLoop++) {
      if (corners[cLoop][0] == missingValue || corners[cLoop][1] == missingValue || corners[cLoop][2] == missingValue) {
        if (iFrac == 0.0 && (cLoop == 1 || cLoop == 2 || cLoop == 5 || cLoop == 6)) {
          RESCUEINT64 alt = 0;
          switch (cLoop) {
          case 2:
            alt = 3;
...
RESCUEBOOL RescueGeometry::Values(RESCUEINT32 i, RESCUEINT32 j, RESCUEINT32 k, RESCUEFLOAT &x, RESCUEFLOAT &y,
                                  RESCUEFLOAT &z) {
  return Values((RESCUEINT64)i, (RESCUEINT64)j, (RESCUEINT64)k, x, y, z);
}

RESCUEBOOL RescueGeometry::Values(RESCUEINT64 i, RESCUEINT64 j, RESCUEINT64 k, RESCUEFLOAT &x, RESCUEFLOAT &y,
                                  RESCUEFLOAT &z) {
  if (lgrType == R_RULE_BASED || lgrType == R_WEIGHT_BASED || lgrType == R_RULE_BASED_NOSPAN ||
      lgrType == R_WEIGHT_BASED_NOSPAN) {
    RESCUEDOUBLE uTerm, vTerm, wTerm;
...
void RescueGeometry::Values(RESCUEINT32 i, RESCUEINT32 j, RESCUEINT32 k, RESCUEINT32 corner, RESCUEFLOAT &x,
                            RESCUEFLOAT &y, RESCUEFLOAT &z) {
  Values((RESCUEINT64)i, (RESCUEINT64)j, (RESCUEINT64)k, (RESCUEINT64)corner, x, y, z);
}

void RescueGeometry::Values(RESCUEINT64 i, RESCUEINT64 j, RESCUEINT64 k, RESCUEINT64 corner, RESCUEFLOAT &x,
                            RESCUEFLOAT &y, RESCUEFLOAT &z) {
  if (lgrType == R_RULE_BASED || lgrType == R_WEIGHT_BASED || lgrType == R_RULE_BASED_NOSPAN ||
      lgrType == R_WEIGHT_BASED_NOSPAN) {
...
void RescueGeometry::LayerCornerValues(RESCUEINT64 kLayer, RESCUEFLOAT *buffer, RESCUEINT64 offset,
...
void RescueGeometry::CornerValuesPrimitive(RESCUEINT64 kLayer, RESCUEBOOL layerValid, RESCUEFLOAT *buffer,
                                           RESCUEINT64 offset, RESCUEINT64 bufferLength) {
  if (lgrGridType != R_STRUCTURED_CPG) {
    throw "Illegal attempt to read geometry of non-CPG LGR";
  }
  ...
  for (loop = 0; loop < count; loop++) {
    ...
    if (axis->AxisIndex() == RescueGridAxis::I_AXIS) {
      ...
      nj = nodes;
    } else if (axis->AxisIndex() == RescueGridAxis::K_AXIS && layerValid == FALSE) {
      nk = nodes;
    }
  }
...
void RescueGeometry::RefinedCountArray(RescueGridAxis::GridNdx axis, RESCUEINT32 *buffer, RESCUEINT32 offset,
                                       RESCUEINT32 bufferLen) {
...
void RescueGeometry::RefinedCountArray(RescueGridAxis::GridNdx axis, RESCUEINT64 *buffer, RESCUEINT64 offset,
                                       RESCUEINT64 bufferLen) {
...
void RescueGeometry::WeightFor(RescueGridAxis::GridNdx axis, RESCUEINT64 iNdx, RESCUEDOUBLE *buffer, RESCUEINT64 offset,
                               RESCUEINT64 bufferLen) {
...
void RescueGeometry::Weight(RescueGridAxis::GridNdx ndx, RESCUEDOUBLE *buffer, RESCUEINT64 offset,
                            RESCUEINT64 bufferLength) {
  switch (ndx) {
  case RescueGridAxis::I_AXIS:
...
RESCUEINT64 RescueGeometry::AllCornerValuesLength64() { return Grid()->NodeCount(TRUE) * 8 * 3; }
...
RESCUEINT64 RescueGeometry::LayerCornerValuesLength64() {
  ...
  for (loop = 0; loop < count; loop++) {
    RescueGridAxis *axis = Grid()->Axis(loop);
    if (axis->AxisIndex() == RescueGridAxis::I_AXIS || axis->AxisIndex() == RescueGridAxis::J_AXIS) {
      RESCUEINT64 nodes = axis->Count64();
      if (nodes > 1) {
        nodes--;
      }
...
void RescueGeometry::CellToNode(RESCUEINT32 i, RESCUEINT32 j, RESCUEINT32 k, RESCUEINT32 corner, RESCUEINT32 &i2,
                                RESCUEINT32 &j2, RESCUEINT32 &k2) {
  RESCUEINT64 i64;
  RESCUEINT64 j64;
  RESCUEINT64 k64;
...
void RescueGeometry::CellToNode(RESCUEINT64 i, RESCUEINT64 j, RESCUEINT64 k, RESCUEINT64 corner, RESCUEINT64 &i2,
                                RESCUEINT64 &j2, RESCUEINT64 &k2) {
  i2 = i;
  j2 = j;
  k2 = k;
  if (corner > 3) {
...
void RescueGeometry::SetStairSteppedSurface(RescueIJSurface *surface, RescueIJKCellPair *cellPairs,
...
void RescueGeometry::SetSurfaceIntersection(RescueIJSurface *surface, RESCUEINT32 *iList, RESCUEINT32 *jList,
                                            RESCUEINT32 listLength) {
  EnsureLoaded();
  RescueSurfaceToGrid *current = IntersectionFor(surface);
  if (current == 0) {
    if (listLength > 0) {
      (*surfaceToGrid) +=
          new RescueSurfaceToGrid(this, surface, RescueContext::Allocate64For32(iList, listLength, true),
                                  RescueContext::Allocate64For32(jList, listLength, true), listLength);
      /*
...
void RescueGeometry::SetSurfaceIntersection(RescueIJSurface *surface, RESCUEINT64 *iList, RESCUEINT64 *jList,
...
void RescueGeometry::SetSurfaceIntersection(RescueIJSurface *surface, RescueSurfaceCell::SurfaceSide side,
                                            RESCUEINT64 i, RESCUEINT64 j, RESCUEINT64 k, RESCUEINT64 cellFaceNumber,
                                            RESCUEFLOAT *uvs) {
  EnsureLoaded();
  RESCUEINT64 maxI = grid->Axis(0)->Count64();
  RESCUEINT64 maxJ = grid->Axis(1)->Count64();
  RESCUEINT64 cellNumber = (k * (maxI * maxJ)) + (j * maxI) + i;
  (*surfaceCell) += new RescueSurfaceCell(this, surface, cellNumber, cellFaceNumber, side, uvs);
  /*
    Constructor will hook it up on the surface side.
  */
}

void RescueGeometry::SetWellboreIntersection(RescueWellbore *wellbore, RESCUEINT64 i, RESCUEINT64 j, RESCUEINT64 k) {
  RESCUEINT64 maxI = grid->Axis(0)->Count64();
  RESCUEINT64 maxJ = grid->Axis(1)->Count64();
  RESCUEINT64 cellNumber = (k * (maxI * maxJ)) + (j * maxI) + i;
...
void RescueGeometry::Archive(FILE *archiveFile) {
  if (parentModel->Context()->FileVersion() == 9) {
    ...
    if (parentModel->Context()->FileVersion() >= 37) {
      ...
      if (propertyContainers == 0 && propertyContainerId != 0 && ParentModel()->propertyActionImmediate == TRUE) {
    ...
    if (IsLoaded()) {
      if (parentModel->Context()->delayedGeometryLoad == FALSE || hasChanged == TRUE ||
  ...
  if (parentModel->Context()->FileVersion() >= 23 && parentModel->Context()->FileVersion() < 28) {
    WriteWireframeData();
  }
  /*
...
RESCUEBOOL RescueGeometry::WriteWireframeData() {
  ...
  RCHString fileName;
  fileName << parentModel->currentPathName << "." << Identifier() << ".wireframe";
...
RescueGeometry::RescueGeometry(RescueContext *context, FILE *archiveFile)
    : RescueHistoryObject(context), grid(0), vertices(0), cellStatus(0), parentModel(0), kLayerIDs(0),
      referenceSurface1(0), referenceSurface2(0), referenceSurface1Id(0), referenceSurface2Id(0), surfaceCell(0),
      wellboreCell(0), surfaceToGrid(0), stairSteps(0), geometryUnit(0), properties(0), hasChanged(FALSE),
      dirtyMinMax(TRUE), loaded(FALSE), color(0), parentBlockUnit(0), parentGeobodyPart(0), referenceID(0),
      referenceName(0), lgrType(R_NOT_LGR), lgrGridType(R_STRUCTURED_CPG), parentILowBound(0), parentICount(0),
      parentJLowBound(0), parentJCount(0), parentKLowBound(0), parentKCount(0), parentGeometry(0),
      lgrs(new cSetRescueGeometry()), xWeightLength(0), xWeight(0), yWeightLength(0), yWeight(0), zWeightLength(0),
      zWeight(0), parametricMap(0), isds(new cSetRescueInterfaceSurfaceDesc()), unstructuredGrid(0), radialGrid(0),
...
void RescueGeometry::SetUnstructuredGrid(RescueUnstructuredGrid *grid) {
  EnsureLoaded();
  if (lgrGridType == R_STRUCTURED_CPG || lgrGridType == R_STRUCTURED_RADIAL) {
...
void RescueGeometry::CalculateMinMax() {
  EnsureLoaded();
  if (lgrGridType == R_STRUCTURED_RADIAL || (lgrType == R_UNCONSTRAINED && radialGrid != 0)) {
    radialGrid->CalculateMinMax(minX, maxX, minY, maxY, minZ, maxZ);
    dirtyMinMax = false;
  } else if (lgrGridType != R_STRUCTURED_CPG || (lgrGridType == R_STRUCTURED_CPG && unstructuredGrid != 0)) {
...
void RescueGeometry::SetOrientation(RescueOrientationLedger *ledger, RescueCoordinateSystem::Orientation orientation) {
  RescueCoordinateSystem::Orientation oNow = Grid()->DisplayOrientation();
  bool swapI = false;
  bool swapJ = false;
  bool swapK = false;
  if (oNow == RescueCoordinateSystem::LUF || oNow == RescueCoordinateSystem::LUB ||
      oNow == RescueCoordinateSystem::LDF || oNow == RescueCoordinateSystem::LDB) {
    if (orientation == RescueCoordinateSystem::RUF || orientation == RescueCoordinateSystem::RUB ||
        orientation == RescueCoordinateSystem::RDF || orientation == RescueCoordinateSystem::RDB) {
      swapI = true;
    }
  } else if (orientation == RescueCoordinateSystem::LUF || orientation == RescueCoordinateSystem::LUB ||
             orientation == RescueCoordinateSystem::LDF || orientation == RescueCoordinateSystem::LDB) {
    swapI = true;
  }
  if (oNow == RescueCoordinateSystem::LUF || oNow == RescueCoordinateSystem::LDF ||
      oNow == RescueCoordinateSystem::RUF || oNow == RescueCoordinateSystem::RDF) {
    if (orientation == RescueCoordinateSystem::LUB || orientation == RescueCoordinateSystem::LDB ||
        orientation == RescueCoordinateSystem::RUB || orientation == RescueCoordinateSystem::RDB) {
      swapJ = true;
    }
  } else if (orientation == RescueCoordinateSystem::LUF || orientation == RescueCoordinateSystem::LDF ||
             orientation == RescueCoordinateSystem::RUF || orientation == RescueCoordinateSystem::RDF) {
    swapJ = true;
  }
  if (oNow == RescueCoordinateSystem::LUF || oNow == RescueCoordinateSystem::LUB ||
      oNow == RescueCoordinateSystem::RUF || oNow == RescueCoordinateSystem::RUB) {
    if (orientation == RescueCoordinateSystem::LDF || orientation == RescueCoordinateSystem::LDB ||
        orientation == RescueCoordinateSystem::RDF || orientation == RescueCoordinateSystem::RDB) {
      swapK = true;
    }
  } else if (orientation == RescueCoordinateSystem::LUF || orientation == RescueCoordinateSystem::LUB ||
             orientation == RescueCoordinateSystem::RUF || orientation == RescueCoordinateSystem::RUB) {
    swapK = true;
  }
    ...
    for (loop = 0; loop < howMany; loop++) {
      ...
      if (object != 0) {
        if (object->VertexIs() == R_SPLIT_LINE) {
          ...
          if (swapI || swapJ) {
            if (object->VertexIs() == R_SPLINE_LINE) {
              ((RescuePillar *)object)->SwapIJAxis(swapI, iLowBound, iCount, swapJ, jLowBound, jCount);
            }
          }
        }
      }
