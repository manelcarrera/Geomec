...
cBagRescueSurfaceToGrid::cBagRescueSurfaceToGrid() { tree = new RescueTree(); }

cBagRescueSurfaceToGrid::~cBagRescueSurfaceToGrid() { delete tree; }

void cBagRescueSurfaceToGrid::operator+=(RescueSurfaceToGrid *newObject) { tree->Add(newObject); }
