...
RescueGeometryUnit::RescueGeometryUnit(RescueGeometry *parentGeometryIn, RescueUnit *relatedUnitIn,
                                       RESCUEINT64 topLayerNdxIn, RESCUEINT64 bottomLayerNdxIn)
    : RescueObject(parentGeometryIn->ParentModel()->Context()), parentGeometry(parentGeometryIn),
      relatedUnit(relatedUnitIn), topLayerNdx(topLayerNdxIn), bottomLayerNdx(bottomLayerNdxIn) {
...
RescueGeometryUnit::RescueGeometryUnit(RescueContext *context, FILE *archiveFile)
    : RescueObject(context), parentGeometry(0), relatedUnit(0), topLayerNdx(0), bottomLayerNdx(0) {
  isA = R_RescueGeometryUnit;
...
void RescueGeometryUnit::Relink(RescueObject *parent) { parentGeometry = (RescueGeometry *)parent; }
