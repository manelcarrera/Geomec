...
RescueSplitLine::RescueSplitLine(RescueGeometry *geometry, RESCUEFLOAT x, RESCUEFLOAT y, RESCUEFLOAT step,
                                 RESCUEFLOAT origin, RESCUEFLOAT *stackValuesIn)
...
RescueSplitLine::RescueSplitLine(RescueGeometry *geometry, RESCUEINT64 i, RESCUEINT64 j,
                                 RescueGeometryObject *previous) {
  RESCUEINT64 kLayers = geometry->Grid()->Axis(2)->Count64();
  addresses = new RESCUEFLOAT[(size_t)(kLayers * 8 * 3)];
...
void RescueSplitLine::SetCornerNode(RescueGeometry *geometry, RESCUEINT64 i, RESCUEINT64 j, RESCUEINT64 k,
...
void RescueSplitLine::SetXValue(RescueGeometry *geometry, RESCUEINT64 i, RESCUEINT64 j, RESCUEINT64 k,
                                RESCUEINT64 corner, RESCUEFLOAT x) {
  RESCUEINT64 iPrime;
  RESCUEINT64 jPrime;
  RESCUEINT64 kPrime;
...
void RescueSplitLine::SetYValue(RescueGeometry *geometry, RESCUEINT64 i, RESCUEINT64 j, RESCUEINT64 k,
                                RESCUEINT64 corner, RESCUEFLOAT y) {
  RESCUEINT64 iPrime;
  RESCUEINT64 jPrime;
  RESCUEINT64 kPrime;
...
void RescueSplitLine::SetZValue(RescueGeometry *geometry, RESCUEINT64 i, RESCUEINT64 j, RESCUEINT64 k,
                                RESCUEINT64 corner, RESCUEFLOAT z) {
  RESCUEINT64 iPrime;
  RESCUEINT64 jPrime;
  RESCUEINT64 kPrime;
...
void RescueSplitLine::Values(RescueGeometry *geometry, RESCUEINT64 i, RESCUEINT64 j, RESCUEINT64 k, RESCUEINT64 corner,
...
RESCUEINT64 RescueSplitLine::GenerateAddress(RESCUEINT64 i, RESCUEINT64 j, RESCUEINT64 k, RESCUEINT64 iPrime,
