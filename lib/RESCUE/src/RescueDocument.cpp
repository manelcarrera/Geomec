...
RescueDocument::RescueDocument(RescueModel *modelIn)
    : RescueHistoryObject(modelIn->Context()), model(modelIn), documentName(0), metaKeywords(0), documentLength(0) {
...
RCHString *RescueDocument::DocumentName() { return documentName; }
...
RESCUEINT64 RescueDocument::DocumentLength64() { return documentLength; }
