...
cBagRescueGeobodyPart::cBagRescueGeobodyPart() { tree = new RescueTree(); }

cBagRescueGeobodyPart::~cBagRescueGeobodyPart() { delete tree; }

void cBagRescueGeobodyPart::operator+=(RescueGeobodyPart *newObject) { tree->Add(newObject); }

RESCUEBOOL cBagRescueGeobodyPart::operator-=(RescueGeobodyPart *existingObject) { return tree->Delete(existingObject); }
