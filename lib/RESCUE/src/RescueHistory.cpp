...
RescueHistory::RescueHistory(RescueContext *context, FILE *archiveFile)
    : RescueHistoryObject(context), objectsChanged(0), relatedObjects(0), forwardRelatedChanges(0),
      backwardRelatedChanges(0), parentModel(0) {
  isA = R_RescueHistory;
...
RescueHistoryObject *RescueHistory::FindObject(RescueModel *model, _RescueObjectType objectType, RESCUEINT64 objectId) {
