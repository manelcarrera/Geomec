...
RescueGrid::RescueGrid(RescueContext *context, RescueCoordinateSystem::Orientation displayOrientationIn,
                       RESCUEINT64 i_lowbound, RESCUEINT64 i_count)
    : RescueHistoryObject(context), displayOrientation(displayOrientationIn), axes(0) {
...
RescueGrid::RescueGrid(RescueContext *context)
    : RescueHistoryObject(context), displayOrientation(RescueCoordinateSystem::LUF), axes(new cSetRescueGridAxis()) {
  isA = R_RescueGrid;
}
...
RescueGrid::RescueGrid(RescueContext *context, FILE *archiveFile) : RescueHistoryObject(context), axes(0) {
  axes = new cSetRescueGridAxis();
  isA = R_RescueGrid;
...
void RescueGrid::Archive(RescueContext *context, FILE *archiveFile) {
