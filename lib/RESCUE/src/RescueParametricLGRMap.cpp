...
RescueParametricLGRMap::RescueParametricLGRMap(RescueGeometry *lgr, RESCUEINT64 expectedRefined,
                                               RESCUEINT64 expectedParent, RESCUEINT64 refinedRealloc,
                                               RESCUEINT64 parentRealloc)
    : refinedReallocFactor(refinedRealloc), refinedAllocated(expectedRefined), cellToCellMapCount(0), lgrIndx(0),
      lgrJndx(0), lgrKndx(0), parentNdx(0), parentCount(0), parentReallocFactor(parentRealloc),
      parentAllocated(expectedParent), parentMapCount(0), parentIndx(0), parentJndx(0), parentKndx(0), lgrNdx(0),
      lgrGeometry(lgr), properties(0), propertyContainerId(0) {
...
void RescueParametricLGRMap::SetCellToCell(RESCUEINT32 iNdx, RESCUEINT32 jNdx, RESCUEINT32 kNdx,
                                           RESCUEINT32 parentCountIn, RESCUEINT32 *pIndx, RESCUEINT32 *pJndx,
                                           RESCUEINT32 *pKndx) {
  AddRefinedCell();
...
void RescueParametricLGRMap::SetCellToCell(RESCUEINT64 iNdx, RESCUEINT64 jNdx, RESCUEINT64 kNdx,
                                           RESCUEINT64 parentCountIn, RESCUEINT64 *pIndx, RESCUEINT64 *pJndx,
                                           RESCUEINT64 *pKndx) {
  AddRefinedCell();
  EnsureParentMapSize(parentCountIn);
...
RESCUEINT32 RescueParametricLGRMap::ReadLGRCellToCell(RESCUEINT32 iNdx, RESCUEINT32 jNdx, RESCUEINT32 kNdx,
                                                      RESCUEINT32 allocated, RESCUEINT32 *pIndx, RESCUEINT32 *pJndx,
                                                      RESCUEINT32 *pKndx) {
  RESCUEINT32 myReturn = -1;
  RESCUEINT32 loop;
  for (loop = 0; loop < cellToCellMapCount && myReturn < 0; loop++) {
    if (iNdx == lgrIndx[loop] && (jNdx == -1 || ((lgrJndx == 0) ? true : lgrJndx[loop] == jNdx)) &&
...
RESCUEINT64 RescueParametricLGRMap::ReadLGRCellToCell(RESCUEINT64 iNdx, RESCUEINT64 jNdx, RESCUEINT64 kNdx,
                                                      RESCUEINT64 allocated, RESCUEINT64 *pIndx, RESCUEINT64 *pJndx,
                                                      RESCUEINT64 *pKndx) {
...
RESCUEINT32 RescueParametricLGRMap::ReadParentCellToCell(RESCUEINT32 iNdx, RESCUEINT32 jNdx, RESCUEINT32 kNdx,
                                                         RESCUEINT32 allocated, RESCUEINT32 *cIndx, RESCUEINT32 *cJndx,
                                                         RESCUEINT32 *cKndx) {
  RESCUEINT32 myReturn = -1;
  RESCUEINT32 loop;
  for (loop = 0; loop < parentMapCount; loop++) {
    if (iNdx == parentIndx[loop] && (jNdx == -1 || ((parentJndx == 0) ? true : parentJndx[loop] == jNdx)) &&
...
RESCUEINT64 RescueParametricLGRMap::ReadParentCellToCell(RESCUEINT64 iNdx, RESCUEINT64 jNdx, RESCUEINT64 kNdx,
                                                         RESCUEINT64 allocated, RESCUEINT64 *cIndx, RESCUEINT64 *cJndx,
                                                         RESCUEINT64 *cKndx) {
  RESCUEINT64 myReturn = -1;
  RESCUEINT64 loop;
  for (loop = 0; loop < parentMapCount; loop++) {
...
void RescueParametricLGRMap::Accept(RESCUEINT32 cellToCellCountIn, RESCUEINT32 *lgrIndxIn, RESCUEINT32 *lgrJndxIn,
                                    RESCUEINT32 *lgrKndxIn, RESCUEINT32 *parentNdxIn, RESCUEINT32 *parentCountIn,
                                    RESCUEINT32 parentMapCountIn, RESCUEINT32 *parentIndxIn, RESCUEINT32 *parentJndxIn,
                                    RESCUEINT32 *parentKndxIn, RESCUEINT32 *lgrNdxIn) {
...
void RescueParametricLGRMap::Accept(RESCUEINT64 cellToCellCountIn, RESCUEINT64 *lgrIndxIn, RESCUEINT64 *lgrJndxIn,
                                    RESCUEINT64 *lgrKndxIn, RESCUEINT64 *parentNdxIn, RESCUEINT64 *parentCountIn,
                                    RESCUEINT64 parentMapCountIn, RESCUEINT64 *parentIndxIn, RESCUEINT64 *parentJndxIn,
                                    RESCUEINT64 *parentKndxIn, RESCUEINT64 *lgrNdxIn) {
  cellToCellMapCount = cellToCellCountIn;
  refinedAllocated = cellToCellMapCount;
  if (lgrIndx != 0) {
    delete[] lgrIndx;
...
void RescueParametricLGRMap::Set(RESCUEINT32 cellToCellCountIn, RESCUEINT32 *lgrIndxIn, RESCUEINT32 *lgrJndxIn,
                                 RESCUEINT32 *lgrKndxIn, RESCUEINT32 *parentNdxIn, RESCUEINT32 *parentCountIn,
                                 RESCUEINT32 parentMapCountIn, RESCUEINT32 *parentIndxIn, RESCUEINT32 *parentJndxIn,
                                 RESCUEINT32 *parentKndxIn, RESCUEINT32 *lgrNdxIn) {
...
void RescueParametricLGRMap::Set(RESCUEINT64 cellToCellCountIn, RESCUEINT64 *lgrIndxIn, RESCUEINT64 *lgrJndxIn,
                                 RESCUEINT64 *lgrKndxIn, RESCUEINT64 *parentNdxIn, RESCUEINT64 *parentCountIn,
                                 RESCUEINT64 parentMapCountIn, RESCUEINT64 *parentIndxIn, RESCUEINT64 *parentJndxIn,
                                 RESCUEINT64 *parentKndxIn, RESCUEINT64 *lgrNdxIn) {
  if (lgrJndxIn == 0 && lgrJndx != 0) {
...
RescueParametricLGRMap::RescueParametricLGRMap(RescueContext *context, FILE *archiveFile)
    : cellToCellMapCount(0), lgrIndx(0), lgrJndx(0), lgrKndx(0), parentNdx(0), parentCount(0), parentMapCount(0),
      parentIndx(0), parentJndx(0), parentKndx(0), lgrNdx(0), properties(0), propertyContainerId(0) {
...
void RescueParametricLGRMap::Relink(RescueGeometry *geometryIn) { lgrGeometry = geometryIn; }
