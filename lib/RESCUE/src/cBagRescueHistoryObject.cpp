...
cBagRescueHistoryObject::cBagRescueHistoryObject() { tree = new RescueTree(); }

cBagRescueHistoryObject::~cBagRescueHistoryObject() { delete tree; }

void cBagRescueHistoryObject::operator+=(RescueHistoryObject *newObject) { tree->Add(newObject); }
