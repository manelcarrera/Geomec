...
RescueEventDescr::RescueEventDescr(RescueContext *context,
                                   RESCUECHAR *nameIn,
                                   EventType flagIn)
                                   :RescueLogicalOrderEntry(context)
                                   ,eventType(flagIn)
                                   ,eventDescrName(new RCHString(nameIn))
                                   ,sections(new cBagRescueSection())
                                   ,sectionIds(0)
{
...
RescueEventDescr::RescueEventDescr(RescueContext *context, FILE *archiveFile)
                                       :RescueLogicalOrderEntry(context)
                                       ,eventType(RescueEventDescr::UNCONFORMITY)
                                       ,sections(new cBagRescueSection())
                                       ,sectionIds(0)
                                       ,horizonAboveID(0)
                                       ,horizonBelowID(0)
