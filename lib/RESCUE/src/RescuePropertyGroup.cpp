...
void RescuePropertyGroup::SetGroupName(const RESCUECHAR *newGroupName)
{
...
RescuePropertyGroup::RescuePropertyGroup(const RESCUECHAR *groupNameIn,
                                         RescueModel *modelIn, 
                                         RescueDataContainer *containerIn)
...
RescuePropertyGroup::RescuePropertyGroup
                              (const RESCUECHAR *groupNameIn,
                               ...
                               ,timeSteps(0)
                               ,isLocked(FALSE)
                               ,context(surfaceIn->ParentModel()->Context())
                               ,tsManager(0)
                               ,properties(0)
{
  groupName = new RCHString(groupNameIn);
...
RescuePropertyGroup::RescuePropertyGroup
                              (const RESCUECHAR *groupNameIn,
                               RescueGeobodyPart *bodyPartIn)
                               :RescueHistoryObject(bodyPartIn->Body()->ParentModel()->Context())
                               ,groupName(0) 
                               ,model(0)
                               ,unit(0)
                               ,blockUnit(0)
                               ...
                               ,timeSteps(0)
                               ,isLocked(FALSE)
                               ,context(bodyPartIn->Body()->ParentModel()->Context())
                               ,tsManager(0)
                               ,properties(0)
{
  groupName = new RCHString(groupNameIn);
...
RescuePropertyGroup::RescuePropertyGroup
                              (const RESCUECHAR *groupNameIn,
                               RescueBlockUnit *blockUnitIn)
                               :RescueHistoryObject(blockUnitIn->ParentModel()->Context())
                               ,groupName(0)
                               ,model(0)
                               ,unit(0)
                               ,blockUnit(blockUnitIn)
                               ,blockUnitID(0)
                               ,body(0)
                               ,bodyPart(0)
                               ,surface(0)
                               ...
                               ,timeSteps(0)
                               ,isLocked(FALSE)
                               ,context(blockUnitIn->ParentModel()->Context())
                               ,tsManager(0)
                               ,properties(0)
{
  groupName = new RCHString(groupNameIn);
