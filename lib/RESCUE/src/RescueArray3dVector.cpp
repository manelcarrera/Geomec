  ...
  if (HasFragments())
  {
    ...
    for (loop = 0; loop < count; loop++)
    {
      ...
      myfscanf(ParentModel()->Context(), fragmentFile, &data.coord2);
          ...
          {
      data = ((RescueArrayFragment3dVector *) 
...
RescueArrayFragment *RescueArray3dVector::Create(RESCUEINT32 iLowBound, RESCUEINT32 iCount,
...
RescueArrayFragment *RescueArray3dVector::Create(RESCUEINT64 iLowBound, RESCUEINT64 iCount,
                                                 RESCUEINT64 jLowBound, RESCUEINT64 jCount)
{
                                              ...
                                              RESCUEINT64 jLowBound, RESCUEINT64 jCount)
{
  ...
  myReturn = new RescueArrayFragment3dVector(this, 3, iLowBound, iCount, 
                                                     jLowBound, jCount,
                                                     kAxis->LowBound64(), kAxis->Count64());
  }
  else
  {
  myReturn = new RescueArrayFragment3dVector(this, 2, iLowBound, iCount,
...
RescueArrayFragment *RescueArray3dVector::CreatePrimitive(RESCUEINT64 iLowBound, RESCUEINT64 iCount,
                                              ...
                                              RESCUEINT64 kLowBound, RESCUEINT64 kCount)
{
  RescueArrayFragment *myReturn = new RescueArrayFragment3dVector(this, 3, iLowBound, iCount, 
                                    jLowBound, jCount,
                                    kLowBound, kCount);
  DemandFragments();
  (*fragments) += myReturn;
...
RescueArrayFragment *RescueArray3dVector::Load(RESCUEINT32 iLowBound, RESCUEINT32 iCount,
                                               RESCUEINT32 jLowBound, RESCUEINT32 jCount,
                                               RESCUEINT32 kLowBound, RESCUEINT32 kCount)
{
  RescueArrayFragment *myReturn = CreatePrimitive((RESCUEINT64) iLowBound, (RESCUEINT64) iCount, 
...
RescueArrayFragment *RescueArray3dVector::Load(RESCUEINT64 iLowBound, RESCUEINT64 iCount,
                      RESCUEINT64 jLowBound, RESCUEINT64 jCount,
                      RESCUEINT64 kLowBound, RESCUEINT64 kCount)
{
  RescueArrayFragment *myReturn = CreatePrimitive(iLowBound, iCount, jLowBound, jCount, kLowBound, kCount);
...
void RescueArray3dVector::SwapAxes(bool swapI, RESCUEINT64 iNodes, 
