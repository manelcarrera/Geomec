...
RESCUEBOOL RescueTruncation::isSelfTruncating() const {
  ...
  return (self_fault_id_def && self_limit_def && is_i_undef && is_j_undef);
}
...
void RescueTruncation::SwapIJAxis(bool swapI, RESCUEINT64 iLowBound, RESCUEINT64 iCount, bool swapJ,
