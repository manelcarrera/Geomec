...
RescueWellboreSurface::RescueWellboreSurface(RescueWellbore *wellboreIn, RescueIJSurface *surfaceIn, RESCUEFLOAT uIn,
                                             RESCUEFLOAT vIn, RESCUEFLOAT mdIn)
    : RescueObject(wellboreIn->ParentModel()->Context()), wellbore(wellboreIn), surface(surfaceIn), u(uIn), v(vIn),
      md(mdIn) {
...
RescueWellboreSurface::RescueWellboreSurface(RescueContext *context, FILE *archiveFile)
    : RescueObject(context), wellbore(0), surface(0) {
