...
RESCUEINT64 RescueRadialGrid::CopyArrays(RESCUEINT64 lowNdx, RESCUEINT64 count, RESCUEFLOAT *preAllocatedX,
...
RESCUEINT64 RescueRadialGrid::CopyCenter(RESCUEINT64 lowNdx, RESCUEINT64 count, RESCUEFLOAT *preAllocatedX,
                                         RESCUEFLOAT *preAllocatedY, RESCUEFLOAT *preAllocatedZ,
                                         RESCUEFLOAT *preAllocatedMD, RESCUEINT64 offset) {
  RESCUEINT64 myReturn = 0;
...
void RescueRadialGrid::Set(RESCUEINT64 radialCellsIn, RESCUEINT64 angularCellsIn, RESCUEINT64 kLayersIn,
                           RESCUEBOOL closedIn, RESCUEFLOAT *vertexXin, RESCUEFLOAT *vertexYin, RESCUEFLOAT *vertexZin,
                           RESCUEFLOAT *centerXin, RESCUEFLOAT *centerYin, RESCUEFLOAT *centerZin,
                           RESCUEFLOAT *centerMDin) {
...
void RescueRadialGrid::Relink(RescueObject *object) { parentGeometry = (RescueGeometry *)object; }

void RescueRadialGrid::CalculateMinMax(RESCUEFLOAT &minX, RESCUEFLOAT &maxX, RESCUEFLOAT &minY, RESCUEFLOAT &maxY,
