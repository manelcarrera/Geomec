...
void RescueWellboreSampling::Dispose()
{
  properties->Dispose();
}
...
RescueWellboreSampling::RescueWellboreSampling(RescueWellbore *parentWellboreIn,
                                               RESCUEINT64 countIn, RESCUEFLOAT originIn, RESCUEFLOAT stepIn)
                                               :RescueObject(parentWellboreIn->ParentModel()->Context())
                                               ,properties(0)
                                               ,parentWellbore(parentWellboreIn)
                                               ,grid(0)
                                               ,values(0)
{
   ...
   grid = new RescueGrid(parentWellboreIn->ParentModel()->Context(),
                         RescueCoordinateSystem::LUB, originIn, stepIn, 0, countIn);
                                               ...
                                               ,values(valuesIn)
{
   ...
   RescueContext::CurrentISOTime(*timeStamp);
   grid = new RescueGrid(parentWellboreIn->ParentModel()->Context(),
                         RescueCoordinateSystem::LUB, 0, countIn);
   properties = new cSetRescueWellboreProperty();
   (*parentWellboreIn->sampling) += this;
}
...
RESCUEBOOL RescueWellboreSampling::AnyFileTruncated()
{
