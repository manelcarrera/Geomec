...
RescueInterfaceSurfaceDesc::RescueInterfaceSurfaceDesc(RescueGeometry *lgrGeometryIn, RESCUEBOOL isExteriorIn,
                                                       RESCUEINT64 expectedFaces, RESCUEINT64 expectedCells,
                                                       RESCUEINT64 facesRealloc, RESCUEINT64 cellsRealloc)
    : lgrGeometry(lgrGeometryIn), facesAllocated(expectedFaces), cellsAllocated(expectedCells),
      facesReallocFactor(facesRealloc), cellsReallocFactor(cellsRealloc), isExterior(isExteriorIn), faceCount(0),
      faceIndx(0), faceJndx(0), faceKndx(0), faceNdx(0), cellNdx(0), cellCount(0), cellMapCount(0), cellRef(0),
      cellIndx(0), cellJndx(0), cellKndx(0), faceRowNdx(0), properties(0), propertyContainerId(0) {
...
void RescueInterfaceSurfaceDesc::SetFaceToCell(RESCUEINT32 iNdx, RESCUEINT32 jNdx, RESCUEINT32 kNdx,
                                               RESCUEINT32 faceNdxIn, RESCUEINT32 cellCountIn, RESCUEINT32 *cellRefIn,
...
void RescueInterfaceSurfaceDesc::SetFaceToCell(RESCUEINT64 iNdx, RESCUEINT64 jNdx, RESCUEINT64 kNdx,
                                               RESCUEINT64 faceNdxIn, RESCUEINT64 cellCountIn, RESCUEINT64 *cellRefIn,
...
RESCUEINT32 RescueInterfaceSurfaceDesc::ReadFaceToCell(RESCUEINT32 iNdx, RESCUEINT32 jNdx, RESCUEINT32 kNdx,
                                                       RESCUEINT32 faceNdxIn, RESCUEINT32 allocated,
                                                       RESCUEINT32 *cellRefIn, RESCUEINT32 *cIndx, RESCUEINT32 *cJndx,
                                                       RESCUEINT32 *cKndx) {
  RESCUEINT64 myReturn = -1;
  RESCUEINT64 loop;
  for (loop = 0; loop < faceCount && myReturn < 0; loop++) {
    if (iNdx == faceIndx[loop] && (jNdx == -1 || ((faceJndx == 0) ? true : faceJndx[loop] == jNdx)) &&
        (kNdx == -1 || ((faceKndx == 0) ? true : faceKndx[loop] == kNdx)) && faceNdxIn == faceNdx[loop]) {
...
RESCUEINT64 RescueInterfaceSurfaceDesc::ReadFaceToCell(RESCUEINT64 iNdx, RESCUEINT64 jNdx, RESCUEINT64 kNdx,
                                                       RESCUEINT64 faceNdxIn, RESCUEINT64 allocated,
                                                       RESCUEINT64 *cellRefIn, RESCUEINT64 *cIndx, RESCUEINT64 *cJndx,
                                                       RESCUEINT64 *cKndx) {
  RESCUEINT64 myReturn = -1;
  RESCUEINT64 loop;
  for (loop = 0; loop < faceCount && myReturn < 0; loop++) {
...
RESCUEINT32 RescueInterfaceSurfaceDesc::ReadCellToFace(RESCUEINT32 cRef, RESCUEINT32 cIndx, RESCUEINT32 cJndx,
                                                       RESCUEINT32 cKndx, RESCUEINT32 allocated, RESCUEINT32 *iNdx,
                                                       RESCUEINT32 *jNdx, RESCUEINT32 *kNdx, RESCUEINT32 *faceNdxIn) {
  RESCUEINT32 myReturn = -1;
  RESCUEINT64 loop;
  for (loop = 0; loop < cellMapCount; loop++) {
    if (cRef == cellRef[loop] && cIndx == cellIndx[loop] &&
...
RESCUEINT64 RescueInterfaceSurfaceDesc::ReadCellToFace(RESCUEINT64 cRef, RESCUEINT64 cIndx, RESCUEINT64 cJndx,
                                                       RESCUEINT64 cKndx, RESCUEINT64 allocated, RESCUEINT64 *iNdx,
                                                       RESCUEINT64 *jNdx, RESCUEINT64 *kNdx, RESCUEINT64 *faceNdxIn) {
  RESCUEINT64 myReturn = -1;
  RESCUEINT64 loop;
  for (loop = 0; loop < cellMapCount; loop++) {
    if (cRef == cellRef[loop] && cIndx == cellIndx[loop] &&
...
void RescueInterfaceSurfaceDesc::Set(RESCUEINT32 faceCountIn, RESCUEINT32 *faceIndxIn, RESCUEINT32 *faceJndxIn,
                                     RESCUEINT32 *faceKndxIn, RESCUEINT32 *faceNdxIn, RESCUEINT32 *cellNdxIn,
                                     RESCUEINT32 *cellCountIn, RESCUEINT32 cellMapCountIn, RESCUEINT32 *cellRefIn,
                                     RESCUEINT32 *cellIndxIn, RESCUEINT32 *cellJndxIn, RESCUEINT32 *cellKndxIn,
...
void RescueInterfaceSurfaceDesc::Set(RESCUEINT64 faceCountIn, RESCUEINT64 *faceIndxIn, RESCUEINT64 *faceJndxIn,
                                     RESCUEINT64 *faceKndxIn, RESCUEINT64 *faceNdxIn, RESCUEINT64 *cellNdxIn,
                                     RESCUEINT64 *cellCountIn, RESCUEINT64 cellMapCountIn, RESCUEINT64 *cellRefIn,
                                     RESCUEINT64 *cellIndxIn, RESCUEINT64 *cellJndxIn, RESCUEINT64 *cellKndxIn,
...
void RescueInterfaceSurfaceDesc::Accept(RESCUEINT32 faceCountIn, RESCUEINT32 *faceIndxIn, RESCUEINT32 *faceJndxIn,
                                        RESCUEINT32 *faceKndxIn, RESCUEINT32 *faceNdxIn, RESCUEINT32 *cellNdxIn,
                                        RESCUEINT32 *cellCountIn, RESCUEINT32 cellMapCountIn, RESCUEINT32 *cellRefIn,
                                        RESCUEINT32 *cellIndxIn, RESCUEINT32 *cellJndxIn, RESCUEINT32 *cellKndxIn,
                                        RESCUEINT32 *faceRowNdxIn) {
...
void RescueInterfaceSurfaceDesc::Accept(RESCUEINT64 faceCountIn, RESCUEINT64 *faceIndxIn, RESCUEINT64 *faceJndxIn,
                                        RESCUEINT64 *faceKndxIn, RESCUEINT64 *faceNdxIn, RESCUEINT64 *cellNdxIn,
                                        RESCUEINT64 *cellCountIn, RESCUEINT64 cellMapCountIn, RESCUEINT64 *cellRefIn,
                                        RESCUEINT64 *cellIndxIn, RESCUEINT64 *cellJndxIn, RESCUEINT64 *cellKndxIn,
                                        RESCUEINT64 *faceRowNdxIn) {
...
void RescueInterfaceSurfaceDesc::Archive(RescueContext *context, FILE *archiveFile) {
  ...
  if (context->FileVersion() >= 37) {
    if (properties == 0 && propertyContainerId != 0 && lgrGeometry->ParentModel()->propertyActionImmediate == TRUE) {
...
RescueInterfaceSurfaceDesc::RescueInterfaceSurfaceDesc(RescueContext *context, FILE *archiveFile)
    : faceCount(0), faceIndx(0), faceJndx(0), faceKndx(0), faceNdx(0), cellNdx(0), cellCount(0), cellMapCount(0),
      cellRef(0), cellIndx(0), cellJndx(0), cellKndx(0), properties(0), propertyContainerId(0) {
...
void RescueInterfaceSurfaceDesc::Relink(RescueGeometry *geometryIn) { lgrGeometry = geometryIn; }
