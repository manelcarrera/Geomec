...
RescueGeobodySurface::RescueGeobodySurface(RescueGeobodyVolume *parentVolumeIn,
                                           RescueSurface *existingSurface, Role roleIn)
...
RescueGeobodySurface::RescueGeobodySurface(RescueContext *context, FILE *archiveFile)
...
void RescueGeobodySurface::Relink(RescueObject *parentGeobodyVolume)
{
  ...
  surface = (RescueSurface *) RescueHistory::FindObject(parentModel, 
                                      surfaceType, 
                                      surfaceID);
}
