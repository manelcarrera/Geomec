...
RescueTimeStepGroup::RescueTimeStepGroup(const RESCUECHAR *timeStepNameIn, RescuePropertyGroup *groupIn)
    : RescueHistoryObject(groupIn->Context()), timeStepName(0), group(groupIn), properties(0), isLocked(FALSE),
      propertyID(0), geometryID(0), relinkingModel(0) {
...
RescueTimeStepGroup::RescueTimeStepGroup(RescueContext *context, FILE *archiveFile)
    : RescueHistoryObject(context), timeStepName(0), properties(0), isLocked(FALSE), propertyID(0), geometryID(0),
      relinkingModel(0) {
