...
RescueGeobodyPart::RescueGeobodyPart(RescueGeobody *parentBody)
                                     :RescueHistoryObject(parentBody->ParentModel()->Context())
                                     ,body(parentBody)
                                     ,bodyVolumes(0)
                                     ,propertyGroups(0)
                                     ,propertyGroupsID(0)
...
RescueGeobodyPart::RescueGeobodyPart(RescueCoordinateSystem::Orientation orientation,
                                     ...
                                     ,color(0)
{
  ...
  gridGeometries = new cSetRescueGeometry();
  propertyGroups = new cBagRescuePropertyGroup();
  RescueGrid *blockUnitGrid = new RescueGrid(parentBody->ParentModel()->Context(),
                                             orientation,
                                             parentBody->ParentModel()->CoordinateSystem()->Axis(0),
                                             i_origin, i_step,
                                             i_lowbound, i_count,
                                             parentBody->ParentModel()->CoordinateSystem()->Axis(1),
                                             j_origin, j_step,
                                             j_lowbound, j_count,
                                             k_origin, k_step,
                                             k_lowbound, k_count);
                                     ...
                                     ,color(0)
{
  ...
  (*gridGeometries) += new RescueGeometry(parentBody->ParentModel(), 
