...
bool RescueOrientationLedger::GetIJFor(RescueIJSurface *face, 
...
void RescueOrientationLedger::SetIJFor(RescueIJSurface *face, 
              RESCUEINT64 iLowBound, RESCUEINT64 iCount, 
              RESCUEINT64 jLowBound, RESCUEINT64 jCount,
              bool swapI, bool swapJ)
{
...
bool RescueOrientationLedger::GetKFor(RescueGeometry *geom, 
...
void RescueOrientationLedger::SetKFor(RescueGeometry *geom,
...
RescueOrientationLedger::GeomK::GeomK(RescueGeometry *geomIn,
           RESCUEINT64 kLowBoundIn, RESCUEINT64 kCountIn, bool swapKIn)
{
  geom = geomIn;
...
RescueOrientationLedger::SurfaceIJ::SurfaceIJ(RescueIJSurface *faceIn, 
                     RESCUEINT64 iLowBoundIn, RESCUEINT64 iCountIn, 
                     RESCUEINT64 jLowBoundIn, RESCUEINT64 jCountIn,
                     bool swapIIn, bool swapJIn)
{
  face = faceIn;
