...
RescueDocumentList::RescueDocumentList(RescueModel *modelIn, RESCUEINT64 identifierIn)
  ...
  if (uniqueID > context->uniqueIDCounter)
    context->uniqueIDCounter = uniqueID + 1;
  allocated = 10;
  count = 0;
