...
cBagRescueTriangleVertex::cBagRescueTriangleVertex()
{
  tree = new RescueTree();
}
...
void cBagRescueTriangleVertex::operator+=(RescueTriangleVertex *newObject)
{
  tree->Add(newObject);
}
...
void cBagRescueTriangleVertex::UnArchive(RescueContext *context,
                                         FILE *archiveFile, RescueTriangulatedSurface *parentSurface)
{
  RESCUEINT64 howMany;
