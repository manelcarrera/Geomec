...
RescueIJSurface::RescueIJSurface(RescueSurface *surfaceIn, RescueCoordinateSystem::Orientation orientation,
    ...
    : RescueHistoryObject(surfaceIn->ParentModel()->Context()), parentSurface(surfaceIn), surfaceGrid(0),
      surfaceCell(0), surfaceToGrid(0), stairSteps(0), surfaceWellbore(0), faceStatus(0) {
  ...
  surfaceGrid = new RescueGrid(surfaceIn->ParentModel()->Context(), orientation, i_axis, i_origin, i_step, i_lowbound,
                               i_count, j_axis, j_origin, j_step, j_lowbound, j_count);
  isA = R_RescueIJSurface;
  surfaceGeometry = new RescueTripletArray(surfaceIn->ParentModel()->Context(), surfaceGrid, missingValue,
                                           parentSurface->ParentModel());
...
RescueIJSurface::RescueIJSurface(RescueSurface *surfaceIn, RescueCoordinateSystem::Orientation orientation,
                                 ...
                                 RESCUEINT64 i_lowbound, RESCUEINT64 i_count, RescueCoordinateSystemAxis *j_axis,
                                 RESCUEFLOAT j_origin, RESCUEFLOAT j_step, RESCUEINT64 j_lowbound, RESCUEINT64 j_count,
                                 RESCUEFLOAT missingValue, RESCUEFLOAT *values)
    : RescueHistoryObject(surfaceIn->ParentModel()->Context()), parentSurface(surfaceIn), surfaceGrid(0),
      surfaceCell(0), surfaceToGrid(0), stairSteps(0), surfaceWellbore(0), faceStatus(0) {
  surfaceGrid = new RescueGrid(surfaceIn->ParentModel()->Context(), orientation, i_axis, i_origin, i_step, i_lowbound,
                               i_count, j_axis, j_origin, j_step, j_lowbound, j_count);
...
RescueIJSurface::RescueIJSurface(RescueSurface *surfaceIn, RescueCoordinateSystem::Orientation orientation,
                                 RESCUEINT64 i_lowbound, RESCUEINT64 i_count, RESCUEINT64 j_lowbound,
                                 RESCUEINT64 j_count, RESCUEFLOAT missingValue)
    : RescueHistoryObject(surfaceIn->ParentModel()->Context()), parentSurface(surfaceIn), surfaceGrid(0),
      surfaceCell(0), surfaceToGrid(0), stairSteps(0), surfaceWellbore(0), faceStatus(0) {
  surfaceGrid =
      new RescueGrid(surfaceIn->ParentModel()->Context(), orientation, i_lowbound, i_count, j_lowbound, j_count);
  surfaceCell = new cBagRescueSurfaceCell();
  surfaceToGrid = new cBagRescueSurfaceToGrid();
  stairSteps = new cBagRescueStairSteppedFault();
  surfaceWellbore = new cBagRescueWellboreSurface();
...
RescueIJSurface::RescueIJSurface(RescueSurface *surfaceIn, RescueCoordinateSystem::Orientation orientation,
                                 RESCUEINT64 i_lowbound, RESCUEINT64 i_count, RESCUEINT64 j_lowbound,
                                 RESCUEINT64 j_count, RESCUEFLOAT missingValue, RESCUEFLOAT *tripletArray)
    : RescueHistoryObject(surfaceIn->ParentModel()->Context()), parentSurface(surfaceIn), surfaceGrid(0),
      surfaceCell(0), surfaceToGrid(0), stairSteps(0), surfaceWellbore(0), faceStatus(0) {
  surfaceCell = new cBagRescueSurfaceCell();
  surfaceToGrid = new cBagRescueSurfaceToGrid();
...
RescueIJSurface::RescueIJSurface(RescueContext *context, FILE *archiveFile)
    : RescueHistoryObject(context), parentSurface(0), surfaceGrid(0), surfaceGeometry(0), surfaceCell(0),
      surfaceToGrid(0), stairSteps(0), surfaceWellbore(0), faceStatus(0) {
  isA = R_RescueIJSurface;
...
void RescueIJSurface::SetOrientation(RescueOrientationLedger *ledger, RescueCoordinateSystem::Orientation orientation) {
