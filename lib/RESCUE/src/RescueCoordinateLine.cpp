...
RescueCoordinateLine::RescueCoordinateLine(RescueGeometry *geometry, 
                       RESCUEFLOAT xTopIn, RESCUEFLOAT yTopIn, RESCUEFLOAT zTopIn,
                       RESCUEFLOAT xBottomIn, RESCUEFLOAT yBottomIn, RESCUEFLOAT zBottomIn,
                       RESCUEFLOAT *middleValues)
                       :middleZs(0)
{
  xTop = xTopIn;
  yTop = yTopIn;
...
void RescueCoordinateLine::Values(RescueGeometry *geometry, 
...
RescueCoordinateLine::RescueCoordinateLine(RescueContext *context, FILE *archiveFile, 
                                           RESCUEBOOL compress)
{
