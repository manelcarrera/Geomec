...
void cSetRescueWireframe::SaveCompatibleEdgeSet(RescueEdgeSet *edgeSet, RescueObject *user, RescueWireframeStub *stub) {
...
RESCUEINT64 cSetRescueWireframe::Count64(void) { return count; }

RESCUEINT32 cSetRescueWireframe::Count(void) { return (RESCUEINT32)count; }
