...
void RescueSOctTreeNode::CommonInitialization(RESCUEFLOAT minXin, RESCUEFLOAT maxXin, 
                                              RESCUEFLOAT minYin, RESCUEFLOAT maxYin,
                                              RESCUEFLOAT minZin, RESCUEFLOAT maxZin)
{
  minX = minXin;
  maxX = maxXin;
  minY = minYin;
...
RescueSOctTreeNode::RescueSOctTreeNode(RescueTriangulatedSurface *parent,
                                       RESCUEFLOAT minXin, RESCUEFLOAT maxXin, 
                                       RESCUEFLOAT minYin, RESCUEFLOAT maxYin,
                                       RESCUEFLOAT minZin, RESCUEFLOAT maxZin,
...
RescueSOctTreeNode *RescueSOctTreeNode::LeafNode(RescueSOctTreeNode *parent,
                                                 RESCUEFLOAT minX, RESCUEFLOAT maxX, 
                                                 RESCUEFLOAT minY, RESCUEFLOAT maxY,
                                                 RESCUEFLOAT minZ, RESCUEFLOAT maxZ,
                                                 RESCUEINT64 xDivisions, RESCUEINT64 yDivisions, RESCUEINT64 zDivisions)
{
  RescueSOctTreeNode *myReturn = new RescueSOctTreeNode(this, minX, maxX, minY, maxY, minZ, maxZ,
                                             xDivisions, yDivisions, zDivisions);
  return myReturn;
}

RescueSOctTreeNode::RescueSOctTreeNode(RescueSOctTreeNode *parent,
                                       RESCUEFLOAT minXin, RESCUEFLOAT maxXin, 
                                       RESCUEFLOAT minYin, RESCUEFLOAT maxYin,
                                       RESCUEFLOAT minZin, RESCUEFLOAT maxZin,
                                       RESCUEINT64 xDivisions, RESCUEINT64 yDivisions, RESCUEINT64 zDivisions)
