...
void RescueCoordinatePolyLine::Values(RescueGeometry *geometry, 
...
void RescueCoordinatePolyLine::Values(RESCUEINT64 k, RESCUEFLOAT &z)
{
  z = value[(kLayers * 2) + k];
}
...
RescueCoordinatePolyLine::RescueCoordinatePolyLine(RescueContext *context, RESCUEINT64 kLayersIn, 
                                                   FILE *archiveFile, RESCUEBOOL compress)
{
  kLayers = kLayersIn;
