...
void RescueUnstructuredGrid::AddVertices(RESCUEINT64 count, RESCUEFLOAT *vertexXin, RESCUEFLOAT *vertexYin,
                                         RESCUEFLOAT *vertexZin) {
...
void RescueUnstructuredGrid::AddCell(RESCUEINT32 cellCenterNdxIn, RESCUEINT32 kLayerIn, RESCUEINT32 count,
...
void RescueUnstructuredGrid::AddCell(RESCUEINT64 cellCenterNdxIn, RESCUEINT64 kLayerIn, RESCUEINT64 count,
...
void RescueUnstructuredGrid::CopyVertices(RESCUEINT64 lowNdx, RESCUEINT64 count, RESCUEFLOAT *preAllocatedX,
                                          RESCUEFLOAT *preAllocatedY, RESCUEFLOAT *preAllocatedZ, RESCUEINT64 offset) {
  RESCUEINT64 loop;
...
RESCUEINT32 RescueUnstructuredGrid::NthFace(RESCUEINT32 zeroBasedOrdinal, RESCUEINT32 count,
...
RESCUEINT64 RescueUnstructuredGrid::NthFace(RESCUEINT64 zeroBasedOrdinal, RESCUEINT64 count,
...
void RescueUnstructuredGrid::CopyFaceVertexTuples(RESCUEINT32 lowNdx, RESCUEINT32 count, RESCUEINT32 *preAllocatedNdx,
                                                  RESCUEINT32 offset) {
  RESCUEINT32 loop;
...
void RescueUnstructuredGrid::CopyFaceVertexTuples(RESCUEINT64 lowNdx, RESCUEINT64 count, RESCUEINT64 *preAllocatedNdx,
                                                  RESCUEINT64 offset) {
  RESCUEINT64 loop;
  for (loop = 0; loop < count && lowNdx + loop < faceVertexTupleCount; loop++) {
    if (preAllocatedNdx != 0) {
...
void RescueUnstructuredGrid::AcceptFaces(RESCUEINT32 faceCountIn, RESCUEINT32 *faceVertexNdxIn,
                                         RESCUEINT32 *faceVertexCountIn, RESCUEINT32 faceVertexTupleCountIn,
...
void RescueUnstructuredGrid::AcceptFaces(RESCUEINT64 faceCountIn, RESCUEINT64 *faceVertexNdxIn,
                                         RESCUEINT64 *faceVertexCountIn, RESCUEINT64 faceVertexTupleCountIn,
...
void RescueUnstructuredGrid::SetFaces(RESCUEINT32 faceCountIn, RESCUEINT32 *faceVertexNdxIn,
                                      RESCUEINT32 *faceVertexCountIn, RESCUEINT32 faceVertexTupleCountIn,
                                      RESCUEINT32 *faceArrayIn) {
...
void RescueUnstructuredGrid::SetFaces(RESCUEINT64 faceCountIn, RESCUEINT64 *faceVertexNdxIn,
                                      RESCUEINT64 *faceVertexCountIn, RESCUEINT64 faceVertexTupleCountIn,
                                      RESCUEINT64 *faceArrayIn) {
  if (faceCountIn > faceAlloc) {
    delete[] faceVertexNdx;
...
RESCUEINT32 RescueUnstructuredGrid::NthCell(RESCUEINT32 zeroBasedOrdinal, RESCUEFLOAT &x, RESCUEFLOAT &y,
                                            RESCUEFLOAT &z, RESCUEINT32 &kLayerIn, RESCUEINT32 count,
                                            RESCUEINT32 *faceIndices) {
  RESCUEINT32 myReturn = 0;
...
RESCUEINT64 RescueUnstructuredGrid::NthCell(RESCUEINT64 zeroBasedOrdinal, RESCUEFLOAT &x, RESCUEFLOAT &y,
                                            RESCUEFLOAT &z, RESCUEINT64 &kLayerIn, RESCUEINT64 count,
                                            RESCUEINT64 *faceIndices) {
  RESCUEINT64 myReturn = 0;
  if (zeroBasedOrdinal >= 0 && zeroBasedOrdinal < cellCount) {
...
void RescueUnstructuredGrid::CopyCells(RESCUEINT32 lowNdx, RESCUEINT32 count, RESCUEINT32 *faceCellNdxArrayIn,
                                       RESCUEINT32 *faceCellCountArrayIn, RESCUEINT32 *cellCenterNdxArrayIn,
                                       RESCUEINT32 *kLayerArrayIn, RESCUEINT32 offset) {
  RESCUEINT32 loop;
...
void RescueUnstructuredGrid::CopyCells(RESCUEINT64 lowNdx, RESCUEINT64 count, RESCUEINT64 *faceCellNdxArrayIn,
                                       RESCUEINT64 *faceCellCountArrayIn, RESCUEINT64 *cellCenterNdxArrayIn,
                                       RESCUEINT64 *kLayerArrayIn, RESCUEINT64 offset) {
  RESCUEINT64 loop;
  for (loop = 0; loop < count && lowNdx + loop < cellCount; loop++) {
    if (faceCellNdxArrayIn != 0) {
...
void RescueUnstructuredGrid::CopyCellFaceTuples(RESCUEINT32 lowNdx, RESCUEINT32 count, RESCUEINT32 *faceListArray,
                                                RESCUEINT32 offset) {
  RESCUEINT32 loop;
...
void RescueUnstructuredGrid::CopyCellFaceTuples(RESCUEINT64 lowNdx, RESCUEINT64 count, RESCUEINT64 *faceListArray,
                                                RESCUEINT64 offset) {
  RESCUEINT64 loop;
  for (loop = 0; loop < count && lowNdx + loop < faceListCount; loop++) {
    if (faceListArray != 0) {
...
void RescueUnstructuredGrid::AcceptCells(RESCUEINT32 cellCountIn, RESCUEINT32 *faceCellNdxIn,
                                         RESCUEINT32 *faceCellCountIn, RESCUEINT32 *cellCenterNdxIn,
...
void RescueUnstructuredGrid::AcceptCells(RESCUEINT64 cellCountIn, RESCUEINT64 *faceCellNdxIn,
                                         RESCUEINT64 *faceCellCountIn, RESCUEINT64 *cellCenterNdxIn,
...
void RescueUnstructuredGrid::SetCells(RESCUEINT32 cellCountIn, RESCUEINT32 *faceCellNdxIn, RESCUEINT32 *faceCellCountIn,
                                      RESCUEINT32 *cellCenterNdxIn, RESCUEINT32 *kLayerIn, RESCUEINT32 faceListCountIn,
...
void RescueUnstructuredGrid::SetCells(RESCUEINT64 cellCountIn, RESCUEINT64 *faceCellNdxIn, RESCUEINT64 *faceCellCountIn,
                                      RESCUEINT64 *cellCenterNdxIn, RESCUEINT64 *kLayerIn, RESCUEINT64 faceListCountIn,
...
void RescueUnstructuredGrid::SetupGrid() { parentGeometry->Grid()->Axis(0)->SetCount(cellCount + 1); }

RescueUnstructuredGrid::RescueUnstructuredGrid(RescueGeometry *lgrGeometry, RESCUEINT64 expectedVertexCount,
                                               RESCUEINT64 expectedFaceCount, RESCUEINT64 expectedFaceVertexTuples,
                                               RESCUEINT64 expectedCellCount, RESCUEINT64 expectedCellFaceTuples,
                                               RESCUEINT64 expectedVertexRealloc, RESCUEINT64 expectedFaceRealloc,
                                               RESCUEINT64 expectedFaceVertexRealloc, RESCUEINT64 expectedCellRealloc,
...
void RescueUnstructuredGrid::Relink(RescueObject *object) { parentGeometry = (RescueGeometry *)object; }

void RescueUnstructuredGrid::CalculateMinMax(RESCUEFLOAT &minX, RESCUEFLOAT &maxX, RESCUEFLOAT &minY, RESCUEFLOAT &maxY,
