...
RescueIdTreeNode::RescueIdTreeNode(RescueIdTreeNode *parentNodeIn, RESCUEINT64 numberToAllocate)
        ...
        */
        if (handled == FALSE) {
          if ((parentNode == 0)
            ...
            branches[1] = new RescueIdTreeNode(this, &objects[midNdx + 1], objectAllocated, objectCount - (midNdx + 2));
          ...
          */
            ...
            RescueIdTreeNode *newNode = new RescueIdTreeNode(parentNode, objectList, objectAllocated, objectsSent);
            objectCount = midNdx;
