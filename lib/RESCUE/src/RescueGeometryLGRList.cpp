...
RescueGeometryLGRList::RescueGeometryLGRList(RescueGeometry *geometry, RESCUEBOOL byTimeStepIn,
                                             RescuePropertyGroup *nullOrGroup, RESCUECHAR *nullOrTimeStepName)
...
void RescueGeometryLGRList::AddGroup(RescuePropertyGroup *toAdd, RescueGeometry *geometry,
...
void RescueGeometryLGRList::AddRow(RescueGeometry *geom, RescueTimeStepGroup *ts, RescuePropertyGroup *group) {
...
RESCUEINT64 RescueGeometryLGRList::NdxOf(RescueGeometry *geom, RescueTimeStepGroup *ts, RescuePropertyGroup *group) {
  RESCUEINT64 ndx = 0;
...
RESCUEINT64 RescueGeometryLGRList::CompareRow(RESCUEINT64 ndx, RescueGeometry *geom, RescueTimeStepGroup *ts,
