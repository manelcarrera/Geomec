...
RescueFaultIntersection::RescueFaultIntersection(RescueModel *model, RescueSection *majorSectionIn,
                                                 RescueSection *minorSectionIn)
    : RescueHistoryObject(model->Context()), parentModel(model), majorSection(majorSectionIn),
      minorSection(minorSectionIn), edges(0), loopId(0), context(model->Context()), sectionEdges(0) {
...
RescueFaultIntersection::RescueFaultIntersection(RescueContext *contextIn, FILE *archiveFile)
    : RescueHistoryObject(contextIn), parentModel(0), majorSection(0), minorSection(0), edges(0), loopId(0),
      context(contextIn), sectionEdges(0) {
  isA = R_RescueFaultIntersection;
