...
RescueColorTableList::RescueColorTableList(RescueContext *context, RESCUEINT64 probableCount) : RescueObject(context) {
...
RescueColorTableList::RescueColorTableList(RescueContext *context, FILE *archiveFile) : RescueObject(context) {
