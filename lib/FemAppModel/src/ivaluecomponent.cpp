...
//////////////////////////////////////////////////////////////////////
IValueComponentBase::IValueComponentBase(unsigned int uName, IValueComposite &composite, unsigned int uComponent,
                                         unsigned int uMode)
...
IValueComponentBase::IValueComponentBase(const QString &sName, IValueComposite &composite, unsigned int uComponent,
                                         unsigned int uMode)
...
IValueComponentBase::IValueComponentBase(const IValueComponentBase &rhs) : CStorageNode(rhs) {}

const IValueDataInterfaceVector *IValueComponentBase::VectorData() const { return 0; }

IValueDataInterfaceVector *IValueComponentBase::VectorData() { return 0; }

const IValueDataInterfaceTensor *IValueComponentBase::TensorData() const { return 0; }

IValueDataInterfaceTensor *IValueComponentBase::TensorData() { return 0; }

const IValueDataInterface *IValueComponentBase::Data(int /*type*/) const { return 0; }

IValueDataInterface *IValueComponentBase::Data(int /*type*/) { return 0; }
...
bool IValueComponentBase::operator==(const IValueComponentBase &rhs) const { return CStorageNode::operator==(rhs); }
...
// Default we can map !!!
bool IValueComponentBase::CanMap(const COpenGLNode & /*node*/) const { return true; }

bool IValueComponentBase::CanComputeOnPoints() const { return true; }
...
int IValueComponentBase::MinMaxSteps(const geo::IObject &object) const {
  ...
  if (pElementSet)
    return pElementSet->ElementSize();
...
bool IValueComponentBase::NeedParallelInitializationCallback() const { return false; }

geo::IParallelInitializationCallback *IValueComponentBase::GetParallelInitializationCallback() { return 0; }

bool IValueComponentBase::PrepareMapping(const geo::IElementSet *pElementSet) {
  return Parent().PrepareMapping(pElementSet, this);
}

void IValueComponentBase::FinishMapping() { Parent().FinishMapping(); }
