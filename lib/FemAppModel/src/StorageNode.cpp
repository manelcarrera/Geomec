...
//////////////////////////////////////////////////////////////////////
CStorageNode::CStorageNode(CFemAppModel &model) : CGraphNode(""), m_nIndex(-1), m_model(model) {}
...
CStorageNode::CStorageNode(const CStorageNode &rhs) : CGraphNode(rhs), m_nIndex(-1), m_model(rhs.m_model) {}

CFemAppModel &CStorageNode::Model() { return m_model; }

const CFemAppModel &CStorageNode::Model() const { return m_model; }

CStorageNode::~CStorageNode() {}

int CStorageNode::Index() const { return m_nIndex; }
...
bool CStorageNode::operator==(const CStorageNode &rhs) const { return CGraphNode::operator==(rhs); }
...
void CStorageNode::InvalidateStorage() { Model().OnInvalidateStorage(); }

void CStorageNode::InvalidateCalculation(int nType) { Model().OnInvalidateCalculation(nType); }
