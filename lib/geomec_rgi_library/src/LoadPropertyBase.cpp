...
CLoadPropertyBase::CLoadPropertyBase(const RGProperty& rgProperty,
...
bool CLoadPropertyBase::loadProperty(const std::vector <geo::CValue>& vcValues,
...
bool CLoadPropertyBase::loadProperty(
...
void CLoadPropertyBase::linkValueTypes(CFormationBase& formation,
...
bool CLoadPropertyBase::addDelta(std::vector <geo::CValue>& /*vcNodalValues*/,
...
IValueDomainScalar::TValueVec CLoadPropertyBase::addDeltaSpecific(
...
bool CLoadPropertyBase::addDeltaBase(std::vector <geo::CValue>& vcNodalValues,
  const QString& strPropertyName, const CFormationBase* pFormation,
  const geo::IElement& elm, int nNod) const
{
...
bool CLoadPropertyBase::isAnisotropic() const
{
  return m_IsAnisotropic;
}

bool CLoadPropertyBase::enforceUniqueness(unsigned int uValueType) const
{
  return false;
}
...
bool CLoadPropertyBase::privateLoadProperty(
  const std::vector <std::vector <geo::CValue> >& vcValues,
...
bool CLoadPropertyBase::loadValues(std::vector <geo::CValue>& vcValues,
  const QString& strPropertyName) const
{
...
bool CLoadPropertyBase::assignValues2Elements(CElementValueSet& elementValueSet,
  bool& fluidPressureFracDetected,
  const std::vector <std::vector <geo::CValue> >& vcValues,
...
unsigned int CLoadPropertyBase::OverruleValueType(unsigned int uValueType) const
{
  return uValueType;
}


void CLoadPropertyBase::buildValueTypes(CValueType** pVT,
  CElementValueSet& elementValueSet, unsigned int uValueType) const
{
  if ((*pVT) == 0)
  {
...
void CLoadPropertyBase::linkValueTypes(CValueType* pVT,
...
void CLoadPropertyBase::addNodalValues(CElementValueSet& elementValueSet,
  int elementIndex, const std::vector <geo::CValue>& nodalValues) const
{
...
void CLoadPropertyBase::setAnisotropic(bool& isAnisotropic,
  bool& anisotropicIsSet, RGInterface& rgi, const CModelBase& modelBase,
...
void CLoadPropertyBase::unlinkValueTypes(CFormationBase& formation, unsigned int uValueType, const CDepletionStage& stage) const
{
