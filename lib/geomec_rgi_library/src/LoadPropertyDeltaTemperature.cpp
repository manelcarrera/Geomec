...
CLoadPropertyDeltaTemperature::CLoadPropertyDeltaTemperature(const RGProperty &rgProperty, RGInterface &rgi,
...
bool CLoadPropertyDeltaTemperature::addDelta(std::vector<geo::CValue> &vcNodalValues, const QString &strPropertyName,
...
IValueDomainScalar::TValueVec CLoadPropertyDeltaTemperature::addDeltaSpecific(const CDepletionStage &prevstage,
