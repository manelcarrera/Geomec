...
std::vector <int> mapMaterialModel2MaterialType(
...
std::vector <int> getMaterialTypes(const std::vector <CGraphNode*>& formations,
...
CGeomecMaterialModel2RGI::CGeomecMaterialModel2RGI(RGInterface& /*rgi*/,
...
std::vector <int> CGeomecMaterialModel2RGI::getMaterialTypes() const
{
