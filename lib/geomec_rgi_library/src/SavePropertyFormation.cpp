...
CSavePropertyFormation::CSavePropertyFormation(const RGProperty &rgProperty) : CSavePropertyBase(rgProperty) {}

CSavePropertyFormation::~CSavePropertyFormation() {}

bool CSavePropertyFormation::saveProperty(RGInterface &rgi, CModelBase &modelBase, const CRockMechProcessor & /*rmp*/) {
