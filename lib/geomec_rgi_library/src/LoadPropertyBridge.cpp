...
typedef GeomecRGI::CLoadPropertyTemplate<IDT_VALUETYPE_VOLUMETRICSTRAIN> TLoadPropertyDeltaDesorptionStrain;
typedef GeomecRGI::CLoadPropertyTemplate<IDT_VALUETYPE_POROSITY> TLoadPropertyPorosity;
typedef GeomecRGI::CLoadPropertyTemplate<IDT_VALUETYPE_RHOB> TLoadPropertySaturatedRockDensity;
typedef GeomecRGI::CLoadPropertyTemplate<IDT_VALUETYPE_VOLUMETRICSTRAIN> TLoadPropertyVolumetricStrain;
typedef GeomecRGI::CLoadPropertyTemplateWithFactor<IDT_VALUETYPE_YOUNGMODULUS_NORM> TLoadPropertyYoungNormal;
typedef GeomecRGI::CLoadPropertyTemplateWithFactor<IDT_VALUETYPE_YOUNGMODULUS_TRANS> TLoadPropertyYoungPlane;
typedef GeomecRGI::CLoadPropertyTemplate<IDT_VALUETYPE_POISSONRATIO_NORM> TLoadPropertyPoissonNormal;
typedef GeomecRGI::CLoadPropertyTemplate<IDT_VALUETYPE_POISSONRATIO_TRANS> TLoadPropertyPoissonPlane;

typedef GeomecRGI::CLoadPropertyTemplateRadials2Degrees<IDT_VALUETYPE_LAYER_NORMAL_INCL> TLoadPropertyOrientation_Dip;
typedef GeomecRGI::CLoadPropertyTemplateRadials2Degrees<IDT_VALUETYPE_LAYER_NORMAL_AZI>
    TLoadPropertyOrientation_Azimuth;

typedef GeomecRGI::CLoadPropertyTemplateWithFactor<IDT_VALUETYPE_ANISOTROPIC_SHEARMODULUS> TLoadPropertyShearNormal;

typedef GeomecRGI::CLoadPropertyTemplateWithFactor<IDT_VALUETYPE_GRAINSTIFFNESS> TLoadPropertyGrainBulkModulus;

typedef GeomecRGI::CLoadPropertyTemplate<IDT_VALUETYPE_NRMSTRAIN> TLoadPropertyStrainLoadingNormal;
typedef GeomecRGI::CLoadPropertyTemplate<IDT_VALUETYPE_LATSTRAIN> TLoadPropertyStrainLoadingPlane;

typedef GeomecRGI::CLoadPropertyTemplateWithFactor<IDT_VALUETYPE_UNDRAINEDYOUNG> TLoadPropertyYoungUndrained;
typedef GeomecRGI::CLoadPropertyTemplate<IDT_VALUETYPE_UNDRAINEDPOISSON> TLoadPropertyPoissonUndrained;

QSharedPointer<GeomecRGI::CLoadPropertyBase> selectLoadProperty(const RGProperty &rgProperty, RGInterface &rgi,
  ...
  case RGPropertyType::propElementPorosity:
    return QSharedPointer<TLoadPropertyPorosity>(new TLoadPropertyPorosity(rgProperty, rgi, modelBase, rmp));
    break;
  ...
  case RGPropertyType::propDeltaDesorptionStrain:
    return QSharedPointer<TLoadPropertyDeltaDesorptionStrain>(
        new TLoadPropertyDeltaDesorptionStrain(rgProperty, rgi, modelBase, rmp));
    break;
  ...
  case RGPropertyType::propElementShearModulus:
    return QSharedPointer<GeomecRGI::CLoadPropertyShearModulus>(
        new GeomecRGI::CLoadPropertyShearModulus(rgProperty, rgi, modelBase, rmp));
    break;
  ...
  case RGPropertyType::propElementYoungPlane:
    return QSharedPointer<TLoadPropertyYoungPlane>(new TLoadPropertyYoungPlane(rgProperty, rgi, modelBase, rmp, 1e-6));
    break;
  case RGPropertyType::propElementPoissonNormal:
    return QSharedPointer<TLoadPropertyPoissonNormal>(new TLoadPropertyPoissonNormal(rgProperty, rgi, modelBase, rmp));
    break;
  case RGPropertyType::propElementPoissonPlane:
    return QSharedPointer<TLoadPropertyPoissonPlane>(new TLoadPropertyPoissonPlane(rgProperty, rgi, modelBase, rmp));
    break;
  ...
  case RGPropertyType::propElementMaterialType:
    return QSharedPointer<GeomecRGI::CLoadPropertyMaterialType>(
        new GeomecRGI::CLoadPropertyMaterialType(rgProperty, rgi, modelBase, rmp));
    break;
  case RGPropertyType::propElementGrainBulkModulus:
    return QSharedPointer<TLoadPropertyGrainBulkModulus>(
        new TLoadPropertyGrainBulkModulus(rgProperty, rgi, modelBase, rmp, 1e-6));
    break;
  ...
  case RGPropertyType::propElementResidualStrainLoading_NN:
    return QSharedPointer<GeomecRGI::CLoadPropertyBase>(new GeomecRGI::CLoadPropertyResidualStrainLoading(
        rgProperty, rgi, modelBase, rmp, ITensorGroup::CComponentComposite::TC_XX));
    break;
  case RGPropertyType::propElementResidualStrainLoading_EE:
    return QSharedPointer<GeomecRGI::CLoadPropertyBase>(new GeomecRGI::CLoadPropertyResidualStrainLoading(
        rgProperty, rgi, modelBase, rmp, ITensorGroup::CComponentComposite::TC_YY));
    break;
  case RGPropertyType::propElementResidualStrainLoading_DD:
    return QSharedPointer<GeomecRGI::CLoadPropertyBase>(new GeomecRGI::CLoadPropertyResidualStrainLoading(
        rgProperty, rgi, modelBase, rmp, ITensorGroup::CComponentComposite::TC_ZZ));
    break;
  case RGPropertyType::propElementResidualStrainLoading_NE:
    return QSharedPointer<GeomecRGI::CLoadPropertyBase>(new GeomecRGI::CLoadPropertyResidualStrainLoading(
        rgProperty, rgi, modelBase, rmp, ITensorGroup::CComponentComposite::TC_XY));
    break;
  case RGPropertyType::propElementResidualStrainLoading_ND:
    return QSharedPointer<GeomecRGI::CLoadPropertyBase>(new GeomecRGI::CLoadPropertyResidualStrainLoading(
        rgProperty, rgi, modelBase, rmp, ITensorGroup::CComponentComposite::TC_ZX));
    break;
  case RGPropertyType::propElementResidualStrainLoading_ED:
    return QSharedPointer<GeomecRGI::CLoadPropertyBase>(new GeomecRGI::CLoadPropertyResidualStrainLoading(
        rgProperty, rgi, modelBase, rmp, ITensorGroup::CComponentComposite::TC_YZ));
    break;
...
CLoadPropertyBridge::CLoadPropertyBridge(const RGProperty &rgProperty, RGInterface &rgi, CModelBase &modelBase,
...
bool CLoadPropertyBridge::loadProperty() { return m_LoadPropertyBase->loadProperty(); }
