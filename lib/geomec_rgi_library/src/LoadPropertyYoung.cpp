...
CLoadPropertyYoung::CLoadPropertyYoung(const RGProperty& rgProperty,
...
{
  return CCalculateShearModulus::loadProperty <CLoadPropertyYoung,
  IDT_VALUETYPE_YOUNGS_MODULUS, IDT_VALUETYPE_YOUNGMODULUS_NORM,
