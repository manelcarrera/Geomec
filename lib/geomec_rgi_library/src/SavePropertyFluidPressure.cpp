...
CSavePropertyFluidPressure::CSavePropertyFluidPressure(const RGProperty &rgProperty) : CSavePropertyBase(rgProperty) {}

CSavePropertyFluidPressure::~CSavePropertyFluidPressure() {}

bool CSavePropertyFluidPressure::saveProperty(RGInterface &rgi, CModelBase &modelBase,
