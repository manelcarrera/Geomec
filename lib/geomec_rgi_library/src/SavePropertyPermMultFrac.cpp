...
CSavePropertyPermMultFrac::CSavePropertyPermMultFrac(const RGProperty &rgProperty, TDensityDirection densityDirection)
    : CSavePropertyBase(rgProperty), m_DensityDirection(densityDirection) {}

CSavePropertyPermMultFrac::~CSavePropertyPermMultFrac() {}

bool CSavePropertyPermMultFrac::saveProperty(RGInterface &rgi, CModelBase &modelBase, const CRockMechProcessor &rmp) {
  ...
  const IScalarResultComponent *scalarResultComponent = getScalarResultComponent(modelBase, depletionStage);
...
std::pair<double, bool> CSavePropertyPermMultFrac::getLength(const IScalarResultComponent *scalarResultComponent,
                                                             const CModelBase &modelBase,
                                                             const geo::IElement &element) const {
  IValueDomainScalar::TValueVec values(element.NrOfPoints());

  scalarResultComponent->ElementValues(values, element, modelBase.Mesh().ValueUnit(),
...
const IScalarResultComponent *
CSavePropertyPermMultFrac::getScalarResultComponent(CModelBase &modelBase,
...
geo::CVector
CSavePropertyPermMultFrac::getVector(const CFFMaterial &cffMaterial,
