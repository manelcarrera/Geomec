...
void addTrianglesCount(GeomecRGI::TSharedBodyTriangleMap& triangleMap,
  GeomecRGI::TSharedBodyTriangle& sharedBodyTriangle, int* nodes,
...
CCalculateBoundingSurfaces::CCalculateBoundingSurfaces(
  geo::IElementSet& elementSet)
: m_SharedBodyTriangleMap(collectTriangles(elementSet))
{
}

const TSharedBodyTriangleMap&
  CCalculateBoundingSurfaces::getSharedBodyTriangleMap() const
{
