...
CSavePropertyBodyIndex::CSavePropertyBodyIndex(const RGProperty &rgProperty) : CSavePropertyBase(rgProperty) {}

CSavePropertyBodyIndex::~CSavePropertyBodyIndex() {}

bool CSavePropertyBodyIndex::saveProperty(RGInterface &rgi, CModelBase &modelBase, const CRockMechProcessor & /*rmp*/) {
  CGeomecFormationVolumeIDs2RGI geomecFormationVolumeIDs2RGI(rgi, modelBase);
  std::vector<int> values = geomecFormationVolumeIDs2RGI.getFormationVolumeIDs();
