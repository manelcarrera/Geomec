...
{
  public:
  CLoadPropertyMaterialType(const RGProperty& rgProperty, RGInterface& rgi,
  ...
  CLoadPropertyMaterialType& operator = (
      const CLoadPropertyMaterialType& rhs);

  bool mapMaterialType2MaterialModel(std::vector <int>& materialModels,
