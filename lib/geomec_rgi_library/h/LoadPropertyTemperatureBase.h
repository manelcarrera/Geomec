...
class CLoadPropertyTemperatureBase : public CLoadPropertyTemplate<IDT_VALUETYPE_TEMPERATURE> {
public:
  CLoadPropertyTemperatureBase(const RGProperty &rgProperty, RGInterface &rgi, CModelBase &modelBase,
...
private:
  ...
  CLoadPropertyTemperatureBase &operator=(const CLoadPropertyTemperatureBase &rhs);
};
