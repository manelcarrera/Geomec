...
public:
  CLoadPropertyDeltaTemperature(const RGProperty &rgProperty, RGInterface &rgi, CModelBase &modelBase,
...
private:
  ...
  CLoadPropertyDeltaTemperature &operator=(const CLoadPropertyDeltaTemperature &rhs);
};
