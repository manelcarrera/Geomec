...
public:
  CLoadPropertyDeltaFluidPressure(const RGProperty &rgProperty, RGInterface &rgi, CModelBase &modelBase,
...
private:
  ...
  CLoadPropertyDeltaFluidPressure &operator=(const CLoadPropertyDeltaFluidPressure &rhs);
