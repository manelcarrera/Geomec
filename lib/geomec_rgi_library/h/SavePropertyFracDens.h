...
public:
  ...
  enum TVectorDirection { X, Y, Z };

  CSavePropertyFracDens(const RGProperty &rgProperty, TDensityDirection densityDirection,
...
private:
  ...
  CSavePropertyFracDens &operator=(const CSavePropertyFracDens &rhs);
