...
template <unsigned int VALUETYPE> class CSavePropertyTemplateDegrees2Radials : public CSavePropertyTemplate<VALUETYPE> {
public:
...
private:
  CSavePropertyTemplateDegrees2Radials(const CSavePropertyTemplateDegrees2Radials &rhs);
  CSavePropertyTemplateDegrees2Radials &operator=(const CSavePropertyTemplateDegrees2Radials &rhs);
};

template <unsigned int VALUETYPE>
CSavePropertyTemplateDegrees2Radials<VALUETYPE>::CSavePropertyTemplateDegrees2Radials(const RGProperty &rgProperty)
    : CSavePropertyTemplate<VALUETYPE>(rgProperty) {}

template <unsigned int VALUETYPE>
CSavePropertyTemplateDegrees2Radials<VALUETYPE>::~CSavePropertyTemplateDegrees2Radials() {}
...
template <unsigned int VALUETYPE>
bool CSavePropertyTemplateDegrees2Radials<VALUETYPE>::saveProperty(RGInterface &rgi, CModelBase &modelBase,
