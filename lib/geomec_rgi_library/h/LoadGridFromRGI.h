...
class CLoadGridFromRGI
{
  public:
    ...
    {
      bool operator () (const geo::IFace* lhs, const geo::IFace* rhs) const
      {
        return *lhs < *rhs;
      }
    };
    ...
    typedef std::pair <TSharedBodyTriangle, TSharedBodyTriangle>
      TTrianglePair;
    ...
    CLoadGridFromRGI(CModelBase& model, RGInterface& rgi,
  ...
  private:
    ...
    void insertElements(TIndices& elementIndices, TIndices& nodeIndices, TPolygonInfo& polygonInfo, TPolygonMap& polygonMap);

    void constructFormations(std::vector <QString>& formationNames,
    ...
    TNodes2Triangles createNodes2TrianglesMapping(
      std::vector <TSharedBodyTriangleMap> trianglesPerVolume) const;

    void constructFaults(TFaceDescriptorMap& linkFace2Horizon,
    ...
    void constructHorizons(TFaceDescriptorMap& linkFace2Horizon,
      TFaceDescriptorMap& linkFace2SurfaceDescriptor,
      const TNodes2Triangles& nodes2Triangles, const TIndices& nodeIndices);
    void constructSideSurfaces(TFaceDescriptorMap& linkFace2SurfaceDescriptor,
      const TNodes2Triangles& nodes2Triangles, const TIndices& nodeIndices);
    void constructFormationVolumes(TFaceDescriptorMap& linkFace2Horizon,
      TFaceDescriptorMap& linkFace2SurfaceDescriptor,
      std::map <int, int>& formationVolume2VolumeMapping,
      const std::vector <TSharedBodyTriangleMap>& trianglesPerVolume,
      std::vector <QString>& formationNames);

    void constructFaceDescriptorMap(
      TFaceDescriptorMap& linkFace2SurfaceDescriptor,
      const CMeshSurface* meshSurface) const;
    void constructFault(TFaceDescriptorMap& linkFace2Horizon,
      TFaceDescriptorMap& linkFace2SurfaceDescriptor,
      const TNodes2Triangles& nodes2Triangles, const TIndices& nodeIndices, const TPolygonInfo& polygonInfo,
      const RGSurface& back, const RGSurface& front) const;
    CMeshSurface* constructMeshSurface(const RGSurface& surface,
      const TNodes2Triangles& nodes2Triangles,
      const TIndices& nodeIndices) const;
    void constructRegularHorizon(TFaceDescriptorMap& linkFace2Horizon,
      TFaceDescriptorMap& linkFace2SurfaceDescriptor,
      const TNodes2Triangles& nodes2Triangles, const TIndices& nodeIndices,
      const RGSurface& horizon) const;
    void constructTopBottomHorizon(TFaceDescriptorMap& linkFace2Horizon,
      TFaceDescriptorMap& linkFace2SurfaceDescriptor,
      const TNodes2Triangles& nodes2Triangles, const TIndices& nodeIndices,
      const RGSurface& horizon) const;
    std::vector <CMeshSurface*> extrapolateMeshSurfaces(
