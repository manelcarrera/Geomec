...
class CLoadPropertyPressureBase : public CLoadPropertyTemplate<IDT_VALUETYPE_PRESSURE> {
public:
  CLoadPropertyPressureBase(const RGProperty &rgProperty, RGInterface &rgi, CModelBase &modelBase,
...
private:
  ...
  CLoadPropertyPressureBase &operator=(const CLoadPropertyPressureBase &rhs);
};
