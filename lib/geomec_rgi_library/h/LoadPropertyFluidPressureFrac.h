...
public:
  CLoadPropertyFluidPressureFrac(const RGProperty &rgProperty, RGInterface &rgi, CModelBase &modelBase,
...
private:
  ...
  CLoadPropertyFluidPressureFrac &operator=(const CLoadPropertyFluidPressureFrac &rhs);
};
