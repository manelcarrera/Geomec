...
public:
  CGeomecFormationVolumeIDs2RGI(RGInterface &rgi, const CModelBase &modelBase);
...
private:
  ...
  CGeomecFormationVolumeIDs2RGI &operator=(const CGeomecFormationVolumeIDs2RGI &rhs);
