...
template <unsigned int VALUETYPE> class CSavePropertyTemplateWithFactor : public CSavePropertyTemplate<VALUETYPE> {
public:
  CSavePropertyTemplateWithFactor(const RGProperty &rgProperty, double factor);
...
private:
  ...
  CSavePropertyTemplateWithFactor &operator=(const CSavePropertyTemplateWithFactor &rhs);

  double m_factor;
};

template <unsigned int VALUETYPE>
CSavePropertyTemplateWithFactor<VALUETYPE>::CSavePropertyTemplateWithFactor(const RGProperty &rgProperty, double factor)
    : CSavePropertyTemplate<VALUETYPE>(rgProperty), m_factor(factor) {}

template <unsigned int VALUETYPE> CSavePropertyTemplateWithFactor<VALUETYPE>::~CSavePropertyTemplateWithFactor() {}

struct CMultiply {
  CMultiply(double factor) : m_factor(factor) {}
...
template <unsigned int VALUETYPE>
bool CSavePropertyTemplateWithFactor<VALUETYPE>::saveProperty(RGInterface &rgi, CModelBase &modelBase,
