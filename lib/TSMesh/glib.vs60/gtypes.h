...
typedef gint (*GCompareFuncData)(gconstpointer a, gconstpointer b, gpointer user_data);
...
#define GUINT16_SWAP_LE_BE_CONSTANT(val)                                                                               \
  ((guint16)((((guint16)(val) & (guint16)0x00ffU) << 8) | (((guint16)(val) & (guint16)0xff00U) >> 8)))
#define GUINT32_SWAP_LE_BE_CONSTANT(val)                                                                               \
  ((guint32)((((guint32)(val) & (guint32)0x000000ffU) << 24) | (((guint32)(val) & (guint32)0x0000ff00U) << 8) |        \
...
#define GUINT16_SWAP_LE_BE_X86(val)                                                                                    \
  (__extension__({                                                                                                     \
    ...
    if (__builtin_constant_p(val))                                                                                     \
      ...
      __asm__ __const__("rorw $8, %w0" : "=r"(__v) : "0"((guint16)(val)));                                             \
    __v;                                                                                                               \
  }))
#define GUINT16_SWAP_LE_BE(val) (GUINT16_SWAP_LE_BE_X86(val))
#if !defined(__i486__) && !defined(__i586__) && !defined(__pentium__) && !defined(__i686__) && !defined(__pentiumpro__)
...
#define GUINT32_SWAP_LE_BE_X86(val)                                                                                    \
  (__extension__({                                                                                                     \
    ...
    if (__builtin_constant_p(val))                                                                                     \
      ...
      __asm__ __const__("bswap %0" : "=r"(__v) : "0"((guint32)(val)));                                                 \
    __v;                                                                                                               \
  }))
...
#define GUINT64_SWAP_LE_BE_CONSTANT(val)                                                                               \
  ((guint64)((((guint64)(val) & (guint64)G_GINT64_CONSTANT(0x00000000000000ffU)) << 56) |                              \
...
#define GUINT32_SWAP_LE_PDP(val)                                                                                       \
  ((guint32)((((guint32)(val) & (guint32)0x0000ffffU) << 16) | (((guint32)(val) & (guint32)0xffff0000U) >> 16)))
#define GUINT32_SWAP_BE_PDP(val)                                                                                       \
  ((guint32)((((guint32)(val) & (guint32)0x00ff00ffU) << 8) | (((guint32)(val) & (guint32)0xff00ff00U) >> 8)))
