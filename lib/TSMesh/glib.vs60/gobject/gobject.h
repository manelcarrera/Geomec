...
struct _GObjectClass {
  ...
  void (*set_property)(GObject *object, guint property_id, const GValue *value, GParamSpec *pspec,
                       const gchar *trailer);
  void (*get_property)(GObject *object, guint property_id, GValue *value, GParamSpec *pspec, const gchar *trailer);
  ...
  /* signals */
  void (*properties_changed)(GObject *object, guint n_pspecs, GParamSpec **pspecs);
...
gpointer g_object_new_valist(GType object_type, const gchar *first_property_name, va_list var_args);
...
GClosure *g_cclosure_new_object(GCallback callback_func, gpointer object);
...
guint g_signal_connect_object(gpointer instance, const gchar *detailed_signal, GCallback c_handler, gpointer gobject,
                              gboolean swapped, gboolean after);
...
#define G_OBJECT_WARN_INVALID_PROPERTY_ID(object, property_id, pspec)                                                  \
  G_STMT_START {                                                                                                       \
    ...
    g_warning("%s: invalid property id %u for \"%s\" of type `%s' in `%s'", G_STRLOC, _property_id, _pspec->name,      \
              g_type_name(G_PARAM_SPEC_TYPE(_pspec)), G_OBJECT_TYPE_NAME(_object));                                    \
  }                                                                                                                    \
  G_STMT_END
