...
/* --- prototypes --- */
void g_value_set_char(GValue *value, gint8 v_char);
gint8 g_value_get_char(const GValue *value);
void g_value_set_uchar(GValue *value, guint8 v_uchar);
...
void g_value_set_ccallback(GValue *value, gpointer callback_func, gpointer callback_data);
void g_value_get_ccallback(const GValue *value, gpointer *callback_func, gpointer *callback_data);
