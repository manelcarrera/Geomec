  ...
  G_STMT_START {                                                                                                       \
    ...
    while (_collect_type && !_error_msg) {                                                                             \
      ...
      case G_VALUE_COLLECT_POINTER:                                                                                    \
        ...
        break;                                                                                                         \
      default:                                                                                                         \
        _error_msg = g_strdup_printf("%s: invalid collect type (%d) used for %s", G_STRLOC, _collect_type,             \
                                     "G_VALUE_COLLECT()");                                                             \
        continue;                                                                                                      \
      }                                                                                                                \
      _error_msg = _vtable->collect_value(_value, _nth_value++, &_collect_type, &_cvalue);                             \
    }                                                                                                                  \
    *(__error) = _error_msg;                                                                                           \
  }                                                                                                                    \
  G_STMT_END
...
#define G_VALUE_LCOPY(value, var_args, __error)                                                                        \
  G_STMT_START {                                                                                                       \
    ...
    while (_lcopy_type && !_error_msg) {                                                                               \
      ...
      default:                                                                                                         \
        _error_msg =                                                                                                   \
            g_strdup_printf("%s: invalid collect type (%d) used for %s", G_STRLOC, _lcopy_type, "G_VALUE_LCOPY()");    \
        continue;                                                                                                      \
      }                                                                                                                \
      _error_msg = _vtable->lcopy_value(_value, _nth_value++, &_lcopy_type, &_cvalue);                                 \
    }                                                                                                                  \
    *(__error) = _error_msg;                                                                                           \
  }                                                                                                                    \
  G_STMT_END
