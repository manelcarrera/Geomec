...
{ G_TYPE_FLAG_CLASSED = (1 << 0),
  ...
  G_TYPE_FLAG_DEEP_DERIVABLE = (1 << 3) } GTypeFundamentalFlags;
typedef enum /*< skip >*/
{ G_TYPE_FLAG_ABSTRACT = (1 << 4) } GTypeFlags;
struct _GTypeInfo {
...
struct _GTypeValueTable {
  ...
  guint collect_type;
  gchar *(*collect_value)(GValue *value, guint nth_value, GType *collect_type, GTypeCValue *collect_value);
  guint lcopy_type;
  gchar *(*lcopy_value)(const GValue *value, guint nth_value, GType *collect_type, GTypeCValue *collect_value);
};
...
GType g_type_register_fundamental(GType type_id, const gchar *type_name, const GTypeInfo *info,
...
GTypePlugin *g_type_interface_get_plugin(GType instance_type, GType implementation_type);

GType g_type_fundamental_last(void);
gboolean g_type_check_flags(GType type, guint flags);
...
gboolean g_type_instance_is_a(GTypeInstance *instance, GType iface_type);
gboolean g_type_check_value(GValue *value);
gboolean g_type_value_is_a(GValue *value, GType type);
