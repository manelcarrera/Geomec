...
#define G_GNUC_PRINTF(format_idx, arg_idx) __attribute__((format(printf, format_idx, arg_idx)))
#define G_GNUC_SCANF(format_idx, arg_idx) __attribute__((format(scanf, format_idx, arg_idx)))
#define G_GNUC_FORMAT(arg_idx) __attribute__((format_arg(arg_idx)))
