...
guint g_io_add_watch_full(GIOChannel *channel, gint priority, GIOCondition condition, GIOFunc func, gpointer user_data,
 ...
 */
gint g_io_channel_win32_poll(GPollFD *fds, gint n_fds, gint timeout);

/* This is used to add polling for Windows messages. GDK (GTk+) programs
 * should *not* use this.
 */
void g_main_poll_win32_msg_add(gint priority, GPollFD *fd, guint hwnd);
