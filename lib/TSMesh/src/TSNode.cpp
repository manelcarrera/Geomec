...
bool CTSNode::Empty() const { return m_pVertex == 0; }

void CTSNode::AssertValid() const { assert(m_pVertex); }
...
GtsVertex *CTSNode::Vertex() { return m_pVertex; }

const GtsVertex *CTSNode::Vertex() const { return m_pVertex; }

CCSNode::CCSNode() { m_vcCoor.clear(); }
...
void CCSNode::AssertValid() const { assert(!Empty()); }

bool CCSNode::Empty() const { return m_vcCoor.size() == 0; }
