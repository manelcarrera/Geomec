...
#define GTS_CHECK_VERSION(major, minor, micro)                                                                         \
  (gts_major_version > (major) || (gts_major_version == (major) && gts_minor_version > (minor)) ||                     \
...
#define GTS_OBJECT(obj) GTS_OBJECT_CAST(obj, GtsObject, gts_object_class())
#define GTS_OBJECT_CLASS(klass) GTS_OBJECT_CLASS_CAST(klass, GtsObjectClass, gts_object_class())
#define GTS_IS_OBJECT(obj) (gts_object_is_from_class(obj, gts_object_class()))

typedef enum { GTS_DESTROYED = 1 << 0 } GtsObjectFlags;
...
#define GTS_OBJECT_SET_FLAGS(obj, flag)                                                                                \
  G_STMT_START { (GTS_OBJECT_FLAGS(obj) |= (flag)); }                                                                  \
  G_STMT_END
...
#define GTS_IS_POINT(obj) (gts_object_is_from_class(obj, gts_point_class()))
#define GTS_POINT(obj) GTS_OBJECT_CAST(obj, GtsPoint, gts_point_class())
#define GTS_POINT_CLASS(klass) GTS_OBJECT_CLASS_CAST(klass, GtsPointClass, gts_point_class())
...
#define gts_point_is_in_rectangle(p, p1, p2)                                                                           \
  ((p)->x >= (p1)->x && (p)->x <= (p2)->x && (p)->y >= (p1)->y && (p)->y <= (p2)->y && (p)->z >= (p1)->z &&            \
   (p)->z <= (p2)->z)
...
#define GTS_IS_VERTEX(obj) (gts_object_is_from_class(obj, gts_vertex_class()))
#define GTS_VERTEX(obj) GTS_OBJECT_CAST(obj, GtsVertex, gts_vertex_class())
#define GTS_VERTEX_CLASS(klass) GTS_OBJECT_CLASS_CAST(klass, GtsVertexClass, gts_vertex_class())
struct _GtsVertex {
  GtsPoint p;
...
#define GTS_IS_SEGMENT(obj) (gts_object_is_from_class(obj, gts_segment_class()))
#define GTS_SEGMENT(obj) GTS_OBJECT_CAST(obj, GtsSegment, gts_segment_class())
#define GTS_SEGMENT_CLASS(klass) GTS_OBJECT_CLASS_CAST(klass, GtsSegmentClass, gts_segment_class())
...
#define gts_segment_connect(s, e1, e2) (((s)->v1 == e1 && (s)->v2 == e2) || ((s)->v1 == e2 && (s)->v2 == e1))
#define gts_segments_are_identical(s1, s2)                                                                             \
  (((s1)->v1 == (s2)->v1 && (s1)->v2 == (s2)->v2) || ((s1)->v1 == (s2)->v2 && (s1)->v2 == (s2)->v1))
...
#define GTS_IS_EDGE(obj) (gts_object_is_from_class(obj, gts_edge_class()))
#define GTS_EDGE(obj) GTS_OBJECT_CAST(obj, GtsEdge, gts_edge_class())
#define GTS_EDGE_CLASS(klass) GTS_OBJECT_CLASS_CAST(klass, GtsEdgeClass, gts_edge_class())
...
#define GTS_IS_TRIANGLE(obj) (gts_object_is_from_class(obj, gts_triangle_class()))
#define GTS_TRIANGLE(obj) GTS_OBJECT_CAST(obj, GtsTriangle, gts_triangle_class())
#define GTS_TRIANGLE_CLASS(klass) GTS_OBJECT_CLASS_CAST(klass, GtsTriangleClass, gts_triangle_class())
...
#define gts_triangle_vertex(t)                                                                                         \
  (GTS_SEGMENT(GTS_TRIANGLE(t)->e1)->v1 == GTS_SEGMENT(GTS_TRIANGLE(t)->e2)->v1 ||                                     \
           GTS_SEGMENT(GTS_TRIANGLE(t)->e1)->v2 == GTS_SEGMENT(GTS_TRIANGLE(t)->e2)->v1                                \
...
void gts_triangle_vertices_edges(GtsTriangle *t, GtsEdge *e, GtsVertex **v1, GtsVertex **v2, GtsVertex **v3,
...
#define GTS_IS_FACE(obj) (gts_object_is_from_class(obj, gts_face_class()))
#define GTS_FACE(obj) GTS_OBJECT_CAST(obj, GtsFace, gts_face_class())
#define GTS_FACE_CLASS(klass) GTS_OBJECT_CLASS_CAST(klass, GtsFaceClass, gts_face_class())
...
#define gts_vector_init(v, p1, p2) ((v)[0] = (p2)->x - (p1)->x, (v)[1] = (p2)->y - (p1)->y, (v)[2] = (p2)->z - (p1)->z)
#define gts_vector_scalar(v1, v2) ((v1)[0] * (v2)[0] + (v1)[1] * (v2)[1] + (v1)[2] * (v2)[2])
GtsMatrix *gts_matrix_new(gdouble a00, gdouble a01, gdouble a02, gdouble a10, gdouble a11, gdouble a12, gdouble a20,
                          gdouble a21, gdouble a22);
void gts_matrix_assign(GtsMatrix *m, gdouble a00, gdouble a01, gdouble a02, gdouble a10, gdouble a11, gdouble a12,
...
#define GTS_IS_BBOX(obj) (gts_object_is_from_class(obj, gts_bbox_class()))
#define GTS_BBOX(obj) GTS_OBJECT_CAST(obj, GtsBBox, gts_bbox_class())
#define GTS_BBOX_CLASS(klass) GTS_OBJECT_CLASS_CAST(klass, GtsBBoxClass, gts_bbox_class())
...
GtsBBox *gts_bbox_new(GtsBBoxClass *klass, gpointer bounded, gdouble x1, gdouble y1, gdouble z1, gdouble x2, gdouble y2,
                      gdouble z2);
void gts_bbox_set(GtsBBox *bbox, gpointer bounded, gdouble x1, gdouble y1, gdouble z1, gdouble x2, gdouble y2,
                  gdouble z2);
...
#define gts_bbox_point_is_inside(bbox, p)                                                                              \
  ((p)->x >= (bbox)->x1 && (p)->y >= (bbox)->y1 && (p)->z >= (bbox)->z1 && (p)->x <= (bbox)->x2 &&                     \
   (p)->y <= (bbox)->y2 && (p)->z <= (bbox)->z2)
...
void gts_bb_tree_triangle_distance(GNode *tree, GtsTriangle *t, GtsBBoxDistFunc distance, gdouble delta,
                                   GtsRange *range);
void gts_bb_tree_surface_distance(GNode *tree, GtsSurface *s, GtsBBoxDistFunc distance, gdouble delta, GtsRange *range);
void gts_bb_tree_surface_boundary_distance(GNode *tree, GtsSurface *s, GtsBBoxDistFunc distance, gdouble delta,
                                           GtsRange *range);
...
#define GTS_IS_SURFACE(obj) (gts_object_is_from_class(obj, gts_surface_class()))
#define GTS_SURFACE(obj) GTS_OBJECT_CAST(obj, GtsSurface, gts_surface_class())
#define GTS_SURFACE_CLASS(klass) GTS_OBJECT_CLASS_CAST(klass, GtsSurfaceClass, gts_surface_class())
...
#define GTS_IS_SURFACE_INTER(obj) (gts_object_is_from_class(obj, gts_surface_inter_class()))
#define GTS_SURFACE_INTER(obj) GTS_OBJECT_CAST(obj, GtsSurfaceInter, gts_surface_inter_class())
#define GTS_SURFACE_INTER_CLASS(klass) GTS_OBJECT_CLASS_CAST(klass, GtsSurfaceInterClass, gts_surface_inter_class())
...
GtsSurfaceInter *gts_surface_inter_new(GtsSurfaceInterClass *klass, GtsSurface *s1, GtsSurface *s2, GNode *faces_tree1,
                                       GNode *faces_tree2);
...
#define GTS_IS_SPLIT(obj) (gts_object_is_from_class(obj, gts_split_class()))
#define GTS_SPLIT(obj) GTS_OBJECT_CAST(obj, GtsSplit, gts_split_class())
#define GTS_SPLIT_CLASS(klass) GTS_OBJECT_CLASS_CAST(klass, GtsSplitClass, gts_split_class())
#define GTS_SPLIT_V1(vs) (GTS_IS_SPLIT((vs)->v1) ? GTS_SPLIT((vs)->v1)->v : GTS_VERTEX((vs)->v1))
#define GTS_SPLIT_V2(vs) (GTS_IS_SPLIT((vs)->v2) ? GTS_SPLIT((vs)->v2)->v : GTS_VERTEX((vs)->v2))
...
#define GTS_IS_PSURFACE(obj) (gts_object_is_from_class(obj, gts_psurface_class()))
#define GTS_PSURFACE(obj) GTS_OBJECT_CAST(obj, GtsPSurface, gts_psurface_class())
#define GTS_PSURFACE_CLASS(klass) GTS_OBJECT_CLASS_CAST(klass, GtsPSurfaceClass, gts_psurface_class())
#define GTS_PSURFACE_IS_CLOSED(ps) (!(ps)->vertices)

GtsPSurfaceClass *gts_psurface_class(void);
GtsPSurface *gts_psurface_new(GtsPSurfaceClass *klass, GtsSurface *surface, GtsSplitClass *split_class,
                              GtsKeyFunc cost_func, gpointer cost_data, GtsCoarsenFunc coarsen_func,
                              gpointer coarsen_data, GtsStopFunc stop_func, gpointer stop_data, gdouble minangle);
...
GtsPSurface *gts_psurface_open(GtsPSurfaceClass *klass, GtsSurface *s, GtsSplitClass *split_class, FILE *fptr,
                               guint *line);
...
#define GTS_IS_HSPLIT(obj) (gts_object_is_from_class(obj, gts_hsplit_class()))
#define GTS_HSPLIT(obj) GTS_OBJECT_CAST(obj, GtsHSplit, gts_hsplit_class())
#define GTS_HSPLIT_CLASS(klass) GTS_OBJECT_CLASS_CAST(klass, GtsHSplitClass, gts_hsplit_class())
...
struct _GtsHSurface {
  ...
  GtsSurface *s;
  GSList *roots;
  GtsEHeap *expandable, *collapsable;
  GPtrArray *split;
  guint nvertex;
};
...
#define GTS_IS_HSURFACE(obj) (gts_object_is_from_class(obj, gts_hsurface_class()))
#define GTS_HSURFACE(obj) GTS_OBJECT_CAST(obj, GtsHSurface, gts_hsurface_class())
#define GTS_HSURFACE_CLASS(klass) GTS_OBJECT_CLASS_CAST(klass, GtsHSurfaceClass, gts_hsurface_class())

GtsHSurfaceClass *gts_hsurface_class(void);
GtsHSurface *gts_hsurface_new(GtsHSurfaceClass *klass, GtsHSplitClass *hsplit_class, GtsPSurface *psurface,
                              GtsKeyFunc expand_key, gpointer expand_data, GtsKeyFunc collapse_key,
                              gpointer collapse_data);
void gts_hsurface_traverse(GtsHSurface *hsurface, GTraverseType order, gint depth, GtsSplitTraverseFunc func,
                           gpointer data);
...
#define GTS_IS_CONSTRAINT(obj) (gts_object_is_from_class(obj, gts_constraint_class()))
#define GTS_CONSTRAINT(obj) GTS_OBJECT_CAST(obj, GtsConstraint, gts_constraint_class())
#define GTS_CONSTRAINT_CLASS(klass) GTS_OBJECT_CLASS_CAST(klass, GtsConstraintClass, gts_constraint_class())
...
guint gts_delaunay_refine(GtsSurface *surface, gint steiner_max, GtsEncroachFunc encroaches, gpointer encroach_data,
                          GtsKeyFunc cost, gpointer cost_data);
...
void gts_iso_slice_fill(GtsIsoSlice *slice, GtsGridPlane *plane1, GtsGridPlane *plane2, gdouble **f1, gdouble **f2,
                        gdouble iso, GtsVertexClass *klass);
void gts_iso_slice_fill_cartesian(GtsIsoSlice *slice, GtsCartesianGrid g, gdouble **f1, gdouble **f2, gdouble iso,
...
void gts_isosurface_cartesian(GtsSurface *surface, GtsCartesianGrid g, GtsIsoCartesianFunc f, gpointer data,
                              gdouble iso);
...
#define GTS_NVERTEX(obj) GTS_OBJECT_CAST(obj, GtsNVertex, gts_nvertex_class())
#define GTS_NVERTEX_CLASS(klass) GTS_OBJECT_CLASS_CAST(klass, GtsNVertexClass, gts_nvertex_class())
#define GTS_IS_NVERTEX(obj) (gts_object_is_from_class(obj, gts_nvertex_class()))
...
#define GTS_NEDGE(obj) GTS_OBJECT_CAST(obj, GtsNEdge, gts_nedge_class())
#define GTS_NEDGE_CLASS(klass) GTS_OBJECT_CLASS_CAST(klass, GtsNEdgeClass, gts_nedge_class())
#define GTS_IS_NEDGE(obj) (gts_object_is_from_class(obj, gts_nedge_class()))
...
#define GTS_NFACE(obj) GTS_OBJECT_CAST(obj, GtsNFace, gts_nface_class())
#define GTS_NFACE_CLASS(klass) GTS_OBJECT_CLASS_CAST(klass, GtsNFaceClass, gts_nface_class())
#define GTS_IS_NFACE(obj) (gts_object_is_from_class(obj, gts_nface_class()))
...
#define GTS_CLUSTER(obj) GTS_OBJECT_CAST(obj, GtsCluster, gts_cluster_class())
#define GTS_CLUSTER_CLASS(klass) GTS_OBJECT_CLASS_CAST(klass, GtsClusterClass, gts_cluster_class())
...
#define GTS_CLUSTER_GRID(obj) GTS_OBJECT_CAST(obj, GtsClusterGrid, gts_cluster_grid_class())
#define GTS_CLUSTER_GRID_CLASS(klass) GTS_OBJECT_CLASS_CAST(klass, GtsClusterGridClass, gts_cluster_grid_class())
#define GTS_IS_CLUSTER_GRID(obj) (gts_object_is_from_class(obj, gts_cluster_grid_class()))
...
GtsClusterGrid *gts_cluster_grid_new(GtsClusterGridClass *klass, GtsClusterClass *cluster_class, GtsSurface *s,
                                     GtsBBox *bbox, gdouble delta);
void gts_cluster_grid_add_triangle(GtsClusterGrid *cluster_grid, GtsPoint *p1, GtsPoint *p2, GtsPoint *p3,
                                   gpointer data);
...
#define GTS_CONTAINEE(obj) GTS_OBJECT_CAST(obj, GtsContainee, gts_containee_class())
#define GTS_CONTAINEE_CLASS(klass) GTS_OBJECT_CLASS_CAST(klass, GtsContaineeClass, gts_containee_class())
#define GTS_IS_CONTAINEE(obj) (gts_object_is_from_class(obj, gts_containee_class()))
...
#define GTS_SLIST_CONTAINEE(obj) GTS_OBJECT_CAST(obj, GtsSListContainee, gts_slist_containee_class())
#define GTS_SLIST_CONTAINEE_CLASS(klass)                                                                               \
  GTS_OBJECT_CLASS_CAST(klass, GtsSListContaineeClass, gts_slist_containee_class())
#define GTS_IS_SLIST_CONTAINEE(obj) (gts_object_is_from_class(obj, gts_slist_containee_class()))
...
#define GTS_CONTAINER(obj) GTS_OBJECT_CAST(obj, GtsContainer, gts_container_class())
#define GTS_CONTAINER_CLASS(klass) GTS_OBJECT_CLASS_CAST(klass, GtsContainerClass, gts_container_class())
#define GTS_IS_CONTAINER(obj) (gts_object_is_from_class(obj, gts_container_class()))
...
#define GTS_HASH_CONTAINER(obj) GTS_OBJECT_CAST(obj, GtsHashContainer, gts_hash_container_class())
#define GTS_HASH_CONTAINER_CLASS(klass) GTS_OBJECT_CLASS_CAST(klass, GtsHashContainerClass, gts_hash_container_class())
#define GTS_IS_HASH_CONTAINER(obj) (gts_object_is_from_class(obj, gts_hash_container_class()))
...
#define GTS_SLIST_CONTAINER(obj) GTS_OBJECT_CAST(obj, GtsSListContainer, gts_slist_container_class())
#define GTS_SLIST_CONTAINER_CLASS(klass)                                                                               \
  GTS_OBJECT_CLASS_CAST(klass, GtsSListContainerClass, gts_slist_container_class())
#define GTS_IS_SLIST_CONTAINER(obj) (gts_object_is_from_class(obj, gts_slist_container_class()))
...
#define GTS_GNODE(obj) GTS_OBJECT_CAST(obj, GtsGNode, gts_gnode_class())
#define GTS_GNODE_CLASS(klass) GTS_OBJECT_CLASS_CAST(klass, GtsGNodeClass, gts_gnode_class())
#define GTS_IS_GNODE(obj) (gts_object_is_from_class(obj, gts_gnode_class()))
...
#define GTS_NGNODE(obj) GTS_OBJECT_CAST(obj, GtsNGNode, gts_ngnode_class())
#define GTS_NGNODE_CLASS(klass) GTS_OBJECT_CLASS_CAST(klass, GtsNGNodeClass, gts_ngnode_class())
#define GTS_IS_NGNODE(obj) (gts_object_is_from_class(obj, gts_ngnode_class()))
...
#define GTS_WGNODE(obj) GTS_OBJECT_CAST(obj, GtsWGNode, gts_wgnode_class())
#define GTS_WGNODE_CLASS(klass) GTS_OBJECT_CLASS_CAST(klass, GtsWGNodeClass, gts_wgnode_class())
#define GTS_IS_WGNODE(obj) (gts_object_is_from_class(obj, gts_wgnode_class()))
...
#define GTS_FNODE(obj) GTS_OBJECT_CAST(obj, GtsFNode, gts_fnode_class())
#define GTS_FNODE_CLASS(klass) GTS_OBJECT_CLASS_CAST(klass, GtsFNodeClass, gts_fnode_class())
#define GTS_IS_FNODE(obj) (gts_object_is_from_class(obj, gts_fnode_class()))
...
#define GTS_GEDGE(obj) GTS_OBJECT_CAST(obj, GtsGEdge, gts_gedge_class())
#define GTS_GEDGE_CLASS(klass) GTS_OBJECT_CLASS_CAST(klass, GtsGEdgeClass, gts_gedge_class())
#define GTS_IS_GEDGE(obj) (gts_object_is_from_class(obj, gts_gedge_class()))
...
#define GTS_WGEDGE(obj) GTS_OBJECT_CAST(obj, GtsWGEdge, gts_wgedge_class())
#define GTS_WGEDGE_CLASS(klass) GTS_OBJECT_CLASS_CAST(klass, GtsWGEdgeClass, gts_wgedge_class())
#define GTS_IS_WGEDGE(obj) (gts_object_is_from_class(obj, gts_wgedge_class()))
...
#define GTS_GRAPH(obj) GTS_OBJECT_CAST(obj, GtsGraph, gts_graph_class())
#define GTS_GRAPH_CLASS(klass) GTS_OBJECT_CLASS_CAST(klass, GtsGraphClass, gts_graph_class())
#define GTS_IS_GRAPH(obj) (gts_object_is_from_class(obj, gts_graph_class()))
...
typedef enum { GTS_BREADTH_FIRST } GtsTraverseType;
...
#define GTS_WGRAPH(obj) GTS_OBJECT_CAST(obj, GtsWGraph, gts_wgraph_class())
#define GTS_WGRAPH_CLASS(klass) GTS_OBJECT_CLASS_CAST(klass, GtsWGraphClass, gts_wgraph_class())
#define GTS_IS_WGRAPH(obj) (gts_object_is_from_class(obj, gts_wgraph_class()))
...
#define GTS_GNODE_SPLIT(obj) GTS_OBJECT_CAST(obj, GtsGNodeSplit, gts_gnode_split_class())
#define GTS_GNODE_SPLIT_CLASS(klass) GTS_OBJECT_CLASS_CAST(klass, GtsGNodeSplitClass, gts_gnode_split_class())
#define GTS_IS_GNODE_SPLIT(obj) (gts_object_is_from_class(obj, gts_gnode_split_class()))
...
#define GTS_PGRAPH(obj) GTS_OBJECT_CAST(obj, GtsPGraph, gts_pgraph_class())
#define GTS_PGRAPH_CLASS(klass) GTS_OBJECT_CLASS_CAST(klass, GtsPGraphClass, gts_pgraph_class())
#define GTS_IS_PGRAPH(obj) (gts_object_is_from_class(obj, gts_pgraph_class()))

GtsPGraphClass *gts_pgraph_class(void);
GtsPGraph *gts_pgraph_new(GtsPGraphClass *klass, GtsGraph *g, GtsGNodeSplitClass *split_class,
                          GtsWGNodeClass *node_class, GtsWGEdgeClass *edge_class, guint min);
...
GSList *gts_graph_recursive_bisection(GtsWGraph *wg, guint n, guint ntry, guint mmax, guint nmin);
...
gdouble gts_graph_bisection_bkl_refine(GtsGraphBisection *bg, guint mmax);
GtsGraphBisection *gts_graph_bisection_new(GtsWGraph *wg, guint ntry, guint mmax, guint nmin);
