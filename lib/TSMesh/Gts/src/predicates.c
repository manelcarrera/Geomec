...
#define Eight_Four_Sum(a7, a6, a5, a4, a3, a2, a1, a0, b4, b3, b1, b0, x11, x10, x9, x8, x7, x6, x5, x4, x3, x2, x1,   \
                       x0)                                                                                             \
...
/*
static int expansion_sum_zeroelim1(int elen, REAL *e, int flen, REAL *f, REAL *h)
// e and h can be the same, but f and h cannot.
{
  REAL Q;
  INEXACT REAL Qnew;
...
/*
static int expansion_sum_zeroelim2(int elen, REAL *e, int flen, REAL *f, REAL *h)
// e and h can be the same, but f and h cannot.
{
  REAL Q, hh;
  INEXACT REAL Qnew;
...
static int fast_expansion_sum_zeroelim(int elen, REAL *e, int flen, REAL *f, REAL *h) {
  ...
  if ((fnow > enow) == (fnow > -enow)) {
    Q = enow;
    /*	An overflow can occur here when elen = 1	*/
    enow = e[++eindex];
  } else {
    Q = fnow;
    fnow = f[++findex];
  ...
  hindex = 0;
  if (((eindex + 1) < elen) && ((findex + 1) < flen)) {
    if ((fnow > enow) == (fnow > -enow)) {
    ...
    while (((eindex + 1) < elen) && ((findex + 1) < flen)) {
      if ((fnow > enow) == (fnow > -enow)) {
        Two_Sum(Q, enow, Qnew, hh);
        enow = e[++eindex];
      } else {
...
/* h cannot be e or f. */
/*
static int linear_expansion_sum(int elen, REAL *e, int flen, REAL *f, REAL *h)
{
  REAL Q, q;
  INEXACT REAL Qnew;
  INEXACT REAL R;
...
/* h cannot be e or f. */
/*
static int linear_expansion_sum_zeroelim(int elen, REAL *e, int flen, REAL *f, REAL *h)
{
  REAL Q, q, hh;
  INEXACT REAL Qnew;
  INEXACT REAL R;
...
/*
static int compress(int elen, REAL *e, REAL *h)  // e and h may be the same.
{
  REAL Q, q;
  INEXACT REAL Qnew;
  int eindex, hindex;
...
REAL orient2dslow(REAL *pa, REAL *pb, REAL *pc) {
  ...
  negate = -acy;
  negatetail = -acytail;
  Two_Two_Product(bcx, bcxtail, negate, negatetail, bxay7, bxay[6], bxay[5], bxay[4], bxay[3], bxay[2], bxay[1],
                  bxay[0]);
  bxay[7] = bxay7;
...
REAL orient3dslow(REAL *pa, REAL *pb, REAL *pc, REAL *pd) {
  ...
  negate = -ady;
  negatetail = -adytail;
  Two_Two_Product(bdx, bdxtail, negate, negatetail, bxay7, bxay[6], bxay[5], bxay[4], bxay[3], bxay[2], bxay[1],
                  bxay[0]);
  bxay[7] = bxay7;
  ...
  negate = -bdy;
  negatetail = -bdytail;
  Two_Two_Product(cdx, cdxtail, negate, negatetail, cxby7, cxby[6], cxby[5], cxby[4], cxby[3], cxby[2], cxby[1],
                  cxby[0]);
  cxby[7] = cxby7;
  ...
  negate = -cdy;
  negatetail = -cdytail;
  Two_Two_Product(adx, adxtail, negate, negatetail, axcy7, axcy[6], axcy[5], axcy[4], axcy[3], axcy[2], axcy[1],
                  axcy[0]);
  axcy[7] = axcy7;
...
REAL insphereslow(REAL *pa, REAL *pb, REAL *pc, REAL *pd, REAL *pe) {
  ...
  negate = -aey;
  negatetail = -aeytail;
  Two_Two_Product(bex, bextail, negate, negatetail, bxay7, bxay[6], bxay[5], bxay[4], bxay[3], bxay[2], bxay[1],
                  bxay[0]);
  bxay[7] = bxay7;
  ...
  negate = -bey;
  negatetail = -beytail;
  Two_Two_Product(cex, cextail, negate, negatetail, cxby7, cxby[6], cxby[5], cxby[4], cxby[3], cxby[2], cxby[1],
                  cxby[0]);
  cxby[7] = cxby7;
  ...
  negate = -cey;
  negatetail = -ceytail;
  Two_Two_Product(dex, dextail, negate, negatetail, dxcy7, dxcy[6], dxcy[5], dxcy[4], dxcy[3], dxcy[2], dxcy[1],
                  dxcy[0]);
  dxcy[7] = dxcy7;
  ...
  negate = -dey;
  negatetail = -deytail;
  Two_Two_Product(aex, aextail, negate, negatetail, axdy7, axdy[6], axdy[5], axdy[4], axdy[3], axdy[2], axdy[1],
                  axdy[0]);
  axdy[7] = axdy7;
  ...
  negate = -aey;
  negatetail = -aeytail;
  Two_Two_Product(cex, cextail, negate, negatetail, cxay7, cxay[6], cxay[5], cxay[4], cxay[3], cxay[2], cxay[1],
                  cxay[0]);
  cxay[7] = cxay7;
  ...
  negate = -bey;
  negatetail = -beytail;
  Two_Two_Product(dex, dextail, negate, negatetail, dxby7, dxby[6], dxby[5], dxby[4], dxby[3], dxby[2], dxby[1],
                  dxby[0]);
  dxby[7] = dxby7;
...
REAL insphereadapt(REAL *pa, REAL *pb, REAL *pc, REAL *pd, REAL *pe, REAL permanent) {
  ...
  if ((aextail == 0.0) && (aeytail == 0.0) && (aeztail == 0.0) && (bextail == 0.0) && (beytail == 0.0) &&
      (beztail == 0.0) && (cextail == 0.0) && (ceytail == 0.0) && (ceztail == 0.0) && (dextail == 0.0) &&
      (deytail == 0.0) && (deztail == 0.0)) {
    return det;
  }
