...
GtsContaineeClass *gts_containee_class(void) {
  ...
  if (klass == NULL) {
    GtsObjectClassInfo containee_info = {"GtsContainee",
                                         sizeof(GtsContainee),
                                         ...
                                         (GtsArgSetFunc)NULL,
                                         (GtsArgGetFunc)NULL};
    klass = gts_object_class_new(gts_object_class(), &containee_info);
  }
...
gboolean gts_containee_is_contained(GtsContainee *item, GtsContainer *c) {
  ...
  if (GTS_CONTAINEE_CLASS(GTS_OBJECT(item)->klass)->is_contained)
    return (*GTS_CONTAINEE_CLASS(GTS_OBJECT(item)->klass)->is_contained)(item, c);
  return FALSE;
}
...
static void slist_containee_destroy(GtsObject *object) {
  ...
  (*GTS_OBJECT_CLASS(gts_slist_containee_class())->parent_class->destroy)(object);
}
...
static void slist_containee_class_init(GtsSListContaineeClass *klass) {
  GTS_CONTAINEE_CLASS(klass)->remove_container = slist_containee_remove_container;
  GTS_CONTAINEE_CLASS(klass)->add_container = slist_containee_add_container;
  GTS_CONTAINEE_CLASS(klass)->is_contained = slist_containee_is_contained;

  GTS_OBJECT_CLASS(klass)->destroy = slist_containee_destroy;
}

static void slist_containee_init(GtsSListContainee *object) { object->containers = NULL; }

GtsSListContaineeClass *gts_slist_containee_class(void) {
  static GtsSListContaineeClass *klass = NULL;

  if (klass == NULL) {
    GtsObjectClassInfo slist_containee_info = {"GtsSListContainee",
                                               ...
                                               (GtsArgSetFunc)NULL,
                                               (GtsArgGetFunc)NULL};
    klass = gts_object_class_new(GTS_OBJECT_CLASS(gts_containee_class()), &slist_containee_info);
  }
...
static void remove_container(GtsContainee *item, GtsContainer *c) {
  if (GTS_CONTAINEE_CLASS(GTS_OBJECT(item)->klass)->remove_container)
    (*GTS_CONTAINEE_CLASS(GTS_OBJECT(item)->klass)->remove_container)(item, c);
}
...
static void container_destroy(GtsObject *object) {
  ...
  (*GTS_OBJECT_CLASS(gts_container_class())->parent_class->destroy)(object);
}

static void container_add(GtsContainer *c, GtsContainee *item) {
  if (GTS_CONTAINEE_CLASS(GTS_OBJECT(item)->klass)->add_container)
    (*GTS_CONTAINEE_CLASS(GTS_OBJECT(item)->klass)->add_container)(item, c);
}
...
static void container_clone_add(GtsContainee *item, GtsContainer *clone) { gts_container_add(clone, item); }

static void container_clone(GtsObject *clone, GtsObject *object) {
  gts_object_init(clone, object->klass);
  gts_container_foreach(GTS_CONTAINER(object), (GtsFunc)container_clone_add, clone);
}
...
GtsContainerClass *gts_container_class(void) {
  ...
  if (klass == NULL) {
    GtsObjectClassInfo container_info = {"GtsContainer",
                                         sizeof(GtsContainer),
                                         ...
                                         (GtsArgSetFunc)NULL,
                                         (GtsArgGetFunc)NULL};
    klass = gts_object_class_new(GTS_OBJECT_CLASS(gts_slist_containee_class()), &container_info);
  }
...
static void hash_container_destroy(GtsObject *object) {
  ...
  (*GTS_OBJECT_CLASS(gts_hash_container_class())->parent_class->destroy)(object);
...
static void hash_container_foreach(GtsContainer *c, GtsFunc func, gpointer data) {
  ...
  g_hash_table_foreach(GTS_HASH_CONTAINER(c)->items, (GHFunc)hash_foreach, info);
  GTS_HASH_CONTAINER(c)->frozen = FALSE;
}

static guint hash_container_size(GtsContainer *c) { return g_hash_table_size(GTS_HASH_CONTAINER(c)->items); }
...
GtsHashContainerClass *gts_hash_container_class(void) {
  ...
  if (klass == NULL) {
    GtsObjectClassInfo hash_container_info = {"GtsHashContainer",
                                              ...
                                              (GtsArgSetFunc)NULL,
                                              (GtsArgGetFunc)NULL};
    klass = gts_object_class_new(GTS_OBJECT_CLASS(gts_container_class()), &hash_container_info);
  }
...
static void slist_container_destroy(GtsObject *object) {
  ...
  (*GTS_OBJECT_CLASS(gts_slist_container_class())->parent_class->destroy)(object);
...
static void slist_container_add(GtsContainer *c, GtsContainee *item) {
  ...
  if (!g_slist_find(GTS_SLIST_CONTAINER(c)->items, item))
    GTS_SLIST_CONTAINER(c)->items = g_slist_prepend(GTS_SLIST_CONTAINER(c)->items, item);
...
static void slist_container_remove(GtsContainer *c, GtsContainee *item) {
  ...
  GTS_SLIST_CONTAINER(c)->items = g_slist_remove(GTS_SLIST_CONTAINER(c)->items, item);
...
static guint slist_container_size(GtsContainer *c) { return g_slist_length(GTS_SLIST_CONTAINER(c)->items); }
...
GtsSListContainerClass *gts_slist_container_class(void) {
  ...
  if (klass == NULL) {
    GtsObjectClassInfo slist_container_info = {"GtsSListContainer",
                                               ...
                                               (GtsArgSetFunc)NULL,
                                               (GtsArgGetFunc)NULL};
    klass = gts_object_class_new(GTS_OBJECT_CLASS(gts_container_class()), &slist_container_info);
  }
