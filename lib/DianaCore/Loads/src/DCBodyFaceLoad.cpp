...
CBodyFaceLoad::CBodyFaceLoad(CLoadCase &loadcase, double size, const geo::IVector &vecDirection, const geo::IBody &body,
                             int nFaceIndex)
...
CBodyFaceLoad::CBodyFaceLoad(CLoadCase &loadcase, const std::vector<double> &vcValues, const geo::IVector &vecDirection,
...
CBodyFaceLoad::CBodyFaceLoad(CLoadCase &loadcase, const std::vector<double> &vcValues, const geo::IBody &body,
                             int nFaceIndex)
...
const geo::IBody &CBodyFaceLoad::Body() const { return m_Body; }
...
int CBodyFaceLoad::FaceIndex() const { return m_nFaceIndex; }
