...
ILoad::ILoad(ICase &icase, double size) : m_Manager(icase.Manager()), m_nValueSize(1) {
...
ILoad::~ILoad() { DIFREE(m_pValue); }

ftn_int_t ILoad::ValueSize() const { return m_nValueSize; }

ftn_double_t *ILoad::Values() const { return m_pValue; }

CLoadManager &ILoad::Manager() const { return m_Manager; }
