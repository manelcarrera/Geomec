...
int IElementProperty::Type() const { return -1; }

int IElementProperty::WriteFilosParamSize(IDianaRunner & /*diarunner*/) const { return 0; }
...
bool IElementProperty::isInterfaceElementMaterial() const { return false; }
