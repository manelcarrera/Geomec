...
CRangeBuilder::CRangeBuilder() : m_pValues(0), m_nValues(0) {}

CRangeBuilder::~CRangeBuilder() { ClearValues(); }
...
int &CRangeBuilder::Lo(TRange &range) const { return range.first; }

int &CRangeBuilder::Hi(TRange &range) const { return range.second; }

int CRangeBuilder::Lo(const TRange &range) const { return range.first; }

int CRangeBuilder::Hi(const TRange &range) const { return range.second; }

int CRangeBuilder::Size(const TRange &range) const { return range.second - range.first + 1; }
