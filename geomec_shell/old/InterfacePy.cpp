...
static PyMethodDef methods[] = {{"send_cmd", send_cmd, METH_VARARGS, "Sends a request"},
...
int script(int argc, char *argv[]) { return 0; }

} // anonymous namespace

namespace gm_shell {

const char *CInterfacePy::ShortDescription() const { return "Py"; }
...
void CInterfacePy::PrintUsage() const { std::cerr << "geomec_shell script" << std::endl; }
