...
namespace {
const char *cmd_cp[] = {"NONE",  "USAGE", "ABORT", "QUIT", "CALCULATE", "END", "CALCULATE_STEP", "SWITCH_INTERFACE",
                        "FOR_ME"};
}
...
public:
  typedef enum { NONE = 0, USAGE, ABORT, QUIT, CALCULATE, END, CALCULATE_STEP, SWITCH_INTERFACE, FOR_ME } TCommand;
