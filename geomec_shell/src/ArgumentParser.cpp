...
void CArgumentParser::GetCommand(std::string &command) { command = m_command; }

void CArgumentParser::GetInterface(std::string &iFace) { iFace = m_interface; }
...
size_t CArgumentParser::ArgumentSize() { return m_arguments.size(); }
