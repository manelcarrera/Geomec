...
CInterfaceModelContext::CInterfaceModelContext(const QString& app_version)
  : m_pModel(0)
  , m_VersionManager(app_version)
  , m_created(false)
  , m_app_version(app_version)
  , m_pDianaExecuter(0)
  , m_pSaveModel(0)
  , m_pRetrieveDianaFileNames(0)
  , m_drc(0)
  , m_nStage(0)
  , m_bHasRun(false)
  , m_bAutoExport(false)
...
void CInterfaceModelContext::OutputPath(const QString& outputPath)
{
  m_output_path = outputPath;
}

QString CInterfaceModelContext::OutputPath() const
{
  return m_output_path;
}

void CInterfaceModelContext::TempPath(const QString& tempPath)
{
  m_temp_path = tempPath;
}

QString CInterfaceModelContext::TempPath() const
{
  return m_temp_path;
}

QString CInterfaceModelContext::ModelFullPath() const
{
  return m_model_full_path;
}

QString CInterfaceModelContext::ModelPath() const
{
  return m_model_path;
}

QString CInterfaceModelContext::ModelName() const
{
  return m_model_name;
}

QString CInterfaceModelContext::ModelExtension() const
{
  return m_model_extension;
}


CModelBase *CInterfaceModelContext::Model()
{
  return m_pModel;
}
...
bool  CInterfaceModelContext::Created() const
{
  return m_created;
}
...
void CInterfaceModelContext::Stage(int nStage)
{
  m_nStage = nStage;
}

int CInterfaceModelContext::Stage() const
{
  return m_nStage;
}

void CInterfaceModelContext::Type(const QString& type)
{
  m_type = type;
}

QString CInterfaceModelContext::Type() const
{
  return m_type;
}

void CInterfaceModelContext::AutoExport(bool flag)
{
  m_bAutoExport = flag;
}

bool CInterfaceModelContext::AutoExport() const
{
  return m_bAutoExport;
}

void CInterfaceModelContext::LicenseRetry(int nLicenseRetry)
{
  m_nLicenseRetry = nLicenseRetry;
}

int CInterfaceModelContext::LicenseRetry() const
{
  return m_nLicenseRetry;
}

QString CInterfaceModelContext::LicenseError() const
{
  return m_sLicenseError;
}

bool CInterfaceModelContext::HaveResults() const
{
  return m_bHaveResults;
}

bool CInterfaceModelContext::GetCalculationResult() const
{
...
bool CInterfaceModelContext::HasRun() const
{
  return m_bHasRun;
}
...
{
  IModelLifetimeFacade::SaveMain(CModelBase::CModelLoadSaveDefault(m_app_version), m_pModel->RootModel(), fileName, true);
}


CDianaExecuter *CInterfaceModelContext::GetDianaExecuter()
{
  return m_pDianaExecuter;
}
CSaveModelConsole *CInterfaceModelContext::GetSaveModel()
{
  return m_pSaveModel;
}
