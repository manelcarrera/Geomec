...
void CSplashWnd::OnPaint()
{
   ...
   dcImage.SelectObject(pOldBitmap);
	...
	font.CreateFont(-30, 0, 0, 0, FW_DONTCARE, 0,0,0,DEFAULT_CHARSET, OUT_DEFAULT_PRECIS,CLIP_DEFAULT_PRECIS,DEFAULT_QUALITY,DEFAULT_PITCH|FF_ROMAN,"Arial");
	oldfont = dc.SelectObject(&font);
	int mode = dc.SetBkMode(TRANSPARENT);

	CString str;
	str = "Wellbore Cement Integrity Model";
	dc.SetTextColor(RGB(0,0,0));
	dc.TextOut(72,22,str);
	dc.SetTextColor(RGB(255,255,255));
	dc.TextOut(70,20,str);
  ...
  str = "DIANA inside";
	dc.SetTextColor(RGB(0,0,0));
	dc.TextOut(72,112,str);
//	dc.SetTextColor(RGB(255,255,255));
//	dc.TextOut(70,120,str);
...
//	str = AfxGetAppName();
	...
	dc.SetTextColor(RGB(0,0,0));
	dc.TextOut(72,62,str);
//	dc.SetTextColor(RGB(255,255,255));
//	dc.TextOut(70,60,str);

	// A smaller font is used so delete the old font and create a new one.
	dc.SelectObject(oldfont);
	font.DeleteObject();
	font.CreateFont(-15, 0, 0, 0, FW_DONTCARE, 0,0,0,DEFAULT_CHARSET, OUT_DEFAULT_PRECIS,CLIP_DEFAULT_PRECIS,DEFAULT_QUALITY,DEFAULT_PITCH|FF_ROMAN,"Arial");
	oldfont = dc.SelectObject(&font);

	str = "Diana Special for well sealant selection";
	dc.SetTextColor(RGB(0,0,0));
	dc.TextOut(10,310,str);

	str.LoadString(IDS_COPYRIGHT);
	dc.SetTextColor(RGB(0,0,0));
	dc.TextOut(10,340,str);
