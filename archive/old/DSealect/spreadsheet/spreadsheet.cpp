...
void CSpreadSheet::SetAction(short propVal)
{
...
BOOL CSpreadSheet::GetCalcDependencies()
{
	BOOL result;
...
void CSpreadSheet::SetCalcDependencies(BOOL propVal)
{
...
short CSpreadSheet::GetCellBorderStyle()
{
	short result;
...
void CSpreadSheet::SetCellBorderStyle(short propVal)
{
...
short CSpreadSheet::GetCellType()
{
	short result;
...
void CSpreadSheet::SetCellType(short propVal)
{
...
short CSpreadSheet::GetCursorStyle()
{
	short result;
...
void CSpreadSheet::SetCursorStyle(short propVal)
{
	SetProperty(0x1c, VT_I2, propVal);
}

short CSpreadSheet::GetCursorType()
{
	short result;
...
void CSpreadSheet::SetCursorType(short propVal)
{
...
short CSpreadSheet::GetPrintType()
{
	short result;
...
void CSpreadSheet::SetPrintType(short propVal)
{
...
void CSpreadSheet::SetSortBy(short propVal)
{
...
short CSpreadSheet::GetTypeButtonAlign()
{
	short result;
...
void CSpreadSheet::SetTypeButtonAlign(short propVal)
{
...
short CSpreadSheet::GetTypeButtonType()
{
	short result;
...
void CSpreadSheet::SetTypeButtonType(short propVal)
{
...
short CSpreadSheet::GetTypeCheckTextAlign()
{
	short result;
...
void CSpreadSheet::SetTypeCheckTextAlign(short propVal)
{
...
short CSpreadSheet::GetTypeDateFormat()
{
	short result;
...
void CSpreadSheet::SetTypeDateFormat(short propVal)
{
...
short CSpreadSheet::GetTypeEditCharCase()
{
	short result;
...
void CSpreadSheet::SetTypeEditCharCase(short propVal)
{
	SetProperty(0x9b, VT_I2, propVal);
}

short CSpreadSheet::GetTypeEditCharSet()
{
	short result;
...
void CSpreadSheet::SetTypeEditCharSet(short propVal)
{
	SetProperty(0x9c, VT_I2, propVal);
}

long CSpreadSheet::GetTypeEditLen()
{
	long result;
...
void CSpreadSheet::SetTypeEditLen(long propVal)
{
...
short CSpreadSheet::GetTypeHAlign()
{
	short result;
...
void CSpreadSheet::SetTypeHAlign(short propVal)
{
...
short CSpreadSheet::GetTypeTextAlignVert()
{
	short result;
...
void CSpreadSheet::SetTypeTextAlignVert(short propVal)
{
...
short CSpreadSheet::GetTypeTime24Hour()
{
	short result;
...
void CSpreadSheet::SetTypeTime24Hour(short propVal)
{
...
short CSpreadSheet::GetUserResize()
{
	short result;
...
void CSpreadSheet::SetUserResize(short propVal)
{
	SetProperty(0xc0, VT_I2, propVal);
}

short CSpreadSheet::GetUserResizeCol()
{
	short result;
...
void CSpreadSheet::SetUserResizeCol(short propVal)
{
	SetProperty(0xc1, VT_I2, propVal);
}

short CSpreadSheet::GetUserResizeRow()
{
	short result;
...
void CSpreadSheet::SetUserResizeRow(short propVal)
{
...
short CSpreadSheet::GetPrintOrientation()
{
	short result;
...
void CSpreadSheet::SetPrintOrientation(short propVal)
{
...
short CSpreadSheet::GetTypeCheckType()
{
	short result;
...
void CSpreadSheet::SetTypeCheckType(short propVal)
{
...
short CSpreadSheet::GetSortKeyOrder(short nIndex)
{
	short result;
	static BYTE parms[] =
		VTS_I2;
...
void CSpreadSheet::SetSortKeyOrder(short nIndex, short nNewValue)
{
	static BYTE parms[] =
		VTS_I2 VTS_I2;
...
LPDISPATCH CSpreadSheet::GetTypeCheckPicture(short Index)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0xdf, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, parms,
		Index);
	return result;
}
