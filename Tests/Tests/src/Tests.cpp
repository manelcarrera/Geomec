...
int loaded = 0 || test_sanity_checks::LibraryLoad_SanityChecks() || test_fw51::LibraryLoad_Fw51() ||
             test_materials::LibraryLoad_Materials() || test_model_operations::LibraryLoad_ModelOperations();
