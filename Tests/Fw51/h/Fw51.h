...
template<class T>
std::ostream& operator<<(std::ostream& os, const TestInfo<T>& info)
{
  return os << info.fileBase;
}


template<class T>
class Fw51BaseTestTemplate : public ::testing::TestWithParam<T>
{
protected:
...
template<class T>
class Fw51InputBaseTestTemplate : public Fw51BaseTestTemplate<T>
{
protected:
  std::string m_Input;
