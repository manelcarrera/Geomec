...
CMaterialContainer::CMaterialContainer(QTextStream &os)
: CModelContainer<CMaterial>()
{
  new CModelObjectReceiver( *this, os );
}

CMaterialContainer::CMaterialContainer( const QString& text, QTextStream &os )
: CModelContainer<CMaterial>( text )
{
  new CModelObjectReceiver( *this, os );
}
