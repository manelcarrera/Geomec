...
CModelObjectReceiver::CModelObjectReceiver(IModelObject &object, QTextStream &os) : m_object(object), m_os(os) {
...
CDocumentReceiver::CDocumentReceiver(CDocumentBase &object, QTextStream &os) : CModelObjectReceiver(object, os) {
...
void CDocumentReceiver::onEndOperation() { m_os << "Document " << m_object.text() << " fired onEndOperation" << endl; }
