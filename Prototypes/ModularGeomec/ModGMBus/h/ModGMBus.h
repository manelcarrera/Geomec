...
public:
  typedef enum Size : quint8 { TYPE_SIZE = 1, NAME_SIZE = 8, PAYLOAD_SIZE = 15, TOTAL_SIZE = 32 } Size;

  typedef enum Type : quint8 { SIGNAL = 0, REQUEST = 1, RESPONSE = 2 } Type;
...
public:
  IConnectionManager(QObject *parent = nullptr) : QObject(parent) {}
...
public:
  typedef enum : int { CLIENT = 0, SERVER = 1 } Type;
