...
C2DVertex::CSegmentPoint::CSegmentPoint(C2DVertex& vertex)
: m_vertex(vertex)
{
  m_coor[0] = 0.0;
  m_coor[1] = 0.0;
...
C2DVertex::CSegmentPoint::CSegmentPoint(const CSegmentPoint& rhs)
...
const double &C2DVertex::CSegmentPoint::X() const
{
  return m_coor[0];
}

const double &C2DVertex::CSegmentPoint::Y() const
{
  return m_coor[1];
}

const double &C2DVertex::CSegmentPoint::Z() const
{
  return m_coor[2];
}

void C2DVertex::CSegmentPoint::X(const double &dX)
{
  m_coor[0] = dX; 
}

void C2DVertex::CSegmentPoint::Y(const double &dY)
{
  m_coor[1] = dY;
}

void C2DVertex::CSegmentPoint::Z(const double &dZ)
{
  m_coor[2] = dZ;
}

int C2DVertex::CSegmentPoint::SegmentSize() const
{
  return m_vertex.SegmentSize();
}

const geo::ISegment& C2DVertex::CSegmentPoint::Segment(int nIndex) const
{
  return m_vertex.Segment(nIndex).Segment();
}
...
bool C2DVertex::CSegmentPoint::Empty() const
{
  return false;
}

C2DVertex& C2DVertex::CSegmentPoint::Vertex()
{
  return m_vertex;
}

const C2DVertex& C2DVertex::CSegmentPoint::Vertex() const
{
  return m_vertex;
}
//////////////////////////////////////////////////////////////////////
...
C2DVertex::C2DVertex(const geo::IPoint& point, IModelObject& parent)
: IModelObject(""), m_point(*this)
{
  m_point.X(point.X());
  m_point.Y(point.Y());
  reParent(parent);
...
C2DVertex::C2DVertex(const double& dX, const double& dY, IModelObject& parent)
: IModelObject(""), m_point(*this)
{
  m_point.X(dX);
  m_point.Y(dY);
...
C2DVertex::C2DVertex(IModelObject& parent)
: IModelObject(parent), m_point(*this)
{
}
/*
...
*/
C2DVertex::TColor C2DVertex::Color() const
{
  return qRgb(255, 0, 0);
}
/*
...
*/
int C2DVertex::geometrySize() const
{
  return 1;
}

const geo::IObject& C2DVertex::geometry(int nIndex) const
{
  return m_point;
}
...
const geo::ISegmentPoint& C2DVertex::Point() const
{
  return m_point;
}

geo::ISegmentPoint& C2DVertex::Point()
{
  return m_point;
}

int C2DVertex::SegmentSize() const
{
  return m_vcContainer.size();
}
...
bool C2DVertex::CanDestroy() const
{
  return SegmentSize() < 3;
}
...
/*
bool C2DVertex::MouseRelease(TFrame& frame, TButtonState state, TButtonState button, const TScreenPoint& point, const TObjectVec& vcHit)
{
