...
public:
  ...
  */
  ...
  /*
    virtual bool MouseRelease(TFrame& frame, TButtonState state, TButtonState button, const TScreenPoint& point, const
    TObjectVec& vcHit); virtual void AppendContextMenu(CContextMenuInvoker &invoker); virtual bool Properties();
  */
