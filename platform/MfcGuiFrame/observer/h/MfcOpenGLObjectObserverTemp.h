...
class CMfcOpenGLObjectObserverTemp : public CMfcOpenGLObjectObserver
{
public:
  CMfcOpenGLObjectObserverTemp(IModelObject& observed_object, CModelObjectScene& scene)
  : CMfcOpenGLObjectObserver(observed_object, scene) { updateChildren(); }

  CMfcOpenGLObjectObserverTemp(IModelObject& observed_object, COpenGLObjectObserver& parent)
  : CMfcOpenGLObjectObserver(observed_object, parent) { updateChildren(); }
