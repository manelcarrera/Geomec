...
#ifdef _DEBUG
void CListViewBase::AssertValid() const
{
  CView::AssertValid();
}

void CListViewBase::Dump(CDumpContext& dc) const
{
  CView::Dump(dc);
}
#endif //_DEBUG
...
CListCtrlBase& CListViewBase::GetListCtrl() const
{
  return (CListCtrlBase &)(*m_pCtrl);
}