...
********************************************************************/
DROPEFFECT CCtrlDropTarget::OnDragEnter( CWnd* pWnd, 
...
DROPEFFECT CCtrlDropTarget::OnDragOver( CWnd* pWnd, COleDataObject* pDataObject, 
...
********************************************************************/
BOOL CCtrlDropTarget::OnDrop(CWnd* pWnd, COleDataObject* pDataObject,
