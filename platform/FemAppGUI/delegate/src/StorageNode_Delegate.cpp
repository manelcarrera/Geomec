...
CStorageNode_Delegate::CStorageNode_Delegate(CStorageNode *storageNode)
    : CGraphNode_Delegate(storageNode), m_storageNode(storageNode) {}
...
void CStorageNode_Delegate::AppendContextMenu(CContextMenuInvoker &invoker) {
  ...
  invoker.AddCommand(_T("&Copy"), *(new TGraphNode_DelegateCommand(*this, &CStorageNode_Delegate::OnCopy)));
  invoker.AddCommand(_T("&Paste"), *(new TGraphNode_DelegateCommand(*this, &CStorageNode_Delegate::OnPaste,
                                                                    &CStorageNode_Delegate::OnCanPaste)));
