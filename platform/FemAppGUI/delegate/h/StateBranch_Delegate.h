#ifndef _StateBranch_Delegate_h_
#define _StateBranch_Delegate_h_

class CTreeView;

#include "NodeObserver_Delegate.h"

template <class OBSERVED_TYPE, class DELEGATE_TYPE, class CHILD_TYPE, class CHILD_OBS_TYPE,
          class UNDEFINEDICON_PROVIDER, BOOL RENAME, enum REMOVE_TYPE REMOVE>
class CStateBranch_Delegate
    : public CNodeObserver_Delegate<OBSERVED_TYPE, DELEGATE_TYPE, CHILD_TYPE, CHILD_OBS_TYPE, RENAME, REMOVE> {
public:
  CStateBranch_Delegate(OBSERVED_TYPE &node, CTreeNode &parent, const BOOL rename, const enum REMOVE_TYPE remove,
  ...
  CStateBranch_Delegate(OBSERVED_TYPE &node, CTreeCtrl &ctrl, const BOOL rename, const enum REMOVE_TYPE remove,
...
#endif // _StateBranch_Delegate_h_
