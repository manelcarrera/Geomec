...
template <class T> class CStorageNodeEntry_Delegate : public CGraphEntryTemp_Delegate<T> {
public:
...
template <class T>
CStorageNodeEntry_Delegate<T>::CStorageNodeEntry_Delegate(CStorageNodeEntry<T> *storageNodeEntry)
    : CGraphEntryTemp_Delegate(storageNodeEntry), m_storageNodeEntry(storageNodeEntry) {
  ACTIVATE_TEMPLATE_DELEGATE(CStorageNodeEntry<T>, CStorageNodeEntry_Delegate<T>);
}
