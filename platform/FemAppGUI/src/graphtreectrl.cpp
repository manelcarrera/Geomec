...
CGraphTreeCtrl::CGraphTreeCtrl(CGraphTreeView &view) : m_view(view) {}
...
CWnd &CGraphTreeCtrl::GetContextWnd() const { return *FemAppGetMainWnd(); }

CGraphTreeView &CGraphTreeCtrl::TreeView() { return m_view; }

const CGraphTreeView &CGraphTreeCtrl::TreeView() const { return m_view; }