...
CGraphTreeView::CRootObserver::CRootObserver() : CGraphNode(_T("")) {}
...
CGraphTreeView::CRootObserver::~CRootObserver() { DeleteRoots(); }

unsigned int CGraphTreeView::CRootObserver::IconId() const { return 0; } // Function not in use
unsigned int CGraphTreeView::CRootObserver::TypeId() const { return 0; } // Function not in use

// ##ModelId=3B653D000287
CGraphTreeView::CGraphTreeView() : m_pSelection(0) {}
...
void CGraphTreeView::AssertValid() const { CTreeViewBase::AssertValid(); }

// ##ModelId=3B653D0002E3
void CGraphTreeView::Dump(CDumpContext &dc) const { CTreeViewBase::Dump(dc); }
#endif //_DEBUG
...
CFemAppDoc *CGraphTreeView::Document() const { return (CFemAppDoc *)(GetDocument()); }
...
void CGraphTreeView::AddRoot(CTreeNode &obs) { m_root.LinkTo(obs.Observer()); }
...
ICtrlObject *CGraphTreeView::SelectedCtrlObject() { return m_pSelection; }
