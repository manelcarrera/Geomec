...
public:
  CEnumerationBranch(CTreeNode &parent_node, const CString &strName, const unsigned int uIcon,
  ...
  virtual QString Text() const { return Observer().Name(); }
  virtual unsigned int Icon() const { return m_uIcon; }
  virtual void Delete() { assert(FALSE); }
  virtual BOOL CanDelete() const { return FALSE; }
  virtual BOOL CanEditText() const { return FALSE; }
  virtual const CGraphNode &ObservedItem() const { return m_parent_node.ObservedItem(); }
  virtual CGraphNode &ObservedItem() { return m_parent_node.ObservedItem(); }
  virtual const CGraphNode_Delegate &Delegate() const { return m_parent_node.Delegate(); }
  virtual CGraphNode_Delegate &Delegate() { return m_parent_node.Delegate(); }
