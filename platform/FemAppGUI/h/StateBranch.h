...
template <class OBSERVED_TYPE, class CHILD_TYPE, class CHILD_OBS_TYPE, class UNDEFINEDICON_PROVIDER, BOOL RENAME,
          enum REMOVE_TYPE REMOVE>
class CStateBranch : public CNodeObserver<OBSERVED_TYPE, CHILD_TYPE, CHILD_OBS_TYPE, RENAME, REMOVE> {
public:
  CStateBranch(OBSERVED_TYPE &node, CTreeNode &parent, const BOOL rename, const enum REMOVE_TYPE remove,
               HTREEITEM hInsertAfter = TVI_LAST, const BOOL bInitialUpdate = TRUE, BOOL bSortAfterInsertion = TRUE)
  ...
  CStateBranch(OBSERVED_TYPE &node, CTreeCtrl &ctrl, const BOOL rename, const enum REMOVE_TYPE remove,
