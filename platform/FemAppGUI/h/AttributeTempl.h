...
template<class T>
class CAttributesTemplate : public CDialog
{
  T&				m_gnSource;
  T*				m_pCopy;
public:
...
template<class T>
void CAttributesTemplate<T>::FillFrame(const unsigned int uFrameId, TColor color, CPaintDC &dc)
{
...
template<class T>
typename CAttributesTemplate<T>::TColor CAttributesTemplate<T>::SelectColor(TColor nDefaultColor)
{
  CColorDialog dlg;
