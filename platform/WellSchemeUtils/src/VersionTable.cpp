...
//////////////////////////////////////////////////////////////////////
CVersionTable::CVersionTable(CDaoDatabase &Database) : CDSTable(Database) {}
...
void CVersionTable::VersionName(const CString &name) { m_VersionName = name; }

CString CVersionTable::VersionName() const { return m_VersionName; }

CString CVersionTable::TableName() const { return VERSION_TABLE; }
