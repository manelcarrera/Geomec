...
CDaoDatabase &CDSTable::Database() const { return ((CDaoDatabase &)m_Database); }

void CDSTable::SetField(const CString &sFieldName, const long iVal) { RS().SetFieldValue(sFieldName, iVal); }

void CDSTable::SetField(const CString &sFieldName, const double dVal) { RS().SetFieldValue(sFieldName, dVal); }
...
void CDSTable::SetField(const CString &sFieldName, const CByteArray &Bytes) { RS().SetFieldValue(sFieldName, Bytes); }
...
void CDSTable::GetField(const CString &sFieldName, long &iVal) { iVal = RS().GetFieldValue(sFieldName).iVal; }

void CDSTable::GetField(const CString &sFieldName, double &dVal) { dVal = RS().GetFieldValue(sFieldName).dblVal; }

void CDSTable::GetField(const CString &sFieldName, CString &sVal) { sVal = RS().GetFieldValue(sFieldName).pbVal; }
