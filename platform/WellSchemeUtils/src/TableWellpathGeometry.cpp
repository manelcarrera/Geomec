...
TableWellpathGeometry::TableWellpathGeometry(CDaoDatabase &database) : CDSTable(database) {}
...
/*virtual*/ CString TableWellpathGeometry::TableName() const { return WELLPATH_GEO_TABLE_NAME; }

///////////////////////////////////////////////////////////////////

TableWellpathGlobal::TableWellpathGlobal(CDaoDatabase &database) : CDSTable(database) {}
...
/*virtual*/ CString TableWellpathGlobal::TableName() const { return WELLPATH_GLB_TABLE_NAME; }
