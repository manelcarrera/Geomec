...
CWellPointListDlg::CWellPointListDlg(well::CWellPathBase &wellpath, CDoubleQuantity::UNIT unit, CWnd *pParent /*=NULL*/
                                     ,
                                     QVector<well::CWellSectionList *> *pSections /*NULL*/
                                     )
    : CDialog(CWellPointListDlg::IDD, pParent), m_WellPointListCtrl(wellpath) {
  if (pSections)
