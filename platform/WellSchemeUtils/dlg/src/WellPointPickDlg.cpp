...
// wjrx mantis 3564
//
CWellPointPickDlg::CWellPointPickDlg(std::list<CNewWellPoint> *pList, CNewWellPathBase &wellpath,
                                     std::list<std::list<INewWellSection *>> Sections,
                                     CDoubleQuantity::UNIT unit /*= CDoubleQuantity::SI_UNIT*/
                                     ,
                                     CWnd *pParent /*=NULL*/
                                     )
    : CDialog(CWellPointPickDlg::IDD, pParent), m_pNewWellPath(&wellpath), m_pNewOrgList(pList),
...
void CWellPointPickDlg::OnButtonAddDefault() { OnAddDefault(m_NewList); }
...
CDoubleQuantity::UNIT CWellPointPickDlg::Unit() { return m_pDepManager->GetUnit(); }
...
void CWellPointPickDlg::OnCancel() { CDialog::OnCancel(); }
