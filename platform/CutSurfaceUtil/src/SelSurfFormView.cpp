...
SelSurfFormView::SelSurfFormView() : CFormView(IDD_FORMVIEW_SELECT_SURF) {
...
SelSurfFormView::~SelSurfFormView() { delete m_geo_handler; }
...
#ifdef _DEBUG
void SelSurfFormView::AssertValid() const { CFormView::AssertValid(); }

void SelSurfFormView::Dump(CDumpContext &dc) const { CFormView::Dump(dc); }
#endif //_DEBUG
...
void SelSurfFormView::DoFromTo(SelSurfGLView *ViewFrom, CListBox *FromList, SelSurfGLView *ViewTo, CListBox *ToList,
                               bool all) {
...
void SelSurfFormView::OnButtonOk() { m_dlg->OnOK(); }

void SelSurfFormView::GetSelecetedSurfaces(CNamedSurfaces &surfaces) { GetMap(&m_ListTo, surfaces); }

void SelSurfFormView::GetUnSelecetedSurfaces(CNamedSurfaces &surfaces) { GetMap(&m_ListFrom, surfaces); }

void SelSurfFormView::OnButtonCancel() { m_dlg->OnCancel(); }

void SelSurfFormView::OnDestroy() { CFormView::OnDestroy(); }
