...
{   
  lpCreateStruct->style = TVS_CHECKBOXES|WS_BORDER   |WS_CHILD | WS_VISIBLE | TVS_HASLINES|TVS_HASBUTTONS|TVS_LINESATROOT ;
...
#ifdef _DEBUG
void CCutsurfaceTreeView::AssertValid() const
{
  CTreeView::AssertValid();
}

void CCutsurfaceTreeView::Dump(CDumpContext& dc) const
{
  CTreeView::Dump(dc);
}
#endif //_DEBUG
