...
#ifdef _DEBUG
void SelSurfGLView::AssertValid() const { CView::AssertValid(); }

void SelSurfGLView::Dump(CDumpContext &dc) const { CView::Dump(dc); }
#endif //_DEBUG

void SelSurfGLView::OnSize(unsigned int nType, int cx, int cy) { COpenGLView::OnSize(nType, cx, cy); }
