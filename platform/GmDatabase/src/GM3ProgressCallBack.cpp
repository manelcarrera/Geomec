...
CProgressCallBack::CProgressCallBack() : m_lTotalRecords(0), m_lRecordCount(0) {}
...
long CProgressCallBack::TotalRecords() const { return m_lTotalRecords; }
...
void CProgressCallBack::OnNewRecord() { m_lRecordCount++; }

int CProgressCallBack::CurrentRecord() const { return m_lRecordCount; }
} // namespace gm3
