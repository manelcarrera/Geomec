...
C3DTimestep::C3DTimestep(const CString &strName, const int nYear) : CTimestep((LPCSTR)strName, nYear) {}

C3DTimestep::C3DTimestep(const CString &strName) : CTimestep((LPCSTR)strName) {}
