...
/*
  ...
  ---------
    ...
    Header:		defines the content of 'subsidence' that can be whatever combination of 'dx', 'dy', and 'dx' ->'dx dy dz',
  'dx dy', 'dx dz', 'dx', 'dy', dz
...
class Displacement : public IT_Data {
  enum Type { Elems, Z, Wdat, Subsidence, Num_Objects };
