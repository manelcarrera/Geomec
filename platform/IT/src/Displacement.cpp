...
{ 
  ...
  {
    case Z:			return z_d();
    case Elems:		return elems_d();
    case Subsidence:return subsidence_d();
    case Wdat:		return wdat_d();
...
TData Displacement::subsidence_d()
{		
  return data<T3Values>( m_subsidence, IT_Data::Cols_Subsidence ); 
}
