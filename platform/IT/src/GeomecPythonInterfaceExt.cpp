...
const TCModule CModuleDefault = TCModule{GeomecPythonInterfaceExt::C_MODULE, GeomecPythonInterfaceExt::GeomecMethods};
...
PyTuple *GeomecPythonInterfaceExt::func(PyObject *self, PyObject *args) {
  ...
  TPyModule py_module = TPyModule{module, function, EMPTY_STRING,
                                  params_t}; // FIXME: check if it's needed to build a tuple or an object is enought
...
PyTuple *GeomecPythonInterfaceExt::reservoir(PyObject *self, PyObject *args) {
  ...
  PyTuple *tuple = wrapper::execute(py_module, TCModuleV{CModuleDefault}, _callback_reservoir);
  return tuple;
}
...
PyTuple *GeomecPythonInterfaceExt::displacement(PyObject *self, PyObject *args) {
  ...
  PyTuple *tuple = wrapper::execute(py_module, TCModuleV{CModuleDefault}, _callback_displacement);
  return tuple;
}