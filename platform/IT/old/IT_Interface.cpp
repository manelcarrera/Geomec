...
const TPyModule &IT_Interface::PyModuleDefault =
    TPyModule{IT_Interface::PYTHON_MODULE, IT_Interface::FUNCTION, IT_Interface::PARAM, IT_Interface::PARAM_PY};

const TCModule &IT_Interface::CModuleDefault =
    TCModule{GeomecPythonInterface::C_MODULE, GeomecPythonInterface::GeomecMethods};

const TCModule &IT_Interface::CModuleExtended =
    TCModule{GeomecPythonInterfaceExt::C_MODULE, GeomecPythonInterfaceExt::GeomecMethods};
                         ...
                         TCModuleV c_modules_v) // FIXME: not taken in account
{
  ...
  // launch
  const TPyModule &py_module_conf =
      TPyModule{config::instance().getValueOfKey<std::string>("MODULE"),
                config::instance().getValueOfKey<std::string>("FUNCTION"), IT_Interface::PARAM, IT_Interface::PARAM_PY};
