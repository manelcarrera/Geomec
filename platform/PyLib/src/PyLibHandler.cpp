...
typedef struct
{
  ...
  PyObject* (__stdcall* f_Py_InitModule4)(const char *name, PyMethodDef *methods, const char *doc, PyObject *self, int
apiver); } functions_struct;
...
typedef PyObject *(__stdcall *f_Py_InitModule4_64)(const char *name, PyMethodDef *methods, const char *doc,
...
// f__Py_NoneStruct_obj _Py_NoneStruct = *( f__Py_NoneStruct )GetProcAddress( PyLibHandler::instance().handler(),
// "_Py_NoneStruct" );
...
// f_PyCObject_Type_obj PyCObject_Type = *( f_PyCObject_Type )GetProcAddress( PyLibHandler::instance().handler(),
// "PyCObject_Type" );
f_PyCObject_Type_obj PyCObject_Type;

typedef PyObject *f_PyExc_AttributeError;
// f_PyExc_AttributeError PyExc_AttributeError = ( f_PyExc_AttributeError )GetProcAddress(
// PyLibHandler::instance().handler(), "PyExc_AttributeError" );
f_PyExc_AttributeError PyExc_AttributeError;

typedef PyObject *f_PyExc_ImportError;
// f_PyExc_ImportError PyExc_ImportError = ( f_PyExc_ImportError )GetProcAddress( PyLibHandler::instance().handler(),
// "PyExc_ImportError" );
f_PyExc_ImportError PyExc_ImportError;

typedef PyObject *f_PyExc_RuntimeError;
// f_PyExc_RuntimeError PyExc_RuntimeError = ( f_PyExc_RuntimeError )GetProcAddress( PyLibHandler::instance().handler(),
// "PyExc_RuntimeError" );
...
void Py_InitVars() {
  ...
  PyExc_AttributeError =
      (f_PyExc_AttributeError)GetProcAddress(PyLibHandler::instance().handler(), "PyExc_AttributeError");
...
/*
f_PyArg_ParseTuple local_PyArg_ParseTuple	= ( f_PyArg_ParseTuple )GetProcAddress( PyLibHandler::instance().handler(),
"PyArg_ParseTuple" ); #define PyArg_ParseTuple(tuple,cp,...) local_PyArg_ParseTuple( tuple,cp,__VA_ARGS__ );
*/
...
int PyArg_VaParse(PyObject *args, const char *format, va_list vargs) {
  f_PyArg_VaParse PyArg_VaParse_ptr =
      (f_PyArg_VaParse)GetProcAddress(PyLibHandler::instance().handler(), "PyArg_VaParse");
...
void Py_Initialize() {
  f_Py_Initialize Py_Initialize_ptr =
      (f_Py_Initialize)GetProcAddress(PyLibHandler::instance().handler(), "Py_Initialize");
  Py_Initialize_ptr();
}
PyObject *Py_InitModule4_64(const char *name, PyMethodDef *methods, const char *doc, PyObject *self, int apiver) {
  f_Py_InitModule4_64 Py_InitModule4_64_ptr =
      (f_Py_InitModule4_64)GetProcAddress(PyLibHandler::instance().handler(), "Py_InitModule4_64");
  return Py_InitModule4_64_ptr(name, methods, doc, self, apiver);
}
void PySys_SetArgv(int argc, char **argv) {
  f_PySys_SetArgv PySys_SetArgv_ptr =
      (f_PySys_SetArgv)GetProcAddress(PyLibHandler::instance().handler(), "PySys_SetArgv");
...
char *PyString_AsString(PyObject *obj) {
  f_PyString_AsString PyString_AsString_ptr =
      (f_PyString_AsString)GetProcAddress(PyLibHandler::instance().handler(), "PyString_AsString");
  return PyString_AsString_ptr(obj);
}
PyObject *Py_VaBuildValue(const char *cp, va_list vargs) {
  f_Py_VaBuildValue Py_VaBuildValue_ptr =
      (f_Py_VaBuildValue)GetProcAddress(PyLibHandler::instance().handler(), "Py_VaBuildValue");
...
PyObject *PyTuple_GetItem(PyObject *obj, Py_ssize_t pos) {
  f_PyTuple_GetItem PyTuple_GetItem_ptr =
      (f_PyTuple_GetItem)GetProcAddress(PyLibHandler::instance().handler(), "PyTuple_GetItem");
...
int PyTuple_SetItem(PyObject *obj, Py_ssize_t size, PyObject *obj2) {
  f_PyTuple_SetItem PyTuple_SetItem_ptr =
      (f_PyTuple_SetItem)GetProcAddress(PyLibHandler::instance().handler(), "PyTuple_SetItem");
  return PyTuple_SetItem_ptr(obj, size, obj2);
}
PyObject *PyString_FromString(const char *cp) {
  f_PyString_FromString PyString_FromString_ptr =
      (f_PyString_FromString)GetProcAddress(PyLibHandler::instance().handler(), "PyString_FromString");
  return PyString_FromString_ptr(cp);
}
PyObject *PyImport_Import(PyObject *name) {
  f_PyImport_Import PyImport_Import_ptr =
      (f_PyImport_Import)GetProcAddress(PyLibHandler::instance().handler(), "PyImport_Import");
  return PyImport_Import_ptr(name);
}
PyObject *PyObject_GetAttrString(PyObject *obj, const char *cp) {
  f_PyObject_GetAttrString PyObject_GetAttrString_ptr =
      (f_PyObject_GetAttrString)GetProcAddress(PyLibHandler::instance().handler(), "PyObject_GetAttrString");
  return PyObject_GetAttrString_ptr(obj, cp);
}
int PyCallable_Check(PyObject *obj) {
  f_PyCallable_Check PyCallable_Check_ptr =
      (f_PyCallable_Check)GetProcAddress(PyLibHandler::instance().handler(), "PyCallable_Check");
  return PyCallable_Check_ptr(obj);
}
PyObject *PyObject_CallObject(PyObject *callable_object, PyObject *args) {
  f_PyObject_CallObject PyObject_CallObject_ptr =
      (f_PyObject_CallObject)GetProcAddress(PyLibHandler::instance().handler(), "PyObject_CallObject");
  return PyObject_CallObject_ptr(callable_object, args);
}
PyObject *PyErr_Occurred(void) {
  f_PyErr_Occurred PyErr_Occurred_ptr =
      (f_PyErr_Occurred)GetProcAddress(PyLibHandler::instance().handler(), "PyErr_Occurred");
...
void *PyCObject_AsVoidPtr(PyObject *obj) {
  f_PyCObject_AsVoidPtr PyCObject_AsVoidPtr_ptr =
      (f_PyCObject_AsVoidPtr)GetProcAddress(PyLibHandler::instance().handler(), "PyCObject_AsVoidPtr");
  return PyCObject_AsVoidPtr_ptr(obj);
}
void PyErr_SetString(PyObject *obj, const char *cp) {
  f_PyErr_SetString PyErr_SetString_ptr =
      (f_PyErr_SetString)GetProcAddress(PyLibHandler::instance().handler(), "PyErr_SetString");
...
PyObject *PyImport_ImportModule(const char *name) {
  f_PyImport_ImportModule PyImport_ImportModule_ptr =
      (f_PyImport_ImportModule)GetProcAddress(PyLibHandler::instance().handler(), "PyImport_ImportModule");
  return PyImport_ImportModule_ptr(name);
}
PyThreadState *PyEval_SaveThread() {
  f_PyEval_SaveThread PyEval_SaveThread_ptr =
      (f_PyEval_SaveThread)GetProcAddress(PyLibHandler::instance().handler(), "PyEval_SaveThread");
  return PyEval_SaveThread_ptr();
}
void PyEval_RestoreThread(PyThreadState *state) {
  f_PyEval_RestoreThread PyEval_RestoreThread_ptr =
      (f_PyEval_RestoreThread)GetProcAddress(PyLibHandler::instance().handler(), "PyEval_RestoreThread");
  return PyEval_RestoreThread_ptr(state);
}
/*void* PyCapsule_GetPointer(PyObject *capsule, const char *name)
{
  f_PyCapsule_GetPointer PyCapsule_GetPointer_ptr = ( f_PyCapsule_GetPointer )GetProcAddress(
PyLibHandler::instance().handler(), "PyCapsule_GetPointer" ); return PyCapsule_GetPointer_ptr( capsule, name );
}*/
void PyEval_InitThreads(void) {
  f_PyEval_InitThreads PyEval_InitThreads_ptr =
      (f_PyEval_InitThreads)GetProcAddress(PyLibHandler::instance().handler(), "PyEval_InitThreads");
  PyEval_InitThreads_ptr();
}
PyThreadState *Py_NewInterpreter(void) {
  f_Py_NewInterpreter Py_NewInterpreter_ptr =
      (f_Py_NewInterpreter)GetProcAddress(PyLibHandler::instance().handler(), "Py_NewInterpreter");
  return Py_NewInterpreter_ptr();
}
void Py_EndInterpreter(PyThreadState *state) {
  f_Py_EndInterpreter Py_EndInterpreter_ptr =
      (f_Py_EndInterpreter)GetProcAddress(PyLibHandler::instance().handler(), "Py_EndInterpreter");
  Py_EndInterpreter_ptr(state);
}
int PyRun_SimpleStringFlags(const char *cp, PyCompilerFlags *flags) {
  f_PyRun_SimpleStringFlags PyRun_SimpleStringFlags_ptr =
      (f_PyRun_SimpleStringFlags)GetProcAddress(PyLibHandler::instance().handler(), "PyRun_SimpleStringFlags");
