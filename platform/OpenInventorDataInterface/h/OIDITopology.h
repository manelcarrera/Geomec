...
template <class CellType, class MiTopologyExplicitIType> class OIDITopologyExplicitI : public MiTopologyExplicitIType {
...
public:
  OIDITopologyExplicitI(const geo::IElementSet *parent, const std::vector<CellType> &cells)
      : m_Parent(parent), m_Cells(0), m_TimeStamp(MxTimeStamp::getTimeStamp()) {
    if (!m_Parent)
      return;
  ...
  OIDITopologyExplicitI(const geo::IArray *parent, const std::vector<CellType> &cells)
      : m_Parent(0), m_Cells(0), m_TimeStamp(MxTimeStamp::getTimeStamp()) {
  ...
  OIDITopologyExplicitI(const geo::IBox *parent, const std::vector<CellType> &cells)
      : m_Parent(0), m_Cells(0), m_TimeStamp(MxTimeStamp::getTimeStamp()) {
    // assert(cells.size() > 0 && cells.size() <= parent->Size());
  ...
  size_t getBeginNodeId() const { return m_beginNodeId; }

  size_t getEndNodeId() const { return m_endNodeId; }
...
public:
  OIDIVolumeTopologyExplicitI(const geo::IElementSet *parent, const std::vector<OIDIVolumeCell> &cells)
      : OIDITopologyExplicitI(parent, cells) {}
  OIDIVolumeTopologyExplicitI(const geo::IArray *parent, const std::vector<OIDIVolumeCell> &cells)
      : OIDITopologyExplicitI(parent, cells) {}
  OIDIVolumeTopologyExplicitI(const geo::IBox *parent, const std::vector<OIDIVolumeCell> &cells)
      : OIDITopologyExplicitI(parent, cells) {}
};

class OIDISurfaceTopologyExplicitI : public OIDITopologyExplicitI<OIDISurfaceCell, MiSurfaceTopologyExplicitI> {
public:
  OIDISurfaceTopologyExplicitI(const geo::IElementSet *parent, const std::vector<OIDISurfaceCell> &cells)
      : OIDITopologyExplicitI(parent, cells) {}
  OIDISurfaceTopologyExplicitI(const geo::IArray *parent, const std::vector<OIDISurfaceCell> &cells)
      : OIDITopologyExplicitI(parent, cells) {}
  OIDISurfaceTopologyExplicitI(const geo::IBox *parent, const std::vector<OIDISurfaceCell> &cells)
      : OIDITopologyExplicitI(parent, cells) {}
};

class OIDILineTopologyExplicitI : public OIDITopologyExplicitI<OIDILineCell, MiLineTopologyExplicitI> {
public:
  OIDILineTopologyExplicitI(const geo::IElementSet *parent, const std::vector<OIDILineCell> &cells)
      : OIDITopologyExplicitI(parent, cells) {}
  OIDILineTopologyExplicitI(const geo::IArray *parent, const std::vector<OIDILineCell> &cells)
      : OIDITopologyExplicitI(parent, cells) {}
  OIDILineTopologyExplicitI(const geo::IBox *parent, const std::vector<OIDILineCell> &cells)
      : OIDITopologyExplicitI(parent, cells) {}
};
...
public:
  ...
  virtual size_t getEndNodeId() const { return m_pointSet->Size(); }

  virtual const MiSurfaceCell *getCell(size_t id) const { return m_cell; }

  virtual size_t getNumCells() const { return 1; }
