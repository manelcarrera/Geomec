...
CDoubleEdit::CDoubleEdit() : m_bAllowNegativeNumbers(true) { m_UseAsIntegerInput = false; }
...
void CDoubleEdit::ShowValue(const double &NewValue) { SetWindowText(Format(NewValue, m_UseAsIntegerInput)); }

// ##ModelId=3C0DC15D036B
void CDoubleEdit::MakeEmpty() { SetWindowText(""); }
...
void CDoubleEdit::UseAsIntegerInput() { m_UseAsIntegerInput = true; }
...
// ##ModelId=3C8D9E1D0292
void CDoubleEdit::OnKillfocus() { DoValidation(); }
