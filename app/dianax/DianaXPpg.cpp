...
IMPLEMENT_OLECREATE_EX(CDianaXPropPage, "DIANAX.DianaXPropPage.1", 0x3a01bc18, 0xba9f, 0x11d2, 0xb3, 0xb4, 0, 0x10,
                       0x4b, 0x25, 0x56, 0xd9)
...
BOOL CDianaXPropPage::CDianaXPropPageFactory::UpdateRegistry(BOOL bRegister) {
  if (bRegister)
    return AfxOleRegisterPropertyPageClass(AfxGetInstanceHandle(), m_clsid, IDS_DIANAX_PPG);
  else
...
CDianaXPropPage::CDianaXPropPage() : COlePropertyPage(IDD, IDS_DIANAX_PPG_CAPTION) {
