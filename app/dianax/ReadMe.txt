========================================================================
		ActiveX Control DLL : DIANAX
========================================================================

ControlWizard has created this project for your DIANAX ActiveX Control
...
that make up your DIANAX ActiveX Control DLL.
...
DianaXCtl.h
	This file contains the declaration of the CDianaXCtrl C++ class.

DianaXCtl.cpp
	This file contains the implementation of the CDianaXCtrl C++ class.

DianaXPpg.h
	This file contains the declaration of the CDianaXPropPage C++ class.

DianaXPpg.cpp
	This file contains the implementation of the CDianaXPropPage C++ class.

DianaXCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CDianaXCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file DianaX.rc.
