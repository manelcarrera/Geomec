...
//
// We define two tasks, one to initialize an array of vectors with random components, and one to calculate their length (stored in component 'l').
// 
...
int main(int argc, char *argv[])
{
  ...
  std::cout << std::endl << "dispatched par init executed in " << kernelDispatcher.seconds() << " seconds (kernel says: " << parKernelInit.seconds() << "s)" << std::endl;
  ...
  std::cout << std::endl << "dispatched par length executed in " << kernelDispatcher.seconds() << " seconds (kernel says: " << parKernelLength.seconds() << "s)" << std::endl;
  ...
  std::cout << std::endl << "100 * dispatched par length executed in " << kernelDispatcher.seconds() << " seconds" << std::endl;
  ...
  std::cout << std::endl << "100 * dispatched seq length executed in " << kernelDispatcher.seconds() << " seconds" << std::endl;
