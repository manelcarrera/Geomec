...
public:
  ...
  enum DataType { Headers, Dependencies, DependentProjects, DependenciesnNotFound };
  ...
  class CProject {
  public:
    enum ProjectsType { Dependent, LikedBy, DependenciesNotFound };
    ...
    CProject(QString _name = "", QString _path = "", bool _is_external = false)
        : name(_name), path(_path), is_external(_is_external) {};
  };
  ...
  void
  new_print_results(CDependencies::CProject::ProjectsType _type = CDependencies::CProject::ProjectsType::Dependent);
...
private:
  ...
  QList<QPair<QString, int>> get_number_of_projects(
      CDependencies::CProject::ProjectsType _type = CDependencies::CProject::ProjectsType::Dependent);
};
