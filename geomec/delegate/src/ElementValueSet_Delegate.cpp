...
CElementValueSet_Delegate::CElementValueSet_Delegate(CElementValueSet *elementValueSet)
    : IValueSet_Delegate(elementValueSet), m_elementValueSet(elementValueSet) {}
