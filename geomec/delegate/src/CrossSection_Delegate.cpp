...
: CStorageNode_Delegate(crossSection)
...
void CCrossSection_Delegate::AppendContextMenu(CContextMenuInvoker& invoker)
{
  ...
  invoker.AddCommand(_T("Flip"),
  *(new TCommand(*m_crossSection, &CCrossSection::Flip,
      &CCrossSection::CanFlip)));
...
CCrossSection_Delegate::CCSObject_Delegate::CCSObject_Delegate(
  CCrossSection::CCSObject* csObject)
: COpenGLNode_Delegate(csObject)
, m_csObject(csObject)
{
}

CCrossSection_Delegate::CCSFormation_Delegate::CCSFormation_Delegate(
  CCrossSection::CCSFormation* csFormation)
: CCSObject_Delegate(csFormation)
, m_csFormation(csFormation)
{
}

CCrossSection_Delegate::CCSWellPath_Delegate::CCSWellPath_Delegate(
  CCrossSection::CCSWellPath* csWellPath)
: CCSObject_Delegate(csWellPath)
, m_csWellPath(csWellPath)
{
}

CCrossSectionEntry_Delegate::CCrossSectionEntry_Delegate(
  CCrossSectionEntry* crossSectionEntry)
: CStorageNodeEntry_Delegate <CCrossSection> (crossSectionEntry)
, m_crossSectionEntry(crossSectionEntry)
{
}

void CCrossSectionEntry_Delegate::AppendContextMenu(
  CContextMenuInvoker& invoker)
{
  ...
  typedef CSingleCommandTemplate <CCrossSectionEntry_Delegate>
  TCrossSectionCommand_Delegate;

  invoker.AddCommand(_T("Insert cross section"),
  *(new TCrossSectionCommand_Delegate(*this,
  &CCrossSectionEntry_Delegate::InsertAny,
...
bool CCrossSectionEntry_Delegate::CanInsertNew() const
{
  ...
  return true; //FIXME
  return m_crossSectionEntry->Model().GraphEntry(MD_BASE_HORIZON)->
  GraphEntryNodes().size() > 1;
}
...
void CCrossSectionEntry_Delegate::InsertAny()
{
  ...
  CCrossSection* pXSec =
  new CCrossSection("New cross section", m_crossSectionEntry->Model(), center, normal);
