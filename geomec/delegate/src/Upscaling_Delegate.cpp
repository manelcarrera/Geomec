...
IUpscalingNodeBase_Delegate::IUpscalingNodeBase_Delegate(IUpscalingNodeBase *upscalingNodeBase)
    : CStorageNode_Delegate(upscalingNodeBase), m_upscalingNodeBase(upscalingNodeBase) {}
...
void IUpscalingNodeBase_Delegate::AppendContextMenu(CContextMenuInvoker &invoker) {
  typedef CSingleCommandTemplate<IUpscalingNodeBase_Delegate> TCommand;

  invoker.AddCommand(
      "Execute", *new TCommand(*this, &IUpscalingNodeBase_Delegate::Execute, &IUpscalingNodeBase_Delegate::CanExecute));
...
void IUpscalingNodeBase_Delegate::Execute() { assert(false); }

CUpscalingEntry_Delegate::CUpscalingEntry_Delegate(CUpscalingEntry *upscalingEntry)
    : CGraphEntryTemp_Delegate<IUpscalingNodeBase>(upscalingEntry), m_upscalingEntry(upscalingEntry) {}
...
void CUpscalingEntry_Delegate::AppendContextMenu(CContextMenuInvoker &invoker) {
  ...
  invoker.AddCommand("New Thin Layer Upscaling",
                     *new TCommand(*m_upscalingEntry, &CUpscalingEntry::CreateThinLayerUpscaling));
  invoker.AddCommand("New CamClay Upscaling",
                     *new TCommand(*m_upscalingEntry, &CUpscalingEntry::CreateCamClayUpscaling));
...
CUpscalingFormationsBranch_Delegate::CUpscalingFormationsBranch_Delegate(
    ...
    : COpenGLNode_Delegate(upscalingFormationsBranch), m_upscalingFormationsBranch(upscalingFormationsBranch) {}

bool CUpscalingFormationsBranch_Delegate::Attributes() {
  CSelectFormationsDlg dlg(*m_upscalingFormationsBranch, m_upscalingFormationsBranch->FormationFilter());
...
IUpscalingPointsetBranchBase_Delegate::IUpscalingPointsetBranchBase_Delegate(
    ...
    : COpenGLNode_Delegate(upscalingPointsetBranchBase), m_upscalingPointsetBranchBase(upscalingPointsetBranchBase) {}

CUpscalingPointsetRangesBranch_Delegate::CUpscalingPointsetRangesBranch_Delegate(
...
CUpscalingTargetPointsetBranch_Delegate::CUpscalingTargetPointsetBranch_Delegate(
...
void CUpscalingTargetPointsetBranch_Delegate::AppendContextMenu(CContextMenuInvoker &invoker) {
  typedef CSingleCommandTemplate<CUpscalingTargetPointsetBranch> TCommand;
  typedef CSingleCommandTemplate<CUpscalingTargetPointsetBranch_Delegate> TCommand_Delegate;

  CContextMenuInvoker *pSubMenu = new CContextMenuInvoker;

  pSubMenu->AddCommand("Define Regular 2D Grid",
                       *new TCommand_Delegate(*this, &CUpscalingTargetPointsetBranch_Delegate::CreateFromRegular2DGrid,
                                              &CUpscalingTargetPointsetBranch_Delegate::CanCreateFromRegular2DGrid));
  pSubMenu->AddCommand("From Existing 2D",
                       *new TCommand_Delegate(*this, &CUpscalingTargetPointsetBranch_Delegate::CreateFromExisting2D,
                                              &CUpscalingTargetPointsetBranch_Delegate::CanCreateFromExisting2D));
  pSubMenu->AddCommand("From Surface Nodes",
                       *new TCommand_Delegate(*this, &CUpscalingTargetPointsetBranch_Delegate::CreateFromSurfaceNodes,
...
void CUpscalingTargetPointsetBranch_Delegate::CreateFromRegular2DGrid() {
  CDefineRegular2DGridDlg dlg(static_cast<CModelBase &>(m_upscalingTargetPointsetBranch->Model()));

  if (dlg.DoModal() == IDOK) {
    m_upscalingTargetPointsetBranch->CreateFromRegular2DGrid(dlg.Corner1(), dlg.Corner2(), dlg.NumPointsNorthing(),
                                                             dlg.NumPointsEasting());
  }
}
...
void CUpscalingTargetPointsetBranch_Delegate::CreateFromExisting2D() {
  CSelect2DPointsetDlg dlg(static_cast<CModelBase &>(m_upscalingTargetPointsetBranch->Model()));

  if (dlg.DoModal() == IDOK) {
    assert(dlg.SelectedPointset());
    m_upscalingTargetPointsetBranch->CreateFromExisting2D(*dlg.SelectedPointset());
  }
}
...
void CUpscalingTargetPointsetBranch_Delegate::CreateFromSurfaceNodes() {
  CSelectSurfaceDlg dlg(static_cast<CModelBase &>(m_upscalingTargetPointsetBranch->Model()));

  if (dlg.DoModal() == IDOK) {
    assert(dlg.SelectedSurface());
    m_upscalingTargetPointsetBranch->CreateFromSurfaceNodes(*dlg.SelectedSurface());
  }
}
