...
CGroupNode_Delegate::CGroupNode_Delegate(CGroupNode *groupNode) : COpenGLNode_Delegate(groupNode) {}
...
void CGroupNode_Delegate::AppendContextMenu(CContextMenuInvoker &invoker) {
  ...
  invoker.AddCommand(_T("&Delete"), *(new TModelCommand(*GetGeomecDoc(), &CFemAppDoc::OnContextDelete,
