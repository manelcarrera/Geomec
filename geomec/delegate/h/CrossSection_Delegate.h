...
class CCrossSectionEntry_Delegate : public CStorageNodeEntry_Delegate<CCrossSection> {
public:
...
private:
  ...
  CCrossSectionEntry_Delegate &operator=(const CCrossSectionEntry_Delegate &rhs);
