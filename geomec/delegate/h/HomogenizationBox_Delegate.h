...
private:
  ...
  CHomogenizationBox_Delegate &operator=(const CHomogenizationBox_Delegate &rhs);
...
class CHomoBoxEntry_Delegate : public CStorageNodeEntry_Delegate<CHomogenizationBox> {
public:
