...
class CDeletableNodeObserver_Delegate
    : public CNodeObserver_Delegate<OBSERVED_TYPE, DELEGATE_TYPE, CHILD_TYPE, CHILD_OBS_TYPE, RENAME, REMOVE> {
public:
  CDeletableNodeObserver_Delegate(OBSERVED_TYPE &node, CTreeNode &parent, const BOOL rename,
  ...
  CDeletableNodeObserver_Delegate(OBSERVED_TYPE &node, CTreeCtrl &ctrl, const BOOL rename,
