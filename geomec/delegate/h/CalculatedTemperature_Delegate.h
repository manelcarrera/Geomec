...
public:
  CCalculatedTemperature_Delegate(CCalculatedTemperature *calculatedTemperature);

private:
  CCalculatedTemperature_Delegate(const CCalculatedTemperature_Delegate &rhs);
  CCalculatedTemperature_Delegate &operator=(const CCalculatedTemperature_Delegate &rhs);
