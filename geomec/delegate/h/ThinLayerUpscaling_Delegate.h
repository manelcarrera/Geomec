...
public:
  CThinLayerUpscalingNode_Delegate(CThinLayerUpscalingNode *thinLayerUpscalingNode);
...
private:
  ...
  CThinLayerUpscalingNode_Delegate &operator=(const CThinLayerUpscalingNode_Delegate &rhs);
