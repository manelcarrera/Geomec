...
public:
  CWellCasingFormationEntry_Delegate(CWellCasingFormationEntry *wellCasingFormationEntry);

private:
  CWellCasingFormationEntry_Delegate(const CWellCasingFormationEntry_Delegate &rhs);
  CWellCasingFormationEntry_Delegate &operator=(const CWellCasingFormationEntry_Delegate &rhs);

  CWellCasingFormationEntry *m_wellCasingFormationEntry;

  REGISTER_DELEGATE(CWellCasingFormationEntry, CWellCasingFormationEntry_Delegate);
};
