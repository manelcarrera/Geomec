...
class CWellCasingRTCIEntry_Delegate : public CStorageNodeEntry_Delegate<CWellCasingRTCI> {
public:
...
private:
  ...
  CWellCasingRTCIEntry_Delegate &operator=(const CWellCasingRTCIEntry_Delegate &rhs);
