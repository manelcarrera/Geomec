...
typedef CMaterialServerParent <COpenGLNode,
  CWellCasingMaterialServer> TWellCasingMaterialServerParent;
...
typedef CMaterialServerParent_Delegate <COpenGLNode_Delegate, COpenGLNode,
  CWellCasingMaterialServer> TWellCasingMaterialServerParent_Delegate;

class CWellCasingSteel_Delegate :
  public TWellCasingMaterialServerParent_Delegate
{
public:
