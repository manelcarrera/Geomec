...
public:
  ...
  public:
    ...
    public:
      IWellSupportNode_Delegate(IWellModel::CBoundary::IWellSupportNode *wellSupportNode);

    private:
      IWellSupportNode_Delegate(const IWellSupportNode_Delegate &rhs);
      IWellSupportNode_Delegate &operator=(const IWellSupportNode_Delegate &rhs);

      IWellModel::CBoundary::IWellSupportNode *m_wellSupportNode;

      REGISTER_DELEGATE(IWellModel::CBoundary::IWellSupportNode, IWellSupportNode_Delegate);
    };

    class CDisplacementSupport_Delegate : public IWellSupportNode_Delegate {
    public:
      CDisplacementSupport_Delegate(IWellModel::CBoundary::CDisplacementSupport *displacementSupport);

    private:
      CDisplacementSupport_Delegate(const CDisplacementSupport_Delegate &rhs);
      CDisplacementSupport_Delegate &operator=(const CDisplacementSupport_Delegate &rhs);

      IWellModel::CBoundary::CDisplacementSupport *m_displacementSupport;

      REGISTER_DELEGATE(IWellModel::CBoundary::CDisplacementSupport, CDisplacementSupport_Delegate);
    };

    class CPressureSupport_Delegate : public IWellSupportNode_Delegate {
    public:
      CPressureSupport_Delegate(IWellModel::CBoundary::CPressureSupport *pressureSupport);

    private:
      CPressureSupport_Delegate(const CPressureSupport_Delegate &rhs);
      CPressureSupport_Delegate &operator=(const CPressureSupport_Delegate &rhs);

      IWellModel::CBoundary::CPressureSupport *m_pressureSupport;

      REGISTER_DELEGATE(IWellModel::CBoundary::CPressureSupport, CPressureSupport_Delegate);
    };
