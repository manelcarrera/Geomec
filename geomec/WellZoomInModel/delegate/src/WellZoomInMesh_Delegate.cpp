...
CWellZoomInMesh_Delegate::CWellZoomInMesh_Delegate(CWellZoomInMesh *wellZoomInMesh)
    : IWellMesh_Delegate(wellZoomInMesh), m_wellZoomInMesh(wellZoomInMesh) {}
...
bool CWellZoomInMesh_Delegate::IsMesh() const { return m_wellZoomInMesh->IsMesh(); }
