...
CWellCasingMaterialServer_Delegate::CWellCasingMaterialServer_Delegate(
    ...
    : IMaterialServerTempl_Delegate<CWellCasingSteelMaterial, CWellCasingSteelMaterial_Delegate,
                                    TWellCasingMaterialServerParent>(wellCasingMaterialServer),
      m_wellCasingMaterialServer(wellCasingMaterialServer) {}

CWellCasingSteel_Delegate::CWellCasingSteel_Delegate(CWellCasingSteel *wellCasingSteel)
    : TWellCasingMaterialServerParent_Delegate(wellCasingSteel), m_wellCasingSteel(wellCasingSteel) {}
