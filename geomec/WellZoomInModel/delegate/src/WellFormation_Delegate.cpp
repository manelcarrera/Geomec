...
: C3DFormation_Delegate(wellFormation)
, m_wellFormation(wellFormation)
{
}
...
CWellFormationEntry_Delegate::CWellFormationEntry_Delegate(
  CWellFormationEntry* wellFormationEntry)
: CFormationEntryTempl_Delegate <CWellFormation> (wellFormationEntry)
, m_wellFormationEntry(wellFormationEntry)
{
}

void CWellFormationEntry_Delegate::AppendContextMenu(
