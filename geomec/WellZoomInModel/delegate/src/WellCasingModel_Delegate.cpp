...
CWellCasingModel_Delegate::CWellCasingModel_Delegate(
  CWellCasingModel* wellCasingModel)
: IWellModel_Delegate(wellCasingModel)
...
: CWellFormationEntry_Delegate(wellCasingFormationEntry)
, m_wellCasingFormationEntry(wellCasingFormationEntry)
{
}
