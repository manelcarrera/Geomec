...
IWellModel_Delegate::CBoundary_Delegate::CBoundary_Delegate(
  IWellModel::CBoundary* boundary)
: CBoundaryBase_Delegate(boundary)
, m_boundary(boundary)
{
}

void IWellModel_Delegate::CBoundary_Delegate::AppendContextMenu(
...
bool IWellModel_Delegate::CBoundary_Delegate::CanEdit() const
{
  return false;
}

bool IWellModel_Delegate::CBoundary_Delegate::CanModify() const
{
  return false;
}
