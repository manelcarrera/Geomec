...
CWellFormationEntryObserver::CWellFormationEntryObserver(CWellFormationEntry &entry, CTreeCtrl &ctrl, HTREEITEM hParent,
                                                         HTREEITEM hInsertAfter)
    : CStateBranch_Delegate<CWellFormationEntry, CWellFormationEntry_Delegate, CWellFormation, TWellFormationObserver,
