...
typedef COpenGLNodeObserver_Delegate<CWellCasingCement, CWellCasingCement_Delegate, CDummyNode, CDummyObserver, FALSE,
                                     FIXED_ITEM>
    TWellCasingCementObserver;
class CWellCasingCementObserver : public TWellCasingCementObserver {
public:
  CWellCasingCementObserver(CWellCasingCement &node, CTreeCtrl &ctrl, const BOOL rename, const enum REMOVE_TYPE remove,
