...
typedef CNodeObserver_Delegate<CGraphNode, CGraphNode_Delegate, CDummyNode, CDummyObserver, FALSE, FIXED_ITEM> TGraphNodeObs;
typedef CStateBranch_Delegate<CWellCasingNode, CWellCasingNode_Delegate, CGraphNode, TGraphNodeObs, CUndefinedIconProvider, FALSE, FIXED_ITEM> TWellCasingNodeObserverBase;
