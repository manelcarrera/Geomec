...
CAttriWellCasingMaterialDlg::CAttriWellCasingMaterialDlg(CWellCasingSteelMaterial &mat, CWnd *pParent)
    : TBase(IDD_ATTRI_WELLCASINGSTEEL, mat, pParent), m_pNewListObject(0) {}
...
void CAttriWellCasingMaterialDlg::DeleteItem(std::pair<double, double> &prDelete,
                                             CStressStrainListObject *pListObject) {
...
int CALLBACK CAttriWellCasingMaterialDlg::ListCtrlCompareFunc(LPARAM lParam1, LPARAM lParam2, LPARAM lParamSort) {
  ...
  const CAttriWellCasingMaterialDlg::CNewStressStrainListObject *pNewObject1 =
      dynamic_cast<const CAttriWellCasingMaterialDlg::CNewStressStrainListObject *>(pListObject1);
  const CAttriWellCasingMaterialDlg::CNewStressStrainListObject *pNewObject2 =
      dynamic_cast<const CAttriWellCasingMaterialDlg::CNewStressStrainListObject *>(pListObject2);
  ...
  const CAttriWellCasingMaterialDlg::CStressStrainListObject *pObject1 =
      (const CAttriWellCasingMaterialDlg::CStressStrainListObject *)lParam1;
  const CAttriWellCasingMaterialDlg::CStressStrainListObject *pObject2 =
      (const CAttriWellCasingMaterialDlg::CStressStrainListObject *)lParam2;
...
CAttriWellCasingMaterialDlg::CStressStrainListObject::CStressStrainListObject(CListCtrl &ctrl,
                                                                              TStressStrainPair &prStressStrain,
                                                                              CAttriWellCasingMaterialDlg &dlg,
                                                                              CDoubleQuantity::UNIT unit)
    : IListObject(ctrl), m_prStressStrain(prStressStrain), m_dlg(dlg), m_unit(unit) {
  Ctrl().SetItemData(Ctrl().GetItemCount() - 1, (DWORD_PTR)this);
  new CStressStrainListSubObject(*this);
}

unsigned int CAttriWellCasingMaterialDlg::CStressStrainListObject::Icon() const { return IDI_SIGMA_EPSILON; }
...
BOOL CAttriWellCasingMaterialDlg::CStressStrainListObject::CanEditText() const { return TRUE; }
...
double CAttriWellCasingMaterialDlg::CStressStrainListObject::Stress() const { return m_prStressStrain.first; }

double CAttriWellCasingMaterialDlg::CStressStrainListObject::Strain() const { return m_prStressStrain.second; }
...
/* NOT OBSOLETE */ void
CAttriWellCasingMaterialDlg::CStressStrainListObject::AppendContextMenu(CContextMenuInvoker &invoker) {
  if (Index() > 0)
    invoker.AddCommand(
        "Delete", *new CSingleCommandTemplate<CStressStrainListObject>(*this, &CStressStrainListObject::DeleteItem));
}

void CAttriWellCasingMaterialDlg::CStressStrainListObject::DeleteItem() { m_dlg.DeleteItem(m_prStressStrain, this); }
...
BOOL CAttriWellCasingMaterialDlg::CStressStrainListSubObject::CanEditText() const { return (ListObject().Index() > 0); }
...
CAttriWellCasingMaterialDlg::CNewStressStrainListObject::CNewStressStrainListObject(CListCtrl &ctrl,
                                                                                    CAttriWellCasingMaterialDlg &dlg)
    : IListObject(ctrl), m_dlg(dlg) {
  Ctrl().SetItemData(Ctrl().GetItemCount() - 1, (DWORD_PTR)this);
  new CDummySubListObject(*this);
}

QString CAttriWellCasingMaterialDlg::CNewStressStrainListObject::Text() const { return "<add new>"; }

void CAttriWellCasingMaterialDlg::CNewStressStrainListObject::OnDoubleClick() { m_dlg.AddNew(); }

unsigned int CAttriWellCasingMaterialDlg::CNewStressStrainListObject::Icon() const { return IDI_NEW_ITEM; }

/////

CAttriWellCasingMaterialDlg::CNewStressStrainListObject::CDummySubListObject::CDummySubListObject(
    CNewStressStrainListObject &parent)
    : ISubListObject(parent, 1) {}

QString CAttriWellCasingMaterialDlg::CNewStressStrainListObject::CDummySubListObject::Text() const { return QString(); }
