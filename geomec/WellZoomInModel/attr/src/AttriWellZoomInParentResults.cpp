...
: CDialog(IDD_ATTRI_WELLZOOMIN_PARENT_RESULTS, pParent),
  m_model(model),
  m_nSelection(int(model.ParentResultsDefinition()))
{
}

void CAttriWellZoomInParentResultsDlg::DoDataExchange(CDataExchange* pDX)
{
  DDX_Radio(pDX, IDC_EQUAL, m_nSelection);
}
