...
CValueReferenceObserver::CValueReferenceObserver(IValueComposite& node,
                          CTreeNode& parent,
                          const BOOL rename,
                          const enum REMOVE_TYPE remove,
                          HTREEITEM hInsertAfter,
                          BOOL bInitialUpdate,
                          BOOL bSortAfterInsertion)
: CValueCompositeObserver(node, parent, rename, remove, hInsertAfter,
                          bInitialUpdate, bSortAfterInsertion)
{
}
...
CValueReferenceObserver::CValueReferenceObserver(IValueComposite& node,
                          ...
                          BOOL bInitialUpdate,
                          BOOL bSortAfterInsertion)
: CValueCompositeObserver(node, ctrl, rename, remove, hParent, hInsertAfter,
                          bInitialUpdate, bSortAfterInsertion)
{
}
