...
typedef CDeletableNodeObserver_Delegate<IUpscalingNodeBase, IUpscalingNodeBase_Delegate, CGraphNode, CDummyObserver, FALSE, FIXED_ITEM> TUpscalingObserver;
class CUpscalingObserver : public TUpscalingObserver
{
public:
  CUpscalingObserver(IUpscalingNodeBase& node,
                      CTreeNode &parent,
                      const BOOL rename,
