...
typedef CNodeObserver_Delegate<IValueComponentBase, IValueComponent_Delegate, CDummyNode, CDummyObserver, FALSE,
                               FIXED_ITEM>
    TValueComponentObserver;

typedef CDeletableNodeObserver_Delegate<IValueComposite, IValueComposite_Delegate, CStorageNode, CDummyObserver, FALSE,
                                        FIXED_ITEM>
    TValueBaseObserver;
...
public:
  CValueCompositeObserver(IValueComposite &node, CTreeNode &parent, const BOOL rename, const enum REMOVE_TYPE remove,
                          HTREEITEM hInsertAfter = TVI_LAST, BOOL bInitialUpdate = FALSE,
                          BOOL bSortAfterInsertion = TRUE);

  CValueCompositeObserver(IValueComposite &node, CTreeCtrl &ctrl, const BOOL rename, const enum REMOVE_TYPE remove,
                          HTREEITEM hParent = TVI_ROOT, HTREEITEM hInsertAfter = TVI_LAST, BOOL bInitialUpdate = FALSE,
                          BOOL bSortAfterInsertion = TRUE);
...
public:
  CValueReferenceObserver(IValueComposite &node, CTreeNode &parent, const BOOL rename, const enum REMOVE_TYPE remove,
                          HTREEITEM hInsertAfter = TVI_LAST, BOOL bInitialUpdate = FALSE,
                          BOOL bSortAfterInsertion = TRUE);

  CValueReferenceObserver(IValueComposite &node, CTreeCtrl &ctrl, const BOOL rename, const enum REMOVE_TYPE remove,
                          HTREEITEM hParent = TVI_ROOT, HTREEITEM hInsertAfter = TVI_LAST, BOOL bInitialUpdate = FALSE,
                          BOOL bSortAfterInsertion = TRUE);
