...
typedef CNodeObserver_Delegate<CNonMeshedSurfaceParametersNode, CNonMeshedSurfaceParametersNode_Delegate, CValueType,
                               CValueCompositeObserver, FALSE, UNLINK_ITEM>
    TNonMeshedSurfaceParametersNodeObserver;
// typedef CNodeObserver_Delegate<CNonMeshedSurfacePressure, CNonMeshedSurfacePressure_Delegate, CValueType,
// CValueCompositeObserver, FALSE, UNLINK_ITEM> TNonMeshedSurfacePressureObserver;
typedef COpenGLNodeObserver_Delegate<CNonMeshedSurface, CNonMeshedSurface_Delegate, CGraphNode, CDummyObserver, TRUE,
                                     DELETE_ITEM>
    TNonMeshedSurfaceObserver;

class CNonMeshedSurfaceObserver : public TNonMeshedSurfaceObserver {
public:
  CNonMeshedSurfaceObserver(CNonMeshedSurface &node, CTreeNode &parent, const BOOL rename,
  ...
  CNonMeshedSurfaceObserver(CNonMeshedSurface &node, CTreeCtrl &ctrl, const BOOL rename, const enum REMOVE_TYPE remove,
...
typedef CStateBranch_Delegate<CNonMeshedSurfaceEntry, CNonMeshedSurfaceEntry_Delegate, CNonMeshedSurface,
                              CNonMeshedSurfaceObserver, CUndefinedIconProvider, TRUE, DELETE_ITEM>
    TNonMeshedSurfaceEntryObserver;
