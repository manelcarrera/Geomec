...
class CGroupNodeObserver : public CStateBranch_Delegate<CGroupNode, CGroupNode_Delegate, Node, Observer,
                                                        CUndefinedIconProvider, TRUE, TREE_DELETE_ITEM> {
public:
  ...
  virtual BOOL CanDelete() { return !static_cast<CGroupNode &>(ObservedItem()).ReadOnly(); }
};
