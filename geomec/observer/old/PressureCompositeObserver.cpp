...
CPressureCompositeObserver::CPressureCompositeObserver(CPressure& node,
											 	 CTreeNode &parent,
												 const BOOL rename,
...
:CValueCompositeObserver((IValueComposite&)node, parent, rename, remove, hInsertAfter, bInitialUpdate, bSortAfterInsertion)
{
	Update();
}
...
CPressureCompositeObserver::CPressureCompositeObserver(CPressure& node,
												 ...
												 BOOL bInitialUpdate,
												 BOOL bSortAfterInsertion)
:CValueCompositeObserver((IValueComposite&)node, ctrl, rename, remove, hParent, hInsertAfter, bInitialUpdate, bSortAfterInsertion)
{
	Update();
}
