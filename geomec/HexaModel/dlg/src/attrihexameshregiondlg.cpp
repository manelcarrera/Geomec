...
CAttriHexaSubMeshRegionDlg::CFormationListObject::CFormationListObject(CListCtrl& ctrl, CHexaFormation& formation, int elements)
...
QString CAttriHexaSubMeshRegionDlg::CFormationListObject::Text() const
{
  return m_formation.Name();
}

unsigned int CAttriHexaSubMeshRegionDlg::CFormationListObject::Icon() const
{
  return m_formation.IconId();
}

const CHexaFormation& CAttriHexaSubMeshRegionDlg::CFormationListObject::Formation() const
{
  return m_formation;
}

CHexaFormation& CAttriHexaSubMeshRegionDlg::CFormationListObject::Formation()
{
  return m_formation;
}
...
int CAttriHexaSubMeshRegionDlg::CMeshDepthObject::Elements() const
{
  return m_nElement;
}
