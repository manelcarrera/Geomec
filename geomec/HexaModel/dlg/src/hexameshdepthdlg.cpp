...
QString CHexaMeshDepthDlg::CFormationListObject::Text() const { return m_formation.Name(); }

unsigned int CHexaMeshDepthDlg::CFormationListObject::Icon() const { return m_formation.IconId(); }

const CHexaFormation &CHexaMeshDepthDlg::CFormationListObject::Formation() const { return m_formation; }

CHexaFormation &CHexaMeshDepthDlg::CFormationListObject::Formation() { return m_formation; }
...
int CHexaMeshDepthDlg::CMeshDepthObject::Elements() const { return m_nElement; }
