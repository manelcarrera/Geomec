...
QString CAttri3DHorizonDlg::CSurfaceListObject::Text() const { return m_pSurface->Name(); }

unsigned int CAttri3DHorizonDlg::CSurfaceListObject::Icon() const { return m_pSurface->IconId(); }
