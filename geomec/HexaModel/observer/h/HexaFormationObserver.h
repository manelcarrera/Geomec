...
typedef COpenGLNodeObserver_Delegate<CHexaFormation, CHexaFormation_Delegate, CDummyNode, CDummyObserver, FALSE,
                                     FIXED_ITEM>
    THexaFormationObserver;
class CHexaFormationEntryObserver
    : public CStateBranch_Delegate<CHexaFormationEntry, CHexaFormationEntry_Delegate, CHexaFormation,
                                   THexaFormationObserver, CUndefinedIconProvider, TRUE, FIXED_ITEM> {
  typedef COpenGLNodeObserver_Delegate<CFormationPlane, CFormationPlane_Delegate, CDummyNode, CDummyObserver, FALSE,
                                       FIXED_ITEM>
      TFormationPlaneObs;
  class CFormationPlaneObs : public TFormationPlaneObs {
  public:
    CFormationPlaneObs(CFormationPlane &node, CTreeNode &parent, const BOOL rename, const enum REMOVE_TYPE remove,
                       HTREEITEM hInsertAfter = TVI_LAST, BOOL bInitialUpdate = TRUE, BOOL bSortAfterInsertion = FALSE);
    CFormationPlaneObs(CFormationPlane &node, CTreeCtrl &ctrl, const BOOL rename, const enum REMOVE_TYPE remove,
...
public:
  CHexaFormationEntryObserver(CHexaFormationEntry &entry, CTreeCtrl &ctrl, HTREEITEM hParent = TVI_ROOT,
