...
CHexaFormationEntryObserver::CFormationPlaneObs::CFormationPlaneObs(CFormationPlane &node, CTreeNode &parent,
                                                                    const BOOL rename, const enum REMOVE_TYPE remove,
...
CHexaFormationEntryObserver::CFormationPlaneObs::CFormationPlaneObs(CFormationPlane &node, CTreeCtrl &ctrl,
                                                                    const BOOL rename, const enum REMOVE_TYPE remove,
...
void CHexaFormationEntryObserver::CFormationPlaneObs::ToggleState() { TFormationPlaneObs::ToggleState(); }

CHexaFormationEntryObserver::CHexaFormationEntryObserver(CHexaFormationEntry &entry, CTreeCtrl &ctrl, HTREEITEM hParent,
                                                         HTREEITEM hInsertAfter)
    : CStateBranch_Delegate<CHexaFormationEntry, CHexaFormationEntry_Delegate, CHexaFormation, THexaFormationObserver,
                            CUndefinedIconProvider, TRUE, FIXED_ITEM>(entry, ctrl, FALSE, FIXED_ITEM, hParent,
                                                                      hInsertAfter, FALSE, FALSE) {
  Update();
}
...
CTreeNode *CHexaFormationEntryObserver::InsertChild(CHexaFormation &t) {
  ...
  typedef COpenGLNodeObserver_Delegate<CHexaHorizon, CHexaHorizon_Delegate, CDummyNode, CDummyObserver, FALSE,
                                       FIXED_ITEM>
      THorizonObj;
  ...
  typedef CMaterialServerObserver_Delegate<CMaterialServer, CMaterialServer_Delegate, CValueType,
      ...
      TMaterialObserver;
  typedef CStateEnumerationBranch<CMaterialServer, TMaterialObserver, TRUE, UNLINK_ITEM, CUndefinedIconProvider>
      TMaterialEnumerator;

  CTreeNode *pTreeObserver =
      CStateBranch_Delegate<CHexaFormationEntry, CHexaFormationEntry_Delegate, CHexaFormation, THexaFormationObserver,
                            CUndefinedIconProvider, TRUE, FIXED_ITEM>::InsertChild(t);

  new THorizonEnumerator(*pTreeObserver, _T("Horizons"), IDI_HORIZONS);
#if 1
  ...
  new TFormationPlaneEnumerator(*pTreeObserver, _T("Planes"), IDI_FORMATIONPLANES);
  /*
