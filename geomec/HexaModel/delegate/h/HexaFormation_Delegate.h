...
class CHexaFormationEntry_Delegate : public CFormationEntryTempl_Delegate<CHexaFormation> {
public:
...
private:
  ...
  CHexaFormationEntry_Delegate &operator=(const CHexaFormationEntry_Delegate &rhs);
