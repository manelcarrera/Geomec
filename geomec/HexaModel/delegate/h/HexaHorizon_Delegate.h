...
class CHexaHorizonEntry_Delegate : public CStorageNodeEntry_Delegate<CHexaHorizon> {
public:
...
private:
  ...
  CHexaHorizonEntry_Delegate &operator=(const CHexaHorizonEntry_Delegate &rhs);
