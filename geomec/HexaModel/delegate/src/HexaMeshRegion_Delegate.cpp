...
CHexaMeshRegionBase_Delegate::CHexaMeshRegionBase_Delegate(
  CHexaMeshRegionBase* hexaMeshRegionBase)
: CMeshRegionBase_Delegate(hexaMeshRegionBase)
, m_hexaMeshRegionBase(hexaMeshRegionBase)
{
}
...
{
  return m_hexaMeshRegionBase->CanDestroy();
}
...
: CHexaMeshRegionBase_Delegate(hexaMainMeshRegion)
, m_hexaMainMeshRegion(hexaMainMeshRegion)
{
}
...
{
  return m_hexaMainMeshRegion->CanDestroy();
}

CHexaSubMeshRegion_Delegate::CHexaSubMeshRegion_Delegate(
  CHexaSubMeshRegion* hexaSubMeshRegion)
: CHexaMeshRegionBase_Delegate(hexaSubMeshRegion)
, m_hexaSubMeshRegion(hexaSubMeshRegion)
{
}
...
CHexaMeshRegionEntry_Delegate::CHexaMeshRegionEntry_Delegate(
  CHexaMeshRegionEntry* hexaMeshRegionEntry)
: CGraphEntryTemp_Delegate <CHexaMeshRegionBase> (hexaMeshRegionEntry)
, m_hexaMeshRegionEntry(hexaMeshRegionEntry)
{
}
...
void CHexaMeshRegionEntry_Delegate::AppendContextMenu(
  CContextMenuInvoker& invoker)
{
