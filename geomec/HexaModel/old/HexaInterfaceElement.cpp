...
const geo::IPoint &CHexaInterfaceElementSet::Point(int nIndex) const { return *m_vcPoint[nIndex]; }

int CHexaInterfaceElementSet::PointSize() const { return m_vcPoint.size(); }

const geo::IElement &CHexaInterfaceElementSet::Element(int nIndex) const { return *m_vcElement[nIndex]; }

int CHexaInterfaceElementSet::ElementSize() const { return m_vcElement.size(); }
...
CHexaInterfaceElement::CHexaInterfaceElement(CHexaInterfaceElementSet &element_set, geo::IPoint &p0, geo::IPoint &p1,
                                             geo::IPoint &p2, geo::IPoint &p3, geo::IPoint &p4, geo::IPoint &p5,
                                             geo::IPoint &p6, geo::IPoint &p7, const geo::CHexahedron &upperBody,
...
CHexaInterfaceElement::~CHexaInterfaceElement() { ClearFaces(); }

// Indexing system
const geo::IElementSet *CHexaInterfaceElement::IndexingElementSet() const { return &m_element_set; }

int CHexaInterfaceElement::Index() const { return m_nIndex; }

int CHexaInterfaceElement::PointIndex(int nIndex) const { return m_points[nIndex]; }
...
int CHexaInterfaceElement::NrOfPoints() const { return 8; }
...
double CHexaInterfaceElement::Volume() const { return 0; }
...
geo::CValue CHexaInterfaceElement::InterpolateValue(const geo::IPoint &point,
...
//=============================================================================
void CHexaInterfaceElement::SetUpperBody(const geo::CHexahedron &body) { m_pUpperBody = &body; }

void CHexaInterfaceElement::SetLowerBody(const geo::CHexahedron &body) { m_pLowerBody = &body; }

const geo::CHexahedron &CHexaInterfaceElement::GetUpperBody() const { return *m_pUpperBody; }

const geo::CHexahedron &CHexaInterfaceElement::GetLowerBody() const { return *m_pLowerBody; }
