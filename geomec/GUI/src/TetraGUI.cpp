...
CTetraGUI::CTetraGUI(CFemAppGUI *parentGUI, CTetraModel *tetraModel)
    : C3DGUI(parentGUI, tetraModel), m_tetraModel(tetraModel) {}

void CTetraGUI::OnCloseModel() { C3DGUI::OnCloseModel(); }

CTetraModel *CTetraGUI::model() const { return m_tetraModel; }

bool CTetraGUI::LoadPre381Stream(CStorageNode::TSTREAM &stream, CStreamVersion &version,
