...
OIV2DWellPathGraphScene* C3DGUI::getOIV2DWellPathGraphScene() const
{
  return m_oiv2DWellPathGraphScene;
}

OIV2DHistoryScene* C3DGUI::getOIV2DHistoryScene() const
{
  return m_oiv2DHistoryScene;
}
