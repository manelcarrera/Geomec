...
CWellCasingGUI::CWellCasingGUI(CFemAppGUI *parentGUI, CWellCasingModel *wellCasingModel)
    : IWellGUI(parentGUI, wellCasingModel), m_wellCasingModel(wellCasingModel) {}
...
void CWellCasingGUI::OnCloseModel() { IWellGUI::OnCloseModel(); }

CWellCasingModel *CWellCasingGUI::model() const { return m_wellCasingModel; }

bool CWellCasingGUI::LoadPre381Stream(CStorageNode::TSTREAM &stream, CStreamVersion &version,
