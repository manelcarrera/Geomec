...
//
//*******************************************************************
typedef CNodeObserver_Delegate<CWellZoomInModel, CWellZoomInModel_Delegate, CDummyNode, CDummyObserver, FALSE, FIXED_ITEM> TNewZoomInObs;
class CNewWellPathObserver : public COpenGLNodeObserver_Delegate<CNewWellPath, CNewWellPath_Delegate, CWellZoomInModel, TNewZoomInObs, FALSE, FIXED_ITEM>
{
public:
