...
: CAttriFormationLoadDlg<CPressure>(prs, IDD_ATTRI_PRESSURE, pParent),
  m_bOk(false)
{
}
...
void CAttriPressureDlg::DoDataExchange(CDataExchange* pDX)
{
  ...
  bool bGetGWCValues = (Copy().Type() == CPressure::GWC_MODE && (!Copy().DistributedOnly() || Copy().DistributedSize() == 0));
  if(bGetGWCValues)
  {
...
CString CAttriPressureDlg::UndefinedLabel() const
{
...
void CAttriPressureDlg::UpdateControls()
{
  ...
  // Enable GWC ...
  GetDlgItem(IDC_ED_CONTACT_PRESSURE)->EnableWindow((Copy().Type() == CPressure::GWC_MODE) && !bDisableAll && (!Copy().DistributedOnly() || Copy().DistributedSize() == 0));
  GetDlgItem(IDC_LBL_CONTACT_PRESSURE)->EnableWindow((Copy().Type() == CPressure::GWC_MODE) && !bDisableAll && (!Copy().DistributedOnly() || Copy().DistributedSize() == 0));
  GetDlgItem(IDC_PRESSURE_UNIT_2)->EnableWindow((Copy().Type() == CPressure::GWC_MODE) && !bDisableAll && (!Copy().DistributedOnly() || Copy().DistributedSize() == 0));

  GetDlgItem(IDC_ED_CONTACT_DEPTH)->EnableWindow((Copy().Type() == CPressure::GWC_MODE) && !bDisableAll && (!Copy().DistributedOnly() || Copy().DistributedSize() == 0));
  GetDlgItem(IDC_LBL_CONTACT_DEPTH)->EnableWindow((Copy().Type() == CPressure::GWC_MODE) && !bDisableAll && (!Copy().DistributedOnly() || Copy().DistributedSize() == 0));
  GetDlgItem(IDC_ST_DEPTH_UNIT_2)->EnableWindow((Copy().Type() == CPressure::GWC_MODE) && !bDisableAll && (!Copy().DistributedOnly() || Copy().DistributedSize() == 0));

  GetDlgItem(IDC_ED_UPPER_GRADIENT)->EnableWindow((Copy().Type() == CPressure::GWC_MODE) && !bDisableAll && (!Copy().DistributedOnly() || Copy().DistributedSize() == 0));
  GetDlgItem(IDC_LBL_UPPER_GRADIENT)->EnableWindow((Copy().Type() == CPressure::GWC_MODE) && !bDisableAll && (!Copy().DistributedOnly() || Copy().DistributedSize() == 0));
  GetDlgItem(IDC_ST_GRADIENT_UNIT_2)->EnableWindow((Copy().Type() == CPressure::GWC_MODE) && !bDisableAll && (!Copy().DistributedOnly() || Copy().DistributedSize() == 0));

  GetDlgItem(IDC_ED_LOWER_GRADIENT)->EnableWindow(Copy().Type() == CPressure::GWC_MODE && Copy().GWC().IsFirstGWC() && !bDisableAll && (!Copy().DistributedOnly() || Copy().DistributedSize() == 0));
  GetDlgItem(IDC_LBL_LOWER_GRADIENT)->EnableWindow(Copy().Type() == CPressure::GWC_MODE && Copy().GWC().IsFirstGWC() && !bDisableAll && (!Copy().DistributedOnly() || Copy().DistributedSize() == 0));
  GetDlgItem(IDC_ST_GRADIENT_UNIT_3)->EnableWindow(Copy().Type() == CPressure::GWC_MODE && Copy().GWC().IsFirstGWC() && !bDisableAll && (!Copy().DistributedOnly() || Copy().DistributedSize() == 0));

  GetDlgItem(IDC_FRAME_TRANS)->EnableWindow((Copy().Type() == CPressure::GWC_MODE) && (!Copy().GWC().IsFirstGWC()) && !bDisableAll && (!Copy().DistributedOnly() || Copy().DistributedSize() == 0));
  GetDlgItem(IDC_TRANS_PREV)->EnableWindow((Copy().Type() == CPressure::GWC_MODE) && (!Copy().GWC().IsFirstGWC()) && !bDisableAll && (!Copy().DistributedOnly() || Copy().DistributedSize() == 0));
  GetDlgItem(IDC_TRANS_SPEC)->EnableWindow((Copy().Type() == CPressure::GWC_MODE) && (!Copy().GWC().IsFirstGWC()) && !bDisableAll && (!Copy().DistributedOnly() || Copy().DistributedSize() == 0));

  GetDlgItem(IDC_LBL_TRANS_PRESSURE)->EnableWindow((Copy().Type() == CPressure::GWC_MODE) && (!Copy().GWC().IsFirstGWC()) && (!Copy().GWC().TransitionFromPrevious()) && !bDisableAll && (!Copy().DistributedOnly() || Copy().DistributedSize() == 0));
  GetDlgItem(IDC_ED_TRANS_PRESSURE)->EnableWindow((Copy().Type() == CPressure::GWC_MODE) && (!Copy().GWC().IsFirstGWC()) && (!Copy().GWC().TransitionFromPrevious()) && !bDisableAll && (!Copy().DistributedOnly() || Copy().DistributedSize() == 0));
  GetDlgItem(IDC_UN_TRANS_PRESSURE)->EnableWindow((Copy().Type() == CPressure::GWC_MODE) && (!Copy().GWC().IsFirstGWC()) && (!Copy().GWC().TransitionFromPrevious()) && !bDisableAll && (!Copy().DistributedOnly() || Copy().DistributedSize() == 0));

  GetDlgItem(IDC_LBL_TRANS_DEPTH)->EnableWindow((Copy().Type() == CPressure::GWC_MODE) && (!Copy().GWC().IsFirstGWC()) && (!Copy().GWC().TransitionFromPrevious()) && !bDisableAll && (!Copy().DistributedOnly() || Copy().DistributedSize() == 0));
  GetDlgItem(IDC_ED_TRANS_DEPTH)->EnableWindow((Copy().Type() == CPressure::GWC_MODE) && (!Copy().GWC().IsFirstGWC()) && (!Copy().GWC().TransitionFromPrevious()) && !bDisableAll && (!Copy().DistributedOnly() || Copy().DistributedSize() == 0));
  GetDlgItem(IDC_UN_TRANS_DEPTH)->EnableWindow((Copy().Type() == CPressure::GWC_MODE) && (!Copy().GWC().IsFirstGWC()) && (!Copy().GWC().TransitionFromPrevious()) && !bDisableAll && (!Copy().DistributedOnly() || Copy().DistributedSize() == 0));
  ...
  GetDlgItem(IDC_MESH_WARNING)->EnableWindow((Copy().Type() == CPressure::GWC_MODE) && !bDisableAll && (!Copy().DistributedOnly() || Copy().DistributedSize() == 0));
