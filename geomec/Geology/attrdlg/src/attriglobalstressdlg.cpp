...
void CAttriGlobalStressDlg::DoDataExchange(CDataExchange *pDX) {
  ...
  DDV_MinMaxDouble(pDX, dWatSurfDepth, Copy().WaterSurfaceDepth().MinValue(UnitNode().Unit()),
  ...
  DDV_MinMaxDouble(pDX, dWtrClmStrGrd, Copy().WaterColumnStressGradient().MinValue(UnitNode().Unit()),
