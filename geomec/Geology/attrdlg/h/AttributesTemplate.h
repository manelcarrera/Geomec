...
template <class T> class CGeomecAttriTemp;

#include "AttributeTempl.h"
#include "BoundarySpecific.h"

template <class T> class CGeomecAttriTemp : public CAttributesTemplate<T> {
public:
...
protected:
  friend void BoundarySpecificDDX_Point<T>(CGeomecAttriTemp<T> *dialog, CDataExchange *pDX, int nID_X, int nID_Y,
                                           int nID_Z, geo::IPoint &point, int nID_UNIT1, int nID_UNIT2, int nID_UNIT3);

  void DDX_Point(CDataExchange *pDX, int nID_X, int nID_Y, int nID_Z, geo::IPoint &point, int nID_UNIT1,
                 int nID_UNIT2 = 0, int nID_UNIT3 = 0);
};

template <class T>
void CGeomecAttriTemp<T>::DDX_Point(CDataExchange *pDX, int nID_X, int nID_Y, int nID_Z, geo::IPoint &point,
