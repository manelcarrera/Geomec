...
template<class T>
class CAttriPointSetTemplate : public CAttributesTemplate<T>
{
public:
...
private:
	...
	void AppendValueTypeToMenu(CMenu& menu, unsigned int uQuantityId, unsigned int uQuantityNameId, const CBitmap *pBitmap= 0);
...
//
template<class T>
void CAttriPointSetTemplate<T>::update_list_cols_width()
{
	int column = 0;
...
: CAttributesTemplate<T>(IDD_ATTRI_POINTSET, set, pParent), m_pCoordinate(0)
, m_pBrush(new CBrush)
{
  ...
  if ((factory->NameIndex(nValueType) > 0) && ((set.Dimension() == CPointSet::DIM_2D) || (nValueType != IDT_VALUETYPE_SURFACE)))
...
template<class T>
CAttriPointSetTemplate<T>::~CAttriPointSetTemplate()
{
  FreeBitmaps();
  delete m_pTreeCtrl;
  delete m_pListCtrl;
...
template<class T>
const CBitmap *
CAttriPointSetTemplate<T>::CreateBitmap
( unsigned int id ///< VS bitmap resource identifier for a Bitmap.
)
{
  CBitmap *p;
  p= new CBitmap;
...
//
template<class T>
void CAttriPointSetTemplate<T>::FreeBitmaps()
{
...
template<class T>
const CBitmap *CAttriPointSetTemplate<T>::FindBitmap
( unsigned int ValueTypeId ///< valuetype identifier for a Bitmap.
)
{
  std::map< unsigned int, const CBitmap *>::iterator it;
...
template<class T>
void CAttriPointSetTemplate<T>::CreateBitmaps()
{
  m_mpBitmap[(unsigned int)IDT_VALUETYPE_COHESION]=
    CreateBitmap((unsigned int)IDB_VT_COHESION);
  m_mpBitmap[(unsigned int)IDT_VALUETYPE_FRICTION_ANGLE]=
    CreateBitmap((unsigned int)IDB_VT_FRICTION_ANGLE);
  m_mpBitmap[(unsigned int)IDT_VALUETYPE_POROSITY]=
    CreateBitmap((unsigned int)IDB_VT_POROSITY);
  m_mpBitmap[(unsigned int)IDT_VALUETYPE_BULKSTIFFNESS]=
    CreateBitmap((unsigned int)IDB_VT_BULK_MODULUS);
  m_mpBitmap[(unsigned int)IDT_VALUETYPE_FLUID_BULK_MOD]=
    CreateBitmap((unsigned int)IDB_VT_FLUID_BULK_MODULUS);
  m_mpBitmap[(unsigned int)IDT_VALUETYPE_SHEARMODULUS]=
    CreateBitmap((unsigned int)IDB_VT_SHEAR_MODULUS);

  m_mpBitmap[(unsigned int)IDT_VALUETYPE_RHOB]=
    CreateBitmap((unsigned int)IDB_VT_DENSITY);
  m_mpBitmap[(unsigned int)IDT_VALUETYPE_VELOCITYP]=
    CreateBitmap((unsigned int)IDB_VT_VP);
  m_mpBitmap[(unsigned int)IDT_VALUETYPE_VELOCITYS]=
    CreateBitmap((unsigned int)IDB_VT_VS);
  m_mpBitmap[(unsigned int)IDT_VALUETYPE_INITFRICTION]=
    CreateBitmap((unsigned int)IDB_VT_INITFRICTION);
  m_mpBitmap[(unsigned int)IDT_VALUETYPE_PRECONSOLIDATION]=
    CreateBitmap((unsigned int)IDB_VT_PRECONSOLIDATION);

  m_mpBitmap[(unsigned int)IDT_VALUETYPE_CAPSHAPE]=
    CreateBitmap((unsigned int)IDB_VT_CAPSHAPE);
  m_mpBitmap[(unsigned int)IDT_VALUETYPE_DILATATION]=
    CreateBitmap((unsigned int)IDB_VT_DILATATION);
  m_mpBitmap[(unsigned int)IDT_VALUETYPE_LATRATIO_MAX]=
    CreateBitmap((unsigned int)IDB_VT_LATRATIO_MAX);
  m_mpBitmap[(unsigned int)IDT_VALUETYPE_LATRATIO_MIN]=
    CreateBitmap((unsigned int)IDB_VT_LATRATIO_MIN);
  m_mpBitmap[(unsigned int)IDT_VALUETYPE_AZIMUTH]=
    CreateBitmap((unsigned int)IDB_VT_AZIMUTH);

  m_mpBitmap[(unsigned int)IDT_VALUETYPE_CREEP_A1]=
    CreateBitmap((unsigned int)IDB_VT_A1);
  m_mpBitmap[(unsigned int)IDT_VALUETYPE_CREEP_A2]=
    CreateBitmap((unsigned int)IDB_VT_A2);
  m_mpBitmap[(unsigned int)IDT_VALUETYPE_CREEP_N1]=
    CreateBitmap((unsigned int)IDB_VT_N1);
  m_mpBitmap[(unsigned int)IDT_VALUETYPE_CREEP_N2]=
      CreateBitmap((unsigned int)IDB_VT_N2);
  ...
  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_CREEP_QR1]=
    CreateBitmap( (unsigned int)IDB_VT_ACTIVATION_ENERGY_Q1R);

  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_CREEP_QR2]=
    CreateBitmap( (unsigned int)IDB_VT_ACTIVATION_ENERGY_Q2R);
  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_CREEP_ALPHA]=
    CreateBitmap( (unsigned int)IDB_VT_CREEP_ALPHA);
  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_TENSILE_STRETCH]=
    CreateBitmap( (unsigned int)IDB_VT_TENSILE_STRETCH);
  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_ELASTIC_HARDENING]=
    CreateBitmap( (unsigned int)IDB_VT_ELASTIC_HARDENING);
  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_SEC_PRECON]=
    CreateBitmap( (unsigned int)IDB_VT_SECONDARY_PRECONSOLIDATION_STRESS);

  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_SEC_HARDENING]=
    CreateBitmap( (unsigned int)IDB_VT_SECONDARY_HARDENING);
  ...
  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_LAYER_NORMAL_AZI]=
    CreateBitmap( (unsigned int)IDB_VT_LAYER_NORMAL_AZIMUTH);

  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_HIGH_FRACT_DENS]=
    CreateBitmap( (unsigned int)IDB_VT_HIGHEST_FRACTURE_DENSITY);
  ...
  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_LOW_FRACT_DENS]=
    CreateBitmap( (unsigned int)IDB_VT_LOWEST_FRACTURE_DENSITY);
  ...
  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_PERMEA]=
    CreateBitmap( (unsigned int)IDB_VT_PERMEABILITY);
  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_VISCOSITY]=
    CreateBitmap( (unsigned int)IDB_VT_VISCOSITY);
   m_mpBitmap[ (unsigned int)IDT_VALUETYPE_FLUIDX]= 
     CreateBitmap(    (unsigned int)IDB_VT_FLUID_THERMAL_EXPANSION);

  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_FLUID_DENSITY]=
    CreateBitmap( (unsigned int)IDB_VT_FLUID_DENSITY);
  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_REFERENCESTRESS]=
    CreateBitmap( (unsigned int)IDB_VT_REFERENCE_STRESS);
  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_APERTUREPARAM]=
    CreateBitmap( (unsigned int)IDB_VT_APERTURE);
  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_GRAINSTIFFNESS]=
    CreateBitmap( (unsigned int)IDB_VT_GRAIN_STIFFNESS);
  ...
  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_THOMSEN_EPSILON]=
    CreateBitmap( (unsigned int)IDB_VT_THOMSEN_EPSILON);
  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_THOMSEN_GAMMA]=
    CreateBitmap( (unsigned int)IDB_VT_THOMSEN_GAMMA);
  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_THOMSEN_DELTA]=
    CreateBitmap( (unsigned int)IDB_VT_THOMSEN_DELTA);

  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_YOUNGS_MODULUS]=
    CreateBitmap(     (unsigned int)IDB_VT_YOUNGSMODULUS);
  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_YOUNGMODULUS_NORM]= 
    CreateBitmap(   (unsigned int)IDB_VT_YOUNGSMODULUS_NORM);
  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_YOUNGMODULUS_TRANS]= 
    CreateBitmap(   (unsigned int)IDB_VT_YOUNGSMODULUS_TRANS);
  m_mpBitmap[     (unsigned int)IDT_VALUETYPE_YOUNG_DECOMP]= 
    CreateBitmap(IDB_VT_YOUNGSMODULUS_DECOMP);
  ...
  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_POISSONS_RATIO]= 
    CreateBitmap(     (unsigned int)IDB_VT_POISSONSRATIO);
  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_POISSONRATIO_NORM]= 
    CreateBitmap(   (unsigned int)IDB_VT_POISSONSRATIO_NORM);
  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_POISSONRATIO_TRANS]= 
    CreateBitmap(   (unsigned int)IDB_VT_POISSONSRATIO_TRANS);
  m_mpBitmap[    (unsigned int)IDT_VALUETYPE_POISSON_DECOMP]= 
    CreateBitmap( (unsigned int)IDB_VT_POISSONSRATIO_DECOMP);
  ...
  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_THERMAL_EXPANSION]= 
    CreateBitmap(    (unsigned int)IDB_VT_THERMAL_EXPANSION);
  ...
  m_mpBitmap[     (unsigned int)IDT_VALUETYPE_THERM_CONDUCT]= 
    CreateBitmap( (unsigned int)IDB_VT_THERMAL_CONDUCTIVITY);
  m_mpBitmap[   (unsigned int)IDT_VALUETYPE_THERM_CAPACI]= 
    CreateBitmap( (unsigned int)IDB_VT_THERMAL_CAPACITY);

  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_RIGI_PARAM1]= 
    CreateBitmap(    (unsigned int)IDB_VT_RIGIDITY_01);
  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_RIGI_PARAM2]= 
    CreateBitmap(    (unsigned int)IDB_VT_RIGIDITY_02);
  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_RIGI_PARAM3]= 
    CreateBitmap(    (unsigned int)IDB_VT_RIGIDITY_03);
  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_RIGI_PARAM4]= 
    CreateBitmap(    (unsigned int)IDB_VT_RIGIDITY_04);
  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_RIGI_PARAM5]= 
    CreateBitmap(    (unsigned int)IDB_VT_RIGIDITY_05);
  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_RIGI_PARAM6]= 
    CreateBitmap(    (unsigned int)IDB_VT_RIGIDITY_06);
  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_RIGI_PARAM7]= 
    CreateBitmap(    (unsigned int)IDB_VT_RIGIDITY_07);
  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_RIGI_PARAM8]= 
    CreateBitmap(    (unsigned int)IDB_VT_RIGIDITY_08);
  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_RIGI_PARAM9]= 
    CreateBitmap(    (unsigned int)IDB_VT_RIGIDITY_09);
  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_RIGI_PARAM10]= 
    CreateBitmap(     (unsigned int)IDB_VT_RIGIDITY_10);
  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_RIGI_PARAM11]= 
    CreateBitmap(     (unsigned int)IDB_VT_RIGIDITY_11);
  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_RIGI_PARAM12]= 
    CreateBitmap(     (unsigned int)IDB_VT_RIGIDITY_12);
  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_RIGI_PARAM13]= 
    CreateBitmap(     (unsigned int)IDB_VT_RIGIDITY_13);
  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_RIGI_PARAM14]= 
    CreateBitmap(     (unsigned int)IDB_VT_RIGIDITY_14);
  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_RIGI_PARAM15]= 
    CreateBitmap(     (unsigned int)IDB_VT_RIGIDITY_15);
  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_RIGI_PARAM16]= 
    CreateBitmap(     (unsigned int)IDB_VT_RIGIDITY_16);
  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_RIGI_PARAM17]= 
    CreateBitmap(     (unsigned int)IDB_VT_RIGIDITY_17);
  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_RIGI_PARAM18]= 
    CreateBitmap(     (unsigned int)IDB_VT_RIGIDITY_18);
  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_RIGI_PARAM19]= 
    CreateBitmap(     (unsigned int)IDB_VT_RIGIDITY_19);
  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_RIGI_PARAM20]= 
    CreateBitmap(     (unsigned int)IDB_VT_RIGIDITY_20);
  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_RIGI_PARAM21]= 
    CreateBitmap(     (unsigned int)IDB_VT_RIGIDITY_21);

  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_HARDENING]= 
    CreateBitmap(    (unsigned int)IDB_VT_HARDENING);
  m_mpBitmap[    (unsigned int)IDT_VALUETYPE_HARD_COHESION1]= 
    CreateBitmap( (unsigned int)IDB_VT_HARDENING_COHESION_1);
  m_mpBitmap[    (unsigned int)IDT_VALUETYPE_HARD_COHESION2]= 
    CreateBitmap( (unsigned int)IDB_VT_HARDENING_COHESION_2);
  m_mpBitmap[    (unsigned int)IDT_VALUETYPE_HARD_COHESION3]= 
    CreateBitmap( (unsigned int)IDB_VT_HARDENING_COHESION_3);
  ...
  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_FRACT_TENSOR]= 
    CreateBitmap( (unsigned int)IDB_VT_FRACTURE_TENSOR);
  ...
  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_V0_HI]= 
    CreateBitmap(    (unsigned int)IDB_VT_V0_HI);
  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_V0_ME]= 
    CreateBitmap(    (unsigned int)IDB_VT_V0_ME);
  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_V0_LO]= 
    CreateBitmap(    (unsigned int)IDB_VT_V0_LO);
  m_mpBitmap[ (unsigned int)IDT_VALUETYPE_REFERENCE_APERTURE]= 
    CreateBitmap(    (unsigned int)IDB_VT_REFERENCE_APERTURE);
  ...
  //
  m_mpBitmap[(unsigned int)ID_MENU_YOUNGS_MODULUS]=
    CreateBitmap((unsigned int)IDB_MENU_VT_YOUNGS_MODULUS);
  m_mpBitmap[(unsigned int)ID_MENU_POISSONS_RATIO]=
    CreateBitmap((unsigned int)IDB_MENU_VT_POISSONS_RATIO);
  m_mpBitmap[(unsigned int)ID_MENU_THERMAL_PARAMETERS]=
    CreateBitmap((unsigned int)IDB_MENU_VT_THERMAL_PARAMETERS);
  m_mpBitmap[(unsigned int)ID_MENU_FRACTURE_PARAMETERS]=
    CreateBitmap((unsigned int)IDB_MENU_VT_FRACTURE_PARAMETERS);
  m_mpBitmap[(unsigned int)ID_MENU_HARDENING_PARAMETERS]=
    CreateBitmap((unsigned int)IDB_MENU_VT_HARDENING_PARAMETERS);
  m_mpBitmap[(unsigned int)ID_MENU_RIGIDITY_PARAMETERS]=
    CreateBitmap((unsigned int)IDB_MENU_VT_RIGIDITY_PARAMETERS);
}

/// \brief set the background color for \a menu to white
template<class T>
void CAttriPointSetTemplate<T>::WhiteBackgroundColor
( CMenu &menu ///< the menu to change
)
{
...
template<class T>
BOOL CAttriPointSetTemplate<T>::OnCommand( WPARAM wParam, LPARAM lParam )
{
	...
	if((m_mpCommand.find(nID) != m_mpCommand.end()))
	{
		...
		m_btInsertQuantity.SetWindowText(
			getStringTableEntry(m_prValue.second));
		OnInsertQuantity();
		return TRUE;
	}
...
template<class T>
void CAttriPointSetTemplate<T>::DoDataExchange(CDataExchange* pDX)
{
	...
	if ( resizeHullValue < 0 ) resizeHullValue= 0;
	...
	if(pDX->m_bSaveAndValidate) 
	{
		...
		if ( pPointSet ) pPointSet->ResizeHullValue( resizeHullValue);
...
template<class T>
CString CAttriPointSetTemplate<T>::PointToString(const geo::IPoint &pt) const
{
...
template<class T>
BOOL CAttriPointSetTemplate<T>::OnInitDialog() 
{
...
template<class T>
typename CAttriPointSetTemplate<T>::TTreeCtrl& CAttriPointSetTemplate<T>::TreeCtrl() const
{
	return (TTreeCtrl&)(*m_pTreeCtrl);
}

template<class T>
typename CAttriPointSetTemplate<T>::TListCtrl& CAttriPointSetTemplate<T>::ListCtrl() const
{
	return (TListCtrl&)(*m_pListCtrl);
}

template<class T>
BOOL CAttriPointSetTemplate<T>::Validate(CDataExchange* pDX)
{
...
template<class T>
void CAttriPointSetTemplate<T>::AppendValueTypeToMenu(CMenu& menu, unsigned int uQuantityId, unsigned int uQuantityNameId, const CBitmap *pBitmap)
{
  ...
  if(CValueTypeFactory::instance()->ValueTypeAvailable(uQuantityId))
  {
    ...
    m_mpCommand.insert(
      TCommandMap::value_type(nCommandID
        , std::make_pair(uQuantityId, uQuantityNameId)));
    if ( pBitmap)
      menu.AppendMenu(MF_BITMAP, nCommandID,pBitmap);
    else
      menu.AppendMenu(MF_STRING, nCommandID,
        getStringTableEntry(uQuantityNameId));
  }
}


template<class T>
void CAttriPointSetTemplate<T>::OnBrowseQuantity() 
{
  m_mpCommand.clear();
  ...
  for(size_t i = 0; i < vcValueType.size(); i++)
  {
    if ( (Copy().Dimension() == CPointSet::DIM_2D)
       || (vcValueType[i].first != (unsigned int)IDT_VALUETYPE_SURFACE))
    {
      ...
      || (vcValueType[i].first == (unsigned int)IDT_VALUETYPE_LATSTRAIN))
        AppendValueTypeToMenu(menu
          , vcValueType[i].first, vcValueType[i].second);
      ...
      || (vcValueType[i].first == (unsigned int)IDT_VALUETYPE_YOUNGMODULUS_TRANS_DECOMP))
        AppendValueTypeToMenu(young
          , vcValueType[i].first, vcValueType[i].second
          , FindBitmap(vcValueType[i].first));
      ...
      || (vcValueType[i].first == (unsigned int)IDT_VALUETYPE_HARD_FRICTION3))
        AppendValueTypeToMenu(hardening
          , vcValueType[i].first, vcValueType[i].second
          , FindBitmap(vcValueType[i].first));
      ...
      || (vcValueType[i].first == (unsigned int)IDT_VALUETYPE_RIGI_PARAM21))
        AppendValueTypeToMenu(rigidi
          , vcValueType[i].first, vcValueType[i].second
          , FindBitmap(vcValueType[i].first));
      else
        AppendValueTypeToMenu(material
          , vcValueType[i].first, vcValueType[i].second
          , FindBitmap(vcValueType[i].first));
    }
  }

  material.AppendMenu(MF_POPUP|MF_BITMAP, (UINT_PTR)young.Detach(), FindBitmap((unsigned int)ID_MENU_YOUNGS_MODULUS)); // _T("Young's Modulus")); 
  material.AppendMenu(MF_POPUP, (UINT_PTR)poisson.Detach(), FindBitmap((unsigned int)ID_MENU_POISSONS_RATIO)); // _T("Poisson's Ratio")); 
  material.AppendMenu(MF_POPUP, (UINT_PTR)therm.Detach(), FindBitmap((unsigned int)ID_MENU_THERMAL_PARAMETERS)); // _T("Thermal Parameters")); 
  material.AppendMenu(MF_POPUP, (UINT_PTR)fract.Detach(), FindBitmap((unsigned int)ID_MENU_FRACTURE_PARAMETERS)); // _T("Fracture Parameters")); 
  material.AppendMenu(MF_POPUP, (UINT_PTR)hardening.Detach(), FindBitmap((unsigned int)ID_MENU_HARDENING_PARAMETERS)); // _T("Hardening Parameters")); 
  material.AppendMenu(MF_POPUP, (UINT_PTR)rigidi.Detach(), FindBitmap((unsigned int)ID_MENU_RIGIDITY_PARAMETERS)); // _T("Rigidity Parameters")); 
...
template<class T>
void CAttriPointSetTemplate<T>::OnInsertQuantity() 
{
...
template<class T>
void CAttriPointSetTemplate<T>::OnInsertValueSet() 
{
...
template<class T>
void CAttriPointSetTemplate<T>::OnCoordinateFieldUnit() 
{
...
template<class T>
void CAttriPointSetTemplate<T>::OnCoordinateSiUnit() 
{
...
template<class T>
void CAttriPointSetTemplate<T>::OnValueFieldUnit() 
{
...
template<class T>
void CAttriPointSetTemplate<T>::OnValueSiUnit() 
{
...
template<class T>
void CAttriPointSetTemplate<T>::OnUpdateMinMax()
{
