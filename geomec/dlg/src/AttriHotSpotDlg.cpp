...
BOOL CAttriHotSpotDlg::OnInitDialog() 
{
  ...
  RightRect.SetRect(m_rcMaxRect.left + (m_rcMaxRect.Width() / 2), m_rcTopView.top, m_rcTopView.right, m_rcTopView.bottom);
  ...
  LeftRect.SetRect(m_rcMinRect.left + (m_rcMinRect.Width() / 2), m_rcBottomView.top, m_rcMaxRect.left + (m_rcMaxRect.Width() / 2), m_rcBottomView.bottom);
  RightRect.SetRect(m_rcMaxRect.left + (m_rcMaxRect.Width() / 2), m_rcBottomView.top, m_rcBottomView.right, m_rcBottomView.bottom);
