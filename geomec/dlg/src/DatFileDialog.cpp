...
CDatFileDialog::CDatFileDialog(CAnalysisType::TAnalysisType analysisType,
...
const CDepletionStage* CDatFileDialog::fileNames2GenerateExist(
...
QString CDatFileDialog::stripExtension(const QString& string,
  const QString& extension) const
{
