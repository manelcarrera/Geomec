...
COptimizationSettingsDlg::COptimizationSettingsDlg(CWnd* pParent)
  : CDialog(IDD_OPTIMIZATION_DLG, pParent)
  , m_pTetraMesh(0)
  , m_pHexaMesh(0)
  , m_nVisualMapping(0)
  , m_nDianaMapping(0)
  , m_nTetraMesher(0)
  , m_nHexaMesher(0)
  , m_nDSFStressSmoothening(0)
  , m_nDSFInterSurfGeneration(0)
  , m_dsa( 0 )
{
}
...
{
  GetDlgItem( IDC_CHECK_DIANA_SEPARATED_PROCESS )->ShowWindow( 
      _g->dsa_available() ? SW_SHOW : SW_HIDE );
