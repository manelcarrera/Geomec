...
void CAttriFaultPressureDlg::EnableControls()
{
  ...
  GetDlgItem(IDC_RADIO_MAXIMUM)->EnableWindow((!Copy().DistributedOnly() || Copy().DistributedSize() == 0) && !Locked());
  GetDlgItem(IDC_RADIO_MINIMUM)->EnableWindow((!Copy().DistributedOnly() || Copy().DistributedSize() == 0) && !Locked());
  GetDlgItem(IDC_RADIO_GRADIENT)->EnableWindow((!Copy().DistributedOnly() || Copy().DistributedSize() == 0) && !Locked());

  GetDlgItem(IDC_LBL_DEPTH)->EnableWindow((!Copy().DistributedOnly() || Copy().DistributedSize() == 0) && Copy().Mode() == CFaultPressure::MT_GRADIENT && !Locked());
  GetDlgItem(IDC_ED_DEPTH)->EnableWindow((!Copy().DistributedOnly() || Copy().DistributedSize() == 0) && Copy().Mode() == CFaultPressure::MT_GRADIENT && !Locked());
  GetDlgItem(IDC_UN_DEPTH)->EnableWindow((!Copy().DistributedOnly() || Copy().DistributedSize() == 0) && Copy().Mode() == CFaultPressure::MT_GRADIENT && !Locked());

  GetDlgItem(IDC_LBL_PRESSURE)->EnableWindow((!Copy().DistributedOnly() || Copy().DistributedSize() == 0) && Copy().Mode() == CFaultPressure::MT_GRADIENT && !Locked());
  GetDlgItem(IDC_ED_PRESSURE)->EnableWindow((!Copy().DistributedOnly() || Copy().DistributedSize() == 0) && Copy().Mode() == CFaultPressure::MT_GRADIENT && !Locked());
  GetDlgItem(IDC_UN_PRESSURE)->EnableWindow((!Copy().DistributedOnly() || Copy().DistributedSize() == 0) && Copy().Mode() == CFaultPressure::MT_GRADIENT && !Locked());

  GetDlgItem(IDC_LBL_GRADIENT)->EnableWindow((!Copy().DistributedOnly() || Copy().DistributedSize() == 0) && Copy().Mode() == CFaultPressure::MT_GRADIENT && !Locked());
  GetDlgItem(IDC_ED_GRADIENT)->EnableWindow((!Copy().DistributedOnly() || Copy().DistributedSize() == 0) && Copy().Mode() == CFaultPressure::MT_GRADIENT && !Locked());
  GetDlgItem(IDC_UN_GRADIENT)->EnableWindow((!Copy().DistributedOnly() || Copy().DistributedSize() == 0) && Copy().Mode() == CFaultPressure::MT_GRADIENT && !Locked());
