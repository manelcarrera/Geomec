...
template<class T>
class CAttriHorizon : public CAttributesTemplate<T>
{
  bool m_bSlipSwitch;
  bool m_bInitialUpdate;
  CHandleFaultFractureBehaviour <T> m_handleFaultFractureBehaviour;
public:
  CAttriHorizon(unsigned int uDialogTemplate, 
              T& horizon, 
          bool bSlipSwitch,
          CWnd* pParent = NULL);
...
*/
template<class T>
CAttriHorizon<T>::CAttriHorizon(unsigned int uDialogTemplate, 
                T& horizon, 
                bool bSlipSwitch,
                CWnd* pParent)
: CAttributesTemplate<T>(uDialogTemplate, horizon, pParent), 
  m_bSlipSwitch(bSlipSwitch),
...
template<class T>
BOOL CAttriHorizon<T>::OnInitDialog() 
{
...
template<class T>
void CAttriHorizon<T>::DoDataExchange(CDataExchange* pDX)
{
  // Variables ....
  CString strName;
  int nSlipType;
...
template<class T>
BOOL CAttriHorizon<T>::OnCommand( WPARAM wParam, LPARAM lParam )
{
  ...
  default:
    bool succeeded =
      m_handleFaultFractureBehaviour.onCommand(Copy(), wParam, lParam);
...
template<class T>
void CAttriHorizon<T>::OnChangeColor() 
{
...
template<class T>
void CAttriHorizon<T>::OnSlipLayer() 
{
