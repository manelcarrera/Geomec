...
template <class T> class CAttriFormationElementSet : public CAttributesTemplate<T> {
...
template <class T> void CAttriFormationElementSet<T>::DoDataExchange(CDataExchange *pDX) {
...
template <class T> BOOL CAttriFormationElementSet<T>::OnCommand(WPARAM wParam, LPARAM lParam) {
...
template <class T> void CAttriFormationElementSet<T>::OnChangeColor() {
  Copy().Color(SelectColor(Copy().Color()));
  Invalidate();
}

template <class T> void CAttriFormationElementSet<T>::OnOK() {
...
template <class T> BOOL CAttriFormationElementSet<T>::OnInitDialog() {
...
template <class T> void CAttriFormationElementSet<T>::OnPaint() {
