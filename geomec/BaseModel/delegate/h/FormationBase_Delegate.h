...
private:
  ...
  IFormationElementSet_Delegate &operator=(const IFormationElementSet_Delegate &rhs);
...
class CFormationBase_Delegate
    : public CMaterialServerParent_Delegate<CColorNode_Delegate, CColorNode, CMaterialServer> {
  typedef CMaterialServerParent_Delegate<CColorNode_Delegate, CColorNode, CMaterialServer> TBase;
...
private:
  ...
  CFormationThickness_Delegate &operator=(const CFormationThickness_Delegate &rhs);
...
template <class FORMATION> class CFormationEntryTempl_Delegate : public CStorageNodeEntry_Delegate<FORMATION> {
public:
  CFormationEntryTempl_Delegate(CFormationEntryTempl<FORMATION> *formationEntryTempl);
...
private:
  ...
  CFormationEntryTempl_Delegate &operator=(const CFormationEntryTempl_Delegate &rhs);

  CFormationEntryTempl<FORMATION> *m_formationEntryTempl;

  REGISTER_DELEGATE(CFormationEntryTempl<FORMATION>, CFormationEntryTempl_Delegate<FORMATION>);
};

template <class FORMATION>
CFormationEntryTempl_Delegate<FORMATION>::CFormationEntryTempl_Delegate(
    CFormationEntryTempl<FORMATION> *formationEntryTempl)
    : CStorageNodeEntry_Delegate(formationEntryTempl), m_formationEntryTempl(formationEntryTempl) {
  ACTIVATE_TEMPLATE_DELEGATE(CFormationEntryTempl<FORMATION>, CFormationEntryTempl_Delegate<FORMATION>);
}

template <class FORMATION>
void CFormationEntryTempl_Delegate<FORMATION>::AppendContextMenu(CContextMenuInvoker &invoker) {
  typedef CSingleCommandTemplate<CFormationEntryTempl<FORMATION>> TForCommand;
...
template <class FORMATION> bool CFormationEntryTempl_Delegate<FORMATION>::CanExportGocad() const {
  return m_formationEntryTempl->CanExportGocad();
}

template <class FORMATION> void CFormationEntryTempl_Delegate<FORMATION>::OnExportGocad() {
  CGocadExportWrapper gew;

  gew.Export(static_cast<CModelBase &>(m_formationEntryTempl->Model()));
}

class TFormationBaseEntry_Delegate : public CGraphEntryTemp_Delegate<CFormationBase> {
public:
...
private:
  ...
  TFormationBaseEntry_Delegate &operator=(const TFormationBaseEntry_Delegate &rhs);
