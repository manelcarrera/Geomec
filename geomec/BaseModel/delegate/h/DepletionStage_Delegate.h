...
class CDepletionStageEntry_Delegate : public CGraphEntryTemp_Delegate<CDepletionStage> {
public:
...
private:
  ...
  CDepletionStageEntry_Delegate &operator=(const CDepletionStageEntry_Delegate &rhs);
