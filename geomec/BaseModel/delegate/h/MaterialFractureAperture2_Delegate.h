...
public:
  CMaterialFractureAperture2_Delegate(CMaterialFractureAperture2 *materialFractureAperture);

private:
  CMaterialFractureAperture2_Delegate(const CMaterialFractureAperture2_Delegate &rhs);
  CMaterialFractureAperture2_Delegate &operator=(const CMaterialFractureAperture2_Delegate &rhs);

  CMaterialFractureAperture2 *m_materialFractureAperture2;

  REGISTER_DELEGATE(CMaterialFractureAperture2, CMaterialFractureAperture2_Delegate);
};
