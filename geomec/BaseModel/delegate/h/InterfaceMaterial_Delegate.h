...
private:
  ...
  CInterfaceMaterial_Delegate &operator=(const CInterfaceMaterial_Delegate &rhs);
...
class CInterfaceMaterialEntry_Delegate : public CGraphEntryTemp_Delegate<CInterfaceMaterial> {
public:
  CInterfaceMaterialEntry_Delegate(CInterfaceMaterialEntry *interfaceMaterialEntry);
...
private:
  ...
  CInterfaceMaterialEntry_Delegate &operator=(const CInterfaceMaterialEntry_Delegate &rhs);
