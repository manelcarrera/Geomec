...
IFormationElementSet_Delegate::IFormationElementSet_Delegate(
  IFormationElementSet* formationElementSet)
: IElementSet_Delegate(formationElementSet)
, m_formationElementSet(formationElementSet)
{
}

CFormationBase_Delegate::CFormationBase_Delegate(CFormationBase* formationBase)
: CMaterialServerParent_Delegate(formationBase)
...
bool CFormationBase_Delegate::CanExport() const
{
  return m_formationBase->CanExport();
}
...
bool CFormationBase_Delegate::CanDestroy() const
{
  return m_formationBase->CanDestroy();
}

CFormationThickness_Delegate::CFormationThickness_Delegate(
  CFormationThickness* formationThickness)
: IValueComposite_Delegate(formationThickness)
, m_formationThickness(formationThickness)
{
}

TFormationBaseEntry_Delegate::TFormationBaseEntry_Delegate(
  TFormationBaseEntry* formationBaseEntry)
: CGraphEntryTemp_Delegate <CFormationBase> (formationBaseEntry)
, m_formationBaseEntry(formationBaseEntry)
{
}
