...
typedef CDeletableNodeObserver_Delegate<IMaterial, IMaterial_Delegate, CDummyNode, CDummyObserver, FALSE, FIXED_ITEM> TMaterialObserver;
typedef CStateBranch_Delegate<CMaterialEntry, CMaterialEntry_Delegate, IMaterial, TMaterialObserver, CUndefinedIconProvider, FALSE, DELETE_ITEM> TMaterialEntryObserver;
