...
template <bool bFixedSurface> class C3DHorizonObserver : public CHorizonObserver<bFixedSurface> {
public:
  C3DHorizonObserver(C3DHorizon &node, CTreeNode &parent, const BOOL rename, const enum REMOVE_TYPE remove,
  ...
  C3DHorizonObserver(C3DHorizon &node, CTreeCtrl &ctrl, const BOOL rename, const enum REMOVE_TYPE remove,
...
class C3DHorizonEntryObserver
    : public CStateBranch_Delegate<CGraphEntry, CGraphEntry_Delegate, C3DHorizon, C3DHorizonObserver<bFixedSurface>,
                                   CUndefinedIconProvider, TRUE, DELETE_ITEM> {
  typedef CStateBranch_Delegate<CGraphEntry, CGraphEntry_Delegate, C3DHorizon, C3DHorizonObserver<bFixedSurface>,
                                CUndefinedIconProvider, TRUE, DELETE_ITEM>
      TBase;

public:
  C3DHorizonEntryObserver(CGraphEntry &entry, CTreeCtrl &ctrl, const BOOL rename, const enum REMOVE_TYPE remove,
  ...
  virtual CTreeNode *InsertChild(C3DHorizon &t) {
    ...
    if (t.Slip()) {
      ...
      new TFaultParametersEnumerationBranch(*pTreeNode, _T("Fault Parameters"), IDI_FAULTPARAMETERS);
    }
