...
CTetraSuperHorizon_Delegate::CTetraSuperHorizon_Delegate(
  CTetraSuperHorizon* tetraSuperHorizon)
: CTetraHorizonBase_Delegate(tetraSuperHorizon)
, m_tetraSuperHorizon(tetraSuperHorizon)
{
}
...
CTetraSuperHorizonEntry_Delegate::CTetraSuperHorizonEntry_Delegate(
...
void CTetraSuperHorizonEntry_Delegate::AppendContextMenu(
