...
public:
  CTetraSuperHorizon_Delegate(CTetraSuperHorizon *tetraSuperHorizon);

  virtual bool Attributes();

private:
  CTetraSuperHorizon_Delegate(const CTetraSuperHorizon_Delegate &rhs);
  CTetraSuperHorizon_Delegate &operator=(const CTetraSuperHorizon_Delegate &rhs);
...
class CTetraSuperHorizonEntry_Delegate : public CStorageNodeEntry_Delegate<CTetraSuperHorizon> {
public:
  CTetraSuperHorizonEntry_Delegate(CTetraSuperHorizonEntry *tetraSuperHorizonEntry);
...
private:
  CTetraSuperHorizonEntry_Delegate(const CTetraSuperHorizonEntry_Delegate &rhs);
  CTetraSuperHorizonEntry_Delegate &operator=(const CTetraSuperHorizonEntry_Delegate &rhs);
