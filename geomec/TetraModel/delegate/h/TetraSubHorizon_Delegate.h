...
class CTetraSubHorizonEntry_Delegate : public CStorageNodeEntry_Delegate<CTetraSubHorizon> {
public:
...
private:
  ...
  CTetraSubHorizonEntry_Delegate &operator=(const CTetraSubHorizonEntry_Delegate &rhs);
