...
private:
  ...
  CTetraFormationVolume_Delegate &operator=(const CTetraFormationVolume_Delegate &rhs);
...
class CTetraFormationEntry_Delegate : public CFormationEntryTempl_Delegate<CTetraFormation> {
public:
...
private:
  ...
  CTetraFormationEntry_Delegate &operator=(const CTetraFormationEntry_Delegate &rhs);
