...
CFaceSupportDlg::CFaceSupportDlg(CPressureSupportNode::CFaceSupportDef &supdef, const CPressureSupportNode &node,
                                 CWnd *pParent /*=NULL*/)
    : CSupportDlgBase(node, CFaceSupportDlg::IDD, pParent), m_SupportDef(supdef) {
...
void CFaceSupportDlg::UpdateControls() {
  ...
  */
  ...
  GetDlgItem(IDC_NORMALLY)
      ->EnableWindow(bSupported && !bBranch && sl == CPressureSupportNode::SL_SIDE ||
                     sl == CPressureSupportNode::SL_BOTTOM);
  GetDlgItem(IDC_FULLY)->EnableWindow(bSupported && !bBranch && sl == CPressureSupportNode::SL_SIDE ||
                                      sl == CPressureSupportNode::SL_BOTTOM || sl == CPressureSupportNode::SL_TOP);
...
void CFaceSupportDlg::SupportType(TSupportType nType) { m_SupportDef.SupportType(nType); }

CFaceSupportDlg::TSupportType CFaceSupportDlg::SupportType() { return m_SupportDef.SupportType(); }
...
void CFaceSupportDlg::OnLocal() { OnRadioButton(); }

void CFaceSupportDlg::OnGlobal() { OnRadioButton(); }

void CFaceSupportDlg::OnUnloaded() { OnRadioButton(); }

void CFaceSupportDlg::OnOK() { CSupportDlgBase::OnOK(IDP_SUPPORT_FACE_APPLYTOALL); }
