...
typedef COpenGLNodeObserver_Delegate<CSurfaceBase, CSurfaceBase_Delegate, CDummyNode, CDummyObserver, FALSE, FIXED_ITEM>
    TSurfObs;
...
public:
  CSideSurfaceObs(CTetraSubBoundaryObserver &obs) : TSurfaceEnumerator(obs, "Side surfaces", IDI_SIDE_SURFACES) {}
  ...
  virtual void AppendContextMenu(CContextMenuInvoker &invoker) {
    ...
    invoker.AddCommand(_T("Delete all side surfaces"), *(new TEntryCommand(*this, &CSideSurfaceObs::DoRemoveAllSurfaces,
                                                                           &CSideSurfaceObs::CanRemoveAllSurfaces)));
  }
...
CTetraSubBoundaryObserver::CTetraSubBoundaryObserver(CTetraSubModelBranch &model_branch, CTetraSubBoundary &boundary)
  ...
  // Horizon observer
  typedef COpenGLNodeObserver_Delegate<CTetraSubHorizon, CTetraSubHorizon_Delegate, CDummyNode, CDummyObserver, FALSE,
                                       FIXED_ITEM>
      THorizonObs;
  typedef CNodeObserver_Delegate<CTetraSubBoundary::CHorizonPlaceHolder,
                                 CTetraSubBoundary_Delegate::CHorizonPlaceHolder_Delegate, CTetraSubHorizon,
                                 THorizonObs, FALSE, UNLINK_ITEM>
      TPlaceHldrObs;
