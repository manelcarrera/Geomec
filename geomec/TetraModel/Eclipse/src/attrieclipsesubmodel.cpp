...
CAttriEclipseSubModel::CReservoirTreeObject::CHorizonTreeObject::CHorizonTreeObject(CReservoirTreeObject& parent, int nHorizonIndex)
...
unsigned int CAttriEclipseSubModel::CReservoirTreeObject::CHorizonTreeObject::Icon() const
{
	return IDI_HORIZON;
}
...
: ITreeObject(dlg.m_tcHorizon, TVI_ROOT, TVI_LAST), m_dlg(dlg), m_nIndex(nReservoirIndex)
{
	...
	Update();
	// Create children
	for(int i = m_dlg.Model().Reservoir(nReservoirIndex).first ; i <= m_dlg.Model().Reservoir(nReservoirIndex).second; i++)
	{
		new CHorizonTreeObject(*this, i);
	}
}

int CAttriEclipseSubModel::CReservoirTreeObject::Index() const
{
	return m_nIndex;
}


unsigned int CAttriEclipseSubModel::CReservoirTreeObject::Icon() const
{
...
CAttriEclipseSubModel& CAttriEclipseSubModel::CReservoirTreeObject::Dlg()
{
	return m_dlg;
}

const CAttriEclipseSubModel& CAttriEclipseSubModel::CReservoirTreeObject::Dlg() const
{
	return m_dlg;
}
...
BOOL CAttriEclipseSubModel::HorizonEnable(int nHorizonIndex) const
{
	return m_vcHorizon[nHorizonIndex];
}
...
CEclipseModel& CAttriEclipseSubModel::Model()
{
	return m_model;
}

const CEclipseModel& CAttriEclipseSubModel::Model() const
{
	return m_model;
}
