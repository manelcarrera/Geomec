...
PolyLineScreenDrawerRetainer::PolyLineScreenDrawerRetainer(COpenInventorEventsHandler *eventHandler,
                                                           SoPolyLineScreenDrawer *drawer)
    : m_handler(eventHandler), m_drawer(drawer) {
  if (!CanWork())
    return;
