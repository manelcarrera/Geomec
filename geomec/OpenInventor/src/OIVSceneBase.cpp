...
COIVSceneBase::COIVSceneBase(CFemAppModel& model)
: CStorageNode(model)
{
}

COIVSceneBase::COIVSceneBase(const QString& strName, CFemAppModel& model)
: CStorageNode(strName, model)
{
}

COIVSceneBase::COIVSceneBase(unsigned int uName, CFemAppModel& model)
