...
OIDIMeshNode::OIDIMeshNode(const OIDIMesh *meshData, OIDIMeshNodeManager *meshNodeManager)
    : m_meshNodeManager(meshNodeManager), m_mesh(meshData), m_colorScalarSetId(-1), m_valueColorScalarSetId(-1),
      m_isoScalarSetId(-1), m_tensorSetId(-1), m_geologyColor(0.0f, 0.0f, 0.0f), m_vectorsSwitch(0),
      m_cellFilterSwitch(0), m_cellFilter(0), m_decimatingCellFilter(0), m_vectors(0), m_tensorVectors(0),
      m_tensorSwitch(0), m_beachballSwitch(0), m_beachballs(0), m_visibility(false) {}

const OIDIMesh *OIDIMeshNode::getMesh() { return m_mesh; }

OIDIMeshNodeManager *OIDIMeshNode::getMeshNodeManager() { return m_meshNodeManager; }

MbVec3d OIDIMeshNode::getMax() { return m_mesh->getMax(); }

MbVec3d OIDIMeshNode::getMin() { return m_mesh->getMin(); }

size_t OIDIMeshNode::getNumCells() { return m_mesh->getNumCells(); }
...
void OIDIMeshNode::setDisplayBeachBalls(bool display) {
  if (m_beachballSwitch)
    m_beachballSwitch->whichChild = display ? SO_SWITCH_ALL : SO_SWITCH_NONE;
}
...
void OIDIMeshNode::setVectorSetId(int id) { m_vectors->vectorSetId = id; }

int OIDIMeshNode::getVectorSetId() { return m_vectors->vectorSetId.getValue(); }

void OIDIMeshNode::setTensorVectorSetId(int id) { m_tensorVectors->vectorSetId = id; }

int OIDIMeshNode::getTensorVectorSetId() const { return m_tensorVectors->vectorSetId.getValue(); }

void OIDIMeshNode::setVectorScalarSetId(int id) { m_tensorVectors->colorScalarSetId = id; }
...
int OIDIMeshNode::getVectorScalarSetId() { return m_tensorVectors->colorScalarSetId.getValue(); }
...
int OIDIMeshNode::getValueColorScalarSetId() { return m_valueColorScalarSetId; }
...
int OIDIMeshNode::getIsoScalarSetId() { return m_isoScalarSetId; }
...
void OIDIMeshNode::setVisibility(bool visibility) { m_visibility = visibility; }

bool OIDIMeshNode::isVisible() const { return m_visibility; }
