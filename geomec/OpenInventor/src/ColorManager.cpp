...
const int ColorManager::s_availableHues[s_numUniqueColors] =
{
    0, 225, 90, 315, 180, 45, 270, 135, 25, 335, 205, 70, 290, 160, 245, 115
};

const int ColorManager::s_availableSaturations[s_numUniqueColors] =
{
...
void ColorManager::releaseColorIndex( int index )
{
    ...
    if ((colorIndexIter = std::find (m_usedColorIndices.begin(), m_usedColorIndices.end(), index)) != m_usedColorIndices.end())
    {
