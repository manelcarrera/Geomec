...
OIV2DWellPathGraphSceneObserver::OIV2DWellPathGraphSceneObserver(OIV2DWellPathGraphScene &node, CTreeNode &parent,
...
unsigned int OIV2DWellPathGraphSceneObserver::Icon() const {
  ...
  return (sceneWrapper != 0 && sceneWrapper->IsOIV2DWellPathGraphScene()) ? IDI_RADIO_CHECKED : IDI_RADIO_UNCHECKED;
}
