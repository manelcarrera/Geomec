...
typedef CNodeObserver_Delegate<COpenInventorSceneNode, COpenInventorSceneNode_Delegate, CDummyNode, CDummyObserver, FALSE, FIXED_ITEM> TOpenInventorSceneNodeObserver;
