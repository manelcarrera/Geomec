...
private:
  OIV2DGraphValueColorScene_Delegate(const OIV2DGraphValueColorScene_Delegate &rhs);
  OIV2DGraphValueColorScene_Delegate(OIV2DGraphValueColorScene_Delegate &&rhs);
  OIV2DGraphValueColorScene_Delegate &operator=(const OIV2DGraphValueColorScene_Delegate &rhs);
  OIV2DGraphValueColorScene_Delegate &operator=(const OIV2DGraphValueColorScene_Delegate &&rhs);

  OIV2DGraphValueColorScene *m_Node;

  REGISTER_DELEGATE(OIV2DGraphValueColorScene, OIV2DGraphValueColorScene_Delegate);
};
