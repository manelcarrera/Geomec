...
{
public:
  COpenInventorSceneNodeAction (COpenInventorSceneNode * receiver, void (COpenInventorSceneNode::*func_ptr)(void * user_data, const std::vector<geo::CPoint> &), void * user_data);
