...
public:
  ...
  template < class T> 
  void SaveValueToStream (T (COpenInventorSceneNode::*func_ptr)() const, TSTREAM& stream)
  {
  ...
  template <>
  void SaveValueToStream(bool (COpenInventorSceneNode::*func_ptr)() const, TSTREAM& stream)
  {
      stream << int((this->*func_ptr)());
  }

  template < class T >
  void RestoreValueFromStream (void (COpenInventorSceneNode::*func_ptr)(T), TSTREAM& stream)
  {
    T value;
    stream >> value;
    (this->* func_ptr) (value);
  ...
  template < >
  void RestoreValueFromStream (void (COpenInventorSceneNode::*func_ptr)(MeshMode), TSTREAM& stream)
  {
    int value;
    stream >> value;
  ...
  // specialization to account for that we cannot stream to a bool
  template <>
  void RestoreValueFromStream (void (COpenInventorSceneNode::*func_ptr)(bool), TSTREAM& stream)
  {
    int value;
    stream >> value;
    (this->* func_ptr) (value);
