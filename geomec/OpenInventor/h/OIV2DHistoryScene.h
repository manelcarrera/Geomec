...
public:
  ...
  template <class T> void SaveValueToStream(T (OIV2DHistoryScene::*func_ptr)() const, TSTREAM &stream) {
    stream << (this->*func_ptr)();
  }

  template <class T> void RestoreValueFromStream(void (OIV2DHistoryScene::*func_ptr)(T), TSTREAM &stream) {
    T value;
    stream >> value;
    (this->*func_ptr)(value);
  }
  ...
  template <> void RestoreValueFromStream(void (OIV2DHistoryScene::*func_ptr)(bool), TSTREAM &stream) {
    int value;
    stream >> value;
    (this->*func_ptr)(value);
  }
