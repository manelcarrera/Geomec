...
CNodeLocationHighlighter::CNodeLocationHighlighter(COpenGLSceneBase& scene)
: m_scene(scene),
...
const geo::INode& CNodeLocationHighlighter::CPointHighlightNode::Node() const
{
  return m_node;
}
...
int CNodeLocationHighlighter::CPointHighlightNode::DisplayListSize() const
{
  return 1;
}

const geo::IObject& CNodeLocationHighlighter::CPointHighlightNode::DisplayList(int nIndex) const
{
  return m_node;
}
...
unsigned int CNodeLocationHighlighter::CPointHighlightNode::IconId() const
{
  return 0;
}

unsigned int CNodeLocationHighlighter::CPointHighlightNode::TypeId() const
{
  return 0;
}

bool CNodeLocationHighlighter::CPointHighlightNode::Empty() const
{
  return true;
}

long CNodeLocationHighlighter::CPointHighlightNode::SavedItems() const
{
  return 0;
}
