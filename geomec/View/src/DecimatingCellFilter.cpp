...
DecimatingCellFilterI::DecimatingCellFilterI() : m_fraction(1.0f), m_maxVisibleIndex(0), m_timestamp(0) {}
...
float DecimatingCellFilterI::visibleFraction() const { return m_fraction; }
...
size_t DecimatingCellFilterI::getTimeStamp() const { return m_timestamp; }
