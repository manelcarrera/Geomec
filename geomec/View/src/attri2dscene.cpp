...
template <class OIV2DSceneType> void CAttri2DScene<OIV2DSceneType>::DoDataExchange(CDataExchange *pDX) {
  CString strName;
...
template <class OIV2DSceneType> void CAttri2DScene<OIV2DSceneType>::OnPaint() {
...
template <class OIV2DSceneType> void CAttri2DScene<OIV2DSceneType>::OnClickForeGroundColor() {
  Copy().ForegroundColor(SelectColor(Copy().ForegroundColor()));
  Invalidate();
}

// ##ModelId=3BE7AEC80324
template <class OIV2DSceneType> void CAttri2DScene<OIV2DSceneType>::OnClickBackGroundColor() {
  Copy().BackgroundColor(SelectColor(Copy().BackgroundColor()));
  Invalidate();
  // TODO: Add your control notification handler code here
}

template <class OIV2DSceneType> void CAttri2DScene<OIV2DSceneType>::OnClickBackGroundColor2() {
  Copy().BackgroundColor2(SelectColor(Copy().BackgroundColor2()));
  Invalidate();
  // TODO: Add your control notification handler code here
}

QRgb InvertQrgb(QRgb color) { return (color ^ RGB_MASK); }

template <class OIV2DSceneType> void CAttri2DScene<OIV2DSceneType>::OnBnClickedBtInvertcolors() {
  UpdateData(true);
...
template <class OIV2DSceneType> void CAttri2DScene<OIV2DSceneType>::OnOK() {
  CAttributesTemplate<OIV2DSceneType>::OnOK();
}

template <class OIV2DSceneType> void CAttri2DScene<OIV2DSceneType>::OnCancel() {
