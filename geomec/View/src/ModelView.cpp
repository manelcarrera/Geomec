...
void CALLBACK TimerCallback(HWND hWnd,         // handle of CWnd that called SetTimer
                            UINT nMsg,         // WM_TIMER
...
CModelView::CModelView() : m_pLegend(0), m_pSceneWrapper(0), m_timerId(0) {}
...
void CModelView::AssertValid() const { CView::AssertValid(); }

// ##ModelId=3BC55D610122
void CModelView::Dump(CDumpContext &dc) const { CView::Dump(dc); }
#endif //_DEBUG
...
void CModelView::OnInsertRectangularMeshRegion() {
  ...
  (static_cast<CHexaMeshRegionEntry_Delegate *>(entry.getDelegate()))->CreateMeshRegionRect();
}

void CModelView::OnInsertPolygonalMeshRegion() {
  CHexaMeshRegionEntry &entry = dynamic_cast<CHexaMeshRegionEntry &>(*Model()->GraphEntry(MD_HEXA_MESH_ZONE));

  (static_cast<CHexaMeshRegionEntry_Delegate *>(entry.getDelegate()))->CreateMeshRegionPoly();
}
...
void CModelView::OnUpdateInsertMeshRegion(CCmdUI *pCmdUI) {
  if (dynamic_cast<CHexaModel *>(Model())) {
    ...
    pCmdUI->Enable((static_cast<CHexaMeshRegionEntry_Delegate *>(entry.getDelegate()))->CanCreateMeshRegion());
  } else
    pCmdUI->Enable(FALSE);
}

CModelBase *CModelView::Model() { return ((CModelBase *)((CFemAppDoc *)GetDocument())->Model()); }
...
void CModelView::OnUpdateCopyPicture(CCmdUI *pCmdUI) { pCmdUI->Enable(Model() != 0); }

void CModelView::OnCopyPicture() { CopyClipboard(); }

void CModelView::OnSaveGraphics() // wjrx mantis 2461
{
  CString sFileName;
  CTnoFileDialog dlg(FALSE, "bmp", sFileName, OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT, "Bitmap (*.bmp)|*.bmp||", NULL);
  if (dlg.DoModal() == IDOK) {
...
void CModelView::OnViewColor() { PerformInvalidatingOIVSceneWrapperFunction(&ISceneWrapper::ShowColor, true); }

// ##ModelId=3BC55D630132
void CModelView::OnViewValue() { PerformInvalidatingOIVSceneWrapperFunction(&ISceneWrapper::ShowColor, false); }
...
void CModelView::OnViewCoordinateAxis() {
  PerformInvalidatingOIVSceneWrapperFunction(&ISceneWrapper::DisplayCoordinateAxis,
                                             !m_pSceneWrapper->DisplayCoordinateAxis());
}
...
void CModelView::OnFormationFull() { SelectMeshMode(FullMesh); }

void CModelView::OnFormationSkin() { SelectMeshMode(SkinMesh); }

void CModelView::OnFormationCenter() { SelectMeshMode(CenterMesh); }

void CModelView::OnSelectDraggerTracker() {
  PerformInvalidatingOIVSceneWrapperFunction(&ISceneWrapper::SelectDraggerTracker,
                                             !m_pSceneWrapper->DraggerTrackerSelected());
}

void CModelView::OnSelectMouseTracker() {
  PerformInvalidatingOIVSceneWrapperFunction(&ISceneWrapper::SelectMouseTracker,
                                             !m_pSceneWrapper->MouseTrackerSelected());
}
...
void CModelView::OnSelectClipPlaneMode() {
  PerformInvalidatingOIVSceneWrapperFunction(&ISceneWrapper::SelectClipPlaneMode,
                                             !m_pSceneWrapper->ClipPlaneModeSelected());
}

void CModelView::OnSelectContourLineMode() {
  PerformInvalidatingOIVSceneWrapperFunction(&ISceneWrapper::SelectContourLineMode,
                                             !m_pSceneWrapper->ContourLineModeSelected());
}

void CModelView::OnSelectMeshLinesDisplayed() {
  PerformInvalidatingOIVSceneWrapperFunction(&ISceneWrapper::SelectMeshLinesDisplayed,
                                             !m_pSceneWrapper->MeshLinesDisplayed());
}

void CModelView::OnSelectFormationOutlinesDisplayed() {
  PerformInvalidatingOIVSceneWrapperFunction(&ISceneWrapper::SelectFormationOutlinesDisplayed,
                                             !m_pSceneWrapper->FormationOutlinesDisplayed());
}

void CModelView::OnShowValuesPerElement() {
  PerformInvalidatingOIVSceneWrapperFunction(&ISceneWrapper::ShowValuesPerElement,
                                             !m_pSceneWrapper->ShowValuesPerElement());
}
...
void CModelView::OnZoomIn() { PerformInvalidatingOIVSceneWrapperFunction(&ISceneWrapper::ZoomIn); }

void CModelView::OnTimerCalled() { PerformInvalidatingOIVSceneWrapperFunction(&ISceneWrapper::TimerCalled); }

void CModelView::OnZoomOut() { PerformInvalidatingOIVSceneWrapperFunction(&ISceneWrapper::ZoomOut); }

void CModelView::OnZoomReset() { PerformInvalidatingOIVSceneWrapperFunction(&ISceneWrapper::ZoomReset); }
...
void CModelView::OnViewEDirection() { PerformInvalidatingOIVSceneWrapperFunction(&ISceneWrapper::ViewEDirection); }

void CModelView::OnViewNDirection() { PerformInvalidatingOIVSceneWrapperFunction(&ISceneWrapper::ViewNDirection); }

void CModelView::OnViewZDirection() { PerformInvalidatingOIVSceneWrapperFunction(&ISceneWrapper::ViewZDirection); }

void CModelView::OnGoHome() { PerformInvalidatingOIVSceneWrapperFunction(&ISceneWrapper::GoHome); }

void CModelView::OnSaveHome() { PerformInvalidatingOIVSceneWrapperFunction(&ISceneWrapper::SaveHome); }
...
void CModelView::OnViewPerspective() {
  PerformInvalidatingOIVSceneWrapperFunction(&ISceneWrapper::DisplayPerspective,
                                             !m_pSceneWrapper->DisplayPerspective());
}
...
void CModelView::OnViewColorscale() {
  CColorScaleEntry *pEntry = dynamic_cast<CColorScaleEntry *>(Model()->GraphEntry(MD_BASE_COLOR_SCALE));
  assert(pEntry);
  CColorScaleEntry_Delegate *pEntry_Delegate = new CColorScaleEntry_Delegate(pEntry);
  assert(pEntry_Delegate);
