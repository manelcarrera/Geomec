...
/*static*/ void MoTensorSet::initClass()
{
  SO_NODE_INIT_CLASS(MoTensorSet, MoActionNode, "MoActionNode");
}

/*static*/ void MoTensorSet::exitClass()
{
  SO__NODE_EXIT_CLASS(MoTensorSet);
}
...
MoTensorSet::MoTensorSet()
  : m_tensorSet(0)
{
  SO_NODE_CONSTRUCTOR(MoTensorSet);
}
...
const MiTensorSetI* MoTensorSet::getTensorSet()
{
  return m_tensorSet;
}

void MoTensorSet::reset()
{
  setTensorSet(0);
}
