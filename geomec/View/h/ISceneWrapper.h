...
public:
  ...
  virtual bool CanConnectToMultipleItems(const CGraphNode &node) { return false; }
  ...
  virtual bool MultipleStagesAllowed() const { return false; }
  virtual bool MultipleValueComponentsAllowed() const { return false; }
  virtual size_t NumberOfValueComponents() const { return ValueComponent() != nullptr ? 1 : 0; }

  virtual IValueComponentBase *ValueComponent(size_t index) const { return index == 0 ? ValueComponent() : 0; }
