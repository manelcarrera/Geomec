...
class CSceneObserver : public CNodeObserver_Delegate<COpenGLSceneBase, COpenGLSceneBase_Delegate, CHILD_TYPE,
                                                     CHILD_OBS_TYPE, RENAME, REMOVE> {
public:
  CSceneObserver(COpenGLSceneBase &node, CTreeNode &parent, const BOOL rename, const REMOVE_TYPE remove,
                 HTREEITEM hInsertAfter = TVI_LAST)
      : CNodeObserver_Delegate<COpenGLSceneBase, COpenGLSceneBase_Delegate, CHILD_TYPE, CHILD_OBS_TYPE, RENAME, REMOVE>(
            node, parent, rename, remove, hInsertAfter) {}
