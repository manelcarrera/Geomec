...
CColorScaleEntry_Delegate::CColorScaleEntry_Delegate(CColorScaleEntry *colorScaleEntry)
    : IColorScaleEntry_Delegate(colorScaleEntry), m_colorScaleEntry(colorScaleEntry) {}
...
void CColorScaleEntry_Delegate::OnNewColorGradient() {
  ...
  CColorGradient *pGradient = new CColorGradient(
      IDS_NEW_COLOR_GRADIENT, m_colorScaleEntry->Model(), pScene->MinValue(), pScene->MaxValue(),
      m_colorScaleEntry->LocalColorGradient()->MinColor(), m_colorScaleEntry->LocalColorGradient()->MaxColor());
...
void CColorScaleEntry_Delegate::OnNewHotSpot() {
  ...
  CHotSpot *pHotSpot =
      new CHotSpot(IDS_NEW_HOTSPOT, m_colorScaleEntry->Model(), m_colorScaleEntry->LocalColorGradient()->MinColor(),
