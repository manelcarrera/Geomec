...
public:
  ...
  public:
    CPointHighlightNode_Delegate(CNodeLocationHighlighter::CPointHighlightNode *pointHighlightNode);

  private:
    CPointHighlightNode_Delegate(const CPointHighlightNode_Delegate &rhs);
    CPointHighlightNode_Delegate &operator=(const CPointHighlightNode_Delegate &rhs);
...
public:
  CNodeLocationHighlighter_Delegate(CNodeLocationHighlighter *nodeLocationHighlighter);

private:
  CNodeLocationHighlighter_Delegate(const CNodeLocationHighlighter_Delegate &rhs);
  CNodeLocationHighlighter_Delegate &operator=(const CNodeLocationHighlighter_Delegate &rhs);
