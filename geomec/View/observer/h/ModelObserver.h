...
typedef COpenGLNodeObserver_Delegate<CZoominModelPlaceHolder, CZoominModelPlaceHolder_Delegate, CDummyNode,
                                     CDummyObserver, TRUE, DELETE_ITEM>
    TZoominModelPlaceHolderObserver;
typedef CStateBranch_Delegate<CZoominModelEntry, CZoominModelEntry_Delegate, CZoominModelPlaceHolder,
                              TZoominModelPlaceHolderObserver, CUndefinedIconProvider, TRUE, DELETE_ITEM>
    TZoominModelEntryObserver;
