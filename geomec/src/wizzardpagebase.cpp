...
unsigned int CWizzardPageBase::CPageTreeItem::Icon() const
{
...
const CPropertySheet& CWizzardPageBase::Sheet() const
{
  return *( (CPropertySheet*) GetParent()); 
}

CPropertySheet& CWizzardPageBase::Sheet()
{
  return *( (CPropertySheet*) GetParent()); 
}

BOOL CWizzardPageBase::Enable() const
{
  return TRUE;
}
...
CString CWizzardPageBase::Text() const
{
  return getStringTableEntry(m_uCaption);
}