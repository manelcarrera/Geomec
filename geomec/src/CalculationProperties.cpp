...
void CCalculationProperties::OnBrowseUser()
{
  OnBrowse(IDC_EDITUSERPATH, CTempPath::TEMP_GENERAL);
}

void CCalculationProperties::OnBrowseCalc() 
{
  OnBrowse(IDC_EDITCALCPATH, CTempPath::TEMP_CALCULATION);
}
