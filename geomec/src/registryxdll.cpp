...
void IRegistryXDllCtrl::SetUserKey(LPCTSTR propVal)
{
...
void IRegistryXDllCtrl::SetSystemKey(LPCTSTR propVal)
{
...
void IRegistryXDllCtrl::SetReportErrors(BOOL propVal)
{
