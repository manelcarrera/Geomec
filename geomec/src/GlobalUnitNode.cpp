...
CGlobalUnitNode::CGlobalUnitNode() : m_unitNode(retrieveGlobalUnitNode()) {}

const CUnitNode &CGlobalUnitNode::unitNode() const { return m_unitNode; }
...
const CUnitNode &CGlobalUnitNode::retrieveGlobalUnitNode() {
  ...
  CFemAppDoc *femAppDoc = dynamic_cast<CFemAppDoc *>(docTemplate->GetNextDoc(position));
