...
: CDialog(CDefineRegular2DGridDlg::IDD, pParent),
  m_model(model),
  m_nPointsNorthing(DEF_NUM_POINTS),
...
int CDefineRegular2DGridDlg::NumPointsNorthing() const
{
  return m_nPointsNorthing;
}

int CDefineRegular2DGridDlg::NumPointsEasting() const
{
  return m_nPointsEasting;
}
...
: CDialog(IDD_SELECTOBJECT_DLG, pParent),
  m_model(model)
{
}

const CModelBase& ISelectObjectDlg::Model() const
{
  return m_model;
}
...
CSelect2DPointsetDlg::CSelect2DPointsetDlg(const CModelBase& model, CWnd* pParent)
: ISelectObjectDlg(model, pParent)
{
}

const CPointSet* CSelect2DPointsetDlg::SelectedPointset() const
{
  return m_pSelectedPointset;
}
...
CString CSelect2DPointsetDlg::ObjectTitle() const
{
  return "Pointset";
}
...
CSelect2DPointsetDlg::CPointsetListObject::CPointsetListObject(const CPointSet& pointset, CSelect2DPointsetDlg& dlg, CListCtrl& ctrl)
: IListObject(ctrl),
  m_pointset(pointset),
  m_dlg(dlg)
{
...
unsigned int CSelect2DPointsetDlg::CPointsetListObject::Icon() const
{
  return m_pointset.IconId();
}

QString CSelect2DPointsetDlg::CPointsetListObject::Text() const
{
  return m_pointset.Name();
}
...
CSelectSurfaceDlg::CSelectSurfaceDlg(const CModelBase& model, CWnd* pParent)
: ISelectObjectDlg(model, pParent)
{
}

const CSurfaceBase* CSelectSurfaceDlg::SelectedSurface() const
{
...
CString CSelectSurfaceDlg::ObjectTitle() const
{
  return "Surface";
}
...
CSelectSurfaceDlg::CSurfaceListObject::CSurfaceListObject(const CSurfaceBase& surface, CSelectSurfaceDlg& dlg, CListCtrl& ctrl)
: IListObject(ctrl),
  m_surface(surface),
  m_dlg(dlg)
{
...
unsigned int CSelectSurfaceDlg::CSurfaceListObject::Icon() const
{
  return m_surface.IconId();
}

QString CSelectSurfaceDlg::CSurfaceListObject::Text() const
{
