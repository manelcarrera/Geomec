...
CBinaryResultsImport::CBinaryResultsImport(CModelBase &model) : m_model(model), m_pFormat(0), m_nProgress(0) {}

CBinaryResultsImport::~CBinaryResultsImport() { Close(); }
...
QString CBinaryResultsImport::ErrorMessage() const { return m_strErrorMessage; }
