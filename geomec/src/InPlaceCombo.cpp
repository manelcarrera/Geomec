...
void CInPlaceCombo::OnChar(unsigned int nChar, unsigned int nRepCnt, unsigned int nFlags) 
{
...
BOOL CInPlaceCombo::ShowComboCtrl(DWORD dwStyle, const CRect &rCellRect, CWnd* pParentWnd, unsigned int uiResourceID,
