...
CDerivedMatLibDlg::CDerivedMatLibDlg(CMaterialEntry_Delegate *materialEntry_Delegate, ml::CMaterialLibrary &matlib,
                                     int modelfilter, CAnalysisLogger &logger, bool bImportMode, UINT nIDTemplate,
                                     CWnd *pParent)
...
void CDerivedMatLibDlg::OnItemchangedListmaterials(NMHDR *pNMHDR, LRESULT *pResult) {
