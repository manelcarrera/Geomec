...
CRenameMaterialDlg::CRenameMaterialDlg(const QString &sName, mlMatModel matmodel, bool bAllowModelChange, int nFilter,
                                       CWnd *pParent /*=NULL*/)
    : CDialog(CRenameMaterialDlg::IDD, pParent), m_strName(sName), m_matmodel(matmodel),
      m_bAllowModelChange(bAllowModelChange), m_nModelFilter(nFilter), m_iModelComboIndex(-1) {
...
const QString &CRenameMaterialDlg::Name() const { return m_strName; }

mlMatModel CRenameMaterialDlg::MaterialModel() const { return m_matmodel; }
