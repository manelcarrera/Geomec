...
CMaterialImportDialog::CMaterialImportDialog(CMaterialEntry_Delegate *materialEntry_Delegate,
    ...
    : CMatLibDlg(matlib, modelfilter, logger, bImportMode, nIDTemplate, pParent), m_materialEntry(materialEntry),
