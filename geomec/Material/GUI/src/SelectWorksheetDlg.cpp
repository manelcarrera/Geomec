...
CSelectWorksheetDlg::CSelectWorksheetDlg(CWnd *pParent /*=NULL*/) : CDialog(CSelectWorksheetDlg::IDD, pParent) {
...
void CSelectWorksheetDlg::SetStrings(const std::vector<CString> &vcStrings) { m_vcStrings = vcStrings; }
