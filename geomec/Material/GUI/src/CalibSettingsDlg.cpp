...
: CDialog(IDD_CALIBSETTINGS, pParent),
  m_dConvCrit(dConvCrit),
  m_iMaxNumIter(iMaxNumIter)
{
}

double CCalibSettingsDlg::ConvergenceCriterion() const
{
  return m_dConvCrit;
}

int CCalibSettingsDlg::MaxNumIterations() const
{
  return m_iMaxNumIter;
}
