...
public:
  ...
  void setMaterialParameterError(const std::vector<QString> &materialParameterError);
  bool hasMaterialParameterErrors() const;

  typedef std::map<int, CLibraryMaterialParameter *>
      TItemParameterMap; // map from an item in the listctrl to the corresponding parameters
