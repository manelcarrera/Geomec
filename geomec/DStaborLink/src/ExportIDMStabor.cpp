...
CExportIDMStabor::CExportIDMStabor
...
, m_stage(stage)
, m_antype(antype)
, m_pNewPointList(pNewPointList)
{
  assert( m_pNewPointList!=0 );

  if (CExportIDMStabor::m_classInited == true) return;
  CExportIDMStabor::m_classInited= true;

  CExportIDMStabor::m_fieldNames.reserve(39);
  CExportIDMStabor::m_units.reserve(39);
  CExportIDMStabor::m_fieldNames.push_back("ValidRow"); CExportIDMStabor::m_units.push_back("");
  CExportIDMStabor::m_fieldNames.push_back("RowNr"); CExportIDMStabor::m_units.push_back("");
  CExportIDMStabor::m_fieldNames.push_back("VerticalDepth"); CExportIDMStabor::m_units.push_back("[m]");
  CExportIDMStabor::m_fieldNames.push_back("BoreholeRadius"); CExportIDMStabor::m_units.push_back("[m]");
  CExportIDMStabor::m_fieldNames.push_back("Inclination"); CExportIDMStabor::m_units.push_back("[deg]");
  CExportIDMStabor::m_fieldNames.push_back("AzimuthAngle"); CExportIDMStabor::m_units.push_back("[deg]");
  CExportIDMStabor::m_fieldNames.push_back("Strsdef"); CExportIDMStabor::m_units.push_back("");
  CExportIDMStabor::m_fieldNames.push_back("PorePress"); CExportIDMStabor::m_units.push_back("[MPa]");
  CExportIDMStabor::m_fieldNames.push_back("TotNorthDirStrs"); CExportIDMStabor::m_units.push_back("[MPa]");
  CExportIDMStabor::m_fieldNames.push_back("TotEastDirStrs"); CExportIDMStabor::m_units.push_back("[MPa]");
  CExportIDMStabor::m_fieldNames.push_back("TotDepthDirStrs"); CExportIDMStabor::m_units.push_back("[MPa]");
  CExportIDMStabor::m_fieldNames.push_back("NorthEastShStrs"); CExportIDMStabor::m_units.push_back("[MPa]");
  CExportIDMStabor::m_fieldNames.push_back("EastDepthShStrs"); CExportIDMStabor::m_units.push_back("[MPa]");
  CExportIDMStabor::m_fieldNames.push_back("NorthDepthShStrs"); CExportIDMStabor::m_units.push_back("[MPa]");
  CExportIDMStabor::m_fieldNames.push_back("PorePressure"); CExportIDMStabor::m_units.push_back("[kPa/m]");
  CExportIDMStabor::m_fieldNames.push_back("VertTSG"); CExportIDMStabor::m_units.push_back("[kPa/m]");
  CExportIDMStabor::m_fieldNames.push_back("MaxHorTSG"); CExportIDMStabor::m_units.push_back("[kPa/m]");
  CExportIDMStabor::m_fieldNames.push_back("MinHorTSG"); CExportIDMStabor::m_units.push_back("[kPa/m]");
  CExportIDMStabor::m_fieldNames.push_back("AzimuthMaxHor"); CExportIDMStabor::m_units.push_back("[deg]");
  CExportIDMStabor::m_fieldNames.push_back("Undrained"); CExportIDMStabor::m_units.push_back("Yes/No");
  CExportIDMStabor::m_fieldNames.push_back("BiotAlpha"); CExportIDMStabor::m_units.push_back("[-]");
  CExportIDMStabor::m_fieldNames.push_back("Skemptoncoef"); CExportIDMStabor::m_units.push_back("[-]");
  CExportIDMStabor::m_fieldNames.push_back("Usecorrelation"); CExportIDMStabor::m_units.push_back("Yes/No");
  CExportIDMStabor::m_fieldNames.push_back("SurfaceArea"); CExportIDMStabor::m_units.push_back("[m2/g]");
  CExportIDMStabor::m_fieldNames.push_back("SonicTT"); CExportIDMStabor::m_units.push_back("[micro-s/m]");
  CExportIDMStabor::m_fieldNames.push_back("Plasticity"); CExportIDMStabor::m_units.push_back("Yes/No");
  CExportIDMStabor::m_fieldNames.push_back("Cohesion"); CExportIDMStabor::m_units.push_back("[MPa]");
  CExportIDMStabor::m_fieldNames.push_back("Friction"); CExportIDMStabor::m_units.push_back("[deg]");
  CExportIDMStabor::m_fieldNames.push_back("Dilatation"); CExportIDMStabor::m_units.push_back("[deg]");
  CExportIDMStabor::m_fieldNames.push_back("Isotropy"); CExportIDMStabor::m_units.push_back("");
  CExportIDMStabor::m_fieldNames.push_back("YoungsMod"); CExportIDMStabor::m_units.push_back("[GPa]");
  CExportIDMStabor::m_fieldNames.push_back("InPlaneYoungsMod"); CExportIDMStabor::m_units.push_back("[GPa]");
  CExportIDMStabor::m_fieldNames.push_back("PerpYoungsMod"); CExportIDMStabor::m_units.push_back("[GPa]");
  CExportIDMStabor::m_fieldNames.push_back("DipAzi"); CExportIDMStabor::m_units.push_back("[deg]");
  CExportIDMStabor::m_fieldNames.push_back("Dipangle"); CExportIDMStabor::m_units.push_back("[deg]");
  CExportIDMStabor::m_fieldNames.push_back("PoissonRatio"); CExportIDMStabor::m_units.push_back("[-]");
  CExportIDMStabor::m_fieldNames.push_back("Hardening"); CExportIDMStabor::m_units.push_back("[-]");
  CExportIDMStabor::m_fieldNames.push_back("HardeningGrad"); CExportIDMStabor::m_units.push_back("[GPa]");
  CExportIDMStabor::m_fieldNames.push_back("FractEnergy"); CExportIDMStabor::m_units.push_back("[Pa.m]");
}
...
CExportIDMStaborRow::CExportIDMStaborRow
( const CModelBase& model
, const CDepletionStage& stage
, const CAnalysisType& antype
, const CNewGeoWellPoint* pNewWellPoint
, int rowNr
)
: m_model(model)
, m_stage(stage)
, m_antype(antype)
, m_pNewWellPoint(pNewWellPoint)
, m_validRow(true)
, m_rowNr(rowNr+1)
, m_verticalDepth(0)
, m_boreHoleRadius(0.1)
, m_inclinationAngle(0)
, m_azimuthAngle(0)
, m_stressDefinitionGeneral(true)
, m_porePressure(-9999)
, m_totalNorthDirecStress(-9999)
, m_totalEastDirecStress(-9999)
, m_totalDepthDirecStress(-9999)
, m_northEastShearStress(-9999)
, m_eastDepthShearStress(-9999)
, m_northDepthShearStress(-9999)
, m_validPorePressure(false)
, m_validTotalNorthDirecStress(false)
, m_validTotalEastDirecStress(false)
, m_validTotalDepthDirecStress(false)
, m_validNorthEastShearStress(false)
, m_validEastDepthShearStress(false)
, m_validNorthDepthShearStress(false)
...
, m_undrained(false)
, m_biotAlpha(1)
, m_skemptonCoefficient(0)
, m_useCorrelationFunction(false)
, m_surfaceArea(-1)
, m_sonicTransitTime(-1)
, m_plasticity(false)
, m_cohesionStrength(0)
, m_frictionAngle(0)
, m_dilatationAngle(0)
, m_isotropy(true)
, m_youngsModulus(0)
...
//, m_fractureEnergy(-1)
{
  ...
  if (  mat.MaterialModel() == MM_CAMCLAY 
...
CStartIDMStaborDlg::CStartIDMStaborDlg
( std::list<CNewWellPoint>* pNewPointList
, CModelBase& model
, CWnd* pParent
)
: CDialog(IDD_EXPORT_IDMSTABOR, pParent)
, m_model(model)
, m_pNewPointList(pNewPointList)
, m_nAnalysisType(0)
{
