...
class CFistExport : public CXMLBase {
  ...
  class CLayer {
  public:
    CLayer(CFistExport &parent, QDomElement xmlparent, const well::CWellPoint &wellpoint, double dStartAHD,
           double dEndAHD, const CModelBase &model, TFormationNameMap &mpFormationNames);
  ...
  {
  public:
    CNewLayer(CFistExport &parent, QDomElement xmlparent, const CNewWellPoint &wellpoint, double dStartAHD,
              double dEndAHD, const CModelBase &model, TFormationNameMap &mpFormationNames);
...
public:
  CFistExport(const CModelBase *pModel, const CNewWellPath *pNewWellPath = 0, bool bNewWellPaths = false);
