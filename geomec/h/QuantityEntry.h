...
public:
  ...
  virtual double GlobalMin(const geo::IBox &box, const int nComponent = 0,
                           const CQuantity::UNIT unit = CQuantity::SI_UNIT) const = 0;
  virtual double GlobalMax(const geo::IBox &box, const int nComponent = 0,
                           const CQuantity::UNIT unit = CQuantity::SI_UNIT) const = 0;
...
template <class T> class CQuantityEntry : public CGraphEntryTemp<T>, public IQuantityEntry {
...
public:
  ...
  double GlobalMin(const geo::IBox &box, const int nComponent = 0,
                   const CQuantity::UNIT unit = CQuantity::SI_UNIT) const;
  double GlobalMax(const geo::IBox &box, const int nComponent = 0,
                   const CQuantity::UNIT unit = CQuantity::SI_UNIT) const;
...
template <class T>
CQuantityEntry<T>::CQuantityEntry(const int nEntryId, const CBoundary &boundary) : CGraphEntryTemp<T>(nEntryId, 0, 0) {
  //	LinkTo(boundary);
...
template <class T> void CQuantityEntry<T>::LinkToEntry(CGraphNode &node) { LinkTo(node); }
...
template <class T> const CHotSpot &CQuantityEntry<T>::HotSpot() const { return *m_pHotSpot; }

template <class T> CHotSpot &CQuantityEntry<T>::HotSpot() { return *m_pHotSpot; }

template <class T> const CColorGradient &CQuantityEntry<T>::GlobalColorGradient() const { return *m_pGlobal; }

template <class T> CColorGradient &CQuantityEntry<T>::GlobalColorGradient() { return *m_pGlobal; }

template <class T> const CColorGradient &CQuantityEntry<T>::LocalColorGradient() const { return *m_pLocal; }

template <class T> CColorGradient &CQuantityEntry<T>::LocalColorGradient() { return *m_pLocal; }
