...
namespace {
static const IListenerDefinition RunDianaGui_ListenerDefinition{CEvents::GuiApp_EH,
                                                                {Progress, DianaMsg,
                                                                 //
                                                                 HeartBeat_Ack,
                                                                 //
...
namespace doc_ {
namespace gui {
void popup(const QString &title, const QString &msg, int timeout = 0);
} // namespace gui
CString executable();
...
public:
  ...
  // protected:
public: // FIXME
  bool RunAnalysis(const CAnalysisType::TAnalysisType antype, bool bWriteInputFiles, bool bWriteQuadDat);
