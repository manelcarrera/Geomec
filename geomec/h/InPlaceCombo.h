...
public:
  ...
  BOOL ShowComboCtrl(DWORD dwStyle, const CRect &rCellRect, CWnd *pParentWnd, unsigned int uiResourceID, int iRowIndex,
                     int iColumnIndex, CStringList *pDropDownList, CString strCurSelecetion = "", int iCurSel = -1);
