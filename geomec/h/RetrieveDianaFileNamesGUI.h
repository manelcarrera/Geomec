...
public:
  CRetrieveDianaFileNamesGUI(CAnalysisType::TAnalysisType analysisType, bool writeInputFiles, bool writeQuadDat,
...
private:
  ...
  CRetrieveDianaFileNamesGUI &operator=(const CRetrieveDianaFileNamesGUI &rhs);
