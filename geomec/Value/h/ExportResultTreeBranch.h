...
typedef CSelectionBranchObserver_Delegate<THorizonBaseEntry, THorizonBaseEntry_Delegate, CHorizonBase, THorizonObs, CHorizonBase, THorizonBaseSelection, FALSE, FIXED_ITEM> THorizonBranchObs;
...
typedef CSelectionLeafObserver_Delegate<CFormationPlane, CFormationPlane_Delegate, TFormationPlaneSelection, FALSE> TFormationPlaneObs;
typedef CSelectionBranchObserver_Delegate<CHexaFormation, CHexaFormation_Delegate, CFormationPlane, TFormationPlaneObs, CFormationPlane, TFormationPlaneSelection, FALSE, FIXED_ITEM> THexaFormationObs;
typedef CSelectionBranchObserver_Delegate<CHexaFormationEntry, CHexaFormationEntry_Delegate, CHexaFormation, THexaFormationObs, CFormationPlane, TFormationPlaneSelection, FALSE, FIXED_ITEM> THexaFormationEntryObs;
...
typedef CSelectionBranchObserver_Delegate<CWellCasingRTCIEntry, CWellCasingRTCIEntry_Delegate, CWellCasingRTCI, TRTCIObs, CWellCasingRTCI, TRTCISelection, FALSE, FIXED_ITEM> TRTCIBranchObs;

class CRTCIEntryObserver : public TRTCIBranchObs
{
public:
  CRTCIEntryObserver(CWellCasingRTCIEntry& entry,
                     TRTCISelection& selection,
                     CTreeCtrlBase& tcObject)
...
typedef CSelectionBranchObserver_Delegate<TPointSetEntry, TPointSetEntry_Delegate, CPointSet, TPointSetObs, CPointSet, TPointSetSelection, FALSE, FIXED_ITEM> TPointSetBranchObs;
...
typedef CSelectionBranchObserver_Delegate<TPointSetEntry, TPointSetEntry_Delegate, IElementSet, TElementSetObs, IElementSet, TElementSetSelection, FALSE, FIXED_ITEM> TElementSetBranchObs;
...
typedef CSelectionLeafObserver_Delegate<CFormationBase, CFormationBase_Delegate, TFormationSelection, FALSE> TFormationObs;
typedef CSelectionBranchObserver_Delegate<TFormationBaseEntry, TFormationBaseEntry_Delegate, CFormationBase, TFormationObs, CFormationBase, TFormationSelection, FALSE, FIXED_ITEM> TFormationBranchObs;

class CFormationBaseEntryObserver : public TFormationBranchObs
{
public:
  CFormationBaseEntryObserver(TFormationBaseEntry& entry,
                              TFormationSelection& selection,
                              CTreeCtrlBase& tcObject)
...
typedef CSelectionLeafObserver_Delegate<CNewWellPath, CNewWellPath_Delegate, TNewWellPathSelection, FALSE> TNewWellPathObs;
typedef CSelectionBranchObserver_Delegate<CNewWellPathEntry, CNewWellPathEntry_Delegate, CNewWellPath, TNewWellPathObs, CNewWellPath, TNewWellPathSelection, FALSE, FIXED_ITEM> TNewWellPathBranchObs;
...
typedef CSelectionLeafObserver_Delegate<CNonMeshedSurface, CNonMeshedSurface_Delegate, TNonMeshedSurfaceSelection, TRUE> TNonMeshedSurfaceObs;
typedef CSelectionBranchObserver_Delegate<CNonMeshedSurfaceEntry, CNonMeshedSurfaceEntry_Delegate, CNonMeshedSurface, TNonMeshedSurfaceObs, CNonMeshedSurface, TNonMeshedSurfaceSelection, FALSE, FIXED_ITEM> TNonMeshedSurfaceBranchObs;

class CNonMeshedSurfaceEntryObserver : public TNonMeshedSurfaceBranchObs
{
public:
  CNonMeshedSurfaceEntryObserver(CNonMeshedSurfaceEntry& entry,
                                 TNonMeshedSurfaceSelection& selection,
                                 CTreeCtrlBase& tcObject)
