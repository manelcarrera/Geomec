...
IResultGroupObserver::CResultObserver::CResultComponentObserver::CResultComponentObserver(CResultObserver& parent, int nComponent)
...
const IResultGroupObserver::CResultObserver& IResultGroupObserver::CResultObserver::CResultComponentObserver::ResultObserver() const
{
	return dynamic_cast<const CResultObserver&>(*Parent());
}
		
IResultGroupObserver::CResultObserver& IResultGroupObserver::CResultObserver::CResultComponentObserver::ResultObserver()
{
...
/* NOT OBSOLETE */ void IResultGroupObserver::CResultObserver::CResultComponentObserver::AppendContextMenu(CContextMenuInvoker &invoker)
{
...
const IResult& IResultGroupObserver::CResultObserver::Result() const
{
	 return m_result;
}

IResult& IResultGroupObserver::CResultObserver::Result()
{
	 return m_result;
}
...
unsigned int IResultGroupObserver::CResultObserver::ResultComponentStateIconId(const IValueComposite& result, int nComponent) const
{
...
void IResultGroupObserver::CResultObserver::AppendResultComponentContextMenu(IResult_Delegate& result, int nComponent, CContextMenuInvoker &invoker)
{
...
const CGraphNode& IResultGroupObserver::CResultObserver::ObservedItem() const
{
	return m_result;
}

CGraphNode& IResultGroupObserver::CResultObserver::ObservedItem()
{
	 return m_result;
}

const CGraphNode_Delegate& IResultGroupObserver::CResultObserver::Delegate() const
{
	return *m_pDelegate;
}

CGraphNode_Delegate& IResultGroupObserver::CResultObserver::Delegate()
{
	return *m_pDelegate;
}
...
IResultGroupObserver::IResultGroupObserver(CResultGroup& group, CTreeCtrl& ctrl, HTREEITEM hParent, HTREEITEM hInsertAfter)
...
const CGraphNode& IResultGroupObserver::ObservedItem() const
{
	return m_group;
}

CGraphNode& IResultGroupObserver::ObservedItem()
{
	 return m_group;
}

const CGraphNode_Delegate& IResultGroupObserver::Delegate() const
{
	return *m_pDelegate;
}

CGraphNode_Delegate& IResultGroupObserver::Delegate()
{
	return *m_pDelegate;
}
...
void IResultGroupObserver::AppendResultGroupContextMenu(CResultGroup_Delegate& group_Delegate, CContextMenuInvoker &invoker)
{
	if(ResultGroupObserver())
...
void IResultGroupObserver::AppendResultComponentContextMenu(const IResult_Delegate& result, int nComponent, CContextMenuInvoker &invoker)
{
	if(ResultGroupObserver())
		ResultGroupObserver()->AppendResultComponentContextMenu(result, nComponent, invoker);
}
...
BOOL IResultGroupObserver::OnFilter(const CGraphNode& node) const
{
	...
	if( pResult || pGroup ) {
		if( ObservedItem().isChild( node ) > -1) {
			if(pGroup) return CanInsertResultGroup( *pGroup );
...
//////////////////////////////////////////////////////////////////////
CResultGroupObserver::CResultGroupObserver(CResultGroup& group, CTreeViewBase& view, HTREEITEM hParent, bool bShowAnalysisTypesAndDimensions, bool bShowDepletions)
...
CResultRegister& CResultGroupObserver::ResultRegister()
{
  ...
  {
		  const IResultComponent* pResultComponent = dynamic_cast<const IResultComponent*> (pDoc->CurrentScene()->ValueComponent());
		  if(pResultComponent)
...
unsigned int CResultGroupObserver::ResultGroupStateIconId(const CResultGroup& group) const
{
	return 0;
}
...
/* NOT OBSOLETE */ void CResultGroupObserver::AppendResultGroupContextMenu(CResultGroup_Delegate& group_Delegate, CContextMenuInvoker &invoker)
{
  group_Delegate.AppendContextMenu(invoker);
}

BOOL CResultGroupObserver::CanInsertResultGroup(const CResultGroup& group) const
{
	return TRUE;
}

unsigned int CResultGroupObserver::ResultStateIconId(const IValueComposite& result) const
{ 
	return 0;
}
...
/* NOT OBSOLETE */ void CResultGroupObserver::AppendResultContextMenu(IResult_Delegate& result, CContextMenuInvoker &invoker)
{
	result.AppendContextMenu(invoker);
}

BOOL CResultGroupObserver::CanInsertResult(const IResult& result) const
{
	return TRUE;
}
          ...
          catch (...)
          {
            ...
            for(unsigned int nMode = 0; nMode < result.ModeSize(); nMode++)
            {
                if(pResultComponent == &result.Component(nComponent, nMode))
                    return pScene->MultipleValueComponentsAllowed() 
                        ? IDI_CHECKED 
                        : IDI_RADIO_CHECKED;
            }
        }
...
void CResultGroupObserver::ResultComponentToggleState(IValueComposite& result, int nComponent)
{
  ...
  // Make the think current
    ...
    {
      const IResultComponent* pResultComponent = 0;
      if (!pScene->IsOpenInventorScene()) // disabling the radiobutton's checkbox behavior; first for main view; TODO: check History/Wells views
      {
        for (size_t i = 0; i < pScene->NumberOfValueComponents(); ++i)
        {
            pResultComponent = dynamic_cast<const IResultComponent*> (pScene->ValueComponent(i));
        ...
        if (!toConnect.empty())
        {
            for_each(toConnect.begin(), toConnect.end(), [pDoc](IResultComponent * pResult) {
                pDoc->CurrentScene()->ConnectItem(*pResult);
            });
            return;
        }
...
/* NOT OBSOLETE */ void CResultGroupObserver::AppendResultComponentContextMenu(const IResult_Delegate& result, int nComponent, CContextMenuInvoker &invoker)
{
...
CAnalysisType::TAnalysisType
  CResultGroupObserver::determineInitialAnalysisType()
{
...
CGVTResultGroupObserver::CGVTResultGroupObserver(CResultGroup& group, CTreeViewBase& view, HTREEITEM hParent, bool bShowAnalysisTypesAndDimensions, bool bShowDepletions)
...
CGVTOutputObserver::CGVTOutputObserver(IValueComposite& node, CTreeNode &parent)
  : CValueCompositeObserver(node, parent, true, UNLINK_ITEM)
  , m_selected(false)
{
}
...
void CLocalResultGroupObserver::AppendResultGroupContextMenu(CResultGroup_Delegate& group_Delegate, CContextMenuInvoker &invoker)
{
	// No context menu
}
...
void CLocalResultGroupObserver::AppendResultComponentContextMenu(const IResult_Delegate& result, int nComponent, CContextMenuInvoker &invoker)
{
	// No context menu
}
*/
...
{
	CDepletionStageBranch::CDepletionStageObserver *pObject1 = ((CDepletionStageBranch::CDepletionStageObserver*)  lParam1);
	CDepletionStageBranch::CDepletionStageObserver *pObject2 = ((CDepletionStageBranch::CDepletionStageObserver*)  lParam2);
...
void CDepletionStageBranch::OnNeighbourModified(const CGraphNode& node, enum ModifiedHint uHint)
{
	Update();
}
...
// DepletionStage leaf
//////////////////////////////////////////////////////////////////////
CDepletionStageBranch::CDepletionStageObserver::CDepletionStageObserver(CDepletionStageBranch& branch, CDepletionStage& stage)
...
/* NOT OBSOLETE */ void CDepletionStageBranch::CDepletionStageObserver::AppendContextMenu(CContextMenuInvoker &invoker)
{
	CDepletionStage& dep_stage = (CDepletionStage&)(ObservedItem());

	typedef CSingleCommandTemplate<CDepletionStage> TCommand;
	invoker.AddCommand(_T("&Mark as initial"),
		*(new TCommand(dep_stage, &CDepletionStage::MarkAsInitial,
								  &CDepletionStage::CanMarkAsInitial)));
}

//////////////////////////////////////////////////////////////////////
// LinearityBranch
//////////////////////////////////////////////////////////////////////
CLinearityBranch::CLinearityBranch(CResultGroupObserver &group_observer)
: IGraphTreeObject(group_observer, TVI_LAST)
{
	Ctrl().SetItemData(Handle(), (DWORD_PTR) this);
...
QString CLinearityBranch::Text() const
{
	return getStringTableEntry(IDS_ANALYSISTYPE);
}

unsigned int CLinearityBranch::Icon() const
{
	return IDI_NON_AND_LINEAR;
}
/*
...
QString CLinearityBranch::CLinearityLeaf::Text() const
{
  return m_antype.Label();
}
...
*/
  IResultComponent* pRes = pResult->ResultComponent(pResultComponent->Stage(),
                                                    m_antype,
                                                    pResultComponent->RegisterIndex(),
                                                    pResultComponent->ComponentIndex());
...
{  
    ...
    for (index = 0; index < numValueComponents; ++index)
    {
        ...
        if (pResultComponent == 0) continue;
        ...
        IResultComponent* pRes = pResult->ResultComponent(pResultComponent->Stage(), m_antype, pResultComponent->RegisterIndex(), pResultComponent->ComponentIndex());
        if(!pRes)
            return false;
...
unsigned int CLinearityBranch::CLinearityLeaf::Icon() const
{
  return m_antype.IconId();
}
...
void CLinearityBranch::CLinearityLeaf::ToggleState()
{
    ...
    while (true)
    {
        ...
        /* Not sure why this was added, but if we're not showing result components, we obviously don't have to update the values
           Especially not if we enter an endless loop (Bug 113173)
           I'll leave it in as comments for now, in case we do find some reason to change this
        else if (Current() == 0)
        {
...
// DimensionBranch
//////////////////////////////////////////////////////////////////////
CDimensionBranch::CDimensionBranch(CResultGroupObserver &group_observer)
: IGraphTreeObject(group_observer, TVI_LAST)
{
	Ctrl().SetItemData(Handle(), (DWORD_PTR) this);
...
QString CDimensionBranch::Text() const
{
	return "Model";
}

unsigned int CDimensionBranch::Icon() const
{
	return IDI_2D_3D_RESULT;
}
/*
