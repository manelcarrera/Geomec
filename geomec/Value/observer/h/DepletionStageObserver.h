...
template <typename DIALOG> class CDepletionStageObserver : public IListObject {
...
public:
  ...
  virtual unsigned int Icon() const { return m_stage.IconId(); }

  virtual QString Text() const { return m_stage.Name(); }
