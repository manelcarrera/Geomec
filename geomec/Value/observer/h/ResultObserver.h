...
{
public:
  CGVTResultGroupObserver(CResultGroup& group, CTreeViewBase& view, HTREEITEM hParent, bool bShowAnalysisTypesAndDimensions, bool bShowDepletions);
...
// current result.  
typedef CNodeObserver_Delegate<CDepletionStageEntry, CDepletionStageEntry_Delegate, CDepletionStage, CDummyObserver, FALSE, FIXED_ITEM> TDepletionStageBranchBase;
