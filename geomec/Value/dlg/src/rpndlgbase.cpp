...
CRpnDlgBase::CValueProxyListObject::CValueProxyListObject(CRpnDlgBase& dlg, CRpnOperand::IValueProxy& proxy, int nListIndex)
...
QString CRpnDlgBase::CValueProxyListObject::Text() const
{
  return m_proxy.TextTag();
}

unsigned int CRpnDlgBase::CValueProxyListObject::Icon() const
{
	return m_proxy.IconId();
}
...
bool CRpnDlgBase::CValueProxyListObject::CanRemove() const
{
	return CanDelete() == TRUE;
}

BOOL CRpnDlgBase::CValueProxyListObject::CanDelete() const
{
	return m_proxy.CanDelete();
}

bool CRpnDlgBase::CValueProxyListObject::HasProperties() const
{
	return m_proxy.HasProperties();
}
...
/* NOT OBSOLETE */ void CRpnDlgBase::CValueProxyListObject::AppendContextMenu(CContextMenuInvoker &invoker)
{
	...
	invoker.AddCommand("&Remove", *(new TCommand(*this, &CRpnDlgBase::CValueProxyListObject::Delete, &CRpnDlgBase::CValueProxyListObject::CanRemove)));
	invoker.AddSeparator();
	invoker.AddCommand("&Properties", *(new TCommand(*this, &CRpnDlgBase::CValueProxyListObject::Properties, &CRpnDlgBase::CValueProxyListObject::HasProperties)));
}
...
CRpnDlgBase::~CRpnDlgBase()
{
	delete m_pStack;
}

CListCtrl& CRpnDlgBase::ListCtrl()
{
	return m_lcOperand;
}
...
HCURSOR CRpnDlgBase::OnQueryDragIcon()
{
	return (HCURSOR) m_hIcon;
}

CRpnStack& CRpnDlgBase::RpnStack()
{
	return *m_pStack;
}

const CRpnStack& CRpnDlgBase::RpnStack() const
{
	return *m_pStack;
}
...
void CRpnDlgBase::OnConvertUnit(CButton& button)
{
  ...
  for(size_t i = 0; i < m_vcUnitConverters.size(); ++i)
    menu.AppendMenu(MF_STRING, WM_USER + COMMAND_OFFSET + m_vcUnitConverters[i].first, m_vcUnitConverters[i].second.toStdString().c_str());
...
BOOL CRpnDlgBase::ValidRpnStack() const
{
  return m_pStack->exists();
}
...
bool CRpnDlgBase::CanSwap() const
{
	return m_lcStack.GetSelectedCount() == 2;
}
