...
public:
  ...
  void CreateProgramResult(CResultServer::TResultType uResultID, UINT uResultName, UINT uExportLabel, UINT uBranchName,
                           UINT uClassType, UINT uSIUnit, UINT uFieldUnit, const double &dFieldFactor);
