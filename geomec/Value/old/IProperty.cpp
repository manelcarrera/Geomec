...
BOOL IProperty::DefineComponent(UINT uHeaderID, UINT uValueTypeID, UINT uComponentID, UINT uMode) { return TRUE; }
IProperty::IProperty(CGraphMode &model) : m_model(mode), m_pPointSet(0) {}
