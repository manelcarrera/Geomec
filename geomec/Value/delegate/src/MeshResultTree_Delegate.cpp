...
CMeshResult_Delegate::CMeshResult_Delegate(CMeshResult *meshResult)
    : IValueComposite_Delegate(meshResult), m_meshResult(meshResult) {}
...
void CMeshResult_Delegate::AppendContextMenu(CContextMenuInvoker &invoker) {
  ...
  invoker.AddCommand("&Export results",
                     *(new TCommand(*this, &CMeshResult_Delegate::Export, &CMeshResult_Delegate::CanExport)));
}

bool CMeshResult_Delegate::CanExport() const { return m_meshResult->CanExport(); }
...
CMeshResultTree_Delegate::CMeshResultTree_Delegate(CMeshResultTree *meshResultTree)
    : CGraphEntryTemp_Delegate<CMeshResult>(meshResultTree), m_meshResultTree(meshResultTree) {}
...
void CMeshResultTree_Delegate::AppendContextMenu(CContextMenuInvoker &invoker) {
  ...
  invoker.AddCommand("&Export results",
                     *(new TCommand(*this, &CMeshResultTree_Delegate::Export, &CMeshResultTree_Delegate::CanExport)));
}

bool CMeshResultTree_Delegate::CanExport() const { return m_meshResultTree->CanExport(); }
