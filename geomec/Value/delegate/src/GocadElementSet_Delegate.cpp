...
CGocadElementSet_Delegate::CGocadElementSet_Delegate(
  CGocadElementSet* gocadElementSet)
: CElementSet_Delegate(gocadElementSet)
, m_gocadElementSet(gocadElementSet)
{
}
...
bool CGocadElementSet_Delegate::canImportInGocadModel() const
{
  return m_gocadElementSet->canImportInGocadModel();
}

void CGocadElementSet_Delegate::importInGocadModel()
{
  m_gocadElementSet->importInGocadModel(selectGocadSolidDlg);
}
