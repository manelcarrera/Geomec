...
CGlobalInitialStressNode_Delegate::CGlobalInitialStressNode_Delegate(
  CGlobalInitialStressNode* globalInitialStressNode)
: CStorageNode_Delegate(globalInitialStressNode)
, m_globalInitialStressNode(globalInitialStressNode)
{
}
