...
CRpnValueSet_Delegate::CRpnValueSet_Delegate(CRpnValueSet *rpnValueSet)
    : IValueSet_Delegate(rpnValueSet), m_rpnValueSet(rpnValueSet) {}
...
bool CRpnValueSet_Delegate::Attributes() {
  ...
  if (m_rpnValueSet->getStack() == 0) {
    ...
    new CRpnValueSet::CValueSetCoordinateProxy(*m_rpnValueSet, IDS_RC_NORTHING, *m_rpnValueSet->getStack(),
                                               CRpnValueSet::CValueSetCoordinateProxy::CO_X);
    new CRpnValueSet::CValueSetCoordinateProxy(*m_rpnValueSet, IDS_RC_EASTING, *m_rpnValueSet->getStack(),
                                               CRpnValueSet::CValueSetCoordinateProxy::CO_Y);
    new CRpnValueSet::CValueSetCoordinateProxy(*m_rpnValueSet, IDS_RC_DEPTH, *m_rpnValueSet->getStack(),
...
bool CRpnValueSet_Delegate::CanDestroy() const { return m_rpnValueSet->CanDestroy(); }
