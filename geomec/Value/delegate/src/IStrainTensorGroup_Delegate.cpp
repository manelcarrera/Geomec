...
IStrainTensorGroup_Delegate::IStrainTensorGroup_Delegate(
  IStrainTensorGroup* strainTensorGroup)
: ITensorGroupTemplate_Delegate <CStrainTensor> (strainTensorGroup)
, m_strainTensorGroup(strainTensorGroup)
{
}
