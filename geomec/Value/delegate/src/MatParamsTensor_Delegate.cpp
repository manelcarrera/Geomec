...
CMatParamsTensor_Delegate::CMatParamsTensor_Delegate(
  CMatParamsTensor* matParamsTensor)
: CValueType_Delegate(matParamsTensor)
, m_matParamsTensor(matParamsTensor)
{
}
