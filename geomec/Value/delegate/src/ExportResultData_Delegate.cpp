...
CExportResultData_Delegate::CExportResultData_Delegate(CExportResultData *exportResultData)
    : CColorNode_Delegate(exportResultData), m_exportResultData(exportResultData) {}
...
bool CExportResultData_Delegate::Attributes() {
  ...
  CResultExportDlg resultExportDlg((CModelBase &)m_exportResultData->Model(), resultExportConfiguration, "Cancel",
                                   true);
...
void CExportResultData_Delegate::AppendContextMenu(CContextMenuInvoker &invoker) {
  typedef CSingleCommandTemplate<CExportResultData_Delegate> CExportResultData_DelegateCommand;

  invoker.AddCommand(_T("&Attributes"),
                     *(new CExportResultData_DelegateCommand(*this, &CExportResultData_Delegate::Attributes)));
}
