...
public:
  CValueTypeTemp_Delegate(CValueTypeTemp<uTypeId, uIconId, uValueNameId, uExportId> *valueTypeTemp);
...
private:
  ...
  typedef CValueTypeTemp<uTypeId, uIconId, uValueNameId, uExportId> CValueTypeTempTemplate;
  typedef CValueTypeTemp_Delegate<uTypeId, uIconId, uValueNameId, uExportId> CValueTypeTemp_DelegateTemplate;

  REGISTER_DELEGATE(CValueTypeTempTemplate, CValueTypeTemp_DelegateTemplate);
};

template <unsigned int uTypeId, unsigned int uIconId, unsigned int uValueNameId, unsigned int uExportId>
CValueTypeTemp_Delegate<uTypeId, uIconId, uValueNameId, uExportId>::CValueTypeTemp_Delegate(
    CValueTypeTemp<uTypeId, uIconId, uValueNameId, uExportId> *valueTypeTemp)
    : CValueType_Delegate(valueTypeTemp), m_valueTypeTemp(valueTypeTemp) {
  ACTIVATE_TEMPLATE_DELEGATE(CValueTypeTempTemplate, CValueTypeTemp_DelegateTemplate);
}
