...
public:
  ...
  public:
    CMatTensorComponent_Delegate(CMatParamsTensor::CMatTensorComponent *matTensorComponent);

  private:
    CMatTensorComponent_Delegate(const CMatTensorComponent_Delegate &rhs);
    CMatTensorComponent_Delegate &operator=(const CMatTensorComponent_Delegate &rhs);

    CMatParamsTensor::CMatTensorComponent *m_matTensorComponent;

    REGISTER_DELEGATE(CMatParamsTensor::CMatTensorComponent, CMatTensorComponent_Delegate);
  };
