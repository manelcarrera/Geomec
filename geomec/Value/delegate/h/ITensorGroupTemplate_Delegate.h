...
template <class TENSOR_TYPE> class ITensorGroupTemplate_Delegate : public ITensorGroup_Delegate {
public:
  ITensorGroupTemplate_Delegate(ITensorGroupTemplate<TENSOR_TYPE> *tensorGroupTemplate);

private:
  ITensorGroupTemplate_Delegate(const ITensorGroupTemplate_Delegate &rhs);
  ITensorGroupTemplate_Delegate &operator=(const ITensorGroupTemplate_Delegate &rhs);
...
ITensorGroupTemplate_Delegate<TENSOR_TYPE>::ITensorGroupTemplate_Delegate(
    ITensorGroupTemplate<TENSOR_TYPE> *tensorGroupTemplate)
    : ITensorGroup_Delegate(tensorGroupTemplate), m_tensorGroupTemplate(tensorGroupTemplate) {}
