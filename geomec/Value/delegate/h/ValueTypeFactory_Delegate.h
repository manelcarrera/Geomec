...
class TLengthComponent_Delegate :
  public CComponentTemp_Delegate <IDS_COMPONENT_DEFAULT, 0>
{
public:
...
class TPressure_Delegate : public CSingleComponentTemp_Delegate <
  IDT_VALUETYPE_PRESSURE, IDI_COMPONENT_PRESSURE_DISTRIBUTED, IDS_ET_PRESSURE,
...
class TFractureMatrixPressure_Delegate : public CSingleComponentTemp_Delegate <
  IDT_VALUETYPE_FRACTURE_MATRIX_PRESSURE,
...
class TTemperature_Delegate : public CSingleComponentTemp_Delegate <
  IDT_VALUETYPE_TEMPERATURE, IDI_COMPONENT_TEMPERATURE_DISTRIBUTED,
...
class TVolumetricStrain_Delegate : public CSingleComponentTemp_Delegate <
  IDT_VALUETYPE_VOLUMETRICSTRAIN, IDI_COMPONENT_VOLUMETRICSTRAIN_DISTRIBUTED,
...
class TNormalStrain_Delegate : public CSingleComponentTemp_Delegate <
  IDT_VALUETYPE_NRMSTRAIN, IDI_COMPONENT_NRMSTRAIN_DISTRIBUTED,
...
class TLateralStrain_Delegate : public CSingleComponentTemp_Delegate <
  IDT_VALUETYPE_LATSTRAIN, IDI_COMPONENT_LATSTRAIN_DISTRIBUTED,
...
class TCohesion_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_COHESION, IDI_VALUETYPE_COHESION, IDS_ET_COHESION,
...
class TBulkStiffness_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_BULKSTIFFNESS, IDI_VALUETYPE_BULKSTIFFNESS,
...
class TShearModulus_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_SHEARMODULUS, IDI_VALUETYPE_SHEARMODULUS, IDS_ET_SHEARMODULUS,
...
class TVelocityP_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_VELOCITYP, IDI_VALUETYPE_VELOCITYP, IDS_ET_VELOCITYP,
...
class TVelocityS_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_VELOCITYS, IDI_VALUETYPE_VELOCITYS, IDS_ET_VELOCITYS,
...
class TFrictionAngle_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_FRICTION_ANGLE, IDI_VALUETYPE_FRICTION_ANGLE,
...
class TPoissonsRatio_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_POISSONS_RATIO, IDI_VALUETYPE_POISSONS_RATIO,
...
class TYoungsModulus_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_YOUNGS_MODULUS, IDI_VALUETYPE_YOUNGS_MODULUS,
...
class TDensity_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_RHOB, IDI_VALUETYPE_RHOB, IDS_ET_RHOB, IDS_VALUENAME_RHOB>
{
public:
...
class TPorosity_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_POROSITY, IDI_VALUETYPE_POROSITY, IDS_ET_POROSITY,
...
class TInitFriction_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_INITFRICTION, IDI_VALUETYPE_INITFRICTION, IDS_ET_INITFRICTION,
...
class THardening_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_HARDENING, IDI_VALUETYPE_HARDENING, IDS_ET_HARDENING,
...
class TPreConsolidation_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_PRECONSOLIDATION, IDI_VALUETYPE_PRECONSOLIDATION,
...
class TCapShape_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_CAPSHAPE, IDI_VALUETYPE_CAPSHAPE, IDS_ET_CAPSHAPE,
...
class TDilatation_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_DILATATION, IDI_VALUETYPE_DILATATION, IDS_ET_DILATATION,
...
class TLatRatioMax_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_LATRATIO_MAX, IDI_VALUETYPE_LATRATIO_MAX, IDS_ET_LATRATIO_MAX,
...
class TLatRatioMin_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_LATRATIO_MIN, IDI_VALUETYPE_LATRATIO_MIN, IDS_ET_LATRATIO_MIN,
...
class TAzimuth_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_AZIMUTH, IDI_VALUETYPE_AZIMUTH, IDS_ET_AZIMUTH,
...
class TCreepA1_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_CREEP_A1, IDI_VALUETYPE_CREEP_A1, IDS_ET_CREEP_A1,
...
class TCreepN1_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_CREEP_N1, IDI_VALUETYPE_CREEP_N1, IDS_ET_CREEP_N1,
...
class TCreepA2_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_CREEP_A2, IDI_VALUETYPE_CREEP_A2, IDS_ET_CREEP_A2,
...
class TCreepN2_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_CREEP_N2, IDI_VALUETYPE_CREEP_N2, IDS_ET_CREEP_N2,
...
class TFluidBulkModulus_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_FLUID_BULK_MOD, IDI_VALUETYPE_FLUID_BULK_MOD,
...
class THardCohesion1_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_HARD_COHESION1, IDI_VALUETYPE_HARD_COHESION1,
...
class THardCohesion2_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_HARD_COHESION2, IDI_VALUETYPE_HARD_COHESION2,
...
class THardCohesion3_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_HARD_COHESION3, IDI_VALUETYPE_HARD_COHESION3,
...
class THardFriction1_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_HARD_FRICTION1, IDI_VALUETYPE_HARD_FRICTION1,
...
class THardFriction2_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_HARD_FRICTION2, IDI_VALUETYPE_HARD_FRICTION2,
...
class THardFriction3_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_HARD_FRICTION3, IDI_VALUETYPE_HARD_FRICTION3,
...
class TCreepQR1_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_CREEP_QR1, IDI_VALUETYPE_CREEP_QR1, IDS_ET_CREEP_QR1,
...
class TCreepQR2_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_CREEP_QR2, IDI_VALUETYPE_CREEP_QR2, IDS_ET_CREEP_QR2,
...
class TTensileStretch_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_TENSILE_STRETCH, IDI_VALUETYPE_TENSILE_STRETCH,
...
class TThermalExpansion_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_THERMAL_EXPANSION, IDI_VALUETYPE_THERMAL_EXPANSION,
...
class TRigidParam1_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_RIGI_PARAM1, IDI_VALUETYPE_RIGID_1, IDS_RIGI_PARAM1,
  IDS_RIGI_PARAM1>
{
public:
...
class TRigidParam2_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_RIGI_PARAM2, IDI_VALUETYPE_RIGID_2, IDS_RIGI_PARAM2,
  IDS_RIGI_PARAM2>
{
public:
...
class TRigidParam3_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_RIGI_PARAM3, IDI_VALUETYPE_RIGID_3, IDS_RIGI_PARAM3,
  IDS_RIGI_PARAM3>
{
public:
...
class TRigidParam4_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_RIGI_PARAM4, IDI_VALUETYPE_RIGID_4, IDS_RIGI_PARAM4,
  IDS_RIGI_PARAM4>
{
public:
...
class TRigidParam5_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_RIGI_PARAM5, IDI_VALUETYPE_RIGID_5, IDS_RIGI_PARAM5,
  IDS_RIGI_PARAM5>
{
public:
...
class TRigidParam6_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_RIGI_PARAM6, IDI_VALUETYPE_RIGID_6, IDS_RIGI_PARAM6,
  IDS_RIGI_PARAM6>
{
public:
...
class TRigidParam7_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_RIGI_PARAM7, IDI_VALUETYPE_RIGID_7, IDS_RIGI_PARAM7,
  IDS_RIGI_PARAM7>
{
public:
...
class TRigidParam8_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_RIGI_PARAM8, IDI_VALUETYPE_RIGID_8, IDS_RIGI_PARAM8,
  IDS_RIGI_PARAM8>
{
public:
...
class TRigidParam9_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_RIGI_PARAM9, IDI_VALUETYPE_RIGID_9, IDS_RIGI_PARAM9,
  IDS_RIGI_PARAM9>
{
public:
...
class TRigidParam10_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_RIGI_PARAM10, IDI_VALUETYPE_RIGID_10, IDS_RIGI_PARAM10,
  IDS_RIGI_PARAM10>
{
public:
...
class TRigidParam11_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_RIGI_PARAM11, IDI_VALUETYPE_RIGID_11, IDS_RIGI_PARAM11,
  IDS_RIGI_PARAM11>
{
public:
...
class TRigidParam12_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_RIGI_PARAM12, IDI_VALUETYPE_RIGID_12, IDS_RIGI_PARAM12,
  IDS_RIGI_PARAM12>
{
public:
...
class TRigidParam13_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_RIGI_PARAM13, IDI_VALUETYPE_RIGID_13, IDS_RIGI_PARAM13,
  IDS_RIGI_PARAM13>
{
public:
...
class TRigidParam14_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_RIGI_PARAM14, IDI_VALUETYPE_RIGID_14, IDS_RIGI_PARAM14,
  IDS_RIGI_PARAM14>
{
public:
...
class TRigidParam15_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_RIGI_PARAM15, IDI_VALUETYPE_RIGID_15, IDS_RIGI_PARAM15,
  IDS_RIGI_PARAM15>
{
public:
...
class TRigidParam16_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_RIGI_PARAM16, IDI_VALUETYPE_RIGID_16, IDS_RIGI_PARAM16,
  IDS_RIGI_PARAM16>
{
public:
...
class TRigidParam17_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_RIGI_PARAM17, IDI_VALUETYPE_RIGID_17, IDS_RIGI_PARAM17,
  IDS_RIGI_PARAM17>
{
public:
...
class TRigidParam18_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_RIGI_PARAM18, IDI_VALUETYPE_RIGID_18, IDS_RIGI_PARAM18,
  IDS_RIGI_PARAM18>
{
public:
...
class TRigidParam19_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_RIGI_PARAM19, IDI_VALUETYPE_RIGID_19, IDS_RIGI_PARAM19,
  IDS_RIGI_PARAM19>
{
public:
...
class TRigidParam20_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_RIGI_PARAM20, IDI_VALUETYPE_RIGID_20, IDS_RIGI_PARAM20,
  IDS_RIGI_PARAM20>
{
public:
...
class TRigidParam21_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_RIGI_PARAM21, IDI_VALUETYPE_RIGID_21, IDS_RIGI_PARAM21,
  IDS_RIGI_PARAM21>
{
public:
...
class TElasticHardening_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_ELASTIC_HARDENING, IDI_VALUETYPE_ELASTIC_HARDENING,
...
class TSecondaryHardening_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_SEC_HARDENING, IDI_VALUETYPE_SEC_HARDENING,
...
class TLayerNormalIncl_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_LAYER_NORMAL_INCL, IDI_VALUETYPE_LAYER_NORMAL_INCL,
...
class TLayerNormalAzi_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_LAYER_NORMAL_AZI, IDI_VALUETYPE_LAYER_NORMAL_AZI,
...
class TFractStiffNormal_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_FRACT_STIFF_NORMAL, IDI_VALUETYPE_FRACT_STIFF_NORMAL,
...
class TFractStiffShear_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_FRACT_STIFF_SHEAR, IDI_VALUETYPE_FRACT_STIFF_SHEAR,
...
class TThermLinExpNormal_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_THERM_LIN_EXP_NORM, IDI_VALUETYPE_THERM_LIN_EXP_NORM,
...
class TThermLinExpLateral_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_THERM_LIN_EXP_LAT, IDI_VALUETYPE_THERM_LIN_EXP_LAT,
...
class TThermalConductivity_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_THERM_CONDUCT, IDI_VALUETYPE_THERM_CONDUCT,
...
class TThermalCapacity_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_THERM_CAPACI, IDI_VALUETYPE_THERM_CAPACI, IDS_ET_THERM_CAPACI,
...
class THighFractDens_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_HIGH_FRACT_DENS, IDI_VALUETYPE_HIGH_FRACT_DENS,
...
class THighFractDensIncl_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_HIGH_FRACT_DENS_INCL, IDI_VALUETYPE_HIGH_FRACT_DENS_INCL,
...
class THighFractDensAzi_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_HIGH_FRACT_DENS_AZI, IDI_VALUETYPE_HIGH_FRACT_DENS_AZI,
...
class TLowFractDens_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_LOW_FRACT_DENS, IDI_VALUETYPE_LOW_FRACT_DENS,
...
class TLowFractDensIncl_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_LOW_FRACT_DENS_INCL, IDI_VALUETYPE_LOW_FRACT_DENS_INCL,
...
class TLowFractDensAzi_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_LOW_FRACT_DENS_AZI, IDI_VALUETYPE_LOW_FRACT_DENS_AZI,
...
class TInterFractDens_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_INTER_FRACT_DENS, IDI_VALUETYPE_INT_FRACT_DENS,
...
class TPermeability_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_PERMEA, IDI_VALUETYPE_PERMEA, IDS_ET_PERMEA,
...
class TViscosity_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_VISCOSITY, IDI_VALUETYPE_VISCOSITY, IDS_ET_VISCOSITY,
...
class TFluidDensity_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_FLUID_DENSITY, IDI_VALUETYPE_FLUID_DENSITY,
...
class TReferenceStress_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_REFERENCESTRESS, IDI_VALUETYPE_REFERENCESTRESS,
...
class TApertureParameter_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_APERTUREPARAM, IDI_VALUETYPE_APERTUREPARAM,
...
class TNormalStress_Delegate : public CSingleComponentTemp_Delegate <
  IDT_VALUETYPE_NRMSTRESS, IDI_VALUETYPE_NRMSTRESS, IDS_ET_NRMSTRESS, IDS_VALUENAME_NRMSTRESS>
{
public:
...
class TMeanStress_Delegate : public CSingleComponentTemp_Delegate <
  IDT_VALUETYPE_MEANSTRESS, IDI_VALUETYPE_MEANSTRESS, IDS_ET_MEANSTRESS, IDS_VALUENAME_MEANSTRESS>
{
public:
...
class TTimeStrain_Delegate : public CSingleComponentTemp_Delegate <
  IDT_VALUETYPE_TIMESTRAIN, IDI_VALUETYPE_TIMESTRAIN, IDS_ET_TIMESTRAIN, IDS_VALUENAME_TIMESTRAIN>
{
public:
...
class TDeltaV_Delegate : public CSingleComponentTemp_Delegate <
  IDT_VALUETYPE_DELTAV, IDI_VALUETYPE_DELTAV, IDS_ET_DELTAV, IDS_VALUENAME_DELTAV>
{
public:
...
class TDeltaT_Delegate : public CSingleComponentTemp_Delegate <
  IDT_VALUETYPE_DELTAT, IDI_VALUETYPE_DELTAT, IDS_ET_DELTAT, IDS_VALUENAME_DELTAT>
{
public:
...
class TDisplacementZ_Delegate : public CSingleComponentTemp_Delegate <
  IDT_VALUETYPE_DISPLACEMENTZ, IDI_VALUETYPE_DISPLACEMENTZ, IDS_ET_DISPLACEMENTZ, IDS_VALUENAME_DISPLACEMENTZ>
{
public:
...
class TDummyMaterialParameter_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_DUMMY, IDI_VALUETYPE_DUMMY, IDS_ET_DUMMY, IDS_VALUENAME_DUMMY>
{
public:
...
class TBoundaryKradMaterialParameter_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_KRAD, IDI_VALUETYPE_KRAD, IDS_ET_KRAD, IDS_VALUENAME_KRAD>
{
public:
...
class TBoundaryKtanMaterialParameter_Delegate : public CMaterialComponentTemp_Delegate <
  IDT_VALUETYPE_KTAN, IDI_VALUETYPE_KTAN, IDS_ET_KTAN, IDS_VALUENAME_KTAN>
{
public:
