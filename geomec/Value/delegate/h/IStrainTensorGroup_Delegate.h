...
class IStrainTensorGroup_Delegate : public ITensorGroupTemplate_Delegate<CStrainTensor> {
public:
  class CInvariantComposite_Delegate : public IResult_Delegate {
  public:
    CInvariantComposite_Delegate(IStrainTensorGroup::CInvariantComposite *invariantComposite);
  ...
  private:
    ...
    REGISTER_DELEGATE(IStrainTensorGroup::CInvariantComposite, CInvariantComposite_Delegate);
  };
  ...
  private:
    CWellPathAxialStrainComposite_Delegate(const CWellPathAxialStrainComposite_Delegate &rhs);
    CWellPathAxialStrainComposite_Delegate &operator=(const CWellPathAxialStrainComposite_Delegate &rhs);

    IStrainTensorGroup::CWellPathAxialStrainComposite *m_wellPathAxialStrainComposite;

    REGISTER_DELEGATE(IStrainTensorGroup::CWellPathAxialStrainComposite, CWellPathAxialStrainComposite_Delegate);
  };
...
private:
  ...
  IStrainTensorGroup_Delegate &operator=(const IStrainTensorGroup_Delegate &rhs);
