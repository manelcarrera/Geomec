...
public:
  ...
  public:
    CDerivedResultComponent_Delegate(CDerivedResult::CDerivedResultComponent *derivedResultComponent);
  ...
  private:
    CDerivedResultComponent_Delegate(const CDerivedResultComponent_Delegate &rhs);
    CDerivedResultComponent_Delegate &operator=(const CDerivedResultComponent_Delegate &rhs);

    CDerivedResult::CDerivedResultComponent *m_derivedResultComponent;

    REGISTER_DELEGATE(CDerivedResult::CDerivedResultComponent, CDerivedResultComponent_Delegate);
  };
...
private:
  ...
  CDerivedResultGroup_Delegate &operator=(const CDerivedResultGroup_Delegate &rhs);
