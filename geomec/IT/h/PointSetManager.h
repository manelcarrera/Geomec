...
public:
	...
	bool create( int id /*IT_Geomec_Interface::eDepletionType*/, const IT_Data::TPointsV& points_v, IPointSet::DIMENSION dim = IPointSet::DIM_2D, std::string name = std::string() );
	...
	bool unlink( int ps_id, int values_id, CFormationBase* pFormation, CDepletionStage* pStage ); // remove from the data tree 
