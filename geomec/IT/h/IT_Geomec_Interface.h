...
protected:
	...
	static const IVectorResult::CVectorComponent* G_RES_component_ONE(		eComposite composite_,
	...
	/* Generic function */
	static const IResultComponent* G_RES_component( eComposite composant_, CDepletionStage *pStage, IVectorResult::VECTOR_COMPONENT _component );
...
private:
	...
	*/
	...
	/**/
	static int G_add_point_set(	const IT_Data::TPointsV& points_v, 
...
public:
	...
	*/
	static void add_pressure(	int reservoir_id,							// Formation to wich add the provided pressure
	...
	*/
	...
	//------------------------------------------------------- displacement (LIST) --------------------------------------------------------------------------
	/**/
	static const IVectorResult::CFullVectorComponent* G_RES_component_FULL( eComposite composite_, CDepletionStage *pStage );
	...
	/**/
	static IT_Data::T3ValuesV BD_values( eComposite composite_, int composite_idx, TDisplacementComponentV component_v = {X,Y,Z} );

	/**/
	static IT_Data::T3Values BD_value( const geo::IPoint& point, IValueComposite* composite, TDisplacementComponentV& component_v );
