...
IT_Events_Handler::IT_Events_Handler( GeomecPythonInterface* gm_iface_ ) : gm_iface( gm_iface_ ) {}// : IEventsHandler( gm_iface_gui_ ){}
  ...
  while( !b_quit ) 
  {
    ...
    switch( cmd_id )
    {
      ...
      default:
        ...
        if( cmd_id == Command::eType::Control_Ini || 
          cmd_id == Command::eType::Control_End )
