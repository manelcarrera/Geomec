...
CStressTensor::CStressTensor(const ITensor &tensor) : CMechanicalTensor(tensor) {}

CStressTensor::CStressTensor(const double &xx, const double &yy, const double &zz, const double &xy, const double &yz,
                             const double &xz)
...
double CStressTensor::AverageStress() const { return (1.0 / 3.0) * InvarI1(); }
