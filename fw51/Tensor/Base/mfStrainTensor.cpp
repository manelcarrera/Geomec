...
CStrainTensor::CStrainTensor(const ITensor& tensor)
...
CStrainTensor::CStrainTensor(const double &xx, const double &yy, const double &zz,
...
double CStrainTensor::EngineerXY() const
{
	return 2.0 * XY();
}

double CStrainTensor::EngineerYZ() const
{
	return 2.0 * YZ();
}

double CStrainTensor::EngineerZX() const
{
	return 2.0 * XZ();
}
...
double CStrainTensor::VolumetricStrain() const
{
	return InvarI1();
}
