...
CModelObjectObserver::CModelObjectObserver(IModelObject &observed_object, CModelObjectObserver *parent)
    : QObject(parent), m_stateChanged(false), m_displayChanged(false), m_propertyChanged(false),
      m_geometryChanged(false), m_parameterChanged(false), m_childOrderChanged(false), m_childInserted(false),
      m_childRemoved(false), m_referenceInserted(false), m_referenceRemoved(false), m_observed_object(observed_object),
      m_select(false) {
...
void CModelObjectObserver::stateChanged() { m_stateChanged = true; }

void CModelObjectObserver::displayChanged() { m_displayChanged = true; }

void CModelObjectObserver::propertyChanged() { m_propertyChanged = true; }

void CModelObjectObserver::geometryChanged() { m_geometryChanged = true; }

void CModelObjectObserver::parameterChanged() { m_parameterChanged = true; }

void CModelObjectObserver::childOrderChanged() { m_childOrderChanged = true; }

void CModelObjectObserver::childInserted() { m_childInserted = true; }

void CModelObjectObserver::childRemoved() { m_childRemoved = true; }

void CModelObjectObserver::referenceInserted() { m_referenceInserted = true; }

void CModelObjectObserver::referenceRemoved() { m_referenceRemoved = true; }

void CModelObjectObserver::error(const QString &description) { m_errors.append(description); }

void CModelObjectObserver::warning(const QString &description) { m_warnings.append(description); }
...
void CModelObjectObserver::onChildInserted() { updateChildren(); }

void CModelObjectObserver::onChildRemoved() { updateChildren(); }

void CModelObjectObserver::onReferenceInserted() { updateChildren(); }

void CModelObjectObserver::onReferenceRemoved() { updateChildren(); }
...
/*!
  ...
  \sa updateChildren
*/
CModelObjectObserver *CModelObjectObserver::insertChild(IModelObject & /*object*/) { return 0; }

int CModelObjectObserver::childSize() const { return observedObject().childSize(); }

IModelObject &CModelObjectObserver::childAt(int nIndex) { return observedObject().childAt(nIndex); }
...
void CModelObjectObserver::appendCommands(ICommandInvoker &mnu) {
  mnu.append(new TModelObjectObserverCommand(tr("Delete"), *this, &CModelObjectObserver::destroy,
                                             &CModelObjectObserver::canDestroy));
  mnu.appendSeparator();
  mnu.append(new TModelObjectObserverCommand(tr("Properties..."), *this, &CModelObjectObserver::showProperties,
                                             &CModelObjectObserver::canShowProperties));
}

void CModelObjectObserver::destroy() { observedObject().destroy(); }

bool CModelObjectObserver::canDestroy() const { return observedObject().canDestroy(); }
...
bool CModelObjectObserver::canShowProperties() const { return false; }

/*virtual*/ void CModelObjectObserver::select() { m_select = true; }

/*virtual*/ void CModelObjectObserver::deSelect() { m_select = false; }

/*virtual*/ bool CModelObjectObserver::isSelected() const { return m_select; }
