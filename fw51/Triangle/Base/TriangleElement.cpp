...
void CTriangleElement::Point(const int /*nIndex*/, const geo::IPoint & /*pt*/) { assert(false); }

int CTriangleElement::NrOfPoints() const { return 3; }

const geo::IElementSet *CTriangleElement::IndexingElementSet() const { return &m_surface; }

int CTriangleElement::Index() const { return m_nIndex; }
...
bool CTriangleElement::Empty() const { return false; }
