...
protected:
  ...
  public:
    ...
    CPolygon(CPolygonModifierBase &mouse_listener, TColor point_color, TColor line_color, TColor point_selected_color,
             bool bAutoClose);
    virtual ~CPolygon();
    // Point Handling
  ...
  // Constructor
  CPolygonModifierBase(TFrame &frame, TColor point_color, TColor line_color, TColor point_selected_color,
