...
public:
  C2DGraphLineBase(C2DGraphBase &parent, unsigned long color = qRgb(255, 0, 0), bool bLineStipple = false);

  C2DGraphLineBase(C2DGraphBase &parent, const QString &description, unsigned long color = qRgb(255, 0, 0),
