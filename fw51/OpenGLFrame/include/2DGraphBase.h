...
public:
	...
	void FillPolygon(const C2DGraphLineBase& min_line, 
					 const C2DGraphLineBase& max_line, 
					 TColor color,
					 const double& dEps,
					 bool bCutOnEps);
	void FillPolygon(const C2DGraphLineBase::TSerie& first, 
					 const C2DGraphLineBase::TSerie& second,
					 TColor color,
					 const double& dEps,
					 bool bCutOnEps);
