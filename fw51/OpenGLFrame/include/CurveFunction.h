...
OPENGLFRAME_EXPORT void setCoordinatesVector1d(double *ctrlpoints, int i_size, const geo::IElement &elem,
                                               const double *coef, int k_size);

OPENGLFRAME_EXPORT void setColorVector1d(double *color_ctrlpoint, int i_size, std::vector<IDrawDef::TColor> &vcColor,
                                         const double *coef, int k_size);

OPENGLFRAME_EXPORT void setCoordinatesVector2d(double *ctrlpoints, int i_size, int j_size, const geo::IElement &elem,
                                               const double *coef, int k_size);

OPENGLFRAME_EXPORT void setColorVector2d(double *color_ctrlpoint, int i_size, int j_size,
                                         std::vector<IDrawDef::TColor> &vcColor, const double *coef, int k_size);
