...
public:
  ...
  CLabelPoint(const double &dX, const double &dY, const double &dZ, const QString &label, const QFont &font = QFont(),
              eLabelAlign Alignment = LA_BOTTOM_LEFT, const double &dRotate = 0);
  CLabelPoint(const geo::IPoint &point, const QString &label, const QFont &font = QFont(),
              eLabelAlign Alignment = LA_BOTTOM_LEFT, const double &dRotate = 0);
