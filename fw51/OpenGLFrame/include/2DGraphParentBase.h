...
private:
  ...
  void AdaptOffset(TAxis axis, double &dLeftOffset, double &dRightOffset, double &dTopOffset, double &dBottomOffset);
...
protected:
  ...
  void DrawAxisLabel(const QString sLabel, TAxis axis, QFont pFont);
  void DrawLabel(const QString &sLabel, const double &dFraction, TDirection direction, TAxis axis);
