...
CColorScale::CColorScale(const CColorScale &right) { *this = right; }
...
void CColorScale::Insert(const TColorPair &p) { m_ColorPairSet.insert(p); }

void CColorScale::Clear() { m_ColorPairSet.clear(); }
