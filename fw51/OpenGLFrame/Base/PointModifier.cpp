...
const geo::IPoint &CPointModifier::Point() const { return m_point; }
...
bool CPointModifier::MouseDblClk(TKeyboardModifiers /*state*/, TMouseButton /*button*/,
...
bool CPointModifier::Dragging() const { return !m_drag_point.Empty(); }
