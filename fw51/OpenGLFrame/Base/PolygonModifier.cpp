...
CPolygonModifier::CPolygonModifier(TFrame &frame, const geo::IPolygon &polygon, const geo::IPlane &plane)
    : CPolygonModifierBase(frame, qRgb(255, 0, 0), qRgb(0, 0, 255), qRgb(0, 255, 0)), m_Plane(plane) {
...
bool CPolygonModifier::MouseDblClk(TKeyboardModifiers /*state*/, TMouseButton /*button*/,
