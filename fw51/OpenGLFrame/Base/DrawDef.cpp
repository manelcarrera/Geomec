...
CDrawDef::CDrawDef(TColor FixedColor) : m_Color(FixedColor) {
  Init();
  m_TextColor = FixedColor;
}

CDrawDef::CDrawDef() : m_Color(qRgb(255, 255, 255)) { Init(); }
...
void CDrawDef::TextColor(const TColor color) { m_TextColor = color; }

CDrawDef::TColor CDrawDef::TextColor() const { return m_TextColor; }

void CDrawDef::SetFixedColor(const TColor color) { m_Color = color; }

CDrawDef::TColor CDrawDef::GetFixedColor() const { return m_Color; }
