...
//////////////////////////////////////////////////////////////////////
CGeoObjectHandlerBase::CGeoObjectHandlerBase(bool autodelete /*=true*/)
: m_bAutoDelete(autodelete)
{
}

CGeoObjectHandlerBase::~CGeoObjectHandlerBase()
{
	RemoveAllObjects();
}


int CGeoObjectHandlerBase::Size() const
{
	return m_DisplayList.count();
}

CDisplayPair* CGeoObjectHandlerBase::GetPair(int index)
{
	return m_DisplayList.at(index); 
}

bool CGeoObjectHandlerBase::AutoDelete() const
{
