...
///////////////////////////////////////////////////////////////////////////////////////////////////////
CPolygonModifierBase::CPolygon::CPolygon(CPolygonModifierBase& mouse_listener,
                     TColor point_color, 
                     TColor line_color, 
                     TColor point_selected_color,
                     bool bAutoClose)
: m_ddPoint(point_color),
  m_ddLine(line_color),
  m_ddSelectedPoint(point_selected_color),
...
int CPolygonModifierBase::CPolygon::PointSize() const
{
...
{
  std::vector<const geo::IObject*> vcSelection = ((IOpenGLFrame&)m_mouse_listener.Frame()).ProcessSelection(screen_point);
...
int CPolygonModifierBase::CPolygon::PointSelection() const
{
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
CPolygonModifierBase::CPolygonModifierBase(TFrame &frame, 
                       TColor point_color,
                      TColor line_color,
                       TColor point_selected_color,
                       bool bAutoClose)
...
geo::CPolygon CPolygonModifierBase::Polygon() const
{
  return m_pPolygon->Polygon();
}

void CPolygonModifierBase::DrawScene()
{
  m_pPolygon->DrawScene();
}
