...
bool CPolygonCreator::KeyPress(TKeyboardModifiers state, int nAscii, TKey key, int nRepCount) {
...
bool CPolygonCreator::MouseDblClk(TKeyboardModifiers /*state*/, TMouseButton /*button*/,
...
bool CPolygonCreator::CanFinish() { return ValidateThisPolygon(); }

bool CPolygonCreator::ValidateThisPolygon() { return ValidatePolygon(GetCreatedPolygon()); }
