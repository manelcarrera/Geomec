...
COpenGLAxis::COpenGLAxis(TColor color, const QString &sX, const QString &sY, const QString &sZ) : COpenGLScene(false) {
...
bool COpenGLAxis::Visible() const { return m_Visible; }

void COpenGLAxis::Visible(bool visible) { m_Visible = visible; }

bool COpenGLAxis::AllowRotateParent() const { return m_AllowRotateParent; }

void COpenGLAxis::AllowRotateParent(bool allow) { m_AllowRotateParent = allow; }
