...
//////////////////////////////////////////////////////////////////////
COpenGLArrow::COpenGLArrow(const geo::IPoint& base_point, const geo::IVector& vector,const TOpenGLArrowShapeDef& shape /*= TOpenGLArrowShapeDef()*/)
{
	m_pLine = 0;
	m_pConus = 0;
...
COpenGLArrow::COpenGLArrow( const COpenGLArrow& rhs )
: geo::IArray(rhs)
{
...
void COpenGLArrow::Change(const geo::IPoint& base_point,const geo::IVector& vector,const TOpenGLArrowShapeDef& shape /*= TOpenGLArrowShapeDef()*/)
{
...
const geo::CVector COpenGLArrow::Dir() const
{
	return m_pLine->Direction();
}
...
void COpenGLArrow::Remove(const int /*nIndex*/)
{
	assert(false);
}

size_t COpenGLArrow::Size() const
{
	return 2;
}
