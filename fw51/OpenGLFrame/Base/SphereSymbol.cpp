...
CSphereSymbol::CSphereSymbol(const geo::IPoint &location, const double& radius)
:m_location(location)
{
...
int CSphereSymbol::NrOfPositions() const
{
  return 1;
}
...
const geo::IArray& CSphereSymbol::Geometry() const
{
  return m_geometry;
}

const geo::IPoint& CSphereSymbol::PivotPoint() const
{
...
/*virtual*/ 
bool CSphereSymbol::Empty() const
{
