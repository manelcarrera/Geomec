...
CDragger::CDragger(TFrame &frame, const geo::IPlane &plane) : CMouseListener(frame), m_plane(plane) {}
...
const geo::IPlane &CDragger::Plane() const { return m_plane; }

bool CDragger::ValidatePoint(const geo::IPoint & /*point*/) const { return true; }

bool CDragger::IsDragging() const { return !m_ptBeginPoint.Empty(); }
...
bool CDragger::MouseWheel(TKeyboardModifiers /*state*/, int /*nDelta*/, const TScreenPoint & /*point*/) { return true; }
