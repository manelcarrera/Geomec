...
CColorScaleDrawDef::CColorScaleDrawDef() { Init(); }

void CColorScaleDrawDef::AddPair(double value, TColor color) { m_colorscale.Insert(std::make_pair(value, color)); }

void CColorScaleDrawDef::Clear() { m_colorscale.Clear(); }
