...
public:
  void putStatusMessage(  const QString&       message,
                          const TFilePosition& info = -1 );
  void putWarningMessage( int                  errorNo,
                          const QString&       message,
                          const TFilePosition& info = -1 );
  void putFatalMessage(   int   errorNo,
                          const QString&       message,
                          const TFilePosition& info = -1 );
  void putAbortMessage(   int errorNo,
                          const QString&       message,
                          const TFilePosition& info = -1 );
