...
public:
  ...
  void create(IModelObject *parent = 0, const IModelObject *pInsertBefore = 0);
  void reParent(IModelObject *new_parent, const IModelObject *pInsertBefore = 0);
  ...
  void moveChildren(const QList<IModelObject *> &children, int destinationIndex);
  void sortChildren();
...
protected: // abstract class: prevent instantiation
  ...
  virtual CUndoOperation *constructCreateUndoOperation(IModelObject &object, const QString &descr);
  virtual CUndoOperation *constructDestroyUndoOperation(IModelObject &location, IModelObject &object,
                                                        const QString &descr);

private:
  void addToParent(IModelObject *parent, const IModelObject *pInsertBefore = 0);
