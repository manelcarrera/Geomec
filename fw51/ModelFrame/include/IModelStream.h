...
public:
  ...
  IModelObject *getModel() {
    assert(m_currentModel);
...
template <class T> IModelStream &operator<<(IModelStream &stream, const QList<T> &list) {
  stream << list.size();
...
template <class T> IModelStream &operator>>(IModelStream &stream, QList<T> &list) {
  int size = 0;
  stream >> size;
...
template <class T> IModelStream &operator<<(IModelStream &stream, const QVector<T> &vec) {
  stream << vec.size();
...
template <class T> IModelStream &operator>>(IModelStream &stream, QVector<T> &vec) {
  int size = 0;
  stream >> size;
