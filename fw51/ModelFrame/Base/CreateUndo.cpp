...
/*!
  ...
  can be restored.
*/
CCreateUndo::CCreateUndo(IModelObject &location, const QString &text) : CLocalUndo(location, text) {}
...
*/
void CCreateUndo::undo(CDocumentBase &document) { location(document).destroy(); }
