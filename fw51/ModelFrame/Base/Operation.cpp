...
COperation::COperation(IModelObject &object) : m_document(object.document()) {
...
COperation::~COperation() { delete m_temp; }

void COperation::undo() {}

void COperation::onDocumentDestroyed() { m_document = 0; }
