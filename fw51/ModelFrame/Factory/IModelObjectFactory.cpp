 ...
 */
IModelObjectFactoryCollection::IModelObjectFactoryCollection()
{
  assert( m_instance == 0 );
}
...
{
  if ( m_instance == 0 ) m_instance = new IModelObjectFactoryCollection();
  return *m_instance;
}
 ...
 */
void IModelObjectFactoryCollection::insert( IModelObjectFactory* factory )
{
 ...
 */
void IModelObjectFactoryCollection::remove( IModelObjectFactory* factory )
{
...
IModelObjectFactory::IModelObjectFactory()
{
  IModelObjectFactoryCollection::instance().insert( this );
}

IModelObjectFactory::~IModelObjectFactory()
{
  IModelObjectFactoryCollection::instance().remove( this );
}
