...
template <class T> class CSpreadFile : public CTextFile {
...
// ##ModelId=3BA8A4B201AA
template <class T> CSpreadFile<T>::CSpreadFile() {}
...
*/
// ##ModelId=3BA8A4B201BF
template <class T> CSpreadFile<T>::TValueVec::size_type CSpreadFile<T>::LineLength() const {
  if (m_vcFile.size() == 0) {
    return 0;
  }
...
// ##ModelId=3BA8A4B201C9
template <class T> CSpreadFile<T>::TValueVec::size_type CSpreadFile<T>::Size() const { return m_vcFile.size(); }

// ##ModelId=3BA8A4B201CB
template <class T> CTextFile::ParseRet CSpreadFile<T>::OnRead() {
...
// ##ModelId=3BA8A4B2019F
template <class T> bool CSpreadFile<T>::ReadLine() {
...
// ##ModelId=3BA8A4B201CD
template <class T> CToken::TokenRet CSpreadFile<T>::OnParseFail(const std::string &sToken) {
...
// ##ModelId=3BA8A4B201D9
template <class T> void CSpreadFile<T>::OnNewToken() {
