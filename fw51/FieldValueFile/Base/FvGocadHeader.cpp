...
CGoCadHeader::CGoCadHeader(const QString &sName)
: m_sName(sName)
{
...
const QString& CGoCadHeader::Name() const
{
	return m_sName;
}

int CGoCadHeader::PropertySize() const
{
...
void CGoCadHeader::AddPoint(const geo::IPoint *pPoint)
{
	m_vcPoints.push_back(pPoint);
}
