...
CTextFile::CTextFile()
    : m_unitType(SI_UNIT), m_line_nr(-1), m_line_position(-1), m_file_position(0), m_pProgress(0), m_pStream(0) {}

CTextFile::~CTextFile() { Clear(); }

const QString &CTextFile::ErrorMessage() const { return m_sErrorMessage; }
...
void CTextFile::setUnitType(unitType icode) { m_unitType = icode; }
...
*/
int CTextFile::lineNr() const { return m_line_nr; }
...
*/
QString CTextFile::PathName() const { return m_file.fileName(); }
