...
CEclipseReservoir::CEclipseReservoir(const CEclipseReservoir &rhs)
    : m_nUpperBoundary(rhs.m_nUpperBoundary), m_nLowerBoundary(rhs.m_nLowerBoundary),
      m_bCircleCompleted(rhs.m_bCircleCompleted), m_bJoin(rhs.m_bJoin), m_nGridX(rhs.m_nGridX), m_nGridY(rhs.m_nGridY) {
  m_pLowerBound = this;
  m_pUpperBound = this;
...
bool CEclipseReservoir::CircleCompleted() const { return m_bCircleCompleted; }

void CEclipseReservoir::CircleCompleted(const bool bCompleted) { m_bCircleCompleted = bCompleted; }

bool CEclipseReservoir::Join() const { return m_bJoin; }

void CEclipseReservoir::Join(const bool bJoin) { m_bJoin = bJoin; }
...
CEclipseReservoir &CEclipseReservoir::LowerReservoirBoundary() const { return *m_pLowerBound; }

CEclipseReservoir &CEclipseReservoir::UpperReservoirBoundary() const { return *m_pUpperBound; }

int CEclipseReservoir::SizeX() const { return m_nGridX - 1; }

int CEclipseReservoir::SizeY() const { return m_nGridY - 1; }
