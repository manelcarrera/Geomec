...
CBodyQuadrilateral::CBodyQuadrilateral(IBody &parent, int nIndex)
...
const IBody* CBodyQuadrilateral::Parent() const
{
  return &m_parent;
}
...
size_t CBodyQuadrilateral::Order() const
{
  return Parent()->Order();
}
...
int CBodyQuadrilateral::Index() const
{
  return m_nIndex;
}
