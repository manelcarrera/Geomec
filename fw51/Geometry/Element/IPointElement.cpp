...
void IPointElement::AssertValid() const { assert(NrOfPoints() == 1); }

int IPointElement::NrOfPoints() const { return 1; }
...
double IPointElement::Size() const { return 0; }

size_t IPointElement::Order() const { return 1; }

double IPointElement::RepresentativeLength() const { return 0; }

std::vector<CLine> IPointElement::Lines() const { return std::vector<CLine>(); }
...
int IPointElement::NrOfLines() const { return 0; }
