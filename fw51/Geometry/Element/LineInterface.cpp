...
*/
CLineInterface::CLineInterface(IMesh &mesh,
...
const IElement& CLineInterface::Front() const
{
  return FrontLine();
}

const ILine& CLineInterface:: FrontLine() const
{
  return getLine( m_nodes[0], m_nodes[1], m_front);
}

const IFace& CLineInterface:: FrontFace() const
{
  return m_front;
}

const IElement& CLineInterface::Back() const
{
  return BackLine();
}

const ILine& CLineInterface:: BackLine() const
{
  return getLine( m_nodes[2], m_nodes[3], m_back);
}

const IFace& CLineInterface:: BackFace() const
{
  return m_back;
}
