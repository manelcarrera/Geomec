...
CTiedPointBodyTriangle::CTiedPointBodyTriangle(IBody &parent, int nIndex)
    : CBodyTriangle(parent, nIndex), m_vcPoints(3), m_vcElements(3, nullptr) {}

void CTiedPointBodyTriangle::AddTying(int nIndex, const geo::IInterfaceElement &elt, const geo::CPoint &point,
                                      int nOffset) {
