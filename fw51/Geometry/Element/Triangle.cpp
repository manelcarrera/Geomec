...
CTriangle::CTriangle(const ITriangle &rhs) 
: m_pPoint(0), 
  m_pNode(0), 
  m_nIndex(-1),
  m_pElementSet(0),
...
CTriangle::CTriangle(const IPoint &p1,
           const IPoint &p2,
           const IPoint &p3)
: m_pPoint(0), 
  m_pNode(0), 
...
std::string CTriangle::Type() const
{
  return "T6EPS";
}
