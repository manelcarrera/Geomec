...
CBodyLine::CBodyLine(IBody& parent, int nIndex)
...
const IBody& CBodyLine::localParent() const
{
	return m_parent;
}

IBody& CBodyLine::localParent()
{
	return m_parent;
}

size_t CBodyLine::NrOfNodes() const
{
	return Order() + 1;
}
...
size_t CBodyLine::Order() const
{
	return localParent().Order();
}
