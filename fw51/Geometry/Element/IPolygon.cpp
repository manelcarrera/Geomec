...
IPolygon::IPolygon(bool bIsHole) : m_bIsHole(bIsHole), m_Normal(CVector::NullVector), m_bNormalCalculated(false) {}
...
CPolygonPtrArray IPolygon::PolyClip(IPolygon::ClipOperation ClipType, CPolygonPtrArray &Poly1,
                                    CPolygonPtrArray &Poly2) {
...
bool IPolygon::IsHole() const { return m_bIsHole; }

void IPolygon::IsHole(bool bIsHole) { m_bIsHole = bIsHole; }
