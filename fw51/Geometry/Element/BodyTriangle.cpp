...
CBodyTriangle::CBodyTriangle(IBody &parent, int nIndex) : m_parent(parent), m_nIndex(nIndex) {}

CBodyTriangle::~CBodyTriangle() {}

const IBody *CBodyTriangle::Parent() const { return &m_parent; }

int CBodyTriangle::PointIndex(int nIndex) const { return Parent()->PointIndex(BodyNode(nIndex)); }

size_t CBodyTriangle::NrOfNodes() const { return Order() * 3; }
...
size_t CBodyTriangle::Order() const { return Parent()->Order(); }
...
int CBodyTriangle::Index() const { return m_nIndex; }
