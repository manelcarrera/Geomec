...
CEmbeddedTriangle::CEmbeddedTriangle(const IBody &parent, const ITriangle &rhs) : CTriangle(rhs), m_parent(parent) {}
...
CEmbeddedTriangle::CEmbeddedTriangle(const IBody &parent, IMesh &mesh, const IPoint &p1, const IPoint &p2,
                                     const IPoint &p3, bool bUnique)
...
const IBody *CEmbeddedTriangle::Parent() const { return &m_parent; }
