...
void IBodyFace::Point(int /*nIndex*/, const IPoint & /*pt*/) { assert(false); }

int IBodyFace::NrOfPoints() const { return m_vcPoint.size(); }

const IBody &IBodyFace::Body() const { return m_body; }

int IBodyFace::BodyNode(int nIndex) const { return m_vcPoint[nIndex]; }

const char *IBodyFace::Name() const { return m_Name; }
