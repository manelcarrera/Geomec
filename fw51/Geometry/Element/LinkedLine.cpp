...
CLinkedLine::CLinkedPoint::CLinkedPoint(CLinkedLine &linked_line, const IPoint &point)
    : CPoint(point), m_pair((CLinkedPoint *)0, (CLinkedPoint *)0), m_linked_line(linked_line)
...
CLinkedLine::CLinkedPoint *CLinkedLine::CLinkedPoint::First() { return m_pair.first; }

CLinkedLine::CLinkedPoint *CLinkedLine::CLinkedPoint::Second() { return m_pair.second; }
...
CLinkedLine::CLinkedLine() : m_pBegin(0) {}

CLinkedLine::~CLinkedLine() { Clear(); }
...
size_t CLinkedLine::Order() const { return 1; }
