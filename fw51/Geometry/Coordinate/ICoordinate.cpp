...
ICoordinate::CCoordinateXYLess::CCoordinateXYLess(const double& dEps)
: m_dEps(dEps)
{
}

ICoordinate::CCoordinateXYLess::CCoordinateXYLess()
: m_dEps( compareTolerance() )
{
}
...
ICoordinate::CCoordinateLess::CCoordinateLess(const double& dEps)
: m_dEps(dEps)
{
}

ICoordinate::CCoordinateLess::CCoordinateLess()
: m_dEps( compareTolerance() )
{
}
