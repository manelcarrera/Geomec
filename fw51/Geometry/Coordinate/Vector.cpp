...
CVector::CVector() : m_empty(true) {}

CVector::CVector(const double &dX, const double &dY, const double &dZ) : m_empty(false) {
  m_coor[0] = dX;
  m_coor[1] = dY;
  m_coor[2] = dZ;
  assert(!Empty());
...
CVector::CVector(const IVector &rhs) : m_empty(rhs.Empty()) {
  if (!rhs.Empty()) {
    m_coor[0] = rhs.X();
    m_coor[1] = rhs.Y();
    m_coor[2] = rhs.Z();
...
CVector::CVector(const CVector &rhs) : m_empty(rhs.Empty()) {
  if (!rhs.Empty()) {
    m_coor[0] = rhs.X();
    m_coor[1] = rhs.Y();
    m_coor[2] = rhs.Z();
...
CVector::CVector(const IPoint &pt) : m_empty(pt.Empty()) {
  if (!pt.Empty()) {
    pt.AssertValid();
    m_coor[0] = pt.X();
    m_coor[1] = pt.Y();
...
CVector::CVector(const ILine &line) : m_empty(line.Empty()) {
  if (!line.Empty()) {
    line.AssertValid();
...
CVector::CVector(const IPoint &first, const IPoint &second) : m_empty(false) {
...
void CVector::AssertValid() const { assert(!m_empty); }
...
CPoint CVector::Min() const { return *this; }

CPoint CVector::Max() const { return *this; }

bool CVector::Empty() const { return m_empty; }
