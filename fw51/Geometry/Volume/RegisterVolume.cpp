...
const IBody &CRegisterVolume::Body(int nIndex) const
{
  return *m_vcBody[nIndex];
}

int CRegisterVolume::BodySize() const
{
...
const IPoint &CRegisterVolume::Point(int nIndex) const
{
  return (const IPoint&)m_vcPoint.ObjectBase(nIndex);
}
...
int CRegisterVolume::PointSize() const
{
