...
bool CNearestNeighbour::BucketsCreated() const
{
  return m_pKernel != 0;
}
...
: CPtrArray<IPoint>(rhs),
  m_pKernel(0),
  m_dPointDensity(rhs.m_dPointDensity)
{
}
...
void CNearestNeighbour::Invalidate()
{
  DestroyBuckets();
}
...
const double& CNearestNeighbour::PointDensity() const
{
  return m_dPointDensity;
}
