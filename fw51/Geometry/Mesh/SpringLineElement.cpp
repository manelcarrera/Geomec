...
CSpringLineElement::CSpringLineElement(IMesh &mesh, int nFirst, int nSecond) : m_mesh(mesh) {
  m_nodes[0] = nFirst;
  m_nodes[1] = nSecond;
...
std::string CSpringLineElement::Type() const { return "SP2RO"; }

const IElementSet *CSpringLineElement::IndexingElementSet() const { return &m_mesh; }

size_t CSpringLineElement::NrOfNodes() const { return 2; }
...
int CSpringLineElement::Index() const { return m_nIndex; }
