...
//////////////////////////////////////////////////////////////////////
CFaceGroup::CFaceGroup(IMesh &mesh) : m_mesh(mesh) { m_mesh.AddElementGroup(*this); }

CFaceGroup::~CFaceGroup() { m_mesh.RemoveElementGroup(*this); }
...
const IMesh &CFaceGroup::Mesh() const { return m_mesh; }

IMesh &CFaceGroup::Mesh() { return m_mesh; }
...
int CFaceGroup::PointSize() const { return (int)m_vcPoint.size(); }
...
int CFaceGroup::FaceSize() const { return (int)m_vcFace.size(); }
