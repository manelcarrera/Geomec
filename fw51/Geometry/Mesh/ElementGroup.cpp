...
//////////////////////////////////////////////////////////////////////
namespace geo {
CElementGroup::CElementGroup(IMesh &mesh, bool bVisible) : m_mesh(mesh), m_bVisible(bVisible) {
  m_mesh.AddElementGroup(*this);
}

CElementGroup::~CElementGroup() { m_mesh.RemoveElementGroup(*this); }
...
int CElementGroup::ElementSize() const { return (int)m_vcElement.size(); }
...
bool CElementGroup::isVisible() const { return m_bVisible; }

void CElementGroup::setVisible(bool bVisible) { m_bVisible = bVisible; }
