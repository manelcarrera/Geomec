...
const IMesh &CMesh::CNode::Mesh() const { return m_mesh; }

int CMesh::CNode::Index() const { return m_nIndex; }

void CMesh::CNode::Index(int nIndex) { m_nIndex = nIndex; }

// Coordinate access
const double &CMesh::CNode::X() const { return m_coor[0]; }

const double &CMesh::CNode::Y() const { return m_coor[1]; }

const double &CMesh::CNode::Z() const { return m_coor[2]; }

// Coordinate modification
void CMesh::CNode::X(const double &dX) { m_coor[0] = dX; }

void CMesh::CNode::Y(const double &dY) { m_coor[1] = dY; }

void CMesh::CNode::Z(const double &dZ) { m_coor[2] = dZ; }

void CMesh::CNode::AssertValid() const {}

bool CMesh::CNode::Empty() const { return false; }

// Looping over elements
int CMesh::CNode::AttachedElementSize() const { return (int)m_vcElement.size(); }
...
void CMesh::reserveElementSize(size_t size) { m_vcElement.reserve(size); }
...
int CMesh::NodeSize() const { return m_vcPoint.Size(); }

const IElement &CMesh::Element(int nIndex) const { return *m_vcElement[nIndex]; }

int CMesh::ElementSize() const { return (int)m_vcElement.size(); }
...
CMesh::TNodeVec CMesh::NearestPoint(const IPoint &point) const { return m_vcPoint.NearestNeighbourIndex(point); }
