...
CRingFactory::CRingFactory() { m_pSegment = new TSegmentSet(); }

CRingFactory::~CRingFactory() { delete (TSegmentSet *)m_pSegment; }
...
int CRingFactory::PointSize() const { return (int)m_vcPoint.size(); }
...
size_t CRingFactory::SegmentSize() const { return m_vcSegment.size(); }
...
int CRingFactory::RingSize() const { return (int)m_vcRing.size(); }

const CRingFactory::TRing &CRingFactory::Ring(int nIndex) const { return m_vcRing[nIndex].first; }

int CRingFactory::BoundarySize() const { return (int)m_vcBoundary.size(); }

const CRingFactory::TRing &CRingFactory::Boundary(int nIndex) const { return m_vcBoundary[nIndex].first; }
