...
CProgressScaler::CProgressScaler(IProgressBase &parent, int nParentSteps)
    : m_parent(parent), m_nTotalParentSteps(nParentSteps), m_nParentSteps(0), m_nTotalSteps(0), m_nSteps(0) {}

CProgressScaler::~CProgressScaler() {}

void CProgressScaler::AddSteps(int nSteps) { m_nTotalSteps += nSteps; }
...
void CProgressScaler::StatusMessage(const QString &sMessage) { m_parent.StatusMessage(sMessage); }
