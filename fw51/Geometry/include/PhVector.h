...
extern Value *Factorial(int n);
extern Value *Binomial(int n, int p);
extern Value *CNP(int a, int b);
extern Value *Gcd(Value a, Value b);
...
extern void Vector_Scale(Value *p1, Value *p2, Value lambda, unsigned length);
extern void Vector_AntiScale(Value *p1, Value *p2, Value lambda, unsigned length);
...
extern void Vector_Combine(Value *p1, Value *p2, Value *p3, Value lambda, Value mu, unsigned length);
...
extern void Vector_Map(Value *p1, Value *p2, Value *p3, unsigned length, Value *(*f)());
extern void Vector_Normalize(Value *p, unsigned length);
extern void Vector_Normalize_Positive(Value *p, int length, int pos);
