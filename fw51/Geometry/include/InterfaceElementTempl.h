...
template <class BASE> class CInterfaceElementTempl : public IInterfaceElement {
...
public:
  ...
  */
  virtual const IElement &Front() const { return *m_Front; }

  /*!
    Return the Back part of the interface
  */
  virtual const IElement &Back() const { return *m_Back; }
};
