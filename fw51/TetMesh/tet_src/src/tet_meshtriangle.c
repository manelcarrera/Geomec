...
static MeshTriangle_t *MeshTriangleCreate( 
                  int                         p0, 
                  int                         p1, 
                  int                         p2)
{
...
static MeshTriangle_t *MeshTriangleClear( 
                  MeshTriangle_t             *mt )
{
  if ( mt ) {
...
static MeshTriangle_t *MeshTriangleDelete( 
                  MeshTriangle_t             *mt )
{
  if ( mt ) {
...
{
  return RBTreeCreate( sizeof( MeshTriangle_t ), MeshTriangleComp );
}

extern MeshTriangleSet_t *MeshTriangleSetDelete( 
...
extern void MeshTriangleSetAdd( 
                  MeshTriangleSet_t          *mtSet, 
                  int                         p0, 
                  int                         p1, 
                  int                         p2, 
...
extern int MeshTriangleSetSize( 
                  const MeshTriangleSet_t     *mtSet )
{
  return (int)RBTreeSize( mtSet );
}

extern const MeshTriangle_t *MeshTriangleSetFirst( 
                  MeshTriangleSet_t           *mtSet,
                  Iterator_t                  *iter )
{
...
extern const MeshTriangle_t *MeshTriangleSetNext( 
                  MeshTriangleSet_t           *mtSet,
                  Iterator_t                  *iter )
{
...
extern MeshTriangle_t *MeshTriangleSetFind( 
                  MeshTriangleSet_t          *mtSet, 
                  int                         p0, 
                  int                         p1, 
                  int                         p2 )
...
extern Surface_t *MeshTriangleGetSurface( 
                  const MeshTriangle_t       *mt )
{
  return mt->surface;
}

extern void MeshTriangleSetSurface( 
                  MeshTriangle_t             *mt, 
                  Surface_t                  *surf,
                  int                         interfaceIdx )
{
...
extern int MeshTriangleSize( 
                  const MeshTriangle_t       *mt )
{
  return mt->nTetrahedron;
}
