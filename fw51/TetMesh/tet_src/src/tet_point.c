...
extern const double *PointSetGet( PointSet_t *pointSet, int id )
{
  return RBTreeGet( pointSet->tree, id );
}
...
extern int PointSetSize( const PointSet_t *pointSet )
{
  return (int)RBTreeSize( pointSet->tree );
}
...
extern const char * PointSetSPrint( 
                 char       *buf, 
                 PointSet_t *pointSet, 
                 const int   pointId )
{
...
extern double PointSetMinimumDistance( 
                 PointSet_t *pointSet, 
                 int        *id1, 
                 int        *id2, 
                 double     *measure )
...
extern double PointSetTolerance( 
                  const PointSet_t           *pointSet )
{
  return pointSet->eps;
}

extern int PointSetCreateMidPoint(
                  PointSet_t                 *pointSet,
                  int                         p0,
                  int                         p1 )
{
...
extern void PointMeshMessageAdd( 
                  void                       *meshV, 
                  PointSet_t                 *pointSet,
                  int                         pointId )
{
