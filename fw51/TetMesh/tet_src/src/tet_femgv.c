...
static PointManager_t *PointManagerCreate(
                  PointSet_t                 *pointSet,
...
static PointManager_t *PointManagerDelete(
...
static int PointManagerGetActiveId(
                  PointManager_t             *pointManager,
                  int                         totalId )
{
...
static int PointManagerGetTotalId(
                  PointManager_t             *pointManager,
                  int                         activeId )
{
  int   totalId = -1;
...
static int PointManagerAddActivePoint(
                  PointManager_t             *pointManager,
                  int                         activeId,
                  double                      x,
                  double                      y,
...
static void FemGvWriteTriangles(  
                  FILE                       *fp,  
                  PointManager_t             *pointManager,
                  SurfaceSet_t               *surfaceSet )
{
...
bool_t RunFemGV(const FemGvPath_t* pPath)
{
  ...
  if ( (l < 4) || !( strcmpcb(pPath->sFgvExeName, ".exe") ) ) add_exe = 1;
#endif
  ...
  if ( p ) exe_name = DiStrsave( p ) ;
  else     exe_name = DiStrsave( pPath->sFgvExeName );
...
extern TetrahedronSet_t *FemGvMeshBody( 
                  PointSet_t                 *pointSet, 
                  SurfaceSet_t               *surfaceSet, 
                  Body_t                     *body,
                  BodySet_t                  *cavities,
