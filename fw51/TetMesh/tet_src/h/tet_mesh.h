...
/* Generate function */
void MeshGenerate(const char *sDianaPath, const char *sDiaSharePath, const char *sDianaLibPath,
                  const char *sDianaSLibPath, const char *sFgvExeName, void *);
...
extern int MeshBodySideSurfaceTriangleNode(int nBodyIndex, int nSideSurfaceIndex, int nTriangleIndex,
                                           int nLocalNodeIndex, const void *);
