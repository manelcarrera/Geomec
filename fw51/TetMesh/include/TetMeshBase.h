...
protected:
  ...
  CTetMeshBase();
  static const geo::INode &NearestNode(const IPoint &point, const IFace *face);
...
private:
  ...
  bool RunFemGV(const std::string &sDianaPath, const std::string &sDiaSharePath, const std::string &sDianaLibPath,
                const std::string &sDianaSLibPath, const std::string &sFgvExeName);
...
public:
  ...
  virtual TRet CreateMesh(const std::string &sDianaPath, const std::string &sDiaSharePath,
                          const std::string &sDianaLibPath, const std::string &sDianaSLibPath,
                          const std::string &sFgvExeName, CTetMeshProgress &progress /* = CTetMeshProgress()*/);
